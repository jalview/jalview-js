(function(){var P$=Clazz.newPackage("javajs.img"),I$=[[0,'javajs.util.Base64']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
