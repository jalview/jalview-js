(function(){var P$=Clazz.newPackage("ext.vamsas"),I$=[[0,'java.net.URL','ext.vamsas.MuscleWSSoapBindingStub','ext.vamsas.MuscleWS','jalview.util.MessageManager','javax.xml.namespace.QName','java.util.HashSet']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "MuscleWSServiceLocator", null, 'org.apache.axis.client.Service', 'ext.vamsas.MuscleWSService');
...
C$.$fields$=[['S',['MuscleWS_address','MuscleWSWSDDServiceName'],'O',['ports','java.util.HashSet']]]
...
var endpoint;
try {
endpoint=Clazz.new_($I$(1,1).c$$S,[this.MuscleWS_address]);
} catch (e) {
...
var _stub=Clazz.new_([Clazz.new_($I$(1,1).c$$S,[this.MuscleWS_address]), this],$I$(2,1).c$$java_net_URL$javax_xml_rpc_Service);
_stub.setPortName$S(this.getMuscleWSWSDDServiceName$());
return _stub;
}} catch (t) {
...
return Clazz.new_($I$(5,1).c$$S$S,["vamsas", "MuscleWSService"]);
});

Clazz.newMeth(C$, 'getPorts$',  function () {
if (this.ports == null ) {
this.ports=Clazz.new_($I$(6,1));
this.ports.add$O(Clazz.new_($I$(5,1).c$$S$S,["vamsas", "MuscleWS"]));
