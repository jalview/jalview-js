...
qName=Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "Sequence"]);
...
qName=Clazz.new_($I$(8,1).c$$S$S,["vamsas", "ArrayOf_tns1_Sequence"]);
this.cachedSerQNames.add$O(qName);
cls=Clazz.array($I$(9), -1);
this.cachedSerClasses.add$O(cls);
this.cachedSerFactories.add$O(arraysf);
this.cachedDeserFactories.add$O(arraydf);
qName=Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "MsaResult"]);
this.cachedSerQNames.add$O(qName);
cls=Clazz.getClass($I$(10));
this.cachedSerClasses.add$O(cls);
this.cachedSerFactories.add$O(beansf);
this.cachedDeserFactories.add$O(beandf);
qName=Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "SequenceSet"]);
this.cachedSerQNames.add$O(qName);
cls=Clazz.getClass($I$(11));
this.cachedSerClasses.add$O(cls);
this.cachedSerFactories.add$O(beansf);
this.cachedDeserFactories.add$O(beandf);
qName=Clazz.new_($I$(8,1).c$$S$S,["http://simple.objects.vamsas", "Object"]);
this.cachedSerQNames.add$O(qName);
cls=Clazz.getClass($I$(12));
this.cachedSerClasses.add$O(cls);
this.cachedSerFactories.add$O(beansf);
this.cachedDeserFactories.add$O(beandf);
qName=Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "Alignment"]);
this.cachedSerQNames.add$O(qName);
cls=Clazz.getClass($I$(13));
this.cachedSerClasses.add$O(cls);
this.cachedSerFactories.add$O(beansf);
this.cachedDeserFactories.add$O(beandf);
qName=Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "WsJobId"]);
this.cachedSerQNames.add$O(qName);
cls=Clazz.getClass($I$(14));
this.cachedSerClasses.add$O(cls);
this.cachedSerFactories.add$O(beansf);
this.cachedDeserFactories.add$O(beandf);
qName=Clazz.new_($I$(8,1).c$$S$S,["vamsas", "ArrayOf_xsd_string"]);
this.cachedSerQNames.add$O(qName);
cls=Clazz.array(String, -1);
this.cachedSerClasses.add$O(cls);
this.cachedSerFactories.add$O(arraysf);
this.cachedDeserFactories.add$O(arraydf);
qName=Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "Result"]);
this.cachedSerQNames.add$O(qName);
...
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(8,1).c$$S$S,["", "seqSet"]), Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "SequenceSet"]), Clazz.getClass($I$(11)), 1, false, false);
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "WsJobId"]));
oper.setReturnClass$Class(Clazz.getClass($I$(14)));
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["", "alignReturn"]));
...
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(8,1).c$$S$S,["", "job_id"]), Clazz.new_($I$(8,1).c$$S$S,["http://www.w3.org/2001/XMLSchema", "string"]), Clazz.getClass(String), 1, false, false);
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "Alignment"]));
oper.setReturnClass$Class(Clazz.getClass($I$(13)));
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["", "getalignReturn"]));
oper.setStyle$org_apache_axis_enum_Style($I$(16).RPC);
oper.setUse$org_apache_axis_enum_Use($I$(17).ENCODED);
...
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(8,1).c$$S$S,["", "job_id"]), Clazz.new_($I$(8,1).c$$S$S,["http://www.w3.org/2001/XMLSchema", "string"]), Clazz.getClass(String), 1, false, false);
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "MsaResult"]));
oper.setReturnClass$Class(Clazz.getClass($I$(10)));
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["", "getResultReturn"]));
oper.setStyle$org_apache_axis_enum_Style($I$(16).RPC);
oper.setUse$org_apache_axis_enum_Use($I$(17).ENCODED);
C$._operations[2]=oper;
oper=Clazz.new_($I$(1,1));
oper.setName$S("cancel");
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(8,1).c$$S$S,["", "jobId"]), Clazz.new_($I$(8,1).c$$S$S,["http://www.w3.org/2001/XMLSchema", "string"]), Clazz.getClass(String), 1, false, false);
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["simple.objects.vamsas", "WsJobId"]));
oper.setReturnClass$Class(Clazz.getClass($I$(14)));
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["", "cancelReturn"]));
oper.setStyle$org_apache_axis_enum_Style($I$(16).RPC);
oper.setUse$org_apache_axis_enum_Use($I$(17).ENCODED);
...
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(18).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["vamsas", "align"]));
...
_call.setSOAPActionURI$S("");
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(18).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["vamsas", "getalign"]));
this.setRequestHeaders$org_apache_axis_client_Call(_call);
this.setAttachments$org_apache_axis_client_Call(_call);
...
_call.setSOAPActionURI$S("");
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(18).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["vamsas", "getResult"]));
this.setRequestHeaders$org_apache_axis_client_Call(_call);
this.setAttachments$org_apache_axis_client_Call(_call);
var _resp=_call.invoke$OA(Clazz.array(java.lang.Object, -1, [job_id]));
if (Clazz.instanceOf(_resp, "java.rmi.RemoteException")) {
...
_call.setSOAPActionURI$S("");
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(18).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(8,1).c$$S$S,["vamsas", "cancel"]));
this.setRequestHeaders$org_apache_axis_client_Call(_call);
this.setAttachments$org_apache_axis_client_Call(_call);
