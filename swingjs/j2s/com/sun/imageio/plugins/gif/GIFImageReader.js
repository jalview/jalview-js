(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.gif"),p$1={},I$=[[0,'java.util.ArrayList','java.awt.image.IndexColorModel','java.awt.image.PixelInterleavedSampleModel','java.awt.image.MultiPixelPackedSampleModel','javax.imageio.ImageTypeSpecifier','javax.imageio.ImageReadParam','com.sun.imageio.plugins.gif.GIFStreamMetadata','java.nio.ByteOrder','StringBuffer','com.sun.imageio.plugins.gif.GIFImageMetadata','com.sun.imageio.plugins.common.ReaderUtil','javax.imageio.ImageReader','java.awt.Rectangle','java.awt.Point','java.awt.image.BufferedImage']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
