...
r[i]=this.palette[off + 2];
 ...
 else this.colorModel=Clazz.new_([this.bitsPerPixel, (size|0), r, g, b],$I$(10,1).c$$I$I$BA$BA$BA);
} else if (this.bitsPerPixel == 16) {
this.numBands=3;
...
return new Boolean(Boolean.getBoolean$S("sun.imageio.plugins.bmp.disableLinkedProfiles"));
});
})()
