(function(){var P$=Clazz.newPackage("fr.orsay.lri.varna.controlers"),I$=[[0,['fr.orsay.lri.varna.controlers.ControleurScriptParser','.ArgumentType'],'java.util.Hashtable',['fr.orsay.lri.varna.controlers.ControleurScriptParser','.Function'],'fr.orsay.lri.varna.models.annotations.ChemProbAnnotation','fr.orsay.lri.varna.models.rna.ModeleColorMap','java.util.ArrayList','java.awt.Color','java.util.Vector',['fr.orsay.lri.varna.controlers.ControleurScriptParser','.NumberArgument'],['fr.orsay.lri.varna.controlers.ControleurScriptParser','.ColorArgument'],['fr.orsay.lri.varna.controlers.ControleurScriptParser','.BooleanArgument'],['fr.orsay.lri.varna.controlers.ControleurScriptParser','.StringArgument'],['fr.orsay.lri.varna.controlers.ControleurScriptParser','.ArrayArgument'],'java.io.StreamTokenizer','java.io.StringReader',['fr.orsay.lri.varna.controlers.ControleurScriptParser','.Command']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "ControleurScriptParser", function(){
Clazz.newInstance(this, arguments,0,C$);
});
C$.$classes$=[['Command',10],['Argument',1034],['NumberArgument',10],['ColorArgument',10],['BooleanArgument',10],['StringArgument',10],['ArrayArgument',10],['ArgumentType',26],['Function',26]];
...
C$.$fields$=[[]
,['S',['SCRIPT_ERROR_PREFIX'],'O',['_name2Fun','java.util.Hashtable','+_fun2Prot']]]
...
var fun=funs[i];
C$._name2Fun.put$O$O(fun.getFunName$(), fun);
C$._fun2Prot.put$O$O(fun, fun.getPrototype$());
}
}, 1);
...
vp.getRNA$().addChemProbAnnotation$fr_orsay_lri_varna_models_annotations_ChemProbAnnotation(Clazz.new_([vp.getRNA$().getBaseAt$I(from), vp.getRNA$().getBaseAt$I(to), t, intensity, c, out],$I$(4,1).c$$fr_orsay_lri_varna_models_rna_ModeleBase$fr_orsay_lri_varna_models_rna_ModeleBase$fr_orsay_lri_varna_models_annotations_ChemProbAnnotation_ChemProbAnnotationType$D$java_awt_Color$Z));
}break;
case $I$(3).ERASE_SEQ:
{
vp.eraseSequence$();
...
{
var arg=cmd._argv.get$I(0);
var vals=Clazz.new_($I$(6,1));
for (var j=0; j < arg.getSize$(); j++) {
var a=arg.getArgument$I(j);
if (a._t === $I$(1).NUMBER_TYPE ) {
var narg=a;
vals.add$O(new Integer(narg.getNumber$().intValue$()));
}}
...
case (-2):
{
result.add$O(Clazz.new_([new Double(st.nval)],$I$(9,1).c$$Number));
}break;
case (-3):
{
var c=C$.parseColor$S(st.sval);
if (c != null ) {
result.add$O(Clazz.new_($I$(10,1).c$$java_awt_Color,[c]));
} else {
var b=C$.parseBoolean$S(st.sval);
if (b != null ) {
result.add$O(Clazz.new_([(b).valueOf()],$I$(11,1).c$$Z));
} else {
result.add$O(Clazz.new_($I$(12,1).c$$S,[st.sval]));
}}}break;
case 34:
{
result.add$O(Clazz.new_($I$(12,1).c$$S,[st.sval]));
...
case 91:
{
result.add$O(Clazz.new_([C$.parseArguments$java_io_StreamTokenizer$Z(st, false)],$I$(13,1).c$$java_util_Vector));
}break;
case 40:
{
result.add$O(Clazz.new_([C$.parseArguments$java_io_StreamTokenizer$Z(st, true)],$I$(13,1).c$$java_util_Vector));
}break;
case 41:
{
...
}var st=Clazz.new_([Clazz.new_([cmd.substring$I(cut + 1)],$I$(15,1).c$$S)],$I$(14,1).c$$java_io_Reader);
...
var result=Clazz.new_($I$(16,1).c$$fr_orsay_lri_varna_controlers_ControleurScriptParser_Function$java_util_Vector,[f, argv]);
return result;
}, 1);
...
C$.initFunctions$();
var cmds=Clazz.new_($I$(8,1));
var data=cmd.split$S(";");
for (var i=0; i < data.length; i++) {
cmds.add$O(C$.parseCommand$S(data[i].trim$()));
}
return cmds;
}, 1);
...
C$._name2Fun=Clazz.new_($I$(2,1));
C$._fun2Prot=Clazz.new_($I$(2,1));
};
;
(function(){/*c*/var C$=Clazz.newClass(P$.ControleurScriptParser, "Command", function(){
...
C$.$fields$=[['O',['_f','fr.orsay.lri.varna.controlers.ControleurScriptParser.Function','_argv','java.util.Vector']]]
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.ControleurScriptParser, "Argument", function(){
Clazz.newInstance(this, arguments[0],false,C$);
});
...
C$.$fields$=[['O',['_t','fr.orsay.lri.varna.controlers.ControleurScriptParser.ArgumentType']]]
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.ControleurScriptParser, "NumberArgument", function(){
Clazz.newInstance(this, arguments[0],false,C$);
...
C$.$fields$=[['O',['_val','Number']]]

Clazz.newMeth(C$, 'c$$Number', function (val) {
;C$.superclazz.c$$fr_orsay_lri_varna_controlers_ControleurScriptParser_ArgumentType.apply(this,[$I$(1).NUMBER_TYPE]);C$.$init$.apply(this);
this._val=val;
}, 1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.ControleurScriptParser, "ColorArgument", function(){
Clazz.newInstance(this, arguments[0],false,C$);
}, ['fr.orsay.lri.varna.controlers.ControleurScriptParser','.Argument']);
...
C$.$fields$=[['O',['_val','java.awt.Color']]]

Clazz.newMeth(C$, 'c$$java_awt_Color', function (val) {
;C$.superclazz.c$$fr_orsay_lri_varna_controlers_ControleurScriptParser_ArgumentType.apply(this,[$I$(1).COLOR_TYPE]);C$.$init$.apply(this);
this._val=val;
}, 1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.ControleurScriptParser, "BooleanArgument", function(){
Clazz.newInstance(this, arguments[0],false,C$);
}, ['fr.orsay.lri.varna.controlers.ControleurScriptParser','.Argument']);
...
;C$.superclazz.c$$fr_orsay_lri_varna_controlers_ControleurScriptParser_ArgumentType.apply(this,[$I$(1).BOOLEAN_TYPE]);C$.$init$.apply(this);
this._val=val;
}, 1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.ControleurScriptParser, "StringArgument", function(){
Clazz.newInstance(this, arguments[0],false,C$);
}, ['fr.orsay.lri.varna.controlers.ControleurScriptParser','.Argument']);
...
;C$.superclazz.c$$fr_orsay_lri_varna_controlers_ControleurScriptParser_ArgumentType.apply(this,[$I$(1).STRING_TYPE]);C$.$init$.apply(this);
this._val=val;
}, 1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.ControleurScriptParser, "ArrayArgument", function(){
Clazz.newInstance(this, arguments[0],false,C$);
}, ['fr.orsay.lri.varna.controlers.ControleurScriptParser','.Argument']);
...
C$.$fields$=[['O',['_val','java.util.Vector']]]

Clazz.newMeth(C$, 'c$$java_util_Vector', function (val) {
;C$.superclazz.c$$fr_orsay_lri_varna_controlers_ControleurScriptParser_ArgumentType.apply(this,[$I$(1).ARRAY_TYPE]);C$.$init$.apply(this);
this._val=val;
}, 1);
...
;
(function(){/*e*/var C$=Clazz.newClass(P$.ControleurScriptParser, "ArgumentType", function(){
Clazz.newInstance(this, arguments[0],false,C$);
}, 'Enum');
...
;
(function(){/*e*/var C$=Clazz.newClass(P$.ControleurScriptParser, "Function", function(){
Clazz.newInstance(this, arguments[0],false,C$);
}, 'Enum');
...
C$.$fields$=[['S',['_funName'],'O',['_args','fr.orsay.lri.varna.controlers.ControleurScriptParser.ArgumentType[]']]]
