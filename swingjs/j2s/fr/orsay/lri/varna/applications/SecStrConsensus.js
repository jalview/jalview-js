(function(){var P$=Clazz.newPackage("fr.orsay.lri.varna.applications"),I$=[[0,'java.util.ArrayList','java.util.Hashtable',['fr.orsay.lri.varna.applications.SecStrConsensus','.SimpleBP']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "SecStrConsensus", function(){
Clazz.newInstance(this, arguments,0,C$);
});
C$.$classes$=[['SimpleBP',8]];
...
}h.put$O$O(new Integer(j), new Double((h.get$O(new Integer(i))).valueOf() + 1.0));
}
}
