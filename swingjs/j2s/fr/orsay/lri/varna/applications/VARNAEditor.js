...
this._sideList.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(13,1).c$$I$I,[100, 0]));
this._sideList.addListSelectionListener$javax_swing_event_ListSelectionListener(((P$.VARNAEditor$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "VARNAEditor$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'javax.swing.event.ListSelectionListener', 1);
...
var map=$I$(14,"DefaultOutermostMapping$I$I",[this.b$['fr.orsay.lri.varna.applications.VARNAEditor']._vp.getRNA$().getSize$(), sel.rna.getSize$()]);
...
this._rnaList=Clazz.new_($I$(15,1).c$$javax_swing_DefaultListModel$javax_swing_JList,[this, null, dlm, this._sideList]);
var _RNA1=Clazz.new_($I$(4,1).c$$S,["User defined 1"]);
var _RNA2=Clazz.new_($I$(4,1).c$$S,["User defined 2"]);
try {
this._vp=Clazz.new_($I$(16,1).c$$S$S,["0", "."]);
...
this._vp.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(13,1).c$$I$I,[400, 400]));
...
var listScroller=Clazz.new_($I$(17,1).c$$java_awt_Component,[this._sideList]);
listScroller.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(13,1).c$$I$I,[150, 0]));
...
this._seqLabel.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(13,1).c$$I$I,[marginTools, 15]));
...
(function(){/*a*/var C$=Clazz.newClass(P$, "VARNAEditor$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
ops.setLayout$java_awt_LayoutManager(Clazz.new_($I$(20,1).c$$I$I,[1, 2]));
ops.add$java_awt_Component(this._deleteButton);
ops.add$java_awt_Component(this._duplicateButton);
var j=Clazz.new_($I$(6,1).c$$S$I,["Structures", 0]);
this._listPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(19,1)));
...
var split=Clazz.new_($I$(21,1).c$$I$Z$java_awt_Component$java_awt_Component,[1, true, this._listPanel, this._vp]);
this.getContentPane$().setLayout$java_awt_LayoutManager(Clazz.new_($I$(19,1)));
...
var dt=Clazz.new_($I$(22,1).c$$java_awt_Component$java_awt_dnd_DropTargetListener,[this._vp, this]);
this._vp.addRNAListener$fr_orsay_lri_varna_interfaces_InterfaceVARNARNAListener(((P$.VARNAEditor$3||
(function(){/*a*/var C$=Clazz.newClass(P$, "VARNAEditor$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'fr.orsay.lri.varna.interfaces.InterfaceVARNARNAListener', 1);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "VARNAEditor$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'fr.orsay.lri.varna.interfaces.InterfaceVARNASelectionListener', 1);
...
try {
this.b$['fr.orsay.lri.varna.applications.VARNAEditor']._hoverHighlightSeq=this.b$['fr.orsay.lri.varna.applications.VARNAEditor']._seq.getHighlighter$().addHighlight$I$I$javax_swing_text_Highlighter_HighlightPainter(newBase.getIndex$(), newBase.getIndex$() + 1, Clazz.new_([$I$(9).green],$I$(23,1).c$$java_awt_Color));
this.b$['fr.orsay.lri.varna.applications.VARNAEditor']._hoverHighlightStr=this.b$['fr.orsay.lri.varna.applications.VARNAEditor']._str.getHighlighter$().addHighlight$I$I$javax_swing_text_Highlighter_HighlightPainter(newBase.getIndex$(), newBase.getIndex$() + 1, Clazz.new_([$I$(9).green],$I$(23,1).c$$java_awt_Color));
} catch (e) {
...
try {
this.b$['fr.orsay.lri.varna.applications.VARNAEditor']._selectionHighlightSeq.add$O(this.b$['fr.orsay.lri.varna.applications.VARNAEditor']._seq.getHighlighter$().addHighlight$I$I$javax_swing_text_Highlighter_HighlightPainter(m.getIndex$(), m.getIndex$() + 1, Clazz.new_([$I$(9).orange],$I$(23,1).c$$java_awt_Color)));
this.b$['fr.orsay.lri.varna.applications.VARNAEditor']._selectionHighlightStr.add$O(this.b$['fr.orsay.lri.varna.applications.VARNAEditor']._str.getHighlighter$().addHighlight$I$I$javax_swing_text_Highlighter_HighlightPainter(m.getIndex$(), m.getIndex$() + 1, Clazz.new_([$I$(9).orange],$I$(23,1).c$$java_awt_Color)));
} catch (e) {
if (Clazz.exceptionOf(e,"javax.swing.text.BadLocationException")){
e.printStackTrace$();
} else {
...
var vp=c;
try {
var bck=$I$(16).importSession$O(o);
...
var rnas=$I$(24).loadSecStr$java_io_File(o);
if (rnas.isEmpty$()) {
throw Clazz.new_($I$(25,1).c$$S,["No RNA could be parsed from that source."]);
}var id=1;
for (var r, $r = rnas.iterator$(); $r.hasNext$()&&((r=($r.next$())),1);) {
r.drawRNA$fr_orsay_lri_varna_models_VARNAConfig(vp.getConfig$());
var name=r.getName$();
if (name.equals$O("")) {
name=path.substring$I(path.lastIndexOf$I($I$(26).separatorChar) + 1);
}if (rnas.size$() > 1) {
name += " - Molecule# " + id++;
...
var newName=$I$(27,"showInputDialog$java_awt_Component$O$S$I$javax_swing_Icon$OA$O",[this, "Specify a new name for this RNA", "Rename RNA", 3, null, null, item.toString()]);
if (newName != null ) {
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.VARNAEditor, "BackupHolder", function(){
