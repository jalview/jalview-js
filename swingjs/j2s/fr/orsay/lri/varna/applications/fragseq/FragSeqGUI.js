...
this._sideList=null;
this._toolbar=Clazz.new_($I$(9,1));
this._choice=Clazz.new_($I$(10,1));
this.index=0;
this._varnaPanels=Clazz.new_($I$(11,1));
},1);

C$.$fields$=[['Z',['redrawOnSlide'],'I',['dividerWidth','index'],'S',['_INIFilename'],'O',['_varnaUpperPanels','javax.swing.JPanel','+_varnaLowerPanels','+_listPanel','+_infoPanel','_sideList','fr.orsay.lri.varna.applications.fragseq.FragSeqTree','_treeModel','fr.orsay.lri.varna.applications.fragseq.FragSeqTreeModel','_toolbar','javax.swing.JToolBar','_choice','javax.swing.JFileChooser','_listScroller','javax.swing.JScrollPane','_selectedElems','javax.swing.JList','_splitLeft','javax.swing.JSplitPane','+_splitRight','+_splitVARNA','_lnf','javax.swing.JComboBox','_varnaPanels','java.util.ArrayList']]]
...
this._selectedElems=Clazz.new_($I$(13,1));
this._lnf=Clazz.new_([$I$(15).getInstalledLookAndFeels$()],$I$(14,1).c$$OA);
this._treeModel=Clazz.new_($I$(16,1));
this._treeModel.addTreeModelListener$javax_swing_event_TreeModelListener(this);
this._sideList=Clazz.new_($I$(17,1).c$$fr_orsay_lri_varna_applications_fragseq_FragSeqTreeModel,[this._treeModel]);
...
var renderer=Clazz.new_($I$(18,1).c$$javax_swing_JTree$fr_orsay_lri_varna_applications_fragseq_FragSeqTreeModel,[this._sideList, this._treeModel]);
this._sideList.setCellRenderer$javax_swing_tree_TreeCellRenderer(renderer);
this._sideList.setCellEditor$javax_swing_tree_TreeCellEditor(Clazz.new_($I$(19,1).c$$javax_swing_JTree$javax_swing_tree_DefaultTreeCellRenderer$fr_orsay_lri_varna_applications_fragseq_FragSeqTreeModel,[this._sideList, renderer, this._treeModel]));
...
(function(){/*a*/var C$=Clazz.newClass(P$, "FragSeqGUI$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('javax.swing.TransferHandler'), null, 1);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "FragSeqGUI$1$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.datatransfer.Transferable', 1);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "FragSeqGUI$1$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.datatransfer.Transferable', 1);
...
), Clazz.new_($I$(23,1).c$$S,[this, null, null],P$.FragSeqGUI$1)));
var refreshAllFoldersButton=Clazz.new_($I$(24,1).c$$S,["Refresh All"]);
...
var watchFolderButton=Clazz.new_($I$(24,1).c$$S,["Add folder"]);
...
this._varnaUpperPanels.setLayout$java_awt_LayoutManager(Clazz.new_($I$(26,1)));
this._varnaUpperPanels.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(2,1).c$$I$I,[800, 600]));
this._varnaLowerPanels.setLayout$java_awt_LayoutManager(Clazz.new_($I$(26,1)));
this._varnaLowerPanels.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(2,1).c$$I$I,[800, 0]));
var sortFileName=Clazz.new_($I$(27,1).c$$S,["Directory"]);
...
var sortID=Clazz.new_($I$(27,1).c$$S,["ID"]);
...
this._splitVARNA=Clazz.new_($I$(30,1).c$$I$Z$java_awt_Component$java_awt_Component,[0, this.redrawOnSlide, this._varnaUpperPanels, this._varnaLowerPanels]);
this._splitVARNA.setDividerSize$I(this.dividerWidth);
this._splitVARNA.setResizeWeight$D(1.0);
this._splitLeft=Clazz.new_($I$(30,1).c$$I$Z$java_awt_Component$java_awt_Component,[1, this.redrawOnSlide, sidePanel, this._splitVARNA]);
this._splitLeft.setResizeWeight$D(0.1);
this._splitLeft.setDividerSize$I(this.dividerWidth);
this._splitRight=Clazz.new_($I$(30,1).c$$I$Z$java_awt_Component$java_awt_Component,[1, this.redrawOnSlide, this._splitLeft, this._infoPanel]);
this._splitRight.setResizeWeight$D(0.85);
this._splitRight.setDividerSize$I(this.dividerWidth);
this._infoPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(26,1).c$$I$I,[0, 1]));
...
var vh=Clazz.new_($I$(31,1).c$$java_awt_dnd_DropTargetListener,[this, null, this]);
...
var tp=Clazz.new_([childNode.getPath$()],$I$(32,1).c$$OA);
...
vh.vp.toXML$S(path);
try {
var b=$I$(1).importSession$O(path);
...
;
(function(){/*e*/var C$=Clazz.newClass(P$.FragSeqGUI, "Commands", function(){
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.FragSeqGUI, "VARNAHolder", function(){
...
C$.$fields$=[['O',['vp','fr.orsay.lri.varna.VARNAPanel','_m','fr.orsay.lri.varna.applications.fragseq.FragSeqRNASecStrModel','_data','fr.orsay.lri.varna.applications.fragseq.FragSeqAnnotationDataModel','_infoPanel','javax.swing.JPanel','_infoTxt','javax.swing.JTextPane']]]
...
(function(){/*a*/var C$=Clazz.newClass(P$, "FragSeqGUI$VARNAHolder$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.FocusListener', 1);
