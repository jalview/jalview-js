...
/*c*/var C$=Clazz.newClass(P$, "VARNASessionParser", null, 'org.xml.sax.helpers.DefaultHandler');
...
this.f=null;
this.config=null;
this._context=Clazz.new_($I$(1,1));
},1);

C$.$fields$=[['O',['_buffer','StringBuffer','mbn','fr.orsay.lri.varna.models.rna.ModeleBaseNucleotide','mbc','fr.orsay.lri.varna.models.rna.ModeleBasesComparison','mbp','fr.orsay.lri.varna.models.rna.ModeleBP','mbps','fr.orsay.lri.varna.models.rna.ModeleBPStyle','msb','fr.orsay.lri.varna.models.rna.ModelBaseStyle','ta','fr.orsay.lri.varna.models.annotations.TextAnnotation','backbone','fr.orsay.lri.varna.models.rna.ModeleBackbone','hra','fr.orsay.lri.varna.models.annotations.HighlightRegionAnnotation','rna','fr.orsay.lri.varna.models.rna.RNA','f','java.awt.Font','config','fr.orsay.lri.varna.models.VARNAConfig','_context','java.util.TreeSet']]]
...
var url=null;
try {
url=Clazz.new_($I$(2,1).c$$S,[path]);
var connexion=url.openConnection$();
connexion.setUseCaches$Z(false);
var r=connexion.getInputStream$();
var inr=Clazz.new_($I$(3,1).c$$java_io_InputStream,[r]);
return Clazz.new_($I$(4,1).c$$java_io_Reader,[inr]);
} catch (e) {
...
return Clazz.new_([Clazz.new_($I$(5,1).c$$S,[""])],$I$(4,1).c$$java_io_Reader);
});
...
this.backbone=Clazz.new_($I$(9,1));
...
this.backbone.addElement$fr_orsay_lri_varna_models_rna_ModeleBackboneElement(Clazz.new_($I$(10,1).c$$I$java_awt_Color,[index, c]));
} else {
this.backbone.addElement$fr_orsay_lri_varna_models_rna_ModeleBackboneElement(Clazz.new_($I$(10,1).c$$I$fr_orsay_lri_varna_models_rna_ModeleBackboneElement_BackboneType,[index, type]));
}}} else if (qName.equals$O($I$(9).XML_ELEMENT_NAME)) {
this.backbone=Clazz.new_($I$(9,1));
} else if (qName.equals$O($I$(14).XML_ELEMENT_NAME)) {
if (this.rna != null ) {
this.mbn=Clazz.new_([this.rna.getSize$()],$I$(14,1).c$$I);
...
this._buffer=Clazz.new_($I$(18,1));
...
if (this.rna != null ) {
this.mbc=Clazz.new_([this.rna.getSize$()],$I$(19,1).c$$I);
...
this.mbp=Clazz.new_([this.rna.getBaseAt$I(i5), this.rna.getBaseAt$I(i3), e5, e3, s],$I$(20,1).c$$fr_orsay_lri_varna_models_rna_ModeleBase$fr_orsay_lri_varna_models_rna_ModeleBase$fr_orsay_lri_varna_models_rna_ModeleBP_Edge$fr_orsay_lri_varna_models_rna_ModeleBP_Edge$fr_orsay_lri_varna_models_rna_ModeleBP_Stericity);
...
var cpa=Clazz.new_([this.rna.getBaseAt$I(i5), this.rna.getBaseAt$I(i3)],$I$(23,1).c$$fr_orsay_lri_varna_models_rna_ModeleBase$fr_orsay_lri_varna_models_rna_ModeleBase);
