...
/*c*/var C$=Clazz.newClass(P$, "ExceptionEdgeEndpointAlreadyConnected", null, 'fr.orsay.lri.varna.exceptions.ExceptionInvalidRNATemplate');
...
;C$.superclazz.c$$S.apply(this,["Edge endpoint is already connected"]);C$.$init$.apply(this);
}, 1);
})();
