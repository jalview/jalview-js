...
var benchmark=Clazz.new_($I$(7,1).c$$fr_orsay_lri_varna_models_rna_RNA,[rna]);
...
throw Clazz.new_($I$(8,1).c$$S,["templates and rnas list size differ"]);
}var outbuf=Clazz.new_([Clazz.new_($I$(10,1).c$$java_io_File,[outfile])],$I$(9,1).c$$java_io_Writer);
...
var templatesDir=Clazz.new_($I$(11,1).c$$S,["templates"]);
var root=Clazz.new_($I$(11,1).c$$java_io_File$S,[templatesDir, "examples"]);
var outfile=Clazz.new_([Clazz.new_($I$(11,1).c$$java_io_File$S,[templatesDir, "benchmark"]), "benchmark.txt"],$I$(11,1).c$$java_io_File$S);
var seqlist=Clazz.array(String, -1, ["RNase P E Coli.ct", "RNase P Synechocystis-PCC6803.ct", "RNase P M Musculus.ct"]);
var templates=Clazz.new_($I$(12,1));
var rnas=Clazz.new_($I$(12,1));
for (var seq, $seq = 0, $$seq = seqlist; $seq<$$seq.length&&((seq=($$seq[$seq])),1);$seq++) {
templates.add$O(Clazz.new_($I$(11,1).c$$java_io_File$S,[root, "RNase P E Coli.xml"]));
rnas.add$O(Clazz.new_($I$(11,1).c$$java_io_File$S,[root, seq]));
}
...
var buf=Clazz.new_([Clazz.new_($I$(14,1).c$$java_io_File,[file])],$I$(13,1).c$$java_io_Reader);
...
sequences.set$I$O(sequences.size$() - 1, sequences.get$I(sequences.size$() - 1) + line);
}}line=buf.readLine$();
}
buf.close$();
}, 1);
...
var seqdir=Clazz.new_($I$(11,1).c$$java_io_File$S,[rootdir, "sequences"]);
var templateFile=Clazz.new_($I$(11,1).c$$java_io_File$S,[rootdir, "template.xml"]);
...
var outfile=Clazz.new_($I$(11,1).c$$java_io_File$S,[rootdir, "benchmark.txt"]);
this.runBenchmark$java_util_List$java_util_List$java_io_File(templates, rnas, outfile);
});
...
Clazz.new_(C$).benchmarkAllDir$java_io_File(Clazz.new_($I$(11,1).c$$java_io_File$S,[templatesDir, arg]));
}
}, 1);
...
return Clazz.new_([C$.removeExt$S(path.getPath$())],$I$(11,1).c$$S);
}, 1);
