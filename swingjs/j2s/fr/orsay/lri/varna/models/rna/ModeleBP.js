...
/*c*/var C$=Clazz.newClass(P$, "ModeleBP", function(){
Clazz.newInstance(this, arguments,0,C$);
}, null, ['java.io.Serializable', 'Comparable']);
C$.$classes$=[['Edge',25],['Stericity',25]];
...
C$.$fields$=[['O',['_partner5','fr.orsay.lri.varna.models.rna.ModeleBase','_edge5','fr.orsay.lri.varna.models.rna.ModeleBP.Edge','_partner3','fr.orsay.lri.varna.models.rna.ModeleBase','_edge3','fr.orsay.lri.varna.models.rna.ModeleBP.Edge','_stericity','fr.orsay.lri.varna.models.rna.ModeleBP.Stericity','_style','fr.orsay.lri.varna.models.rna.ModeleBPStyle']]
,['S',['XML_ELEMENT_NAME','XML_VAR_PARTNER5_NAME','XML_VAR_EDGE5_NAME','XML_VAR_PARTNER3_NAME','XML_VAR_EDGE3_NAME','XML_VAR_STERICITY_NAME','XML_VAR_SEC_STR_NAME']]]
...
throw Clazz.new_([e.getMessage$(), "Bad inner color Syntax:" + valuesArray.get$I(i)],$I$(8,1).c$$S$S);
} else {
throw e;
}
}
...
if (Clazz.exceptionOf(e,"NumberFormatException")){
throw Clazz.new_([e.getMessage$(), "Bad value for bp thickness:" + valuesArray.get$I(i)],$I$(8,1).c$$S$S);
} else {
throw e;
}
}
...
} else throw Clazz.new_(["Bad value for edge:" + valuesArray.get$I(i)],$I$(8,1).c$$S);
...
} else throw Clazz.new_(["Bad value for stericity:" + valuesArray.get$I(i)],$I$(8,1).c$$S);
...
Clazz.newMeth(C$, ['compareTo$fr_orsay_lri_varna_models_rna_ModeleBP','compareTo$O'], function (mb) {
...
;
(function(){/*e*/var C$=Clazz.newClass(P$.ModeleBP, "Edge", function(){
...
;
(function(){/*e*/var C$=Clazz.newClass(P$.ModeleBP, "Stericity", function(){
Clazz.newInstance(this, arguments[0],false,C$);
}, 'Enum');
