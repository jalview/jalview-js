(function(){var P$=Clazz.newPackage("fr.orsay.lri.varna.models.geom"),p$1={},I$=[[0,['java.awt.geom.Point2D','.Double']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CubicBezierCurve");
...
C$.$fields$=[['I',['n'],'O',['P0','java.awt.geom.Point2D.Double','+P1','+P2','+P3','points','java.awt.geom.Point2D.Double[]','lengths','double[]','unitVectors','java.awt.geom.Point2D.Double[]']]]
