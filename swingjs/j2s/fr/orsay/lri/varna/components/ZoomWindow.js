(function(){var P$=Clazz.newPackage("fr.orsay.lri.varna.components"),I$=[[0,'java.awt.image.BufferedImage','java.awt.RenderingHints','fr.orsay.lri.varna.models.export.SwingGraphics',['java.awt.geom.Rectangle2D','.Double'],['java.awt.geom.Point2D','.Double'],'java.awt.Color','java.awt.BasicStroke','Thread']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "ZoomWindow", null, 'javax.swing.JPanel', ['java.awt.image.ImageObserver', 'Runnable', 'java.awt.event.MouseMotionListener', 'java.awt.event.MouseListener']);
...
C$.$fields$=[['O',['_vp','fr.orsay.lri.varna.VARNAPanel','_bi','java.awt.image.BufferedImage','rnaRect','java.awt.geom.Rectangle2D.Double']]]
...
this._bi=Clazz.new_([this.getWidth$(), this.getHeight$(), 6],$I$(1,1).c$$I$I$I);
...
var g2D=Clazz.new_($I$(3,1).c$$java_awt_Graphics2D,[g2]);
this.rnaRect=this._vp.renderRNA$fr_orsay_lri_varna_models_export_VueVARNAGraphics$java_awt_geom_Rectangle2D_Double$Z$Z(g2D, Clazz.new_([0, 0, this.getWidth$(), this.getHeight$()],$I$(4,1).c$$D$D$D$D), false, true);
var p1=this._vp.panelToLogicPoint$java_awt_geom_Point2D_Double(Clazz.new_($I$(5,1).c$$D$D,[0.0, 0.0]));
var p2=this._vp.panelToLogicPoint$java_awt_geom_Point2D_Double(Clazz.new_([this._vp.getWidth$(), this._vp.getHeight$()],$I$(5,1).c$$D$D));
var w=p2.x - p1.x;
var h=p2.y - p1.y;
var rnaBox=this._vp.getRNA$().getBBox$();
var ratiox=w / rnaBox.width;
var ratioy=h / rnaBox.height;
var rvisible=Clazz.new_([this.rnaRect.x + this.rnaRect.width * (p1.x - rnaBox.x) / rnaBox.width, this.rnaRect.y + this.rnaRect.height * (p1.y - rnaBox.y) / rnaBox.height, ratiox * this.rnaRect.width, ratioy * this.rnaRect.height],$I$(4,1).c$$D$D$D$D);
var shade=Clazz.new_($I$(6,1).c$$F$F$F$F,[0.9, 0.9, 0.9, 0.4]);
g2.setStroke$java_awt_Stroke(Clazz.new_($I$(7,1).c$$F,[1.0]));
...
g2.setColor$java_awt_Color(Clazz.new_($I$(6,1).c$$F$F$F$F,[0.7, 0.7, 0.7, 0.3]));
