(function(){var P$=Clazz.newPackage("jalview.ws.dbsources"),I$=[[0,'java.io.File','StringBuffer','java.io.BufferedReader','java.io.FileReader']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
