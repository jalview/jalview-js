(function(){var P$=Clazz.newPackage("jalview.ws.dbsources"),I$=[[0,'jalview.datamodel.DBRefSource']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
