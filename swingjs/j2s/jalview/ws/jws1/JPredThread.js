...
$I$(1,"info$S",[this.WsUrl + " Job Id '" + job.getJobId$() + "'" ]);
}} else {
...
$I$(1).warn$S$Throwable("Server Exception", e);
} else {
...
$I$(1,"debug$S$Throwable",["Failed Submission of job " + j.getJobnum$(), e]);
...
$I$(1).error$S$Throwable("Unexpected exception when processing results for " + this.altitle, ex);
...
try {
$I$(1).debug$S("Parsing output of job " + jn);
jobres=j.getResultSet$();
$I$(1).debug$S("Finished parsing output.");
...
if (Clazz.exceptionOf(e,"Exception")){
$I$(1).error$S$Throwable("JNet Client: JPred Annotation Parse Error", e);
this.wsInfo.setStatus$I$I(j.getJobnum$(), 4);
...
$I$(1).info$S("Append results onto existing alignment.");
}}}});
...
$I$(1).debug$S("Parsing output from JNet job.");
...
$I$(1).debug$S("Got prediction profile.");
if ((this.msa != null ) && (result.getAligfile$() != null ) ) {
$I$(1).debug$S("Getting associated alignment.");
var format=Clazz.new_($I$(4,1)).identify$S$jalview_io_DataSourceType(result.getAligfile$(), $I$(3).PASTE);
if (format != null ) {
var sqs;
if (this.predMap != null ) {
var alandcolsel=this.b$['jalview.ws.jws1.JPredThread'].input.getAlignmentAndHiddenColumns$C(this.b$['jalview.ws.AWSThread'].getGapChar$.apply(this.b$['jalview.ws.AWSThread'], []));
sqs=alandcolsel[0];
...
if (this.b$['jalview.ws.jws1.JPredThread'].currentView.getDataset$() != null ) {
al.setDataset$jalview_datamodel_AlignmentI(this.b$['jalview.ws.jws1.JPredThread'].currentView.getDataset$());
} else {
...
var sqs=this.b$['jalview.ws.jws1.JPredThread'].input.getAlignmentAndHiddenColumns$C(gc)[0];
...
}Clazz.new_([$I$(9).getString$S("label.remove_gaps"), Clazz.array($I$(7), -1, [sqs[this.msaIndex]]), this.b$['jalview.ws.jws1.JPredThread'].currentView],$I$(12,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI);
...
if (this.predMap != null ) {
alhidden=al.propagateInsertions$jalview_datamodel_SequenceI$jalview_datamodel_AlignmentView(profileseq, this.b$['jalview.ws.jws1.JPredThread'].input);
