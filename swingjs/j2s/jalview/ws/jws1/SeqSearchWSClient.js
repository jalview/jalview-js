...
$I$(11,"warn$S$Throwable",["Database list request failed, so disabling SeqSearch Service client " + sh.getName$() + " at " + sh.getEndpointURL$() , e]);
return;
} else {
throw e;
}
...
), Clazz.new_(P$.SeqSearchWSClient$2.$init$,[this, {af:af,searchdb:searchdb,sh:sh}])));
}
