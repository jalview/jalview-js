...
var aln=Clazz.array($I$(2), [msf.length]);
for (var i=0, j=msf.length; i < j; i++) {
aln[i]=Clazz.new_($I$(8,1).c$$jalview_datamodel_SequenceI,[msf[i]]);
}
var SequenceInfo=$I$(3).uniquify$jalview_datamodel_SequenceIA$Z(aln, true);
var server=p$1.locateWebService.apply(this, []);
if (server == null ) {
...
var wsInfo=Clazz.new_($I$(9,1).c$$S$S$Z,[this.WebServiceJobTitle, this.WebServiceReference, true]);
return wsInfo;
}, p$1);

Clazz.newMeth(C$, 'locateWebService', function () {
var loc=Clazz.new_($I$(10,1));
var server=null;
try {
server=loc.getjpred$java_net_URL(Clazz.new_($I$(11,1).c$$S,[this.WsURL]));
...
var method=Clazz.new_([sh.getName$()],$I$(14,1).c$$S);
...
Clazz.new_([this.$finals$.sh, this.$finals$.af.getTitle$(), false, msa, this.$finals$.af, true],$I$(15,1).c$$ext_vamsas_ServiceHandle$S$Z$jalview_datamodel_AlignmentView$jalview_gui_AlignFrame$Z);
} else {
if (msa.getSequences$().length > 1) {
Clazz.new_([this.$finals$.sh, this.$finals$.af.getTitle$(), true, msa, this.$finals$.af, true],$I$(15,1).c$$ext_vamsas_ServiceHandle$S$Z$jalview_datamodel_AlignmentView$jalview_gui_AlignFrame$Z);
}}});
})()
), Clazz.new_(P$.JPredClient$1.$init$,[this, {sh:sh,af:af}])));
