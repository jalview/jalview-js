(function(){var P$=Clazz.newPackage("jalview.ws.rest"),I$=[[0,'java.util.ArrayList','java.util.regex.Pattern','java.nio.charset.Charset','org.apache.http.entity.mime.content.StringBody','java.util.Locale','jalview.ws.params.simple.IntegerParameter','StringBuffer','jalview.ws.params.simple.Option',['jalview.ws.rest.InputType','.molType']]],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
valid=false;
warnings.append$S("Invalid value for parameter " + mtch.group$I(1).toLowerCase$java_util_Locale($I$(5).ROOT) + " '" + mtch.group$I(2) + "' (expected an integer)\n" );
} else {
throw x;
}
}
...
opts.add$O(Clazz.new_($I$(6,1).c$$S$S$Z$I$I$I$I,["min", "Minimum number of data of this type", true, 1, this.min, 0, -1]));
opts.add$O(Clazz.new_($I$(6,1).c$$S$S$Z$I$I$I$I,["max", "Maximum number of data of this type", false, 0, this.max, 0, -1]));
return opts;
});
...
var warnings;
if (!this.configureFromURLtokenString$java_util_List$StringBuffer(urltoks, warnings=Clazz.new_($I$(7,1)))) {
...
return Clazz.new_([name, descr, req, defType == null  ? "" : defType.toString(), curType == null  ? "" : curType.toString(), $I$(9).toStringValues$(), null],$I$(8,1).c$$S$S$Z$S$S$java_util_Collection$java_net_URL);
});
