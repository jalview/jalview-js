(function(){var P$=Clazz.newPackage("jalview.ws.jws2.dm"),p$1={},I$=[[0,'java.util.ArrayList','Error','jalview.util.MessageManager','jalview.ws.jws2.JabaParamStore']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
