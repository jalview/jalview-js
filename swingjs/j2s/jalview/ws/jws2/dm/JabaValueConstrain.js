(function(){var P$=Clazz.newPackage("jalview.ws.jws2.dm"),I$=[[0,['compbio.metadata.ValueConstrain','.Type'],['jalview.ws.params.ValueConstrainI','.ValueType'],'Error','jalview.util.MessageManager']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
