...
}} while (stats != null  && Long.$gt(rpos,cpos ) );
...
$I$(8,"debug$S",["Updating result annotation from Job " + this.rslt + " at " + this.service.getUri$() ]);
...
if (this.ap != null ) {
this.calcMan.workerComplete$jalview_api_AlignCalcWorkerI(this);
if (this.guiProgress != null  && Long.$ne(progressId,-1 ) ) {
