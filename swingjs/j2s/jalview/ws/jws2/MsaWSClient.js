(function(){var P$=Clazz.newPackage("jalview.ws.jws2"),p$1={},I$=[[0,'jalview.gui.JvOptionPane','jalview.gui.Desktop','jalview.util.MessageManager','jalview.ws.jws2.MsaWSThread','javax.swing.JMenu','javax.swing.JMenuItem','jalview.ws.jws2.MsaWSClient','javax.swing.ToolTipManager','java.awt.event.MouseAdapter','jalview.gui.JvSwingUtils']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
msawsmenu=Clazz.new_($I$(5,1).c$$S,[svcname]);
...
if (submitGaps == true ) {
action="Realign ";
msawsmenu=Clazz.new_([$I$(3,"formatMessage$S$SA",["label.realign_with_params", Clazz.array(String, -1, [svcname])])],$I$(5,1).c$$S);
msawsmenu.setToolTipText$S($I$(3).getString$S("label.align_sequences_to_existing_alignment"));
rmsawsmenu.add$javax_swing_JMenuItem(msawsmenu);
}var withGaps=submitGaps;
var method=Clazz.new_([$I$(3,"formatMessage$S$SA",["label.calcname_with_default_settings", Clazz.array(String, -1, [calcName])])],$I$(6,1).c$$S);
...
if (msa != null ) {
Clazz.new_([this.$finals$.service, this.$finals$.alignFrame.getTitle$(), msa, this.$finals$.withGaps, true, this.$finals$.alignFrame.getViewport$().getAlignment$().getDataset$(), this.$finals$.alignFrame],$I$(7,1).c$$jalview_ws_jws2_jabaws2_Jws2Instance$S$jalview_datamodel_AlignmentView$Z$Z$jalview_datamodel_AlignmentI$jalview_gui_AlignFrame);
}});
})()
), Clazz.new_(P$.MsaWSClient$1.$init$,[this, {alignFrame:alignFrame,withGaps:withGaps,service:service}])));
msawsmenu.add$javax_swing_JMenuItem(method);
if (hasparams) {
method=Clazz.new_([$I$(3).getString$S("label.edit_settings_and_run")],$I$(6,1).c$$S);
...
var msa=this.$finals$.alignFrame.gatherSequencesForAlignment$();
if (msa != null ) {
Clazz.new_([this.$finals$.service, null, null, true, this.$finals$.alignFrame.getTitle$(), msa, this.$finals$.withGaps, true, this.$finals$.alignFrame.getViewport$().getAlignment$().getDataset$(), this.$finals$.alignFrame],$I$(7,1).c$$jalview_ws_jws2_jabaws2_Jws2Instance$jalview_ws_params_WsParamSetI$java_util_List$Z$S$jalview_datamodel_AlignmentView$Z$Z$jalview_datamodel_AlignmentI$jalview_gui_AlignFrame);
}});
})()
), Clazz.new_(P$.MsaWSClient$2.$init$,[this, {alignFrame:alignFrame,withGaps:withGaps,service:service}])));
msawsmenu.add$javax_swing_JMenuItem(method);
var presets=service.getParamStore$().getPresets$();
if (presets != null  && presets.size$() > 0 ) {
var presetlist=Clazz.new_([$I$(3,"formatMessage$S$SA",["label.run_with_preset_params", Clazz.array(String, -1, [calcName])])],$I$(5,1).c$$S);
...
var methodR=Clazz.new_([preset.getName$()],$I$(6,1).c$$S);
...
), Clazz.new_($I$(9,1),[this, {showToolTipFor:showToolTipFor}],P$.MsaWSClient$3)));
...
var msa=this.$finals$.alignFrame.gatherSequencesForAlignment$();
if (msa != null ) {
var msac=Clazz.new_([this.$finals$.service, this.$finals$.preset, this.$finals$.alignFrame.getTitle$(), msa, false, true, this.$finals$.alignFrame.getViewport$().getAlignment$().getDataset$(), this.$finals$.alignFrame],$I$(7,1).c$$jalview_ws_jws2_jabaws2_Jws2Instance$jalview_ws_params_WsParamSetI$S$jalview_datamodel_AlignmentView$Z$Z$jalview_datamodel_AlignmentI$jalview_gui_AlignFrame);
}});
})()
