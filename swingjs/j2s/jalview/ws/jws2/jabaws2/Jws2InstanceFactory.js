(function(){var P$=Clazz.newPackage("jalview.ws.jws2.jabaws2"),I$=[[0,'java.util.HashMap','compbio.ws.client.Services','jalview.ws.jws2.AAConClient','jalview.ws.jws2.RNAalifoldClient','java.util.HashSet','jalview.ws.jws2.jabaws2.Jws2Instance']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
