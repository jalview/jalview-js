(function(){var P$=Clazz.newPackage("jalview.ws.jws2"),I$=[[0,'java.util.ArrayList','compbio.metadata.Option','java.util.HashSet','compbio.metadata.ValueConstrain','Error','jalview.util.MessageManager','compbio.metadata.Parameter']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
