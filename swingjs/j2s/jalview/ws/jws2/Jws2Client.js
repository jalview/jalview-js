(function(){var P$=Clazz.newPackage("jalview.ws.jws2"),I$=[[0,'Error','jalview.util.MessageManager','jalview.ws.jws2.JabaParamStore','jalview.gui.Desktop','jalview.gui.WsJobParameters','jalview.gui.WebserviceInfo','javax.swing.JCheckBoxMenuItem','jalview.gui.JvSwingUtils','jalview.ws.jws2.Jws2Client','javax.swing.JMenuItem','jalview.ws.jws2.SequenceAnnotationWSClient','jalview.bin.Console','compbio.ws.client.Services','jalview.ws.jws2.Jws2Discoverer','jalview.ws.jws2.dm.AAConSettings']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (prset == null ) {
this.paramset=$I$(3,"getJabafromJwsArgs$java_util_List",[jobParams.getJobParams$()]);
this.preset=null;
} else {
this.preset=prset;
this.paramset=null;
...
), Clazz.new_(P$.Jws2Client$3.$init$,[this, {aaConEnabled:aaConEnabled,modifyParams:modifyParams,alignFrame:alignFrame,aaui:aaui}])));
}return true;
});
...
$I$(12,"debug$S",["Changing AACon service to " + service.hosturl + " from " + fave.getService$().hosturl ]);
...
$I$(12,"warn$S",["Ignoring invalid preferred service for AACon calculations (service type was " + service.serviceType + ")" ]);
service=null;
} else {
