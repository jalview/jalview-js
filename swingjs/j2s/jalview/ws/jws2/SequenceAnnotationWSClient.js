(function(){var P$=Clazz.newPackage("jalview.ws.jws2"),I$=[[0,'jalview.ws.jws2.jabaws2.Jws2Instance','jalview.gui.AlignFrame','jalview.ws.params.WsParamSetI','java.util.List','Error','jalview.util.MessageManager','java.util.Locale','jalview.ws.jws2.AADisorderClient','javax.swing.JMenuItem','jalview.ws.jws2.SequenceAnnotationWSClient','javax.swing.JMenu','jalview.gui.JvSwingUtils','jalview.gui.Desktop']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
}}if (sh.action.toLowerCase$java_util_Locale($I$(7).ROOT).contains$CharSequence("disorder")) {
if (!this.processParams$jalview_ws_jws2_jabaws2_Jws2Instance$Z(sh, editParams)) {
return;
}alignFrame.getViewport$().getCalcManager$().startWorker$jalview_api_AlignCalcWorkerI(Clazz.new_($I$(8,1).c$$jalview_ws_jws2_jabaws2_Jws2Instance$jalview_gui_AlignFrame$jalview_ws_params_WsParamSetI$java_util_List,[sh, alignFrame, preset, this.paramset]));
}});
...
var annotservice=Clazz.new_([$I$(6,"formatMessage$S$SA",["label.calcname_with_default_settings", Clazz.array(String, -1, [calcName])])],$I$(9,1).c$$S);
...
Clazz.new_($I$(10,1).c$$jalview_ws_jws2_jabaws2_Jws2Instance$jalview_gui_AlignFrame$jalview_ws_params_WsParamSetI$Z,[this.$finals$.service, this.$finals$.alignFrame, null, false]);
});
})()
...
if (hasparams) {
annotservice=Clazz.new_([$I$(6).getString$S("label.edit_settings_and_run")],$I$(9,1).c$$S);
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent',  function (e) {
Clazz.new_($I$(10,1).c$$jalview_ws_jws2_jabaws2_Jws2Instance$jalview_gui_AlignFrame$jalview_ws_params_WsParamSetI$Z,[this.$finals$.service, this.$finals$.alignFrame, null, true]);
});
})()
...
var presetlist=Clazz.new_([$I$(6,"formatMessage$S$SA",["label.run_with_preset", Clazz.array(String, -1, [calcName])])],$I$(11,1).c$$S);
for (var preset, $preset = presets.iterator$(); $preset.hasNext$()&&((preset=($preset.next$())),1);) {
var methodR=Clazz.new_([preset.getName$()],$I$(9,1).c$$S);
methodR.setToolTipText$S($I$(12,"wrapTooltip$Z$S",[true, "<strong>" + (preset.isModifiable$() ? $I$(6).getString$S("label.user_preset") : $I$(6).getString$S("label.service_preset")) + "</strong><br/>" + preset.getDescription$() ]));
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent',  function (e) {
Clazz.new_($I$(10,1).c$$jalview_ws_jws2_jabaws2_Jws2Instance$jalview_gui_AlignFrame$jalview_ws_params_WsParamSetI$Z,[this.$finals$.service, this.$finals$.alignFrame, this.$finals$.preset, false]);
});
})()
...
annotservice=Clazz.new_([$I$(6).getString$S("label.view_documentation")],$I$(9,1).c$$S);
...
$I$(13).showUrl$S(this.$finals$.service.docUrl);
});
})()
), Clazz.new_(P$.SequenceAnnotationWSClient$4.$init$,[this, {service:service}])));
annotservice.setToolTipText$S($I$(12,"wrapTooltip$Z$S",[true, $I$(6,"formatMessage$S$SA",["label.view_service_doc_url", Clazz.array(String, -1, [service.docUrl, service.docUrl])])]));
wsmenu.add$javax_swing_JMenuItem(annotservice);
}}});
})();
