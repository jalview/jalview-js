...
this.jws2Discoverer.addInvalidServiceUrl$S(this.jwsserver);
$I$(6).warn$S("Ignoring invalid Jws2 service url " + this.jwsserver);
}} catch (e$$) {
if (Clazz.exceptionOf(e$$,"Exception")){
var e = e$$;
{
e.printStackTrace$();
$I$(6).warn$S$Throwable("Exception when discovering Jws2 services.", e);
this.jws2Discoverer.addInvalidServiceUrl$S(this.jwsserver);
}
} else if (Clazz.exceptionOf(e$$,"Error")){
var e = e$$;
{
$I$(6).error$S$Throwable("Exception when discovering Jws2 services.", e);
this.jws2Discoverer.addInvalidServiceUrl$S(this.jwsserver);
}
} else {
throw e$$;
