(function(){var P$=Clazz.newPackage("jalview.ws.params.simple"),I$=[[0,['jalview.ws.params.ValueConstrainI','.ValueType']]],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return Integer.valueOf$I(this.b$['jalview.ws.params.simple.IntegerParameter'].min);
} else {
return null;
}});
...
if (this.b$['jalview.ws.params.simple.IntegerParameter'].min < this.b$['jalview.ws.params.simple.IntegerParameter'].max) {
return Integer.valueOf$I(this.b$['jalview.ws.params.simple.IntegerParameter'].max);
} else {
return null;
}});
})()
