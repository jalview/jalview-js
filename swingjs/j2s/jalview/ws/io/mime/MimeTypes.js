(function(){var P$=Clazz.newPackage("jalview.ws.io.mime"),I$=[[0,['jalview.io.packed.DataProvider','.JvDataType']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
