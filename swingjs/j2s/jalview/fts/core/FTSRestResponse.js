(function(){var P$=Clazz.newPackage("jalview.fts.core"),I$=[[0,'jalview.fts.api.FTSDataColumnI','jalview.datamodel.SequenceI','javax.swing.table.DefaultTableModel','jalview.fts.core.DecimalFormatTableCellRenderer']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var prefedWidth=columnPrefs.get$O(wantedField.getName$()) == null  ? wantedField.getPreferredWidth$() : (columnPrefs.get$O(wantedField.getName$())).valueOf();
