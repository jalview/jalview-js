(function(){var P$=Clazz.newPackage("jalview.fts.core"),I$=[[0,'jalview.bin.Cache']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
Clazz.newMeth(C$, 'getFieldIndex$S',  function (string) {
var i=this.associatedSequence != null  ? 1 : 0;
for (var field, $field = this.wantedFields.iterator$(); $field.hasNext$()&&((field=($field.next$())),1);) {
if (field.getName$().equals$O(string)) {
return i;
}++i;
}
return -1;
