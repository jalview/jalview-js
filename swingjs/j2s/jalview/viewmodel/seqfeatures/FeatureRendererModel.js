(function(){var P$=Clazz.newPackage("jalview.viewmodel.seqfeatures"),p$1={},I$=[[0,'java.util.concurrent.ConcurrentHashMap','java.util.HashMap','java.beans.PropertyChangeSupport','java.util.Hashtable','jalview.viewmodel.seqfeatures.FeatureRendererSettings','jalview.viewmodel.seqfeatures.FeaturesDisplayed','java.util.Arrays','java.util.ArrayList','java.util.HashSet','jalview.util.QuickSort','jalview.util.ColorUtils','jalview.schemes.FeatureColour','jalview.util.Platform','jalview.datamodel.features.SequenceFeatures','jalview.datamodel.SearchResults','jalview.datamodel.MappedFeatures']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['newFeatureAdded','findingFeatures'],'F',['transparency'],'O',['featureColours','java.util.Map','+featureGroups','+featureFilters','renderOrder','String[]','featureOrder','java.util.Map','av','jalview.api.AlignViewportI','changeSupport','java.beans.PropertyChangeSupport','minmax','java.util.Map','firing','Boolean']]]
...
return Clazz.new_($I$(5,1).c$$jalview_viewmodel_seqfeatures_FeatureRendererModel,[this]);
});
...
var fr=_fr;
var frs=Clazz.new_($I$(5,1).c$$jalview_viewmodel_seqfeatures_FeatureRendererModel,[fr]);
...
this.av.setFeaturesDisplayed$jalview_api_FeaturesDisplayedI(Clazz.new_($I$(6,1).c$$jalview_api_FeaturesDisplayedI,[featuresDisplayed]));
});

Clazz.newMeth(C$, 'setVisible$S',  function (featureType) {
var fdi=this.av.getFeaturesDisplayed$();
if (fdi == null ) {
this.av.setFeaturesDisplayed$jalview_api_FeaturesDisplayedI(fdi=Clazz.new_($I$(6,1)));
}if (!fdi.isRegistered$S(featureType)) {
p$1.pushFeatureType$java_util_List.apply(this, [$I$(7,"asList$OA",[Clazz.array(String, -1, [featureType])])]);
...
{
if (this.firing.equals$O(Boolean.FALSE)) {
...
Clazz.newMeth(C$, 'notifyFeaturesChanged$',  function () {
...
this.av.setFeaturesDisplayed$jalview_api_FeaturesDisplayedI(Clazz.new_($I$(6,1)));
}var featuresDisplayed=this.av.getFeaturesDisplayed$();
var oldfeatures=Clazz.new_($I$(9,1));
if (this.renderOrder != null ) {
...
var allfeatures=Clazz.new_($I$(8,1));
for (var i=0; i < alignment.getHeight$(); i++) {
var asq=alignment.getSequenceAt$I(i);
for (var group, $group = asq.getFeatures$().getFeatureGroups$Z$SA(true, Clazz.array(String, -1, [])).iterator$(); $group.hasNext$()&&((group=($group.next$())),1);) {
...
this.featureGroups.put$O$O(group, Boolean.valueOf$Z(groupDisplayed));
}}if (groupDisplayed) {
var types=asq.getFeatures$().getFeatureTypesForGroups$Z$SA(true, Clazz.array(String, -1, [group]));
...
var allfeatures=Clazz.new_($I$(8,1).c$$java_util_Collection,[allFeatures]);
...
if (iSize > 1 && sort ) {
$I$(10).sort$FA$OA(sortOrder, newf);
}sortOrder=null;
...
if (fc == null ) {
var col=$I$(11).createColourFromName$S(featureType);
fc=Clazz.new_($I$(12,1).c$$java_awt_Color,[col]);
...
this.av.setFeaturesDisplayed$jalview_api_FeaturesDisplayedI(av_featuresdisplayed=Clazz.new_($I$(6,1)));
}} else {
...
if (this.renderOrder == null ) {
return $I$(7,"asList$OA",[Clazz.array(String, -1, [])]);
}return $I$(7).asList$OA(this.renderOrder);
});
...
return (this.featureGroups == null ) ? $I$(7,"asList$OA",[Clazz.array(String, [0])]) : $I$(7,"asList$OA",[this.featureGroups.keySet$().toArray$OA(Clazz.array(String, [0]))]);
});
...
this.featureGroups.put$O$O(group, Boolean.valueOf$Z(true));
return true;
}return false;
});
...
this.featureGroups.put$O$O(group, Boolean.valueOf$Z(visible));
});
...
this.featureGroups.put$O$O(gst, Boolean.valueOf$Z(visible));
if (st != null ) {
...
var displayed=Clazz.new_($I$(8,1));
...
$I$(7).sort$OA$java_util_Comparator(this.renderOrder, order);
});
...
mapping=acf.getCoveringCodonMapping$jalview_datamodel_SequenceI(ds);
if (mapping == null ) {
continue;
}var sr=Clazz.new_($I$(15,1));
mapping.markMappedRegion$jalview_datamodel_SequenceI$I$jalview_datamodel_SearchResultsI(ds, pos, sr);
...
return Clazz.new_([mapping.getMapping$(), mapFrom, pos, residue, result],$I$(16,1).c$$jalview_datamodel_Mapping$jalview_datamodel_SequenceI$I$C$java_util_List);
});
