...
if (hc != -1 && Long.$ne(hc,this.sgrouphash ) ) {
if (b) {
this.sgrouphash=hc;
}return true;
}return false;
...
if (hc != -1 && Long.$ne(hc,this.colselhash ) ) {
if (b) {
this.colselhash=hc;
}return true;
}return false;
...
this.conservation=Clazz.new_(["Conservation", $I$(21,"formatMessage$S$OA",["label.conservation_descr", Clazz.array(java.lang.Object, -1, [Integer.valueOf$I(this.getConsPercGaps$())])]), Clazz.array($I$(22), [1]), 0.0, 11.0, 1],$I$(19,1).c$$S$S$jalview_datamodel_AnnotationA$F$F$I);
