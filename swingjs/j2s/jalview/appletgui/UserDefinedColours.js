(function(){var P$=Clazz.newPackage("jalview.appletgui"),p$1={},I$=[[0,'java.util.Vector','java.awt.Panel','java.awt.GridLayout','java.awt.Button','java.awt.Scrollbar','java.awt.Label','java.awt.TextField','jalview.schemes.FeatureColour','java.awt.Rectangle','jalview.util.MessageManager','java.awt.Dialog','Error','java.awt.Frame','jalview.bin.JalviewLite','jalview.schemes.ResidueProperties','java.awt.Color','java.awt.Font','java.awt.event.MouseAdapter','jalview.schemes.UserColourScheme','jalview.renderer.ResidueShader','jalview.analysis.AAFrequency']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.jmol.colourByJalviewColourScheme$jalview_schemes_UserColourScheme(ucs);
