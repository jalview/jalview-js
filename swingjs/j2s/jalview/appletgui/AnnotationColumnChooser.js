...
this.b$['jalview.appletgui.AnnotationColumnChooser'].setActionOption$I.apply(this.b$['jalview.appletgui.AnnotationColumnChooser'], [1]);
this.b$['jalview.appletgui.AnnotationColumnChooser'].updateView$.apply(this.b$['jalview.appletgui.AnnotationColumnChooser'], []);
} else {
this.b$['jalview.appletgui.AnnotationColumnChooser'].setActionOption$I.apply(this.b$['jalview.appletgui.AnnotationColumnChooser'], [$I$(2).ACTION_OPTION_HIDE]);
this.b$['jalview.appletgui.AnnotationColumnChooser'].updateView$.apply(this.b$['jalview.appletgui.AnnotationColumnChooser'], []);
}});
