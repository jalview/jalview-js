(function(){var P$=Clazz.newPackage("jalview.appletgui"),p$1={},I$=[[0,'jalview.structure.StructureSelectionManager','java.awt.Panel','java.awt.GridLayout','java.awt.Dimension','java.awt.BorderLayout','jalview.bin.JalviewLite']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
