(function(){var P$=Clazz.newPackage("jalview.appletgui"),I$=[[0,'java.awt.Color','jalview.util.Platform','jalview.renderer.AnnotationRenderer','jalview.datamodel.Annotation','jalview.appletgui.UserDefinedColours','jalview.appletgui.EditNameDialog','java.awt.PopupMenu','jalview.util.MessageManager','java.awt.MenuItem','StringBuilder','jalview.util.Comparison','jalview.schemes.ResidueProperties','java.awt.Dimension']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
