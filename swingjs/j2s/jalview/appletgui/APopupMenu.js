(function(){var P$=Clazz.newPackage("jalview.appletgui"),p$1={},I$=[[0,'java.awt.Menu','java.awt.MenuItem','java.awt.CheckboxMenuItem','jalview.util.MessageManager','jalview.io.FileFormats','java.util.LinkedHashMap','jalview.util.UrlLink','java.util.Collections','java.util.Arrays','jalview.datamodel.SequenceI','java.util.TreeMap','jalview.analysis.AlignmentUtils','StringBuilder','jalview.appletgui.EditNameDialog','jalview.commands.EditCommand',['jalview.commands.EditCommand','.Action'],'jalview.commands.ChangeCaseCommand','java.util.ArrayList','jalview.datamodel.SequenceFeature','jalview.appletgui.CutAndPasteTransfer','java.awt.Frame','jalview.bin.JalviewLite','jalview.io.AppletFormatAdapter','jalview.io.SequenceAnnotationReport','jalview.appletgui.AppletJmol','jalview.io.DataSourceType','mc_view.AppletPDBViewer','jalview.schemes.JalviewColourScheme','jalview.renderer.ResidueShader','jalview.schemes.ClustalxColourScheme','jalview.schemes.ZappoColourScheme','jalview.schemes.TaylorColourScheme','jalview.schemes.HydrophobicColourScheme','jalview.schemes.HelixColourScheme','jalview.schemes.StrandColourScheme','jalview.schemes.TurnColourScheme','jalview.schemes.BuriedColourScheme','jalview.schemes.NucleotideColourScheme','jalview.schemes.PurinePyrimidineColourScheme','jalview.analysis.AAFrequency','jalview.appletgui.SliderPanel','jalview.appletgui.UserDefinedColours','jalview.schemes.PIDColourScheme','jalview.schemes.Blosum62ColourScheme','jalview.analysis.Conservation','jalview.analysis.AlignmentAnnotationUtils']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var selectedSequence=(this.seq == null  ? $I$(8).emptyList$() : $I$(9,"asList$OA",[Clazz.array($I$(10), -1, [this.seq])]));
...
var tipEntries=Clazz.new_($I$(11,1));
var candidates=Clazz.new_($I$(6,1));
var al=this.ap.av.getAlignment$();
$I$(12).findAddableReferenceAnnotations$java_util_List$java_util_Map$java_util_Map$jalview_datamodel_AlignmentI(forSequences, tipEntries, candidates, al);
if (!candidates.isEmpty$()) {
var tooltip=Clazz.new_($I$(13,1).c$$I,[64]);
...
$I$(12).addReferenceAnnotations$java_util_Map$jalview_datamodel_AlignmentI$jalview_datamodel_SequenceGroup(candidates, alignment, selectionGroup);
this.refresh$();
});
...
var dialog=Clazz.new_([this.getGroup$().getName$(), this.getGroup$().getDescription$(), "       Group Name", "Group Description", this.ap.alignFrame, "Edit Group Name / Description", 500, 100, true],$I$(14,1).c$$S$S$S$S$java_awt_Frame$S$I$I$Z);
if (dialog.accept) {
...
}var dialog=Clazz.new_([this.seq.getSequenceAsString$I$I(sg.getStartRes$(), sg.getEndRes$() + 1), null, "Edit Sequence ", null, this.ap.alignFrame, "Edit Sequence", 500, 100, true],$I$(14,1).c$$S$S$S$S$java_awt_Frame$S$I$I$Z);
if (dialog.accept) {
var editCommand=Clazz.new_([$I$(4).getString$S("label.edit_sequences"), $I$(16).REPLACE, dialog.getName$().replace$C$C(" ", this.ap.av.getGapCharacter$()), sg.getSequencesAsArray$java_util_Map(this.ap.av.getHiddenRepSequences$()), sg.getStartRes$(), sg.getEndRes$() + 1, this.ap.av.getAlignment$()],$I$(15,1).c$$S$jalview_commands_EditCommand_Action$S$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI);
...
caseChange=$I$(17).TOGGLE_CASE;
} else if (source === this.toUpper ) {
description="To Upper Case";
caseChange=$I$(17).TO_UPPER;
} else {
description="To Lower Case";
caseChange=$I$(17).TO_LOWER;
}var caseCommand=Clazz.new_([description, sg.getSequencesAsArray$java_util_Map(this.ap.av.getHiddenRepSequences$()), startEnd, caseChange],$I$(17,1).c$$S$jalview_datamodel_SequenceIA$java_util_List$I);
...
var seqs=Clazz.new_($I$(18,1));
var features=Clazz.new_($I$(18,1));
...
features.add$O(Clazz.new_($I$(19,1).c$$S$S$I$I$S,[null, null, start, end, "Jalview"]));
}}
if (!seqs.isEmpty$()) {
...
var cap=Clazz.new_($I$(20,1).c$$Z$jalview_appletgui_AlignFrame,[true, this.ap.alignFrame]);
var frame=Clazz.new_($I$(21,1));
frame.add$java_awt_Component(cap);
$I$(22,"addFrame$java_awt_Frame$S$I$I",[frame, $I$(4,"formatMessage$S$OA",["label.selection_output_command", Clazz.array(java.lang.Object, -1, [e.getActionCommand$()])]), 600, 500]);
var fileFormat=$I$(5).getInstance$().forName$S(e.getActionCommand$());
cap.setText$S(Clazz.new_($I$(23,1)).formatSequences$jalview_io_FileFormatI$Z$jalview_api_AlignmentViewPanel$Z(fileFormat, this.ap.av.getShowJVSuffix$(), this.ap, true));
});
...
this.createSequenceDetailsReport$jalview_datamodel_SequenceIA(Clazz.array($I$(10), -1, [this.seq]));
});

Clazz.newMeth(C$, 'createSequenceDetailsReport$jalview_datamodel_SequenceIA',  function (sequences) {
var cap=Clazz.new_($I$(20,1).c$$Z$jalview_appletgui_AlignFrame,[false, this.ap.alignFrame]);
var contents=Clazz.new_($I$(13,1).c$$I,[128]);
...
Clazz.new_($I$(24,1).c$$Z,[false]).createSequenceAnnotationReport$StringBuilder$jalview_datamodel_SequenceI$Z$Z$jalview_viewmodel_seqfeatures_FeatureRendererModel(contents, seq, true, true, this.ap.seqPanel.seqCanvas.fr);
contents.append$S("</p>");
}
var frame=Clazz.new_($I$(21,1));
frame.add$java_awt_Component(cap);
$I$(22,"addFrame$java_awt_Frame$S$I$I",[frame, "Sequence Details for " + (sequences.length == 1 ? sequences[0].getDisplayId$Z(true) : "Selection"), 600, 500]);
...
var dialog=Clazz.new_([this.seq.getName$(), this.seq.getDescription$(), "       Sequence Name", "Sequence Description", this.ap.alignFrame, "Edit Sequence Name / Description", 500, 100, true],$I$(14,1).c$$S$S$S$S$java_awt_Frame$S$I$I$Z);
if (dialog.accept) {
...
Clazz.new_([entry, Clazz.array($I$(10), -1, [this.seq]), null, this.ap, $I$(26).URL],$I$(25,1).c$$jalview_datamodel_PDBEntry$jalview_datamodel_SequenceIA$SA$jalview_appletgui_AlignmentPanel$jalview_io_DataSourceType);
} else {
Clazz.new_([entry, Clazz.array($I$(10), -1, [this.seq]), null, this.ap, $I$(26).URL],$I$(27,1).c$$jalview_datamodel_PDBEntry$jalview_datamodel_SequenceIA$SA$jalview_appletgui_AlignmentPanel$jalview_io_DataSourceType);
}} else {
var cap=Clazz.new_($I$(20,1).c$$Z$jalview_appletgui_AlignFrame,[true, this.ap.alignFrame]);
...
var frame=Clazz.new_($I$(21,1));
frame.add$java_awt_Component(cap);
$I$(22,"addFrame$java_awt_Frame$S$I$I",[frame, $I$(4,"formatMessage$S$OA",["label.paste_pdb_file_for_sequence", Clazz.array(java.lang.Object, -1, [this.seq.getName$()])]), 400, 300]);
}});
...
this.PIDColour.setLabel$S($I$(4).getString$S("label.colourScheme_%identity"));
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent',  function (e) {
$I$(12,"showOrHideSequenceAnnotations$jalview_datamodel_AlignmentI$java_util_Collection$java_util_List$Z$Z",[this.b$['jalview.appletgui.APopupMenu'].ap.getAlignment$(), this.$finals$.types, this.$finals$.forSequences, this.$finals$.allTypes, this.$finals$.actionIsShow]);
this.b$['jalview.appletgui.APopupMenu'].refresh$.apply(this.b$['jalview.appletgui.APopupMenu'], []);
});
})()
), Clazz.new_(P$.APopupMenu$3.$init$,[this, {forSequences:forSequences,actionIsShow:actionIsShow,allTypes:allTypes,types:types}])));
