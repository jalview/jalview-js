...
orderedSeqs.put$O$O(new Integer(index), seq);
}
var index=0;
var startRes;
var endRes;
...
), Clazz.new_($I$(64,1),[this, {item:item,treePanel:treePanel,title:title}],P$.AlignFrame$3)));
});
