(function(){var P$=Clazz.newPackage("jalview.appletgui"),I$=[[0,'java.awt.Font','java.util.HashMap','jalview.util.Platform','java.awt.Panel','java.awt.FlowLayout','java.awt.Color','java.awt.Label','java.awt.PopupMenu']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
