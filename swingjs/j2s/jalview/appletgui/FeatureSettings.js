(function(){var P$=Clazz.newPackage("jalview.appletgui"),I$=[[0,'java.awt.Color','java.awt.Panel','java.awt.Scrollbar','java.awt.Toolkit','java.awt.BorderLayout','java.awt.ScrollPane','java.awt.Button','jalview.util.MessageManager','java.awt.GridLayout','java.awt.Label','java.awt.Frame','java.awt.event.WindowAdapter','jalview.bin.JalviewLite','java.awt.PopupMenu','java.awt.MenuItem','java.util.Arrays','jalview.appletgui.FeatureColourChooser','jalview.appletgui.UserDefinedColours',['jalview.appletgui.FeatureSettings','.MyCheckbox'],'java.awt.Font','java.util.ArrayList','java.util.HashSet',['jalview.viewmodel.seqfeatures.FeatureRendererModel','.FeatureSettingsBean']]],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
), Clazz.new_(P$.FeatureSettings$6.$init$,[this, {type:type,check:check,typeCol:typeCol,me:me}])));
...
rowData[i]=Clazz.new_([check.type, colour, null, Boolean.valueOf$Z(check.getState$())],$I$(23,1).c$$S$jalview_api_FeatureColourI$jalview_datamodel_features_FeatureMatcherSetI$Boolean);
++i;
}
...
this.type=label;
var fm=this.b$['jalview.appletgui.FeatureSettings'].av.nullFrame.getFontMetrics$java_awt_Font(this.b$['jalview.appletgui.FeatureSettings'].av.nullFrame.getFont$());
...
g.drawImage$java_awt_Image$I$I$java_awt_image_ImageObserver(this.b$['jalview.appletgui.FeatureSettings'].linkImage, this.stringWidth + 25, ((this.getSize$().height - this.b$['jalview.appletgui.FeatureSettings'].linkImage.getHeight$java_awt_image_ImageObserver(this))/2|0), this);
}});
