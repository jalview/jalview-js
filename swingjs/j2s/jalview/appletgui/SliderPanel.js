(function(){var P$=Clazz.newPackage("jalview.appletgui"),p$1={},I$=[[0,'java.awt.Scrollbar','java.awt.TextField','java.awt.Label','java.awt.Panel','java.awt.Button','java.awt.FlowLayout','java.awt.Checkbox','java.awt.BorderLayout','java.awt.Frame','jalview.util.MessageManager','jalview.bin.JalviewLite','jalview.appletgui.SliderPanel','java.awt.event.WindowAdapter','jalview.analysis.Conservation','java.awt.Color','java.awt.Font','java.awt.event.FocusAdapter']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
