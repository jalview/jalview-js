(function(){var P$=Clazz.newPackage("jalview.appletgui"),I$=[[0,'java.awt.Color','java.awt.Font','jalview.util.MessageManager','java.awt.Panel','java.awt.BorderLayout','java.awt.TextField','java.awt.TextArea','java.awt.Button',['jalview.appletgui.FeatureRenderer','.FeatureColourPanel'],'java.awt.GridLayout','java.awt.Label','java.awt.Choice','jalview.datamodel.SearchResults','jalview.util.ColorUtils','jalview.schemes.FeatureColour','java.awt.ScrollPane','jalview.appletgui.JVDialog','jalview.appletgui.UserDefinedColours','jalview.appletgui.FeatureColourChooser','java.awt.event.MouseAdapter','jalview.io.FeaturesFile','jalview.datamodel.SequenceFeature','java.awt.FlowLayout']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
), Clazz.new_(P$.FeatureRenderer$3.$init$,[this, {sequences:sequences,start:start,overlaps:overlaps,end:end,ap:ap,features:features,group:group,description:description,name:name}])));
...
), Clazz.new_($I$(20,1),[this, {fr:fr,ap:ap,dialog:dialog,name:name}],P$.FeatureRenderer$5)));
...
if (this.featureGroups.containsKey$O(group) && !(this.featureGroups.get$O(group)).valueOf() ) {
