...
if (!isGapped) {
if (this.av.getAlignment$().isNucleotide$()) {
var base=$I$(8).nucleotideName.get$O(Character.valueOf$C(ch));
text.append$S(" Nucleotide: ").append$O(base == null  ? Character.valueOf$C(ch) : base);
} else {
var residue=(ch == "x" || ch == "X" ) ? "X" : $I$(8).aa2Triplet.get$O(String.valueOf$C(ch));
text.append$S(" Residue: ").append$O(residue == null  ? Character.valueOf$C(ch) : residue);
...
this.needOverviewUpdate=!!(this.needOverviewUpdate|(vischange && this.av.isSelectionDefinedGroup$() && afterDrag  ));
...
this.needOverviewUpdate=!!(this.needOverviewUpdate|(this.av.isSelectionDefinedGroup$()));
...
}}repaint=!!(repaint|(this.av.isColSelChanged$Z(true)));
...
if (this.evt != null ) {
if (this.b$['jalview.appletgui.SeqPanel'].mouseDragging && this.evt.getY$() < 0  && this.b$['jalview.appletgui.SeqPanel'].av.getRanges$().getStartSeq$() > 0 ) {
this.b$['jalview.appletgui.SeqPanel'].av.getRanges$().scrollUp$Z(true);
}if (this.b$['jalview.appletgui.SeqPanel'].mouseDragging && this.evt.getY$() >= this.b$['java.awt.Component'].getSize$.apply(this.b$['java.awt.Component'], []).height  && this.b$['jalview.appletgui.SeqPanel'].av.getAlignment$().getHeight$() > this.b$['jalview.appletgui.SeqPanel'].av.getRanges$().getEndSeq$() ) {
this.b$['jalview.appletgui.SeqPanel'].av.getRanges$().scrollUp$Z(false);
}if (this.b$['jalview.appletgui.SeqPanel'].mouseDragging && this.evt.getX$() < 0 ) {
this.b$['jalview.appletgui.SeqPanel'].av.getRanges$().scrollRight$Z(false);
} else if (this.b$['jalview.appletgui.SeqPanel'].mouseDragging && this.evt.getX$() >= this.b$['java.awt.Component'].getSize$.apply(this.b$['java.awt.Component'], []).width ) {
this.b$['jalview.appletgui.SeqPanel'].av.getRanges$().scrollRight$Z(true);
}}try {
$I$(1).sleep$J(75);
} catch (ex) {
