(function(){var P$=Clazz.newPackage("jalview.appletgui"),I$=[[0,'java.awt.Button','java.awt.Panel','java.awt.FlowLayout','java.awt.event.WindowAdapter']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
