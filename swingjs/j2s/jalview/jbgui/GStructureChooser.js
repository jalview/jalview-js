(function(){var P$=Clazz.newPackage("jalview.jbgui"),p$1={},I$=[[0,'javax.swing.JComboBox','javax.swing.JLabel','java.awt.FlowLayout','jalview.util.MessageManager','javax.swing.JPanel','java.awt.BorderLayout','javax.swing.JSeparator','java.awt.Font','java.util.HashMap','javax.swing.JInternalFrame','StringBuilder','javax.swing.JButton','javax.swing.JCheckBox','javax.swing.JTextField','java.awt.CardLayout','javax.swing.ImageIcon',['jalview.jbgui.GStructureChooser','.AssociateSeqPanel'],'javax.swing.JTable','javax.swing.JTabbedPane','jalview.jbgui.GStructureChooser','jalview.gui.JvSwingUtils','javax.swing.Timer','java.awt.event.MouseAdapter','java.awt.event.KeyAdapter','jalview.gui.StructureViewer','javax.swing.JScrollPane','java.awt.Dimension',['jalview.jbgui.GStructureChooser','.CustomComboSeparatorsRenderer'],'net.miginfocom.swing.MigLayout','jalview.fts.api.FTSDataColumnI','java.awt.GridLayout','javax.swing.event.InternalFrameAdapter','jalview.gui.Desktop','java.util.Arrays']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "GStructureChooser", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'javax.swing.JPanel', 'java.awt.event.ItemListener');
C$.$classes$=[['AssociateSeqOptions',1],['AssociateSeqPanel',1],['CustomComboSeparatorsRenderer',1025]];
...
this.btn_queryTDB=Clazz.new_($I$(12,1));
...
this.tdbImage=Clazz.new_([this.getClass$().getResource$S("/images/3d-beacons-logo-transparent.png")],$I$(16,1).c$$java_net_URL);
...
$I$(20).tempUserPrefs.put$O$O(colHeader, Integer.valueOf$I(resizingColumn.getWidth$()));
...
toolTipText=(toolTipText == null  ? null : (toolTipText.length$() > 500 ? $I$(21,"wrapTooltip$Z$S",[true, "\"" + toolTipText.subSequence$I$I(0, 500) + "...\"" ]) : $I$(21).wrapTooltip$Z$S(true, toolTipText)));
return toolTipText;
});
})()
...
C$.$fields$=[['S',['frameTitle'],'O',['statusPanel','javax.swing.JPanel','statusBar','javax.swing.JLabel','mainFrame','javax.swing.JInternalFrame','cmb_filterOption','javax.swing.JComboBox','ap','jalview.gui.AlignmentPanel','errorWarning','StringBuilder','btn_add','javax.swing.JButton','+btn_newView','+btn_pdbFromFile','+btn_queryTDB','chk_superpose','javax.swing.JCheckBox','txt_search','javax.swing.JTextField','pnl_switchableViews','javax.swing.JPanel','layout_switchableViews','java.awt.CardLayout','chk_invertFilter','javax.swing.JCheckBox','loadingImage','javax.swing.ImageIcon','+goodImage','+errorImage','+warningImage','+tdbImage','lbl_loading','javax.swing.JLabel','+lbl_pdbManualFetchStatus','+lbl_fromFileStatus','idInputAssSeqPanel','jalview.jbgui.GStructureChooser.AssociateSeqPanel','+fileChooserAssSeqPanel','targetView','javax.swing.JComboBox','tbl_local_pdb','javax.swing.JTable','pnl_filter','javax.swing.JTabbedPane','previousWantedFields','jalview.fts.api.FTSDataColumnI[]','tbl_summary','javax.swing.JTable','timer','javax.swing.Timer']]
...
), Clazz.new_(P$.GStructureChooser$2.$init$,[this, null]))],$I$(22,1).c$$I$java_awt_event_ActionListener);
this.timer.setRepeats$Z(false);
this.timer.start$();
});

Clazz.newMeth(C$, 'jbInit',  function () {
var width=Integer.valueOf$I(C$.tempUserPrefs.get$O("structureChooser.width") == null  ? 800 : (C$.tempUserPrefs.get$O("structureChooser.width")).$c());
var height=Integer.valueOf$I(C$.tempUserPrefs.get$O("structureChooser.height") == null  ? 400 : (C$.tempUserPrefs.get$O("structureChooser.height")).$c());
...
if (!this.popupAction$java_awt_event_MouseEvent(e)) {
...
Clazz.newMeth(C$, 'popupAction$java_awt_event_MouseEvent',  function (e) {
if (e.isPopupTrigger$()) {
var pt=e.getPoint$();
var selectedRow=this.b$['jalview.jbgui.GStructureChooser'].tbl_summary.rowAtPoint$java_awt_Point(pt);
if (this.b$['jalview.jbgui.GStructureChooser'].showPopupFor$I$I$I.apply(this.b$['jalview.jbgui.GStructureChooser'], [selectedRow, pt.x, pt.y])) {
return true;
}}return false;
});
})()
), Clazz.new_($I$(23,1),[this, null],P$.GStructureChooser$3)));
...
), Clazz.new_($I$(24,1),[this, null],P$.GStructureChooser$4)));
...
), Clazz.new_($I$(24,1),[this, null],P$.GStructureChooser$6)));
...
), Clazz.new_($I$(23,1),[this, null],P$.GStructureChooser$7)));
...
), Clazz.new_($I$(24,1),[this, {btn_cancel:btn_cancel}],P$.GStructureChooser$8)));
this.btn_newView=Clazz.new_([$I$(4,"formatMessage$S$OA",["action.new_structure_view_with", Clazz.array(java.lang.Object, -1, [$I$(25).getViewerType$().toString()])])],$I$(12,1).c$$S);
...
), Clazz.new_($I$(24,1),[this, null],P$.GStructureChooser$10)));
...
), Clazz.new_($I$(24,1),[this, null],P$.GStructureChooser$12)));
...
), Clazz.new_($I$(24,1),[this, null],P$.GStructureChooser$14)));
var scrl_foundStructures=Clazz.new_($I$(26,1).c$$java_awt_Component,[this.tbl_summary]);
scrl_foundStructures.setPreferredSize$java_awt_Dimension(Clazz.new_([(width).$c(), (height).$c()],$I$(27,1).c$$I$I));
var scrl_localPDB=Clazz.new_($I$(26,1).c$$java_awt_Component,[this.tbl_local_pdb]);
scrl_localPDB.setPreferredSize$java_awt_Dimension(Clazz.new_([(width).$c(), (height).$c()],$I$(27,1).c$$I$I));
scrl_localPDB.setHorizontalScrollBarPolicy$I(31);
this.chk_invertFilter.setFont$java_awt_Font(C$.VERDANA_12);
this.txt_search.setToolTipText$S($I$(21,"wrapTooltip$Z$S",[true, $I$(4).getString$S("label.enter_pdb_id_tip")]));
...
Clazz.newMeth(C$, 'addSeparatorAfter$javax_swing_JList$jalview_jbgui_FilterOption$I',  function (list, value, index) {
return value.isAddSeparatorAfter$();
});
})()
), Clazz.new_([this, null, this.cmb_filterOption.getRenderer$()],$I$(28,1).c$$javax_swing_ListCellRenderer,P$.GStructureChooser$16)));
this.chk_invertFilter.addItemListener$java_awt_event_ItemListener(this);
this.btn_queryTDB.setFont$java_awt_Font(C$.VERDANA_12);
this.btn_queryTDB.setText$S($I$(4).getString$S("label.search_3dbeacons"));
this.btn_queryTDB.setToolTipText$S($I$(4).getString$S("label.find_models_from_3dbeacons"));
this.btn_queryTDB.setIcon$javax_swing_Icon(this.tdbImage);
this.btn_queryTDB.setVisible$Z(false);
this.targetView.setVisible$Z(false);
var actionsPanel=Clazz.new_([Clazz.new_($I$(29,1))],$I$(5,1).c$$java_awt_LayoutManager);
...
var pnl_main=Clazz.new_([Clazz.new_($I$(6,1))],$I$(5,1).c$$java_awt_LayoutManager);
var pnl_controls=Clazz.new_($I$(5,1));
pnl_main.add$java_awt_Component$O(this.btn_queryTDB, "North");
pnl_controls.add$java_awt_Component(this.cmb_filterOption);
pnl_controls.add$java_awt_Component(this.lbl_loading);
pnl_controls.add$java_awt_Component(this.chk_invertFilter);
pnl_main.add$java_awt_Component$O(pnl_controls, "Center");
...
this.b$['jalview.jbgui.GStructureChooser'].previousWantedFields=this.b$['jalview.jbgui.GStructureChooser'].getFTSDocFieldPrefs$.apply(this.b$['jalview.jbgui.GStructureChooser'], []).getStructureSummaryFields$().toArray$OA(Clazz.array($I$(30), [0]));
...
), Clazz.new_(P$.GStructureChooser$17.$init$,[this, {foundStructureSummary:foundStructureSummary,btn_cancel:btn_cancel,configureCols:configureCols}]));
this.pnl_filter.addChangeListener$javax_swing_event_ChangeListener(changeListener);
this.pnl_filter.setPreferredSize$java_awt_Dimension(Clazz.new_([(width).$c(), (height).$c()],$I$(27,1).c$$I$I));
this.pnl_filter.add$S$java_awt_Component(foundStructureSummary, scrl_foundStructures);
this.pnl_filter.add$S$java_awt_Component(configureCols, this.getFTSDocFieldPrefs$());
...
this.statusPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(31,1)));
...
), Clazz.new_($I$(32,1),[this, null],P$.GStructureChooser$18)));
...
}$I$(33,"addInternalFrame$javax_swing_JInternalFrame$S$I$I",[this.mainFrame, this.frameTitle, (width).$c(), (height).$c()]);
}, p$1);

Clazz.newMeth(C$, 'closeAction$I',  function (preferredHeight) {
C$.tempUserPrefs.put$O$O("structureChooser.width", Integer.valueOf$I(this.pnl_filter.getWidth$()));
C$.tempUserPrefs.put$O$O("structureChooser.height", Integer.valueOf$I(preferredHeight));
C$.tempUserPrefs.put$O$O("structureChooser.x", Integer.valueOf$I(this.mainFrame.getX$()));
C$.tempUserPrefs.put$O$O("structureChooser.y", Integer.valueOf$I(this.mainFrame.getY$()));
...
return true;
}var currentWantedFields=this.getFTSDocFieldPrefs$().getStructureSummaryFields$().toArray$OA(Clazz.array($I$(30), [0]));
return $I$(34).equals$OA$OA(currentWantedFields, this.previousWantedFields) ? false : true;
});
...
this.b$['jalview.jbgui.GStructureChooser'].populateCmbAssociateSeqOptions$javax_swing_JComboBox$javax_swing_JLabel.apply(this.b$['jalview.jbgui.GStructureChooser'], [this.cmb_assSeq, this.lbl_associateSeq]);
});
...
this.b$['jalview.jbgui.GStructureChooser'].cmbAssSeqStateChanged$.apply(this.b$['jalview.jbgui.GStructureChooser'], []);
}});
})()
;
...
if (index != -1 && this.addSeparatorAfter$javax_swing_JList$jalview_jbgui_FilterOption$I(list, value, index) ) {
