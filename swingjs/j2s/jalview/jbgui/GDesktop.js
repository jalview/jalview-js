(function(){var P$=Clazz.newPackage("jalview.jbgui"),p$1={},I$=[[0,'javax.swing.JMenu','javax.swing.JMenuBar','javax.swing.JMenuItem','java.awt.FlowLayout','javax.swing.JCheckBoxMenuItem','jalview.util.Platform','jalview.jbgui.APQHandlers','jalview.bin.Console','jalview.bin.Cache','jalview.util.MessageManager','javax.swing.KeyStroke','jalview.util.ShortcutKeyMaskExWrapper']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var apqHandlersSet=false;
try {
apqHandlersSet=$I$(7).setAPQHandlers$jalview_jbgui_GDesktop(this);
} catch (e$$) {
if (Clazz.exceptionOf(e$$,"Exception")){
var e = e$$;
{
System.out.println$S("Cannot set APQHandlers");
}
} else {
var t = e$$;
{
$I$(8,"warn$S",["Error setting APQHandlers: " + t.toString()]);
$I$(8,"trace$S",[$I$(9).getStackTraceString$Throwable(t)]);
}
}
}
this.setName$S("jalview-desktop");
this.FileMenu.setText$S($I$(10).getString$S("action.file"));
this.HelpMenu.setText$S($I$(10).getString$S("action.help"));
this.inputLocalFileMenuItem.setText$S($I$(10).getString$S("label.load_tree_from_file"));
this.inputLocalFileMenuItem.setAccelerator$javax_swing_KeyStroke($I$(11,"getKeyStroke$I$I$Z",[79, $I$(12).getMenuShortcutKeyMaskEx$(), false]));
...
this.inputURLMenuItem.setText$S($I$(10).getString$S("label.from_url"));
...
this.inputTextboxMenuItem.setText$S($I$(10).getString$S("label.from_textbox"));
...
this.quit.setText$S($I$(10).getString$S("action.quit"));
...
this.aboutMenuItem.setText$S($I$(10).getString$S("label.about"));
...
this.documentationMenuItem.setText$S($I$(10).getString$S("label.documentation"));
this.documentationMenuItem.setAccelerator$javax_swing_KeyStroke($I$(11).getKeyStroke$I$I$Z(112, 0, false));
...
C$.windowMenu.setText$S($I$(10).getString$S("label.window"));
this.preferences.setText$S($I$(10).getString$S("label.preferences"));
...
this.toolsMenu.setText$S($I$(10).getString$S("label.tools"));
this.saveState.setText$S($I$(10).getString$S("action.save_project"));
...
this.saveAsState.setText$S($I$(10).getString$S("action.save_project_as"));
...
this.loadState.setText$S($I$(10).getString$S("action.load_project"));
...
this.inputMenu.setText$S($I$(10).getString$S("label.input_alignment"));
this.inputSequence.setText$S($I$(10).getString$S("action.fetch_sequences"));
...
this.closeAll.setText$S($I$(10).getString$S("action.close_all"));
...
this.raiseRelated.setText$S($I$(10).getString$S("action.raise_associated_windows"));
...
this.minimizeAssociated.setText$S($I$(10).getString$S("action.minimize_associated_windows"));
...
this.garbageCollect.setText$S($I$(10).getString$S("label.collect_garbage"));
...
this.showMemusage.setText$S($I$(10).getString$S("label.show_memory_usage"));
...
this.showConsole.setText$S($I$(10).getString$S("label.show_java_console"));
...
this.showNews.setText$S($I$(10).getString$S("label.show_jalview_news"));
...
this.groovyShell.setText$S($I$(10).getString$S("label.groovy_console"));
...
this.experimentalFeatures.setText$S($I$(10).getString$S("label.show_experimental"));
this.experimentalFeatures.setToolTipText$S($I$(10).getString$S("label.show_experimental_tip"));
...
this.snapShotWindow.setText$S($I$(10).getString$S("label.take_snapshot"));
