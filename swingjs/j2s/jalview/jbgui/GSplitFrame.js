(function(){var P$=Clazz.newPackage("jalview.jbgui"),p$1={},I$=[[0,'javax.swing.JSplitPane','jalview.util.Platform','java.awt.MouseInfo','java.awt.Rectangle']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.topFrame.putClientProperty$O$O("JInternalFrame.isPalette", Boolean.valueOf$Z(true));
this.bottomFrame.putClientProperty$O$O("JInternalFrame.isPalette", Boolean.valueOf$Z(true));
} else {
