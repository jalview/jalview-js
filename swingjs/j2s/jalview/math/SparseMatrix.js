(function(){var P$=Clazz.newPackage("jalview.math"),I$=[[0,'jalview.ext.android.SparseDoubleArray','jalview.math.Matrix']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
(count=Long.$inc(count,1));
}}
}
if (Long.$lt(Long.$mul(count,5),$in.height$() * this.cols )) {
