(function(){var P$=Clazz.newPackage("jalview.renderer"),I$=[[0,'java.util.ArrayList',['jalview.renderer.ScaleRenderer','.ScaleMark']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
