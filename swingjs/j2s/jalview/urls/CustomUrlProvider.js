(function(){var P$=Clazz.newPackage("jalview.urls"),p$1={},I$=[[0,'java.util.HashMap','java.util.StringTokenizer','jalview.util.UrlLink','java.util.ArrayList','StringBuffer','jalview.util.MessageManager']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
