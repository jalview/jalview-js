(function(){var P$=Clazz.newPackage("jalview.urls"),p$1={},I$=[[0,'jalview.urls.IdOrgSettings','java.util.ArrayList','java.util.HashMap','java.io.FileReader','jalview.util.JSONUtils','jalview.util.UrlLink','java.util.StringTokenizer','StringBuffer']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
