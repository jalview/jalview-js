(function(){var P$=Clazz.newPackage("jalview.urls"),I$=[[0,'java.util.regex.Pattern','java.util.ArrayList','jalview.urls.UrlLinkDisplay']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
