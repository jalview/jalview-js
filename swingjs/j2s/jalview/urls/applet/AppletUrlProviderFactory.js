(function(){var P$=Clazz.newPackage("jalview.urls.applet"),I$=[[0,'java.util.ArrayList','jalview.urls.CustomUrlProvider','jalview.urls.UrlProvider']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
