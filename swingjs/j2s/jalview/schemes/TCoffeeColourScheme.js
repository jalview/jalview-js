(function(){var P$=Clazz.newPackage("jalview.schemes"),I$=[[0,'java.util.ArrayList','java.util.IdentityHashMap','java.awt.Color','jalview.schemes.JalviewColourScheme']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
