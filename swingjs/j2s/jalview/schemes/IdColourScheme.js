(function(){var P$=Clazz.newPackage("jalview.schemes"),I$=[[0,'jalview.schemes.JalviewColourScheme','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
