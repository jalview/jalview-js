(function(){var P$=Clazz.newPackage("jalview.schemes"),I$=[[0,'java.util.Hashtable','jalview.schemes.ResidueProperties','jalview.schemes.ColourSchemeProperty','java.awt.Color','jalview.schemes.JalviewColourScheme']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (this.annotation != null  && ((this.annotation._rnasecstr == null  || Long.$ne(this.lastrefresh,this.annotation._rnasecstr.hashCode$() ) ) && this.annotation.isValidStruc$() ) ) {
...
this.positionsToHelix.put$O$O(Integer.valueOf$I(this.annotation._rnasecstr[x].getBegin$()), this.annotation._rnasecstr[x].getFeatureGroup$());
this.positionsToHelix.put$O$O(Integer.valueOf$I(this.annotation._rnasecstr[x].getEnd$()), this.annotation._rnasecstr[x].getFeatureGroup$());
...
currentHelix=this.positionsToHelix.get$O(Integer.valueOf$I(j));
