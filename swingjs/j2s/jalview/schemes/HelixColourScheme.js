...
/*c*/var C$=Clazz.newClass(P$, "HelixColourScheme", null, 'jalview.schemes.ScoreColourScheme');
...
;C$.superclazz.c$$IA$DA$D$D.apply(this,[$I$(1).aaIndex, $I$(1).helix, 0.57, 1.51]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'makeColour$F', function (c) {
return Clazz.new_($I$(2,1).c$$F$F$F,[c, 1.0 - c, c]);
});
