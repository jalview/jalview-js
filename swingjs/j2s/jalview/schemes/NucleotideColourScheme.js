...
/*c*/var C$=Clazz.newClass(P$, "NucleotideColourScheme", null, 'jalview.schemes.ResidueColourScheme');
...
;C$.superclazz.c$$IA$java_awt_ColorA.apply(this,[$I$(1).nucleotideIndex, $I$(1).nucleotide]);C$.$init$.apply(this);
}, 1);
