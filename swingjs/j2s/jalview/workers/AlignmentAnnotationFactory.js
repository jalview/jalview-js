(function(){var P$=Clazz.newPackage("jalview.workers"),I$=[[0,'jalview.bin.Jalview','jalview.workers.ColumnCounterSetWorker','jalview.workers.AnnotationWorker','jalview.datamodel.Annotation','jalview.datamodel.AlignmentAnnotation']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
