(function(){var P$=Clazz.newPackage("jalview.workers"),I$=[[0,'java.util.ArrayList','Thread','jalview.renderer.seqfeatures.FeatureRenderer','java.awt.Color','jalview.datamodel.Annotation','jalview.util.ColorUtils','jalview.util.Comparison']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
