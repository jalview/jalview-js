...
/*c*/var C$=Clazz.newClass(P$, "ShortcutKeyMaskExWrapper11", null, null, 'jalview.util.ShortcutKeyMaskExWrapperI');
...
try {
if (!$I$(1).isHeadless$()) {
return $I$(2).getDefaultToolkit$().getMenuShortcutKeyMaskEx$();
}} catch (t) {
}
return 0;
});
