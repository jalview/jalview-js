(function(){var P$=Clazz.newPackage("jalview.util"),I$=[[0,'java.util.HashMap','jalview.util.DBRefUtils','java.util.HashSet','java.util.ArrayList','com.stevesoft.pat.Regex','jalview.datamodel.DBRefEntry','jalview.datamodel.PDBEntry',['jalview.datamodel.PDBEntry','.Type'],'jalview.datamodel.DBRefSource','java.util.BitSet']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var r=Clazz.new_(["([0-9][0-9A-Za-z]{3})\\s*(.?)\\s*;\\s*([0-9]+)-([0-9]+)"],$I$(5,1).c$$S);
...
chaincode="_";
}ref=Clazz.new_($I$(6,1).c$$S$S$S,[locsrc, version, pdbid + chaincode]);
var pdbr=Clazz.new_($I$(7,1));
pdbr.setId$S(pdbid);
...
ref=Clazz.new_($I$(6,1).c$$S$S$S,[locsrc, version, acn]);
}}if (ref != null ) {
...
var bsSelect=Clazz.new_($I$(10,1));
...
C$.canonicalSourceNameLookup.put$O$O(k.toLowerCase$(), C$.canonicalSourceNameLookup.get$O(k));
}
};
...
Clazz.newMeth(C$, 'matches$jalview_datamodel_DBRefEntry$jalview_datamodel_DBRefEntry$I', function (refa, refb, mode) {
if ($I$(2,"nullOrEqualSource$S$S",[refa.getSource$(), refb.getSource$()]) && $I$(2,"nullOrEqual$O$O",[refa.getVersion$(), refb.getVersion$()]) && $I$(2,"nullOrEqual$O$O",[refa.getAccessionId$(), refb.getAccessionId$()]) && $I$(2,"nullOrEqual$O$O",[refa.getMap$(), refb.getMap$()])  ) {
return true;
}return false;
});
})()
