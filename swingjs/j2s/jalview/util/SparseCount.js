(function(){var P$=Clazz.newPackage("jalview.util"),I$=[[0,'jalview.ext.android.SparseShortArray','jalview.ext.android.SparseIntArray']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
