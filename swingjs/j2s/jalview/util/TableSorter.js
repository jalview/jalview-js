...
for (var it=this.b$['jalview.util.TableSorter'].sortingColumns.iterator$(); it.hasNext$(); ) {
var directive=it.next$();
var column=directive.column;
var o1=this.b$['jalview.util.TableSorter'].tableModel.getValueAt$I$I(row1, column);
var o2=this.b$['jalview.util.TableSorter'].tableModel.getValueAt$I$I(row2, column);
var comparison=0;
if (o1 == null  && o2 == null  ) {
comparison=0;
} else if (o1 == null ) {
...
comparison=this.b$['jalview.util.TableSorter'].getComparator$I.apply(this.b$['jalview.util.TableSorter'], [column]).compare$O$O(o1, o2);
}if (comparison != 0) {
...
if (!this.b$['jalview.util.TableSorter'].isSorting$.apply(this.b$['jalview.util.TableSorter'], [])) {
p$1.clearSortingState.apply(this.b$['jalview.util.TableSorter'], []);
...
p$1.cancelSorting.apply(this.b$['jalview.util.TableSorter'], []);
this.b$['javax.swing.table.AbstractTableModel'].fireTableChanged$javax_swing_event_TableModelEvent.apply(this.b$['javax.swing.table.AbstractTableModel'], [e]);
return;
}var column=e.getColumn$();
if (e.getFirstRow$() == e.getLastRow$() && column != -1  && this.b$['jalview.util.TableSorter'].getSortingStatus$I.apply(this.b$['jalview.util.TableSorter'], [column]) == 0  && this.b$['jalview.util.TableSorter'].modelToView != null  ) {
var viewIndex=p$1.getModelToView.apply(this.b$['jalview.util.TableSorter'], [])[e.getFirstRow$()];
this.b$['javax.swing.table.AbstractTableModel'].fireTableChanged$javax_swing_event_TableModelEvent.apply(this.b$['javax.swing.table.AbstractTableModel'], [Clazz.new_([this.b$['jalview.util.TableSorter'], viewIndex, viewIndex, column, e.getType$()],$I$(1,1).c$$javax_swing_table_TableModel$I$I$I$I)]);
return;
}p$1.clearSortingState.apply(this.b$['jalview.util.TableSorter'], []);
...
if (column != -1) {
var status=this.b$['jalview.util.TableSorter'].getSortingStatus$I.apply(this.b$['jalview.util.TableSorter'], [column]);
if (!e.isControlDown$()) {
p$1.cancelSorting.apply(this.b$['jalview.util.TableSorter'], []);
}status=status + (e.isShiftDown$() ? -1 : 1);
status=(status + 4) % 3 - 1;
this.b$['jalview.util.TableSorter'].setSortingStatus$I$I.apply(this.b$['jalview.util.TableSorter'], [column, status]);
}});
...
l.setIcon$javax_swing_Icon(this.b$['jalview.util.TableSorter'].getHeaderRendererIcon$I$I.apply(this.b$['jalview.util.TableSorter'], [modelColumn, l.getFont$().getSize$()]));
}return c;
});
