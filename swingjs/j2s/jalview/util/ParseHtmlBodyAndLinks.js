(function(){var P$=Clazz.newPackage("jalview.util"),p$1={},I$=[[0,'java.util.regex.Pattern','java.util.ArrayList','StringBuilder','java.util.Locale','java.util.StringTokenizer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (description.toUpperCase$java_util_Locale($I$(4).ROOT).indexOf$S("<HTML>") == -1) {
this.htmlContent=false;
}this.orig=description;
var st=Clazz.new_($I$(5,1).c$$S$S,[description, "<"]);
var token;
var link;
var startTag;
var tag=null;
...
}if (tag != null  && tag.toUpperCase$java_util_Locale($I$(4).ROOT).startsWith$S("A HREF=") ) {
if (token.length$() > 0) {
sb.append$S(token);
