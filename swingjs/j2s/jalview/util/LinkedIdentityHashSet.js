(function(){var P$=Clazz.newPackage("jalview.util"),p$1={},I$=[[0,'java.util.LinkedHashMap',['jalview.util.LinkedIdentityHashSet','.IdentityWrapper']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
