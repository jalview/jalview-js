(function(){var P$=Clazz.newPackage("jalview.util"),I$=[[0,'java.util.Collections','java.util.ArrayList']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
try {
var start=(Integer.valueOf$S(range[0])).valueOf();
var end=range.length == 1 ? start : (Integer.valueOf$S(range[1])).valueOf();
