...
C$.$fields$=[[]
,['O',['_JalviewModel_QNAME','javax.xml.namespace.QName','+_JalviewUserColours_QNAME','+_WebServiceParameterSet_QNAME']]]
...
return Clazz.new_($I$(53,1));
});

Clazz.newMeth(C$, 'createJalviewModel$jalview_xml_binding_jalview_JalviewModel',  function (value) {
return Clazz.new_([C$._JalviewModel_QNAME, Clazz.getClass($I$(11)), null, value],$I$(54,1).c$$javax_xml_namespace_QName$Class$Class$O);
});

Clazz.newMeth(C$, 'createJalviewUserColours$jalview_xml_binding_jalview_JalviewUserColours',  function (value) {
return Clazz.new_([C$._JalviewUserColours_QNAME, Clazz.getClass($I$(8)), null, value],$I$(54,1).c$$javax_xml_namespace_QName$Class$Class$O);
});

Clazz.newMeth(C$, 'createWebServiceParameterSet$jalview_xml_binding_jalview_WebServiceParameterSet',  function (value) {
return Clazz.new_([C$._WebServiceParameterSet_QNAME, Clazz.getClass($I$(35)), null, value],$I$(54,1).c$$javax_xml_namespace_QName$Class$Class$O);
});

C$.$static$=function(){C$.$static$=0;
C$._JalviewModel_QNAME=Clazz.new_($I$(1,1).c$$S$S,["www.jalview.org", "JalviewModel"]);
C$._JalviewUserColours_QNAME=Clazz.new_($I$(1,1).c$$S$S,["www.jalview.org/colours", "JalviewUserColours"]);
C$._WebServiceParameterSet_QNAME=Clazz.new_($I$(1,1).c$$S$S,["www.jalview.org/xml/wsparamset", "WebServiceParameterSet"]);
};
C$.$getAnn$ = function(){ return [
[[null,'jalview.xml.binding.jalview.ObjectFactory',null,['javax.xml.bind.annotation.XmlRegistry']],['']],
  [['M:createJalviewModel','javax.xml.bind.JAXBElement<jalview.xml.binding.jalview.JalviewModel>','createJalviewModel$jalview_xml_binding_jalview_JalviewModel',['javax.xml.bind.annotation.XmlElementDecl']],['namespace="www.jalview.org" name="JalviewModel" ']],
  [['M:createJalviewUserColours','javax.xml.bind.JAXBElement<jalview.xml.binding.jalview.JalviewUserColours>','createJalviewUserColours$jalview_xml_binding_jalview_JalviewUserColours',['javax.xml.bind.annotation.XmlElementDecl']],['namespace="www.jalview.org/colours" name="JalviewUserColours" ']],
  [['M:createWebServiceParameterSet','javax.xml.bind.JAXBElement<jalview.xml.binding.jalview.WebServiceParameterSet>','createWebServiceParameterSet$jalview_xml_binding_jalview_WebServiceParameterSet',['javax.xml.bind.annotation.XmlElementDecl']],['namespace="www.jalview.org/xml/wsparamset" name="WebServiceParameterSet" ']]]}
})();
