(function(){var P$=Clazz.newPackage("jalview.gui"),I$=[[0,'java.awt.print.PrinterJob','jalview.gui.ProgressBar','javax.swing.event.InternalFrameAdapter','jalview.analysis.scoremodels.ScoreModels','jalview.viewmodel.PCAModel','jalview.gui.PaintRefresher','jalview.gui.RotatableCanvas','jalview.util.MessageManager','jalview.gui.JalviewColourChooser','jalview.gui.OOMWarning','jalview.gui.Desktop','java.awt.Dimension',['jalview.math.RotatableMatrix','.Axis'],'jalview.gui.CutAndPasteTransfer',['jalview.gui.PCAPanel','.PCAPrinter'],'jalview.bin.Console','jalview.datamodel.Alignment','jalview.gui.AlignFrame','jalview.gui.ImageExporter','javax.swing.ButtonGroup','javax.swing.JRadioButtonMenuItem']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.rc.setAxisEndPoints$jalview_datamodel_PointA(null);
this.rc=null;
}});
...
this.repaint$();
if (this.getParent$() == null ) {
$I$(11,"addInternalFrame$javax_swing_JInternalFrame$S$I$I",[this, $I$(8,"formatMessage$S$OA",["label.calc_title", Clazz.array(java.lang.Object, -1, ["PCA", this.getPcaModel$().getScoreModelName$()])]), 475, 450]);
...
$I$(16).info$S("Unexpected call to originalSeqData_actionPerformed - should have hidden this menu action.");
return;
}var gc="-";
try {
...
this.b$['jalview.gui.PCAPanel'].getRotatableCanvas$.apply(this.b$['jalview.gui.PCAPanel'], []).drawBackground$java_awt_Graphics(pg);
this.b$['jalview.gui.PCAPanel'].getRotatableCanvas$.apply(this.b$['jalview.gui.PCAPanel'], []).drawScene$java_awt_Graphics(pg);
if (this.b$['jalview.gui.PCAPanel'].getRotatableCanvas$.apply(this.b$['jalview.gui.PCAPanel'], []).drawAxes) {
this.b$['jalview.gui.PCAPanel'].getRotatableCanvas$.apply(this.b$['jalview.gui.PCAPanel'], []).drawAxes$java_awt_Graphics(pg);
}if (pi == 0) {
return 0;
} else {
return 1;
