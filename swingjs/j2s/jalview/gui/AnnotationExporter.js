...
var complement=nucleotide ? $I$(5).getString$S("label.protein").toLowerCase$() : "CDS";
var label=Clazz.new_([$I$(5).formatMessage$S$OA("label.include_linked_features", [complement])],$I$(19,1).c$$S);
label.setHorizontalAlignment$I(11);
var tooltip=$I$(5).formatMessage$S$OA("label.include_linked_tooltip", [complement]);
label.setToolTipText$S($I$(20).wrapTooltip$Z$S(true, tooltip));
this.includeLinkedFeatures=Clazz.new_($I$(21,1));
...
var toFile=Clazz.new_([$I$(5).getString$S("label.to_file")],$I$(22,1).c$$S);
...
var toTextbox=Clazz.new_([$I$(5).getString$S("label.to_textbox")],$I$(22,1).c$$S);
...
var close=Clazz.new_([$I$(5).getString$S("action.close")],$I$(22,1).c$$S);
...
var buttonGroup=Clazz.new_($I$(23,1));
...
var format=Clazz.new_([$I$(5).getString$S("action.format") + " "],$I$(19,1).c$$S);
