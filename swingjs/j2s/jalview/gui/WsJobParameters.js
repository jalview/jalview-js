...
if ($I$(28).isDebugEnabled$()) {
$I$(28,"debug$S",["Item state changed for " + setname + " (handling ? " + !this.settingDialog + ")" ]);
}if (this.settingDialog) {
return;
}if (setname == null ) {
return;
...
if ($I$(29).showConfirmDialog$java_awt_Component$O$S$I(this, "Parameter set '" + lsetname + "' is modifed, and your changes will be lost.\nReally change preset ?" , "Warning: Unsaved Changes", 2) != 0) {
this.settingDialog=true;
...
Clazz.newMeth(C$, 'run$',  function () {
$I$(29,"showMessageDialog$java_awt_Component$S$S$I",[this.$finals$.ourframe, $I$(11).getString$S("label.invalid_name_preset_exists"), $I$(11).getString$S("label.invalid_name"), 2]);
});
})()
