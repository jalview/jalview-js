(function(){var P$=Clazz.newPackage("jalview.gui"),I$=[[0,'jalview.util.MessageManager','jalview.bin.Jalview','jalview.io.JalviewFileView','jalview.bin.Cache','jalview.util.Platform','java.util.concurrent.atomic.AtomicBoolean',['jalview.util.ImageMaker','.TYPE'],'jalview.gui.LineartOptions','jalview.util.ImageMaker']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
), Clazz.new_(P$.ImageExporter$1.$init$,[this, {textSelected:textSelected,messageId:messageId,chosenFile:chosenFile,height:height,width:width}]));
