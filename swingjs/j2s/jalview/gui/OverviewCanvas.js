(function(){var P$=Clazz.newPackage("jalview.gui"),I$=[[0,'java.awt.Color','jalview.gui.SequenceRenderer','jalview.renderer.seqfeatures.FeatureRenderer','jalview.bin.Cache','jalview.renderer.OverviewResColourFinder','java.awt.Dimension','jalview.renderer.OverviewRenderer','java.awt.image.BufferedImage']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
