(function(){var P$=Clazz.newPackage("jalview.gui"),p$1={},I$=[[0,'java.awt.Font','jalview.gui.ComboBoxTooltipRenderer','java.util.ArrayList','java.awt.BorderLayout','javax.swing.JInternalFrame','java.awt.Color','javax.swing.JRadioButton','jalview.util.MessageManager','javax.swing.JPanel','java.awt.FlowLayout','jalview.gui.JvSwingUtils','javax.swing.BorderFactory','javax.swing.ButtonGroup','java.awt.GridLayout','javax.swing.JCheckBox','javax.swing.JLabel','javax.swing.JButton','java.awt.Dimension','jalview.gui.Desktop','javax.swing.event.InternalFrameAdapter','javax.swing.JLayeredPane','javax.swing.JComboBox','java.awt.event.MouseAdapter','javax.swing.DefaultComboBoxModel','jalview.analysis.scoremodels.ScoreModels','jalview.bin.Cache','jalview.gui.JvOptionPane','jalview.gui.PCAPanel','Thread','jalview.analysis.scoremodels.SimilarityParams']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CalculationChooser", null, 'javax.swing.JPanel');

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.renderer=Clazz.new_($I$(2,1));
this.tips=Clazz.new_($I$(3,1));
},1);

C$.$fields$=[['O',['af','jalview.gui.AlignFrame','pca','javax.swing.JRadioButton','+neighbourJoining','+averageDistance','modelNames','javax.swing.JComboBox','calculate','javax.swing.JButton','frame','javax.swing.JInternalFrame','includeGaps','javax.swing.JCheckBox','+matchGaps','+includeGappedColumns','+shorterSequence','renderer','jalview.gui.ComboBoxTooltipRenderer','tips','java.util.List','pcaPanel','jalview.gui.PCAPanel']]
,['Z',['treeMatchGaps'],'O',['VERDANA_11PT','java.awt.Font']]]
...
(function(){/*a*/var C$=Clazz.newClass(P$, "CalculationChooser$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.FocusListener', 1);
...
this.pca=Clazz.new_([$I$(8).getString$S("label.principal_component_analysis")],$I$(7,1).c$$S);
this.pca.setOpaque$Z(false);
this.neighbourJoining=Clazz.new_([$I$(8).getString$S("label.tree_calc_nj")],$I$(7,1).c$$S);
this.neighbourJoining.setSelected$Z(true);
this.neighbourJoining.setOpaque$Z(false);
this.averageDistance=Clazz.new_([$I$(8).getString$S("label.tree_calc_av")],$I$(7,1).c$$S);
this.averageDistance.setOpaque$Z(false);
var calcChoicePanel=Clazz.new_([Clazz.new_($I$(10,1).c$$I,[0])],$I$(9,1).c$$java_awt_LayoutManager);
calcChoicePanel.setOpaque$Z(false);
var treePanel=Clazz.new_([Clazz.new_($I$(10,1).c$$I,[0])],$I$(9,1).c$$java_awt_LayoutManager);
treePanel.setOpaque$Z(false);
$I$(11,"createTitledBorder$javax_swing_JComponent$S$Z",[treePanel, $I$(8).getString$S("label.tree"), true]);
var pcaBorderless=Clazz.new_([Clazz.new_($I$(10,1).c$$I,[0])],$I$(9,1).c$$java_awt_LayoutManager);
...
var calcTypes=Clazz.new_($I$(13,1));
...
(function(){/*a*/var C$=Clazz.newClass(P$, "CalculationChooser$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var scoreModelPanel=Clazz.new_([Clazz.new_($I$(10,1).c$$I,[1])],$I$(9,1).c$$java_awt_LayoutManager);
scoreModelPanel.setOpaque$Z(false);
scoreModelPanel.add$java_awt_Component(this.modelNames);
var paramsPanel=Clazz.new_([Clazz.new_($I$(14,1).c$$I$I,[5, 1])],$I$(9,1).c$$java_awt_LayoutManager);
paramsPanel.setOpaque$Z(false);
this.includeGaps=Clazz.new_($I$(15,1).c$$S,["Include gaps"]);
this.matchGaps=Clazz.new_($I$(15,1).c$$S,["Match gaps"]);
this.includeGappedColumns=Clazz.new_($I$(15,1).c$$S,["Include gapped columns"]);
this.shorterSequence=Clazz.new_($I$(15,1).c$$S,["Match on shorter sequence"]);
paramsPanel.add$java_awt_Component(Clazz.new_($I$(16,1).c$$S,["Pairwise sequence scoring options"]));
...
this.calculate=Clazz.new_([$I$(8).getString$S("action.calculate")],$I$(17,1).c$$S);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "CalculationChooser$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var close=Clazz.new_([$I$(8).getString$S("action.close")],$I$(17,1).c$$S);
close.setFont$java_awt_Font(C$.VERDANA_11PT);
close.addActionListener$java_awt_event_ActionListener(((P$.CalculationChooser$4||
(function(){/*a*/var C$=Clazz.newClass(P$, "CalculationChooser$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var actionPanel=Clazz.new_($I$(9,1));
...
this.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(18,1).c$$I$I,[325, height - 10]));
...
(function(){/*a*/var C$=Clazz.newClass(P$, "CalculationChooser$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('javax.swing.event.InternalFrameAdapter'), null, 1);
...
), Clazz.new_($I$(20,1),[this, null],P$.CalculationChooser$5)));
...
var ttip=$I$(8,"formatMessage$S$OA",["label.you_need_at_least_n_sequences", Clazz.array(java.lang.Object, -1, [Integer.valueOf$I(minsize)])]);
...
var scoreModelsCombo=Clazz.new_($I$(22,1));
scoreModelsCombo.setRenderer$javax_swing_ListCellRenderer(this.renderer);
var mouseListener=((P$.CalculationChooser$6||
(function(){/*a*/var C$=Clazz.newClass(P$, "CalculationChooser$6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseAdapter'), null, 1);
...
), Clazz.new_($I$(23,1),[this, {scoreModelsCombo:scoreModelsCombo}],P$.CalculationChooser$6));
...
filtered.add$O(scoreModels.getBlosum62$());
}return filtered;
}, 1);
...
$I$(27,"showMessageDialog$java_awt_Component$S$S$I",[$I$(19).desktop, $I$(8,"formatMessage$S$OA",["label.you_need_at_least_n_sequences", Clazz.array(java.lang.Object, -1, [Integer.valueOf$I(3)])]), $I$(8).getString$S("label.not_enough_sequences"), 2]);
return;
...
$I$(27,"showInternalMessageDialog$java_awt_Component$S$S$I",[this, $I$(8,"formatMessage$S$OA",["label.you_need_at_least_n_sequences", Clazz.array(java.lang.Object, -1, [Integer.valueOf$I(4)])]), $I$(8).getString$S("label.sequence_selection_insufficient"), 2]);
return;
}this.pcaPanel=Clazz.new_($I$(28,1).c$$jalview_gui_AlignmentPanel$S$jalview_api_analysis_SimilarityParamsI,[this.af.alignPanel, modelName, params]);
Clazz.new_($I$(29,1).c$$Runnable,[this.pcaPanel]).start$();
});
...
return Clazz.new_($I$(30,1).c$$Z$Z$Z$Z,[includeGapGap, matchGap, includeGapResidue, matchOnShortestLength]);
});
