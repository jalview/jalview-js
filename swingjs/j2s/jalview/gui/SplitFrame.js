...
if (c != null  && Clazz.instanceOf(c, "jalview.gui.AlignFrame") ) {
var af=c;
var dna=af.getViewport$().getAlignment$().isNucleotide$();
var scope=$I$(1).getString$S("label.in") + " " + (dna ? $I$(1).getString$S("label.nucleotide") : $I$(1).getString$S("label.protein")) ;
Clazz.new_($I$(12,1).c$$jalview_gui_AlignmentPanel$Z$S,[af.alignPanel, true, scope]);
}});
})()
...
this.featureSettingsPanels.insertTab$S$javax_swing_Icon$java_awt_Component$S$I(this.tabName[0], null, featureSettings, $I$(1,"formatMessage$S$OA",["label.sequence_feature_settings_for", Clazz.array(java.lang.Object, -1, [this.tabName[0]])]), 0);
}if (pos == 1) {
this.featureSettingsPanels.removeTabAt$I(1);
this.featureSettingsPanels.insertTab$S$javax_swing_Icon$java_awt_Component$S$I(this.tabName[1], null, featureSettings, $I$(1,"formatMessage$S$OA",["label.sequence_feature_settings_for", Clazz.array(java.lang.Object, -1, [this.tabName[1]])]), 1);
}this.featureSettingsPanels.setSelectedComponent$java_awt_Component(featureSettings);
...
this.featureSettingsPanels.insertTab$S$javax_swing_Icon$java_awt_Component$S$I(this.tabName[tabIndex], null, dummyTab, $I$(1,"formatMessage$S$OA",["label.sequence_feature_settings_for", Clazz.array(java.lang.Object, -1, [this.tabName[tabIndex]])]), tabIndex);
}}}
}, p$1);
