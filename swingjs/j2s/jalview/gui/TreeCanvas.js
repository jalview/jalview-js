...
nodeLabel=Clazz.new_($I$(5,1).c$$S,["%g"]).form$D(node.dist);
...
for (var entry, $entry = this.nameHash.entrySet$().iterator$(); $entry.hasNext$()&&((entry=($entry.next$())),1);) {
var rect=entry.getValue$();
if ((x >= rect.x) && (x <= (rect.x + rect.width)) && (y >= rect.y) && (y <= (rect.y + rect.height))  ) {
return entry.getKey$();
}}
for (var entry, $entry = this.nodeHash.entrySet$().iterator$(); $entry.hasNext$()&&((entry=($entry.next$())),1);) {
var rect=entry.getValue$();
if ((x >= rect.x) && (x <= (rect.x + rect.width)) && (y >= rect.y) && (y <= (rect.y + rect.height))  ) {
return entry.getKey$();
}}
...
var nameCount=this.nameHash.size$();
if (nameCount == 0) {
this.repaint$();
...
this.setPreferredSize$java_awt_Dimension(Clazz.new_([this.scrollPane.getWidth$(), this.fm.getHeight$() * nameCount],$I$(11,1).c$$I$I));
this.draw$java_awt_Graphics$I$I(g, this.scrollPane.getWidth$(), this.fm.getHeight$() * nameCount);
