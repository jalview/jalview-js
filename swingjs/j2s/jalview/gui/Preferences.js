...
C$.$fields$=[['O',['frame','javax.swing.JInternalFrame','wsPrefs','jalview.gui.WsPreferences','promptEachTimeOpt','jalview.gui.Preferences.OptionsParam','+lineArtOpt','+textOpt']]
,['O',['sequenceUrlLinks','jalview.urls.api.UrlProviderI','dataModel','jalview.urls.UrlLinkTableModel','groupURLLinks','java.util.List']]]
...
var sorter=Clazz.new_([this.linkUrlTable.getModel$()],$I$(18,1).c$$javax_swing_table_TableModel);
this.linkUrlTable.setRowSorter$javax_swing_RowSorter(sorter);
var sortKeys=Clazz.new_($I$(4,1));
var m=this.linkUrlTable.getModel$();
sortKeys.add$O(Clazz.new_([m.getPrimaryColumn$(), $I$(20).DESCENDING],$I$(19,1).c$$I$javax_swing_SortOrder));
sortKeys.add$O(Clazz.new_([m.getSelectedColumn$(), $I$(20).DESCENDING],$I$(19,1).c$$I$javax_swing_SortOrder));
sortKeys.add$O(Clazz.new_([m.getNameColumn$(), $I$(20).ASCENDING],$I$(19,1).c$$I$javax_swing_SortOrder));
...
), Clazz.new_($I$(21,1),[this, null],P$.Preferences$3));
var customSorter=Clazz.new_([this.linkUrlTable.getModel$()],$I$(18,1).c$$javax_swing_table_TableModel);
...
this.linkUrlTable.getSelectionModel$().addListSelectionListener$javax_swing_event_ListSelectionListener(Clazz.new_($I$(22,1),[this, null]));
var onClickCol=(this.linkUrlTable.getModel$()).getPrimaryColumn$();
var onClickName=this.linkUrlTable.getColumnName$I(onClickCol);
this.linkUrlTable.getColumn$O(onClickName).setCellRenderer$javax_swing_table_TableCellRenderer(Clazz.new_($I$(23,1),[this, null]));
this.linkUrlTable.getColumn$O(onClickName).setCellEditor$javax_swing_table_TableCellEditor(Clazz.new_($I$(24,1),[this, null]));
...
$I$(28).backupfilesPresetEntriesValues.put$O$O(new Integer(0), customBFPE);
$I$(1).applicationProperties.setProperty$S$S("BACKUPFILES_CUSTOM", customBFPE.toString());
}var savedBFPE=$I$(28).backupfilesPresetEntriesValues.get$O(new Integer(preset));
...
var f=Clazz.new_([this.chimeraPath.getText$()],$I$(34,1).c$$S);
if (!f.canExecute$()) {
$I$(32,"showInternalMessageDialog$java_awt_Component$S$S$I",[$I$(9).desktop, $I$(6).getString$S("label.invalid_chimera_path"), $I$(6).getString$S("label.invalid_name"), 0]);
return false;
}}return true;
}, p$1);
...
var paths=$I$(35).getChimeraPaths$();
paths.add$I$O(0, this.chimeraPath.getText$());
...
var showHelp=$I$(36,"showInternalOptionDialog$java_awt_Component$O$S$I$I$javax_swing_Icon$OA$O",[$I$(9).desktop, $I$(37,"wrapTooltip$Z$S",[true, $I$(6).getString$S("label.chimera_missing")]), "", 0, 2, null, options, options[0]]);
if (showHelp == 1) {
try {
$I$(38,"showHelpWindow$jalview_gui_Help_HelpId",[$I$(39).StructureViewer]);
} catch (e) {
