...
), Clazz.new_(P$.AnnotationLabels$1.$init$,[this, {addNew:addNew,annotation:annotation,dialog:dialog}])));
});
...
), Clazz.new_(P$.AnnotationLabels$3.$init$,[this, {ap:ap,aaa:aaa,cbmi:cbmi}])));
...
), Clazz.new_(P$.AnnotationLabels$4.$init$,[this, {ap:ap,aaa:aaa,chist:chist}])));
...
), Clazz.new_(P$.AnnotationLabels$5.$init$,[this, {ap:ap,cprofl:cprofl,aaa:aaa}])));
...
), Clazz.new_(P$.AnnotationLabels$6.$init$,[this, {ap:ap,cproflnorm:cproflnorm,aaa:aaa}])));
...
), Clazz.new_(P$.AnnotationLabels$8.$init$,[this, {cprof:cprof,ap:ap}])));
...
if (!desc.toLowerCase$java_util_Locale($I$(15).ROOT).startsWith$S("<html>")) {
tooltip.append$S("<html>");
desc=desc.replace$CharSequence$CharSequence("<", "&lt;");
} else if (desc.toLowerCase$java_util_Locale($I$(15).ROOT).endsWith$S("</html>")) {
...
this.setCursor$java_awt_Cursor($I$(16).getPredefinedCursor$I(this.resizePanel ? 9 : 0));
this.repaint$();
}});

Clazz.newMeth(C$, 'mouseClicked$java_awt_event_MouseEvent',  function (evt) {
var aa=this.ap.av.getAlignment$().getAlignmentAnnotation$();
if (!evt.isPopupTrigger$() && $I$(17).isLeftMouseButton$java_awt_event_MouseEvent(evt) ) {
...
if (sg == null  || sg === aa[this.selectedRow].groupRef   || !($I$(18).isControlDown$java_awt_event_MouseEvent(evt) || evt.isShiftDown$() ) ) {
if ($I$(18).isControlDown$java_awt_event_MouseEvent(evt) || evt.isShiftDown$() ) {
this.ap.av.setSelectionGroup$jalview_datamodel_SequenceGroup(Clazz.new_($I$(19,1).c$$jalview_datamodel_SequenceGroup,[aa[this.selectedRow].groupRef]));
} else {
...
if ($I$(18).isControlDown$java_awt_event_MouseEvent(evt)) {
...
$I$(20,"Refresh$java_awt_Component$S",[this.ap, this.ap.av.getSequenceSetId$()]);
...
this.ap.getSeqPanel$().ap.getIdPanel$().highlightSearchResults$java_util_List($I$(21,"asList$OA",[Clazz.array($I$(22), -1, [aa[this.selectedRow].sequenceRef])]));
} else if (evt.getClickCount$() >= 2) {
this.ap.getSeqPanel$().ap.getIdPanel$().highlightSearchResults$java_util_List(null);
var sg=this.ap.av.getSelectionGroup$();
if (sg != null ) {
if (!($I$(18).isControlDown$java_awt_event_MouseEvent(evt) || evt.isShiftDown$() )) {
sg=Clazz.new_($I$(19,1).c$$jalview_datamodel_SequenceGroup,[sg]);
sg.clear$();
...
var seqs=Clazz.array($I$(22), -1, [sq]);
var omitHidden=null;
var dseqs=Clazz.array($I$(22), -1, [sq.getDatasetSequence$()]);
if (dseqs[0] == null ) {
dseqs[0]=Clazz.new_($I$(23,1).c$$jalview_datamodel_SequenceI,[sq]);
dseqs[0].setSequence$S($I$(24,"extractGaps$S$S",[$I$(25).GapChars, sq.getSequenceAsString$()]));
sq.setDatasetSequence$jalview_datamodel_SequenceI(dseqs[0]);
}var ds=Clazz.new_($I$(26,1).c$$jalview_datamodel_SequenceIA,[dseqs]);
...
}var output=Clazz.new_($I$(27,1)).formatSequences$jalview_io_FileFormatI$jalview_datamodel_SequenceIA$SA$IA($I$(28).Fasta, seqs, omitHidden, alignmentStartEnd);
$I$(29).getDefaultToolkit$().getSystemClipboard$().setContents$java_awt_datatransfer_Transferable$java_awt_datatransfer_ClipboardOwner(Clazz.new_($I$(30,1).c$$S,[output]), $I$(31).instance);
var hiddenColumns=null;
if (this.av.hasHiddenColumns$()) {
hiddenColumns=Clazz.new_([this.av.getAlignment$().getHiddenColumns$()],$I$(32,1).c$$jalview_datamodel_HiddenColumns);
}$I$(31).jalviewClipboard=Clazz.array(java.lang.Object, -1, [seqs, ds, hiddenColumns]);
});
...
g2.setRenderingHint$java_awt_RenderingHints_Key$O($I$(33).KEY_ANTIALIASING, $I$(33).VALUE_ANTIALIAS_ON);
...
fontHeight=-8 + (h|0);
s=(fontHeight) / ofontH;
var f=baseFont.deriveFont$java_awt_geom_AffineTransform($I$(35).getScaleInstance$D$D(s, s));
...
g.setColor$java_awt_Color($I$(34).lightGray);
