...
if (this.b$['jalview.gui.BlogReader'].$parent != null ) {
$I$(12).debug$S("News window closed.");
this.b$['jalview.gui.BlogReader'].jd=null;
this.b$['jalview.gui.BlogReader'].$parent.showNews$Z(false);
}});
...
Clazz.super_(C$, this);
$I$(12).debug$S("Constructing news reader.");
this.$parent=desktop;
this._channelModel=Clazz.new_($I$(14,1));
var chan=Clazz.new_($I$(15,1));
chan.setURL$S($I$(16,"getDefault$S$S",["JALVIEW_NEWS_RSS", $I$(16).getDefault$S$S("www.jalview.org", "https://www.jalview.org") + "/feeds/desktop/rss"]));
...
this.updating=false;
if (!$I$(16).getDefault$S$Z("NONEWS", false)) {
var setvisible=p$1.checkForNew$org_robsite_jswingreader_model_Channel$Z.apply(this, [chan, true]);
if (setvisible) {
$I$(12).debug$S("Will show jalview news automatically");
this.showNews$();
}}$I$(12).debug$S("Completed construction of reader.");
}, 1);
...
var me=this;
$I$(17,"invokeLater$Runnable",[((P$.BlogReader$3||
...
var bounds=Clazz.new_($I$(18,1).c$$I$I$I$I,[5, 5, 550, 350]);
if (this.b$['jalview.gui.BlogReader'].$parent == null ) {
this.b$['jalview.gui.BlogReader'].xf=Clazz.new_($I$(19,1));
...
var actionEvent=Clazz.new_([this, 1001, this.b$['jalview.gui.BlogReader'].exitAction.getValue$S("Name")],$I$(20,1).c$$O$I$S);
...
), Clazz.new_($I$(21,1),[this, null],P$.BlogReader$3$1)));
this.$finals$.me.setSize$java_awt_Dimension(Clazz.new_($I$(22,1).c$$I$I,[550, 350]));
this.b$['jalview.gui.BlogReader'].xf.setVisible$Z(true);
} else {
p$1.createDialog.apply(this.b$['jalview.gui.BlogReader'], []);
bounds=Clazz.new_($I$(18,1).c$$I$I$I$I,[5, 5, 550, 350]);
this.b$['jalview.gui.BlogReader'].jd.initDialogFrame$java_awt_Container$Z$Z$S$I$I(this.$finals$.me, false, false, $I$(23).getString$S("label.news_from_jalview"), bounds.width, bounds.height);
this.b$['jalview.gui.BlogReader'].jd.frame.setModalExclusionType$java_awt_Dialog_ModalExclusionType($I$(24).NO_EXCLUDE);
$I$(12).debug$S("Displaying news.");
...
try {
earliest=Clazz.new_($I$(25,1).c$$S,["YYYY-MM-DD"]).parse$S(chan.getHTTPLastModified$());
} catch (x) {
...
$I$(12,"debug$S",["Scanning news items: newsnew=" + this.newsnew + " and lastDate is " + this.lastDate ]);
...
if (!this.updating || updateItems ) {
this.newsnew=!!(this.newsnew|(!isread));
}if (updateItems) {
i.setRead$Z(isread);
...
this.lastDate=$I$(16).getDateProperty$S("JALVIEW_NEWS_RSS_LASTMODIFIED");
}, p$1);
...
var formatted=$I$(16).setDateProperty$S$java_util_Date("JALVIEW_NEWS_RSS_LASTMODIFIED", this.lastDate);
$I$(12).debug$S("Saved last read date as " + formatted);
}}}, p$1);
...
var spTextDescription=Clazz.new_($I$(26,1).c$$java_awt_Component,[this.textDescription]);
this.textDescription.setText$S("");
this.statusBar.setText$S(Clazz.new_($I$(27,1).c$$S,["["]).append$S($I$(23).getString$S("label.status")).append$S("]").toString());
...
var spListItems=Clazz.new_($I$(26,1).c$$java_awt_Component,[this.listItems]);
...
), Clazz.new_($I$(28,1),[this, null],P$.BlogReader$5)));
this._popupItems=p$1._buildItemsPopupMenu.apply(this, []);
this._popupChannels=p$1._buildChannelsPopupMenu.apply(this, []);
var popupAdapter=Clazz.new_($I$(29,1).c$$javax_swing_JPopupMenu,[this._popupItems]);
var popupChannelsAdapter=Clazz.new_($I$(29,1).c$$javax_swing_JPopupMenu,[this._popupChannels]);
this.listItems.addMouseListener$java_awt_event_MouseListener(popupAdapter);
this.listItems.setCellRenderer$javax_swing_ListCellRenderer(Clazz.new_($I$(30,1)));
this.lblChannels.setText$S($I$(23).getString$S("label.channels"));
}, p$1);
...
if (e.getEventType$() === $I$(31).ACTIVATED ) {
...
this._itemTimer=Clazz.new_($I$(32,1).c$$javax_swing_JList$javax_swing_JList,[this.listChannels, this.listItems]);
...
popup.add$javax_swing_JMenuItem(Clazz.new_([Clazz.new_($I$(35,1).c$$javax_swing_JList,[this, null, this.listItems])],$I$(34,1).c$$javax_swing_Action));
popup.addSeparator$();
popup.add$javax_swing_JMenuItem(Clazz.new_([Clazz.new_($I$(36,1).c$$javax_swing_JList,[this.listItems])],$I$(34,1).c$$javax_swing_Action));
popup.add$javax_swing_JMenuItem(Clazz.new_([Clazz.new_($I$(37,1).c$$javax_swing_JList,[this.listItems])],$I$(34,1).c$$javax_swing_Action));
return popup;
}, p$1);

Clazz.newMeth(C$, '_buildChannelsPopupMenu',  function () {
var popup=Clazz.new_($I$(33,1));
popup.add$javax_swing_JMenuItem(Clazz.new_([Clazz.new_($I$(38,1).c$$javax_swing_JList$javax_swing_JList,[this.listChannels, this.listItems])],$I$(34,1).c$$javax_swing_Action));
popup.add$javax_swing_JMenuItem(Clazz.new_([Clazz.new_($I$(39,1).c$$javax_swing_JList$javax_swing_JList,[this.listChannels, this.listItems])],$I$(34,1).c$$javax_swing_Action));
return popup;
}, p$1);
...
try {
$I$(40).parse$org_robsite_jswingreader_model_Channel(channel);
} catch (ex) {
...
itemsModel.clear$();
var iter=(channel.getItems$() != null ) ? channel.getItems$().iterator$() : $I$(41).EMPTY_LIST.iterator$();
while (iter.hasNext$()){
...
var general=$I$(43).getPreferences$().get$O("general");
if (general == null ) {
return;
...
if (Boolean.toString$Z(false).equals$O(general.get$O("useToolBarText"))) {
button.setText$S("");
}if (Boolean.toString$Z(true).equals$O(general.get$O("radioTextBelow"))) {
button.setVerticalTextPosition$I(3);
button.setHorizontalTextPosition$I(0);
} else if (Boolean.toString$Z(true).equals$O(general.get$O("radioTextRight"))) {
...
}var action=Clazz.new_($I$(35,1).c$$javax_swing_JList,[this, null, this.listItems]);
var event=Clazz.new_($I$(20,1).c$$O$I$S,[this, 1001, "LaunchBrowserOnItem"]);
