(function(){var P$=Clazz.newPackage("jalview.gui"),p$1={},I$=[[0,'javax.swing.JCheckBox','javax.swing.JPanel','java.util.Hashtable','javax.swing.JInternalFrame','javax.swing.JLayeredPane','jalview.gui.Desktop','jalview.util.MessageManager','java.awt.Dimension','javax.swing.JComboBox','Error','jalview.gui.JvSwingUtils','javax.swing.BorderFactory','java.awt.event.MouseAdapter','javax.swing.JButton','java.awt.Color','java.awt.BorderLayout','net.miginfocom.swing.MigLayout','java.awt.FlowLayout','jalview.bin.Cache','jalview.gui.JalviewColourChooser','jalview.datamodel.GraphLine','jalview.schemes.AnnotationColourGradient']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "AnnotationColourChooser", null, 'jalview.gui.AnnotationRowFilter');

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.useOriginalColours=Clazz.new_($I$(1,1));
this.minColour=Clazz.new_($I$(2,1));
this.maxColour=Clazz.new_($I$(2,1));
this.thresholdIsMin=Clazz.new_($I$(1,1));
},1);

C$.$fields$=[['O',['oldcs','jalview.schemes.ColourSchemeI','defColours','javax.swing.JButton','oldgroupColours','java.util.Hashtable','useOriginalColours','javax.swing.JCheckBox','minColour','javax.swing.JPanel','+maxColour','thresholdIsMin','javax.swing.JCheckBox']]]
...
this.oldgroupColours=Clazz.new_($I$(3,1));
...
this.frame.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(8,1).c$$I$I,[500, 240]));
...
this.annotations=Clazz.new_($I$(9,1).c$$java_util_Vector,[annotItems]);
...
break;
default:
throw Clazz.new_([$I$(7).getString$S("error.implementation_error_dont_know_about_threshold_setting")],$I$(10,1).c$$S);
}
this.thresholdIsMin.setSelected$Z(acg.isThresholdIsMinMax$());
this.thresholdValue.setText$S(String.valueOf$F(acg.getAnnotationThreshold$()));
}this.jbInit$();
...
this.minColour.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(8,1).c$$I$I,[40, 20]));
...
(function(){/*a*/var C$=Clazz.newClass(P$, "AnnotationColourChooser$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseAdapter'), null, 1);
...
), Clazz.new_($I$(13,1),[this, null],P$.AnnotationColourChooser$1)));
...
this.maxColour.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(8,1).c$$I$I,[40, 20]));
...
(function(){/*a*/var C$=Clazz.newClass(P$, "AnnotationColourChooser$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseAdapter'), null, 1);
...
), Clazz.new_($I$(13,1),[this, null],P$.AnnotationColourChooser$2)));
this.defColours=Clazz.new_($I$(14,1));
...
(function(){/*a*/var C$=Clazz.newClass(P$, "AnnotationColourChooser$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "AnnotationColourChooser$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "AnnotationColourChooser$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "AnnotationColourChooser$6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var jPanel1=Clazz.new_($I$(2,1));
var jPanel2=Clazz.new_($I$(2,1));
jPanel2.setLayout$java_awt_LayoutManager(Clazz.new_($I$(17,1).c$$S$S$S,["", "[left][center][right]", "[][][]"]));
...
var colpanel=Clazz.new_([Clazz.new_($I$(18,1))],$I$(2,1).c$$java_awt_LayoutManager);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "AnnotationColourChooser$7", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, [['jalview.gui.JalviewColourChooser','jalview.gui.JalviewColourChooser.ColourChooserListener']], 1);
...
var currentAnnotation=this.getCurrentAnnotation$();
...
currentAnnotation.setThreshold$jalview_datamodel_GraphLine(Clazz.new_([(currentAnnotation.graphMax - currentAnnotation.graphMin) / 2.0, "Threshold", $I$(15).black],$I$(21,1).c$$F$S$java_awt_Color));
}if (selectedThresholdItem != -1) {
this.adjusting=true;
this.setSliderModel$F$F$F(currentAnnotation.graphMin, currentAnnotation.graphMax, currentAnnotation.threshold.value);
this.slider.setEnabled$Z(true);
this.setThresholdValueText$();
this.thresholdValue.setEnabled$Z(true);
this.adjusting=false;
}this.colorAlignmentContaining$jalview_datamodel_AlignmentAnnotation$I(currentAnnotation, selectedThresholdItem);
...
acg=Clazz.new_([currentAnn, this.av.getGlobalColourScheme$(), selectedThresholdOption],$I$(22,1).c$$jalview_datamodel_AlignmentAnnotation$jalview_schemes_ColourSchemeI$I);
} else {
acg=Clazz.new_([currentAnn, this.minColour.getBackground$(), this.maxColour.getBackground$(), selectedThresholdOption],$I$(22,1).c$$jalview_datamodel_AlignmentAnnotation$java_awt_Color$java_awt_Color$I);
