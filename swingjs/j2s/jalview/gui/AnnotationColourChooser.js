(function(){var P$=Clazz.newPackage("jalview.gui"),p$1={},I$=[[0,'javax.swing.JCheckBox','javax.swing.JPanel','java.util.Hashtable','javax.swing.JInternalFrame','javax.swing.JLayeredPane','jalview.gui.Desktop','jalview.util.MessageManager','java.awt.Dimension','javax.swing.JComboBox','Error','jalview.gui.JvSwingUtils','javax.swing.BorderFactory','java.awt.event.MouseAdapter','javax.swing.JButton','java.awt.Color','java.awt.BorderLayout','net.miginfocom.swing.MigLayout','java.awt.FlowLayout','jalview.bin.Cache','jalview.gui.JalviewColourChooser','jalview.datamodel.GraphLine','jalview.schemes.AnnotationColourGradient']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.getCurrentAnnotation$().setThreshold$jalview_datamodel_GraphLine(Clazz.new_([(this.getCurrentAnnotation$().graphMax - this.getCurrentAnnotation$().graphMin) / 2.0, "Threshold", $I$(15).black],$I$(21,1).c$$F$S$java_awt_Color));
}if (selectedThresholdItem != -1) {
this.adjusting=true;
