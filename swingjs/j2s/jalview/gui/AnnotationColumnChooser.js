...
currentAnnotation.setThreshold$jalview_datamodel_GraphLine(Clazz.new_([(currentAnnotation.graphMax - currentAnnotation.graphMin) / 2.0, "Threshold", $I$(19).black],$I$(26,1).c$$F$S$java_awt_Color));
}this.adjusting=true;
...
filterParams.setThresholdValue$F(currentAnnotation.threshold.value);
if (selectedThresholdItem == 1) {
...
this.av.getColumnSelection$().filterAnnotations$jalview_datamodel_AnnotationA$jalview_viewmodel_annotationfilter_AnnotationFilterParameter(currentAnnotation.annotations, filterParams);
...
this.searchBox=Clazz.new_($I$(8,1).c$$S$I,["CACHE.SELECT_FILTER_BY_ANNOT", 23]);
},1);
...
var labelTtip=$I$(7,"formatMessage$S$OA",["info.search_in_annotation_label", Clazz.array(java.lang.Object, -1, [this.b$['jalview.gui.AnnotationColumnChooser'].annotations.getSelectedItem$().toString()])]);
var descTtip=$I$(7,"formatMessage$S$OA",["info.search_in_annotation_description", Clazz.array(java.lang.Object, -1, [this.b$['jalview.gui.AnnotationColumnChooser'].annotations.getSelectedItem$().toString()])]);
