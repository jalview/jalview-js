(function(){var P$=Clazz.newPackage("jalview.gui"),p$1={},p$2={},I$=[[0,'javax.swing.JCheckBox','javax.swing.JLabel','javax.swing.JComboBox','java.awt.BorderLayout','java.awt.Font','jalview.gui.JvSwingUtils','jalview.util.MessageManager','java.awt.GridLayout','jalview.gui.OptsAndParamsPage','javax.swing.JPanel','javax.swing.JScrollPane','javax.swing.JButton','javax.swing.JTextArea',['jalview.ws.params.ValueConstrainI','.ValueType'],'net.miginfocom.swing.MigLayout','java.awt.Dimension','javax.swing.border.TitledBorder','java.awt.Rectangle',['java.awt.Component','.BaselineResizeBehavior'],'javax.swing.JSlider','javax.swing.JTextField','java.util.LinkedHashMap','javax.swing.JPopupMenu','javax.swing.JMenuItem','jalview.gui.Desktop',['jalview.gui.OptsAndParamsPage','.OptionBox'],['jalview.gui.OptsAndParamsPage','.ParamBox'],'Error','java.util.ArrayList']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.optSet=Clazz.new_($I$(22,1));
this.paramSet=Clazz.new_($I$(22,1));
},1);
...
var mnu=Clazz.new_($I$(23,1));
var mitem=Clazz.new_([$I$(7,"formatMessage$S$SA",["label.view_params", Clazz.array(String, -1, [finfo])])],$I$(24,1).c$$S);
...
$I$(25).showUrl$S(this.$finals$.finfo);
});
})()
...
if (cb == null ) {
cb=Clazz.new_($I$(26,1).c$$jalview_ws_params_OptionI,[this, null, opt]);
...
if (pb == null ) {
pb=Clazz.new_($I$(27,1).c$$jalview_gui_OptsParametersContainerI$jalview_ws_params_ParameterI,[this, null, this.poparent, arg]);
...
throw Clazz.new_([$I$(7,"formatMessage$S$SA",["error.invalid_value_for_option", Clazz.array(String, -1, [string, option.getName$()])])],$I$(28,1).c$$S);
...
C$.$fields$=[['Z',['adjusting','choice','descisvisible','integ'],'O',['choicebox','javax.swing.JComboBox','controlPanel','javax.swing.JPanel','descPanel','javax.swing.JScrollPane','finfo','java.net.URL','lastVal','java.lang.Object','parameter','jalview.ws.params.ParameterI','pmdialogbox','jalview.gui.OptsParametersContainerI','settingPanel','javax.swing.JPanel','showDesc','javax.swing.JButton','slider','javax.swing.JSlider','string','javax.swing.JTextArea','validator','jalview.ws.params.ValueConstrainI','valueField','javax.swing.JTextField']]]
...
iVal=(Integer.valueOf$S(this.valueField.getText$())).valueOf();
