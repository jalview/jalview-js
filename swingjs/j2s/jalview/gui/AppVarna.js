...
var m=(rnaTrim.findPair$I(i).get$I(1)).$c();
var l=(rnaTrim.findPair$I(i).get$I(0)).$c();
...
this.b$['jalview.gui.AppVarna'].vab.updateSelectedRNA$fr_orsay_lri_varna_models_rna_RNA(this._lastRNAhighlighted);
this._lastRNAhighlighted=null;
