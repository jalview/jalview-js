...
var al=Clazz.new_($I$(21,1).c$$jalview_datamodel_SequenceIA,[alAndColsel[0]]);
...
var af=Clazz.new_($I$(22,1).c$$jalview_datamodel_AlignmentI$jalview_datamodel_HiddenColumns$I$I,[al, alAndColsel[1], 700, 500]);
...
var commands=Clazz.new_($I$(23,1));
...
var undo;
undo=Clazz.new_(["Tree Sort", oldOrder, viewport.getAlignment$()],$I$(25,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI);
...
return;
}Clazz.new_($I$(26,1).c$$jalview_gui_TreePanel,[this]);
});
...
var exporter=Clazz.new_($I$(27,1).c$$jalview_gui_ImageExporter_ImageWriterI$jalview_gui_IProgressIndicator$jalview_util_ImageMaker_TYPE$S,[writer, null, imageFormat, tree]);
...
var width=this.treeCanvas.getWidth$();
var height=this.treeCanvas.getHeight$();
var out=Clazz.new_($I$(29,1).c$$java_io_File,[outFile]);
var pg=Clazz.new_($I$(30,1).c$$S$java_io_OutputStream$I$I$I$I,["Tree", out, 0, 0, width, height]);
...
this.this$0.tree=Clazz.new_([this.this$0.av.getAlignment$().getSequencesArray$(), this.odata, this.newtree],$I$(1,1).c$$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentView$jalview_io_NewickFile);
...
var njtree=this.this$0.treeType.equals$O("NJ") ? Clazz.new_($I$(3,1).c$$jalview_viewmodel_AlignmentViewport$jalview_api_analysis_ScoreModelI$jalview_api_analysis_SimilarityParamsI,[this.this$0.av, sm, this.this$0.similarityParams]) : Clazz.new_($I$(4,1).c$$jalview_viewmodel_AlignmentViewport$jalview_api_analysis_ScoreModelI$jalview_api_analysis_SimilarityParamsI,[this.this$0.av, sm, this.this$0.similarityParams]);
this.this$0.tree=Clazz.new_($I$(1,1).c$$jalview_analysis_TreeBuilder,[njtree]);
