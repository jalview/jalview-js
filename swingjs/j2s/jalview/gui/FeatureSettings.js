...
this.scrollPane=Clazz.new_($I$(11,1));
this.transparency=Clazz.new_($I$(12,1));
...
this.originalFilters=Clazz.new_([this.fr.getFeatureFilters$()],$I$(13,1).c$$java_util_Map);
this.originalViewStyle=Clazz.new_([this.af.viewport.getViewStyle$()],$I$(14,1).c$$jalview_api_ViewStyleI);
}, p$1);
...
switch (column) {
case 0:
tip=$I$(15,"wrapTooltip$Z$S",[true, $I$(1).getString$S("label.feature_settings_click_drag")]);
break;
case 1:
var colour=this.b$['jalview.gui.FeatureSettings'].table.getValueAt$I$I(row, column);
tip=$I$(4).getColorTooltip$jalview_api_FeatureColourI$Z(colour, true);
break;
case 2:
...
var loc=Clazz.new_([r.x + (r.width/2|0), r.y + r.height - 3],$I$(16,1).c$$I$I);
return loc;
});
})()
), Clazz.new_($I$(17,1),[this, null],P$.FeatureSettings$1));
var tableHeader=this.table.getTableHeader$();
tableHeader.setFont$java_awt_Font(Clazz.new_($I$(18,1).c$$S$I$I,["Verdana", 0, 12]));
tableHeader.setReorderingAllowed$Z(false);
this.table.setFont$java_awt_Font(Clazz.new_($I$(18,1).c$$S$I$I,["Verdana", 0, 12]));
$I$(19).sharedInstance$().registerComponent$javax_swing_JComponent(this.table);
this.table.setDefaultEditor$Class$javax_swing_table_TableCellEditor(Clazz.getClass($I$(2)), Clazz.new_($I$(20,1),[this, null]));
this.table.setDefaultRenderer$Class$javax_swing_table_TableCellRenderer(Clazz.getClass($I$(2)), Clazz.new_($I$(21,1),[this, null]));
this.table.setDefaultEditor$Class$javax_swing_table_TableCellEditor(Clazz.getClass($I$(3)), Clazz.new_($I$(22,1),[this, null]));
this.table.setDefaultRenderer$Class$javax_swing_table_TableCellRenderer(Clazz.getClass($I$(3)), Clazz.new_($I$(23,1),[this, null]));
var colourColumn=Clazz.new_([1, 75, Clazz.new_($I$(21,1),[this, null]), Clazz.new_($I$(20,1),[this, null])],$I$(24,1).c$$I$I$javax_swing_table_TableCellRenderer$javax_swing_table_TableCellEditor);
this.table.addColumn$javax_swing_table_TableColumn(colourColumn);
var filterColumn=Clazz.new_([2, 75, Clazz.new_($I$(23,1),[this, null]), Clazz.new_($I$(22,1),[this, null])],$I$(24,1).c$$I$I$javax_swing_table_TableCellRenderer$javax_swing_table_TableCellEditor);
...
var toggleSelection=$I$(9).isControlDown$java_awt_event_MouseEvent(evt);
...
), Clazz.new_($I$(25,1),[this, null],P$.FeatureSettings$2)));
...
), Clazz.new_($I$(26,1),[this, null],P$.FeatureSettings$3)));
...
this.frame=Clazz.new_($I$(27,1));
this.frame.setContentPane$java_awt_Container(this);
var bounds=this.af.getFeatureSettingsGeometry$();
var title;
if (this.af.getAlignPanels$().size$() > 1 || $I$(28,"getAlignmentPanels$S",[this.af.alignPanel.av.getSequenceSetId$()]).length > 1 ) {
title=$I$(1,"formatMessage$S$OA",["label.sequence_feature_settings_for_view", Clazz.array(java.lang.Object, -1, [this.af.alignPanel.getViewName$()])]);
} else {
title=$I$(1).getString$S("label.sequence_feature_settings");
}if (bounds == null ) {
if ($I$(9).isAMacAndNotJS$()) {
$I$(28).addInternalFrame$javax_swing_JInternalFrame$S$I$I(this.frame, title, 600, 480);
} else {
$I$(28).addInternalFrame$javax_swing_JInternalFrame$S$I$I(this.frame, title, 600, 450);
}} else {
$I$(28).addInternalFrame$javax_swing_JInternalFrame$S$Z$I$I(this.frame, title, false, bounds.width, bounds.height);
this.frame.setBounds$java_awt_Rectangle(bounds);
this.frame.setVisible$Z(true);
}this.frame.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(29,1).c$$I$I,[400, 400]));
...
), Clazz.new_($I$(30,1),[this, null],P$.FeatureSettings$5)));
this.frame.setLayer$Integer($I$(31).PALETTE_LAYER);
...
var men=Clazz.new_([$I$(1,"formatMessage$S$SA",["label.settings_for_param", Clazz.array(String, -1, [type])])],$I$(32,1).c$$S);
var scr=Clazz.new_([$I$(1).getString$S("label.sort_by_score")],$I$(33,1).c$$S);
men.add$javax_swing_JMenuItem(scr);
scr.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$6||
...
this.b$['jalview.gui.FeatureSettings'].sortByScore$java_util_List.apply(this.b$['jalview.gui.FeatureSettings'], [$I$(34,"asList$OA",[Clazz.array(String, -1, [this.$finals$.type])])]);
});
})()
), Clazz.new_(P$.FeatureSettings$6.$init$,[this, {type:type}])));
var dens=Clazz.new_([$I$(1).getString$S("label.sort_by_density")],$I$(33,1).c$$S);
dens.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$7||
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent',  function (e) {
this.b$['jalview.gui.FeatureSettings'].sortByDensity$java_util_List.apply(this.b$['jalview.gui.FeatureSettings'], [$I$(34,"asList$OA",[Clazz.array(String, -1, [this.$finals$.type])])]);
});
})()
), Clazz.new_(P$.FeatureSettings$7.$init$,[this, {type:type}])));
men.add$javax_swing_JMenuItem(dens);
var selCols=Clazz.new_([$I$(1).getString$S("label.select_columns_containing")],$I$(33,1).c$$S);
selCols.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$8||
...
var clearCols=Clazz.new_([$I$(1).getString$S("label.select_columns_not_containing")],$I$(33,1).c$$S);
clearCols.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$9||
...
var hideCols=Clazz.new_([$I$(1).getString$S("label.hide_columns_containing")],$I$(33,1).c$$S);
hideCols.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$10||
...
var hideOtherCols=Clazz.new_([$I$(1).getString$S("label.hide_columns_not_containing")],$I$(33,1).c$$S);
hideOtherCols.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$11||
...
$I$(35,"showMessageDialog$java_awt_Component$S$S$I",[this, $I$(1).getString$S("label.no_features_to_sort_by"), title, 0]);
return false;
}return true;
}, p$1);

Clazz.newMeth(C$, 'discoverAllFeatureData$',  function () {
var allGroups=Clazz.new_($I$(36,1));
var alignment=this.af.getViewport$().getAlignment$();
for (var i=0; i < alignment.getHeight$(); i++) {
var seq=alignment.getSequenceAt$I(i);
for (var group, $group = seq.getFeatures$().getFeatureGroups$Z$SA(true, Clazz.array(String, -1, [])).iterator$(); $group.hasNext$()&&((group=($group.next$())),1);) {
...
var grp=group;
var check=Clazz.new_($I$(37,1).c$$S$Z,[group, visible]);
check.setFont$java_awt_Font(Clazz.new_($I$(18,1).c$$S$I$I,["Serif", 1, 12]));
check.setToolTipText$S(group);
check.addItemListener$java_awt_event_ItemListener(((P$.FeatureSettings$12||
(function(){/*a*/var C$=Clazz.newClass(P$, "FeatureSettings$12", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
), Clazz.new_(P$.FeatureSettings$12.$init$,[this, {check:check,grp:grp}])));
...
this.typeWidth=Clazz.new_($I$(38,1));
var displayableTypes=Clazz.new_($I$(36,1));
var foundGroups=Clazz.new_($I$(36,1));
for (var i=0; i < this.af.getViewport$().getAlignment$().getHeight$(); i++) {
var seq=this.af.getViewport$().getAlignment$().getSequenceAt$I(i);
var groups=seq.getFeatures$().getFeatureGroups$Z$SA(true, Clazz.array(String, -1, []));
var visibleGroups=Clazz.new_($I$(36,1));
...
}avWidth[0]+=seq.getFeatures$().getFeatureCount$Z$SA(true, Clazz.array(String, -1, [type]));
avWidth[1]+=seq.getFeatures$().getTotalFeatureLength$SA(Clazz.array(String, -1, [type]));
}
}
...
data[dataIndex][3]=Boolean.valueOf$Z(this.af.getViewport$().getFeaturesDisplayed$().isVisible$S(type));
++dataIndex;
...
data[dataIndex][2]=featureFilter == null  ? Clazz.new_($I$(3,1)) : featureFilter;
data[dataIndex][3]=Boolean.valueOf$Z(true);
++dataIndex;
displayableTypes.remove$O(type);
}
...
}this.table.setModel$javax_swing_table_TableModel(Clazz.new_($I$(39,1).c$$OAA,[this, null, data]));
this.table.getColumnModel$().getColumn$I(0).setPreferredWidth$I(200);
this.groupPanel.setLayout$java_awt_LayoutManager(Clazz.new_([(this.fr.getFeatureGroupsSize$()/4|0) + 1, 4],$I$(40,1).c$$I$I));
...
if (sort) {
$I$(41).sort$FA$OA(order, data);
}}, p$1);

Clazz.newMeth(C$, 'load$',  function () {
var chooser=Clazz.new_($I$(42,1).c$$S$S,["fc", C$.SEQUENCE_FEATURE_COLOURS]);
chooser.setFileView$javax_swing_filechooser_FileView(Clazz.new_($I$(43,1)));
chooser.setDialogTitle$S($I$(1).getString$S("label.load_feature_colours"));
chooser.setToolTipText$S($I$(1).getString$S("action.load"));
chooser.setResponseHandler$O$Runnable(Integer.valueOf$I(0), ((P$.FeatureSettings$13||
(function(){/*a*/var C$=Clazz.newClass(P$, "FeatureSettings$13", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
), Clazz.new_(P$.FeatureSettings$13.$init$,[this, {chooser:chooser}])));
chooser.showOpenDialog$java_awt_Component(this);
});

Clazz.newMeth(C$, 'load$java_io_File',  function (file) {
try {
var $in=Clazz.new_([Clazz.new_($I$(45,1).c$$java_io_File,[file]), "UTF-8"],$I$(44,1).c$$java_io_InputStream$S);
var jc=$I$(46).newInstance$S("jalview.xml.binding.jalview");
var um=jc.createUnmarshaller$();
var streamReader=$I$(47).newInstance$().createXMLStreamReader$java_io_Reader($in);
var jbe=um.unmarshal$javax_xml_stream_XMLStreamReader$Class(streamReader, Clazz.getClass($I$(48)));
var jucs=jbe.getValue$();
for (var i=jucs.getColour$().size$() - 1; i >= 0; i--) {
var newcol=jucs.getColour$().get$I(i);
var colour=$I$(49).parseColour$jalview_xml_binding_jalview_JalviewUserColours_Colour(newcol);
...
var filter=$I$(49,"parseFilter$S$jalview_xml_binding_jalview_FeatureMatcherSet",[featureType, filterModel.getMatcherSet$()]);
if (!filter.isEmpty$()) {
...
var ucs=Clazz.new_($I$(48,1));
ucs.setSchemeName$S("Sequence Features");
try {
var out=Clazz.new_([Clazz.new_([Clazz.new_($I$(52,1).c$$java_io_File,[file]), "UTF-8"],$I$(51,1).c$$java_io_OutputStream$S)],$I$(50,1).c$$java_io_Writer);
var fr_colours=this.fr.getAllFeatureColours$();
var sortedTypes=fr_colours.toArray$OA(Clazz.array(String, [fr_colours.size$()]));
$I$(34,"sort$OA$java_util_Comparator",[sortedTypes, ((P$.FeatureSettings$14||
(function(){/*a*/var C$=Clazz.newClass(P$, "FeatureSettings$14", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.Comparator', 1);
...
), Clazz.new_(P$.FeatureSettings$14.$init$,[this, null]))]);
...
var col=$I$(49).marshalColour$S$jalview_api_FeatureColourI(featureType, fcol);
...
var ms=$I$(49,"marshalFilter$jalview_datamodel_features_FeatureMatcherI$java_util_Iterator$Z",[firstMatcher, iterator, filter.isAnded$()]);
var filterModel=Clazz.new_($I$(53,1));
...
var jaxbContext=$I$(46,"newInstance$ClassA",[Clazz.array(Class, -1, [Clazz.getClass($I$(48))])]);
var jaxbMarshaller=jaxbContext.createMarshaller$();
jaxbMarshaller.marshal$O$java_io_Writer(Clazz.new_($I$(54,1)).createJalviewUserColours$jalview_xml_binding_jalview_JalviewUserColours(ucs), out);
out.flush$();
out.close$();
} catch (ex) {
if (Clazz.exceptionOf(ex,"Exception")){
...
var data=(this.table.getModel$()).getData$();
for (var i=0; i < data.length; i++) {
data[i][3]=Boolean.valueOf$Z((!((data[i][3]).$c())));
}
...
var rowData=Clazz.array($I$(55), [data.length]);
for (var i=0; i < data.length; i++) {
var type=data[i][0];
var colour=data[i][1];
var theFilter=data[i][2];
var isShown=data[i][3];
rowData[i]=Clazz.new_($I$(55,1).c$$S$jalview_api_FeatureColourI$jalview_datamodel_features_FeatureMatcherSetI$Boolean,[type, colour, theFilter, isShown]);
}
return rowData;
}, p$1);

Clazz.newMeth(C$, 'jbInit',  function () {
this.setLayout$java_awt_LayoutManager(Clazz.new_($I$(56,1)));
var hasComplement=this.af.getViewport$().getCodingComplement$() != null ;
var settingsPane=Clazz.new_($I$(57,1));
settingsPane.setLayout$java_awt_LayoutManager(Clazz.new_($I$(56,1)));
var bigPanel=Clazz.new_($I$(57,1));
bigPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(56,1)));
this.groupPanel=Clazz.new_($I$(57,1));
bigPanel.add$java_awt_Component$O(this.groupPanel, "North");
var invert=Clazz.new_([$I$(1).getString$S("label.invert_selection")],$I$(6,1).c$$S);
invert.setFont$java_awt_Font($I$(15).getLabelFont$());
invert.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$15||
(function(){/*a*/var C$=Clazz.newClass(P$, "FeatureSettings$15", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var optimizeOrder=Clazz.new_([$I$(1).getString$S("label.optimise_order")],$I$(6,1).c$$S);
optimizeOrder.setFont$java_awt_Font($I$(15).getLabelFont$());
optimizeOrder.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$16||
...
var sortByScore=Clazz.new_($I$(6,1).c$$S,[byScoreLabel]);
sortByScore.setFont$java_awt_Font($I$(15).getLabelFont$());
sortByScore.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$17||
...
), Clazz.new_(P$.FeatureSettings$17.$init$,[this, {byScoreLabel:byScoreLabel}])));
var byDensityLabel=$I$(1).getString$S("label.sequence_sort_by_density");
var sortByDens=Clazz.new_($I$(6,1).c$$S,[byDensityLabel]);
sortByDens.setFont$java_awt_Font($I$(15).getLabelFont$());
sortByDens.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$18||
...
), Clazz.new_(P$.FeatureSettings$18.$init$,[this, {byDensityLabel:byDensityLabel}])));
var help=Clazz.new_([$I$(1).getString$S("action.help")],$I$(6,1).c$$S);
help.setFont$java_awt_Font($I$(15).getLabelFont$());
help.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$19||
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent',  function (e) {
try {
$I$(58,"showHelpWindow$jalview_gui_Help_HelpId",[$I$(59).SequenceFeatureSettings]);
} catch (e1) {
...
var cancel=Clazz.new_([$I$(1).getString$S(hasComplement ? "action.revert" : "action.cancel")],$I$(6,1).c$$S);
...
cancel.setFont$java_awt_Font($I$(15).getLabelFont$());
cancel.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$20||
...
), Clazz.new_(P$.FeatureSettings$20.$init$,[this, {hasComplement:hasComplement}])));
var ok=Clazz.new_([$I$(1).getString$S(hasComplement ? "action.apply" : "action.ok")],$I$(6,1).c$$S);
ok.setFont$java_awt_Font($I$(15).getLabelFont$());
ok.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$21||
...
var loadColours=Clazz.new_([$I$(1).getString$S("label.load_colours")],$I$(6,1).c$$S);
loadColours.setFont$java_awt_Font($I$(15).getLabelFont$());
loadColours.setToolTipText$S($I$(1).getString$S("label.load_colours_tooltip"));
loadColours.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$22||
...
var saveColours=Clazz.new_([$I$(1).getString$S("label.save_colours")],$I$(6,1).c$$S);
saveColours.setFont$java_awt_Font($I$(15).getLabelFont$());
saveColours.setToolTipText$S($I$(1).getString$S("label.save_colours_tooltip"));
saveColours.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$23||
...
this.transparency.addChangeListener$javax_swing_event_ChangeListener(((P$.FeatureSettings$24||
(function(){/*a*/var C$=Clazz.newClass(P$, "FeatureSettings$24", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'javax.swing.event.ChangeListener', 1);
...
var text=$I$(1,"formatMessage$S$OA",["label.show_linked_features", Clazz.array(java.lang.Object, -1, [nucleotide ? $I$(1).getString$S("label.protein").toLowerCase$java_util_Locale($I$(60).ROOT) : "CDS"])]);
this.showComplement=Clazz.new_($I$(37,1).c$$S,[text]);
this.showComplement.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$25||
(function(){/*a*/var C$=Clazz.newClass(P$, "FeatureSettings$25", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
this.showComplementOnTop=Clazz.new_([$I$(1).getString$S("label.on_top")],$I$(37,1).c$$S);
this.showComplementOnTop.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$26||
...
var lowerPanel=Clazz.new_([Clazz.new_($I$(40,1).c$$I$I,[1, 2])],$I$(57,1).c$$java_awt_LayoutManager);
bigPanel.add$java_awt_Component$O(lowerPanel, "South");
var transbuttons=Clazz.new_([Clazz.new_($I$(40,1).c$$I$I,[5, 1])],$I$(57,1).c$$java_awt_LayoutManager);
...
var transPanelLeft=Clazz.new_([Clazz.new_($I$(40,1).c$$I$I,[hasComplement ? 4 : 2, 1])],$I$(57,1).c$$java_awt_LayoutManager);
transPanelLeft.add$java_awt_Component(Clazz.new_($I$(10,1).c$$S,[" Colour transparency:"]));
transPanelLeft.add$java_awt_Component(this.transparency);
if (hasComplement) {
var cp=Clazz.new_([Clazz.new_($I$(61,1).c$$I,[0])],$I$(57,1).c$$java_awt_LayoutManager);
...
var buttonPanel=Clazz.new_($I$(57,1));
...
var af2=$I$(28).getAlignFrameFor$jalview_api_AlignViewportI(complement);
...
description=description.replaceAll$S$S(">", "&gt;");
var tt=Clazz.new_($I$(62,1).c$$S,[description]);
if (withHint) {
tt.append$S("<br>").append$S(C$.BASE_TOOLTIP).append$S("</br>");
}return $I$(15,"wrapTooltip$Z$S",[true, tt.toString()]);
}, 1);

Clazz.newMeth(C$, 'renderGraduatedColor$javax_swing_JLabel$jalview_api_FeatureColourI$I$I',  function (comp, gcol, w, h) {
var thr=false;
var tx=Clazz.new_($I$(62,1));
if (gcol.isColourByAttribute$()) {
tx.append$S($I$(63,"toAttributeDisplayName$SA",[gcol.getAttributeName$()]));
...
var ficon=Clazz.new_([gcol, comp.getBackground$(), w, h, thr],$I$(64,1).c$$jalview_api_FeatureColourI$java_awt_Color$I$I$Z);
...
this.b$['jalview.gui.FeatureSettings'].updateFeatureRenderer$OAA.apply(this.b$['jalview.gui.FeatureSettings'], [this.data]);
});
...
$I$(4,"renderGraduatedColor$javax_swing_JLabel$jalview_api_FeatureColourI$I$I",[this, cellColour, (cr.getWidth$()|0), (cr.getHeight$()|0)]);
} else {
this.setText$S("");
...
this.selectedBorder=$I$(5,"createMatteBorder$I$I$I$I$java_awt_Color",[2, 5, 2, 5, tbl.getSelectionBackground$()]);
}this.setBorder$javax_swing_border_Border(this.selectedBorder);
} else {
if (this.unselectedBorder == null ) {
this.unselectedBorder=$I$(5,"createMatteBorder$I$I$I$I$java_awt_Color",[2, 5, 2, 5, tbl.getBackground$()]);
...
var ttl=$I$(1,"formatMessage$S$OA",["label.select_colour_for", Clazz.array(java.lang.Object, -1, [this.type])]);
...
$I$(7,"showColourChooser$java_awt_Component$S$java_awt_Color$jalview_gui_JalviewColourChooser_ColourChooserListener",[this.button, ttl, this.currentColor.getColour$(), listener]);
} else {
this.chooser=Clazz.new_($I$(8,1).c$$jalview_gui_FeatureRenderer$S,[this.b$['jalview.gui.FeatureSettings'].fr, this.type]);
if (!$I$(9).isJS$()) 
{}
this.chooser.addActionListener$java_awt_event_ActionListener(this);
this.fireEditingStopped$();
}} else {
this.currentColor=this.b$['jalview.gui.FeatureSettings'].fr.getFeatureColours$().get$O(this.type);
var currentFilter=this.b$['jalview.gui.FeatureSettings'].fr.getFeatureFilter$S(this.type);
if (currentFilter == null ) {
currentFilter=Clazz.new_($I$(3,1));
}var data=(this.b$['jalview.gui.FeatureSettings'].table.getModel$()).getData$()[this.rowSelected];
...
this.type=this.b$['jalview.gui.FeatureSettings'].table.getValueAt$I$I(row, 0).toString();
this.button.setOpaque$Z(true);
this.button.setBackground$java_awt_Color(this.b$['jalview.gui.FeatureSettings'].getBackground$.apply(this.b$['jalview.gui.FeatureSettings'], []));
if (!this.currentColor.isSimpleColour$()) {
var btn=Clazz.new_($I$(10,1));
btn.setSize$java_awt_Dimension(this.button.getSize$());
$I$(4).renderGraduatedColor$javax_swing_JLabel$jalview_api_FeatureColourI(btn, this.currentColor);
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent',  function (e) {
if (this.button === e.getSource$() ) {
var chooser=Clazz.new_($I$(8,1).c$$jalview_gui_FeatureRenderer$S,[this.b$['jalview.gui.FeatureSettings'].fr, this.type]);
...
var currentColor=this.b$['jalview.gui.FeatureSettings'].fr.getFeatureColours$().get$O(this.type);
this.currentFilter=this.b$['jalview.gui.FeatureSettings'].fr.getFeatureFilter$S(this.type);
