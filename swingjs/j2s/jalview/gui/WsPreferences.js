(function(){var P$=Clazz.newPackage("jalview.gui"),p$1={},I$=[[0,'java.awt.Dimension','java.awt.Color','jalview.util.MessageManager','jalview.ws.jws2.Jws2Discoverer','java.util.Vector',['jalview.gui.WsPreferences','.JabaWSStatusRenderer'],'jalview.ws.rest.RestClient','jalview.bin.Cache',['jalview.gui.WsPreferences','.WsUrlTableModel'],'jalview.gui.RestServiceEditorPane','jalview.ws.rest.RestServiceDescription','Boolean','javax.swing.JTextField','javax.swing.JPanel','java.awt.BorderLayout','javax.swing.JLabel','javax.swing.JOptionPane','jalview.gui.Desktop','java.net.URL','jalview.gui.JvOptionPane','Thread']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (url == null ) {
url="";
}var urltf=Clazz.new_($I$(13,1).c$$S$I,[url, 40]);
var panel=Clazz.new_([Clazz.new_($I$(15,1))],$I$(14,1).c$$java_awt_LayoutManager);
var pane12=Clazz.new_([Clazz.new_($I$(15,1))],$I$(14,1).c$$java_awt_LayoutManager);
pane12.add$java_awt_Component$O(Clazz.new_([$I$(3).getString$S("label.url:")],$I$(16,1).c$$S), "Center");
...
), Clazz.new_(P$.WsPreferences$2.$init$,[this, null]))],$I$(21,1).c$$Runnable).start$();
});
...
), Clazz.new_(P$.WsPreferences$3.$init$,[this, null]))],$I$(21,1).c$$Runnable).start$();
} else {
...
), Clazz.new_(P$.WsPreferences$4.$init$,[this, null]))],$I$(21,1).c$$Runnable).start$();
}});
...
), Clazz.new_(P$.WsPreferences$5.$init$,[this, {showProgressInDialog:showProgressInDialog}]))],$I$(21,1).c$$Runnable).start$();
});
;
