...
var channel=value;
component.setText$S($I$(23,"formatMessage$S$SA",["label.channel_title_item_count", Clazz.array(String, -1, [channel.getTitle$(), Integer.valueOf$I(channel.getUnreadItemCount$()).toString()])]));
