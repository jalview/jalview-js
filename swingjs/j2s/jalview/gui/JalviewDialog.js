(function(){var P$=Clazz.newPackage("jalview.gui"),I$=[[0,'javax.swing.JButton','Thread','javax.swing.JDialog','jalview.gui.Desktop','java.awt.Rectangle','java.awt.Dimension','jalview.util.MessageManager','java.awt.event.WindowAdapter']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
