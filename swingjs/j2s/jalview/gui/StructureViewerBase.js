...
C$.$fields$=[['Z',['alignAddedStructures','_started','addingStructures','allChainsSelected','seqColoursApplied'],'S',['viewId'],'O',['_aps','java.util.List','_alignwith','java.util.Vector','+_colourwith','ap','jalview.gui.AlignmentPanel','worker','Thread','viewSelectionMenu','javax.swing.JMenu']]]
...
), Clazz.new_(P$.StructureViewerBase$1.$init$,[this, {seqs:seqs,chains:chains,alignFrame:alignFrame,pdbentry:pdbentry}]))],$I$(5,1).c$$Runnable).start$();
return;
...
return;
}var menuItem=Clazz.new_([$I$(11).getString$S("label.all")],$I$(10,1).c$$S);
...
menuItem=Clazz.new_($I$(12,1).c$$S$Z,[chain, true]);
...
var backGround=Clazz.new_($I$(10,1));
...
this.seqColour=Clazz.new_($I$(15,1));
...
this.chainColour=Clazz.new_($I$(15,1));
...
this.chargeColour=Clazz.new_($I$(15,1));
...
this.viewerColour=Clazz.new_($I$(15,1));
...
this._alignwith=Clazz.new_($I$(2,1));
}var seqColourBy=Clazz.new_([$I$(11).getString$S("label.colour_by"), this, this._colourwith, ((P$.StructureViewerBase$9||
...
), Clazz.new_(P$.StructureViewerBase$9.$init$,[this, null]))],$I$(17,1).c$$S$jalview_gui_ViewSelectionMenu_ViewSetProvider$java_util_List$java_awt_event_ItemListener);
...
this.viewSelectionMenu=Clazz.new_([$I$(11).getString$S("label.superpose_with"), this, this._alignwith, handler],$I$(17,1).c$$S$jalview_gui_ViewSelectionMenu_ViewSetProvider$java_util_List$java_awt_event_ItemListener);
...
var chooser=Clazz.new_([$I$(21).getProperty$S("LAST_DIRECTORY")],$I$(23,1).c$$S);
