...
var selectedSequence=(this.forIdPanel && seq != null   ? $I$(17).asList$OA([seq]) : $I$(18).emptyList$());
...
var selectedGroup=(alignPanel.av.getSelectionGroup$() == null  ? $I$(18).emptyList$() : alignPanel.av.getSelectionGroup$().getSequences$());
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
Clazz.new_($I$(19,1).c$$jalview_datamodel_SequenceI$jalview_datamodel_AlignmentAnnotation$jalview_gui_AlignmentPanel,[this.$finals$.seq, this.$finals$.aa, this.$finals$.alignPanel]);
});
})()
...
$I$(20,"setColourSelected$javax_swing_JMenu$jalview_schemes_ColourSchemeI",[this.colourMenu, sg.getColourScheme$()]);
...
}var pdbe=Clazz.new_($I$(21,1));
var reppdb=Clazz.new_($I$(21,1));
var sqass=null;
...
if (pdbe.size$() > 0) {
var pe=pdbe.values$().toArray$OA(Clazz.array($I$(22), [pdbe.size$()]));
var pr=reppdb.values$().toArray$OA(Clazz.array($I$(22), [reppdb.size$()]));
var gpdbview;
var rpdbview;
}} else {
...
var features=null;
if (this.forIdPanel) {
features=this.sequence.getFeatures$().getNonPositionalFeatures$SA([]);
} else {
...
if (!$I$(23,"isGap$C",[this.sequence.getCharAt$I(column)])) {
...
for (var sf, $sf = features.iterator$(); $sf.hasNext$()&&((sf=($sf.next$())),1);) {
this.addFeatureDetailsMenuItem$javax_swing_JMenu$S$jalview_datamodel_SequenceFeature(details, name, sf);
}
if (mf != null ) {
name=mf.fromSeq === seq  ? mf.mapping.getTo$().getName$() : mf.fromSeq.getName$();
for (var sf, $sf = mf.features.iterator$(); $sf.hasNext$()&&((sf=($sf.next$())),1);) {
this.addFeatureDetailsMenuItem$javax_swing_JMenu$S$jalview_datamodel_SequenceFeature(details, name, sf);
}
}});

Clazz.newMeth(C$, 'addFeatureDetailsMenuItem$javax_swing_JMenu$S$jalview_datamodel_SequenceFeature', function (details, seqName, sf) {
var start=sf.getBegin$();
var end=sf.getEnd$();
var desc=Clazz.new_($I$(24,1));
desc.append$S(sf.getType$()).append$S(" ").append$S(String.valueOf$I(start));
if (start != end) {
desc.append$S("-").append$S(String.valueOf$I(end));
}var description=sf.getDescription$();
if (description != null ) {
desc.append$S(" ");
description=$I$(25).stripHtmlTags$S(description);
...
}var htmlText=$I$(26,"wrapTooltip$Z$S",[true, desc.toString()]);
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
this.b$['jalview.gui.PopupMenu'].showFeatureDetails$S$jalview_datamodel_SequenceFeature.apply(this.b$['jalview.gui.PopupMenu'], [this.$finals$.seqName, this.$finals$.sf]);
});
})()
), Clazz.new_(P$.PopupMenu$10.$init$,[this, {seqName:seqName,sf:sf}])));
details.add$javax_swing_JMenuItem(item);
});

Clazz.newMeth(C$, 'showFeatureDetails$S$jalview_datamodel_SequenceFeature', function (seqName, sf) {
var details;
if ($I$(27).isJS$()) {
details=Clazz.new_($I$(28,1));
var panel=Clazz.new_([Clazz.new_($I$(30,1))],$I$(29,1).c$$java_awt_LayoutManager);
panel.setOpaque$Z(true);
panel.setBackground$java_awt_Color($I$(31).white);
var reprt=Clazz.new_([$I$(4,"formatMessage$S$OA",["label.html_content", Clazz.array(java.lang.Object, -1, [sf.getDetailsReport$S(seqName)])])],$I$(32,1).c$$S);
reprt.setBackground$java_awt_Color($I$(31).WHITE);
...
$I$(33,"getShownHiddenTypes$java_util_Map$java_util_Map$java_util_List$java_util_List",[shownTypes, hiddenTypes, $I$(33).asList$jalview_datamodel_AlignmentAnnotationA(annotations), forSequences]);
...
forSequences=seq == null  ? $I$(18).emptyList$() : $I$(17).asList$OA([seq]);
}return forSequences;
});
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
$I$(34,"showOrHideSequenceAnnotations$jalview_datamodel_AlignmentI$java_util_Collection$java_util_List$Z$Z",[this.b$['jalview.gui.PopupMenu'].ap.getAlignment$(), this.$finals$.types, this.$finals$.forSequences, this.$finals$.allTypes, this.$finals$.actionIsShow]);
this.b$['jalview.gui.PopupMenu'].refresh$.apply(this.b$['jalview.gui.PopupMenu'], []);
});
})()
), Clazz.new_(P$.PopupMenu$11.$init$,[this, {actionIsShow:actionIsShow,types:types,forSequences:forSequences,allTypes:allTypes}])));
...
var idandseqs=$I$(35).formStrings$jalview_datamodel_SequenceIA(seqs);
var commonDbrefs=Clazz.new_($I$(21,1));
...
var urlLink=null;
try {
urlLink=Clazz.new_($I$(35,1).c$$S,[link]);
} catch (foo) {
if (Clazz.exceptionOf(foo,"Exception")){
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
this.b$['jalview.gui.PopupMenu'].createSequenceDetailsReport$jalview_datamodel_SequenceIA.apply(this.b$['jalview.gui.PopupMenu'], [Clazz.array($I$(36), -1, [this.b$['jalview.gui.PopupMenu'].sequence])]);
});
})()
...
var selectedSeqs=Clazz.array($I$(36), -1, [this.b$['jalview.gui.PopupMenu'].sequence]);
...
}Clazz.new_($I$(37,1).c$$jalview_datamodel_SequenceIA$jalview_datamodel_SequenceI$jalview_gui_AlignmentPanel,[selectedSeqs, this.b$['jalview.gui.PopupMenu'].sequence, this.b$['jalview.gui.PopupMenu'].ap]);
});
})()
...
this.annotationColour=Clazz.new_([$I$(4).getString$S("action.by_annotation")],$I$(38,1).c$$S);
...
var bg=$I$(20).addMenuItems$javax_swing_JMenu$jalview_gui_ColourMenuHelper_ColourChangeListener$jalview_datamodel_AnnotatedCollectionI$Z(this.colourMenu, this, sg, false);
...
if (sg.cs != null ) {
$I$(39,"setConservationSlider$jalview_gui_AlignmentPanel$jalview_renderer_ResidueShaderI$S",[this.ap, sg.cs, sg.getName$()]);
$I$(39).showConservationSlider$();
}});

Clazz.newMeth(C$, 'modifyPID_actionPerformed$', function () {
var sg=this.getGroup$();
if (sg.cs != null ) {
$I$(39,"setPIDSliderSource$jalview_gui_AlignmentPanel$jalview_renderer_ResidueShaderI$S",[this.ap, sg.cs, this.getGroup$().getName$()]);
$I$(39).showPIDSlider$();
}});
...
var tipEntries=Clazz.new_($I$(40,1));
var candidates=Clazz.new_($I$(8,1));
var al=this.ap.av.getAlignment$();
$I$(34).findAddableReferenceAnnotations$java_util_List$java_util_Map$java_util_Map$jalview_datamodel_AlignmentI(forSequences, tipEntries, candidates, al);
if (!candidates.isEmpty$()) {
var tooltip=Clazz.new_($I$(24,1).c$$I,[64]);
...
var tooltipText=$I$(26,"wrapTooltip$Z$S",[true, tooltip.toString()]);
...
$I$(34).addReferenceAnnotations$java_util_Map$jalview_datamodel_AlignmentI$jalview_datamodel_SequenceGroup(candidates, alignment, selectionGroup);
this.refresh$();
});
...
var contents=Clazz.new_($I$(24,1).c$$I,[128]);
...
Clazz.new_($I$(42,1).c$$S,[null]).createSequenceAnnotationReport$StringBuilder$jalview_datamodel_SequenceI$Z$Z$jalview_viewmodel_seqfeatures_FeatureRendererModel(contents, seq, true, true, this.ap.getSeqPanel$().seqCanvas.fr);
contents.append$S("</p>");
}
...
var frame;
if ($I$(27).isJS$()) {
var textLabel=Clazz.new_($I$(32,1));
textLabel.setText$S(report);
textLabel.setBackground$java_awt_Color($I$(31).WHITE);
var pane=Clazz.new_([Clazz.new_($I$(30,1))],$I$(29,1).c$$java_awt_LayoutManager);
pane.setOpaque$Z(true);
pane.setBackground$java_awt_Color($I$(31).WHITE);
pane.add$java_awt_Component$O(textLabel, "North");
frame=Clazz.new_($I$(28,1));
frame.getContentPane$().add$java_awt_Component(Clazz.new_($I$(43,1).c$$java_awt_Component,[pane]));
} else 
{}
...
$I$(44,"Refresh$java_awt_Component$S",[this, this.ap.av.getSequenceSetId$()]);
});
...
sg.cs.setConsensus$jalview_datamodel_ProfilesI($I$(45,"calculate$java_util_List$I$I",[sg.getSequences$java_util_Map(this.ap.av.getHiddenRepSequences$()), sg.getStartRes$(), sg.getEndRes$() + 1]));
var threshold=$I$(39,"setPIDSliderSource$jalview_gui_AlignmentPanel$jalview_renderer_ResidueShaderI$S",[this.ap, sg.getGroupColourScheme$(), this.getGroup$().getName$()]);
...
Clazz.new_($I$(46,1).c$$jalview_gui_AlignmentPanel,[this.ap]);
});
...
var c=Clazz.new_(["Group", sg.getSequences$java_util_Map(this.ap.av.getHiddenRepSequences$()), sg.getStartRes$(), sg.getEndRes$() + 1],$I$(47,1).c$$S$java_util_List$I$I);
c.calculate$();
c.verdict$Z$F(false, this.ap.av.getConsPercGaps$());
sg.cs.setConservation$jalview_analysis_Conservation(c);
$I$(39,"setConservationSlider$jalview_gui_AlignmentPanel$jalview_renderer_ResidueShaderI$S",[this.ap, sg.getGroupColourScheme$(), sg.getName$()]);
$I$(39).showConservationSlider$();
} else {
sg.cs.setConservation$jalview_analysis_Conservation(null);
$I$(39).hideConservationSlider$();
...
var sg=this.getGroup$();
var dialog=Clazz.new_([sg.getName$(), sg.getDescription$(), $I$(4).getString$S("label.group_name"), $I$(4).getString$S("label.group_description")],$I$(48,1).c$$S$S$S$S);
...
var dialog=Clazz.new_([this.sequence.getName$(), this.sequence.getDescription$(), $I$(4).getString$S("label.sequence_name"), $I$(4).getString$S("label.sequence_description")],$I$(48,1).c$$S$S$S$S);
...
$I$(49,"showColourChooser$java_awt_Component$S$java_awt_Color$jalview_gui_JalviewColourChooser_ColourChooserListener",[$I$(14).getDesktop$(), title, $I$(31).BLUE, listener]);
});
...
caseChange=$I$(50).TOGGLE_CASE;
} else if (source === this.upperCase ) {
description=$I$(4).getString$S("label.to_upper_case");
caseChange=$I$(50).TO_UPPER;
} else {
description=$I$(4).getString$S("label.to_lower_case");
caseChange=$I$(50).TO_LOWER;
}var caseCommand=Clazz.new_([description, sg.getSequencesAsArray$java_util_Map(this.ap.av.getHiddenRepSequences$()), startEnd, caseChange],$I$(50,1).c$$S$jalview_datamodel_SequenceIA$java_util_List$I);
...
cap.setText$S(Clazz.new_($I$(52,1).c$$jalview_api_AlignmentViewPanel,[this.ap]).formatSequences$jalview_io_FileFormatI$jalview_api_AlignmentViewPanel$Z(fileFormat, this.ap, true));
});
...
features.add$O(Clazz.new_($I$(53,1).c$$S$S$I$I$S,[null, null, start, end, null]));
}}
if (!seqs.isEmpty$()) {
Clazz.new_($I$(54,1).c$$jalview_gui_AlignmentPanel$java_util_List$java_util_List$Z,[this.ap, seqs, features, true]).showDialog$();
}});

Clazz.newMeth(C$, 'textColour_actionPerformed$', function () {
var sg=this.getGroup$();
if (sg != null ) {
Clazz.new_($I$(55,1)).chooseColour$jalview_gui_AlignmentPanel$jalview_datamodel_SequenceGroup(this.ap, sg);
}});
...
}var dialog=Clazz.new_([seq.getSequenceAsString$I$I(sg.getStartRes$(), sg.getEndRes$() + 1), null, $I$(4).getString$S("label.edit_sequence"), null],$I$(48,1).c$$S$S$S$S);
...
Clazz.newMeth(C$, 'run$', function () {
var editCommand=Clazz.new_([$I$(4).getString$S("label.edit_sequences"), $I$(57).REPLACE, this.$finals$.dialog.getName$().replace$C$C(" ", this.b$['jalview.gui.PopupMenu'].ap.av.getGapCharacter$()), this.$finals$.sg.getSequencesAsArray$java_util_Map(this.b$['jalview.gui.PopupMenu'].ap.av.getHiddenRepSequences$()), this.$finals$.sg.getStartRes$(), this.$finals$.sg.getEndRes$() + 1, this.b$['jalview.gui.PopupMenu'].ap.av.getAlignment$()],$I$(56,1).c$$S$jalview_commands_EditCommand_Action$S$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI);
...
var sg=this.getGroup$();
var colourScheme=$I$(58).getInstance$().getColourScheme$S$jalview_api_AlignViewportI$jalview_datamodel_AnnotatedCollectionI$java_util_Map(colourSchemeName, this.ap.av, sg, this.ap.av.getHiddenRepSequences$());
