(function(){var P$=Clazz.newPackage("jalview.gui"),I$=[[0,'java.awt.Font','javax.swing.JButton','jalview.util.MessageManager','javax.swing.JPanel','javax.swing.BoxLayout','java.awt.FlowLayout','javax.swing.JLabel','javax.swing.JTextField','jalview.gui.JvOptionPane']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
$I$(9).newOptionDialog$java_awt_Component(parent).setResponseHandler$O$Runnable(Integer.valueOf$I(0), action).showInternalDialog$javax_swing_JPanel$S$I$I$javax_swing_Icon$OA$S(this.panel, title, 1, -1, null, options, $I$(3).getString$S("action.ok"));
});
