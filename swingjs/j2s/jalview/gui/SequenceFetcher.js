(function(){var P$=Clazz.newPackage("jalview.gui"),p$1={},I$=[[0,'jalview.ws.SequenceFetcher','javax.swing.JInternalFrame','jalview.gui.Desktop','jalview.util.Platform','jalview.util.MessageManager','java.awt.BorderLayout','javax.swing.JComboBox','jalview.gui.JvSwingUtils',['jalview.gui.SequenceFetcher','.StringPair'],'java.util.Arrays','jalview.fts.service.pdb.PDBFTSPanel','jalview.fts.service.uniprot.UniprotFTSPanel','jalview.fts.service.threedbeacons.TDBeaconsFTSPanel','javax.swing.JLabel','java.awt.Font','javax.swing.JCheckBox','javax.swing.JButton','javax.swing.JTextArea','java.awt.event.KeyAdapter','javax.swing.JPanel','javax.swing.JScrollPane','StringBuilder','java.util.HashSet','Thread','java.util.ArrayList','StringBuffer','jalview.gui.OOMWarning','jalview.bin.Console','jalview.util.DBRefUtils','jalview.gui.AlignFrame','jalview.bin.Cache','javax.swing.SwingUtilities','jalview.gui.JvOptionPane']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "SequenceFetcher", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'javax.swing.JPanel', 'Runnable');
C$.$classes$=[['StringPair',2]];
...
var instructionItem=Clazz.new_([this, null, $I$(5).getString$S("action.select_ddbb")],$I$(9,1).c$$S);
this.database.setPrototypeDisplayValue$O(instructionItem);
var sources=Clazz.new_($I$(1,1)).getSupportedDb$();
$I$(10).sort$OA$java_util_Comparator(sources, String.CASE_INSENSITIVE_ORDER);
this.database.addItem$O(instructionItem);
for (var source, $source = 0, $$source = sources; $source<$$source.length&&((source=($$source[$source])),1);$source++) {
var slist=C$.sfetch.getSourceProxy$S(source);
if (slist.size$() == 1 && slist.get$I(0) != null  ) {
this.database.addItem$O(Clazz.new_([this, null, source, slist.get$I(0).getDbName$()],$I$(9,1).c$$S$S));
} else {
this.database.addItem$O(Clazz.new_($I$(9,1).c$$S,[this, null, source]));
}}
p$1.setDatabaseSelectedItem$S.apply(this, [selectedDb]);
...
var currentSelection=(this.b$['jalview.gui.SequenceFetcher'].database.getSelectedItem$()).getKey$();
...
this.b$['jalview.gui.SequenceFetcher'].frame.dispose$();
Clazz.new_($I$(12,1).c$$jalview_gui_SequenceFetcher,[this.b$['jalview.gui.SequenceFetcher']]);
} else if ("3d-beacons".equalsIgnoreCase$S(currentSelection)) {
this.b$['jalview.gui.SequenceFetcher'].frame.dispose$();
Clazz.new_($I$(13,1).c$$jalview_gui_SequenceFetcher,[this.b$['jalview.gui.SequenceFetcher']]);
} else {
...
this.exampleAccession=Clazz.new_($I$(14,1).c$$S,[""]);
this.exampleAccession.setFont$java_awt_Font(Clazz.new_($I$(15,1).c$$S$I$I,["Verdana", 1, 11]));
var jLabel1=Clazz.new_([$I$(5).getString$S("label.separate_multiple_accession_ids")],$I$(14,1).c$$S);
jLabel1.setFont$java_awt_Font(Clazz.new_($I$(15,1).c$$S$I$I,["Verdana", 2, 11]));
jLabel1.setHorizontalAlignment$I(2);
this.replacePunctuation=Clazz.new_([$I$(5).getString$S("label.replace_commas_semicolons")],$I$(16,1).c$$S);
this.replacePunctuation.setHorizontalAlignment$I(2);
this.replacePunctuation.setFont$java_awt_Font(Clazz.new_($I$(15,1).c$$S$I$I,["Verdana", 2, 11]));
this.okBtn=Clazz.new_([$I$(5).getString$S("action.ok")],$I$(17,1).c$$S);
...
var clear=Clazz.new_([$I$(5).getString$S("action.clear")],$I$(17,1).c$$S);
...
this.exampleBtn=Clazz.new_([$I$(5).getString$S("label.example")],$I$(17,1).c$$S);
...
this.closeBtn=Clazz.new_([$I$(5).getString$S("action.cancel")],$I$(17,1).c$$S);
...
this.backBtn=Clazz.new_([$I$(5).getString$S("action.back")],$I$(17,1).c$$S);
...
this.textArea=Clazz.new_($I$(18,1));
...
), Clazz.new_($I$(19,1),[this, null],P$.SequenceFetcher$7)));
var actionPanel=Clazz.new_($I$(20,1));
...
var databasePanel=Clazz.new_($I$(20,1));
...
var jPanel2a=Clazz.new_([Clazz.new_($I$(6,1))],$I$(20,1).c$$java_awt_LayoutManager);
...
Clazz.newMeth(C$, 'setDatabaseSelectedItem$S',  function (db) {
for (var i=0; i < this.database.getItemCount$(); i++) {
var sp=this.database.getItemAt$I(i);
if (sp != null  && db != null   && db.equals$O(sp.getKey$()) ) {
this.database.setSelectedIndex$I(i);
return;
}}
}, p$1);
...
var eq=this.getExampleQueries$S((this.database.getSelectedItem$()).getKey$());
...
var worker=Clazz.new_($I$(24,1).c$$Runnable,[this]);
worker.start$();
});
...
var addToLast=false;
var aresultq=Clazz.new_($I$(25,1));
var presultTitle=Clazz.new_($I$(25,1));
var presult=Clazz.new_($I$(25,1));
var aresult=Clazz.new_($I$(25,1));
var sources=C$.sfetch.getSourceProxy$S((this.database.getSelectedItem$()).getKey$());
var proxies=sources.iterator$();
var qries=this.textArea.getText$().trim$().split$S(";");
var nextFetch=$I$(10).asList$OA(qries);
var en=$I$(10,"asList$OA",[Clazz.array(String, [0])]).iterator$();
...
nextFetch=Clazz.new_($I$(25,1));
}var proxy=proxies.next$();
try {
this.guiWindow.setProgressBar$S$J($I$(5,"formatMessage$S$SA",["status.fetching_sequence_queries_from", Clazz.array(String, -1, [Integer.valueOf$I(nqueries).toString(), proxy.getDbName$()])]), $I$(24).currentThread$().hashCode$());
...
var e = e$$;
{
this.showErrorMessage$S("Error retrieving " + this.textArea.getText$() + " from " + (this.database.getSelectedItem$()).getDisplay$() );
System.err.println$S("Retrieval failed for source ='" + (this.database.getSelectedItem$()).getDisplay$() + "' and query\n'" + this.textArea.getText$() + "'\n" );
e.printStackTrace$();
}
} else if (Clazz.exceptionOf(e$$,"OutOfMemoryError")){
var e = e$$;
{
this.showErrorMessage$S("Out of Memory when retrieving " + this.textArea.getText$() + " from " + (this.database.getSelectedItem$()).getDisplay$() + "\nPlease see the Jalview FAQ for instructions for increasing the memory available to Jalview.\n" );
e.printStackTrace$();
}
} else if (Clazz.exceptionOf(e$$,"Error")){
var e = e$$;
{
this.showErrorMessage$S("Serious Error retrieving " + this.textArea.getText$() + " from " + (this.database.getSelectedItem$()).getDisplay$() );
e.printStackTrace$();
}
} else {
throw e$$;
...
}}this.guiWindow.setProgressBar$S$J($I$(5).getString$S("status.finshed_querying"), $I$(24).currentThread$().hashCode$());
}
this.guiWindow.setProgressBar$S$J((presult.size$() > 0) ? $I$(5).getString$S("status.parsing_results") : $I$(5).getString$S("status.processing"), $I$(24).currentThread$().hashCode$());
...
this.guiWindow.setProgressBar$S$J(null, $I$(24).currentThread$().hashCode$());
if (nextFetch.size$() > 0) {
...
var multiacc=Clazz.new_($I$(22,1));
var tosend=Clazz.new_($I$(25,1));
...
Clazz.new_(["fetching " + multiacc + " from " + (this.database.getSelectedItem$()).getDisplay$() , oome, this],$I$(27,1).c$$S$OutOfMemoryError$java_awt_Component);
} else {
throw oome;
}
}
...
if (Clazz.exceptionOf(oome,"OutOfMemoryError")){
Clazz.new_(["fetching " + accession + " from " + proxy.getDbName$() , oome, this],$I$(27,1).c$$S$OutOfMemoryError$java_awt_Component);
} else {
throw oome;
}
}
...
if (Clazz.exceptionOf(e,"Exception")){
$I$(28,"info$S$Throwable",["Error retrieving " + accession + " from " + proxy.getDbName$() , e]);
} else {
throw e;
}
}
...
if (rs[r] != null ) {
var found=$I$(29,"searchRefs$java_util_List$S",[rs[r].getDBRefs$(), accId]);
if (!found.isEmpty$()) {
rfound=true;
break;
}}}
...
return "Retrieved from " + (this.database.getSelectedItem$()).getDisplay$();
});
...
var af=Clazz.new_($I$(30,1).c$$jalview_datamodel_AlignmentI$I$I,[al, 700, 500]);
...
if ($I$(31).getDefault$S$Z("HIDE_INTRONS", true)) {
...
try {
af.setMaximum$Z($I$(31).getDefault$S$Z("SHOW_FULLSCREEN", false));
} catch (ex) {
if (Clazz.exceptionOf(ex,"Exception")){
} else {
throw ex;
...
p$1.resetDialog.apply(this, []);
$I$(32,"invokeLater$Runnable",[((P$.SequenceFetcher$8||
...
Clazz.newMeth(C$, 'run$',  function () {
$I$(33,"showInternalMessageDialog$java_awt_Component$S$S$I",[$I$(3).desktop, this.$finals$.error, $I$(5).getString$S("label.error_retrieving_data"), 2]);
});
})()
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.SequenceFetcher, "StringPair", function(){
...
C$.$fields$=[['S',['key','display']]]

Clazz.newMeth(C$, 'c$$S$S',  function (s1, s2) {
;C$.$init$.apply(this);
this.key=s1;
this.display=s2;
}, 1);
...
Clazz.newMeth(C$, 'equals$jalview_gui_SequenceFetcher_StringPair',  function (other) {
