(function(){var P$=Clazz.newPackage("jalview.gui"),p$1={},I$=[[0,'java.math.MathContext','jalview.util.MessageManager','java.text.DecimalFormat','javax.swing.JRadioButton','javax.swing.JPanel','javax.swing.JComboBox','javax.swing.JTextField','javax.swing.JCheckBox','jalview.datamodel.features.FeatureMatcher','jalview.datamodel.GraphLine','java.awt.Color','java.awt.BorderLayout','jalview.datamodel.features.FeatureAttributes','javax.swing.BoxLayout','jalview.gui.JvSwingUtils','java.awt.FlowLayout','java.awt.Dimension','javax.swing.BorderFactory','java.awt.event.MouseAdapter','javax.swing.border.LineBorder','jalview.util.ColorUtils','javax.swing.JLabel','java.awt.event.FocusAdapter','jalview.gui.Slider','javax.swing.ButtonGroup','jalview.gui.JalviewColourChooser','jalview.schemes.FeatureColour','java.awt.event.ActionEvent','java.math.BigDecimal','java.util.ArrayList','java.awt.GridLayout','javax.swing.JButton','javax.swing.border.EmptyBorder','jalview.util.matcher.Condition',['jalview.datamodel.features.FeatureAttributes','.Datatype'],'jalview.bin.Console','jalview.datamodel.features.FeatureMatcherSet','jalview.gui.Desktop']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.simpleColour=Clazz.new_($I$(4,1));
this.byCategory=Clazz.new_($I$(4,1));
this.graduatedColour=Clazz.new_($I$(4,1));
this.singleColour=Clazz.new_($I$(5,1));
this.minColour=Clazz.new_($I$(5,1));
this.maxColour=Clazz.new_($I$(5,1));
this.threshold=Clazz.new_($I$(6,1));
this.thresholdValue=Clazz.new_($I$(7,1).c$$I,[20]);
this.thresholdIsMin=Clazz.new_($I$(8,1));
this.featureSettings=null;
},1);

C$.$fields$=[['Z',['adjusting'],'F',['min','max'],'S',['featureType'],'O',['fr','jalview.gui.FeatureRenderer','ap','jalview.api.AlignmentViewPanel','originalColour','jalview.api.FeatureColourI','originalFilter','jalview.datamodel.features.FeatureMatcherSetI','simpleColour','javax.swing.JRadioButton','+byCategory','+graduatedColour','coloursPanel','javax.swing.JPanel','+filtersPanel','+singleColour','+minColour','+maxColour','threshold','javax.swing.JComboBox','slider','jalview.gui.Slider','thresholdValue','javax.swing.JTextField','thresholdIsMin','javax.swing.JCheckBox','threshline','jalview.datamodel.GraphLine','featureSettings','java.awt.event.ActionListener','+changeColourAction','noValueCombo','javax.swing.JComboBox','+colourByTextCombo','+colourByRangeCombo','andFilters','javax.swing.JRadioButton','+orFilters','filters','java.util.List','chooseFiltersPanel','javax.swing.JPanel']]
,['S',['LABEL_18N','SCORE_18N'],'O',['FOUR_SIG_FIG','java.math.MathContext','DECFMT_2_2','java.text.DecimalFormat']]]
...
var title=$I$(2,"formatMessage$S$SA",["label.display_settings_for", Clazz.array(String, -1, [theType])]);
...
}this.slider.setSliderModel$F$F$F(this.min, this.max, this.min);
this.slider.setMajorTickSpacing$I((((this.slider.getMaximum$() - this.slider.getMinimum$()) / 10.0)|0));
...
this.slider.setSliderValue$F(fc.getThreshold$());
this.setThresholdValueText$F(fc.getThreshold$());
...
var graduatedColourPanel=Clazz.new_($I$(5,1));
graduatedColourPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(14,1).c$$java_awt_Container$I,[graduatedColourPanel, 1]));
$I$(15,"createTitledBorder$javax_swing_JComponent$S$Z",[graduatedColourPanel, $I$(2).getString$S("label.graduated_colour"), true]);
graduatedColourPanel.setBackground$java_awt_Color($I$(11).white);
var graduatedChoicePanel=Clazz.new_([Clazz.new_($I$(16,1).c$$I,[0])],$I$(5,1).c$$java_awt_LayoutManager);
graduatedChoicePanel.setBackground$java_awt_Color($I$(11).white);
this.graduatedColour=Clazz.new_([$I$(2).getString$S("label.by_range_of") + ":"],$I$(4,1).c$$S);
...
var colourRangePanel=Clazz.new_([Clazz.new_($I$(16,1).c$$I,[0])],$I$(5,1).c$$java_awt_LayoutManager);
...
this.minColour.setToolTipText$S($I$(2).getString$S("label.min_colour"));
...
var ttl=$I$(2).getString$S("label.select_colour_minimum_value");
...
this.maxColour.setToolTipText$S($I$(2).getString$S("label.max_colour"));
...
var ttl=$I$(2).getString$S("label.select_colour_maximum_value");
...
}this.noValueCombo=Clazz.new_($I$(6,1));
this.noValueCombo.addItem$O($I$(2).getString$S("label.no_colour"));
this.noValueCombo.addItem$O($I$(2).getString$S("label.min_colour"));
this.noValueCombo.addItem$O($I$(2).getString$S("label.max_colour"));
...
var minText=Clazz.new_([$I$(2).getString$S("label.min_value") + ":"],$I$(22,1).c$$S);
minText.setFont$java_awt_Font($I$(15).getLabelFont$());
var maxText=Clazz.new_([$I$(2).getString$S("label.max_value") + ":"],$I$(22,1).c$$S);
maxText.setFont$java_awt_Font($I$(15).getLabelFont$());
var noText=Clazz.new_([$I$(2).getString$S("label.no_value") + ":"],$I$(22,1).c$$S);
...
var thresholdPanel=Clazz.new_([Clazz.new_($I$(16,1).c$$I,[0])],$I$(5,1).c$$java_awt_LayoutManager);
...
this.threshold.setToolTipText$S($I$(2).getString$S("label.threshold_feature_display_by_score"));
this.threshold.addItem$O($I$(2).getString$S("label.threshold_feature_no_threshold"));
this.threshold.addItem$O($I$(2).getString$S("label.threshold_feature_above_threshold"));
this.threshold.addItem$O($I$(2).getString$S("label.threshold_feature_below_threshold"));
...
this.slider=Clazz.new_($I$(24,1).c$$F$F$F,[0.0, 100.0, 50.0]);
...
this.slider.setToolTipText$S($I$(2).getString$S("label.adjust_threshold"));
...
this.b$['jalview.gui.FeatureTypeSettings'].setThresholdValueText$F.apply(this.b$['jalview.gui.FeatureTypeSettings'], [this.b$['jalview.gui.FeatureTypeSettings'].slider.getSliderValue$()]);
...
this.thresholdIsMin.setText$S($I$(2).getString$S("label.threshold_minmax"));
this.thresholdIsMin.setToolTipText$S($I$(2).getString$S("label.toggle_absolute_relative_display_threshold"));
...
var okCancelPanel=Clazz.new_($I$(5,1));
...
var colourByPanel=Clazz.new_($I$(5,1));
...
$I$(15,"createTitledBorder$javax_swing_JComponent$S$Z",[colourByPanel, $I$(2).getString$S("action.colour"), true]);
var simpleColourPanel=Clazz.new_([Clazz.new_($I$(16,1).c$$I,[0])],$I$(5,1).c$$java_awt_LayoutManager);
simpleColourPanel.setBackground$java_awt_Color($I$(11).white);
colourByPanel.add$java_awt_Component(simpleColourPanel);
this.simpleColour=Clazz.new_([$I$(2).getString$S("label.simple_colour")],$I$(4,1).c$$S);
...
var ttl=$I$(2,"formatMessage$S$OA",["label.select_colour_for", Clazz.array(java.lang.Object, -1, [this.b$['jalview.gui.FeatureTypeSettings'].featureType])]);
...
var byTextPanel=Clazz.new_([Clazz.new_($I$(16,1).c$$I,[0])],$I$(5,1).c$$java_awt_LayoutManager);
byTextPanel.setBackground$java_awt_Color($I$(11).white);
$I$(15,"createTitledBorder$javax_swing_JComponent$S$Z",[byTextPanel, $I$(2).getString$S("label.colour_by_text"), true]);
colourByPanel.add$java_awt_Component(byTextPanel);
this.byCategory=Clazz.new_([$I$(2).getString$S("label.by_text_of") + ":"],$I$(4,1).c$$S);
...
$I$(26,"showColourChooser$java_awt_Component$S$java_awt_Color$jalview_gui_JalviewColourChooser_ColourChooserListener",[this, title, colourPanel.getBackground$(), listener]);
});
...
}var fc=Clazz.new_([this.singleColour.getBackground$(), this.minColour.getBackground$(), this.maxColour.getBackground$(), noColour, minValue, maxValue],$I$(27,1).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color$F$F);
...
this.featureSettings.actionPerformed$java_awt_event_ActionEvent(Clazz.new_($I$(28,1).c$$O$I$S,[this, 0, "CLOSED"]));
}});
...
this.setThresholdValueText$F(f);
this.slider.setSliderValue$F(f);
...
Clazz.newMeth(C$, 'setThresholdValueText$F',  function (f) {
var formatted=Clazz.new_($I$(29,1).c$$D,[f]).round$java_math_MathContext(C$.FOUR_SIG_FIG).stripTrailingZeros$();
this.thresholdValue.setText$S(formatted.toPlainString$());
});
...
var displayAtts=Clazz.new_($I$(30,1));
var tooltips=Clazz.new_($I$(30,1));
if (withText) {
displayAtts.add$O(C$.LABEL_18N);
tooltips.add$O($I$(2).getString$S("label.description"));
}if (withRange) {
...
var displayAttsObjects=Clazz.new_($I$(30,1).c$$java_util_Collection,[displayAtts]);
...
this.filters=Clazz.new_($I$(30,1));
var filtersPanel=Clazz.new_($I$(5,1));
...
$I$(15,"createTitledBorder$javax_swing_JComponent$S$Z",[filtersPanel, $I$(2).getString$S("label.filters"), true]);
var andOrPanel=p$1.initialiseAndOrPanel.apply(this, []);
filtersPanel.add$java_awt_Component(andOrPanel);
this.chooseFiltersPanel=Clazz.new_($I$(5,1));
...
var andOrPanel=Clazz.new_([Clazz.new_($I$(16,1).c$$I,[0])],$I$(5,1).c$$java_awt_LayoutManager);
andOrPanel.setBackground$java_awt_Color($I$(11).white);
this.andFilters=Clazz.new_([$I$(2).getString$S("label.and")],$I$(4,1).c$$S);
this.orFilters=Clazz.new_([$I$(2).getString$S("label.or")],$I$(4,1).c$$S);
...
andOrPanel.add$java_awt_Component(Clazz.new_([$I$(2).getString$S("label.join_conditions")],$I$(22,1).c$$S));
...
this.chooseFiltersPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(31,1).c$$I$I,[5, 1]));
} else {
...
var filterRow=Clazz.new_([Clazz.new_($I$(16,1).c$$I,[0])],$I$(5,1).c$$java_awt_LayoutManager);
...
var condCombo=Clazz.new_($I$(6,1));
...
), Clazz.new_(P$.FeatureTypeSettings$17.$init$,[this, {patternField:patternField,attCombo:attCombo,filterIndex:filterIndex,condCombo:condCombo}]));
...
), Clazz.new_(P$.FeatureTypeSettings$19.$init$,[this, {patternField:patternField,actionListener:actionListener,attCombo:attCombo,condCombo:condCombo}])));
...
var removeCondition=Clazz.new_($I$(32,1).c$$S,["\u2717"]);
removeCondition.setBorder$javax_swing_border_Border(Clazz.new_($I$(33,1).c$$I$I$I$I,[0, 0, 0, 0]));
...
removeCondition.setToolTipText$S($I$(2).getString$S("label.delete_condition"));
...
var tip=String.format$S$OA("(%s - %s)", Clazz.array(java.lang.Object, -1, [minFormatted, maxFormatted]));
patternField.setToolTipText$S(tip);
if (patternField.getText$().isEmpty$()) {
if (selectedCondition === $I$(34).GE  || selectedCondition === $I$(34).GT  ) {
patternField.setText$S(minFormatted);
} else {
if (selectedCondition === $I$(34).LE  || selectedCondition === $I$(34).LT  ) {
...
for (var c, $c = 0, $$c = $I$(34).values$(); $c<$$c.length&&((c=($$c[$c])),1);$c++) {
if ((c.isNumeric$() && type === $I$(35).Number  ) || (!c.isNumeric$() && type !== $I$(35).Number  ) ) {
...
value.setToolTipText$S($I$(2).getString$S("label.numeric_required"));
return false;
} else {
throw e;
}
...
$I$(36).error$S("Problem casting Combo box entry to String");
...
var combined=Clazz.new_($I$(37,1));
for (var filter, $filter = this.filters.iterator$(); $filter.hasNext$()&&((filter=($filter.next$())),1);) {
var pattern=filter.getMatcher$().getPattern$();
...
var af2=$I$(38).getAlignFrameFor$jalview_api_AlignViewportI(complement);
af2.alignPanel.paintAlignment$Z$Z(true, updateStructsAndOverview);
}});

C$.$static$=function(){C$.$static$=0;
C$.FOUR_SIG_FIG=Clazz.new_($I$(1,1).c$$I,[4]);
C$.LABEL_18N=$I$(2).getString$S("label.label");
C$.SCORE_18N=$I$(2).getString$S("label.score");
C$.DECFMT_2_2=Clazz.new_($I$(3,1).c$$S,["##.##"]);
};
