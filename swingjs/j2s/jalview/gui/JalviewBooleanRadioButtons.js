(function(){var P$=Clazz.newPackage("jalview.gui"),I$=[[0,'jalview.gui.JvSwingUtils','javax.swing.ButtonGroup','javax.swing.JRadioButton']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
