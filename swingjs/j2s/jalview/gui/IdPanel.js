...
C$.$fields$=[['Z',['mouseDragging'],'I',['offy','lastid'],'O',['idCanvas','jalview.gui.IdCanvas','av','jalview.viewmodel.AlignmentViewport','alignPanel','jalview.gui.AlignmentPanel','scrollThread','jalview.gui.IdPanel.ScrollThread','seqAnnotReport','jalview.io.SequenceAnnotationReport']]]
...
this.seqAnnotReport=Clazz.new_($I$(3,1).c$$Z,[true]);
...
this.b$['jalview.gui.IdPanel'].scrollThread=null;
});

Clazz.newMeth(C$, 'scrollOnce$',  function () {
var ranges=this.b$['jalview.gui.IdPanel'].av.getRanges$();
if (ranges.scrollUp$Z(this.up)) {
var toSeq=this.up ? ranges.getStartSeq$() : ranges.getEndSeq$();
var fromSeq=toSeq < this.b$['jalview.gui.IdPanel'].lastid ? this.b$['jalview.gui.IdPanel'].lastid - 1 : this.b$['jalview.gui.IdPanel'].lastid + 1;
this.b$['jalview.gui.IdPanel'].selectSeqs$I$I.apply(this.b$['jalview.gui.IdPanel'], [fromSeq, toSeq]);
this.b$['jalview.gui.IdPanel'].lastid=toSeq;
this.b$['jalview.gui.IdPanel'].alignPanel.paintAlignment$Z$Z(false, false);
return true;
}return false;
});
