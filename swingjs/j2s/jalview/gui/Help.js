(function(){var P$=Clazz.newPackage("jalview.gui"),I$=[[0,'jalview.util.Platform','jalview.util.BrowserLauncher',['jalview.gui.Help','.HelpId']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
