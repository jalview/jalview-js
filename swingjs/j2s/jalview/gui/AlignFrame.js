...
if ($I$(7).getDefault$S$S("VERSION", "DEVELOPMENT").toLowerCase$java_util_Locale($I$(14).ROOT).indexOf$S("devel") > -1 || $I$(7).getDefault$S$S("VERSION", "DEVELOPMENT").toLowerCase$java_util_Locale($I$(14).ROOT).indexOf$S("test") > -1 ) {
...
), Clazz.new_($I$(15,1),[this, null],P$.AlignFrame$4)));
});
...
this.b$['jalview.gui.AlignFrame'].alignPanel.getSeqPanel$().moveCursor$I$I$Z(0, 1, evt.isShiftDown$());
}break;
case 38:
if (evt.isAltDown$() || !this.b$['jalview.gui.AlignFrame'].viewport.cursorMode ) {
...
this.b$['jalview.gui.AlignFrame'].alignPanel.getSeqPanel$().moveCursor$I$I$Z(-1, 0, evt.isShiftDown$());
}break;
case 39:
if (evt.isAltDown$() || !this.b$['jalview.gui.AlignFrame'].viewport.cursorMode ) {
...
), Clazz.new_($I$(17,1),[this, null],P$.AlignFrame$5)));
});
...
$I$(18,"Register$java_awt_Component$S",[ap, ap.av.getSequenceSetId$()]);
...
{
$I$(19,"invokeLater$Runnable",[((P$.AlignFrame$6$1||
...
), Clazz.new_($I$(20,1),[this, {thisListener:thisListener}],P$.AlignFrame$7)));
...
), Clazz.new_(P$.AlignFrame$8.$init$,[this, null]))],$I$(21,1).c$$Runnable).start$();
}, p$1);
...
$I$(22,"setColourSelected$javax_swing_JMenu$jalview_schemes_ColourSchemeI",[this.colourMenu, av.getGlobalColourScheme$()]);
...
Clazz.new_($I$(23,1).c$$jalview_gui_IProgressIndicator,[this]);
});
...
if ($I$(24).Jalview.equals$O(this.currentFileFormat)) {
...
$I$(8).instance.closeAssociatedWindows$();
var loader=Clazz.new_($I$(25,1));
var protocol=$I$(26).startsWithHttpOrHttps$S(this.fileName) ? $I$(27).URL : $I$(27).FILE;
...
newframe=loader.LoadFileWaitTillLoaded$java_io_File$jalview_io_DataSourceType$jalview_io_FileFormatI(this.fileObject, $I$(27).FILE, this.currentFileFormat);
...
$I$(19,"invokeLater$Runnable",[((P$.AlignFrame$9||
...
if (this.fileName == null  || (this.currentFileFormat == null )  || $I$(26).startsWithHttpOrHttps$S(this.fileName) ) {
...
var chooser=$I$(28,"forWrite$S$S",[$I$(7).getProperty$S("LAST_DIRECTORY"), format]);
chooser.setFileView$javax_swing_filechooser_FileView(Clazz.new_($I$(29,1)));
...
$I$(30,"showInternalMessageDialog$java_awt_Component$S$S$I",[$I$(8).desktop, $I$(11).getString$S("label.select_file_format_before_saving"), $I$(11).getString$S("label.file_format_not_specified"), 2]);
this.currentFileFormat=chooser.getSelectedFormat$();
...
if (!$I$(10).isHeadless$()) {
$I$(30,"showInternalMessageDialog$java_awt_Component$S$S$I",[this, $I$(11,"formatMessage$S$OA",["label.couldnt_save_file", Clazz.array(java.lang.Object, -1, [this.lastFilenameSaved])]), $I$(11).getString$S("label.error_saving_file"), 2]);
} else {
$I$(31,"error$S",[$I$(11,"formatMessage$S$OA",["label.couldnt_save_file", Clazz.array(java.lang.Object, -1, [this.lastFilenameSaved])])]);
}} else {
...
if ($I$(24).Jalview.equals$O(format)) {
var shortName=this.title;
if (shortName.indexOf$I($I$(32).separatorChar) > -1) {
shortName=shortName.substring$I(shortName.lastIndexOf$I($I$(32).separatorChar) + 1);
}this.lastSaveSuccessful=Clazz.new_($I$(33,1)).saveAlignment$jalview_gui_AlignFrame$S$S(this, file, shortName);
this.statusBar.setText$S($I$(11,"formatMessage$S$OA",["label.successfully_saved_to_file_in_format", Clazz.array(java.lang.Object, -1, [file, format])]));
return;
}var options=Clazz.new_($I$(34,1).c$$Z,[false]);
...
var output=Clazz.new_($I$(35,1).c$$jalview_api_AlignmentViewPanel$jalview_api_AlignExportSettingsI,[this.b$['jalview.gui.AlignFrame'].alignPanel, this.$finals$.options]).formatSequences$jalview_io_FileFormatI$jalview_datamodel_AlignmentI$SA$IA$jalview_datamodel_HiddenColumns(this.$finals$.format, exportData.getAlignment$(), exportData.getOmitHidden$(), exportData.getStartEndPostions$(), this.b$['jalview.gui.AlignFrame'].viewport.getAlignment$().getHiddenColumns$());
if (output == null ) {
this.b$['jalview.gui.AlignFrame'].lastSaveSuccessful=false;
} else {
var doBackup=$I$(36).getEnabled$();
var backupfiles=null;
if (doBackup) {
$I$(31).trace$S("ALIGNFRAME making backupfiles object for " + this.$finals$.file);
backupfiles=Clazz.new_($I$(36,1).c$$S,[this.$finals$.file]);
}try {
var tempFilePath=doBackup ? backupfiles.getTempFilePath$() : this.$finals$.file;
$I$(31).trace$S("ALIGNFRAME setting PrintWriter");
var out=Clazz.new_([Clazz.new_($I$(38,1).c$$S,[tempFilePath])],$I$(37,1).c$$java_io_Writer);
if (backupfiles != null ) {
$I$(31,"trace$S",["ALIGNFRAME about to write to temp file " + backupfiles.getTempFilePath$()]);
}out.print$S(output);
$I$(31).trace$S("ALIGNFRAME about to close file");
out.close$();
$I$(31).trace$S("ALIGNFRAME closed file");
...
{
this.b$['jalview.gui.AlignFrame'].lastSaveSuccessful=false;
$I$(31).error$S("ALIGNFRAME Something happened writing the temp file");
$I$(31,"error$S",[e.getMessage$()]);
$I$(31,"debug$S",[$I$(7).getStackTraceString$Throwable(e)]);
}
} else if (Clazz.exceptionOf(e$$,"Exception")){
var ex = e$$;
{
this.b$['jalview.gui.AlignFrame'].lastSaveSuccessful=false;
$I$(31).error$S("ALIGNFRAME Something unexpected happened writing the temp file");
$I$(31,"error$S",[ex.getMessage$()]);
$I$(31,"debug$S",[$I$(7).getStackTraceString$Throwable(ex)]);
}
} else {
throw e$$;
}
...
$I$(31,"debug$S",["ALIGNFRAME writing temp file was " + (this.b$['jalview.gui.AlignFrame'].lastSaveSuccessful ? "" : "NOT ") + "successful" ]);
$I$(31).trace$S("ALIGNFRAME about to rollBackupsAndRenameTempFile");
this.b$['jalview.gui.AlignFrame'].lastSaveSuccessful=backupfiles.rollBackupsAndRenameTempFile$();
$I$(31,"debug$S",["ALIGNFRAME performed rollBackupsAndRenameTempFile " + (this.b$['jalview.gui.AlignFrame'].lastSaveSuccessful ? "" : "un") + "successfully" ]);
}}});
})()
), Clazz.new_(P$.AlignFrame$11.$init$,[this, {file:file,format:format,options:options}]));
if ($I$(39).isNeeded$jalview_api_AlignViewportI$jalview_io_FileFormatI(this.viewport, format)) {
var choices=Clazz.new_([this.alignPanel.getAlignViewport$(), format, options],$I$(39,1).c$$jalview_api_AlignViewportI$jalview_io_FileFormatI$jalview_api_AlignExportSettingsI);
choices.setResponseAction$O$Runnable(Integer.valueOf$I(0), outputAction);
choices.setResponseAction$O$Runnable(Integer.valueOf$I(1), cancelAction);
choices.showDialog$();
} else {
outputAction.run$();
}});
...
var fileFormat=$I$(40).getInstance$().forName$S(fileFormatName);
var options=Clazz.new_($I$(34,1).c$$Z,[false]);
...
Clazz.new_(["Outputting alignment as " + this.$finals$.fileFormat.getName$(), oom],$I$(42,1).c$$S$OutOfMemoryError);
cap.dispose$();
} else {
throw oom;
}
...
if ($I$(39).isNeeded$jalview_api_AlignViewportI$jalview_io_FileFormatI(this.viewport, fileFormat)) {
var choices=Clazz.new_([this.alignPanel.getAlignViewport$(), fileFormat, options],$I$(39,1).c$$jalview_api_AlignViewportI$jalview_io_FileFormatI$jalview_api_AlignExportSettingsI);
choices.setResponseAction$O$Runnable(Integer.valueOf$I(0), outputAction);
choices.showDialog$();
} else {
outputAction.run$();
...
var htmlSVG=Clazz.new_($I$(43,1).c$$jalview_gui_AlignmentPanel,[this.alignPanel]);
htmlSVG.exportHTML$S(null);
});

Clazz.newMeth(C$, 'bioJSMenuItem_actionPerformed$java_awt_event_ActionEvent',  function (e) {
var bjs=Clazz.new_($I$(44,1).c$$jalview_gui_AlignmentPanel,[this.alignPanel]);
...
this.alignPanel.makeAlignmentImage$jalview_util_ImageMaker_TYPE$java_io_File($I$(45).PNG, f);
});

Clazz.newMeth(C$, 'createEPS$java_io_File',  function (f) {
this.alignPanel.makeAlignmentImage$jalview_util_ImageMaker_TYPE$java_io_File($I$(45).EPS, f);
});

Clazz.newMeth(C$, 'createSVG$java_io_File',  function (f) {
this.alignPanel.makeAlignmentImage$jalview_util_ImageMaker_TYPE$java_io_File($I$(45).SVG, f);
});

Clazz.newMeth(C$, 'pageSetup_actionPerformed$java_awt_event_ActionEvent',  function (e) {
var printJob=$I$(46).getPrinterJob$();
$I$(47).pf=printJob.pageDialog$java_awt_print_PageFormat(printJob.defaultPage$());
});

Clazz.newMeth(C$, 'printMenuItem_actionPerformed$java_awt_event_ActionEvent',  function (e) {
var thread=Clazz.new_($I$(47,1).c$$jalview_gui_AlignmentPanel,[this.alignPanel]);
thread.start$();
});

Clazz.newMeth(C$, 'exportFeatures_actionPerformed$java_awt_event_ActionEvent',  function (e) {
Clazz.new_($I$(48,1).c$$jalview_gui_AlignmentPanel,[this.alignPanel]).exportFeatures$();
});

Clazz.newMeth(C$, 'exportAnnotations_actionPerformed$java_awt_event_ActionEvent',  function (e) {
Clazz.new_($I$(48,1).c$$jalview_gui_AlignmentPanel,[this.alignPanel]).exportAnnotations$();
});

Clazz.newMeth(C$, 'associatedData_actionPerformed$java_awt_event_ActionEvent',  function (e) {
var chooser=Clazz.new_([$I$(7).getProperty$S("LAST_DIRECTORY")],$I$(28,1).c$$S);
chooser.setFileView$javax_swing_filechooser_FileView(Clazz.new_($I$(29,1)));
...
chooser.setResponseHandler$O$Runnable(Integer.valueOf$I(0), ((P$.AlignFrame$13||
...
if (this.alignPanels != null ) {
var als=Clazz.array($I$(49), [this.alignPanels.size$()]);
var i=0;
...
return Clazz.array($I$(49), -1, [this.viewport.getAlignment$()]);
}return null;
});
...
$I$(31).warn$S("Implementation worry: mismatch of viewport origin for undo");
...
if (originalSource != null ) {
if (originalSource !== this.viewport ) {
$I$(31).warn$S("Implementation worry: mismatch of viewport origin for redo");
}originalSource.updateHiddenColumns$();
originalSource.firePropertyChange$S$O$O("alignment", null, originalSource.getAlignment$().getSequences$());
}});
...
var comps=$I$(18).components.get$O(this.viewport.getSequenceSetId$());
...
if (al != null ) {
$I$(18,"validateSequences$jalview_datamodel_AlignmentI$jalview_datamodel_AlignmentI",[al, this.viewport.getAlignment$()]);
...
sg=Clazz.new_($I$(50,1));
sg.addSequence$jalview_datamodel_SequenceI$Z(this.viewport.getAlignment$().getSequenceAt$I(this.alignPanel.getSeqPanel$().seqCanvas.cursorY), false);
} else {
return;
}}if (sg.getSize$() < 1) {
return;
...
var seqs1=sg.toArray$OA(Clazz.array($I$(51), [0]));
var seqs2=Clazz.array($I$(51), [invertGroup.size$()]);
for (var i=0; i < invertGroup.size$(); i++) {
seqs2[i]=invertGroup.get$I(i);
}
var ssc;
if (right) {
ssc=Clazz.new_(["Slide Sequences", seqs2, seqs1, size, this.viewport.getGapCharacter$()],$I$(52,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_SequenceIA$I$C);
} else {
ssc=Clazz.new_(["Slide Sequences", seqs1, seqs2, size, this.viewport.getGapCharacter$()],$I$(52,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_SequenceIA$I$C);
...
}var output=Clazz.new_($I$(35,1)).formatSequences$jalview_io_FileFormatI$jalview_datamodel_SequenceIA$SA$IA($I$(24).Fasta, seqs, omitHidden, null);
var ss=Clazz.new_($I$(53,1).c$$S,[output]);
try {
$I$(8).internalCopy=true;
$I$(54).getDefaultToolkit$().getSystemClipboard$().setContents$java_awt_datatransfer_Transferable$java_awt_datatransfer_ClipboardOwner(Clazz.new_($I$(53,1).c$$S,[""]), null);
$I$(54).getDefaultToolkit$().getSystemClipboard$().setContents$java_awt_datatransfer_Transferable$java_awt_datatransfer_ClipboardOwner(ss, $I$(8).instance);
} catch (er) {
if (Clazz.exceptionOf(er,"OutOfMemoryError")){
Clazz.new_($I$(42,1).c$$S$OutOfMemoryError,["copying region", er]);
return;
} else {
throw er;
}
...
hiddenColumns=Clazz.new_([this.viewport.getAlignment$().getHiddenColumns$(), hiddenOffset, hiddenCutoff, hiddenOffset],$I$(55,1).c$$jalview_datamodel_HiddenColumns$I$I$I);
...
try {
var c=$I$(54).getDefaultToolkit$().getSystemClipboard$();
...
var format;
try {
str=contents.getTransferData$java_awt_datatransfer_DataFlavor($I$(56).stringFlavor);
if (str.length$() < 1) {
return;
}format=Clazz.new_($I$(57,1)).identify$S$jalview_io_DataSourceType(str, $I$(27).PASTE);
} catch (er) {
if (Clazz.exceptionOf(er,"OutOfMemoryError")){
Clazz.new_($I$(42,1).c$$S$OutOfMemoryError,["Out of memory pasting sequences!!", er]);
return;
} else {
throw er;
}
...
sequences=Clazz.array($I$(51), [newseq.length]);
for (var i=0; i < newseq.length; i++) {
sequences[i]=Clazz.new_($I$(58,1).c$$jalview_datamodel_SequenceI,[newseq[i]]);
}
alignment=Clazz.new_($I$(59,1).c$$jalview_datamodel_SequenceIA,[sequences]);
externalPaste=false;
} else {
alignment=Clazz.new_($I$(35,1)).readFile$S$jalview_io_DataSourceType$jalview_io_FileFormatI(str, $I$(27).PASTE, format);
...
var newDs=(importDs) ? Clazz.new_($I$(60,1)) : null;
...
ds=Clazz.new_($I$(58,1).c$$jalview_datamodel_SequenceI,[ds]);
...
var newann=Clazz.new_($I$(61,1).c$$jalview_datamodel_AlignmentAnnotation,[alann[i]]);
...
this.addHistoryItem$jalview_commands_CommandI(Clazz.new_([$I$(11).getString$S("label.add_sequences"), $I$(63).PASTE, sequences, 0, alignment.getWidth$(), alignment],$I$(62,1).c$$S$jalview_commands_EditCommand_Action$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI));
}for (var i=0; i < sequences.length; i++) {
...
var newann=Clazz.new_($I$(61,1).c$$jalview_datamodel_AlignmentAnnotation,[sann[a]]);
...
try {
var alignment=$I$(64,"expandContext$jalview_datamodel_AlignmentI$I",[this.getViewport$().getAlignment$(), -1]);
var af=Clazz.new_(C$.c$$jalview_datamodel_AlignmentI$I$I,[alignment, 700, 500]);
...
var oom = e$$;
{
Clazz.new_($I$(42,1).c$$S$OutOfMemoryError,["Viewing flanking region of alignment", oom]);
}
} else {
throw e$$;
}
...
Clazz.newMeth(C$, 'run$',  function () {
var cut=this.$finals$.sg.getSequences$().toArray$OA(Clazz.array($I$(51), [this.$finals$.sg.getSize$()]));
this.b$['jalview.gui.AlignFrame'].addHistoryItem$jalview_commands_CommandI.apply(this.b$['jalview.gui.AlignFrame'], [Clazz.new_([$I$(11).getString$S("label.cut_sequences"), $I$(63).CUT, cut, this.$finals$.sg.getStartRes$(), this.$finals$.sg.getEndRes$() - this.$finals$.sg.getStartRes$() + 1, this.b$['jalview.gui.AlignFrame'].viewport.getAlignment$()],$I$(62,1).c$$S$jalview_commands_EditCommand_Action$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI)]);
...
var dialog=$I$(30,"newOptionDialog$java_awt_Component",[$I$(8).desktop]);
dialog.setResponseHandler$O$Runnable(Integer.valueOf$I(0), okAction);
...
$I$(18,"Refresh$java_awt_Component$S",[this, this.viewport.getSequenceSetId$()]);
...
var sg=Clazz.new_([this.viewport.getAlignment$().getSequences$()],$I$(50,1).c$$java_util_List);
...
$I$(18,"Refresh$java_awt_Component$S",[this.alignPanel, this.viewport.getSequenceSetId$()]);
});
...
this.viewport.setSearchResults$jalview_datamodel_SearchResultsI(null);
...
if (trimLeft) {
trimRegion=Clazz.new_(["Remove Left", true, seqs, column, this.viewport.getAlignment$()],$I$(65,1).c$$S$Z$jalview_datamodel_SequenceIA$I$jalview_datamodel_AlignmentI);
this.viewport.getRanges$().setStartRes$I(0);
} else {
trimRegion=Clazz.new_(["Remove Right", false, seqs, column, this.viewport.getAlignment$()],$I$(65,1).c$$S$Z$jalview_datamodel_SequenceIA$I$jalview_datamodel_AlignmentI);
...
seqs=this.viewport.getAlignment$().getSequencesArray$();
}var removeGapCols=Clazz.new_(["Remove Gapped Columns", seqs, start, end, this.viewport.getAlignment$()],$I$(66,1).c$$S$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI);
...
this.addHistoryItem$jalview_commands_CommandI(Clazz.new_(["Remove Gaps", seqs, start, end, this.viewport.getAlignment$()],$I$(67,1).c$$S$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI));
...
Clazz.new_($I$(68,1).c$$jalview_gui_AlignmentPanel$Z$S,[this.alignPanel, false, null]);
});
...
var newap=Clazz.new_($I$(33,1)).copyAlignPanel$jalview_gui_AlignmentPanel(this.alignPanel);
if (!copyAnnotation) {
...
Clazz.new_($I$(69,1).c$$jalview_gui_AlignmentPanel,[this.alignPanel]);
});
...
}this.featureSettings=Clazz.new_($I$(70,1).c$$jalview_gui_AlignFrame,[this]);
return this.featureSettings;
});
...
var pane;
var contents=Clazz.new_([this.viewport.getAlignment$()],$I$(71,1).c$$jalview_datamodel_AlignmentI).formatAsHtml$();
var content=$I$(11,"formatMessage$S$OA",["label.html_content", Clazz.array(java.lang.Object, -1, [contents.toString()])]);
contents=null;
if ($I$(10).isJS$()) {
var textLabel=Clazz.new_($I$(72,1));
textLabel.setText$S(content);
textLabel.setBackground$java_awt_Color($I$(73).WHITE);
pane=Clazz.new_([Clazz.new_($I$(75,1))],$I$(74,1).c$$java_awt_LayoutManager);
(pane).setOpaque$Z(true);
pane.setBackground$java_awt_Color($I$(73).WHITE);
(pane).add$java_awt_Component$O(textLabel, "North");
} else 
{}
var frame=Clazz.new_($I$(76,1));
frame.getContentPane$().add$java_awt_Component(Clazz.new_($I$(77,1).c$$java_awt_Component,[pane]));
...
var overview=Clazz.new_($I$(78,1).c$$jalview_gui_AlignmentPanel,[this.alignPanel]);
...
frame.pack$();
frame.setLayer$Integer($I$(79).PALETTE_LAYER);
...
), Clazz.new_($I$(20,1),[this, {overview:overview}],P$.AlignFrame$15)));
...
Clazz.new_($I$(80,1)).chooseColour$jalview_gui_AlignmentPanel$jalview_datamodel_SequenceGroup(this.alignPanel, null);
});

Clazz.newMeth(C$, 'annotationColour_actionPerformed$',  function () {
Clazz.new_($I$(81,1).c$$jalview_gui_AlignViewport$jalview_gui_AlignmentPanel,[this.viewport, this.alignPanel]);
});

Clazz.newMeth(C$, 'annotationColumn_actionPerformed$java_awt_event_ActionEvent',  function (e) {
Clazz.new_($I$(82,1).c$$jalview_gui_AlignViewport$jalview_gui_AlignmentPanel,[this.viewport, this.alignPanel]);
});
...
Clazz.new_($I$(83,1).c$$jalview_gui_AlignmentPanel,[this.alignPanel]);
return;
}var cs=$I$(84).getInstance$().getColourScheme$S$jalview_api_AlignViewportI$jalview_datamodel_AnnotatedCollectionI$java_util_Map(name, this.viewport, this.viewport.getAlignment$(), this.viewport.getHiddenRepSequences$());
this.changeColour$jalview_schemes_ColourSchemeI(cs);
});

Clazz.newMeth(C$, 'changeColour$jalview_schemes_ColourSchemeI',  function (cs) {
$I$(22).setColourSelected$javax_swing_JMenu$jalview_schemes_ColourSchemeI(this.colourMenu, cs);
this.viewport.setGlobalColourScheme$jalview_schemes_ColourSchemeI(cs);
this.alignPanel.paintAlignment$Z$Z(true, true);
});

Clazz.newMeth(C$, 'modifyPID_actionPerformed$',  function () {
$I$(85,"setPIDSliderSource$jalview_gui_AlignmentPanel$jalview_renderer_ResidueShaderI$S",[this.alignPanel, this.viewport.getResidueShading$(), this.alignPanel.getViewName$()]);
$I$(85).showPIDSlider$();
});

Clazz.newMeth(C$, 'modifyConservation_actionPerformed$',  function () {
$I$(85,"setConservationSlider$jalview_gui_AlignmentPanel$jalview_renderer_ResidueShaderI$S",[this.alignPanel, this.viewport.getResidueShading$(), this.alignPanel.getViewName$()]);
$I$(85).showConservationSlider$();
});
...
$I$(86,"sortByPID$jalview_datamodel_AlignmentI$jalview_datamodel_SequenceI",[this.viewport.getAlignment$(), this.viewport.getAlignment$().getSequenceAt$I(0)]);
this.addHistoryItem$jalview_commands_CommandI(Clazz.new_(["Pairwise Sort", oldOrder, this.viewport.getAlignment$()],$I$(87,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI));
this.alignPanel.paintAlignment$Z$Z(true, false);
});

Clazz.newMeth(C$, 'sortIDMenuItem_actionPerformed$java_awt_event_ActionEvent',  function (e) {
var oldOrder=this.viewport.getAlignment$().getSequencesArray$();
$I$(86,"sortByID$jalview_datamodel_AlignmentI",[this.viewport.getAlignment$()]);
this.addHistoryItem$jalview_commands_CommandI(Clazz.new_(["ID Sort", oldOrder, this.viewport.getAlignment$()],$I$(87,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI));
this.alignPanel.paintAlignment$Z$Z(true, false);
});

Clazz.newMeth(C$, 'sortLengthMenuItem_actionPerformed$java_awt_event_ActionEvent',  function (e) {
var oldOrder=this.viewport.getAlignment$().getSequencesArray$();
$I$(86,"sortByLength$jalview_datamodel_AlignmentI",[this.viewport.getAlignment$()]);
this.addHistoryItem$jalview_commands_CommandI(Clazz.new_(["Length Sort", oldOrder, this.viewport.getAlignment$()],$I$(87,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI));
this.alignPanel.paintAlignment$Z$Z(true, false);
});

Clazz.newMeth(C$, 'sortGroupMenuItem_actionPerformed$java_awt_event_ActionEvent',  function (e) {
var oldOrder=this.viewport.getAlignment$().getSequencesArray$();
$I$(86,"sortByGroup$jalview_datamodel_AlignmentI",[this.viewport.getAlignment$()]);
this.addHistoryItem$jalview_commands_CommandI(Clazz.new_(["Group Sort", oldOrder, this.viewport.getAlignment$()],$I$(87,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI));
this.alignPanel.paintAlignment$Z$Z(true, false);
});

Clazz.newMeth(C$, 'removeRedundancyMenuItem_actionPerformed$java_awt_event_ActionEvent',  function (e) {
Clazz.new_($I$(88,1).c$$jalview_gui_AlignmentPanel$jalview_gui_AlignFrame,[this.alignPanel, this]);
});
...
$I$(30,"showInternalMessageDialog$java_awt_Component$S$S$I",[this, $I$(11).getString$S("label.you_must_select_least_two_sequences"), $I$(11).getString$S("label.invalid_selection"), 2]);
} else {
var frame=Clazz.new_($I$(76,1));
frame.setContentPane$java_awt_Container(Clazz.new_($I$(89,1).c$$jalview_viewmodel_AlignmentViewport,[this.viewport]));
...
$I$(30,"showMessageDialog$java_awt_Component$S$S$I",[$I$(8).desktop, $I$(11).getString$S("label.selected_region_to_tree_may_only_contain_residues_or_gaps"), $I$(11).getString$S("label.sequences_selection_not_aligned"), 2]);
return;
}}
onSelection=true;
} else {
...
return;
}}tp=Clazz.new_($I$(90,1).c$$jalview_gui_AlignmentPanel$S$S$jalview_api_analysis_SimilarityParamsI,[this.alignPanel, type, modelName, options]);
...
var item=Clazz.new_([$I$(11,"formatMessage$S$OA",["action.by_title_param", Clazz.array(java.lang.Object, -1, [title])])],$I$(91,1).c$$S);
...
$I$(86,"sortBy$jalview_datamodel_AlignmentI$jalview_datamodel_AlignmentOrder",[this.b$['jalview.gui.AlignFrame'].viewport.getAlignment$(), this.$finals$.order]);
this.b$['jalview.gui.AlignFrame'].addHistoryItem$jalview_commands_CommandI.apply(this.b$['jalview.gui.AlignFrame'], [Clazz.new_([this.$finals$.order.getName$(), oldOrder, this.b$['jalview.gui.AlignFrame'].viewport.getAlignment$()],$I$(87,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI)]);
...
var item=Clazz.new_($I$(91,1).c$$S,[scoreLabel]);
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent',  function (e) {
var oldOrder=this.b$['jalview.gui.AlignFrame'].viewport.getAlignment$().getSequencesArray$();
$I$(86,"sortByAnnotationScore$S$jalview_datamodel_AlignmentI",[this.$finals$.scoreLabel, this.b$['jalview.gui.AlignFrame'].viewport.getAlignment$()]);
this.b$['jalview.gui.AlignFrame'].addHistoryItem$jalview_commands_CommandI.apply(this.b$['jalview.gui.AlignFrame'], [Clazz.new_(["Sort by " + this.$finals$.scoreLabel, oldOrder, this.b$['jalview.gui.AlignFrame'].viewport.getAlignment$()],$I$(87,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI)]);
this.b$['jalview.gui.AlignFrame'].alignPanel.paintAlignment$Z$Z(true, false);
});
})()
...
var scoreSorts=Clazz.new_($I$(92,1));
var aann;
...
var item=Clazz.new_([tp.getTitle$()],$I$(91,1).c$$S);
...
var oldOrder=this.viewport.getAlignment$().getSequencesArray$();
$I$(86,"sortBy$jalview_datamodel_AlignmentI$jalview_datamodel_AlignmentOrder",[this.viewport.getAlignment$(), alorder]);
if (undoname != null ) {
this.addHistoryItem$jalview_commands_CommandI(Clazz.new_([undoname, oldOrder, this.viewport.getAlignment$()],$I$(87,1).c$$S$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI));
}this.alignPanel.paintAlignment$Z$Z(true, false);
return true;
});
...
var option=$I$(30,"showConfirmDialog$java_awt_Component$O$S$I",[this, $I$(11).getString$S("warn.oneseq_msainput_selection"), $I$(11).getString$S("label.invalid_selection"), 2]);
if (option == 0) {
...
seqs.setSequences$jalview_datamodel_SeqCigarA(Clazz.array($I$(93), -1, [seqs.getSequences$()[0]]));
}return seqs;
});
...
chooser.setResponseHandler$O$Runnable(Integer.valueOf$I(0), ((P$.AlignFrame$19||
...
var fin=null;
try {
fin=Clazz.new_([Clazz.new_([this.$finals$.chooser.getSelectedFile$(), $I$(27).FILE],$I$(95,1).c$$O$jalview_io_DataSourceType)],$I$(94,1).c$$jalview_io_FileParse);
...
if (Clazz.exceptionOf(ex,"Exception")){
$I$(30,"showMessageDialog$java_awt_Component$S$S$I",[$I$(8).desktop, ex.getMessage$(), $I$(11).getString$S("label.problem_reading_tree_file"), 2]);
ex.printStackTrace$();
} else {
throw ex;
}
...
$I$(30,"showMessageDialog$java_awt_Component$S$S$I",[$I$(8).desktop, fin.getWarningMessage$(), $I$(11).getString$S("label.possible_problem_with_tree_file"), 2]);
}});
})()
...
nf.parse$();
if (nf.getTree$() != null ) {
tp=Clazz.new_($I$(90,1).c$$jalview_gui_AlignmentPanel$jalview_io_NewickFile$S$jalview_datamodel_AlignmentView,[this.alignPanel, nf, treeTitle, input]);
tp.setSize$I$I(w, h);
if (x > 0 && y > 0 ) {
...
try {
var wsmenu=Clazz.new_($I$(60,1));
var af=this.$finals$.me;
var msawsmenu=Clazz.new_($I$(96,1).c$$S,["Alignment"]);
var secstrmenu=Clazz.new_($I$(96,1).c$$S,["Secondary Structure Prediction"]);
var seqsrchmenu=Clazz.new_($I$(96,1).c$$S,["Sequence Database Search"]);
var analymenu=Clazz.new_($I$(96,1).c$$S,["Analysis"]);
var dismenu=Clazz.new_($I$(96,1).c$$S,["Protein Disorder"]);
if ($I$(97).services != null  && ($I$(97).services.size$() > 0) ) {
var secstrpr=$I$(97).services.get$O("SecStrPred");
if (secstrpr != null ) {
for (var i=0, j=secstrpr.size$(); i < j; i++) {
var sh=secstrpr.get$I(i);
var impl=$I$(97).getServiceClient$ext_vamsas_ServiceHandle(sh);
...
$I$(19,"invokeLater$Runnable",[((P$.AlignFrame$20$1||
...
var jws2servs=$I$(98).getDiscoverer$();
if (jws2servs != null ) {
...
if (sv.description.toLowerCase$java_util_Locale($I$(14).ROOT).contains$CharSequence("jpred")) {
for (var jmi, $jmi = this.$finals$.legacyItems.iterator$(); $jmi.hasNext$()&&((jmi=($jmi.next$())),1);) {
jmi.setVisible$Z(false);
}
}}
}if (jws2servs.isRunning$()) {
var tm=Clazz.new_($I$(91,1).c$$S,["Still discovering JABA Services"]);
tm.setEnabled$Z(false);
this.b$['jalview.gui.AlignFrame'].webService.add$javax_swing_JMenuItem(tm);
} else if (!$I$(7).getDefault$S$Z("SHOW_JWS2_SERVICES", true)) {
var enableJws2=Clazz.new_($I$(91,1).c$$S,["Discover Web Services"]);
enableJws2.setToolTipText$S("Select to start JABA Web Service discovery (or enable option in Web Service preferences)");
enableJws2.setEnabled$Z(true);
enableJws2.addActionListener$java_awt_event_ActionListener(((P$.AlignFrame$20$1$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "AlignFrame$20$1$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent',  function (e) {
$I$(8).instance.startServiceDiscovery$Z$Z(false, true);
});
})()
), Clazz.new_(P$.AlignFrame$20$1$1.$init$,[this, null])));
this.b$['jalview.gui.AlignFrame'].webService.add$javax_swing_JMenuItem(enableJws2);
...
if (Clazz.exceptionOf(e,"Exception")){
$I$(31).debug$S$Throwable("Exception during web service menu building process.", e);
} else {
throw e;
}
}
...
), Clazz.new_(P$.AlignFrame$20$1.$init$,[this, {legacyItems:legacyItems,wsmenu:wsmenu,me:this.$finals$.me}]))]);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
} else {
throw e;
...
), Clazz.new_(P$.AlignFrame$20.$init$,[this, {me:me}]))],$I$(21,1).c$$Runnable).start$();
});

Clazz.newMeth(C$, 'build_urlServiceMenu$javax_swing_JMenu',  function (webService) {
for (var client, $client = 0, $$client = $I$(99).getRestClients$(); $client<$$client.length&&((client=($$client[$client])),1);$client++) {
client.attachWSMenuEntry$javax_swing_JMenu$jalview_gui_AlignFrame($I$(100,"findOrCreateMenu$javax_swing_JMenu$S",[webService, client.getAction$()]), this);
}
});
...
try {
var ptypes=Clazz.new_($I$(101,1).c$$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI,[seqs, dataset]).findXrefSourcesForSequences$Z(dna);
for (var source, $source = ptypes.iterator$(); $source.hasNext$()&&((source=($source.next$())),1);) {
showp=true;
var af=this;
var xtype=Clazz.new_($I$(91,1).c$$S,[source]);
...
if (Clazz.exceptionOf(e,"Exception")){
$I$(31).warn$S$Throwable("canShowProducts threw an exception - please report to help@jalview.org", e);
return false;
} else {
throw e;
}
...
Clazz.new_([$I$(102).getHandlerFor$jalview_datamodel_SequenceIA$Z$S$jalview_gui_AlignFrame(sel, _odna, source, this)],$I$(21,1).c$$Runnable).start$();
});

Clazz.newMeth(C$, 'showTranslation_actionPerformed$jalview_analysis_GeneticCodeI',  function (codeTable) {
var al=null;
try {
var dna=Clazz.new_([this.viewport, this.viewport.getViewAsVisibleContigs$Z(true)],$I$(103,1).c$$jalview_api_AlignViewportI$java_util_Iterator);
al=dna.translateCdna$jalview_analysis_GeneticCodeI(codeTable);
} catch (ex) {
if (Clazz.exceptionOf(ex,"Exception")){
$I$(31).error$S$Throwable("Exception during translation. Please report this !", ex);
...
$I$(30,"showMessageDialog$java_awt_Component$S$S$I",[$I$(8).desktop, msg, errorTitle, 0]);
return;
} else {
throw ex;
}
...
$I$(30,"showMessageDialog$java_awt_Component$S$S$I",[$I$(8).desktop, msg, errorTitle, 2]);
} else {
...
var seqs=this.viewport.getSelectionAsNewSequence$();
this.viewport.openSplitFrame$jalview_gui_AlignFrame$jalview_datamodel_AlignmentI(af, Clazz.new_($I$(59,1).c$$jalview_datamodel_SequenceIA,[seqs]));
} else {
$I$(8).addInternalFrame$javax_swing_JInternalFrame$S$I$I(af, newTitle, 700, 500);
}}});
...
Clazz.newMeth(C$, 'run$',  function () {
try {
var idm=Clazz.new_([this.b$['jalview.gui.AlignFrame'].viewport.getAlignment$().getSequencesArray$()],$I$(104,1).c$$jalview_datamodel_SequenceIA);
...
var pdbfn="";
var protocol=(Clazz.instanceOf(file, "java.io.File") ? $I$(27).FILE : $I$(105).checkProtocol$O(fileName));
if (protocol === $I$(27).FILE ) {
var fl;
if (Clazz.instanceOf(file, "java.io.File")) {
fl=file;
$I$(10).cacheFileData$java_io_File(fl);
} else {
fl=Clazz.new_($I$(32,1).c$$S,[fileName]);
}pdbfn=fl.getName$();
} else if (protocol === $I$(27).URL ) {
var url=Clazz.new_($I$(106,1).c$$S,[fileName]);
pdbfn=url.getFile$();
}if (pdbfn.length$() > 0) {
...
var type;
try {
type=Clazz.new_($I$(57,1)).identify$O$jalview_io_DataSourceType(file, protocol);
} catch (ex) {
if (Clazz.exceptionOf(ex,"Exception")){
type=null;
} else {
...
var choice=$I$(30).showConfirmDialog$java_awt_Component$O$S$I(this.$finals$.thisaf, msg, ttl, 0);
...
var pe=Clazz.new_($I$(107,1)).associatePdbWithSeq$S$jalview_io_DataSourceType$jalview_datamodel_SequenceI$Z$jalview_api_StructureSelectionManagerProvider(fm[0].toString(), fm[1], toassoc, false, $I$(8).instance);
if (pe != null ) {
...
if (assocfiles > 0 && ($I$(7).getDefault$S$Z("AUTOASSOCIATE_PDBANDSEQS_IGNOREOTHERS", false) || $I$(30,"showConfirmDialog$java_awt_Component$O$S$I",[this.$finals$.thisaf, "<html>" + $I$(11,"formatMessage$S$OA",["label.ignore_unmatched_dropped_files_info", Clazz.array(java.lang.Object, -1, [Integer.valueOf$I(filesnotmatched.size$()).toString()])]) + "</html>" , $I$(11).getString$S("label.ignore_unmatched_dropped_files"), 0]) == 0 ) ) {
return;
...
), Clazz.new_(P$.AlignFrame$22.$init$,[this, {files:files,thisaf:thisaf}]))],$I$(21,1).c$$Runnable).start$();
}});
...
try {
if (sourceType == null ) {
sourceType=$I$(105).checkProtocol$O(file);
}var isAnnotation=(format == null  || $I$(24).Pfam.equals$O(format) ) ? Clazz.new_($I$(108,1)).annotateAlignmentView$jalview_api_AlignViewportI$O$jalview_io_DataSourceType(this.viewport, file, sourceType) : false;
if (!isAnnotation) {
var tcf=null;
try {
tcf=Clazz.new_($I$(109,1).c$$O$jalview_io_DataSourceType,[file, sourceType]);
if (tcf.isValid$()) {
if (tcf.annotateAlignment$jalview_datamodel_AlignmentI$Z(this.viewport.getAlignment$(), true)) {
this.buildColourMenu$();
this.changeColour$jalview_schemes_ColourSchemeI(Clazz.new_([this.viewport.getAlignment$()],$I$(110,1).c$$jalview_datamodel_AnnotatedCollectionI));
isAnnotation=true;
this.setStatus$S($I$(11).getString$S("label.successfully_pasted_tcoffee_scores_to_alignment"));
} else {
$I$(30,"showMessageDialog$java_awt_Component$S$S$I",[$I$(8).desktop, tcf.getWarningMessage$() == null  ? $I$(11).getString$S("label.check_file_matches_sequence_ids_alignment") : tcf.getWarningMessage$(), $I$(11).getString$S("label.problem_reading_tcoffee_score_file"), 2]);
}} else {
tcf=null;
}} catch (x) {
if (Clazz.exceptionOf(x,"Exception")){
$I$(31).debug$S$Throwable("Exception when processing data source as T-COFFEE score file", x);
tcf=null;
} else {
throw x;
}
...
if (tcf == null ) {
if (format == null ) {
format=Clazz.new_($I$(57,1)).identify$O$jalview_io_DataSourceType(file, sourceType);
}if ($I$(24).ScoreMatrix === format ) {
var sm=Clazz.new_([Clazz.new_($I$(95,1).c$$O$jalview_io_DataSourceType,[file, sourceType])],$I$(111,1).c$$jalview_io_FileParse);
sm.parse$();
this.setStatus$S($I$(11,"formatMessage$S$OA",["label.successfully_loaded_matrix", Clazz.array(java.lang.Object, -1, [sm.getMatrixName$()])]));
} else if ($I$(24).Jnet.equals$O(format)) {
var predictions=Clazz.new_($I$(112,1).c$$O$jalview_io_DataSourceType,[file, sourceType]);
Clazz.new_($I$(113,1));
$I$(113,"add_annotation$jalview_io_JPredFile$jalview_datamodel_AlignmentI$I$Z",[predictions, this.viewport.getAlignment$(), 0, false]);
this.viewport.getAlignment$().setupJPredAlignment$();
isAnnotation=true;
} else if ($I$(24).Features.equals$O(format)) {
...
Clazz.new_($I$(25,1)).LoadFile$jalview_gui_AlignViewport$O$jalview_io_DataSourceType$jalview_io_FileFormatI(this.viewport, file, sourceType, format);
}}}if (isAnnotation) {
...
Clazz.new_(["loading data " + (sourceType != null  ? (sourceType === $I$(27).PASTE  ? "from clipboard." : "using " + sourceType + " from " + file ) : ".") + (format != null  ? "(parsing as '" + format + "' file)"  : "") , oom, $I$(8).desktop],$I$(42,1).c$$S$OutOfMemoryError$java_awt_Component);
}
} else {
throw e$$;
}
...
var reply=$I$(30).showInputDialog$S$S(msg, ttl);
if (reply != null ) {
...
var pp=Clazz.new_([this.viewport.getAlignment$()],$I$(114,1).c$$jalview_datamodel_AlignmentI);
...
var rfetch=Clazz.new_([$I$(11).getString$S("action.fetch_db_references")],$I$(96,1).c$$S);
...
var trimrs=Clazz.new_([$I$(11).getString$S("option.trim_retrieved_seqs")],$I$(115,1).c$$S);
...
$I$(7,"setProperty$S$S",["TRIM_FETCHED_DATASET_SEQS", Boolean.valueOf$Z(this.$finals$.trimrs.isSelected$()).toString()]);
});
})()
), Clazz.new_(P$.AlignFrame$23.$init$,[this, {trimrs:trimrs}])));
rfetch.add$javax_swing_JMenuItem(trimrs);
var fetchr=Clazz.new_([$I$(11).getString$S("label.standard_databases")],$I$(91,1).c$$S);
...
var dbRefFetcher=Clazz.new_([this.b$['jalview.gui.AlignFrame'].alignPanel.av.getSequenceSelection$(), this.b$['jalview.gui.AlignFrame'].alignPanel.alignFrame, null, this.b$['jalview.gui.AlignFrame'].alignPanel.alignFrame.featureSettings, isNucleotide],$I$(116,1).c$$jalview_datamodel_SequenceIA$jalview_gui_IProgressIndicator$jalview_ws_seqfetcher_DbSourceProxyA$jalview_gui_FeatureSettings$Z);
...
), Clazz.new_(P$.AlignFrame$24$1.$init$,[this, null]))],$I$(21,1).c$$Runnable).start$();
});
})()
...
Clazz.newMeth(C$, 'run$',  function () {
var sf=$I$(23).getSequenceFetcherSingleton$();
$I$(19,"invokeLater$Runnable",[((P$.AlignFrame$25$1||
...
var otherdb;
var dfetch=Clazz.new_($I$(96,1));
var ifetch=Clazz.new_($I$(96,1));
var fetchr=null;
var comp=0;
var icomp=0;
var mcomp=15;
...
var dassource=otherdb.toArray$OA(Clazz.array($I$(117), [0]));
var src=otherdb.get$I(0);
fetchr=Clazz.new_([src.getDbSource$()],$I$(91,1).c$$S);
...
), Clazz.new_(P$.AlignFrame$25$1$1$1.$init$,[this, {dassource:this.$finals$.dassource}]))],$I$(21,1).c$$Runnable).start$();
});
})()
), Clazz.new_(P$.AlignFrame$25$1$1.$init$,[this, {dassource:dassource}])));
fetchr.setToolTipText$S($I$(100,"wrapTooltip$Z$S",[true, $I$(11,"formatMessage$S$OA",["label.fetch_retrieve_from", Clazz.array(java.lang.Object, -1, [src.getDbName$()])])]));
dfetch.add$javax_swing_JMenuItem(fetchr);
++comp;
} else {
var dassource=otherdb.toArray$OA(Clazz.array($I$(117), [0]));
var src=otherdb.get$I(0);
fetchr=Clazz.new_([$I$(11,"formatMessage$S$OA",["label.fetch_all_param", Clazz.array(java.lang.Object, -1, [src.getDbSource$()])])],$I$(91,1).c$$S);
...
), Clazz.new_(P$.AlignFrame$25$1$2$1.$init$,[this, {dassource:this.$finals$.dassource}]))],$I$(21,1).c$$Runnable).start$();
});
})()
), Clazz.new_(P$.AlignFrame$25$1$2.$init$,[this, {dassource:dassource}])));
fetchr.setToolTipText$S($I$(100,"wrapTooltip$Z$S",[true, $I$(11,"formatMessage$S$OA",["label.fetch_retrieve_from_all_sources", Clazz.array(java.lang.Object, -1, [Integer.valueOf$I(otherdb.size$()).toString(), src.getDbSource$(), src.getDbName$()])])]));
dfetch.add$javax_swing_JMenuItem(fetchr);
++comp;
ifetch=Clazz.new_([$I$(11,"formatMessage$S$OA",["label.source_from_db_source", Clazz.array(java.lang.Object, -1, [src.getDbSource$()])])],$I$(96,1).c$$S);
icomp=0;
var imname=null;
var i=0;
...
}fetchr=Clazz.new_($I$(91,1).c$$S,[msname]);
var dassrc=Clazz.array($I$(117), -1, [sproxy]);
...
), Clazz.new_(P$.AlignFrame$25$1$3$1.$init$,[this, {dassrc:this.$finals$.dassrc}]))],$I$(21,1).c$$Runnable).start$();
});
})()
...
ifetch.setText$S($I$(11,"formatMessage$S$OA",["label.source_to_target", Clazz.array(java.lang.Object, -1, [imname, sname])]));
dfetch.add$javax_swing_JMenuItem(ifetch);
ifetch=Clazz.new_($I$(96,1));
imname=null;
icomp=0;
++comp;
}}
...
dfetch.setText$S($I$(11,"formatMessage$S$OA",["label.source_to_target", Clazz.array(java.lang.Object, -1, [mname, dbclass])]));
this.$finals$.rfetch.add$javax_swing_JMenuItem(dfetch);
dfetch=Clazz.new_($I$(96,1));
mname=null;
comp=0;
}}
});
})()
), Clazz.new_(P$.AlignFrame$25$1.$init$,[this, {rfetch:this.$finals$.rfetch,sf:sf}]))]);
});
})()
), Clazz.new_(P$.AlignFrame$25.$init$,[this, {rfetch:rfetch}]))],$I$(21,1).c$$Runnable).start$();
});
...
throw Clazz.new_([$I$(11).getString$S("error.implementation_error_cannot_show_view_alignment_frame")],$I$(118,1).c$$S);
...
if (dnaSeq != null ) {
var newSeq=Clazz.new_($I$(58,1).c$$jalview_datamodel_SequenceI,[dnaSeq]);
...
if (cdnaSeqs.size$() == 0) {
return;
}var cdna=Clazz.new_([cdnaSeqs.toArray$OA(Clazz.array($I$(51), [cdnaSeqs.size$()]))],$I$(59,1).c$$jalview_datamodel_SequenceIA);
...
this.addHistoryItem$jalview_commands_CommandI(Clazz.new_([$I$(11).getString$S("label.add_sequences"), $I$(63).PASTE, al.getSequencesArray$(), 0, al.getWidth$(), this.viewport.getAlignment$()],$I$(62,1).c$$S$jalview_commands_EditCommand_Action$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI));
} catch (ex) {
if (Clazz.exceptionOf(ex,"Exception")){
...
$I$(30,"showInternalMessageDialog$java_awt_Component$S$S$I",[$I$(8).desktop, $I$(11).getString$S("label.couldnt_run_groovy_script"), $I$(11).getString$S("label.groovy_support_failed"), 0]);
} else {
throw ex;
}
}
...
var bg=$I$(22,"addMenuItems$javax_swing_JMenu$jalview_gui_ColourMenuHelper_ColourChangeListener$jalview_datamodel_AnnotatedCollectionI$Z",[this.colourMenu, this, this.viewport.getAlignment$(), false]);
...
$I$(22).setColourSelected$javax_swing_JMenu$jalview_schemes_ColourSchemeI(this.colourMenu, colourScheme);
});

Clazz.newMeth(C$, 'openTreePcaDialog$',  function () {
if (this.alignPanel.getCalculationDialog$() == null ) {
Clazz.new_($I$(119,1).c$$jalview_gui_AlignFrame,[this]);
}});
...
var us=this;
chooser.setResponseHandler$O$Runnable(Integer.valueOf$I(0), ((P$.AlignFrame$26||
...
Clazz.new_($I$(120,1).c$$S,[choice]).loadVCF$jalview_datamodel_SequenceIA$jalview_api_AlignViewControllerGuiI(seqs, this.$finals$.us);
});
})()
), Clazz.new_(P$.AlignFrame$26.$init$,[this, {us:us,chooser:chooser}])));
