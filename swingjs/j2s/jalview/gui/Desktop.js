(function(){var P$=Clazz.newPackage("jalview.gui"),p$1={},I$=[[0,'jalview.gui.Desktop','Thread','java.text.NumberFormat','Runtime','java.awt.Color','jalview.util.MessageManager','java.util.HashMap','jalview.gui.JalviewChangeSupport','java.util.ArrayList','java.util.concurrent.Executors','java.util.concurrent.Semaphore','jalview.bin.Cache','jalview.gui.APQHandlers','java.awt.event.WindowAdapter',['jalview.gui.Desktop','.MyDesktopPane'],'java.awt.BorderLayout','jalview.util.Platform',['jalview.gui.Desktop','.MyDesktopManager'],'javax.swing.DefaultDesktopManager','jalview.gui.AquaInternalFrameManager','java.awt.Toolkit','java.awt.dnd.DropTarget','java.awt.event.MouseAdapter','Boolean','jalview.structure.StructureSelectionManager','jalview.gui.BlogReader','jalview.ws.utils.UrlDownloadClient','jalview.urls.IdOrgSettings','java.awt.Rectangle','javax.swing.JPopupMenu','javax.swing.JMenuItem','java.awt.datatransfer.DataFlavor','jalview.io.IdentifyFile','jalview.io.DataSourceType','jalview.io.FileLoader','java.awt.Dimension','jalview.bin.Jalview','jalview.gui.PaintRefresher','jalview.jbgui.GDesktop','javax.swing.event.InternalFrameAdapter','javax.swing.AbstractAction','javax.swing.KeyStroke','jalview.util.ShortcutKeyMaskExWrapper','jalview.io.FileFormat','jalview.io.JalviewFileChooser','jalview.io.BackupFiles','jalview.io.JalviewFileView','jalview.io.FileFormats','javax.swing.JLabel','javax.swing.JPanel','java.awt.GridLayout','javax.swing.JTextField','jalview.gui.JvOptionPane','jalview.gui.CutAndPasteTransfer','jalview.gui.SplashScreen','StringBuilder','jalview.util.BrowserLauncher','jalview.gui.Preferences','jalview.project.Jalview2XML','jalview.gui.OOMWarning','jalview.gui.SequenceFetcher','javax.swing.JProgressBar','jalview.gui.AlignmentPanel','jalview.viewmodel.AlignmentViewport','jalview.gui.AlignFrame','jalview.gui.UserQuestionnaireCheck','jalview.util.UrlConstants','javax.swing.BoxLayout','javax.swing.Box','javax.swing.JCheckBox','javax.swing.JOptionPane','jalview.jbgui.GStructureViewer','groovy.ui.Console','java.util.Hashtable','Error','javax.swing.JButton','jalview.ws.jws1.Discoverer','jalview.ws.jws2.Jws2Discoverer','jalview.gui.WsParamSetManager',['javax.swing.event.HyperlinkEvent','.EventType'],'javax.swing.SwingUtilities','java.io.File','jalview.gui.ImageExporter',['jalview.util.ImageMaker','.TYPE'],'jalview.gui.SplitFrame','java.util.StringTokenizer','java.net.URI','org.stackoverflowusers.file.WindowsShortcut','jalview.io.AppletFormatAdapter']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.$changeSupport=Clazz.new_($I$(8,1));
this.jvnews=null;
this.jconsole=null;
this.fileLoadingPanels=Clazz.new_($I$(9,1));
this.totalProgressCount=0;
this.inBatchMode=false;
this.serviceChangedDialog=null;
this.dialogExecutor=$I$(10).newSingleThreadExecutor$();
this.dialogPause=true;
this.block=Clazz.new_($I$(11,1).c$$I,[0]);
},1);
...
try {
$I$(13).setAPQHandlers$jalview_gui_Desktop(this);
} catch (t) {
System.out.println$S("Error setting APQHandlers: " + t.toString());
}
...
C$.desktop.setDesktopManager$javax_swing_DesktopManager(Clazz.new_([this, null, ($I$(17).isWindowsAndNotJS$() ? Clazz.new_($I$(19,1)) : $I$(17).isAMacAndNotJS$() ? Clazz.new_([C$.desktop.getDesktopManager$()],$I$(20,1).c$$javax_swing_DesktopManager) : C$.desktop.getDesktopManager$())],$I$(18,1).c$$javax_swing_DesktopManager));
var dims=this.getLastKnownDimensions$S("");
if (dims != null ) {
this.setBounds$java_awt_Rectangle(dims);
} else {
var screenSize=$I$(21).getDefaultToolkit$().getScreenSize$();
...
{}
this.setDropTarget$java_awt_dnd_DropTarget(Clazz.new_($I$(22,1).c$$java_awt_Component$java_awt_dnd_DropTargetListener,[C$.desktop, this]));
...
), Clazz.new_($I$(14,1),[this, null],P$.Desktop$5)));
var ma;
...
), Clazz.new_($I$(23,1),[this, null],P$.Desktop$6)));
C$.desktop.addMouseListener$java_awt_event_MouseListener(ma);
}, 1);

Clazz.newMeth(C$, 'showExperimental$', function () {
var experimental=$I$(12,"getDefault$S$S",["EXPERIMENTAL_FEATURES", $I$(24).FALSE.toString()]);
return $I$(24).valueOf$S(experimental).booleanValue$();
});

Clazz.newMeth(C$, 'doConfigureStructurePrefs$', function () {
var ssm=$I$(25).getStructureSelectionManager$jalview_api_StructureSelectionManagerProvider(this);
...
this.b$['jalview.gui.Desktop'].jvnews=Clazz.new_($I$(26,1).c$$jalview_gui_Desktop,[this.$finals$.me]);
...
try {
$I$(27,"download$S$S",[$I$(28).getUrl$(), $I$(28).getDownloadLocation$()]);
} catch (e) {
...
}return Clazz.new_($I$(29,1).c$$I$I$I$I,[ix, iy, iw, ih]);
}return null;
});

Clazz.newMeth(C$, 'showPasteMenu$I$I', function (x, y) {
var popup=Clazz.new_($I$(30,1));
var item=Clazz.new_([$I$(6).getString$S("label.paste_new_window")],$I$(31,1).c$$S);
...
try {
var c=$I$(21).getDefaultToolkit$().getSystemClipboard$();
var contents=c.getContents$O(this);
if (contents != null ) {
var file=contents.getTransferData$java_awt_datatransfer_DataFlavor($I$(32).stringFlavor);
var format=Clazz.new_($I$(33,1)).identify$S$jalview_io_DataSourceType(file, $I$(34).PASTE);
Clazz.new_($I$(35,1)).LoadFile$S$jalview_io_DataSourceType$jalview_io_FileFormatI(file, $I$(34).PASTE, format);
}} catch (ex) {
...
if (!ignoreMinSize) {
frame.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(36,1).c$$I$I,[C$.DEFAULT_MIN_WIDTH, C$.DEFAULT_MIN_HEIGHT]));
if (Clazz.instanceOf(frame, "jalview.gui.AlignFrame")) {
frame.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(36,1).c$$I$I,[C$.ALIGN_FRAME_DEFAULT_MIN_WIDTH, C$.ALIGN_FRAME_DEFAULT_MIN_HEIGHT]));
...
$I$(37).setCurrentAlignFrame$jalview_gui_AlignFrame(itf);
}itf.requestFocus$();
}});

Clazz.newMeth(C$, 'internalFrameClosed$javax_swing_event_InternalFrameEvent', function (evt) {
$I$(38).RemoveComponent$java_awt_Component(this.$finals$.frame);
...
}$I$(39).windowMenu.remove$javax_swing_JMenuItem(this.$finals$.menuItem);
});
})()
), Clazz.new_($I$(40,1),[this, {frame:frame,menuItem:menuItem}],P$.Desktop$11)));
...
$I$(39).windowMenu.add$javax_swing_JMenuItem(menuItem);
frame.toFront$();
try {
...
), Clazz.new_($I$(41,1),[this, {frame:frame}],P$.Desktop$13));
var ctrlWKey=$I$(42).getKeyStroke$I$I(87, 128);
var cmdWKey=$I$(42,"getKeyStroke$I$I",[87, $I$(43).getMenuShortcutKeyMaskEx$()]);
...
var files=Clazz.new_($I$(9,1));
var protocols=Clazz.new_($I$(9,1));
try {
...
var protocol=(protocols == null ) ? $I$(34).FILE : protocols.get$I(i);
var format=null;
if (fileName.endsWith$S(".jar")) {
format=$I$(44).Jalview;
} else {
format=Clazz.new_($I$(33,1)).identify$O$jalview_io_DataSourceType(file, protocol);
}if (Clazz.instanceOf(file, "java.io.File")) {
$I$(17).cacheFileData$java_io_File(file);
}Clazz.new_($I$(35,1)).LoadFile$jalview_gui_AlignViewport$O$jalview_io_DataSourceType$jalview_io_FileFormatI(null, file, protocol, format);
}
} catch (ex) {
if (Clazz.exceptionOf(ex,"Exception")){
success=false;
...
var chooser=$I$(45,"forRead$S$S$Z",[$I$(12).getProperty$S("LAST_DIRECTORY"), fileFormat, $I$(46).getEnabled$()]);
chooser.setFileView$javax_swing_filechooser_FileView(Clazz.new_($I$(47,1)));
...
if ($I$(48).getInstance$().isIdentifiable$jalview_io_FileFormatI(format)) {
try {
format=Clazz.new_($I$(33,1)).identify$java_io_File$jalview_io_DataSourceType(selectedFile, $I$(34).FILE);
} catch (e) {
...
}Clazz.new_($I$(35,1)).LoadFile$jalview_gui_AlignViewport$O$jalview_io_DataSourceType$jalview_io_FileFormatI(this.$finals$.viewport, selectedFile, $I$(34).FILE, format);
});
})()
...
var label=Clazz.new_([$I$(6).getString$S("label.input_file_url")],$I$(49,1).c$$S);
var panel=Clazz.new_([Clazz.new_($I$(51,1).c$$I$I,[2, 1])],$I$(50,1).c$$java_awt_LayoutManager);
panel.add$java_awt_Component(label);
var history;
var urlBase="http://www.";
if ($I$(17).isJS$()) {
history=Clazz.new_($I$(52,1).c$$S$I,[urlBase, 35]);
} else 
{}
...
Clazz.new_($I$(35,1)).LoadFile$jalview_gui_AlignViewport$O$jalview_io_DataSourceType$jalview_io_FileFormatI(this.$finals$.viewport, url, $I$(34).URL, $I$(44).Jalview);
} else {
Clazz.new_($I$(35,1)).LoadFile$S$jalview_io_DataSourceType$jalview_io_FileFormatI(url, $I$(34).URL, $I$(44).Jalview);
}} else {
var format=null;
try {
format=Clazz.new_($I$(33,1)).identify$S$jalview_io_DataSourceType(url, $I$(34).URL);
} catch (e) {
if (Clazz.exceptionOf(e,"jalview.io.FileFormatException")){
} else {
throw e;
...
$I$(53,"showInternalMessageDialog$java_awt_Component$S$S$I",[$I$(1).desktop, msg, $I$(6).getString$S("label.url_not_found"), 2]);
return;
}if (this.$finals$.viewport != null ) {
Clazz.new_($I$(35,1)).LoadFile$jalview_gui_AlignViewport$O$jalview_io_DataSourceType$jalview_io_FileFormatI(this.$finals$.viewport, url, $I$(34).URL, format);
} else {
Clazz.new_($I$(35,1)).LoadFile$S$jalview_io_DataSourceType$jalview_io_FileFormatI(url, $I$(34).URL, format);
}}});
})()
), Clazz.new_(P$.Desktop$15.$init$,[this, {viewport:viewport,history:history}]));
var dialogOption=$I$(6).getString$S("label.input_alignment_from_url");
$I$(53).newOptionDialog$java_awt_Component(C$.desktop).setResponseHandler$O$Runnable(new Integer(0), action).showInternalDialog$javax_swing_JPanel$S$I$I$javax_swing_Icon$OA$S(panel, dialogOption, 1, -1, null, options, $I$(6).getString$S("action.ok"));
});

Clazz.newMeth(C$, 'inputTextboxMenuItem_actionPerformed$jalview_api_AlignmentViewPanel', function (viewPanel) {
var cap=Clazz.new_($I$(54,1));
...
var screen=$I$(21).getDefaultToolkit$().getScreenSize$();
$I$(12).setProperty$S$S("SCREENGEOMETRY_WIDTH", screen.width + "");
$I$(12).setProperty$S$S("SCREENGEOMETRY_HEIGHT", screen.height + "");
p$1.storeLastKnownDimensions$S$java_awt_Rectangle.apply(this, ["", Clazz.new_([this.getBounds$().x, this.getBounds$().y, this.getWidth$(), this.getHeight$()],$I$(29,1).c$$I$I$I$I)]);
...
var message=Clazz.new_($I$(56,1).c$$I,[1024]);
message.append$S("<h1><strong>Version: ").append$S($I$(12).getProperty$S("VERSION")).append$S("</strong></h1>").append$S("<strong>Built: <em>").append$S($I$(12).getDefault$S$S("BUILD_DATE", "unknown")).append$S("</em> from ").append$S($I$(12).getBuildDetailsForSplash$()).append$S("</strong>");
var latestVersion=$I$(12).getDefault$S$S("LATEST_VERSION", "Checking");
if (latestVersion.equals$O("Checking")) {
} else if (!latestVersion.equals$O($I$(12).getProperty$S("VERSION"))) {
var red=false;
...
}message.append$S("<br>!! Version ").append$S($I$(12).getDefault$S$S("LATEST_VERSION", "..Checking..")).append$S(" is available for download from ").append$S($I$(12).getDefault$S$S("www.jalview.org", "http://www.jalview.org")).append$S(" !!");
if (red) {
message.append$S("</div>");
}}message.append$S("<br>Authors:  ");
message.append$S($I$(12,"getDefault$S$S",["AUTHORFNAMES", "The Jalview Authors (See AUTHORS file for current list)"]));
message.append$S("<br><br>Development managed by The Barton Group, University of Dundee, Scotland, UK.<br><br><br>For help, see the FAQ at <a href=\"http://www.jalview.org/faq\">www.jalview.org/faq</a> and/or join the jalview-discuss@jalview.org mailing list<br><br>If  you use Jalview, please cite:<br>Waterhouse, A.M., Procter, J.B., Martin, D.M.A, Clamp, M. and Barton, G. J. (2009)<br>Jalview Version 2 - a multiple sequence alignment editor and analysis workbench<br>Bioinformatics doi: 10.1093/bioinformatics/btp033");
...
try {
if ($I$(17).isJS$()) {
$I$(57).openURL$S("http://www.jalview.org/help.html");
} else 
{}
} catch (ex) {
if (Clazz.exceptionOf(ex,"Exception")){
...
$I$(37).setCurrentAlignFrame$jalview_gui_AlignFrame(null);
...
$I$(12,"setProperty$S$S",["SHOW_JAVA_CONSOLE", $I$(24).valueOf$Z(selected).toString()]);
...
var autoSave=projectFile != null  && !saveAs  && $I$(46).getEnabled$() ;
var approveSave=false;
if (!autoSave) {
var chooser=Clazz.new_($I$(45,1).c$$S$S,["jvp", "Jalview Project"]);
chooser.setFileView$javax_swing_filechooser_FileView(Clazz.new_($I$(47,1)));
...
try {
var doBackup=$I$(46).getEnabled$();
var backupfiles=doBackup ? Clazz.new_($I$(46,1).c$$java_io_File,[this.$finals$.chosenFile]) : null;
Clazz.new_($I$(59,1)).saveState$java_io_File(doBackup ? backupfiles.getTempFile$() : this.$finals$.chosenFile);
if (doBackup) {
...
var oom = e$$;
{
Clazz.new_(["Whilst saving current state to " + this.$finals$.chosenFile.getName$(), oom],$I$(60,1).c$$S$OutOfMemoryError);
}
} else if (Clazz.exceptionOf(e$$,"Exception")){
var ex = e$$;
{
$I$(12).log.error$O$Throwable("Problems whilst trying to save to " + this.$finals$.chosenFile.getName$(), ex);
$I$(53,"showMessageDialog$java_awt_Component$S$S$I",[this.$finals$.me, $I$(6,"formatMessage$S$OA",["label.error_whilst_saving_current_state_to", Clazz.array(java.lang.Object, -1, [this.$finals$.chosenFile.getName$()])]), $I$(6).getString$S("label.couldnt_save_project"), 2]);
}
} else {
throw e$$;
}
...
var chooser=Clazz.new_([$I$(12).getProperty$S("LAST_DIRECTORY"), suffix, desc, "Jalview Project", true, $I$(46).getEnabled$()],$I$(45,1).c$$S$SA$SA$S$Z$Z);
chooser.setFileView$javax_swing_filechooser_FileView(Clazz.new_($I$(47,1)));
...
Clazz.newMeth(C$, 'run$', function () {
try {
Clazz.new_($I$(59,1)).loadJalviewAlign$O(this.$finals$.selectedFile);
} catch (e$$) {
if (Clazz.exceptionOf(e$$,"OutOfMemoryError")){
var oom = e$$;
{
Clazz.new_($I$(60,1).c$$S$OutOfMemoryError,["Whilst loading project from " + this.$finals$.choice, oom]);
}
} else if (Clazz.exceptionOf(e$$,"Exception")){
var ex = e$$;
{
$I$(12).log.error$O$Throwable("Problems whilst loading project from " + this.$finals$.choice, ex);
$I$(53,"showMessageDialog$java_awt_Component$S$S$I",[$I$(1).desktop, $I$(6,"formatMessage$S$OA",["label.error_whilst_loading_project_from", Clazz.array(java.lang.Object, -1, [this.$finals$.choice])]), $I$(6).getString$S("label.couldnt_load_project"), 2]);
}
} else {
throw e$$;
}
...
), Clazz.new_(P$.Desktop$18$1.$init$,[this, {selectedFile:selectedFile,choice:choice}]))],$I$(2,1).c$$Runnable).start$();
});
})()
...
Clazz.new_($I$(61,1).c$$jalview_gui_IProgressIndicator,[this]);
});
...
this.progressPanel=Clazz.new_([Clazz.new_($I$(51,1).c$$I$I,[1, 1])],$I$(50,1).c$$java_awt_LayoutManager);
this.totalProgressCount=0;
C$.instance.getContentPane$().add$java_awt_Component$O(this.progressPanel, "South");
}var thisprogress=Clazz.new_([Clazz.new_($I$(16,1).c$$I$I,[10, 5])],$I$(50,1).c$$java_awt_LayoutManager);
var progressBar=Clazz.new_($I$(62,1));
progressBar.setIndeterminate$Z(true);
thisprogress.add$java_awt_Component$O(Clazz.new_($I$(49,1).c$$S,[string]), "West");
...
if (aps.size$() == 0) {
return null;
}var vap=aps.toArray$OA(Clazz.array($I$(63), [aps.size$()]));
return vap;
}, 1);

Clazz.newMeth(C$, 'getViewports$S', function (sequenceSetId) {
var viewp=Clazz.new_($I$(9,1));
if (C$.desktop != null ) {
var frames=C$.getAlignFrames$();
...
if (viewp.size$() > 0) {
return viewp.toArray$OA(Clazz.array($I$(64), [viewp.size$()]));
}}return null;
}, 1);
...
var newaf=Clazz.new_($I$(65,1).c$$jalview_gui_AlignmentPanel,[ap]);
if (ap === af.alignPanel ) {
...
var jvq=Clazz.new_($I$(66,1).c$$S,[url]);
...
var links=$I$(58).sequenceUrlLinks.getLinksForMenu$();
var li=links.listIterator$();
var check=false;
var urls=Clazz.new_($I$(9,1));
while (li.hasNext$()){
var link=li.next$();
if (link.contains$CharSequence("SEQUENCE_ID") && !$I$(67).isDefaultString$S(link) ) {
check=true;
var barPos=link.indexOf$S("|");
var urlMsg=barPos == -1 ? link : link.substring$I$I(0, barPos) + ": " + link.substring$I(barPos + 1) ;
urls.add$O(Clazz.new_($I$(49,1).c$$S,[urlMsg]));
}}
if (!check) {
return;
}var msgPanel=Clazz.new_($I$(50,1));
msgPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(68,1).c$$java_awt_Container$I,[msgPanel, 3]));
msgPanel.add$java_awt_Component($I$(69).createVerticalGlue$());
var msg=Clazz.new_([$I$(6).getString$S("label.SEQUENCE_ID_for_DB_ACCESSION1")],$I$(49,1).c$$S);
var msg2=Clazz.new_([$I$(6).getString$S("label.SEQUENCE_ID_for_DB_ACCESSION2")],$I$(49,1).c$$S);
...
var jcb=Clazz.new_([$I$(6).getString$S("label.do_not_display_again")],$I$(70,1).c$$S);
...
$I$(12,"setProperty$S$S",["CHECKURLLINKS", $I$(24).valueOf$Z(showWarningAgain).toString()]);
});
})()
), Clazz.new_(P$.Desktop$19$1.$init$,[this, {jcb:jcb}])));
msgPanel.add$java_awt_Component(jcb);
$I$(71,"showMessageDialog$java_awt_Component$O$S$I",[$I$(1).desktop, msgPanel, $I$(6).getString$S("label.SEQUENCE_ID_no_longer_used"), 2]);
}});
})()
...
if ($I$(37).isHeadlessMode$()) {
return Clazz.array($I$(65), -1, [$I$(37).currentAlignFrame]);
}var frames=C$.desktop.getAllFrames$();
if (frames == null ) {
return null;
}var avp=Clazz.new_($I$(9,1));
...
if (avp.size$() == 0) {
return null;
}var afs=avp.toArray$OA(Clazz.array($I$(65), [avp.size$()]));
return afs;
}, 1);
...
if (avp.size$() == 0) {
return null;
}var afs=avp.toArray$OA(Clazz.array($I$(72), [avp.size$()]));
return afs;
});
...
$I$(53,"showInternalMessageDialog$java_awt_Component$S$S$I",[C$.desktop, $I$(6).getString$S("label.couldnt_create_groovy_shell"), $I$(6).getString$S("label.groovy_support_failed"), 0]);
} else {
throw ex;
}
}
...
if (C$.groovyConsole == null ) {
C$.groovyConsole=Clazz.new_($I$(73,1));
...
), Clazz.new_($I$(14,1),[this, null],P$.Desktop$20)));
}(C$.groovyConsole.getFrame$()).setVisible$Z(true);
this.enableExecuteGroovy$Z(true);
});

Clazz.newMeth(C$, 'addQuitHandler$', function () {
this.getRootPane$().getInputMap$I(2).put$javax_swing_KeyStroke$O($I$(42,"getKeyStroke$I$I",[81, $I$(43).getMenuShortcutKeyMaskEx$()]), "Quit");
...
), Clazz.new_($I$(41,1),[this, null],P$.Desktop$21)));
});
...
this.progressBars=Clazz.new_($I$(74,1));
this.progressBarHandlers=Clazz.new_($I$(74,1));
...
throw Clazz.new_([$I$(6).getString$S("error.call_setprogressbar_before_registering_handler")],$I$(75,1).c$$S);
...
var cancel=Clazz.new_([$I$(6).getString$S("action.cancel")],$I$(76,1).c$$S);
var us=this;
...
), Clazz.new_(P$.Desktop$22.$init$,[this, {progressPanel:progressPanel,id:id,us:us,handler:handler}])));
...
C$.discoverer=Clazz.new_($I$(77,1));
...
t2=$I$(78).getDiscoverer$().startDiscoverer$java_beans_PropertyChangeListener(this.$changeSupport);
}var t3=null;
{
}if (blocking) {
while (alive){
...
var ermsg=$I$(78).getDiscoverer$().getErrorMessages$();
if (ermsg != null ) {
...
Clazz.newMeth(C$, 'run$', function () {
$I$(53,"showConfirmDialog$java_awt_Component$O$S$I$I",[$I$(1).desktop, Clazz.new_(["<html><table width=\"450\"><tr><td>" + this.$finals$.ermsg + "</td></tr></table>" + "<p>It may be that you have invalid JABA URLs<br/>in your web service preferences," + "<br>or as a command-line argument, or mis-configured HTTP proxy settings.</p>" + "<p>Check the <em>Connections</em> and <em>Web services</em> tab<br/>of the" + " Tools->Preferences dialog box to change them.</p></html>" ],$I$(49,1).c$$S), "Web Service Configuration Problem", -1, 0]);
...
}$I$(57).openURL$S(this.$finals$.url);
} catch (ex) {
if (Clazz.exceptionOf(ex,"Exception")){
$I$(53,"showInternalMessageDialog$java_awt_Component$S$S$I",[$I$(1).desktop, $I$(6).getString$S("label.web_browser_not_found_unix"), $I$(6).getString$S("label.web_browser_not_found"), 2]);
ex.printStackTrace$();
} else {
throw ex;
}
...
$I$(81).invokeAndWait$Runnable(this.$finals$.prompter);
} catch (q) {
...
var of=Clazz.new_(["Jalview_snapshot_" + System.currentTimeMillis$() + ".eps" ],$I$(82,1).c$$S);
...
var exporter=Clazz.new_([writer, null, $I$(84).EPS, title],$I$(83,1).c$$jalview_gui_ImageExporter_ImageWriterI$jalview_gui_IProgressIndicator$jalview_util_ImageMaker_TYPE$S);
...
var newTopFrame=Clazz.new_($I$(65,1).c$$jalview_gui_AlignmentPanel,[topPanel]);
...
var newBottomFrame=Clazz.new_($I$(65,1).c$$jalview_gui_AlignmentPanel,[bottomPanel]);
...
var splitFrame=Clazz.new_($I$(85,1).c$$jalview_jbgui_GAlignFrame$jalview_jbgui_GAlignFrame,[newTopFrame, newBottomFrame]);
if (geometry != null ) {
...
myTopFrame.viewport.setExplodedGeometry$java_awt_Rectangle(Clazz.new_([source.getX$(), source.getY$(), myTopFrame.getWidth$(), myTopFrame.getHeight$()],$I$(29,1).c$$I$I$I$I));
myBottomFrame.viewport.setExplodedGeometry$java_awt_Rectangle(Clazz.new_([source.getX$(), source.getY$(), myBottomFrame.getWidth$(), myBottomFrame.getHeight$()],$I$(29,1).c$$I$I$I$I));
...
topPanel.av.setGatherViewsHere$Z(false);
bottomPanel.av.setGatherViewsHere$Z(false);
topPanel.av.setExplodedGeometry$java_awt_Rectangle(Clazz.new_([sf.getLocation$(), topFrame.getSize$()],$I$(29,1).c$$java_awt_Point$java_awt_Dimension));
bottomPanel.av.setExplodedGeometry$java_awt_Rectangle(Clazz.new_([sf.getLocation$(), bottomFrame.getSize$()],$I$(29,1).c$$java_awt_Point$java_awt_Dimension));
...
var uriListFlavor=Clazz.new_(["text/uri-list;class=java.lang.String"],$I$(32,1).c$$S);
var urlFlavour=null;
try {
urlFlavour=Clazz.new_(["application/x-java-url; class=java.net.URL"],$I$(32,1).c$$S);
} catch (cfe) {
...
}if (t.isDataFlavorSupported$java_awt_datatransfer_DataFlavor($I$(32).javaFileListFlavor)) {
$I$(12).log.debug$O("Drop handled as javaFileListFlavor");
for (var file, $file = t.getTransferData$java_awt_datatransfer_DataFlavor($I$(32).javaFileListFlavor).iterator$(); $file.hasNext$()&&((file=($file.next$())),1);) {
files.add$O(file);
protocols.add$O($I$(34).FILE);
}
} else {
var added=false;
var data=null;
...
var textDf=Clazz.new_(["text/plain;class=java.lang.String"],$I$(32,1).c$$S);
...
for (var st=Clazz.new_($I$(86,1).c$$S$S,[data, "\r\n"]); st.hasMoreTokens$(); ) {
added=true;
var s=st.nextToken$();
if (s.startsWith$S("#")) {
continue;
}var uri=Clazz.new_($I$(87,1).c$$S,[s]);
if (uri.getScheme$().toLowerCase$().startsWith$S("http")) {
protocols.add$O($I$(34).URL);
files.add$O(uri.toString());
} else {
var file=Clazz.new_($I$(82,1).c$$java_net_URI,[uri]);
protocols.add$O($I$(34).FILE);
...
if (protocols.get$I(f).equals$O($I$(34).FILE) && (source.endsWith$S(".lnk") || source.endsWith$S(".url") || source.endsWith$S(".site")  ) ) {
try {
var obj=files.get$I(f);
var lf=(Clazz.instanceOf(obj, "java.io.File") ? obj : Clazz.new_($I$(82,1).c$$S,[obj]));
$I$(12).log.debug$O("Found potential link file: " + lf);
var wscfile=Clazz.new_($I$(88,1).c$$java_io_File,[lf]);
var fullname=wscfile.getRealFilename$();
protocols.set$I$O(f, $I$(89).checkProtocol$O(fullname));
...
$I$(12,"setProperty$S$S",["EXPERIMENTAL_FEATURES", $I$(24).toString$Z(selected)]);
});
...
C$.savingFiles=Clazz.new_($I$(7,1));
C$.openFrameCount=0;
C$.internalCopy=false;
C$.fileLoadingCount=0;
