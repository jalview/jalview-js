...
C$.$fields$=[['O',['af','jalview.gui.AlignFrame','ap','jalview.gui.AlignmentPanel','historyList','java.util.Stack','redundancy','float[]','originalSequences','jalview.datamodel.SequenceI[]','frame','javax.swing.JInternalFrame','redundantSeqs','java.util.Vector']]]
...
(function(){/*a*/var C$=Clazz.newClass(P$, "RedundancyPanel$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'javax.swing.event.ChangeListener', 1);
...
var worker=Clazz.new_($I$(4,1).c$$Runnable,[this]);
worker.start$();
...
(function(){/*a*/var C$=Clazz.newClass(P$, "RedundancyPanel$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('javax.swing.event.InternalFrameAdapter'), null, 1);
...
), Clazz.new_($I$(7,1),[this, {ap:ap}],P$.RedundancyPanel$2)));
}, 1);

Clazz.newMeth(C$, 'run$',  function () {
var progress=Clazz.new_($I$(8,1));
...
var redundantSequences=Clazz.new_($I$(10,1));
...
var del=Clazz.new_($I$(10,1));
this.undoButton.setEnabled$Z(true);
var value=this.slider.getValue$();
var sg=this.ap.av.getSelectionGroup$();
for (var i=0; i < this.redundancy.length; i++) {
if (value <= this.redundancy[i] ) {
del.add$O(this.originalSequences[i]);
}}
if (del.size$() > 0) {
...
var cut=Clazz.new_([$I$(3).getString$S("action.remove_redundancy"), $I$(13).CUT, deleted, 0, width, this.ap.av.getAlignment$()],$I$(12,1).c$$S$jalview_commands_EditCommand_Action$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI);
for (var i=0; i < del.size$(); i++) {
