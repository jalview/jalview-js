...
names[i]=(child.getUserObject$()).getDbName$().toLowerCase$java_util_Locale($I$(19).ROOT);
} else {
names[i]=(child.getUserObject$()).toLowerCase$java_util_Locale($I$(19).ROOT);
p$2.sortTreeNodes$javax_swing_tree_DefaultMutableTreeNode.apply(this, [child]);
}} else {
throw Clazz.new_([$I$(8).getString$S("error.implementation_error_cant_reorder_tree")],$I$(20,1).c$$S);
}}
$I$(21).sort$SA$OA(names, nodes);
...
Clazz.super_(C$, this);
this.us=me;
$I$(1).sharedInstance$().registerComponent$javax_swing_JComponent(this.b$['jalview.gui.JDatabaseTree'].dbviews);
}, 1);
