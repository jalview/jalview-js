(function(){var P$=Clazz.newPackage("jalview.javascript.web"),I$=[[0,'jalview.util.Platform','jalview.javascript.json.JSON','java.util.Map']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
