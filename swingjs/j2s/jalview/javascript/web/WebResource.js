(function(){var P$=Clazz.newPackage("jalview.javascript.web"),I$=[[0,'jalview.javascript.web.ClientResponse','java.net.URL','jalview.util.Platform','java.net.URI',['jalview.javascript.web.WebResource','.Builder']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
