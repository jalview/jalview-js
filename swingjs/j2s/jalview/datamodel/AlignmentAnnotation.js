(function(){var P$=Clazz.newPackage("jalview.datamodel"),p$1={},I$=[[0,'java.util.HashMap','jalview.analysis.Rna','java.util.Arrays','jalview.datamodel.SFSortByEnd','StringBuffer','jalview.schemes.ResidueProperties',['jalview.datamodel.AlignmentAnnotation','.AnnotCharSequence'],'jalview.datamodel.GraphLine','jalview.datamodel.Annotation','StringBuilder','java.util.Locale','Error','java.util.Collections','java.util.ArrayList']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (Long.$gt(this.invalidrnastruc,-1 )) {
return;
...
var val=0;
try {
val=(Integer.valueOf$S(this._rnasecstr[x].getFeatureGroup$())).$c();
if (mxval < val) {
mxval=val;
}} catch (q) {
...
this.hasIcons=!!(this.hasIcons|(true));
} else {
if (this.annotations[i].secondaryStructure == "(" || this.annotations[i].secondaryStructure == "["  || this.annotations[i].secondaryStructure == "<"  || this.annotations[i].secondaryStructure == "{"  || this.annotations[i].secondaryStructure == "A"  || this.annotations[i].secondaryStructure == "D"  || this.annotations[i].secondaryStructure == "F"  || this.annotations[i].secondaryStructure == "J"  || this.annotations[i].secondaryStructure == "K"  || this.annotations[i].secondaryStructure == "L"  || this.annotations[i].secondaryStructure == "M"  || this.annotations[i].secondaryStructure == "N"  || this.annotations[i].secondaryStructure == "O"  || this.annotations[i].secondaryStructure == "P"  || this.annotations[i].secondaryStructure == "Q"  || this.annotations[i].secondaryStructure == "R"  || this.annotations[i].secondaryStructure == "U"  || this.annotations[i].secondaryStructure == "V"  || this.annotations[i].secondaryStructure == "W"  || this.annotations[i].secondaryStructure == "Y"  || this.annotations[i].secondaryStructure == "Z" ) {
this.hasIcons=!!(this.hasIcons|(true));
this.isrna=!!(this.isrna|(true));
...
if (Long.$ne(this._lastrnaannot,rnastruc.hashCode$() )) {
...
var i=this.description.toLowerCase$java_util_Locale($I$(11).ROOT).indexOf$S("<html>");
if (i > -1) {
...
return Long.$eq(this.invalidrnastruc,-1 );
});
...
throw Clazz.new_($I$(12,1).c$$S,["liftOver currently not implemented for transfer of annotation between different types of seqeunce"]);
...
var mpos=Integer.valueOf$I(mapIsTo ? sp2sq.getMappedPosition$I((ie.getKey$()).$c()) : sp2sq.getPosition$I((ie.getKey$()).$c()));
if ((mpos).$c() >= sq.getStart$()  && (mpos).$c() <= sq.getEnd$()  ) {
...
if (this.properties == null ) {
return $I$(13).emptyList$();
}return this.properties.keySet$();
});

Clazz.newMeth(C$, 'getAnnotationForPosition$I',  function (position) {
return this.sequenceMapping == null  ? null : this.sequenceMapping.get$O(Integer.valueOf$I(position));
});
...
return ([C$.counter,C$.counter=Long.$inc(C$.counter,1)][0]);
}, 1);
...
C$.c$$I$I.apply(this, [0, this.b$['jalview.datamodel.AlignmentAnnotation'].annotations.length]);
}, 1);
...
return ((index + this.offset < 0) || (index + this.offset) >= this.max  || this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[index + this.offset] == null   || (this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[index + this.offset].secondaryStructure <= " ")  ? " " : this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[index + this.offset].displayCharacter == null  || this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[index + this.offset].displayCharacter.length$() == 0  ? this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[index + this.offset].secondaryStructure : this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[index + this.offset].displayCharacter.charAt$I(0));
});

Clazz.newMeth(C$, 'toString',  function () {
var string=Clazz.array(Character.TYPE, [this.max - this.offset]);
var mx=this.b$['jalview.datamodel.AlignmentAnnotation'].annotations.length;
for (var i=this.offset; i < mx; i++) {
string[i]=(this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[i] == null  || ((this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[i].secondaryStructure).$c() <= 32 ) ) ? " " : (this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[i].displayCharacter == null  || this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[i].displayCharacter.length$() == 0  ? this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[i].secondaryStructure : this.b$['jalview.datamodel.AlignmentAnnotation'].annotations[i].displayCharacter.charAt$I(0));
}
