(function(){var P$=Clazz.newPackage("jalview.datamodel.features"),I$=[[0,'intervalstore.impl.IntervalStore','java.util.HashSet','java.util.ArrayList','intervalstore.impl.BinarySearcher','java.util.Collections','jalview.datamodel.SequenceFeature']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
(function(){/*m*/var C$=Clazz.newClass(P$, "FeatureStore$lambda1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Function', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$jalview_datamodel_SequenceFeature','apply$O'], function (f) { return (f.getBegin$() >= this.$finals$.feature.getBegin$());});
})()
...
(function(){/*m*/var C$=Clazz.newClass(P$, "FeatureStore$lambda2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Function', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$jalview_datamodel_SequenceFeature','apply$O'], function (f) { return (f.getEnd$() >= this.$finals$.feature.getEnd$());});
})()
...
(function(){/*m*/var C$=Clazz.newClass(P$, "FeatureStore$lambda3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Function', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$jalview_datamodel_SequenceFeature','apply$O'], function (val) { return (val.getBegin$() >= this.$finals$.feature.getBegin$());});
})()
...
(function(){/*m*/var C$=Clazz.newClass(P$, "FeatureStore$lambda4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Function', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$jalview_datamodel_SequenceFeature','apply$O'], function (f) { return (f.getEnd$() >= this.$finals$.from);});
})()
...
(function(){/*m*/var C$=Clazz.newClass(P$, "FeatureStore$lambda5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Function', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$jalview_datamodel_SequenceFeature','apply$O'], function (f) { return (f.getBegin$() >= this.$finals$.from);});
})()
...
var sf2=Clazz.new_([sf, newBegin, newEnd, sf.getFeatureGroup$(), sf.getScore$()],$I$(6,1).c$$jalview_datamodel_SequenceFeature$I$I$S$F);
