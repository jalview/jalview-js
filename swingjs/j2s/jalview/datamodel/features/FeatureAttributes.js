(function(){var P$=Clazz.newPackage("jalview.datamodel.features"),I$=[[0,['jalview.datamodel.features.FeatureAttributes','.Datatype'],'java.util.ArrayList','java.util.HashMap','java.util.Collections','java.util.TreeMap',['jalview.datamodel.features.FeatureAttributes','.AttributeData']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
