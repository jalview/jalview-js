(function(){var P$=Clazz.newPackage("jalview.datamodel"),I$=[[0,'jalview.datamodel.VisibleRowsIterator']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "VisibleRowsCollection", null, null, 'jalview.api.AlignmentRowsCollectionI');
...
C$.$fields$=[['I',['start','end'],'O',['alignment','jalview.datamodel.AlignmentI']]]
