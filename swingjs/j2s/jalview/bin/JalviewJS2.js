(function(){var P$=Clazz.newPackage("jalview.bin"),I$=[[0,'jalview.bin.Jalview','jalview.util.Platform','javax.swing.Timer','jalview.bin.JalviewJS2']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
