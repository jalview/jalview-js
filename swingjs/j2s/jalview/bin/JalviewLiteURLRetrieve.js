(function(){var P$=Clazz.newPackage("jalview.bin"),I$=[[0,'jalview.io.DataSourceType','jalview.io.FileParse','jalview.io.FileFormats','jalview.io.IdentifyFile','jalview.io.AppletFormatAdapter','jalview.io.FileFormat']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
