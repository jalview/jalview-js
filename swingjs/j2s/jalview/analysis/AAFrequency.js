...
return;
}gaprow.graphMax=Long.$fval(nseq);
gaprow.graphMin=0;
var scale=0.8 / nseq;
for (var i=startCol; i < endCol; i++) {
var profile=profiles.get$I(i);
