(function(){var P$=Clazz.newPackage("jalview.analysis"),I$=[[0,'java.util.HashMap','java.util.ArrayList','java.util.Collections','java.util.BitSet','java.util.Arrays']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
groupLabelsForCalcId.get$O(new Integer(aa.graphGroup)).add$O(displayLabel);
}} else {
groupLabelsForCalcId.put$O$O(new Integer(aa.graphGroup), labelAsList);
}} else {
