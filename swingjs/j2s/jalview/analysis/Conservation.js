(function(){var P$=Clazz.newPackage("jalview.analysis"),p$1={},I$=[[0,'jalview.util.Format','jalview.datamodel.SequenceI','jalview.util.Comparison','java.util.Map','java.util.TreeMap','java.util.Locale','jalview.schemes.ResidueProperties','jalview.datamodel.ResidueCount','StringBuilder','jalview.datamodel.Sequence','jalview.analysis.scoremodels.ScoreModels','java.util.Vector','jalview.datamodel.Annotation','java.awt.Color']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
res=res.toUpperCase$java_util_Locale($I$(6).ROOT);
for (var property, $property = $I$(7).propHash.entrySet$().iterator$(); $property.hasNext$()&&((property=($property.next$())),1);) {
...
var values=Clazz.new_($I$(8,1).c$$Z,[false]);
...
var index=$I$(7).aaIndex[c.$c()];
c=index > 20 ? "-" : $I$(7).aa[index].charAt$I(0);
} else {
...
var consString=Clazz.new_($I$(9,1).c$$I,[this.end]);
...
var count=0;
var positives=Clazz.new_($I$(9,1).c$$I,[64]);
var negatives=Clazz.new_($I$(9,1).c$$I,[32]);
...
this.consSequence=Clazz.new_([this.name, consString.toString(), this.start, this.end],$I$(10,1).c$$S$S$I$I);
});
...
this.findQuality$I$I$jalview_analysis_scoremodels_ScoreMatrix(0, this.maxLength - 1, $I$(11).getInstance$().getBlosum62$());
});

Clazz.newMeth(C$, 'percentIdentity$jalview_analysis_scoremodels_ScoreMatrix',  function (sm) {
this.seqNums=Clazz.new_($I$(12,1));
var i=0;
var iSize=this.sequences.length;
for (i=0; i < iSize; i++) {
...
this.quality=Clazz.new_($I$(12,1));
...
conservation.annotations[i]=Clazz.new_([String.valueOf$C(c), conssym, " ", value, Clazz.new_([minR + (maxR * vprop), minG + (maxG * vprop), minB + (maxB * vprop)],$I$(14,1).c$$F$F$F)],$I$(13,1).c$$S$S$C$F$java_awt_Color);
}if (quality2 != null ) {
value=this.quality.elementAt$I(i).floatValue$();
var vprop=value - qmin;
vprop/=qmax;
var description=C$.FORMAT_3DP.form$D(value);
quality2.annotations[i]=Clazz.new_([" ", description, " ", value, Clazz.new_([minR + (maxR * vprop), minG + (maxG * vprop), minB + (maxB * vprop)],$I$(14,1).c$$F$F$F)],$I$(13,1).c$$S$S$C$F$java_awt_Color);
}}
});
