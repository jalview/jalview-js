(function(){var P$=Clazz.newPackage("jalview.analysis"),p$1={},p$2={},I$=[[0,'java.util.Locale','java.util.HashMap',['jalview.analysis.SequenceIdMatcher','.SeqIdName'],'java.util.Arrays','java.util.ArrayList','jalview.datamodel.SequenceI','java.util.Vector']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.names.put$O$O(Clazz.new_([this, null, seq.getDisplayId$Z(true)],$I$(3,1).c$$S), seq);
var dbseq=seq;
...
sid=Clazz.new_([this, null, dbr.get$I(r).getAccessionId$()],$I$(3,1).c$$S);
...
C$.c$$java_util_List.apply(this, [$I$(4).asList$OA(sequences)]);
}, 1);
...
var nam=Clazz.new_([this, null, seq.getName$()],$I$(3,1).c$$S);
...
var nam=Clazz.new_($I$(3,1).c$$S,[this, null, seqnam]);
return p$2.findIdMatch$jalview_analysis_SequenceIdMatcher_SeqIdName.apply(this, [nam]);
});
...
if (m != null ) {
return m.toArray$OA(Clazz.array($I$(6), [m.size$()]));
}return null;
});
...
var nam;
if (seqs.length > 0) {
namedseqs=Clazz.array($I$(6), [seqs.length]);
do {
nam=Clazz.new_([this, null, seqs[i].getName$()],$I$(3,1).c$$S);
...
;C$.$init$.apply(this);
if (s != null ) {
this.id=s.toLowerCase$java_util_Locale($I$(1).ROOT);
} else {
this.id="";
}}, 1);
...
return p$1.stringequals$S.apply(this, [(s).toLowerCase$java_util_Locale($I$(1).ROOT)]);
}}return false;
});
