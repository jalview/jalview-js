(function(){var P$=Clazz.newPackage("jalview.analysis"),I$=[[0,'java.util.ArrayList','jalview.datamodel.Alignment','jalview.datamodel.SequenceI','java.util.LinkedHashMap','java.util.HashSet','jalview.datamodel.AlignedCodonFrame','jalview.schemes.ResidueProperties','jalview.util.MapList','StringBuilder','jalview.util.MappingUtils','java.util.Arrays','jalview.util.Comparison','java.util.TreeMap','jalview.analysis.CodonComparator','java.util.HashMap','jalview.datamodel.AlignedCodon','jalview.datamodel.AlignmentAnnotation','java.util.Collections','jalview.datamodel.DBRefEntry','jalview.datamodel.Mapping','jalview.analysis.Dna','jalview.datamodel.Sequence','jalview.util.DBRefUtils','jalview.datamodel.SequenceFeature','jalview.datamodel.features.SequenceFeatures','jalview.util.IntRangeComparator','jalview.analysis.SequenceIdMatcher','jalview.commands.RemoveGapColCommand']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var newAl=Clazz.new_([sq.toArray$OA(Clazz.array($I$(3), [0]))],$I$(2,1).c$$jalview_datamodel_SequenceIA);
for (var s, $s = sq.iterator$(); $s.hasNext$()&&((s=($s.next$())),1);) {
...
return false;
}var mappedDna=Clazz.new_($I$(5,1));
var mappedProtein=Clazz.new_($I$(5,1));
...
var map=Clazz.new_([Clazz.array(Integer.TYPE, -1, [cdnaStart, cdnaEnd]), Clazz.array(Integer.TYPE, -1, [proteinStart, proteinEnd]), 3, 1],$I$(8,1).c$$IA$IA$I$I);
return map;
...
var thisAligned=Clazz.new_($I$(9,1).c$$I,[2 * toLength]);
...
var trailingCopiedGap=Clazz.new_($I$(9,1));
var intronLength=0;
...
trailingCopiedGap=Clazz.new_($I$(9,1));
}intronLength++;
inExon=false;
} else {
...
var mappings=protein.getCodonFrames$();
var alignedCodons=Clazz.new_([Clazz.new_($I$(14,1))],$I$(13,1).c$$java_util_Comparator);
for (var dnaSeq, $dnaSeq = dna.getSequences$().iterator$(); $dnaSeq.hasNext$()&&((dnaSeq=($dnaSeq.next$())),1);) {
...
if (lastCodon != null ) {
var firstPeptide=Clazz.new_([lastCodon.pos1, lastCodon.pos2, lastCodon.pos3, String.valueOf$C(seq.getCharAt$I(0)), 0],$I$(16,1).c$$I$I$I$S$I);
toAdd.put$O$O(seq, firstPeptide);
} else {
var firstPeptide=Clazz.new_([0, 0, 0, String.valueOf$C(seq.getCharAt$I(0)), 0],$I$(16,1).c$$I$I$I$S$I);
toAdd.put$O$O(seq, firstPeptide);
...
var copyAnn=Clazz.new_($I$(17,1).c$$jalview_datamodel_AlignmentAnnotation,[ann]);
var startRes=0;
...
var cdsRange=$I$(18,"singletonList$O",[Clazz.array(Integer.TYPE, -1, [cdsSeq.getStart$(), cdsSeq.getLength$() + cdsSeq.getStart$() - 1])]);
var cdsToProteinMap=Clazz.new_([cdsRange, mapList.getToRanges$(), mapList.getFromRatio$(), mapList.getToRatio$()],$I$(8,1).c$$java_util_List$java_util_List$I$I);
if (!dataset.getSequences$().contains$O(cdsSeqDss)) {
dataset.addSequence$jalview_datamodel_SequenceI(cdsSeqDss);
var cdsToProteinMapping=Clazz.new_($I$(6,1));
...
var dnaToCdsMapping=Clazz.new_($I$(6,1));
var dnaToCdsMap=Clazz.new_([mapList.getFromRanges$(), cdsRange, 1, 1],$I$(8,1).c$$java_util_List$java_util_List$I$I);
...
var cdsCrossRef=Clazz.new_([source, source + ":" + version , primRef.getAccessionId$()],$I$(19,1).c$$S$S$S);
cdsCrossRef.setMap$jalview_datamodel_Mapping(Clazz.new_([dnaDss, Clazz.new_($I$(8,1).c$$jalview_util_MapList,[cdsToDnaMap])],$I$(20,1).c$$jalview_datamodel_SequenceI$jalview_util_MapList));
cdsSeqDss.addDBRef$jalview_datamodel_DBRefEntry(cdsCrossRef);
dnaSeq.addDBRef$jalview_datamodel_DBRefEntry(Clazz.new_([source, version, cdsSeq.getName$(), Clazz.new_($I$(20,1).c$$jalview_datamodel_SequenceI$jalview_util_MapList,[cdsSeqDss, dnaToCdsMap])],$I$(19,1).c$$S$S$S$jalview_datamodel_Mapping));
var proteinToCdsRef=Clazz.new_([source, version, cdsSeq.getName$()],$I$(19,1).c$$S$S$S);
proteinToCdsRef.setMap$jalview_datamodel_Mapping(Clazz.new_([cdsSeqDss, cdsToProteinMap.getInverse$()],$I$(20,1).c$$jalview_datamodel_SequenceI$jalview_util_MapList));
...
var cds=Clazz.new_([cdsSeqs.toArray$OA(Clazz.array($I$(3), [cdsSeqs.size$()]))],$I$(2,1).c$$jalview_datamodel_SequenceIA);
...
var newSeq=null;
var maplist=mapping.getMap$();
if (maplist.isContiguous$() && maplist.isFromForwardStrand$() ) {
var start=maplist.getFromLowest$();
var end=maplist.getFromHighest$();
newSeq=seq.getSubSequence$I$I(start - 1, end);
newSeq.setName$S(seqId);
} else {
var seqChars=seq.getSequence$();
var fromRanges=maplist.getFromRanges$();
...
newSeq=Clazz.new_($I$(22,1).c$$S$CA$I$I,[seqId, newSeqChars, 1, newPos]);
}if (dataset != null ) {
...
var directSources=Clazz.new_($I$(5,1));
...
}var onSource=$I$(23,"selectRefs$java_util_List$SA",[proteinProduct.getDBRefs$(), directSources.toArray$OA(Clazz.array(String, [0]))]);
var propagated=Clazz.new_($I$(1,1));
for (var ic=0, nc=direct.size$(); ic < nc; ic++) {
var cdsref=direct.get$I(ic);
var m=cdsref.getMap$();
var cdsposmap=Clazz.new_([$I$(11,"asList$OA",[Clazz.array(Integer.TYPE, -2, [Clazz.array(Integer.TYPE, -1, [cdsSeq.getStart$(), cdsSeq.getEnd$()])])]), m.getMap$().getToRanges$(), 3, 1],$I$(8,1).c$$java_util_List$java_util_List$I$I);
var cdsmap=Clazz.new_([m.getTo$(), m.getMap$()],$I$(20,1).c$$jalview_datamodel_SequenceI$jalview_util_MapList);
var newref=Clazz.new_([cdsref.getSource$(), cdsref.getVersion$(), cdsref.getAccessionId$(), Clazz.new_([cdsmap.getTo$(), cdsposmap],$I$(20,1).c$$jalview_datamodel_SequenceI$jalview_util_MapList)],$I$(19,1).c$$S$S$S$jalview_datamodel_Mapping);
...
var copy=Clazz.new_([sf, newBegin, newEnd, sf.getFeatureGroup$(), sf.getScore$()],$I$(24,1).c$$jalview_datamodel_SequenceFeature$I$I$S$F);
...
return Clazz.new_($I$(8,1).c$$java_util_List$java_util_List$I$I,[ranges, proteinRange, 3, 1]);
}return null;
}, 1);
...
var copy=Clazz.new_([Clazz.new_($I$(2,1).c$$jalview_datamodel_SequenceIA,[seqs])],$I$(2,1).c$$jalview_datamodel_AlignmentI);
copy.setDataset$jalview_datamodel_AlignmentI(dataset);
var isProtein=!copy.isNucleotide$();
var matcher=Clazz.new_($I$(27,1).c$$jalview_datamodel_SequenceIA,[seqs]);
if (xrefs != null ) {
...
return false;
}var alignedDatasets=Clazz.new_($I$(15,1));
...
$I$(11).fill$CA$C(seqchars, gapCharacter);
...
Clazz.new_(["", unaligned.getSequencesArray$(), 0, unaligned.getWidth$() - 1, unaligned],$I$(28,1).c$$S$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI);
return true;
}, 1);
...
seqMap=Clazz.new_([seq.getDatasetSequence$(), seqMap.getMap$().getInverse$()],$I$(20,1).c$$jalview_datamodel_SequenceI$jalview_util_MapList);
...
if (seqsMap == null ) {
seqsMap=Clazz.new_($I$(15,1));
map.put$O$O(new Integer(fromCol), seqsMap);
}seqsMap.put$O$O(seq, new Character(seq.getCharAt$I(mappedCharPos - toStart)));
mappedCharPos++;
}fromCol+=(forward ? 1 : -1);
}
}
