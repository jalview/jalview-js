(function(){var P$=Clazz.newPackage("jalview.analysis"),I$=[[0,'jalview.analysis.Rna','jalview.util.Comparison','java.util.Hashtable','jalview.util.Format','jalview.util.QuickSort','jalview.datamodel.Annotation']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var precision=2;
while (Long.$gt(nseq,100 )){
++precision;
(nseq=Long.$div(nseq,(10)));
}
if (precision > 2) {
