(function(){var P$=Clazz.newPackage("jalview.ext.ensembl"),I$=[[0,'java.util.ArrayList','jalview.util.DBRefUtils','jalview.datamodel.DBRefEntry','java.net.URL']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
