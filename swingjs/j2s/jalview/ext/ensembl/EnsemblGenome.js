(function(){var P$=Clazz.newPackage("jalview.ext.ensembl"),I$=[[0,['jalview.ext.ensembl.EnsemblSequenceFetcher','.EnsemblFeatureType'],['jalview.ext.ensembl.EnsemblSeqProxy','.EnsemblSeqType'],'jalview.ext.ensembl.EnsemblSeqProxy','java.util.ArrayList']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var sfs=seq.getFeatures$().getFeaturesByOntology$SA(Clazz.array(String, -1, ["transcript", "NMD_transcript_variant"]));
