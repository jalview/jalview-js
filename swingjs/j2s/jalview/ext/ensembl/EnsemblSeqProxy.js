(function(){var P$=Clazz.newPackage("jalview.ext.ensembl"),I$=[[0,'java.util.Arrays','jalview.ext.ensembl.EnsemblFeatures','jalview.ext.ensembl.EnsemblProtein','jalview.analysis.AlignmentUtils','jalview.datamodel.Mapping','jalview.datamodel.DBRefEntry','jalview.util.DBRefUtils','jalview.bin.Cache','jalview.ext.ensembl.EnsemblXref','jalview.datamodel.Alignment','jalview.datamodel.SequenceI','java.util.ArrayList','jalview.datamodel.Sequence','StringBuffer','java.net.URL','java.util.Collections','jalview.util.IntRangeComparator','jalview.util.MapList','jalview.datamodel.SequenceFeature','jalview.io.gff.SequenceOntologyFactory','StringBuilder','jalview.util.Comparison','jalview.analysis.Dna','jalview.datamodel.features.SequenceFeatures']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
upxref=upx.get$I(0);
if (upx.size$() > 1) {
$I$(8).log.warn$O("Implementation issue - multiple uniprot acc on product sequence.");
}} else {
...
var to=$I$(1,"asList$OA",[[Clazz.array(Integer.TYPE, -1, [start, start + mappedLength - 1])]]);
