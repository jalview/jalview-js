(function(){var P$=Clazz.newPackage("jalview.ext.ensembl"),I$=[[0,'StringBuilder','java.net.URL','java.util.ArrayList','jalview.ext.ensembl.Species']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
