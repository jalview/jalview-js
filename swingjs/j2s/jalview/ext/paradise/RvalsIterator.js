(function(){var P$=Clazz.newPackage("jalview.ext.paradise"),I$=[[0,'java.util.ArrayList','org.apache.http.message.BasicNameValuePair','jalview.ws.HttpClientUtils','org.json.simple.parser.JSONParser','jalview.ext.paradise.RvalsIterator','jalview.util.MessageManager','java.net.URL','java.io.InputStreamReader','jalview.util.JSONUtils','java.io.StringReader','Error']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
