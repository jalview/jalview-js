(function(){var P$=Clazz.newPackage("jalview.ext.htsjdk"),p$1={},I$=[[0,'java.io.File','htsjdk.variant.vcf.VCFFileReader','jalview.bin.Cache']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
$I$(3).log.error$O("File not found: " + filePath);
}}, 1);
...
), Clazz.new_(P$.VCFReader$1.$init$,[this, {chrom:chrom,it:it,end:end,start:start}]));
});
