(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'java.awt.Color','jalview.schemes.FeatureColour']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return type.equalsIgnoreCase$S("RESNUM");
});
