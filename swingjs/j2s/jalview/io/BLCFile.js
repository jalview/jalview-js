(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'java.util.Vector','StringBuffer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "BLCFile", null, 'jalview.io.AlignFile');
...
C$.$fields$=[['I',['iterationSkips','iterationCount'],'O',['titles','java.util.Vector']]]
...
var headerLines=Clazz.new_($I$(2,1));
