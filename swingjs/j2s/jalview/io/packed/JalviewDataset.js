(function(){var P$=Clazz.newPackage("jalview.io.packed"),I$=[[0,'java.util.ArrayList','jalview.analysis.SeqsetUtils','jalview.analysis.TreeModel','java.util.Hashtable','java.util.HashMap',['jalview.io.packed.JalviewDataset','.AlignmentSet']]],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (this.b$['jalview.io.packed.JalviewDataset'].seqDetails == null  || this.b$['jalview.io.packed.JalviewDataset'].seqDetails.size$() == 0 ) {
return;
}$I$(2,"deuniquify$java_util_Hashtable$jalview_datamodel_SequenceIA$Z",[this.b$['jalview.io.packed.JalviewDataset'].seqDetails, this.al.getSequencesArray$(), true]);
...
this.modified=!!(this.modified|(modifiedFromAction));
});
