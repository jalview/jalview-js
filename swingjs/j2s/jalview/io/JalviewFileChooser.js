(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'java.awt.Dimension','jalview.bin.Cache','java.util.Vector','java.util.StringTokenizer','javax.swing.JList','javax.swing.DefaultListCellRenderer','java.awt.event.MouseAdapter','javax.swing.border.TitledBorder','jalview.util.MessageManager','javax.swing.JScrollPane','javax.swing.SpringLayout','jalview.util.Platform','javax.swing.SwingUtilities','java.util.HashMap','java.util.ArrayList','jalview.io.FileFormats',['jalview.io.JalviewFileChooser','.RecentlyOpened'],'java.io.File','jalview.io.JalviewFileFilter','javax.swing.JPanel','javax.swing.BoxLayout','javax.swing.JCheckBox','java.awt.EventQueue','Thread','jalview.gui.JvOptionPane']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "JalviewFileChooser", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'javax.swing.JFileChooser', ['jalview.util.dialogrunner.DialogRunnerI', 'java.beans.PropertyChangeListener']);
C$.$classes$=[['RecentlyOpened',0]];

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.callbacks=Clazz.new_($I$(14,1));
this.$selectedFile=null;
this.backupfilesCheckBox=null;
this.includeBackupFiles=false;
},1);

C$.$fields$=[['Z',['includeBackupFiles'],'O',['callbacks','java.util.Map','$selectedFile','java.io.File','backupfilesCheckBox','javax.swing.JCheckBox']]]
...
var extensions=Clazz.new_($I$(15,1));
var descs=Clazz.new_($I$(15,1));
for (var format, $format = $I$(16).getInstance$().getFormats$().iterator$(); $format.hasNext$()&&((format=($format.next$())),1);) {
if (format.isReadable$()) {
extensions.add$O(format.getExtensions$());
descs.add$O(format.getName$());
}}
return Clazz.new_(C$.c$$S$SA$SA$S$Z$Z,[directory, extensions.toArray$OA(Clazz.array(String, [extensions.size$()])), descs.toArray$OA(Clazz.array(String, [descs.size$()])), selected, true, allowBackupFiles]);
}, 1);
...
return Clazz.new_(C$.c$$S$SA$SA$S$Z,[directory, extensions.toArray$OA(Clazz.array(String, [extensions.size$()])), descs.toArray$OA(Clazz.array(String, [descs.size$()])), selected, false]);
}, 1);

Clazz.newMeth(C$, 'c$$S',  function (dir) {
;C$.superclazz.c$$java_io_File.apply(this,[C$.safePath$S(dir)]);C$.$init$.apply(this);
this.setAccessory$javax_swing_JComponent(Clazz.new_($I$(17,1),[this, null]));
}, 1);
...
var formats=Clazz.new_($I$(15,1));
for (var i=0; i < extensions.length; i++) {
formats.add$O(Clazz.array(String, -1, [extensions[i], descs[i]]));
}
...
if (dir == null ) {
return null;
}var f=Clazz.new_($I$(18,1).c$$S,[dir]);
...
var jvf=Clazz.new_($I$(19,1).c$$S$S,[format[0], format[1]]);
if (allowBackupFiles) {
...
var multi=Clazz.new_($I$(20,1));
multi.setLayout$java_awt_LayoutManager(Clazz.new_($I$(21,1).c$$java_awt_Container$I,[multi, 3]));
if (this.backupfilesCheckBox == null ) {
try {
this.includeBackupFiles=Boolean.parseBoolean$S($I$(2).getProperty$S("BACKUPFILES_FC_INCLUDE"));
} catch (e) {
...
this.backupfilesCheckBox=Clazz.new_([$I$(9).getString$S("label.include_backup_files"), this.includeBackupFiles],$I$(22,1).c$$S$Z);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "JalviewFileChooser$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
}multi.add$java_awt_Component(Clazz.new_($I$(17,1),[this, null]));
...
return;
}$I$(23,"invokeLater$Runnable",[((P$.JalviewFileChooser$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "JalviewFileChooser$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('Thread'), null, 1);
...
), Clazz.new_($I$(24,1),[this, {fcui:fcui,name:name}],P$.JalviewFileChooser$2))]);
}} catch (ex) {
...
this.$selectedFile=Clazz.new_([this.getCurrentDirectory$(), filename],$I$(18,1).c$$java_io_File$S);
}} catch (x) {
...
this.$selectedFile=(Clazz.new_([this.getCurrentDirectory$(), withExtension],$I$(18,1).c$$java_io_File$S));
this.setSelectedFile$java_io_File(this.$selectedFile);
}}if (this.$selectedFile.exists$()) {
var confirm=$I$(25,"showConfirmDialog$java_awt_Component$O$S$I",[this, $I$(9).getString$S("label.overwrite_existing_file"), $I$(9).getString$S("label.file_already_exists"), 0]);
if (confirm != 0) {
return;
}}C$.superclazz.prototype.approveSelection$.apply(this, []);
});
...
this.setSelectedFile$java_io_File(null);
if (selection != null ) {
var file=Clazz.new_($I$(18,1).c$$S,[selection]);
if (Clazz.instanceOf(this.getFileFilter$(), "jalview.io.JalviewFileFilter")) {
var jvf=this.getFileFilter$();
...
case "SelectedFile":
this.handleResponse$O(Integer.valueOf$I(0));
break;
}
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.JalviewFileChooser, "RecentlyOpened", function(){
...
C$.$fields$=[['O',['list','javax.swing.JList']]]

Clazz.newMeth(C$, 'c$',  function () {
Clazz.super_(C$, this);
this.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(1,1).c$$I$I,[300, 100]));
var historyItems=$I$(2).getProperty$S("RECENT_FILE");
var st;
var recent=Clazz.new_($I$(3,1));
if (historyItems != null ) {
st=Clazz.new_($I$(4,1).c$$S$S,[historyItems, "\t"]);
while (st.hasMoreTokens$()){
recent.addElement$O(st.nextToken$());
}
}this.list=Clazz.new_($I$(5,1).c$$java_util_Vector,[recent]);
var dlcr=Clazz.new_($I$(6,1));
...
(function(){/*a*/var C$=Clazz.newClass(P$, "JalviewFileChooser$RecentlyOpened$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseAdapter'), null, 1);
...
), Clazz.new_($I$(7,1),[this, null],P$.JalviewFileChooser$RecentlyOpened$1)));
this.setBorder$javax_swing_border_Border(Clazz.new_([$I$(9).getString$S("label.recently_opened")],$I$(8,1).c$$S));
var scroller=Clazz.new_($I$(10,1).c$$java_awt_Component,[this.list]);
var layout=Clazz.new_($I$(11,1));
...
scroller.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(1,1).c$$I$I,[500, 100]));
} else {
scroller.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(1,1).c$$I$I,[530, 200]));
}this.add$java_awt_Component(scroller);
$I$(13,"invokeLater$Runnable",[((P$.JalviewFileChooser$RecentlyOpened$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "JalviewFileChooser$RecentlyOpened$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
