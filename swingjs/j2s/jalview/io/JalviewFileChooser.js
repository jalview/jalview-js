(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'java.awt.Dimension','jalview.bin.Cache','java.util.Vector','java.util.StringTokenizer','javax.swing.JList','javax.swing.DefaultListCellRenderer','java.awt.event.MouseAdapter','javax.swing.border.TitledBorder','jalview.util.MessageManager','javax.swing.JScrollPane','javax.swing.SpringLayout','jalview.util.Platform','javax.swing.SwingUtilities','java.util.HashMap','java.util.ArrayList','jalview.io.FileFormats',['jalview.io.JalviewFileChooser','.RecentlyOpened'],'java.io.File','jalview.io.JalviewFileFilter','javax.swing.JPanel','javax.swing.BoxLayout','Boolean','javax.swing.JCheckBox','java.awt.EventQueue','Thread','jalview.gui.JvOptionPane']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.backupfilesCheckBox=Clazz.new_([$I$(9).getString$S("label.include_backup_files"), this.includeBackupFiles],$I$(23,1).c$$S$Z);
...
), Clazz.new_($I$(25,1),[this, {fcui:fcui,name:name}],P$.JalviewFileChooser$2))]);
}} catch (ex) {
