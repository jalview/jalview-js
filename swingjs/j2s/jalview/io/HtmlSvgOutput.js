(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'StringBuilder','java.io.File','jalview.io.HTMLOutput','Boolean','jalview.bin.Cache','java.util.concurrent.atomic.AtomicBoolean','jalview.gui.LineartOptions','jalview.util.MessageManager','jalview.gui.OOMWarning','org.jfree.graphics2d.svg.SVGGraphics2D','org.jfree.graphics2d.svg.SVGHints','java.io.FileOutputStream']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return ($I$(4,"valueOf$S",[$I$(5).getDefault$S$S("EXPORT_EMBBED_BIOJSON", "true")])).valueOf();
});
...
var textOption=Clazz.new_([!"Lineart".equals$O(renderStyle)],$I$(6,1).c$$Z);
...
var svgOption=Clazz.new_($I$(7,1).c$$S$java_util_concurrent_atomic_AtomicBoolean,["HTML", textOption]);
...
Clazz.new_($I$(9,1).c$$S$OutOfMemoryError,["Creating Image for " + this.generatedFile, err]);
}
...
var idPanelGraphics=Clazz.new_([aDimension.getWidth$(), aDimension.getHeight$()],$I$(10,1).c$$I$I);
var alignPanelGraphics=Clazz.new_([aDimension.getWidth$(), aDimension.getHeight$()],$I$(10,1).c$$I$I);
if (!textCharacters) {
