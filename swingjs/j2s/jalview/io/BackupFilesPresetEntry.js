(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'jalview.io.IntKeyStringValueEntry','jalview.util.MessageManager','jalview.io.BackupFilesPresetEntry','java.util.HashMap','StringBuilder','java.util.StringTokenizer','Boolean','jalview.bin.Cache']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
try {
suffix=st.nextToken$();
digits=(Integer.valueOf$S(st.nextToken$())).valueOf();
reverse=($I$(7,"valueOf$S",[st.nextToken$()])).valueOf();
keepAll=($I$(7,"valueOf$S",[st.nextToken$()])).valueOf();
rollMax=(Integer.valueOf$S(st.nextToken$())).valueOf();
confirmDelete=($I$(7,"valueOf$S",[st.nextToken$()])).valueOf();
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
$I$(8).log.error$O("Error parsing backupfiles scheme '" + line + "'" );
} else {
throw e;
}
}
...
if (savedPreset == null ) {
savedPreset=C$.backupfilesPresetEntriesValues.get$O(new Integer(1));
}return savedPreset;
}, 1);
...
Clazz.newMeth(C$, '$init$', function () {
{
this.put$O$O(new Integer(1), Clazz.new_($I$(3,1).c$$S$I$Z$Z$I$Z,[".bak%n", 3, false, false, 3, false]));
this.put$O$O(new Integer(2), Clazz.new_($I$(3,1).c$$S$I$Z$Z$I$Z,["~", 1, false, false, 1, false]));
this.put$O$O(new Integer(3), Clazz.new_($I$(3,1).c$$S$I$Z$Z$I$Z,[".v%n", 3, false, true, 10, true]));
this.put$O$O(new Integer(4), Clazz.new_($I$(3,1).c$$S$I$Z$Z$I$Z,["_bak.%n", 1, true, false, 9, false]));
this.put$O$O(new Integer(0), Clazz.new_($I$(3,1).c$$S$I$Z$Z$I$Z,["", 0, false, false, 0, false]));
}
},1);
