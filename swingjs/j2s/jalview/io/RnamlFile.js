(function(){var P$=Clazz.newPackage("jalview.io"),p$1={},I$=[[0,'java.io.FileReader','java.io.BufferedReader','jalview.util.MessageManager','fr.orsay.lri.varna.factories.RNAFactory','jalview.datamodel.SequenceI','jalview.datamodel.Sequence','jalview.datamodel.Annotation','jalview.analysis.Rna','jalview.datamodel.AlignmentAnnotation','com.stevesoft.pat.Regex']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
