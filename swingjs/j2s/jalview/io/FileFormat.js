...
Clazz.newMeth(C$, 'getReader$jalview_io_FileParse', function (source) {
var af=Clazz.new_($I$(14,1).c$$jalview_io_FileParse,[source]);
...
Clazz.newMeth(C$, 'getReader$jalview_io_FileParse', function (source) {
return Clazz.new_($I$(15,1).c$$jalview_io_FileParse,[source]);
});
...
Clazz.newMeth(C$, 'getReader$jalview_io_FileParse', function (source) {
return Clazz.new_($I$(16,1).c$$jalview_io_FileParse,[source]);
});
...
if (isParseWithJMOL) {
return Clazz.new_($I$(19,1).c$$jalview_io_FileParse,[source]);
} else {
$I$(17).setShowSeqFeatures$Z(true);
return Clazz.new_([$I$(17).isVisibleChainAnnotation$(), $I$(17).isProcessSecondaryStructure$(), $I$(17).isExternalSecondaryStructure$(), source],$I$(20,1).c$$Z$Z$Z$jalview_io_FileParse);
}});
