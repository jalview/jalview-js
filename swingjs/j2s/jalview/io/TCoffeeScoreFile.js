...
return this.fWidth != null  ? (this.fWidth).valueOf() : 0;
});
...
} else if ((this.fWidth).valueOf() !== str.length$() ) {
this.error=true;
...
if ("".equals$O(id)) {
continue;
}result.scores.put$O$O(id, new Integer(val));
}
if (result == null ) {
...
return this.scores.containsKey$O(ID) ? (this.scores.get$O(ID)).valueOf() : -1;
});
