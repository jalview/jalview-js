...
if (useTextField) {
this.appCache=null;
this.textComponent=this.textField=Clazz.new_($I$(4,1));
} else {
this.appCache=$I$(5).getInstance$();
this.comboBox=Clazz.new_($I$(6,1));
...
), Clazz.new_($I$(7,1),[this, null],P$.JvCacheableInputBox$1)));
...
return;
}var persistedCacheItems=$I$(9,"asList$OA",[delimitedCacheStr.split$S(";")]);
var foundCacheItems=this.appCache.getAllCachedItemsFor$S(cacheKey);
if (foundCacheItems == null ) {
foundCacheItems=Clazz.new_($I$(10,1));
...
if (this.appCache == null ) {
return;
}this.menuItemClearCache.setFont$java_awt_Font(Clazz.new_($I$(11,1).c$$S$I$I,["Verdana", 0, 12]));
...
var reversedCacheItems=Clazz.new_($I$(14,1));
