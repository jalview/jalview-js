(function(){var P$=Clazz.newPackage("jalview.io.cache"),I$=[[0,'java.util.Hashtable','java.util.LinkedHashSet','StringBuffer','jalview.bin.Cache']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
}return (Integer.valueOf$S(formerLimit)).valueOf();
});
