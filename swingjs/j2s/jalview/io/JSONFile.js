...
var start=(Integer.valueOf$S(sequence.get$O("start").toString())).valueOf();
var end=(Integer.valueOf$S(sequence.get$O("end").toString())).valueOf();
var seq=Clazz.new_($I$(20,1).c$$S$S$I$I,[sequenceName, sequcenceString, start, end]);
...
var displayBoxes=($I$(18,"valueOf$S",[seqGrpObj.get$O("displayBoxes").toString()])).valueOf();
var displayText=($I$(18,"valueOf$S",[seqGrpObj.get$O("displayText").toString()])).valueOf();
var colourText=($I$(18,"valueOf$S",[seqGrpObj.get$O("colourText").toString()])).valueOf();
var showNonconserved=($I$(18,"valueOf$S",[seqGrpObj.get$O("showNonconserved").toString()])).valueOf();
var startRes=(Integer.valueOf$S(seqGrpObj.get$O("startRes").toString())).valueOf();
var endRes=(Integer.valueOf$S(seqGrpObj.get$O("endRes").toString())).valueOf();
...
}var seqGrp=Clazz.new_($I$(21,1).c$$java_util_List$S$jalview_schemes_ColourSchemeI$Z$Z$Z$I$I,[grpSeqs, grpName, null, displayBoxes, displayText, colourText, startRes, endRes]);
...
annotations[count]=Clazz.new_($I$(23,1).c$$S$S$C$F,[displayChar, desc, ss, val]);
if (annot.get$O("colour") != null ) {
var color=$I$(24,"parseColourString$S",[annot.get$O("colour").toString()]);
annotations[count].colour=color;
}}++count;
}
var alignAnnot=Clazz.new_([alAnnot.get$O("label").toString(), alAnnot.get$O("description").toString(), annotations],$I$(25,1).c$$S$S$jalview_datamodel_AnnotationA);
alignAnnot.graph=(alAnnot.get$O("graphType") == null ) ? 0 : (Integer.valueOf$S(alAnnot.get$O("graphType").toString())).valueOf();
var diplaySettings=alAnnot.get$O("annotationSettings");
if (diplaySettings != null ) {
alignAnnot.scaleColLabel=(diplaySettings.get$O("scaleColLabel") == null ) ? false : ($I$(18,"valueOf$S",[diplaySettings.get$O("scaleColLabel").toString()])).valueOf();
alignAnnot.showAllColLabels=(diplaySettings.get$O("showAllColLabels") == null ) ? true : ($I$(18,"valueOf$S",[diplaySettings.get$O("showAllColLabels").toString()])).valueOf();
alignAnnot.centreColLabels=(diplaySettings.get$O("centreColLabels") == null ) ? true : ($I$(18,"valueOf$S",[diplaySettings.get$O("centreColLabels").toString()])).valueOf();
alignAnnot.belowAlignment=(diplaySettings.get$O("belowAlignment") == null ) ? false : ($I$(18,"valueOf$S",[diplaySettings.get$O("belowAlignment").toString()])).valueOf();
alignAnnot.visible=(diplaySettings.get$O("visible") == null ) ? true : ($I$(18,"valueOf$S",[diplaySettings.get$O("visible").toString()])).valueOf();
alignAnnot.hasIcons=(diplaySettings.get$O("hasIcon") == null ) ? true : ($I$(18,"valueOf$S",[diplaySettings.get$O("hasIcon").toString()])).valueOf();
...
var sequenceFeature=Clazz.new_([type, description, featureBegin, featureEnd, (score).valueOf(), featureGrp],$I$(28,1).c$$S$S$I$I$F$S);
...
return this.hiddenSequences.toArray$OA(Clazz.array($I$(29), [this.hiddenSequences.size$()]));
}});
