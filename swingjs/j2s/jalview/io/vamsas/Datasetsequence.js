(function(){var P$=Clazz.newPackage("jalview.io.vamsas"),p$1={},I$=[[0,'uk.ac.vamsas.objects.core.Sequence','jalview.datamodel.SequenceI','jalview.datamodel.Sequence','jalview.io.vamsas.DatastoreItem','jalview.io.vamsas.Sequencefeature','jalview.io.vamsas.Dbref']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
;C$.superclazz.c$$jalview_io_VamsasAppDatastore$uk_ac_vamsas_client_Vobject$Class.apply(this,[vamsasAppDatastore, vdseq, Clazz.getClass($I$(2),['addAlignmentAnnotation$jalview_datamodel_AlignmentAnnotation','addDBRef$jalview_datamodel_DBRefEntry','addPDBId$jalview_datamodel_PDBEntry','addSequenceFeature$jalview_datamodel_SequenceFeature','createDatasetSequence$','deleteChars$I$I','deleteFeature$jalview_datamodel_SequenceFeature','deriveSequence$','findFeatures$I$I$SA','findIndex$I','findPosition$I','findPositionMap$','findPositions$I$I','firstResidueOutsideIterator$java_util_Iterator','gapBitset$','gapMap$','getAlignmentAnnotations$S$S','getAlignmentAnnotations$S$S$S','getAllPDBEntries$','getAnnotation$','getAnnotation$S','getCharAt$I','getDBRefs$','getDatasetSequence$','getDescription$','getDisplayId$Z','getEnd$','getFeatures$','getGeneLoci$','getInsertions$','getInsertionsAsBits$','getLength$','getName$','getPDBEntry$S','getPrimaryDBRefs$','getRNA$','getSequence$','getSequence$I$I','getSequenceAsString$','getSequenceAsString$I$I','getSequenceFeatures$','getSequenceStringFromIterator$java_util_Iterator','getStart$','getSubSequence$I$I','getVamsasId$','hasAnnotation$jalview_datamodel_AlignmentAnnotation','insertCharAt$I$C','insertCharAt$I$I$C','isProtein$','removeAlignmentAnnotation$jalview_datamodel_AlignmentAnnotation','replace$C$C','sequenceChanged$','setAlignmentAnnotation$jalview_datamodel_AlignmentAnnotationA','setDBRefs$jalview_datamodel_Sequence_DBModList','setDatasetSequence$jalview_datamodel_SequenceI','setDescription$S','setEnd$I','setGeneLoci$S$S$S$jalview_util_MapList','setName$S','setPDBId$java_util_Vector','setRNA$fr_orsay_lri_varna_models_rna_RNA','setSequence$S','setSequenceFeatures$java_util_List','setStart$I','setVamsasId$S','transferAnnotation$jalview_datamodel_SequenceI$jalview_datamodel_Mapping','updatePDBIds$'])]);C$.$init$.apply(this);
this.doJvUpdate$();
}, 1);

Clazz.newMeth(C$, 'addFromDocument$',  function () {
var vseq=this.vobj;
var dsseq=Clazz.new_([vseq.getName$(), vseq.getSequence$(), Long.$ival(vseq.getStart$()), Long.$ival(vseq.getEnd$())],$I$(3,1).c$$S$S$I$I);
...
$I$(4).log.warn$S("Potential Client Error ! - mismatch of dataset sequence: and jalview internal dataset sequence.");
} else {
...
if (Long.$ne(sequence.getStart$(),sq.getStart$() ) || Long.$ne(sequence.getEnd$(),sq.getEnd$() ) ) {
sequence.setSequence$S(sq.getSequence$());
sequence.setStart$I(Long.$ival(sq.getStart$()));
sequence.setEnd$I(Long.$ival(sq.getEnd$()));
this.modified=true;
}}if (!sequence.getName$().equals$O(sq.getName$())) {
sequence.setName$S(sq.getName$());
this.modified=true;
}this.modified=!!(this.modified|(p$1.updateJvDbRefs.apply(this, [])));
}});
...
changed=!!(changed|(Clazz.new_($I$(5,1).c$$jalview_io_VamsasAppDatastore$jalview_datamodel_SequenceFeature$uk_ac_vamsas_objects_core_DataSet$uk_ac_vamsas_objects_core_Sequence,[this.datastore, sf, this.dataset, this.vobj]).docWasUpdated$()));
}
return changed;
}, p$1);
...
modifiedthedoc=!!(modifiedthedoc|(Clazz.new_([this.datastore, entries.get$I(db), sq, this.vobj, this.dataset],$I$(6,1).c$$jalview_io_VamsasAppDatastore$jalview_datamodel_DBRefEntry$jalview_datamodel_SequenceI$uk_ac_vamsas_objects_core_Sequence$uk_ac_vamsas_objects_core_DataSet).docWasUpdated$()));
}
...
modifiedtheseq=!!(modifiedtheseq|(Clazz.new_($I$(6,1).c$$jalview_io_VamsasAppDatastore$uk_ac_vamsas_objects_core_DbRef$uk_ac_vamsas_objects_core_Sequence$jalview_datamodel_SequenceI,[this.datastore, entries[db], vsq, sq]).jvWasUpdated$()));
}
}return modifiedtheseq;
}, p$1);

Clazz.newMeth(C$, 'conflict$',  function () {
$I$(4).log.warn$S("Conflict in dataset sequence update to document. Overwriting document");
this.updateToDoc$();
});
...
sequence.setName$S(sq.getName$());
this.modified=true;
}this.modified=!!(this.modified|(p$1.updateDbRefs.apply(this, [])));
this.modified=!!(this.modified|(p$1.updateSqFeatures.apply(this, [])));
});
