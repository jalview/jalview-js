(function(){var P$=Clazz.newPackage("jalview.io.vamsas"),I$=[[0,'jalview.log.JLoggerLog4j','java.util.IdentityHashMap']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.log.debug$S("Returning DatastoreItem self reference.");
return obj;
