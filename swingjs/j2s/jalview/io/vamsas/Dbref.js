(function(){var P$=Clazz.newPackage("jalview.io.vamsas"),p$1={},I$=[[0,'uk.ac.vamsas.objects.core.DbRef','jalview.datamodel.DBRefEntry','uk.ac.vamsas.objects.core.Map','jalview.bin.Console','jalview.io.vamsas.DatastoreItem','jalview.io.vamsas.Datasetsequence','jalview.datamodel.Mapping']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
$I$(4,"debug$S",["Ignoring mapless DbRef.Map " + jvobj.getSrcAccString$()]);
}});

Clazz.newMeth(C$, 'updateMapTo$jalview_datamodel_Mapping',  function (mp) {
$I$(5).log.info$S("Performing updateMapTo remove this message when we know what we\'re doing.");
...
$I$(5).log.debug$S("Ignoring non-dataset sequence mapping.");
}}, p$1);
...
$I$(4,"debug$S",["Ignoring additional mappings on DbRef: " + jvobj.getSource$() + ":" + jvobj.getAccessionId$() ]);
...
var vobj=this.vobj;
var jvobj=this.jvobj;
$I$(4,"debug$S",["Conflict in dbentry update for " + vobj.getAccessionId$() + vobj.getSource$() + " " + vobj.getVorbaId$() ]);
});
