(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'java.io.File','jalview.bin.Cache','java.util.Objects','java.util.TreeMap','jalview.io.BioJsHTMLOutput','jalview.json.binding.biojs.BioJSRepositoryPojo','Thread','java.io.PrintWriter','java.io.FileWriter','java.net.URL','java.io.BufferedInputStream','java.io.BufferedReader','java.io.InputStreamReader','StringBuilder','jalview.io.HTMLOutput','jalview.util.MessageManager','jalview.gui.OOMWarning']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
out.flush$();
out.close$();
this.setProgressMessage$S($I$(16,"formatMessage$S$OA",["status.export_complete", Clazz.array(java.lang.Object, -1, [this.getDescription$()])]));
...
var e = e$$;
{
this.setProgressMessage$S($I$(16,"formatMessage$S$OA",["info.error_creating_file", Clazz.array(java.lang.Object, -1, [this.getDescription$()])]));
e.printStackTrace$();
}
} else {
throw e$$;
