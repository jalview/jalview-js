(function(){var P$=Clazz.newPackage("jalview.io"),p$1={},I$=[[0,'jalview.datamodel.Sequence','StringBuffer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "PhylipFile", null, 'jalview.io.AlignFile');
...
sequences[i]=Clazz.new_([p$1.removeWhitespace$S.apply(this, [line.substring$I(10)])],$I$(2,1).c$$S);
} else {
sequenceElements[i]=this.parseId$S(p$1.validateName$S.apply(this, [potentialName.substring$I$I(0, tabIndex)]));
sequences[i]=Clazz.new_([p$1.removeWhitespace$S.apply(this, [line.substring$I(tabIndex)])],$I$(2,1).c$$S);
}}
...
this.seqs.add$O(sequenceElements[i]);
}
} catch (e) {
...
var sb=Clazz.new_([Integer.toString$I(sqs.length)],$I$(2,1).c$$S);
sb.append$S(" ");
...
name=String.format$S$OA("%1$-10s", Clazz.array(java.lang.Object, -1, [s.getName$()]));
}sb.append$S(name);
if (sequential) {
