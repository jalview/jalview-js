(function(){var P$=Clazz.newPackage("jalview.io"),p$1={},I$=[[0,'jalview.datamodel.Sequence','StringBuffer']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
