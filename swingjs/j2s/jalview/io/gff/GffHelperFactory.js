(function(){var P$=Clazz.newPackage("jalview.io.gff"),I$=[[0,'jalview.io.gff.ExonerateHelper','jalview.io.gff.InterProScanHelper','jalview.io.gff.Gff3Helper','jalview.io.gff.Gff2Helper']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
