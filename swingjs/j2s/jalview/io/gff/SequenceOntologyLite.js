(function(){var P$=Clazz.newPackage("jalview.io.gff"),p$1={},I$=[[0,'java.util.ArrayList','java.util.HashMap','java.util.Collections']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
