(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'java.io.File','jalview.io.BackupFilenameParts']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
