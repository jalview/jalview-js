(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'jalview.util.MessageManager','jalview.datamodel.Annotation','jalview.datamodel.AlignmentAnnotation']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
annot=Clazz.new_([preds[i].getName$(), "JPred Output", annotations, 0.0, 10.0, 1],$I$(3,1).c$$S$S$jalview_datamodel_AnnotationA$F$F$I);
} else {
annot=Clazz.new_([preds[i].getName$(), "JPred Output", annotations],$I$(3,1).c$$S$S$jalview_datamodel_AnnotationA);
}if (seqRef != null ) {
...
if (!firstsol) {
annot=Clazz.new_(["Jnet Burial", "<html>Prediction of Solvent Accessibility<br/>levels are<ul><li>0 - Exposed</li><li>3 - 25% or more S.A. accessible</li><li>6 - 5% or more S.A. accessible</li><li>9 - Buried (<5% exposed)</li></ul>", sol, 0.0, 9.0, 1],$I$(3,1).c$$S$S$jalview_datamodel_AnnotationA$F$F$I);
