...
} else if (Clazz.new_($I$(14,1).c$$S,[data]).exists$()) {
protocol=$I$(10).FILE;
}return protocol;
}, 1);
...
try {
var idformat=Clazz.new_($I$(15,1)).identify$S$jalview_io_DataSourceType(file, protocol);
if (idformat == null ) {
if (debug) {
