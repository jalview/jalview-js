(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'java.util.Hashtable','java.util.StringTokenizer','jalview.io.BackupFilenameParts','java.util.Locale','java.util.LinkedHashMap']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return filename.substring$I(i + 1).toLowerCase$java_util_Locale($I$(4).ROOT);
};}return "";
});

Clazz.newMeth(C$, 'addExtension$S',  function (extension) {
if (this.filters == null ) {
this.filters=Clazz.new_($I$(5,1).c$$I,[5]);
}this.filters.put$O$O(extension.toLowerCase$java_util_Locale($I$(4).ROOT), this);
