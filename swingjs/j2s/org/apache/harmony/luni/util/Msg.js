...
var answer=Clazz.new_([format.length$() + (args.length * 20)],$I$(1,1).c$$I);
...
;Clazz.setTVer('3.2.9-v1');//Created 2020-03-27 13:55:47 Java2ScriptVisitor version 3.2.9-v1 net.sf.j2s.core.jar version 3.2.9-v1
