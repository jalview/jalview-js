(function(){var P$=Clazz.newPackage("org.apache.commons.cli"),p$1={},I$=[[0,['org.apache.commons.cli.HelpFormatter','.OptionComparator'],'java.io.PrintWriter','StringBuffer','java.util.ArrayList','java.util.Collections','StringBuilder','java.io.BufferedReader','java.io.StringReader','java.util.Arrays']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
