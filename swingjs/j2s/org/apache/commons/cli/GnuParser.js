(function(){var P$=Clazz.newPackage("org.apache.commons.cli"),I$=[[0,'java.util.ArrayList','org.apache.commons.cli.Util']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
