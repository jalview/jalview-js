(function(){var P$=Clazz.newPackage("org.apache.commons.cli"),I$=[[0,'java.util.LinkedHashMap','java.util.ArrayList','java.util.HashSet','org.apache.commons.cli.Option','java.util.Collections','org.apache.commons.cli.Util','StringBuilder']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
