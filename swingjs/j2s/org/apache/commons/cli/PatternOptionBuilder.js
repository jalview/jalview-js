(function(){var P$=Clazz.newPackage("org.apache.commons.cli"),I$=[[0,'java.io.FileInputStream','java.io.File','java.net.URL','org.apache.commons.cli.Options','org.apache.commons.cli.Option']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
