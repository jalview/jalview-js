(function(){var P$=Clazz.newPackage("org.jmol.render"),p$1={},I$=[[0,'javajs.util.P3','org.jmol.util.BoxInfo','org.jmol.util.C','org.jmol.util.SimpleUnitCell','javajs.util.PT','javajs.util.DF']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
