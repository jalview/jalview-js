(function(){var P$=Clazz.newPackage("org.jmol.render"),p$1={},I$=[[0,'javajs.util.V3','javajs.util.P3','javajs.util.BS','org.jmol.render.FontLineShapeRenderer','org.jmol.util.Edge','org.jmol.util.C','org.jmol.c.PAL','javajs.util.M3','javajs.util.A4']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.colixA=(function(a,f){return f.apply(null,a)})([($s$[0] = (this.colix | this.vwr.cm.getColixAtomPalette$org_jmol_modelset_Atom$B(atomA0, $I$(7).CPK.id)), $s$[0]), this.colixA],$I$(6).getColixInherited$H$H);
this.colixB=(function(a,f){return f.apply(null,a)})([($s$[0] = (this.colix | this.vwr.cm.getColixAtomPalette$org_jmol_modelset_Atom$B(atomB0, $I$(7).CPK.id)), $s$[0]), this.colixB],$I$(6).getColixInherited$H$H);
} else {
