(function(){var P$=Clazz.newPackage("org.jmol.render"),I$=[[0,'javajs.util.P3i','javajs.util.P3','org.jmol.viewer.JC','org.jmol.render.TextRenderer','org.jmol.modelset.Text']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
