(function(){var P$=Clazz.newPackage("org.jmol.render"),p$1={},I$=[[0,'javajs.util.BS','org.jmol.viewer.Viewer','org.jmol.util.Logger','Thread','org.jmol.viewer.JC','org.jmol.api.Interface','org.jmol.render.ShapeRenderer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (!isOK) {
(function(a,f){return f.apply(null,a)})(["Cannot export " + params.get$O("type")],$I$(3).error$S);
return null;
}if (this.renderers == null ) this.renderers=Clazz.array($I$(7), [37]);
p$1.getAllRenderers.apply(this, []);
var msg=null;
