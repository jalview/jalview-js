(function(){var P$=Clazz.newPackage("org.jmol.popup"),p$1={},I$=[[0,'java.util.Hashtable','javajs.util.Lst','org.jmol.util.Logger','java.util.StringTokenizer','javajs.util.PT','javajs.util.SB']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.addMenu$S$S$org_jmol_api_SC$S$org_jmol_popup_PopupResource(id, item, subMenu, label, popupResourceBundle);
newItem=subMenu;
