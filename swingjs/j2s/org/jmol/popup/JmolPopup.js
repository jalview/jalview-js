(function(){var P$=Clazz.newPackage("org.jmol.popup"),p$1={},I$=[[0,'javajs.util.Lst','org.jmol.popup.MainPopupResourceBundle','javajs.util.PT','java.util.Hashtable','org.jmol.i18n.GT','org.jmol.util.Elements','org.jmol.modelset.Group','java.util.Arrays']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
Clazz.newMeth(C$, 'updateMenus$', function () {
...
script=$I$(3,"rep$S$S$S",[script, "PdbId?", "=xxxx"]);
}return script;
});
...
return (this.modelSetInfo != null  && this.modelSetInfo.get$O(key) === Boolean.TRUE  );
}, p$1);
...
if (this.modelInfo == null ) this.modelInfo=Clazz.new_($I$(4,1));
...
this.menuSetLabel$org_jmol_api_SC$S(menu, $I$(5,"o$S$O",[$I$(5).$$S(text), this.modelSetFileName]));
...
var elementName=$I$(6).elementNameFromNumber$I(i);
var elementSymbol=$I$(6).elementSymbolFromNumber$I(i);
var entryName=elementSymbol + " - " + elementName ;
this.menuCreateItem$org_jmol_api_SC$S$S$S(menu, entryName, "SELECT " + elementName, null);
}
for (var i=4; i < $I$(6).altElementMax; ++i) {
var n=$I$(6).elementNumberMax + i;
if (elementsPresentBitSet.get$I(n)) {
n=$I$(6).altElementNumberFromIndex$I(i);
var elementName=$I$(6).elementNameFromNumber$I(n);
var elementSymbol=$I$(6).elementSymbolFromNumber$I(n);
var entryName=elementSymbol + " - " + elementName ;
this.menuCreateItem$org_jmol_api_SC$S$S$S(menu, entryName, "SELECT " + elementName, null);
}}
this.menuEnable$org_jmol_api_SC$Z(menu, true);
...
if (nOrb == 0) {
this.menuSetLabel$org_jmol_api_SC$S(menu, $I$(5,"o$S$O",[$I$(5).$$S(text), ""]));
this.menuEnable$org_jmol_api_SC$Z(menu, false);
return;
}this.menuSetLabel$org_jmol_api_SC$S(menu, $I$(5,"i$S$I",[$I$(5).$$S(text), nOrb]));
this.menuEnable$org_jmol_api_SC$Z(menu, true);
var subMenu=menu;
var nmod=(nOrb % 25);
if (nmod == 0) nmod=25;
...
var menu3=this.htMenus.get$O("PDBaaResiduesComputedMenu");
if (menu3 != null ) {
this.menuRemoveAll$org_jmol_api_SC$I(menu3, 0);
this.menuEnable$org_jmol_api_SC$Z(menu3, false);
...
var nItems=0;
var groupList=$I$(7).standardGroupList;
if (menu3 != null ) {
for (var i=1; i < 24; ++i) nItems+=p$1.updateGroup3List$org_jmol_api_SC$S.apply(this, [menu3, groupList.substring$I$I(i * 6 - 4, i * 6 - 1).trim$()]);

nItems+=p$1.augmentGroup3List$org_jmol_api_SC$S$Z.apply(this, [menu3, "p>", true]);
this.menuEnable$org_jmol_api_SC$Z(menu3, (nItems > 0));
...
this.menuSetLabel$org_jmol_api_SC$S(menu, name == null  ? $I$(5).$$S("Space Group") : name);
var subMenu=menu;
...
this.htMenus.put$O$O(id, subMenu);
pt=1;
}if (i == 0) this.menuEnable$org_jmol_api_SC$Z(this.menuCreateItem$org_jmol_api_SC$S$S$S(subMenu, $I$(5).$$S("none"), "draw sym_* delete", null), true);
...
if (this.modelCount > 1) this.menuCreateCheckboxItem$org_jmol_api_SC$S$S$S$Z$Z(menu, $I$(5).$$S("All"), "frame 0 ##", null, (this.modelIndex < 0), false);
var subMenu=menu;
...
this.menuCreateCheckboxItem$org_jmol_api_SC$S$S$S$Z$Z(menu, $I$(5).$$S("All"), script, null, (this.updateMode == 1 && this.configurationSelected.equals$O(script) ), false);
...
if (submenu == null ) {
submenu=this.menuNewSubMenu$S$S($I$(5,"$$S",[p$1.getMenuText$S.apply(this, ["biomoleculesMenuText"])]), this.menuGetId$org_jmol_api_SC(menu) + ".biomolecules");
this.menuAddSubMenu$org_jmol_api_SC$org_jmol_api_SC(menu, submenu);
...
return $I$(5,"i$S$I",[$I$(5,"$$S",[p$1.getMenuText$S.apply(this, [s])]), n]);
}, p$1);

Clazz.newMeth(C$, 'gto$S$O', function (s, o) {
return $I$(5,"o$S$O",[$I$(5,"$$S",[p$1.getMenuText$S.apply(this, [s])]), o]);
}, p$1);
...
if (menu == null ) return;
this.menuRemoveAll$org_jmol_api_SC$I(menu, 0);
var language=$I$(5).getLanguage$();
var id=this.menuGetId$org_jmol_api_SC(menu);
var languages=$I$(5).getLanguageList$org_jmol_i18n_GT(null);
...
var menuLabel=code + " - " + $I$(5).$$S(name) ;
if ((nativeName != null ) && (!nativeName.equals$O($I$(5).$$S(name))) ) {
...
if (name.indexOf$S("captureLooping") >= 0) info=(this.vwr.am.animationReplayMode == 1073742070 ? "ONCE" : "LOOP");
 ...
 else if (name.indexOf$S("captureMenu") >= 0) info=(this.vwr.captureParams == null  ? $I$(5).$$S("not capturing") : this.vwr.fm.getFilePath$S$Z$Z(this.vwr.captureParams.get$O("captureFileName"), false, true) + " " + this.vwr.captureParams.get$O("captureCount") );
