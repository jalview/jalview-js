(function(){var P$=Clazz.newPackage("org.jmol.shapesurface"),p$1={},I$=[[0,'javajs.util.PT','javajs.util.V3','org.jmol.util.C','javajs.util.SB','org.jmol.shape.Shape','org.jmol.util.Escape']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return (id != null  ? id : (this.isLonePair || this.isRadical  ? "lp_" : "lcao_") + (i + 1) + "_" ) + (this.thisType == null  ? "" : (function(a,f){return f.apply(null,a)})([this.thisType, "-", (this.thisType.indexOf$S("-p") == 0 ? "" : "_")],$I$(1).rep$S$S$S));
}, p$1);

Clazz.newMeth(C$, 'getShapeState$', function () {
var sb=Clazz.new_($I$(4,1));
if (this.lcaoScale != null ) (function(a,f){return f.apply(null,a)})([sb, "lcaoCartoon scale " + new Float(this.lcaoScale.floatValue$()).toString()],$I$(5).appendCmd$javajs_util_SB$S);
if (this.lcaoColorNeg != null ) (function(a,f){return f.apply(null,a)})([sb, "lcaoCartoon color " + (function(a,f){return f.apply(null,a)})([this.lcaoColorNeg.intValue$()],$I$(6).escapeColor$I) + " " + (function(a,f){return f.apply(null,a)})([this.lcaoColorPos.intValue$()],$I$(6).escapeColor$I) ],$I$(5).appendCmd$javajs_util_SB$S);
if (this.lcaoTranslucent) (function(a,f){return f.apply(null,a)})([sb, "lcaoCartoon translucent " + new Float(this.translucentLevel).toString()],$I$(5).appendCmd$javajs_util_SB$S);
