...
this.setProperty$S$O$javajs_util_BS("squareData", Boolean.FALSE, null);
...
if (mat4 != null ) {
var minv=$I$(13).newM4$javajs_util_M4(mat4);
minv.invert$();
...
$I$(14).error$S("Isosurface: could not open file " + fileName + " -- " + value );
return null;
}if (!(Clazz.instanceOf(value, "java.io.BufferedReader"))) try {
value=$I$(15).getBufferedReader$java_io_BufferedInputStream$S(value, "ISO-8859-1");
} catch (e) {
...
this.setProperty$S$O$javajs_util_BS("map", Boolean.FALSE, null);
...
if (property === "keys" ) {
var keys=(Clazz.instanceOf(data[1], "javajs.util.Lst") ? data[1] : Clazz.new_($I$(16,1)));
data[1]=keys;
keys.addLast$O("info");
keys.addLast$O("data");
...
return $I$(20,"jvxlGetFile$org_jmol_jvxl_data_JvxlData$org_jmol_jvxl_data_MeshData$SA$S$Z$I$S$S",[this.jvxlData, meshData, this.title, "", true, 1, sb.toString(), null]);
}if (property === "jvxlFileInfo" ) {
return $I$(20).jvxlGetInfo$org_jmol_jvxl_data_JvxlData(this.jvxlData);
}if (property === "command" ) {
var sb=Clazz.new_($I$(19,1));
...
}var meshData=Clazz.new_($I$(18,1));
...
}var ret=$I$(18).calculateVolumeOrArea$org_jmol_jvxl_data_MeshData$I$Z$Z(meshData, mesh.jvxlData.thisSet, isArea, false);
...
if (modelCount > 1) $I$(21,"appendCmd$javajs_util_SB$S",[sb, "frame " + this.vwr.getModelNumberDotted$I(imesh.modelIndex)]);
...
$I$(21).appendCmd$javajs_util_SB$S(sb, cmd);
var id=this.myType + " ID " + $I$(8).esc$S(imesh.thisID) ;
if (imesh.jvxlData.thisSet >= 0) $I$(21,"appendCmd$javajs_util_SB$S",[sb, id + " set " + (imesh.jvxlData.thisSet + 1) ]);
if (imesh.mat4 != null  && !imesh.isModelConnected ) $I$(21,"appendCmd$javajs_util_SB$S",[sb, id + " move " + $I$(22).matrixToScript$O(imesh.mat4) ]);
if (imesh.scale3d != 0 ) $I$(21,"appendCmd$javajs_util_SB$S",[sb, id + " scale3d " + new Float(imesh.scale3d).toString() ]);
if (imesh.jvxlData.slabValue != -2147483648) $I$(21).appendCmd$javajs_util_SB$S(sb, id + " slab " + imesh.jvxlData.slabValue );
if (imesh.slabOptions != null ) $I$(21,"appendCmd$javajs_util_SB$S",[sb, imesh.slabOptions.toString()]);
if (cmd.charAt$I(0) != "#") {
if (this.allowMesh) $I$(21,"appendCmd$javajs_util_SB$S",[sb, imesh.getState$S(this.myType)]);
if (!imesh.isColorSolid && imesh.colorType == 0  && $I$(9).isColixTranslucent$H(imesh.colix) ) $I$(21,"appendCmd$javajs_util_SB$S",[sb, "color " + this.myType + " " + $I$(21).getTranslucentLabel$H(imesh.colix) ]);
if (imesh.colorCommand != null  && imesh.colorType == 0  && !imesh.colorCommand.equals$O("#inherit;") ) {
$I$(21).appendCmd$javajs_util_SB$S(sb, imesh.colorCommand);
...
$I$(21,"appendCmd$javajs_util_SB$S",[sb, $I$(21).getColorCommandUnk$S$H$Z(this.myType, imesh.colix, this.translucentAllowed)]);
} else if (imesh.jvxlData.isBicolorMap && imesh.colorPhased ) {
$I$(21,"appendCmd$javajs_util_SB$S",[sb, "color isosurface phase " + $I$(21).encodeColor$H(imesh.jvxlData.minColorIndex) + " " + $I$(21).encodeColor$H(imesh.jvxlData.maxColorIndex) ]);
...
if (!bs.isEmpty$()) $I$(21,"appendCmd$javajs_util_SB$S",[sb, "color " + this.myType + " " + $I$(22).eBS$javajs_util_BS(bs) + " " + entry.getKey$() ]);
}
}}, p$1);
...
var m=Clazz.new_($I$(26,1)).setAA$javajs_util_A4(a);
...
p$1.initState.apply(this, []);
if ($I$(14).debugging) {
$I$(14).debug$S("creating isosurface ID " + this.thisMesh.thisID);
}if (lobeAxis == null ) {
...
if (this.thisMesh.bsVdw == null ) this.thisMesh.bsVdw=Clazz.new_($I$(23,1));
...
return (iA < 0 || iB < 0  || iC < 0  || isAbsolute && !$I$(18).checkCutoff$I$I$I$FA(iA, iB, iC, this.thisMesh.vvs)   ? -1 : this.thisMesh.addTriangleCheck$I$I$I$I$I$I(iA, iB, iC, check, iContour, color));
});
...
info.put$O$O("visible", Boolean.valueOf$Z(mesh.visible));
...
var s=$I$(20).jvxlGetInfo$org_jmol_jvxl_data_JvxlData(mesh.jvxlData);
if (s != null ) info.put$O$O("jvxlInfo", s.replace$C$C("\n", " "));
info.put$O$O("modelIndex", Integer.valueOf$I(mesh.modelIndex));
info.put$O$O("color", $I$(29,"colorPtFromInt$I$javajs_util_P3",[$I$(9).getArgb$H(mesh.colix), null]));
...
if (pickedContour != null ) return pickedContour.get$I(2).toString() + ($I$(14).debugging ? " " + pickedJ : "");
...
return (pickedVertex == -1 ? null : ($I$(14).debugging ? "$" + m.thisID + "[" + (pickedVertex + 1) + "] " + m.vs[pickedVertex] + ": "  : m.thisID + ": ") + new Float(m.vvs[pickedVertex]).toString());
}, p$1);

Clazz.newMeth(C$, 'getCmd$I', function (index) {
var sb=Clazz.new_($I$(19,1)).append$S("\n");
