(function(){var P$=Clazz.newPackage("org.jmol.shapecgo"),p$1={},I$=[[0,'javajs.util.Lst','java.util.Hashtable','javajs.util.PT','org.jmol.util.Logger','javajs.util.BS','org.jmol.util.C','javajs.util.CU','org.jmol.util.Normix']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.cList.addLast$O(Short.valueOf$H($I$(6,"getColix$I",[$I$(7).colorPtToFFRGB$javajs_util_T3(this.vTemp)])));
}, p$1);
