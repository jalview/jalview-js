...
if (percentile < 0  || percentile > 1  ) (function(a,f){return f.apply(null,a)})(["Que ha ocurrido? " + new Float(percentile).toString()],$I$(4).error$S);
...
(function(a,f){return f.apply(null,a)})(["unrecognized setMad(" + mad + ")" ],$I$(4).error$S);
return $s$[0] = 0, $s$[0];
}, p$1);
...
(function(a,f){return f.apply(null,a)})([temp, atomIndex1, atomIndex2, type + (this.bsSizeSet.get$I(i) ? " on" : " off")],$I$(8).setMapBitSet$java_util_Map$I$I$S);
} else {
(function(a,f){return f.apply(null,a)})([temp, atomIndex1, atomIndex2, type + " " + $I$(9).escF$F(this.mads[i] / 2000.0) ],$I$(8).setMapBitSet$java_util_Map$I$I$S);
