...
p$1.app$javajs_util_SB$S.apply(this, [s, $I$(18,"getFontCommand$S$org_jmol_util_Font",["label", $I$(19).getFont3D$B(l.defaultFontId)])]);
return s.toString();
}, p$1);
...
if (isProperty && Float.isNaN$F(m.value) ) continue;
var count=m.count;
...
if (m.colix != 0) sb.append$S(" color ").append$S($I$(9,"escapeColor$I",[$I$(22).getArgb$H(m.colix)]));
if (m.text != null ) {
...
if (isProperty) sb.append$S(" " + m.property + " value " + new Float((Float.isNaN$F(m.value) ? 0.0 : m.value)).toString() ).append$S(" " + $I$(4,"esc$S",[m.getString$()]));
...
if ((colix & -30721) == 2) $I$(10,"setMapBitSet$java_util_Map$I$I$S",[this.temp, i, i, $I$(18,"getColorCommand$S$B$H$Z",["bonds", $I$(24).CPK.id, colix, shape.translucentAllowed])]);
...
if (l.bsColixSet != null  && l.bsColixSet.get$I(i) ) $I$(10,"setMapBitSet$java_util_Map$I$I$S",[this.temp2, i, i, $I$(18).getColorCommand$S$B$H$Z("label", l.paletteIDs[i], l.colixes[i], l.translucentAllowed)]);
...
if (l.bsFontSet != null  && l.bsFontSet.get$I(i) ) $I$(10,"setMapBitSet$java_util_Map$I$I$S",[this.temp2, i, i, $I$(18,"getFontCommand$S$org_jmol_util_Font",["label", $I$(19).getFont3D$B(l.fids[i])])]);
}
...
if (pid != $I$(24).CPK.id || $I$(22).isColixTranslucent$H(atoms[i].colixAtom) ) $I$(10,"setMapBitSet$java_util_Map$I$I$S",[this.temp, i, i, $I$(18).getColorCommand$S$B$H$Z("atoms", pid, atoms[i].colixAtom, shape.translucentAllowed)]);
if (colixes != null  && i < colixes.length ) $I$(10,"setMapBitSet$java_util_Map$I$I$S",[this.temp2, i, i, $I$(18).getColorCommand$S$B$H$Z("balls", pids[i], colixes[i], shape.translucentAllowed)]);
}}
...
if (shape.bsColixSet != null ) for (var i=shape.bsColixSet.nextSetBit$I(0); i >= 0; i=shape.bsColixSet.nextSetBit$I(i + 1)) $I$(10,"setMapBitSet$java_util_Map$I$I$S",[this.temp2, i, i, $I$(18).getColorCommand$S$B$H$Z(type, shape.paletteIDs[i], shape.colixes[i], shape.translucentAllowed)]);
...
var bs;
var sb=Clazz.new_($I$(2,1));
sb.append$S("#" + type + " " + taintedAtom + " " + (Clazz.new_(java.util.Date)) + "\n" );
if (taintedAtom >= 0) {
