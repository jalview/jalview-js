...
var plane=(function(a,f){return f.apply(null,a)})([-m.m20, -m.m21, -m.m22, -m.m23 + (isDepth ? this.depthValue : this.slabValue)],$I$(14).new4$F$F$F$F);
return plane;
}, p$1);
...
var ptRef=(function(a,f){return f.apply(null,a)})([(this.screenWidth/2|0), (this.screenHeight/2|0), this.referencePlaneOffset],$I$(1).new3$F$F$F);
this.unTransformPoint$javajs_util_T3$javajs_util_T3(ptRef, ptRef);
var ptCamera=(function(a,f){return f.apply(null,a)})([(this.screenWidth/2|0), (this.screenHeight/2|0), 0],$I$(1).new3$F$F$F);
...
var pt=(function(a,f){return f.apply(null,a)})([(this.screenWidth/2|0), (this.screenHeight/2|0), this.cameraDistanceFromCenter * this.scalePixelsPerAngstrom],$I$(1).new3$F$F$F);
this.unTransformPoint$javajs_util_T3$javajs_util_T3(pt, pt);
...
}this.vwr.g.setO$S$O("_slabPlane", (function(a,f){return f.apply(null,a)})([p$1.getSlabDepthPlane$Z.apply(this, [false])],$I$(13).eP4$javajs_util_P4));
this.vwr.g.setO$S$O("_depthPlane", (function(a,f){return f.apply(null,a)})([p$1.getSlabDepthPlane$Z.apply(this, [true])],$I$(13).eP4$javajs_util_P4));
