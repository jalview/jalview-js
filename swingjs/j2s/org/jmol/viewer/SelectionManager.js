(function(){var P$=Clazz.newPackage("org.jmol.viewer"),p$1={},I$=[[0,'org.jmol.api.JmolSelectionListener','javajs.util.BS','org.jmol.util.BSUtil','org.jmol.i18n.GT','javajs.util.AU']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
switch (addRemove) {
default:
var bsNotSubset=(this.bsSubset == null  ? null : (function(a,f){return f.apply(null,a)})([$I$(3).copy$javajs_util_BS(this.bsHidden), this.bsSubset],$I$(3).andNot$javajs_util_BS$javajs_util_BS));
...
if (!isQuiet) this.vwr.reportSelection$S((function(a,f){return f.apply(null,a)})([$I$(4).$$S("{0} atoms hidden"), this.bsHidden.cardinality$()],$I$(4).i$S$I));
});

Clazz.newMeth(C$, 'hide$org_jmol_modelset_ModelSet$javajs_util_BS$I$Z', function (modelSet, bs, addRemove, isQuiet) {
var bsNotSubset=(addRemove == 0 || this.bsSubset == null   ? null : (function(a,f){return f.apply(null,a)})([$I$(3).copy$javajs_util_BS(this.bsHidden), this.bsSubset],$I$(3).andNot$javajs_util_BS$javajs_util_BS));
...
if (reportChime) this.vwr.getChimeMessenger$().reportSelection$I(n);
 else if (!isQuiet) this.vwr.reportSelection$S((function(a,f){return f.apply(null,a)})([$I$(4).$$S("{0} atoms selected"), n],$I$(4).i$S$I));
});
