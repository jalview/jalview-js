(function(){var P$=Clazz.newPackage("org.jmol.viewer"),p$1={},I$=[[0,'org.jmol.util.ColorEncoder','org.jmol.c.PAL','javajs.util.AU','org.jmol.viewer.JC','org.jmol.util.Elements','org.jmol.util.C','org.jmol.util.Logger']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.altArgbsCpk=(function(a,f){return f.apply(null,a)})([$I$(4).altArgbsCpk, 0, -1],$I$(3).arrayCopyRangeI$IA$I$I);
}, 1);

Clazz.newMeth(C$, 'setDefaultColors$Z', function (isRasmol) {
if (isRasmol) {
this.isDefaultColorRasmol=true;
this.argbsCpk=(function(a,f){return f.apply(null,a)})([$I$(1).getRasmolScale$(), -1],$I$(3).arrayCopyI$IA$I);
} else {
...
case 2:
index=(function(a,f){return f.apply(null,a)})([atom.getPartialCharge$(), -1, 1, $I$(4).PARTIAL_CHARGE_RANGE_SIZE],$I$(1).quantize4$F$F$F$I);
...
this.argbsCpk=(function(a,f){return f.apply(null,a)})([$I$(2).argbsCpk, 0, -1],$I$(3).arrayCopyRangeI$IA$I$I);
this.altArgbsCpk=(function(a,f){return f.apply(null,a)})([$I$(4).altArgbsCpk, 0, -1],$I$(3).arrayCopyRangeI$IA$I$I);
...
if ($I$(7).debugging) (function(a,f){return f.apply(null,a)})(["ColorManager: color \"" + this.ce.getCurrentColorSchemeName$() + "\" range " + new Float(min).toString() + " " + new Float(max).toString() ],$I$(7).debug$S);
});
...
return (function(a,f){return f.apply(null,a)})([this.ce.getColorSchemeArray$I(iPt)],$I$(1).getColorSchemeList$IA);
});
