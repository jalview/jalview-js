(function(){var P$=Clazz.newPackage("org.jmol.viewer"),I$=[[0,'java.util.Hashtable','javajs.util.V3','org.jmol.util.Elements','javajs.util.PT','org.jmol.util.Logger']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
pt=id.indexOf$S(".");
var n=(pt > 0 ? (function(a,f){return f.apply(null,a)})([id.substring$I(pt + 1)],$I$(4).parseInt$S) : 0);
...
}if (format.indexOf$S("%c") >= 0) for (var i=1, n=id.length$(); i <= n; i++) if (format.indexOf$S("%c" + i) >= 0) format=(function(a,f){return f.apply(null,a)})([format, "%c" + i, id.substring$I$I(i - 1, i).toLowerCase$()],$I$(4).rep$S$S$S);

return (format.indexOf$S("%FILE") >= 0 ? $I$(4).rep$S$S$S(format, "%FILE", id) : format.indexOf$S("%file") >= 0 ? (function(a,f){return f.apply(null,a)})([format, "%file", id.toLowerCase$()],$I$(4).rep$S$S$S) : format + id);
}, 1);
...
return (options != null  && (function(a,f){return f.apply(null,a)})([options.toLowerCase$(), ";/cactvs///;/cactus///;/nci///;/canonical///;"],$I$(4).isOneOf$S$S) );
}, 1);
