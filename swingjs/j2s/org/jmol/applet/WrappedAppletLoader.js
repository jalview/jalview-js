...
var tickerThread;
if ($I$(1).debugging) {
(function(a,f){return f.apply(null,a)})(["WrappedAppletLoader.run(org.jmol.applet.Jmol)"],$I$(1).debug$S);
}
{}
try {
...
if ($I$(1).debugging) (function(a,f){return f.apply(null,a)})(["applet load time = " + loadTimeSeconds + " seconds" ],$I$(1).debug$S);
