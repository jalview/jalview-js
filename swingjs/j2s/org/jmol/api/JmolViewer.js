(function(){var P$=Clazz.newPackage("org.jmol.api"),I$=[[0,'java.util.Hashtable','org.jmol.viewer.Viewer']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return Clazz.new_($I$(2,1).c$$java_util_Map,[info]);
}, 1);
