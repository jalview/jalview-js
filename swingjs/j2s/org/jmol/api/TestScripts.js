...
var performance=Boolean.getBoolean$S("test.performance");
...
var dir=Clazz.new_($I$(1,1).c$$S,[directory]);
...
Clazz.newMeth(C$, 'accept$java_io_File$S', function (dir, name) {
var file=Clazz.new_($I$(1,1).c$$java_io_File$S,[dir, name]);
...
p$1.addDirectory$S$Z$Z.apply(this, [Clazz.new_($I$(1,1).c$$S$S,[directory, dirs[i]]).getAbsolutePath$(), checkOnly, performance]);
}
}}, p$1);

Clazz.newMeth(C$, 'addFile$S$S$Z$Z', function (directory, filename, checkOnly, performance) {
var file=Clazz.new_($I$(1,1).c$$S$S,[directory, filename]);
var test=Clazz.new_($I$(2,1).c$$java_io_File$Z$Z,[file, checkOnly, performance]);
