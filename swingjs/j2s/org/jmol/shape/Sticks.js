(function(){var P$=Clazz.newPackage("org.jmol.shape"),p$1={},I$=[[0,'javajs.util.P3i','org.jmol.util.BSUtil','javajs.util.BS','org.jmol.util.C','org.jmol.c.PAL','org.jmol.util.Edge','org.jmol.util.Escape','javajs.util.P3','java.util.Hashtable']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
