(function(){var P$=Clazz.newPackage("org.jmol.shape"),I$=[[0,'org.jmol.viewer.JC','org.jmol.util.Logger','org.jmol.util.C','org.jmol.c.PAL']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return;
}(function(a,f){return f.apply(null,a)})(["unassigned " + $I$(1).shapeClassBases[this.shapeID] + " + shape setProperty:" + propertyName + ":" + value ],$I$(2).warn$S);
});
...
return (function(a,f){return f.apply(null,a)})([(colixes == null  || i >= colixes.length  ? 0 : colixes[i]), atom.colixAtom],$I$(3).getColixInherited$H$H);
}, 1);
