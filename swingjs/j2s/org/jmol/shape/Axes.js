(function(){var P$=Clazz.newPackage("org.jmol.shape"),I$=[[0,'javajs.util.P3','javajs.util.V3','Boolean','org.jmol.viewer.JC']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
