...
info.put$O$O("haveQuads", Boolean.valueOf$Z(this.haveQuads));
info.put$O$O("haveValues", Boolean.valueOf$Z(this.vvs != null ));
if (isAll) {
if (this.vc > 0) {
info.put$O$O("vertices", $I$(14).arrayCopyPt$javajs_util_T3A$I(this.vs, this.vc));
if (this.bsSlabDisplay != null ) info.put$O$O("bsVertices", this.getVisibleVBS$());
}if (this.vvs != null ) info.put$O$O("vertexValues", $I$(14).arrayCopyF$FA$I(this.vvs, this.vc));
if (this.pc > 0) {
info.put$O$O("polygons", $I$(14).arrayCopyII$IAA$I(this.pis, this.pc));
...
if (this.mat4 == null ) this.mat4=$I$(15).newM4$javajs_util_M4(null);
this.mat4.getRotationScale$javajs_util_M3(m3);
...
}this.mat4=$I$(15).newMV$javajs_util_M3$javajs_util_T3(m3, v);
