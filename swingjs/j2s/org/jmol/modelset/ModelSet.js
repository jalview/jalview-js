...
var aa=$I$(35,"newVA$javajs_util_V3$F",[v, (-angle / 57.29577951308232)]);
...
for (var i=bsAtoms.nextSetBit$I(0); i >= 0; i=bsAtoms.nextSetBit$I(i + 1)) {
var twoD=-$I$(36).distanceToPlaneD$javajs_util_P4$F$javajs_util_P3(plane, d, this.at[i]) * 2;
var x=norm.x * twoD;
var y=norm.y * twoD;
var z=norm.z * twoD;
this.setAtomCoordRelative$I$F$F$F(i, x, y, z);
...
pt=$I$(36).getCenterAndPoints$javajs_util_Lst(vNot)[0];
...
for (var p=0; i >= 0; i=bsAtoms.nextSetBit$I(i + 1)) wts[p++]=$I$(37,"getCellWeight$javajs_util_P3",[this.at[i].getFractionalUnitCoordPt$Z$Z$javajs_util_P3(true, false, pt)]);
