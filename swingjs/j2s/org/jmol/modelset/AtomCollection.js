...
return (function(a,f){return f.apply(null,a)})([this.at[i].getAtomicAndIsotopeNumber$()],$I$(5).elementNameFromNumber$I);
});
...
return (function(a,f){return f.apply(null,a)})([atom.getElementNumber$(), $I$(6).JMOL],$I$(5).getVanderwaalsMar$I$org_jmol_c_VDW) / 1000.0;
});
...
if (d < 0  && $I$(10).debugging ) (function(a,f){return f.apply(null,a)})(["draw d" + j + " " + $I$(11).eP$javajs_util_T3(points[j]) + " \"" + new Float(d).toString() + " ? " + atom.getInfo$() + "\"" ],$I$(10).debug$S);
...
break;
default:
(function(a,f){return f.apply(null,a)})(["unsettable atom property: " + $I$(13).nameOf$I(tok)],$I$(10).error$S);
return;
}
}
switch (tok) {
...
var n=0;
try {
var nData=(function(a,f){return f.apply(null,a)})([dataString.substring$I$I(0, lines[0] - 1)],$I$(17).parseInt$S);
for (var i=1; i <= nData; i++) {
var tokens=(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([dataString.substring$I$I(lines[i], lines[i + 1] - 1)],$I$(17).parseTrimmed$S)],$I$(17).getTokens$S);
...
try {
var nData=(function(a,f){return f.apply(null,a)})([data.substring$I$I(0, lines[0] - 1)],$I$(17).parseInt$S);
for (var i=1; i <= nData; i++) {
var tokens=(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([data.substring$I$I(lines[i], lines[i + 1])],$I$(17).parseTrimmed$S)],$I$(17).getTokens$S);
var atomIndex=$I$(17).parseInt$S(tokens[0]) - 1;
...
if (pt != 3) {
x.normalize$();
Clazz.new_($I$(19,1)).setAA$javajs_util_A4((function(a,f){return f.apply(null,a)})([z.x, z.y, z.z, (pt == 2 ? 1 : -1) * 2.0943952],$I$(20).new4$F$F$F$F)).rotate$javajs_util_T3(x);
...
if (doSort) (function(a,f){return f.apply(null,a)})([attached, Clazz.new_($I$(24,1),[this, null])],$I$(23).sort$OA$java_util_Comparator);
}return attached;
}, p$1);
...
return bs;
case 1073742357:
return (function(a,f){return f.apply(null,a)})([this.getChainBits$I(iSpec)],$I$(9).copy$javajs_util_BS);
case 1073742360:
...
return bs;
case 1073742362:
return (function(a,f){return f.apply(null,a)})([this.getSeqcodeBits$I$Z(iSpec, true)],$I$(9).copy$javajs_util_BS);
case 5:
...
(function(a,f){return f.apply(null,a)})(["MISSING getAtomBits entry for " + $I$(13).nameOf$I(tokType)],$I$(10).error$S);
return bs;
});
...
return (function(a,f){return f.apply(null,a)})([atom.getAtomName$().toUpperCase$(), strPattern, checkStar, allowInitialStar],$I$(17).isMatch$S$S$Z$Z);
}, p$1);
