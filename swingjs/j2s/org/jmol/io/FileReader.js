(function(){var P$=Clazz.newPackage("org.jmol.io"),I$=[[0,'javajs.util.AU','java.io.BufferedReader','org.jmol.util.Logger','javajs.util.PT','org.jmol.api.Interface','javajs.util.Rdr']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return (function(a,f){return f.apply(null,a)})([vwr.getLigandModel$S$S$S$S(nameAsGivenIn, fullPathNameIn, "_file", null)],$I$(6).getBR$S);
}, 1);
