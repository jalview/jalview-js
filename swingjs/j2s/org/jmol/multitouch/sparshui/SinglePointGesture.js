(function(){var P$=Clazz.newPackage("org.jmol.multitouch.sparshui"),p$1={},I$=[[0,'java.util.ArrayList','org.jmol.util.Logger','com.sparshui.common.messages.events.TouchEvent','com.sparshui.server.TouchPoint']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if ($I$(2).debugging) (function(a,f){return f.apply(null,a)})(["\nSinglePointGesture id=" + id + " state=" + changedTouchPoint.getState$() + " ncurrent=" + this._nCurrent + " nMoves=" + this._nMoves ],$I$(2).debug$S);
