(function(){var P$=Clazz.newPackage("org.jmol.multitouch"),p$1={},I$=[[0,'com.sparshui.GestureType','org.jmol.api.Interface','org.jmol.util.Logger','javajs.util.Lst','org.jmol.viewer.binding.Binding']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
(function(a,f){return f.apply(null,a)})(["ActionManagerMT SparshUI groupID=" + this.groupID],$I$(3).info$S);
(function(a,f){return f.apply(null,a)})(["ActionManagerMT adapter = " + this.adapter],$I$(3).info$S);
if (isSparsh) {
...
if ($I$(3).debugging) (function(a,f){return f.apply(null,a)})([this + " time=" + time + " groupID=" + groupID + " " + Integer.toHexString$I(groupID) + " eventType=" + eventType + "(" + C$.getEventName$I(eventType) + ") iData=" + iData + " pt=" + pt ],$I$(3).debug$S);
switch (eventType) {
case 0:
if (iData == 2) {
