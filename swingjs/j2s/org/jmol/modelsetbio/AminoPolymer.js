(function(){var P$=Clazz.newPackage("org.jmol.modelsetbio"),p$1={},I$=[[0,'javajs.util.Measure','javajs.util.P3','javajs.util.V3','org.jmol.modelset.HBond','org.jmol.util.Logger','org.jmol.c.STR']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
structureTags[i]="n";
}if ($I$(5).debugging) (function(a,f){return f.apply(null,a)})([(0 + this.monomers[0].chain.chainID) + " aminopolymer:" + i + " " + new Float(trailingResidue.getGroupParameter$I(1111490569)).toString() + "," + new Float(leadingResidue.getGroupParameter$I(1111490570)).toString() + " " + structureTags[i] ],$I$(5).debug$S);
}
