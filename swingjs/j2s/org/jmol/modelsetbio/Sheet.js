(function(){var P$=Clazz.newPackage("org.jmol.modelsetbio"),p$1={},I$=[[0,'org.jmol.c.STR','javajs.util.P3','javajs.util.V3','javajs.util.Measure']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "Sheet", null, 'org.jmol.modelsetbio.ProteinStructure');
...
C$.$fields$=[['O',['widthUnitVector','javajs.util.V3','+heightUnitVector']]]
...
var vectorCO=Clazz.new_($I$(3,1));
var vectorCOSum=Clazz.new_($I$(3,1));
