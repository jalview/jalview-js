...
tokenOut.value=Clazz.new_($I$(13,1).c$$BA,[b]);
break;
}
return tokenOut;
}, 1);
...
switch (args[1].tok) {
case 15:
bytes=$I$(3,"arrayCopyByte$BA$I",[(args[1].value).data, -1]);
break;
case 7:
...
return (pt == 22 ? C$.getVariable$O(bytes) : pt == 12 ? Clazz.new_($I$(13,1).c$$BA,[bytes]) : ";base64," + $I$(14).getBase64$BA(bytes).toString());
}
}
...
default:
return (allowNull ? null : Clazz.new_($I$(15,1)));
}
}, 1);
...
if (bs2 == null ) return (allowNull ? null : Clazz.new_($I$(15,1)));
...
$I$(16,"sort$java_util_List$java_util_Comparator",[this.getList$(), Clazz.new_($I$(17,1).c$$I$S,[this, null, --arrayPt, null])]);
}}return this;
});
...
Clazz.newMeth(C$, 'getArrayDepth$org_jmol_script_T', function (x) {
var n=0;
var sv;
...
Clazz.newMeth(C$, 'fflistValue$org_jmol_script_T$I', function (x, nMin) {
if (x.tok != 7) {
return Clazz.array(Float.TYPE, -2, [Clazz.array(Float.TYPE, -1, [C$.fValue$org_jmol_script_T(x)])]);
}var sv=(x).getList$();
var svlen=sv.size$();
var list;
list=$I$(3).newFloat2$I(svlen);
if (nMin == 0) nMin=list.length;
for (var i=list.length; --i >= 0; ) list[i]=C$.flistValue$org_jmol_script_T$I(i >= svlen ? null : sv.get$I(i), 0);

return list;
}, 1);

Clazz.newMeth(C$, 'flistValue$org_jmol_script_T$I', function (x, nMin) {
if (x == null  || x.tok != 7 ) return Clazz.array(Float.TYPE, -1, [C$.fValue$org_jmol_script_T(x)]);
var sv=(x).getList$();
var list;
...
var lst=this.getList$();
if (lst != null ) {
$I$(16,"sort$java_util_List$java_util_Comparator",[this.getList$(), Clazz.new_($I$(17,1).c$$I$S,[this, null, 0, key])]);
}return this;
});
