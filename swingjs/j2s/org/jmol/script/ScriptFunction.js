(function(){var P$=Clazz.newPackage("org.jmol.script"),p$1={},I$=[[0,'javajs.util.Lst','java.util.Hashtable','org.jmol.script.T','org.jmol.script.SV','javajs.util.AU','javajs.util.SB']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (this.tok != 364558) {
contextVariables.put$O$O("_argcount", $I$(4,"newI$I",[params == null  ? 0 : params.size$()]));
contextVariables.put$O$O("_arguments", (params == null  ? $I$(4,"getVariableAI$IA",[Clazz.array(Integer.TYPE, -1, [])]) : $I$(4).getVariableList$javajs_util_Lst(params)));
}contextVariables.put$O$O("_retval", $I$(4,"newI$I",[this.tok == 364558 ? 2147483647 : 0]));
});
