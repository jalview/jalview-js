...
sb.append$S((function(a,f){return f.apply(null,a)})([sc.functionName, sc.scriptFileName, sc.lineNumbers[pc], pc, C$.statementAsString$org_jmol_viewer_Viewer$org_jmol_script_TA$I$Z(vwr, sc.statement, (isTop ? sc.iToken : 9999), false)],$I$(5).getErrorLineMessage$S$S$I$I$S));
...
return (this.pc < this.aatoken.length ? (function(a,f){return f.apply(null,a)})([this.functionName, this.scriptFileName, this.getLinenumber$org_jmol_script_ScriptContext(null), this.pc, C$.statementAsString$org_jmol_viewer_Viewer$org_jmol_script_TA$I$Z(this.vwr, this.aatoken[this.pc], -9999, this.debugHigh)],$I$(5).getErrorLineMessage$S$S$I$I$S) : "");
});
...
(function(a,f){return f.apply(null,a)})(["darn problem in Eval getCommand: ichBegin=" + ichBegin + " ichEnd=" + ichEnd + " len = " + this.script.length$() + "\n" + e ],$I$(6).error$S);
} else {
throw e;
}
}
...
this.iToken=-9999;
if (this.debugHigh) {
if (st.length > 0) (function(a,f){return f.apply(null,a)})([st[0].toString()],$I$(6).debug$S);
for (var i=1; i < st.length; ++i) if (st[i] != null ) (function(a,f){return f.apply(null,a)})([st[i].toString()],$I$(6).debug$S);
...
scr=(function(a,f){return f.apply(null,a)})([scr, "\n\r", "),("],$I$(7).replaceAllCharacters$S$S$S);
scr=(function(a,f){return f.apply(null,a)})([scr, "()", "(none)"],$I$(7).rep$S$S$S);
...
if (pt < 0) return 0;
pt=(function(a,f){return f.apply(null,a)})([extensions.substring$I(pt + 15)],$I$(7).parseInt$S);
...
var f=func;
return (function(a,f){return f.apply(null,a)})([p$1.runFunctionAndRet$org_jmol_api_JmolScriptFunction$S$javajs_util_Lst$org_jmol_script_SV$Z$Z$Z.apply(this, [f, f.name, p, null, true, false, false])],$I$(8).fValue$org_jmol_script_T);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return NaN;
} else {
...
this.vwr.definedAtomSets.put$O$O(script, $I$(15).TRUE);
return;
...
if (bs != null ) return $I$(16).copy$javajs_util_BS(bs);
...
$I$(16).deleteBits$javajs_util_BS$javajs_util_BS(value, bsDeleted);
...
}if (this.debugHigh || this.isCmdLine_c_or_C_Option ) (function(a,f){return f.apply(null,a)})(["-->>----------------------".substring$I$I(0, Math.min(15, this.scriptLevel + 5)) + this.scriptLevel + " " + this.scriptFileName + " " + token + " " + this.thisContext.id + " " + why + " path=" + this.thisContext.contextPath ],$I$(6).info$S);
}, p$1);

Clazz.newMeth(C$, 'getScriptContext$S', function (why) {
var context=Clazz.new_($I$(17,1));
if (this.debugHigh) (function(a,f){return f.apply(null,a)})(["creating context " + context.id + " for " + why + " path=" + this.contextPath ],$I$(6).info$S);
...
if (this.debugHigh || this.isCmdLine_c_or_C_Option ) (function(a,f){return f.apply(null,a)})(["--<<------------".substring$I$I(0, Math.min(15, this.scriptLevel + 5)) + (this.scriptLevel + 1) + " " + this.scriptFileName + " isFlow " + isFlowCommand + " thisContext=" + (this.thisContext == null  ? "" : "" + this.thisContext.id) + " pc=" + this.pc + "-->" + this.pc + " path=" + (this.thisContext == null  ? "" : this.thisContext.contextPath) ],$I$(6).info$S);
});
...
if (this.debugHigh || this.isCmdLine_c_or_C_Option ) (function(a,f){return f.apply(null,a)})(["--r------------".substring$I$I(0, Math.min(15, this.scriptLevel + 5)) + this.scriptLevel + " " + this.scriptFileName + " isPop " + isPopContext + " isFlow " + isFlowCommand + " context.id=" + context.id + " pc=" + this.pc + "-->" + context.pc + " " + this.contextPath ],$I$(6).info$S);
} else {
...
(function(a,f){return f.apply(null,a)})(["eval ERROR: " + s + this.toString() ],$I$(6).error$S);
...
continue;
case 6:
if ($I$(15).TRUE === (token.value).get$O("$_BINARY_$") ) {
...
if (token.intValue != 2147483647) sb.appendI$I(token.intValue);
 else sb.append$S((function(a,f){return f.apply(null,a)})([$I$(19).getSeqCode$org_jmol_script_T(token)],$I$(18).getSeqcodeStringFor$I));
token=statement[++i];
sb.appendC$C(" ");
sb.append$S(inBrace ? "-" : "- ");
case 1073742362:
...
sb.append$S($I$(20).escapeModelFileNumber$I(token.intValue));
} else {
...
sb.append$S($I$(18).standardGroupList.substring$I$I(ptr, ptr + 3).trim$());
sb.appendC$C("]");
continue;
case 1073742360:
sb.appendC$C("[");
...
var pt=token.value;
sb.append$S("cell=").append$S($I$(20).eP$javajs_util_T3(pt));
continue;
}break;
case 4:
...
(function(a,f){return f.apply(null,a)})(["script execution paused at command " + (this.pc + 1) + " level " + this.scriptLevel + ": " + this.thisCommand ],$I$(6).debug$S);
...
}this.scriptDelayThread=Clazz.new_($I$(21,1).c$$org_jmol_api_JmolScriptEvaluator$org_jmol_viewer_Viewer$I,[this, this.vwr, millis]);
this.scriptDelayThread.run$();
});

Clazz.newMeth(C$, 'doDelay$I', function (millis) {
if (!this.useThreads$()) return;
if (this.isJS) throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "delay", millis]);
...
this.fileLoadThread=Clazz.new_($I$(23,1).c$$org_jmol_api_JmolScriptEvaluator$org_jmol_viewer_Viewer$S$S$S,[this, this.vwr, filename, key, cacheName]);
if (this.vwr.testAsync) this.fileLoadThread.start$();
 else this.fileLoadThread.run$();
if (i < 0) this.fileLoadThread=null;
throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "load", 1]);
});
...
return (function(a,f){return f.apply(null,a)})([this.functionName, this.scriptFileName, this.getLinenumber$org_jmol_script_ScriptContext(null), this.pc, C$.statementAsString$org_jmol_viewer_Viewer$org_jmol_script_TA$I$Z(this.vwr, this.st, -9999, this.debugHigh)],$I$(5).getErrorLineMessage$S$S$I$I$S);
});
...
}if (this.debugScript && !this.chk ) (function(a,f){return f.apply(null,a)})(["Command " + this.pc + (this.thisContext == null  ? "" : " path=" + this.thisContext.contextPath) ],$I$(6).info$S);
...
(function(a,f){return f.apply(null,a)})([p$1.getCommand$I$Z$Z.apply(this, [this.pc, true, false]) + " -- STATEMENT CONTAINING @{} SKIPPED"],$I$(6).info$S);
continue;
...
if (this.debugHigh && this.theToken != null  ) (function(a,f){return f.apply(null,a)})([this.theToken.toString()],$I$(6).debug$S);
...
if (this.parallelProcessor != null ) vProcess=Clazz.new_($I$(24,1));
continue;
default:
...
case 266256:
if (this.chk) return;
if (this.outputBuffer != null ) (function(a,f){return f.apply(null,a)})([this.outputBuffer.toString()],$I$(6).warn$S);
this.vwr.exitJmol$();
break;
case 1228935687:
...
var animationMode=(function(a,f){return f.apply(null,a)})([this.paramAsStr$I(2)],$I$(9).getTokFromName$S);
...
return;
}o=(file.startsWith$S(";base64,") ? Clazz.new_([$I$(27).decodeBase64$S(file)],$I$(26,1).c$$BA) : file);
}
if (this.vwr.fm.loadImage$O$S$Z(o, null, !this.useThreads$())) throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "backgroundImage", 1]);
return;
...
case 2:
case 3:
if ((order=(function(a,f){return f.apply(null,a)})([this.floatParameter$I(1)],$I$(28).getBondOrderFromFloat$F)) == 131071) this.invArg$();
break;
default:
if ((order=(function(a,f){return f.apply(null,a)})([this.paramAsStr$I(1)],$I$(29).getBondOrderFromString$S)) == 131071) this.invArg$();
if (order == 33 && this.tokAt$I(2) == 3 ) {
order=$I$(29).getPartialBondOrderFromFloatEncodedInt$I(this.st[2].intValue);
}}
...
strColor=strColor += "=" + (function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([this.stringParameterSet$I(i)],$I$(8).getVariableAS$SA)],$I$(8).sValue$org_jmol_script_T).replace$C$C("\n", " ");
i=this.iToken + 1;
...
this.checkLast$I(this.iToken);
if (str.equalsIgnoreCase$S("axes") || $I$(30).getObjectIdFromName$S(str) >= 0 ) {
...
if (this.doReport$()) this.report$S$Z((function(a,f){return f.apply(null,a)})([$I$(31).$$S("show saved: {0}"), this.vwr.stm.listSavedStates$()],$I$(31).o$S$O), false);
return;
}this.setObjectProperty$();
return;
...
if (this.doReport$()) this.report$S$Z((function(a,f){return f.apply(null,a)})([$I$(31).$$S("{0} atoms deleted"), nDeleted],$I$(31).i$S$I), false);
}, p$1);
...
break;
default:
if (this.slen == 4 && this.tokAt$I(2) == 1677721602 ) bs=(function(a,f){return f.apply(null,a)})([$I$(16).newBitSet2$I$I(0, this.vwr.ms.bondCount), null],$I$(32).newBS$javajs_util_BS$IA);
...
var rd=(Float.isNaN$F(value) ? this.encodeRadiusParameter$I$Z$Z(ipt, false, true) : Clazz.new_([null, value, type, $I$(35).AUTO],$I$(34,1).c$$FA$F$org_jmol_atomdata_RadiusData_EnumType$org_jmol_c_VDW));
if (rd == null ) return;
...
}if (doRefresh && this.vwr.getRefreshing$() ) this.showString$S($I$(36).formatText$org_jmol_api_JmolViewer$S(this.vwr, text));
}, p$1);
...
if (this.isBondSet) bsOrList=$I$(32).newBS$javajs_util_BS$IA(bsOrList, null);
...
var i12=Clazz.array(Integer.TYPE, -1, [(function(a,f){return f.apply(null,a)})([v.get$I(0)],$I$(8).iValue$org_jmol_script_T), (function(a,f){return f.apply(null,a)})([v.get$I(j - 1)],$I$(8).iValue$org_jmol_script_T)]);
...
forVar.tok=10;
if (this.isBondSet) {
forVar.value=Clazz.new_($I$(32,1));
(forVar.value).set$I(j);
} else {
forVar.value=$I$(16).newAndSetBit$I(j);
}}pt++;
if (!isOK) {
...
if ($I$(38).getFontStyleID$S(fontface) >= 0) {
fontstyle=fontface;
fontface="SansSerif";
...
this.report$S$Z((function(a,f){return f.apply(null,a)})([$I$(31).$$S("{0} hydrogen bonds"), Math.abs(n)],$I$(31).i$S$I), false);
return;
...
return;
}if ((function(a,f){return f.apply(null,a)})([$I$(9).getTokFromName$S(what), 4096],$I$(9).tokAttr$I$I)) what="?command=" + what;
...
case 12294:
case 1610625028:
this.setShapeProperty$I$S$O(5, "display", this.theTok == 1610625028 ? $I$(15).TRUE : $I$(15).FALSE);
return;
case 7:
...
htParams.put$O$O("isStateScript", $I$(15).TRUE);
if (this.forceNoAddHydrogens) htParams.put$O$O("doNotAddHydrogens", $I$(15).TRUE);
}var modelName=null;
var filenames=null;
...
htParams.put$O$O("sync", $I$(15).TRUE);
...
tokType=(tok == 1073741824 && (function(a,f){return f.apply(null,a)})([modelName.toLowerCase$(), ";xyz;vxyz;vibration;temperature;occupancy;partialcharge;"],$I$(7).isOneOf$S$S)  ? $I$(9).getTokFromName$S(modelName) : 0);
if (tokType != 0) {
htParams.put$O$O("atomDataOnly", $I$(15).TRUE);
...
case 1073741849:
isAsync=true;
htParams.put$O$O("async", $I$(15).TRUE);
i++;
break;
case 536870926:
case 1094717454:
i++;
loadScript.append$S(" " + modelName);
if (tok == 536870926) htParams.put$O$O("isTrajectory", $I$(15).TRUE);
...
loadScript.append$S(" " + $I$(20).eP$javajs_util_T3(pt));
} else {
switch (this.tokAt$I(i)) {
case 10:
bsModels=this.getToken$I(i++).value;
htParams.put$O$O("bsModels", bsModels);
loadScript.append$S(" " + $I$(20).eBS$javajs_util_BS(bsModels));
break;
default:
...
filenames=$I$(20).unescapeStringArray$S(filename);
if (filenames != null ) {
...
if (isMutate) htParams.put$O$O("isMutate", $I$(15).TRUE);
...
(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([$I$(31).$$S("file {0} created"), localName],$I$(31).o$S$O)],$I$(6).info$S);
...
throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "async", 1]);
...
if ((this.vwr.testAsync || $I$(39).isJS ) && (isAsync || filename.startsWith$S("?") )  || this.vwr.apiPlatform.forceAsyncLoad$S(filename) ) {
...
strModel=(function(a,f){return f.apply(null,a)})([strModel, this.vwr.getInlineChar$()],$I$(39).fixInlineString$S$C);
htParams.put$O$O("fileData", strModel);
htParams.put$O$O("isData", $I$(15).TRUE);
...
firstLastSteps=Clazz.new_($I$(24,1));
pt=$I$(25).new3$F$F$F(0, -1, 1);
}if (this.isPoint3f$I(++i)) {
...
loadScript.append$S(" COORD " + $I$(20).eP$javajs_util_T3(pt));
} else if (bs != null ) {
firstLastSteps.addLast$O(bs);
loadScript.append$S(" COORD " + $I$(20).eBS$javajs_util_BS(bs));
...
htParams.put$O$O("useFileModelNumbers", $I$(15).TRUE);
...
sOptions.append$S(" " + $I$(20).eAI$IA(iArray));
...
if ($I$(40).isAI$O(centroid) && this.vwr.ms.ac > 0 ) {
var bs=$I$(16).newBitSet2$I$I(isAppend ? ac0 : 0, this.vwr.ms.ac);
...
if (this.chk) return;
var s=$I$(36).formatText$org_jmol_api_JmolViewer$S(this.vwr, text);
...
var iFrame=(this.theTok == 4 ? $I$(29).getFloatEncodedInt$S(this.theToken.value) : this.theToken.intValue);
...
var dRot=(function(a,f){return f.apply(null,a)})([this.floatParameter$I(1), this.floatParameter$I(2), this.floatParameter$I(3)],$I$(41).new3$F$F$F);
var dZoom=this.floatParameter$I(4);
var dTrans=(function(a,f){return f.apply(null,a)})([this.intParameter$I(5), this.intParameter$I(6), this.intParameter$I(7)],$I$(41).new3$F$F$F);
...
if (floatSecondsTotal > 0  && this.isJS ) throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "move", 1]);
}, p$1);
...
if (this.isJS && floatSecondsTotal > 0   && this.vwr.g.waitForMoveTo ) throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "moveTo", 1]);
return;
}var axis=$I$(41).new3$F$F$F(NaN, 0, 0);
var center=null;
var i=1;
...
bsCenter=ret[0];
q=(this.chk ? Clazz.new_($I$(42,1)) : this.vwr.ms.getQuaternion$I$C(bsCenter.nextSetBit$I(0), this.vwr.getQuaternionFrame$()));
} else {
...
case 0:
q=$I$(42).new4$F$F$F$F(0.5, 0.5, 0.5, -0.5);
break;
case 1:
q=$I$(42).new4$F$F$F$F(0.5, 0.5, 0.5, 0.5);
break;
case 2:
q=$I$(42).new4$F$F$F$F(0, 0, 0, 1);
break;
default:
var uc;
...
break;
default:
axis=(function(a,f){return f.apply(null,a)})([this.floatParameter$I(i++), this.floatParameter$I(i++), this.floatParameter$I(i++)],$I$(41).new3$F$F$F);
degrees=this.floatParameter$I(i++);
}
if (q != null ) {
var aa;
...
}if (this.vwr.autoExit || !this.vwr.haveDisplay && !$I$(39).isWebGL  ) return false;
if (this.scriptLevel == 0 && this.pc == this.aatoken.length - 1 ) {
this.vwr.scriptStatus$S("nothing to pause: " + msg);
return false;
}msg=(msg.length$() == 0 ? ": RESUME to continue." : ": " + $I$(36).formatText$org_jmol_api_JmolViewer$S(this.vwr, msg));
...
var ptsA=null;
var points=Clazz.array($I$(25), [2]);
var rotAxis=$I$(41).new3$F$F$F(0, 1, 0);
...
n=lst.size$();
if (n < 3) return;
pts=Clazz.array($I$(25), [3]);
for (var j=0; j < 3; j++) pts[j]=this.vwr.ms.getAtomSetCenter$javajs_util_BS((function(a,f){return f.apply(null,a)})([lst.get$I(n - 3 + j), false],$I$(8).getBitSet$org_jmol_script_SV$Z));
...
if (n < 3) return;
q=$I$(42).getQuaternionFrame$javajs_util_P3$javajs_util_T3$javajs_util_T3(pts[n - 3], pts[n - 2], pts[n - 1]);
q=$I$(42).new4$F$F$F$F(1, 0, 0, 0).mulQ$javajs_util_Quat(q.inv$().div$javajs_util_Quat(this.vwr.tm.getRotationQ$()));
rotAxis.setT$javajs_util_T3(q.getNormal$());
endDegrees=q.getTheta$();
break;
case 134217731:
...
endDegrees=p4.w;
q=$I$(42).newVA$javajs_util_T3$F(rotAxis, endDegrees);
break;
case 1073742328:
isSelected=true;
isMolecular=true;
...
case 4160:
translation=(function(a,f){return f.apply(null,a)})([this.centerParameter$I$OA(++i, null)],$I$(41).newV$javajs_util_T3);
...
rotAxis.normalize$();
(function(a,f){return f.apply(null,a)})([points[0], rotAxis, invPlane=Clazz.new_($I$(44,1))],$I$(43).getPlaneThroughPoint$javajs_util_T3$javajs_util_V3$javajs_util_P4);
}q=$I$(42).newVA$javajs_util_T3$F(rotAxis, endDegrees);
...
this.iToken=i;
this.invArg$();
}m4=Clazz.new_($I$(45,1));
points[0]=Clazz.new_($I$(25,1));
nPoints=1;
$I$(46).getInterface$S$org_jmol_viewer_Viewer$S("javajs.util.Eigen", this.vwr, "script");
var stddev=(this.chk ? 0 : $I$(43).getTransformMatrix4$javajs_util_Lst$javajs_util_Lst$javajs_util_M4$javajs_util_P3(ptsA, ptsB, m4, points[0]));
if (stddev > 0.001 ) ptsB=null;
case 12:
case 11:
haveRotation=true;
m3=Clazz.new_($I$(47,1));
if (tok == 12) {
is4x4=true;
m4=this.theToken.value;
}if (m4 != null ) {
translation=Clazz.new_($I$(41,1));
m4.getTranslation$javajs_util_T3(translation);
m4.getRotationScale$javajs_util_M3(m3);
} else {
m3=this.theToken.value;
}q=(this.chk ? Clazz.new_($I$(42,1)) : $I$(42).newM$javajs_util_M3(m3));
rotAxis.setT$javajs_util_T3(q.getNormal$());
endDegrees=q.getTheta$();
isMolecular=true;
break;
...
points[1]=$I$(25).newP$javajs_util_T3(points[0]);
points[1].add$javajs_util_T3(translation);
var ret=$I$(43).computeHelicalAxis$javajs_util_P3$javajs_util_P3$javajs_util_Quat(points[0], points[1], q);
points[0]=ret[0];
var theta=(ret[3]).x;
if (theta != 0 ) {
translation=ret[1];
rotAxis=$I$(41).newV$javajs_util_T3(translation);
if (theta < 0 ) rotAxis.scale$F(-1);
}m4=null;
}if (isSpin && m4 == null  ) m4=(function(a,f){return f.apply(null,a)})([q.getMatrix$(), translation],$I$(48).getMatrix4f$javajs_util_M3$javajs_util_T3);
...
if (this.isJS && isSpin && bsAtoms == null    && this.vwr.g.waitForMoveTo  && endDegrees != 3.4028235E38  ) throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "rotate", 1]);
}return;
}if (nPoints == 0) points[0]=Clazz.new_($I$(25,1));
points[1]=$I$(25).newP$javajs_util_T3(points[0]);
...
ptsB=$I$(43).transformPoints$javajs_util_Lst$javajs_util_M4$javajs_util_P3(ptsA, m4, points[0]);
...
if (this.isJS && floatSecondsTotal > 0   && this.vwr.g.waitForMoveTo ) throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "restore" + type, 1]);
return;
}
this.checkLength23$();
switch (tok) {
...
this.contextVariables.put$O$O("_arguments", (params == null  ? (function(a,f){return f.apply(null,a)})([Clazz.array(Integer.TYPE, -1, [])],$I$(8).getVariableAI$IA) : $I$(8).getVariableList$javajs_util_Lst(params)));
this.contextVariables.put$O$O("_argcount", (function(a,f){return f.apply(null,a)})([params == null  ? 0 : params.size$()],$I$(8).newI$I));
...
(function(a,f){return f.apply(null,a)})([$I$(31).$$S("script ERROR: ") + this.errorMessage],$I$(6).error$S);
this.popContext$Z$Z(false, false);
if (wasScriptCheck) {
this.setErrorMessage$S(null);
} else {
...
this.vwr.slm.noneSelected=(function(a,f){return f.apply(null,a)})([this.slen == 4 && tok == 1073742333 ],$I$(15).valueOf$Z);
var bs=null;
switch (tok) {
case 10:
...
if (this.vwr.fm.loadImage$O$S$Z(o, "\u0000windowImage", !this.useThreads$())) throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "windowImage", 1]);
} else {
this.vwr.setWindowDimensions$FA(o);
}return;
case 1639976963:
var type=(function(a,f){return f.apply(null,a)})([this.paramAsStr$I(2)],$I$(49).getProteinStructureType$S);
if (type === $I$(49).NOT ) this.invArg$();
...
this.checkLength$I(this.iToken + 1);
}if (!this.chk) this.vwr.tm.zSlabPoint=(pt == null  ? null : $I$(25).newP$javajs_util_T3(pt));
return;
}
var justShow=true;
switch (tok) {
...
modelNumber=$I$(29).getFloatEncodedInt$S(modelDotted);
}if (this.chk) return;
...
if (this.slen == 3 && $I$(35).getVdwType$S(sval) == null   && (function(a,f){return f.apply(null,a)})([sval=p$1.getSettingStr$I$Z.apply(this, [2, false])],$I$(35).getVdwType$S) == null  ) this.invArg$();
...
pt=Clazz.new_($I$(25,1));
var ijk=$var.asInt$();
if (ijk >= 100) $I$(50).ijkToPoint3f$I$javajs_util_P3$I$I(ijk, pt, -1, 0);
...
key=(function(a,f){return f.apply(null,a)})([tok=newTok],$I$(9).nameOf$I);
} else if (!justShow && !isContextVariable ) {
if (key.length$() == 0 || key.charAt$I(0) == "_" && this.tokAt$I(2) != 268435520  ) this.error$I(56);
var lckey=key.toLowerCase$();
if (lckey.indexOf$S("label") == 0 && (function(a,f){return f.apply(null,a)})([lckey.substring$I(5), ";front;group;atom;offset;offsetexact;offsetabsolute;pointer;alignment;toggle;scalereference;for;"],$I$(7).isOneOf$S$S) ) {
...
case 1073742335:
propertyName="hidden";
propertyValue=$I$(15).FALSE;
break;
case 12294:
case 2097194:
propertyName="hidden";
propertyValue=$I$(15).TRUE;
break;
case 1094717454:
...
id=data[0];
}if (!this.chk && this.vwr.ms.getEchoStateActive$() && this.vwr.fm.loadImage$O$S$Z(this.getToken$I(pt).value, id, !this.useThreads$())  ) throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "setEchoImage", 1]);
return;
...
if (!TF) str="front";
propertyValue=(TF ? $I$(15).TRUE : $I$(15).FALSE);
break;
}if (str.equals$O("atom")) {
if (!TF && this.tokAt$I(2) != 1073742334 ) this.invArg$();
str="front";
propertyValue=(TF ? $I$(15).FALSE : $I$(15).TRUE);
break;
}return false;
}
...
mode=(function(a,f){return f.apply(null,a)})([str.substring$I$I(0, mode)],$I$(51).getPickingMode$S);
...
if ($I$(51).getPickingStyleIndex$S(str) < 0) this.errorStr2$I$S$S(50, "SET PICKINGSTYLE " + type, str);
...
var type=(function(a,f){return f.apply(null,a)})([this.paramAsStr$I(1)],$I$(49).getProteinStructureType$S);
if (type === $I$(49).NOT ) this.invArg$();
var bs=null;
switch (this.tokAt$I(2)) {
case 12290:
...
var text="";
var applet="";
var port=(function(a,f){return f.apply(null,a)})([this.optParameterAsString$I(1)],$I$(7).parseInt$S);
if (port == -2147483648) {
this.checkLength$I(-3);
port=0;
switch (this.slen) {
...
var v=(pt == 1 ? this.setVariable$I$I$S$Z(1, this.slen, "thrown_value", false) : this.vwr.g.setUserVariable$S$org_jmol_script_SV("thrown_value", (function(a,f){return f.apply(null,a)})([this.optParameterAsString$I(2)],$I$(8).newS$S)));
var info=v.asString$();
if (info.length$() == 0 && (info=this.optParameterAsString$I(1)).length$() == 0 ) info="context";
if (pt == 2) {
p$1.saveContext$S.apply(this, [info]);
if (this.doReport$()) this.report$S$Z((function(a,f){return f.apply(null,a)})([$I$(31).$$S("to resume, enter: &{0}"), info],$I$(31).o$S$O), false);
throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, info, -2147483648]);
...
if (name == null  && mouseAction != null   && $I$(51).getActionFromName$S(mouseAction) >= 0 ) {
name=mouseAction;
mouseAction=null;
...
var sym=$I$(46).getSymmetry$org_jmol_viewer_Viewer$S(this.vwr, "eval");
...
p$1.setShapeSize$I$org_jmol_atomdata_RadiusData.apply(this, [18, Clazz.new_($I$(34,1).c$$FA$F$org_jmol_atomdata_RadiusData_EnumType$org_jmol_c_VDW,[null, value, type, null])]);
}, p$1);
...
if (!isQuiet) this.report$S$Z((function(a,f){return f.apply(null,a)})([$I$(31).$$S("{0} atoms deleted"), nDeleted],$I$(31).i$S$I), false);
...
if (this.isJS && floatSecondsTotal > 0   && this.vwr.g.waitForMoveTo ) throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "zoomTo", 1]);
}, p$1);
...
var pal=(isColorIndex || isIsosurface  ? $I$(52).PROPERTY : tok == 1112152075 ? $I$(52).CPK : $I$(52).getPalette$S(name));
if (pal === $I$(52).UNKNOWN  || (pal === $I$(52).TYPE  || pal === $I$(52).ENERGY  ) && shapeType != 2  ) this.invArg$();
var data=null;
var bsSelected=(pal !== $I$(52).PROPERTY  && pal !== $I$(52).VARIABLE   || !this.vwr.g.rangeSelected  ? null : this.vwr.bsA$());
if (pal === $I$(52).PROPERTY ) {
if (isColorIndex) {
if (!this.chk) {
...
if (isPropertyExplicit && (function(a,f){return f.apply(null,a)})([(tok=this.getToken$I(++index).tok), 1077936128],$I$(9).tokAttr$I$I) && !$I$(9).tokAttr$I$I(tok, 1086324736)  ) {
tok=this.getToken$I(index).tok;
...
index++;
}}} else if (pal === $I$(52).VARIABLE ) {
index++;
name=this.paramAsStr$I(index++);
data=Clazz.array(Float.TYPE, [this.vwr.ms.ac]);
(function(a,f){return f.apply(null,a)})(["" + this.getParameter$S$I$Z(name, 4, true), null, data],$I$(53).parseStringInfestedFloatArray$S$javajs_util_BS$FA);
pal=$I$(52).PROPERTY;
}if (pal === $I$(52).PROPERTY ) {
var scheme=null;
...
scheme += "=" + (function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([this.stringParameterSet$I(index)],$I$(8).getVariableAS$SA)],$I$(8).sValue$org_jmol_script_T).replace$C$C("\n", " ");
index=this.iToken + 1;
...
if (Clazz.exceptionOf(e,"Exception")){
throw Clazz.new_($I$(22,1).c$$org_jmol_script_ScriptEval$S$I,[this, "partialcharge", 1]);
} else {
throw e;
}
}
...
case 1648363544:
value=1;
factorType=$I$(33).FACTOR;
vdwType=(tok == 1648363544 ? null : (function(a,f){return f.apply(null,a)})([$I$(9).nameOf$I(tok)],$I$(35).getVdwType2$S));
...
if (vdwType == null ) {
vdwType=(function(a,f){return f.apply(null,a)})([this.optParameterAsString$I(++this.iToken)],$I$(35).getVdwType$S);
if (vdwType == null ) {
this.iToken=index;
vdwType=$I$(35).AUTO;
}}return Clazz.new_($I$(34,1).c$$FA$F$org_jmol_atomdata_RadiusData_EnumType$org_jmol_c_VDW,[null, value, factorType, vdwType]);
});
...
return (function(a,f){return f.apply(null,a)})([$I$(54).getPaletteAtoB$I$I$I(color1, color2, nColors)],$I$(54).getColorSchemeList$IA);
});
...
return (function(a,f){return f.apply(null,a)})([points[0], points[1], points[2], Clazz.new_($I$(41,1)), vAB, Clazz.new_($I$(44,1))],$I$(43).getPlaneThroughPoints$javajs_util_T3$javajs_util_T3$javajs_util_T3$javajs_util_V3$javajs_util_V3$javajs_util_P4);
case 24:
...
data=Clazz.array($I$(42), [pts.length]);
for (var i=0; i < pts.length; i++) data[i]=$I$(42).newP4$javajs_util_P4(pts[i]);

break;
case 1073742001:
var sv=quaternionOrSVData;
data=Clazz.array($I$(42), [sv.size$()]);
for (var i=0; i < sv.size$(); i++) {
var pt=(function(a,f){return f.apply(null,a)})([sv.get$I(i)],$I$(8).pt4Value$org_jmol_script_SV);
if (pt == null ) return null;
data[i]=$I$(42).newP4$javajs_util_P4(pt);
}
break;
default:
return null;
...
return (pt >= this.slen ? NaN : (function(a,f){return f.apply(null,a)})([this.parameterExpressionToken$I(pt)],$I$(8).fValue$org_jmol_script_T));
}, p$1);
...
case 12294:
case 1610625028:
this.setShapeProperty$I$S$O(iShape, "hidden", tokCommand == 1610625028 ? $I$(15).FALSE : $I$(15).TRUE);
break;
case 134222350:
...
if (rd == null ) rd=Clazz.new_([null, scale, $I$(33).FACTOR, $I$(35).AUTO],$I$(34,1).c$$FA$F$org_jmol_atomdata_RadiusData_EnumType$org_jmol_c_VDW);
...
if (tok == 545259568 && (units.toLowerCase$().endsWith$S("hz") || (function(a,f){return f.apply(null,a)})([units.toLowerCase$(), ";angstroms;au;bohr;nanometers;nm;picometers;pm;vanderwaals;vdw;"],$I$(7).isOneOf$S$S) ) ) {
if (!this.chk) this.vwr.setUnits$S$Z(units, true);
} else if (tok == 545259558 && (function(a,f){return f.apply(null,a)})([units.toLowerCase$(), ";kcal;kj;"],$I$(7).isOneOf$S$S) ) {
