...
/*c*/var C$=Clazz.newClass(P$, "ScriptManager", null, null, 'org.jmol.api.JmolScriptManager');
...
this.scriptQueue=Clazz.new_($I$(2,1));
this.useCommandWatcherThread=false;
this.isScriptQueued=true;
},1);

C$.$fields$=[['Z',['useCommandWatcherThread','isScriptQueued'],'I',['scriptIndex'],'O',['vwr','org.jmol.viewer.Viewer','eval','org.jmol.script.ScriptEval','evalTemp','org.jmol.api.JmolScriptEvaluator','queueThreads','Thread[]','scriptQueueRunning','boolean[]','commandWatcherThread','org.jmol.thread.JmolThread','scriptQueue','javajs.util.Lst']]
,['I',['prevCovalentVersion']]]
...
var scriptItem=Clazz.new_($I$(2,1));
scriptItem.addLast$O(strScript);
scriptItem.addLast$O(statusList);
scriptItem.addLast$O(returnType);
scriptItem.addLast$O(isQuiet ? $I$(5).TRUE : $I$(5).FALSE);
scriptItem.addLast$O(Integer.valueOf$I(useCommandThread ? -1 : 1));
this.scriptQueue.addLast$O(scriptItem);
...
(function(a,f){return f.apply(null,a)})(["...scriptManager waiting for queue: " + this.scriptQueue.size$() + " thread=" + $I$(1).currentThread$().getName$() ],$I$(6).debug$S);
}} catch (e) {
...
if ($I$(6).debugging) (function(a,f){return f.apply(null,a)})([this.scriptQueue.size$() + " scripts; removed: " + strScript ],$I$(6).debug$S);
}}
}, p$1);
...
this.queueThreads[pt]=Clazz.new_($I$(7,1).c$$org_jmol_script_ScriptManager$org_jmol_viewer_Viewer$Z$I,[this, this.vwr, startedByCommandWatcher, pt]);
...
(function(a,f){return f.apply(null,a)})(["command watcher " + (isStart ? "started" : "stopped") + this.commandWatcherThread ],$I$(6).debug$S);
}});
...
if (scriptItem != null ) {
scriptItem.set$I$O(4, Integer.valueOf$I(0));
...
if (ptWait >= 0) {
return this.evalStringWaitStatusQueued$S$S$S$Z$Z("String", "script " + (function(a,f){return f.apply(null,a)})([strFilename.substring$I$I(0, ptWait)],$I$(4).esc$S), "", false, false);
...
var outputBuffer=(statusList == null  || statusList.equals$O("output")  ? Clazz.new_($I$(8,1)) : null);
var oldStatusList=this.vwr.sm.statusList;
this.vwr.getStatusChanged$S(statusList);
if (this.vwr.isSyntaxCheck) (function(a,f){return f.apply(null,a)})(["--checking script:\n" + this.eval.getScript$() + "\n----\n" ],$I$(6).info$S);
...
(function(a,f){return f.apply(null,a)})(["(use \'exit\' to stop checking)"],$I$(6).info$S);
}this.isScriptQueued=true;
...
this.vwr.scriptStatusMsg$S$S("", "execution resumed");
...
return this.addScript$S$Z(strScript, isQuiet && !this.vwr.getBoolean$I(603979879) );
});
...
}(function(a,f){return f.apply(null,a)})([this.vwr.isSyntaxCheck ? haltType + " -- stops script checking" : (isInsert ? "!" : "") + haltType + " received" ],$I$(6).info$S);
...
if (type == null ) {
type=(function(a,f){return f.apply(null,a)})([this.vwr.getBufferedInputStream$S(fileName)],$I$(9).determineSurfaceTypeIs$java_io_InputStream);
...
var tokens=(function(a,f){return f.apply(null,a)})([version.replace$C$C(".", " ").replace$C$C("_", " ")],$I$(4).getTokens$S);
try {
...
if (modelIndex != this.vwr.ms.mc - 1) return Clazz.new_($I$(14,1));
...
var sbConnect=Clazz.new_($I$(8,1));
