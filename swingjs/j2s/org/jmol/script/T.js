(function(){var P$=Clazz.newPackage("org.jmol.script"),I$=[[0,'java.util.Hashtable','org.jmol.util.Logger','javajs.util.Lst','java.util.Arrays','javajs.util.AU']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if ((token.tok & 4096) != 0 && (s == null  || name.indexOf$S(s) == 0 )  && (isMultiCharacter || (token.value).equals$O(name) ) ) htSet.put$O$O(name, Boolean.TRUE);
}
...
return $I$(5).sortedItem$javajs_util_Lst$I(v, n);
}, 1);
