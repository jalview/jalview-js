...
return $I$(1,"newV$I$O",[6, Clazz.new_($I$(3,1))]);
}$var=$var.toLowerCase$();
...
data.addLast$O(bs.cardinality$() == 1 ? $I$(7,"newP$javajs_util_T3",[this.vwr.ms.at[bs.nextSetBit$I(0)]]) : this.vwr.ms.getAtomSetCenter$javajs_util_BS(bs));
} else {
this.invArg$();
}}
return data;
...
return $I$(10,"getPlaneThroughPoints$javajs_util_T3$javajs_util_T3$javajs_util_T3$javajs_util_V3$javajs_util_V3$javajs_util_P4",[this.pt1, this.pt2, this.pt3, Clazz.new_($I$(8,1)), Clazz.new_($I$(8,1)), Clazz.new_($I$(9,1))]);
});
...
var pt;
var pts=(t).getList$();
for (var j=0; j < pts.size$(); j++) if ((pt=$I$(1,"ptValue$org_jmol_script_SV",[pts.get$I(j)])) != null ) data.addLast$O(pt);
 else return null;
