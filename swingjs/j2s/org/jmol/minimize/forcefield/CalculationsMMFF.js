...
case 1:
case 3:
return (function(a,f){return f.apply(null,a)})(["%11s  %-5s %-5s %-5s  %8.3f  %8.3f     %8.3f   %8.3f", "ssssFI", Clazz.array(java.lang.Object, -1, [$I$(11).decodeKey$Integer(c.key), this.minAtoms[c.ia].sType, this.minAtoms[c.ib].sType, this.minAtoms[c.ic].sType, Clazz.array(Float.TYPE, -1, [(c.theta * 57.29577951308232), c.dData[1], c.dData[0], energy]), Clazz.array(Integer.TYPE, -1, [this.minAtoms[c.ia].atom.getAtomNumber$(), this.minAtoms[c.ib].atom.getAtomNumber$(), this.minAtoms[c.ic].atom.getAtomNumber$()])])],$I$(10).sprintf$S$S$OA);
case 2:
return (function(a,f){return f.apply(null,a)})(["%15s  %-5s %-5s %-5s %-5s  %8.3f %8.3f %8.3f %8.3f %8.3f", "sssssF", Clazz.array(java.lang.Object, -1, [$I$(11).decodeKey$Integer(c.key), this.minAtoms[c.ia].sType, this.minAtoms[c.ib].sType, this.minAtoms[c.ic].sType, this.minAtoms[c.id].sType, Clazz.array(Float.TYPE, -1, [(c.theta * 57.29577951308232), c.dData[0], c.dData[1], c.dData[2], energy])])],$I$(10).sprintf$S$S$OA);
default:
