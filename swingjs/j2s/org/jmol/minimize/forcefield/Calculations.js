(function(){var P$=Clazz.newPackage("org.jmol.minimize.forcefield"),p$1={},I$=[[0,'javajs.util.AU','javajs.util.SB','javajs.util.V3d','org.jmol.minimize.MMConstraint','javajs.util.Lst','org.jmol.minimize.Util','javajs.util.PT']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
switch (c.type) {
case 0:
this.appendLogData$S($I$(7,"sprintf$S$S$OA",["%3d %3d  %-5s %-5s  %12.6f", "ssFI", Clazz.array(java.lang.Object, -1, [this.minAtoms[this.ia].atom.getAtomName$(), this.minAtoms[this.ib].atom.getAtomName$(), Clazz.array(Float.TYPE, -1, [targetValue]), Clazz.array(Integer.TYPE, -1, [this.minAtoms[this.ia].atom.getAtomNumber$(), this.minAtoms[this.ib].atom.getAtomNumber$()])])]));
break;
case 1:
this.appendLogData$S($I$(7,"sprintf$S$S$OA",["%3d %3d %3d  %-5s %-5s %-5s  %12.6f", "sssFI", Clazz.array(java.lang.Object, -1, [this.minAtoms[this.ia].atom.getAtomName$(), this.minAtoms[this.ib].atom.getAtomName$(), this.minAtoms[this.ic].atom.getAtomName$(), Clazz.array(Float.TYPE, -1, [targetValue]), Clazz.array(Integer.TYPE, -1, [this.minAtoms[this.ia].atom.getAtomNumber$(), this.minAtoms[this.ib].atom.getAtomNumber$(), this.minAtoms[this.ic].atom.getAtomNumber$()])])]));
break;
case 2:
this.appendLogData$S($I$(7,"sprintf$S$S$OA",["%3d %3d %3d %3d  %-5s %-5s %-5s %-5s  %3d %8.3f     %8.3f     %8.3f     %8.3f", "ssssFI", Clazz.array(java.lang.Object, -1, [this.minAtoms[this.ia].atom.getAtomName$(), this.minAtoms[this.ib].atom.getAtomName$(), this.minAtoms[this.ic].atom.getAtomName$(), this.minAtoms[this.id].atom.getAtomName$(), Clazz.array(Float.TYPE, -1, [targetValue]), Clazz.array(Integer.TYPE, -1, [this.minAtoms[this.ia].atom.getAtomNumber$(), this.minAtoms[this.ib].atom.getAtomNumber$(), this.minAtoms[this.ic].atom.getAtomNumber$(), this.minAtoms[this.id].atom.getAtomNumber$()])])]));
break;
}
}
}
...
switch (iType) {
case 0:
return $I$(7,"sprintf$S$S$OA",["%3d %3d  %-5s %-5s  %4.2f%8.3f   %8.3f     %8.3f   %8.3f   %8.3f", "ssFI", Clazz.array(java.lang.Object, -1, [this.minAtoms[c.ia].sType, this.minAtoms[c.ib].sType, Clazz.array(Float.TYPE, -1, [0, c.rab, c.dData[1], c.dData[0], c.delta, energy]), Clazz.array(Integer.TYPE, -1, [this.minAtoms[c.ia].atom.getAtomNumber$(), this.minAtoms[c.ib].atom.getAtomNumber$()])])]);
case 1:
case 3:
return $I$(7,"sprintf$S$S$OA",["%3d %3d %3d  %-5s %-5s %-5s  %8.3f  %8.3f     %8.3f   %8.3f", "sssFI", Clazz.array(java.lang.Object, -1, [this.minAtoms[c.ia].sType, this.minAtoms[c.ib].sType, this.minAtoms[c.ic].sType, Clazz.array(Float.TYPE, -1, [(c.theta * 57.29577951308232), c.dData[1], c.dData[0], energy]), Clazz.array(Integer.TYPE, -1, [this.minAtoms[c.ia].atom.getAtomNumber$(), this.minAtoms[c.ib].atom.getAtomNumber$(), this.minAtoms[c.ic].atom.getAtomNumber$()])])]);
case 2:
return $I$(7,"sprintf$S$S$OA",["%3d %3d %3d %3d  %-5s %-5s %-5s %-5s  %3d %8.3f     %8.3f     %8.3f     %8.3f", "ssssFI", Clazz.array(java.lang.Object, -1, [this.minAtoms[c.ia].sType, this.minAtoms[c.ib].sType, this.minAtoms[c.ic].sType, this.minAtoms[c.id].sType, Clazz.array(Float.TYPE, -1, [c.dData[1], c.dData[0], (c.theta * 57.29577951308232), energy]), Clazz.array(Integer.TYPE, -1, [this.minAtoms[c.ia].atom.getAtomNumber$(), this.minAtoms[c.ib].atom.getAtomNumber$(), this.minAtoms[c.ic].atom.getAtomNumber$(), this.minAtoms[c.id].atom.getAtomNumber$(), c.iData[4]])])]);
case 4:
return $I$(7,"sprintf$S$S$OA",["%3d %3d %3d %3d  %-5s %-5s %-5s %-5s  %8.3f   %8.3f     %8.3f", "ssssFI", Clazz.array(java.lang.Object, -1, [this.minAtoms[c.ia].sType, this.minAtoms[c.ib].sType, this.minAtoms[c.ic].sType, this.minAtoms[c.id].sType, Clazz.array(Float.TYPE, -1, [(c.theta * 57.29577951308232), c.dData[0], energy]), Clazz.array(Integer.TYPE, -1, [this.minAtoms[c.ia].atom.getAtomNumber$(), this.minAtoms[c.ib].atom.getAtomNumber$(), this.minAtoms[c.ic].atom.getAtomNumber$(), this.minAtoms[c.id].atom.getAtomNumber$()])])]);
case 5:
return $I$(7,"sprintf$S$S$OA",["%3d %3d  %-5s %-5s %6.3f  %8.3f  %8.3f", "ssFI", Clazz.array(java.lang.Object, -1, [this.minAtoms[c.iData[0]].sType, this.minAtoms[c.iData[1]].sType, Clazz.array(Float.TYPE, -1, [c.rab, c.dData[0], energy]), Clazz.array(Integer.TYPE, -1, [this.minAtoms[c.ia].atom.getAtomNumber$(), this.minAtoms[c.ib].atom.getAtomNumber$()])])]);
case 6:
return $I$(7,"sprintf$S$S$OA",["%3d %3d  %-5s %-5s %6.3f  %8.3f  %8.3f  %8.3f  %8.3f", "ssFI", Clazz.array(java.lang.Object, -1, [this.minAtoms[c.iData[0]].sType, this.minAtoms[c.iData[1]].sType, Clazz.array(Float.TYPE, -1, [c.rab, c.dData[0], c.dData[1], c.dData[2], energy]), Clazz.array(Integer.TYPE, -1, [this.minAtoms[c.ia].atom.getAtomNumber$(), this.minAtoms[c.ib].atom.getAtomNumber$()])])]);
}
return "";
});
