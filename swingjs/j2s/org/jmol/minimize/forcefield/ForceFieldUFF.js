...
elemNo=(function(a,f){return f.apply(null,a)})([smarts.substring$I$I(2, len - 1)],$I$(4).parseInt$S);
} else {
...
}if ($I$(2).debugging && bs.nextSetBit$I(0) >= 0 ) (function(a,f){return f.apply(null,a)})([smarts + " minimize atoms=" + bs ],$I$(2).debug$S);
return bs;
}, p$1);
...
(function(a,f){return f.apply(null,a)})([temp.size$() + " atom types read from " + resourceName ],$I$(2).info$S);
return temp;
}, p$1);
...
(function(a,f){return f.apply(null,a)})([types.size$() + " UFF parameters read"],$I$(2).info$S);
