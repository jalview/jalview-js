...
if ($I$(5).debugging) (function(a,f){return f.apply(null,a)})([a1 + " g=" + new Double(p$1.getIsotopeData$org_jmol_modelset_Atom$I.apply(this, [a1, 1])).toString() + "; " + a2 + " g=" + new Double(p$1.getIsotopeData$org_jmol_modelset_Atom$I.apply(this, [a2, 1])).toString() ],$I$(5).debug$S);
...
if (debugging) (function(a,f){return f.apply(null,a)})([isoname + "  " + $I$(9).eAD$DA(dataGQ) ],$I$(5).info$S);
...
(function(a,f){return f.apply(null,a)})(["Exception " + e.toString() + " reading " + "nmr_data.txt" ],$I$(5).error$S);
} else {
throw e;
}
} finally {
...
return map;
}if ((function(a,f){return f.apply(null,a)})([what.charAt$I(0)],$I$(8).isDigit$C)) return this.isotopeData.get$O(what);
var info=Clazz.new_($I$(2,1));
for (var e, $e = this.isotopeData.entrySet$().iterator$(); $e.hasNext$()&&((e=($e.next$())),1);) {
var key=e.getKey$();
if ((function(a,f){return f.apply(null,a)})([key.charAt$I(0)],$I$(8).isDigit$C) && key.endsWith$S(what) ) info.addLast$O(e.getValue$());
}
return info;
});
...
var angle=(function(a,f){return f.apply(null,a)})([h1, c, h2, Clazz.new_($I$(6,1)), Clazz.new_($I$(6,1)), false],$I$(11).computeAngle$javajs_util_T3$javajs_util_T3$javajs_util_T3$javajs_util_V3$javajs_util_V3$Z);
...
var noe=NaN;
if (noeMatrix == null ) {
noeMatrix=(function(a,f){return f.apply(null,a)})([viewer, viewer.getModelUndeletedAtomsBitSet$I(atom1.mi), viewer.ms.getInfo$I$S(atom1.mi, "noeLabels"), viewer.ms.getInfo$I$S(atom1.mi, "noeParams")],$I$(12).createMatrix$org_jmol_viewer_Viewer$javajs_util_BS$SA$org_jmol_quantum_NMRNoeMatrix_NOEParams);
