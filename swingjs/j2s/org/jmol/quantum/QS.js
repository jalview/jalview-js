(function(){var P$=Clazz.newPackage("org.jmol.quantum"),I$=[[0,'javajs.util.SB','javajs.util.PT']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "QS");
...
C$.$fields$=[[]
,['I',['MAX_TYPE_SUPPORTED'],'O',['idSpherical','int[]','tags','String[]','+tags2']]]
