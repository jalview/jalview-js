...
var bs=(function(a,f){return f.apply(null,a)})([vR.get$I(r)],$I$(1).copy$javajs_util_BS);
...
npi+=n;
if (n == 1) n1++;
if ($I$(6).debuggingHigh) (function(a,f){return f.apply(null,a)})(["atom " + atom + " pi=" + n + " npi=" + npi ],$I$(6).info$S);
continue;
}
}}
...
var set=(function(a,f){return f.apply(null,a)})([edges.get$I(j), htEdgeMap],$I$(3).getSetByEdge$org_jmol_util_Edge$java_util_Hashtable);
