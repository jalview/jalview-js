(function(){var P$=Clazz.newPackage("org.jmol.g3d"),p$1={},I$=[[0,'org.jmol.util.Rgb16','org.jmol.util.GData']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
