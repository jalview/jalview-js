...
var g=($I$(19).isJS ? null : this.platform.getGraphicsForTextOrImage$I$I(imageWidth, imageHeight));
...
this.currentFont=$I$(20).getFont3D$B(fid);
});
...
maskB&=~16384;
maskC&=~16384;
var mask=$I$(3,"roundInt$I",[((maskA + maskB + maskC )/3|0)]) & 30720;
this.translucencyMask=(mask << 13) | 16777215;
}}, p$1);
...
var zIncrementScaled=$I$(3,"roundInt$I",[(((dz << 10) + (dz >= 0 ? roundFactor : -roundFactor))/count|0)]);
if (x < 0) {
x=-x;
...
var rScaled=rgb16Left.r << 8;
var rIncrement=$I$(3,"roundInt$I",[(((rgb16Right.r - rgb16Left.r) << 8)/count|0)]);
var gScaled=rgb16Left.g;
var gIncrement=$I$(3,"roundInt$I",[((rgb16Right.g - gScaled)/count|0)]);
var bScaled=rgb16Left.b;
var bIncrement=$I$(3,"roundInt$I",[((rgb16Right.b - bScaled)/count|0)]);
while (--count >= 0){
var z=zScaled >> 10;
...
var vertexVectors=$I$(21).getVertexVectors$();
