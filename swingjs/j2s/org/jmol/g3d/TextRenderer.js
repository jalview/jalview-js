(function(){var P$=Clazz.newPackage("org.jmol.g3d"),p$1={},I$=[[0,'java.util.Hashtable','javajs.util.CU']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (pt < 0) continue;
argb=(function(a,f){return f.apply(null,a)})([text.substring$I$I(i + 7, pt).trim$()],$I$(2).getArgbFromString$S);
i=pt;
continue;
