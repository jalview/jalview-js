...
this.vwr.getProperty$S$S$O("DATA_API", "scriptEditorState", b ? Boolean.TRUE : Boolean.FALSE);
...
if (this.editor != null ) this.editor.setFont$java_awt_Font(Clazz.new_($I$(18,1).c$$S$I$I,["dialog", 0, this.fontSize]));
});
...
this.editor.scrollRectToVisible$java_awt_Rectangle(Clazz.new_($I$(19,1).c$$I$I,[i, j]));
}, p$1);
...
this.output$S($I$(20).getEmbeddedScript$S(msg));
}this.setVisible$Z(true);
});
...
this.b$['org.jmol.console.ScriptEditor'].filename=null;
this.clearContent$S(null);
});

Clazz.newMeth(C$, 'clearContent$S', function (text) {
this.editorDoc.outputEcho$S(text);
this.b$['org.jmol.console.ScriptEditor'].parseScript$S.apply(this.b$['org.jmol.console.ScriptEditor'], [text]);
});
...
case 90:
if (ke.isControlDown$()) {
if (ke.isShiftDown$()) this.b$['org.jmol.console.ScriptEditor'].editor.editorDoc.redo$();
 else this.b$['org.jmol.console.ScriptEditor'].editor.editorDoc.undo$();
return;
}break;
case 89:
if (ke.isControlDown$()) {
this.b$['org.jmol.console.ScriptEditor'].editor.editorDoc.redo$();
return;
}break;
case 116:
if (this.b$['org.jmol.console.ScriptEditor'].stepButton.isEnabled$()) this.b$['org.jmol.console.ScriptEditor'].doStep$.apply(this.b$['org.jmol.console.ScriptEditor'], []);
return;
case 119:
if (this.b$['org.jmol.console.ScriptEditor'].resumeButton.isEnabled$()) this.b$['org.jmol.console.ScriptEditor'].doResume$.apply(this.b$['org.jmol.console.ScriptEditor'], []);
return;
}
...
this.b$['org.jmol.console.ScriptEditor'].editor.select$I$I(from, to);
this.b$['org.jmol.console.ScriptEditor'].editor.setSelectedTextColor$java_awt_Color(attr === this.b$['org.jmol.console.ScriptEditor'].attError  ? $I$(4).RED : $I$(4).black);
});

Clazz.newMeth(C$, 'clearHighlight$', function () {
this.setCharacterAttributes$I$I$javax_swing_text_AttributeSet$Z(0, this.b$['org.jmol.console.ScriptEditor'].editor.editorDoc.getLength$(), this.b$['org.jmol.console.ScriptEditor'].attEcho, true);
});
...
if (!text.endsWith$S("\n")) text += "\n";
try {
C$.superclazz.prototype.insertString$I$S$javax_swing_text_AttributeSet.apply(this, [0, text, this.b$['org.jmol.console.ScriptEditor'].attEcho]);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
...
this.b$['org.jmol.console.ScriptEditor.EditorDocument'].undo.addEdit$javax_swing_undo_UndoableEdit(e.getEdit$());
});
