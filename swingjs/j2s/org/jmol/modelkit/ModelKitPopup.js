...
this.allOperators=$I$(6,"split$S$S",[data.trim$().replace$C$C("\t", " "), "\n"]);
var menu=this.htMenus.get$O("xtalOp!PersistMenu");
if (menu != null ) p$1.addAllCheckboxItems$org_jmol_api_SC$SA.apply(this, [menu, this.allOperators]);
});
...
if (name === "isMolecular" ) {
return Boolean.valueOf$Z(p$1.getMKState.apply(this, []) == 0);
}if (name === "hoverlabel" ) {
...
this.vwr.highlight$javajs_util_BS($I$(7).newAndSetBit$I(atomIndex));
}} else {
if (msg == null ) {
...
if (element == null  || $I$(8).elementNumberFromSymbol$S$Z(element, true) == 0 ) return null;
...
var atomicNumber=($I$(6,"isUpperCase$C",[type.charAt$I(0)]) ? $I$(8).elementNumberFromSymbol$S$Z(type, true) : -1);
var isDelete=false;
if (atomicNumber > 0) {
this.vwr.ms.setElement$org_jmol_modelset_Atom$I$Z(atom, atomicNumber, !addHsAndBond);
this.vwr.shm.setShapeSizeBs$I$I$org_jmol_atomdata_RadiusData$javajs_util_BS(0, 0, this.vwr.rd, $I$(7).newAndSetBit$I(atomIndex));
...
var v=$I$(9,"newVsub$javajs_util_T3$javajs_util_T3",[atom, this.vwr.ms.at[atom.getBondedAtomIndex$I(0)]]);
var d=v.length$();
v.normalize$();
v.scale$F(dx - d);
this.vwr.ms.setAtomCoordRelative$I$F$F$F(atomIndex, v.x, v.y, v.z);
}var bsA=$I$(7).newAndSetBit$I(atomIndex);
if (isDelete) {
...
case 112:
case 109:
bondOrder=($I$(10,"getBondOrderNumberFromOrder$I",[bond.getCovalentOrder$()]).charCodeAt$I(0)) - 48 + (type == 112  ? 1 : -1);
...
$I$(11,"error$S",["Exception in seBondOrder: " + e.toString()]);
} else {
throw e;
}
}
...
}var v1=$I$(9).new3$F$F$F(atomMove.sX - atomFix.sX, atomMove.sY - atomFix.sY, 0);
var v2=$I$(9).new3$F$F$F(deltaX, deltaY, 0);
v1.cross$javajs_util_T3$javajs_util_T3(v1, v2);
var degrees=(v1.z > 0  ? 1 : -1) * v2.length$();
var bs=$I$(7).copy$javajs_util_BS(bsBranch);
...
var a=$I$(6,"parseFloatArray$S",[$I$(6).replaceAllCharacters$S$S$S(pos, "{,}", " ")]);
