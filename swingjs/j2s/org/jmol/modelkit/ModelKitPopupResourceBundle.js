(function(){var P$=Clazz.newPackage("org.jmol.modelkit"),I$=[[0,'org.jmol.i18n.GT']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
