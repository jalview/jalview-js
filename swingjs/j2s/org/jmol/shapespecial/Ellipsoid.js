(function(){var P$=Clazz.newPackage("org.jmol.shapespecial"),p$1={},I$=[[0,'javajs.util.P3']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "Ellipsoid");
...
C$.$fields$=[['Z',['visible','isValid','isOn'],'B',['pid'],'F',['scale'],'I',['modelIndex','percent'],'H',['colix'],'S',['options','id','label'],'O',['center','javajs.util.P3','tensor','org.jmol.util.Tensor','lengths','float[]','+scaleXYZ','info','java.util.Map']]
,['O',['crtval','float[]']]]
...
Clazz.newMeth(C$, 'scaleAxes$FA', function (value) {
this.scaleXYZ=value;
this.setLengths$();
});
...
for (var i=0; i < this.lengths.length; i++) this.lengths[i]=this.tensor.getFactoredValue$I(i) * this.scale * (this.scaleXYZ == null  ? 1 : Math.abs(this.scaleXYZ[i])) ;
