...
o=info.get$O("center");
this.center=(function(a,f){return f.apply(null,a)})([isSV ? $I$(4).ptValue$org_jmol_script_SV(o) : o],$I$(1).newP$javajs_util_T3);
o=info.get$O("modelIndex");
this.modelIndex=(o == null  ? vwr.am.cmi : isSV ? (o).intValue : (o).intValue$());
o=info.get$O("color");
this.colix=(function(a,f){return f.apply(null,a)})([o == null  ? "gold" : isSV ? (o).asString$() : o],$I$(5).getColixS$S);
o=info.get$O("colorEdge");
if (o != null ) this.colixEdge=(function(a,f){return f.apply(null,a)})([isSV ? (o).asString$() : o.toString()],$I$(5).getColixS$S);
o=info.get$O("offset");
if (o != null ) this.offset=(function(a,f){return f.apply(null,a)})([isSV ? $I$(4).ptValue$org_jmol_script_SV(o) : o],$I$(1).newP$javajs_util_T3);
o=info.get$O("scale");
...
if (this.center == null ) {
this.vertices[this.nVertices]=(function(a,f){return f.apply(null,a)})([info.get$O("ptRef")],$I$(4).ptValue$org_jmol_script_SV);
} else {
...
var lst=(isSV ? (o).getList$() : o);
var ai=(function(a,f){return f.apply(null,a)})([lst.size$()],$I$(3).newInt2$I);
...
info.put$O$O("colorEdge", (function(a,f){return f.apply(null,a)})([this.colixEdge == 0 ? this.colix : this.colixEdge],$I$(5).getHexCode$H));
...
names[i]=(isNode ? (pt).getAtomName$() : Clazz.instanceOf(pt, "org.jmol.util.Point3fi") ? (function(a,f){return f.apply(null,a)})([(pt).sD],$I$(12).elementSymbolFromNumber$I) : "");
...
if (this.collapsed) info.put$O$O("collapsed", $I$(14).valueOf$Z(this.collapsed));
...
return "  polyhedron @{" + (function(a,f){return f.apply(null,a)})([this.getInfo$org_jmol_viewer_Viewer$S(vwr, null)],$I$(16).e$O) + "} " + (this.isFullyLit ? " fullyLit" : "") + ";" + (this.visible ? "" : "polyhedra " + ident + " off;" ) + "\n" ;
});
