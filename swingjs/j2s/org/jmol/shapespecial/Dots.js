...
if (this.bsColixSet != null  && this.bsColixSet.get$I(i) ) $I$(6,"setMapBitSet$java_util_Map$I$I$S",[temp, i, i, $I$(11).getColorCommand$S$B$H$Z(type, this.paletteIDs[i], this.colixes[i], this.translucentAllowed)]);
var bs=dotsConvexMaps[i];
if (!bs.isEmpty$()) {
var r=this.ec.getAppropriateRadius$I(i);
$I$(11,"appendCmd$javajs_util_SB$S",[s, type + i + " radius " + new Float(r).toString() + " " + $I$(12).eBS$javajs_util_BS(bs) ]);
}}
