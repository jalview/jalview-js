(function(){var P$=Clazz.newPackage("org.jmol.renderbio"),p$1={},I$=[[0,'javajs.util.V3','javajs.util.A4','javajs.util.P3','javajs.util.M3','javajs.util.BS','org.jmol.util.Logger','org.jmol.shape.Mesh','org.jmol.util.GData','org.jmol.util.Normix']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.meshes[i]=null;
(function(a,f){return f.apply(null,a)})(["render mesh error hermiteRibbon: " + e.toString()],$I$(6).error$S);
} else {
throw e;
}
}
...
this.bsRenderMesh.clear$I(i);
this.meshes[i]=null;
(function(a,f){return f.apply(null,a)})(["render mesh error hermiteConic: " + e.toString()],$I$(6).error$S);
} else {
throw e;
}
}
...
this.bsRenderMesh.clear$I(i);
this.meshes[i]=null;
(function(a,f){return f.apply(null,a)})(["render mesh error hermiteArrowHead: " + e.toString()],$I$(6).error$S);
} else {
throw e;
}
}
...
(function(a,f){return f.apply(null,a)})([4, this.ptPrev, this.pt, this.pt1, this.ptNext, this.ptNext, this.radiusHermites, 0, (nHermites + 1) >> 1, true],$I$(8).getHermiteList$I$javajs_util_T3$javajs_util_T3$javajs_util_T3$javajs_util_T3$javajs_util_T3$javajs_util_T3A$I$I$Z);
}var nPoints=0;
