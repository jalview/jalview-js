(function(){var P$=Clazz.newPackage("org.jmol.jvxl.readers"),p$1={},I$=[[0,'org.jmol.jvxl.data.JvxlCoder','org.jmol.util.Logger','javajs.util.CU','javajs.util.P4']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (p$1.readVerticesAndPolygons.apply(this, [])) $I$(2).info$S(this.type + " file contains " + this.nVertices + " 4D vertices and " + this.nPolygons + " polygons for " + this.nTriangles + " triangles" );
 else (function(a,f){return f.apply(null,a)})([this.params.fileName + ": " + (this.pmeshError == null  ? "Error reading pmesh4 data " : this.pmeshError) ],$I$(2).error$S);
});
...
this.color=(function(a,f){return f.apply(null,a)})([p$1.getFloat.apply(this, []), p$1.getFloat.apply(this, []), p$1.getFloat.apply(this, [])],$I$(3).colorTriadToFFRGB$F$F$F);
...
var pt=(function(a,f){return f.apply(null,a)})([p$1.getFloat.apply(this, []), p$1.getFloat.apply(this, []), p$1.getFloat.apply(this, []), p$1.getFloat.apply(this, [])],$I$(4).new4$F$F$F$F);
