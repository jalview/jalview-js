(function(){var P$=Clazz.newPackage("org.jmol.jvxl.readers"),p$1={},I$=[[0,'org.jmol.util.Logger','javajs.util.SB']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
(function(a,f){return f.apply(null,a)})(["PyMOLMeshReader for " + this.params.calculationType + " pymolType=" + this.pymolType + "; isMesh=" + this.isMesh + " surfaceName=" + this.surfaceName ],$I$(1).info$S);
...
(function(a,f){return f.apply(null,a)})(["PyMOLMeshReader: Number of grid points = " + this.voxelList.size$()],$I$(1).info$S);
});
...
(function(a,f){return f.apply(null,a)})(["PyMOLMeshReader rmsd=" + new Float(rmsd).toString() + " mean=" + new Float(mean).toString() ],$I$(1).info$S);
