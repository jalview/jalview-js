(function(){var P$=Clazz.newPackage("org.jmol.jvxl.readers"),p$1={},I$=[[0,'org.jmol.api.Interface','javajs.util.AU','javajs.util.P3','java.util.Random','javajs.util.PT','org.jmol.quantum.QS','javajs.util.V3','javajs.util.Measure','org.jmol.util.Logger']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
line=$I$(5,"formatStringS$S$S$S",[line, "E", energy != null  && ++rep != 0  ? "" + energy.toString() : ""]);
} else if (energy != null ) {
var s=$I$(5,"formatStringF$S$S$F",[line, "E", energy.floatValue$()]);
if (s != line) {
line=s;
rep++;
