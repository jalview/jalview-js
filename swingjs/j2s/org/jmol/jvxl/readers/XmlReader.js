(function(){var P$=Clazz.newPackage("org.jmol.jvxl.readers"),p$1={},I$=[[0,'javajs.util.SB','javajs.util.PT','org.jmol.util.Escape','javajs.util.P3']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (pt1 >= pt2) return "";
while ((function(a,f){return f.apply(null,a)})([data.charAt$I(++pt1)],$I$(2).isWhitespace$C)){
}
return C$.unwrapCdata$S(data.substring$I$I(pt1, pt2));
}, 1);

Clazz.newMeth(C$, 'unwrapCdata$S', function (s) {
return (s.startsWith$S("<![CDATA[") && s.endsWith$S("]]>")  ? (function(a,f){return f.apply(null,a)})([s.substring$I$I(9, s.length$() - 3), "]]]]><![CDATA[>", "]]>"],$I$(2).rep$S$S$S) : s);
}, 1);
