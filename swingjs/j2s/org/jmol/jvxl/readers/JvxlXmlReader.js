...
this.jvxlData.jvxlExcluded[0]=(function(a,f){return f.apply(null,a)})([this.xr.getXmlData$S$S$Z$Z("jvxlExcludedVertexData", null, false, false)],$I$(3).jvxlDecodeBitSet$S);
if (this.xr.isNext$S("jvxlExcludedPlaneData")) this.jvxlData.jvxlExcluded[2]=(function(a,f){return f.apply(null,a)})([this.xr.getXmlData$S$S$Z$Z("jvxlExcludedPlaneData", null, false, false)],$I$(3).jvxlDecodeBitSet$S);
}if (this.excludedTriangleCount > 0) this.jvxlData.jvxlExcluded[3]=(function(a,f){return f.apply(null,a)})([this.xr.getXmlData$S$S$Z$Z("jvxlExcludedTriangleData", null, false, false)],$I$(3).jvxlDecodeBitSet$S);
if (this.invalidatedVertexCount > 0) this.jvxlData.jvxlExcluded[1]=(function(a,f){return f.apply(null,a)})([this.xr.getXmlData$S$S$Z$Z("jvxlInvalidatedVertexData", null, false, false)],$I$(3).jvxlDecodeBitSet$S);
...
var bs=(function(a,f){return f.apply(null,a)})([this.xr.getXmlData$S$S$Z$Z("jvxlColorMap", s, false, false)],$I$(3).jvxlDecodeBitSet$S);
this.jvxlData.vertexColorMap.put$O$O(color, bs);
}
}} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
(function(a,f){return f.apply(null,a)})([e.toString()],$I$(5).error$S);
return false;
} else {
throw e;
}
...
this.jvxlFileHeaderBuffer=(function(a,f){return f.apply(null,a)})([s == null  ? "" : s],$I$(6).newS$S);
...
if (!Float.isNaN$F(this.jvxlCutoff)) (function(a,f){return f.apply(null,a)})(["JVXL read: cutoff " + new Float(this.jvxlCutoff).toString()],$I$(5).info$S);
...
(function(a,f){return f.apply(null,a)})(["JVXL read: contourValues " + $I$(7).eAF$FA(this.jvxlData.contourValues)],$I$(5).info$S);
...
(function(a,f){return f.apply(null,a)})(["JVXL read: contourColixes " + $I$(8).getHexCodes$HA(this.jvxlData.contourColixes)],$I$(5).info$S);
...
(function(a,f){return f.apply(null,a)})(["JVXL Error reading plane definition -- setting to 0 0 1 0  (z=0)"],$I$(5).error$S);
...
(function(a,f){return f.apply(null,a)})(["JVXL read: data_min/max " + new Float(this.params.mappedDataMin).toString() + "/" + new Float(this.params.mappedDataMax).toString() ],$I$(5).info$S);
...
this.params.rangeDefined=true;
}(function(a,f){return f.apply(null,a)})(["JVXL read: color red/blue: " + new Float(this.params.valueMappedToRed).toString() + "/" + new Float(this.params.valueMappedToBlue).toString() ],$I$(5).info$S);
...
this.bsVoxelBitSet=(function(a,f){return f.apply(null,a)})([this.xr.getXmlData$S$S$Z$Z("jvxlEdgeData", this.tempDataXml, false, false)],$I$(3).jvxlDecodeBitSet$S);
...
str=(function(a,f){return f.apply(null,a)})([$I$(1).getXmlAttrib$S$S(this.tempDataXml, "data")],$I$(3).jvxlDecompressString$S);
} else {
...
str=(function(a,f){return f.apply(null,a)})([$I$(1).getXmlAttrib$S$S(data, "data")],$I$(3).jvxlDecompressString$S);
}} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
...
if (!this.endOfData) (function(a,f){return f.apply(null,a)})(["end of file in JvxlReader?" + " line=" + this.line ],$I$(5).error$S);
this.endOfData=true;
nThisValue=10000;
...
fraction=(function(a,f){return f.apply(null,a)})([this.jvxlColorDataRead.charAt$I(this.colorPtr).$c(), this.jvxlColorDataRead.charAt$I((this.colorPtr++) + this.valueCount).$c(), this.colorFractionBase, this.colorFractionRange],$I$(3).jvxlFractionFromCharacter2$I$I$I$I);
} else {
fraction=(function(a,f){return f.apply(null,a)})([this.jvxlColorDataRead.charAt$I(this.colorPtr++).$c(), this.colorFractionBase, this.colorFractionRange, 0.5],$I$(3).jvxlFractionFromCharacter$I$I$I$F);
}break;
}
...
this.fractionPtr=0;
}return (function(a,f){return f.apply(null,a)})([this.strFractionTemp.charAt$I(this.fractionPtr++).$c(), base, range, fracOffset],$I$(3).jvxlFractionFromCharacter$I$I$I$F);
}, p$1);
...
var tokens=(function(a,f){return f.apply(null,a)})([this.jvxlColorDataRead.substring$I(nextc[0])],$I$(11).getTokens$S);
...
colixes[i]=(function(a,f){return f.apply(null,a)})([this.jvxlData.vertexColors[i]=c],$I$(8).getColixTranslucent$I);
...
(function(a,f){return f.apply(null,a)})(["JVXL reading color data mapped min/max: " + new Float(this.params.mappedDataMin).toString() + "/" + new Float(this.params.mappedDataMax).toString() + " for " + vertexCount + " vertices." + " using encoding keys " + this.colorFractionBase + " " + this.colorFractionRange ],$I$(5).info$S);
(function(a,f){return f.apply(null,a)})(["mapping red-->blue for " + new Float(this.params.valueMappedToRed).toString() + " to " + new Float(this.params.valueMappedToBlue).toString() + " colorPrecision:" + this.jvxlData.isJvxlPrecisionColor ],$I$(5).info$S);
...
break;
case 48:
n=(function(a,f){return f.apply(null,a)})([c.substring$I(2), 16],$I$(11).parseIntRadix$S$I);
break;
default:
...
if (fdata[0] != vertexCount * 3 ) (function(a,f){return f.apply(null,a)})(["JvxlXmlReader: vertexData count=" + ((fdata[0]|0)) + "; expected " + (vertexCount * 3) ],$I$(5).info$S);
...
fraction=(function(a,f){return f.apply(null,a)})([s.charAt$I(++pt).$c(), s.charAt$I(pt + ptCount).$c(), colorFractionBase, colorFractionRange],$I$(3).jvxlFractionFromCharacter2$I$I$I$I);
...
(function(a,f){return f.apply(null,a)})(["JvxlXmlReader: jvxlTriangleEdgeData count=" + n + "; expected " + nTriangles ],$I$(5).info$S);
...
var fData=(function(a,f){return f.apply(null,a)})([$I$(1).getXmlAttrib$S$S(s, "data")],$I$(3).jvxlDecompressString$S);
var bs=(function(a,f){return f.apply(null,a)})([this.xr.getXmlData$S$S$Z$Z("jvxlContour", s, false, false)],$I$(3).jvxlDecodeBitSet$S);
var n=bs.length$();
(function(a,f){return f.apply(null,a)})([v, n, bs, value, colix, color, $I$(6).newS$S(fData)],$I$(15).setContourVector$javajs_util_Lst$I$javajs_util_BS$F$H$I$javajs_util_SB);
vs.addLast$O(v);
}
var n=vs.size$();
if (n > 0) {
