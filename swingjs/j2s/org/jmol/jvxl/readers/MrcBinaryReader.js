(function(){var P$=Clazz.newPackage("org.jmol.jvxl.readers"),I$=[[0,'org.jmol.util.Logger','javajs.util.SB']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
(function(a,f){return f.apply(null,a)})(["nx=" + this.n0 + " not displayable as MRC file" ],$I$(1).info$S);
...
(function(a,f){return f.apply(null,a)})(["MRC header: nxyzStart: " + new Float(this.xyzStart[0]).toString() + " " + new Float(this.xyzStart[1]).toString() + " " + new Float(this.xyzStart[2]).toString() ],$I$(1).info$S);
...
(function(a,f){return f.apply(null,a)})(["MRC header: dmin,dmax,dmean: " + new Float(this.dmin).toString() + "," + new Float(this.dmax).toString() + "," + new Float(this.dmean).toString() ],$I$(1).info$S);
...
(function(a,f){return f.apply(null,a)})(["MRC header: rms: " + new Float(rmsDeviation).toString()],$I$(1).info$S);
...
(function(a,f){return f.apply(null,a)})(["MRC header: bytes read: " + this.binarydoc.getPosition$() + "\n" ],$I$(1).info$S);
