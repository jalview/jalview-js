(function(){var P$=Clazz.newPackage("org.jmol.jvxl.readers"),p$1={},I$=[[0,'org.jmol.util.Logger','javajs.util.PT','javajs.util.P3','javajs.util.CU']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "KinemageReader", null, 'org.jmol.jvxl.readers.PmeshReader');
...
C$.$fields$=[['F',['vMin','vMax'],'I',['nDots','pointType'],'S',['findString','lastAtom']]]
...
if (this.nDots > n0) (function(a,f){return f.apply(null,a)})(["dots: " + (this.nDots - n0) + "/" + this.nDots ],$I$(1).info$S);
continue;
} else if (this.line.indexOf$S("@vectorlist") == 0) {
n0=this.nPolygons;
p$1.readVectors.apply(this, []);
if (this.nPolygons > n0) (function(a,f){return f.apply(null,a)})(["lines: " + (this.nPolygons - n0) + "/" + this.nPolygons ],$I$(1).info$S);
continue;
}}}this.rd$();
}
return true;
...
}var tokens=(function(a,f){return f.apply(null,a)})([line.substring$I(line.indexOf$S("}") + 1)],$I$(2).getTokens$S);
...
tokens=(function(a,f){return f.apply(null,a)})([tokens[i].replace$C$C(",", " ")],$I$(2).getTokens$S);
var pt=(function(a,f){return f.apply(null,a)})([$I$(2).parseFloat$S(tokens[0]), $I$(2).parseFloat$S(tokens[1]), $I$(2).parseFloat$S(tokens[2])],$I$(3).new3$F$F$F);
