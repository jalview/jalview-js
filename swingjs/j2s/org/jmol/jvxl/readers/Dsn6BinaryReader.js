(function(){var P$=Clazz.newPackage("org.jmol.jvxl.readers"),p$1={},I$=[[0,'java.io.DataInputStream','javajs.util.Rdr','org.jmol.util.Logger','javajs.util.SB']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (data == null ) this.binarydoc.setStream$java_io_BufferedInputStream$Z(sg.atomDataServer.getBufferedInputStream$S(fileName), true);
 else this.binarydoc.setStreamData$java_io_DataInputStream$Z(Clazz.new_([$I$(2,"getBIS$BA",[data.getBytes$()])],$I$(1,1).c$$java_io_InputStream), true);
