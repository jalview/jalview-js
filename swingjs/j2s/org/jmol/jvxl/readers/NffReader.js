(function(){var P$=Clazz.newPackage("org.jmol.jvxl.readers"),p$1={},I$=[[0,'java.util.Hashtable','javajs.util.P3','org.jmol.jvxl.data.JvxlCoder','org.jmol.util.Logger','javajs.util.CU']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
continue;
case 102:
color=(function(a,f){return f.apply(null,a)})([this.parseFloatStr$S(tokens[1]), this.parseFloatStr$S(tokens[2]), this.parseFloatStr$S(tokens[3])],$I$(5).colorTriadToFFRGB$F$F$F);
continue;
case 112:
