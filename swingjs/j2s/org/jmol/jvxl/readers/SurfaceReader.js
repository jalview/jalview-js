...
if (!this.jvxlData.isValid) $I$(2).error$S("no isosurface points were found!");
 else (function(a,f){return f.apply(null,a)})(["boundbox corners " + $I$(3).eP$javajs_util_T3(this.xyzMin) + " " + $I$(3).eP$javajs_util_T3(this.xyzMax) ],$I$(2).info$S);
...
if (!this.isQuiet) (function(a,f){return f.apply(null,a)})(["reading data progressively -- yzCount = " + this.yzCount],$I$(2).info$S);
...
(function(a,f){return f.apply(null,a)})(["Exception in SurfaceReader::readSurfaceData: " + e.toString()],$I$(2).error$S);
} else {
throw e;
}
}
...
this.jvxlData.minColorIndex=(function(a,f){return f.apply(null,a)})([$I$(5).getColix$I(this.params.isColorReversed ? this.params.colorPos : this.params.colorNeg), this.jvxlData.translucency != 0 , this.jvxlData.translucency],$I$(5).getColixTranslucent3$H$Z$F);
this.jvxlData.maxColorIndex=(function(a,f){return f.apply(null,a)})([$I$(5).getColix$I(this.params.isColorReversed ? this.params.colorNeg : this.params.colorPos), this.jvxlData.translucency != 0 , this.jvxlData.translucency],$I$(5).getColixTranslucent3$H$Z$F);
...
(function(a,f){return f.apply(null,a)})([this.jvxlData, (saveColorData ? this.meshData.vvs : null)],$I$(9).jvxlCreateColorData$org_jmol_jvxl_data_JvxlData$FA);
...
colors[i]=(function(a,f){return f.apply(null,a)})([this.params.colorEncoder.getArgb$F(v)],$I$(5).getColixTranslucent$I);
}
