(function(){var P$=Clazz.newPackage("org.jmol.jvxl.readers"),I$=[[0,'javajs.util.P3','javajs.util.PT']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
for (var i=0, n=values.length; i < n; i++) values[i]=(function(a,f){return f.apply(null,a)})([list.get$I(i)],$I$(2).parseFloat$S);
