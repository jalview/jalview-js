(function(){var P$=Clazz.newPackage("org.jmol.jvxl.data"),p$1={},I$=[[0,'javajs.util.BS',['org.jmol.jvxl.data.MeshData','.SSet'],'java.util.Arrays',['org.jmol.jvxl.data.MeshData','.SortSet'],'javajs.util.AU','javajs.util.V3']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
(function(a,f){return f.apply(null,a)})([sets, Clazz.new_($I$(4,1),[this, null])],$I$(3).sort$OA$java_util_Comparator);
