(function(){var P$=Clazz.newPackage("org.jmol.jvxl.calc"),p$1={},I$=[[0,'javajs.util.P3',['org.jmol.jvxl.calc.MarchingSquares','.ContourVertex'],['org.jmol.jvxl.calc.MarchingSquares','.Triangle'],'java.util.Hashtable','javajs.util.AU','org.jmol.util.Logger']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "MarchingSquares", function(){
Clazz.newInstance(this, arguments,0,C$);
});
C$.$classes$=[['ContourVertex',2],['Triangle',2]];

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.thisContour=0;
this.pointA=Clazz.new_($I$(1,1));
this.pointB=Clazz.new_($I$(1,1));
...
this.htPts=Clazz.new_($I$(4,1));
},1);

C$.$fields$=[['Z',['contourFromZero'],'F',['valueMin','valueMax','contourPlaneMinimumValue','contourPlaneMaximumValue'],'I',['nContourSegments','contourType','thisContour','contourVertexCount','triangleCount'],'O',['surfaceReader','org.jmol.jvxl.api.VertexDataServer','volumeData','org.jmol.jvxl.data.VolumeData','pointA','javajs.util.P3','+pointB','contoursDiscrete','float[]','contourVertexes','org.jmol.jvxl.calc.MarchingSquares.ContourVertex[]','contourValuesUsed','float[]','ptTemp','javajs.util.P3','triangles','org.jmol.jvxl.calc.MarchingSquares.Triangle[]','htPts','java.util.Map']]]
...
this.contourVertexes[this.contourVertexCount++]=Clazz.new_($I$(2,1).c$$javajs_util_P3,[this, null, vertexXYZ]);
return vPt;
});
...
this.triangles[this.triangleCount++]=Clazz.new_($I$(3,1).c$$I$I$I$I$I,[this, null, iA, iB, iC, check, iContour]);
return 0;
});
...
(function(a,f){return f.apply(null,a)})(["#contour " + (i + 1) + " " + new Float(cutoff).toString() + " " + this.triangleCount ],$I$(6).info$S);
this.htPts.clear$();
...
}}}this.htPts.put$O$O(key, Integer.valueOf$I(iPt));
return iPt;
}, p$1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.MarchingSquares, "ContourVertex", function(){
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.MarchingSquares, "Triangle", function(){
Clazz.newInstance(this, arguments[0],true,C$);
});
...
C$.$fields$=[['Z',['isValid'],'I',['check','contourIndex'],'O',['pts','int[]']]]
