...
this.exportScale=10;
}(function(a,f){return f.apply(null,a)})(["__Exporter exportScale: " + new Float(this.exportScale).toString()],$I$(3).info$S);
...
ms.pis=(function(a,f){return f.apply(null,a)})([ms.pc=n],$I$(8).newInt2$I);
