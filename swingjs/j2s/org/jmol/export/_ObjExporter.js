...
var face=data.pis[i];
sum.set$F$F$F(0, 0, 0);
for (var iVertex, $iVertex = 0, $$iVertex = face; $iVertex<$$iVertex.length&&((iVertex=($$iVertex[$iVertex])),1);$iVertex++) sum.add$javajs_util_T3($I$(17,"colorPtFromInt$I$javajs_util_P3",[this.gdata.getColorArgbOrGray$H(colixes[iVertex]), ptTemp]));
