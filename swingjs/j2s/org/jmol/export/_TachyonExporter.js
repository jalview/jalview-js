(function(){var P$=Clazz.newPackage("org.jmol.export"),p$1={},I$=[[0,'org.jmol.export.UseTable','org.jmol.export.___Exporter','org.jmol.viewer.Viewer','javajs.util.SB']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.lighting=" AMBIENT " + $I$(2,"round$D",[this.gdata.getAmbientPercent$() / 100.0]) + " DIFFUSE " + $I$(2,"round$D",[this.gdata.getDiffusePercent$() / 100.0]) + " SPECULAR " + $I$(2,"round$D",[this.gdata.getSpecularPercent$() / 100.0]) ;
...
this.output$S(" Inner " + $I$(2,"round$D",[(doFill ? 0 : radius * 0.95)]));
