(function(){var P$=Clazz.newPackage("org.jmol.export"),p$1={},I$=[[0,'javajs.util.P3','org.jmol.api.Interface','org.jmol.g3d.HermiteRenderer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if ((this.exporter=(function(a,f){return f.apply(null,a)})(["export." + (this.webGL ? "" : "_") + this.exportName + "Exporter" , vwr, "export"],$I$(2).getOption$S$org_jmol_viewer_Viewer$S)) == null ) return null;
