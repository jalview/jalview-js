(function(){var P$=Clazz.newPackage("org.jmol.export"),p$1={},I$=[[0,'org.jmol.viewer.Viewer','org.jmol.export.___Exporter','javajs.util.Measure','javajs.util.P4']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var plane=(function(a,f){return f.apply(null,a)})([screenBase, screenTip, this.tempP1, this.tempV1, this.tempV2, Clazz.new_($I$(4,1))],$I$(3).getPlaneThroughPoints$javajs_util_T3$javajs_util_T3$javajs_util_T3$javajs_util_V3$javajs_util_V3$javajs_util_P4);
