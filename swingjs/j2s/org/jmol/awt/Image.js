(function(){var P$=Clazz.newPackage("org.jmol.awt"),I$=[[0,'java.awt.image.DirectColorModel','java.awt.Toolkit','javajs.util.AU','org.jmol.api.Interface','java.awt.image.MemoryImageSource','javax.swing.JPanel','java.awt.MediaTracker','java.awt.image.PixelGrabber','java.awt.AlphaComposite','java.awt.Color','java.awt.image.BufferedImage','java.awt.image.Raster','java.awt.image.SinglePixelPackedSampleModel','java.awt.image.DataBufferInt','java.awt.RenderingHints','org.jmol.console.ImageDialog']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var w=(o[1]).intValue$();
var h=(o[2]).intValue$();
return c.createImage$java_awt_image_ImageProducer(Clazz.new_($I$(5,1).c$$I$I$IA$I$I,[w, h, o[0], 0, w]));
...
if (display == null ) display=Clazz.new_($I$(6,1));
var mediaTracker=Clazz.new_($I$(7,1).c$$java_awt_Component,[display]);
...
var image=imageobj;
var pixelGrabber=(pixels == null  ? Clazz.new_($I$(8,1).c$$java_awt_Image$I$I$I$I$Z,[image, 0, 0, width, height, true]) : Clazz.new_($I$(8,1).c$$java_awt_Image$I$I$I$I$IA$I$I,[image, 0, startRow, width, nRows, pixels, 0, width]));
try {
...
g.setColor$java_awt_Color(bgcolor == 0 ? Clazz.new_($I$(10,1).c$$I$I$I$I,[0, 0, 0, 0]) : Clazz.new_($I$(10,1).c$$I,[bgcolor]));
...
return Clazz.new_([w, h, (image).getType$()],$I$(11,1).c$$I$I$I);
}, 1);

Clazz.newMeth(C$, 'newBufferedImage$I$I', function (w, h) {
return Clazz.new_($I$(11,1).c$$I$I$I,[w, h, 2]);
}, 1);

Clazz.newMeth(C$, 'allocateRgbImage$I$I$IA$I$Z', function (windowWidth, windowHeight, pBuffer, windowSize, backgroundTransparent) {
return Clazz.new_([C$.rgbColorModel, (function(a,f){return f.apply(null,a)})([Clazz.new_($I$(13,1).c$$I$I$I$IA,[3, windowWidth, windowHeight, C$.sampleModelBitMasks]), Clazz.new_($I$(14,1).c$$IA$I,[pBuffer, windowSize]), null],$I$(12).createWritableRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point), false, null],$I$(11,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable);
}, 1);
...
return Clazz.new_($I$(16,1).c$$org_jmol_viewer_Viewer$S$java_util_Map,[vwr, title, imageMap]);
}, 1);
