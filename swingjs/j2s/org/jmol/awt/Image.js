(function(){var P$=Clazz.newPackage("org.jmol.awt"),I$=[[0,'java.awt.image.DirectColorModel','java.awt.image.BufferedImage','java.awt.image.Raster','java.awt.image.SinglePixelPackedSampleModel','java.awt.image.DataBufferInt','java.awt.Toolkit','javajs.util.AU','org.jmol.api.Interface','java.awt.image.MemoryImageSource','javax.swing.JPanel','java.awt.MediaTracker','java.awt.image.PixelGrabber','java.awt.AlphaComposite','java.awt.Color','org.jmol.viewer.Viewer','java.awt.RenderingHints','org.jmol.console.ImageDialog']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (!$I$(15).isJS) {
g2d.setRenderingHint$java_awt_RenderingHints_Key$O($I$(16).KEY_TEXT_ANTIALIASING, $I$(16).VALUE_TEXT_ANTIALIAS_ON);
g2d.setRenderingHint$java_awt_RenderingHints_Key$O($I$(16).KEY_ANTIALIASING, $I$(16).VALUE_ANTIALIAS_OFF);
g2d.setRenderingHint$java_awt_RenderingHints_Key$O($I$(16).KEY_RENDERING, $I$(16).VALUE_RENDER_SPEED);
}return g2d;
}, 1);
...
return Clazz.new_($I$(17,1).c$$org_jmol_viewer_Viewer$S$java_util_Map,[vwr, title, imageMap]);
}, 1);
