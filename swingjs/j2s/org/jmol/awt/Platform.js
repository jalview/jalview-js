...
var jmolpopup=(function(a,f){return f.apply(null,a)})([type == "j" ? "awt.AwtJmolPopup" : "awt.AwtModelKitPopup", null, null],$I$(2).getOption$S$org_jmol_viewer_Viewer$S);
...
return (function(a,f){return f.apply(null,a)})([font.getFontMetrics$(), text],$I$(5).stringWidth$O$S);
});
...
return "D:" + Clazz.new_($I$(8,1).c$$S,["YYYYMMddHHmmssX"]).format$java_util_Date(Clazz.new_($I$(9,1))) + "'00'" ;
} else if (isoType.contains$CharSequence("8601")) {
return Clazz.new_($I$(8,1).c$$S,["yyyy-MM-dd\'T\'HH:mm:ss"]).format$java_util_Date(Clazz.new_($I$(9,1)));
}return Clazz.new_($I$(8,1).c$$S,[isoType]).format$java_util_Date(Clazz.new_($I$(9,1)));
});

Clazz.newMeth(C$, 'newFile$S', function (name) {
return Clazz.new_($I$(10,1).c$$S,[name]);
});
...
return (function(a,f){return f.apply(null,a)})([this.newFile$S(fileName)],$I$(10).getLocalUrl$org_jmol_api_GenericFileInterface);
});
