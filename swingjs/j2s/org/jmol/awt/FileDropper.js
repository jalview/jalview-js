...
switch (this.vwr.ms.ac > 0 && !isScript  && !isSurface  ? (function(a,f){return f.apply(null,a)})([null, $I$(5).$$S("Would you like to replace the current model with the selected model?")],$I$(4).showConfirmDialog$java_awt_Component$O) : 0) {
case 2:
return;
case 0:
break;
...
(function(a,f){return f.apply(null,a)})(["  class: " + flavor.getRepresentationClass$().getName$()],$I$(8).info$S);
(function(a,f){return f.apply(null,a)})(["  mime : " + flavor.getMimeType$()],$I$(8).info$S);
...
if ($I$(8).debugging) {
(function(a,f){return f.apply(null,a)})(["  String: " + o.toString()],$I$(8).debug$S);
