(function(){var P$=Clazz.newPackage("org.jmol.awt"),I$=[[0,'java.awt.Toolkit','java.awt.image.MemoryImageSource','java.awt.Point','java.awt.Cursor','javax.swing.JOptionPane','javajs.util.PT','javax.swing.SwingUtilities']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var i=(function(a,f){return f.apply(null,a)})([null, label, "Jmol prompt", -1, 1, null, list, list == null  ? "OK" : list[0]],$I$(5).showOptionDialog$java_awt_Component$O$S$I$I$javax_swing_Icon$OA$O);
