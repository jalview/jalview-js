(function(){var P$=Clazz.newPackage("org.jmol.awt"),I$=[[0,'java.io.File','java.io.BufferedInputStream','java.io.FileInputStream','org.jmol.viewer.Viewer','java.io.OutputStreamWriter','javajs.util.PT']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
for (var i=0; i < C$.urlPrefixPairs.length; i+=2) if (path.indexOf$S(C$.urlPrefixPairs[i]) > 0) return C$.urlPrefixPairs[i + 1] + (function(a,f){return f.apply(null,a)})([path.substring$I(path.indexOf$S(C$.urlPrefixPairs[i]) + C$.urlPrefixPairs[i].length$()), "/"],$I$(6).trim$S$S);
