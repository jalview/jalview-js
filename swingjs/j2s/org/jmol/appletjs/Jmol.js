(function(){var P$=Clazz.newPackage("org.jmol.appletjs"),I$=[[0,'java.util.Hashtable','org.jmol.util.Parser','org.jmol.util.Logger','javajs.util.PT','org.jmol.awtjs2d.Platform']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var surl=(function(a,f){return f.apply(null,a)})([url.toString(), "?POST?"],$I$(4).split$S$S);
if (surl.length == 1) {
{
window.open(surl[0]);
}
...
if (Clazz.exceptionOf(e,"Exception")){
(function(a,f){return f.apply(null,a)})(["# error evaluating " + strEval + ":" + e.toString() ],$I$(3).error$S);
} else {
throw e;
}
}
