(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.quantum"),p$1={},I$=[[0,'org.jmol.util.Logger','javajs.util.Lst','org.jmol.adapter.smarter.AtomSetCollectionReader','javajs.util.PT','javajs.util.V3']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (Float.isNaN$F(x) || Float.isNaN$F(y) || Float.isNaN$F(z)  ) break;
var atom=this.asc.addNewAtom$();
atom.elementSymbol=$I$(3,"getElementSymbol$I",[this.parseIntRange$S$I$I(this.line, 11, 14)]);
...
var dipole=$I$(5,"new3$F$F$F",[this.parseFloatStr$S(tokens[0]), this.parseFloatStr$S(tokens[1]), this.parseFloatStr$S(tokens[2])]);
