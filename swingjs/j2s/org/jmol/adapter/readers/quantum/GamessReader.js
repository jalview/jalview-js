(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.quantum"),p$1={},I$=[[0,'javajs.util.PT','javajs.util.Lst','java.util.Hashtable','org.jmol.adapter.readers.quantum.BasisFunctionReader','javajs.util.AU','org.jmol.util.Logger']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var tokens=(function(a,f){return f.apply(null,a)})([this.line.substring$I(this.line.indexOf$S("ENERGY"))],$I$(1).getTokens$S);
...
this.shellCount++;
slater=Clazz.array(Integer.TYPE, -1, [(function(a,f){return f.apply(null,a)})([this.fixShellTag$S(tokens[1])],$I$(4).getQuantumShellTagID$S), this.gaussianCount, 0]);
nGaussians=0;
}++nGaussians;
++this.gaussianCount;
...
if (this.debugging) {
(function(a,f){return f.apply(null,a)})([(this.vibrationNumber + 1) + " frequency=" + new Float(frequency).toString() ],$I$(6).debug$S);
}}
var red_masses=null;
...
var tokens=(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([this.line, "=", " = "],$I$(1).rep$S$S$S) + " ?"],$I$(1).getTokens$S);
for (var i=0; i < tokens.length; i++) {
...
if (this.debugging) (function(a,f){return f.apply(null,a)})([key + " = " + value ],$I$(6).debug$S);
