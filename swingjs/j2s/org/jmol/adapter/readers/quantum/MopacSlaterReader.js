(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.quantum"),I$=[[0,'org.jmol.adapter.readers.quantum.SlaterReader']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (el == 3) {
return 0;
}return (function(a,f){return f.apply(null,a)})([el + er + 1 , Math.abs(zeta), ex, ey],$I$(1).getSlaterConstDSpherical$I$D$I$I);
});
