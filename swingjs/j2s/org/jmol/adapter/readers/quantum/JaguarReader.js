(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.quantum"),p$1={},I$=[[0,'org.jmol.util.Logger','javajs.util.AU','javajs.util.Lst','javajs.util.PT','org.jmol.adapter.readers.quantum.BasisFunctionReader','Boolean','java.util.Hashtable']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (this.debugging) {
(function(a,f){return f.apply(null,a)})([sarray.size$() + " slater shells read"],$I$(1).debug$S);
...
(function(a,f){return f.apply(null,a)})([sarray.size$() + " slater shells read"],$I$(1).debug$S);
$I$(1).debug$S(this.gaussianCount + " gaussian primitives read");
}this.moData.put$O$O("isNormalized", $I$(6).TRUE);
}, p$1);
