...
if (this.isOpenShell) this.asc.setCurrentModelInfo$S$O("isOpenShell", Boolean.TRUE);
...
if (this.nboParser == null ) this.nboParser=Clazz.new_($I$(4,1));
...
if (structures == null ) this.asc.setCurrentModelInfo$S$O("nboStructures", structures=Clazz.new_($I$(6,1)));
return structures;
}, p$1);
...
this.gaussians=$I$(7).newFloat2$I(this.gaussianCount);
...
var tokens=$I$(8,"getTokens$S",[this.rd$()]);
...
for (var i=0; i < ac; i++) {
tokens=$I$(8,"getTokens$S",[this.rd$()]);
...
tokens=$I$(8).getTokens$S(this.line);
var type=tokens[0];
...
for (var i=0, pt=0; i < tokens.length; i++, pt+=10) tokens[i]=$I$(8,"rep$S$S$S",[sb.substring2$I$I(pt, pt + 10), " ", ""]);
...
for (var i=0; i < this.nOrbitals; i++) this.setMO$java_util_Map(Clazz.new_($I$(9,1)));
...
$I$(4,"getStructures46$SA$S$javajs_util_Lst$I",[map.get$O("NBO"), "alpha", structures, this.asc.ac]);
$I$(4,"getStructures46$SA$S$javajs_util_Lst$I",[map.get$O("beta_NBO"), "beta", structures, this.asc.ac]);
}, p$1);
...
var ext=$I$(10).getNBOTypeFromName$S(nboType);
var isAO=nboType.equals$O("AO");
var isNBO=nboType.equals$O("NBO");
var hasNoBeta=$I$(8).isOneOf$S$S(nboType, ";AO;PNAO;NAO;");
...
coefs[j]=$I$(8).parseFloatChecked$S$I$IA$Z(data, len, next, false);
...
for (var j=0; j < nAOs; j++) occupancies[j]=$I$(8).parseFloatChecked$S$I$IA$Z(data, len, next, false);
...
var discardExtra=$I$(8).isOneOf$S$S(this.nboType, ";NBO;NLMO;");
var hasNoBeta=$I$(8).isOneOf$S$S(this.nboType, ";AO;PNAO;NAO;");
...
var addOccupancy=!$I$(8).isOneOf$S$S(moType, ";AO;NAO;PNAO;MO;NO;");
