(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.quantum"),I$=[[0,'javajs.util.Lst','org.jmol.quantum.SlaterData','org.jmol.util.Logger','java.util.Arrays',['org.jmol.adapter.readers.quantum.SlaterReader','.SlaterSorter'],'java.util.Map',['org.jmol.adapter.readers.quantum.SlaterReader','.OrbitalSorter']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (doSort) {
$I$(4,"sort$OA$java_util_Comparator",[this.slaterArray, Clazz.new_($I$(5,1),[this, null])]);
...
$I$(4,"sort$OA$java_util_Comparator",[array, Clazz.new_($I$(7,1),[this, null])]);
this.orbitals.clear$();
