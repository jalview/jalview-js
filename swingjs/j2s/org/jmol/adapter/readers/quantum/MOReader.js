(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.quantum"),p$1={},I$=[[0,'javajs.util.PT','org.jmol.util.Logger','javajs.util.Lst','javajs.util.AU','java.util.Hashtable','org.jmol.adapter.readers.quantum.BasisFunctionReader','org.jmol.quantum.QS']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
break;
case 100:
dCoeffLabels += " " + $I$(6,"canonicalizeQuantumSubshellTag$S",[type.toUpperCase$()]);
break;
case 102:
fCoeffLabels += " " + $I$(6,"canonicalizeQuantumSubshellTag$S",[type.toUpperCase$()]);
break;
case 115:
}
}} else {
...
if (!this.haveCoeffMap && nChar == 3 ) fCoeffLabels += " " + $I$(6,"canonicalizeQuantumSubshellTag$S",[type.toUpperCase$()]);
 else if (!this.haveCoeffMap && nChar == 2 ) dCoeffLabels += " " + $I$(6,"canonicalizeQuantumSubshellTag$S",[type.toUpperCase$()]);
...
for (var i=this.moTypes.size$(); --i >= 0; ) ht.put$O$O($I$(1,"rep$S$S$S",[this.moTypes.get$I(i).substring$I(10), " ", ""]), Integer.valueOf$I(i + this.iMo0));
...
strSecondOrderData.addLast$O(Clazz.array(String, -1, [$I$(1,"rep$S$S$S",[this.line.substring$I$I(5, 27).trim$(), " ", ""]), $I$(1,"rep$S$S$S",[this.line.substring$I$I(32, 54).trim$(), " ", ""]), this.line.substring$I$I(55, 62).trim$(), this.line.substring$I(71).trim$()]));
}
