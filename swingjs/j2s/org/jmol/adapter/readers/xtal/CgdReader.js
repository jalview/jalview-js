(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.xtal"),p$1={},I$=[[0,'javajs.util.V3','javajs.util.Lst','org.jmol.util.Logger','javajs.util.PT','java.util.Hashtable','javajs.util.P3','javajs.util.M3','org.jmol.adapter.smarter.Bond']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
}(function(a,f){return f.apply(null,a)})(["CgdReader using GROUP " + name + (name0 == null  ? "" : " alias of " + name0) ],$I$(3).info$S);
return name;
}, p$1);
...
this.tokens=(function(a,f){return f.apply(null,a)})([this.line=this.edgeData.get$I(j)],$I$(4).getTokens$S);
...
return (function(a,f){return f.apply(null,a)})([$I$(4).parseFloatFraction$S(this.tokens[i++]), $I$(4).parseFloatFraction$S(this.tokens[i++]), $I$(4).parseFloatFraction$S(this.tokens[i++])],$I$(6).new3$F$F$F);
}, p$1);
...
if (b != null ) this.asc.addBond$org_jmol_adapter_smarter_Bond(Clazz.new_($I$(8,1).c$$I$I$I,[a.index, b.index, 1]));
 else if (pt.x >= 0  && pt.x <= 1   && pt.y >= 0   && pt.y <= 1   && pt.z >= 0   && pt.z <= 1  ) (function(a,f){return f.apply(null,a)})([" not found: i=" + i + "  pt=" + pt + " for a=" + a + "\n a0=" + a0 + " edge[" + j + "]=" + edges[j] + "\n a.vib=" + a.vib + "\n m=" + m ],$I$(3).error$S);
}
a.vib=null;
}
}, p$1);
