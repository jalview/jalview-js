...
(function(a,f){return f.apply(null,a)})(["Looking for q-pt=" + this.desiredQpt],$I$(3).info$S);
}, p$1);
...
(function(a,f){return f.apply(null,a)})(["error reading coordinates of lattice vector " + Integer.toString$I(i + 1) + " in %BLOCK LATTICE_CART in CASTEP .cell file" ],$I$(3).warn$S);
return;
}if (p$1.tokenizeCastepCell.apply(this, []) == 0) return;
}
...
var qvec=(function(a,f){return f.apply(null,a)})([this.parseFloatStr$S(this.tokens[2]), this.parseFloatStr$S(this.tokens[3]), this.parseFloatStr$S(this.tokens[4])],$I$(1).new3$F$F$F);
