(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.xtal"),p$1={},I$=[[0,'javajs.util.PT','org.jmol.util.Logger','javajs.util.DF']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.rd$();
if (this.line.contains$CharSequence("Ef")) this.totE=Double.valueOf$D(Double.parseDouble$S((function(a,f){return f.apply(null,a)})([this.line.substring$I$I(this.line.indexOf$S("Ef") + 1, this.line.indexOf$S("Ha"))],$I$(1).getTokens$S)[1]));
}, p$1);
...
if (this.debugging) (function(a,f){return f.apply(null,a)})([(this.vibrationNumber + n) + " frequency=" + new Float(frequencies[n]).toString() ],$I$(2).debug$S);
}
