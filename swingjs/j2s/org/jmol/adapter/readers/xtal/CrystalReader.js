...
this.line=(function(a,f){return f.apply(null,a)})([this.line, "( ", "("],$I$(3).rep$S$S$S);
...
var xyz=(function(a,f){return f.apply(null,a)})([f * this.parseFloatStr$S(value.substring$I$I(0, 12)), f * this.parseFloatStr$S(value.substring$I$I(12, 24)), f * this.parseFloatStr$S(value.substring$I$I(24, 36))],$I$(1).new3$F$F$F);
m.put$O$O("point", xyz);
...
var pt=3;
var cellOffset=(tokens.length == 9 ? (function(a,f){return f.apply(null,a)})([this.parseFloatStr$S(tokens[pt++]), this.parseFloatStr$S(tokens[pt++]), this.parseFloatStr$S(tokens[pt++])],$I$(1).new3$F$F$F) : null);
...
(function(a,f){return f.apply(null,a)})(["state:" + this.state + " Symmop " + this.symops.size$() + ": " + xyz ],$I$(5).info$S);
}}
}, p$1);
...
}this.matUnitCellOrientation=(function(a,f){return f.apply(null,a)})([Clazz.new_($I$(1,1)), a, b],$I$(11).getQuaternionFrame$javajs_util_P3$javajs_util_T3$javajs_util_T3).getMatrix$();
$I$(5).info$S("oriented unit cell is in model " + this.asc.atomSetCount);
}, p$1);

Clazz.newMeth(C$, 'readPrimitiveLatticeVectors', function () {
this.primitiveToCrystal=(function(a,f){return f.apply(null,a)})([this.fillFloatArray$S$I$FA(null, 0, Clazz.array(Float.TYPE, [9]))],$I$(10).newA9$FA);
}, p$1);
...
var tokens=(function(a,f){return f.apply(null,a)})([this.rd$()],$I$(3).getTokens$S);
if (this.isSlab) {
...
atom.elementSymbol=(function(a,f){return f.apply(null,a)})([p$1.getAtomicNumber$S.apply(this, [tokens[pt++]])],$I$(12).getElementSymbol$I);
...
return (s.length$() > 1 && (function(a,f){return f.apply(null,a)})([s.charAt$I(1)],$I$(3).isLetter$C)  ? s.substring$I$I(0, 1) + Character.toLowerCase$C(s.charAt$I(1)) + s.substring$I(2)  : s);
}, 1);
...
var atom=this.asc.addNewAtom$();
var tokens=(function(a,f){return f.apply(null,a)})([this.lstCoords.get$I(i)],$I$(3).getTokens$S);
...
Sfrag=(function(a,f){return f.apply(null,a)})([Sfrag, "(", " "],$I$(3).rep$S$S$S);
...
var tokens=(function(a,f){return f.apply(null,a)})([this.line.substring$I(15)],$I$(3).getTokens$S);
...
if (this.debugging) (function(a,f){return f.apply(null,a)})([(this.vibrationNumber + i) + " frequency=" + new Float(frequencies[i]).toString() ],$I$(5).debug$S);
}
...
this.asc.setAtomSetName$S((this.isLongMode ? "LO " : "") + data[0] + " " + $I$(13).formatDecimal$F$I(freq, 2) + " cm-1 (" + (function(a,f){return f.apply(null,a)})([Float.parseFloat$S(data[1]), 0],$I$(13).formatDecimal$F$I) + " km/Mole), " + activity );
}, p$1);
...
var data="";
while (this.rd$() != null  && (this.line.length$() < 4 || (function(a,f){return f.apply(null,a)})([this.line.charAt$I(3)],$I$(3).isDigit$C) ) )data += this.line;
...
tokens=(function(a,f){return f.apply(null,a)})([this.readLines$I(3)],$I$(3).getTokens$S);
