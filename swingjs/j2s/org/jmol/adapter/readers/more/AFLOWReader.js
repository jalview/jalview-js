(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.more"),p$1={},I$=[[0,'java.util.Hashtable','javajs.util.PT','javajs.util.BS','org.jmol.util.Logger','javajs.util.SB','javajs.util.Lst','java.util.Arrays']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.keyMap.put$O$O(key, kclean=$I$(2,"trim$S$S",[$I$(2,"rep$S$S$S",[ String.instantialize(chars), "__", "_"]), "_"]));
return kclean;
}, p$1);
