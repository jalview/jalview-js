...
}(function(a,f){return f.apply(null,a)})(["Total number of atoms used=" + this.nAtoms],$I$(3).info$S);
...
var n=(function(a,f){return f.apply(null,a)})([this.line.substring$I(this.line.indexOf$S("("))],$I$(5).getFortranFormatLengths$S).get$I(0).intValue$();
var i=0;
var len=0;
while (true){
if (i >= len) {
...
this.htParams.put$O$O("isPeriodic", $I$(6).TRUE);
}(function(a,f){return f.apply(null,a)})(["Total number of atoms read=" + this.ac],$I$(3).info$S);
...
(function(a,f){return f.apply(null,a)})(["Total number of residues=" + resPtrs.length],$I$(3).info$S);
var pt1=this.ac;
var pt2;
var atoms=this.asc.atoms;
