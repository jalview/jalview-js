(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.pymol"),p$1={},I$=[[0,'org.jmol.util.BSUtil','javajs.util.SB','javajs.util.PT','org.jmol.util.Escape','org.jmol.adapter.readers.pymol.PyMOLReader','javajs.util.P3']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var min=(function(a,f){return f.apply(null,a)})([$I$(5).listAt$javajs_util_Lst$I(mep, 3), 0],$I$(5).floatAt$javajs_util_Lst$I);
var max=(function(a,f){return f.apply(null,a)})([$I$(5).listAt$javajs_util_Lst$I(mep, 3), 2],$I$(5).floatAt$javajs_util_Lst$I);
sb=Clazz.new_($I$(2,1));
