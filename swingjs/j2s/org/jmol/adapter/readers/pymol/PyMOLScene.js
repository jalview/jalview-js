...
return Clazz.new_($I$(10,1).c$$I$S$javajs_util_BS$O,[id, this.objectNameID, bsAtoms, info]);
}, p$1);
...
myGroup.type=type;
if (!myGroup.visible) {
this.occludedObjects.put$O$O(this.objectNameID, Boolean.TRUE);
...
for (var i=0; i < nCoord; i++, p+=3) points.addLast$O($I$(5,"pointAt$javajs_util_Lst$I$javajs_util_P3",[list, p, Clazz.new_($I$(15,1))]));
...
md.set$I$java_util_Map$org_jmol_atomdata_RadiusData$S$S$S$org_jmol_modelset_TickInfo$Z$Z$Boolean$Z$I$H$org_jmol_modelset_Text$F(12290, null, null, null, strFormat, "angstroms", null, false, false, null, false, ((rad * 2000)|0), colix, text, NaN);
...
sb.append$S(";moveto 0 PyMOL " + $I$(17).eAF$FA(pymolView));
sb.append$S(";save orientation \'default\';");
return sb;
});

Clazz.newMeth(C$, 'getColix$I$F', function (colorIndex, translucency) {
var colix=(colorIndex == -7 ? ($I$(13).getBgContrast$I(this.bgRgb) == 8 ? 4 : 8) : colorIndex == -6 ? $I$(13).getBgContrast$I(this.bgRgb) : $I$(13,"getColixO$O",[Integer.valueOf$I($I$(6).getRGB$I(colorIndex))]));
return $I$(13).getColixTranslucent3$H$Z$F(colix, translucency > 0 , translucency);
});
...
var t=$I$(19,"newLabel$org_jmol_viewer_Viewer$org_jmol_util_Font$S$H$H$I$F",[this.vwr, font, label, this.getColix$I$F(colorIndex, 0), 0, 0, 0]);
...
var bs=e.getValue$();
p$1.addJmolObject$I$javajs_util_BS$O.apply(this, [1140850689, bs, null]).rd=Clazz.new_([null, r, $I$(21).ABSOLUTE, $I$(22).AUTO],$I$(20,1).c$$FA$F$org_jmol_atomdata_RadiusData_EnumType$org_jmol_c_VDW);
}
this.htSpacefill.clear$();
}, p$1);
...
if (!Float.isNaN$F(trans)) b.colix=$I$(13,"getColixTranslucent3$H$Z$F",[colix, trans != 0 , trans]);
