...
C$.$fields$=[['Z',['cartoonLadderMode','cartoonRockets','haveNucleicLadder','objectHidden','doCache','haveScenes','solventAccessible'],'F',['cartoonTranslucency','ribbonTranslucency','labelSize','meshWidth','nonbondedSize','nonbondedTranslucency','sphereScale','sphereTranslucency','stickTranslucency','transparency'],'I',['pymolVersion','bgRgb','dotColor','surfaceMode','surfaceColor','cartoonColor','ribbonColor','sphereColor','labelFontId','labelColor','objectType','baseModelIndex','baseAtomIndex','stateCount','thisState','currentAtomSetIndex'],'S',['objectName','objectNameID','objectJmolName','mepList','surfaceInfoName'],'O',['vwr','org.jmol.viewer.Viewer','bsHidden','javajs.util.BS','+bsNucleic','+bsNonbonded','+bsLabeled','+bsHydrogen','+bsNoSurface','htSpacefill','java.util.Map','+ssMapAtom','atomColorList','javajs.util.Lst','occludedObjects','java.util.Map','+labels','colixes','short[]','frameObj','org.jmol.adapter.readers.pymol.JmolObject','groups','java.util.Map','+objectSettings','bsCartoon','javajs.util.BS','htCarveSets','java.util.Map','+htDefinedAtoms','+htHiddenObjects','moleculeNames','javajs.util.Lst','+jmolObjects','htAtomMap','java.util.Map','+htObjectAtoms','+htObjectGroups','+htMeasures','+htObjectSettings','+objectInfo','settings','javajs.util.Lst','htStateSettings','java.util.Map','+stateSettings','+uniqueSettings','+uniqueList','bsUniqueBonds','javajs.util.BS','labelPosition','javajs.util.P3','+labelPosition0','bsAtoms','javajs.util.BS','reader','org.jmol.api.PymolAtomReader','uniqueIDs','int[]','+cartoonTypes','+sequenceNumbers','newChain','boolean[]','radii','float[]','bsCarve','javajs.util.BS','+bsLineBonds','+bsStickBonds','ptTemp','javajs.util.P3']]
,['O',['MEAS_DIGITS','int[]']]]
...
return (Clazz.instanceOf(o, "java.lang.Integer") ? (o).intValue$() : (function(a,f){return f.apply(null,a)})([$I$(5).pointAt$javajs_util_Lst$I$javajs_util_P3(o, 0, this.ptTemp)],$I$(7).colorPtToFFRGB$javajs_util_T3));
}, p$1);

Clazz.newMeth(C$, 'pointSetting$I', function (i) {
var pt=Clazz.new_($I$(4,1));
var pos=$I$(5).listAt$javajs_util_Lst$I(this.settings, i);
if (pos != null  && pos.size$() == 3 ) return (function(a,f){return f.apply(null,a)})([pos.get$I(2), 0, pt],$I$(5).pointAt$javajs_util_Lst$I$javajs_util_P3);
...
this.htObjectGroups.put$O$O(this.objectNameID, groupName);
}this.objectInfo.put$O$O(this.objectName, Clazz.array(java.lang.Object, -1, [this.objectNameID, Integer.valueOf$I(type)]));
...
this.htStateSettings.put$O$O(this.objectNameID, this.stateSettings);
...
(function(a,f){return f.apply(null,a)})([$I$(5).listAt$javajs_util_Lst$I(setting, 2), 0, this.labelPosition],$I$(5).pointAt$javajs_util_Lst$I$javajs_util_P3);
} catch (e) {
...
(function(a,f){return f.apply(null,a)})(["PyMOLScene - generateScene " + scene.get$O("name")],$I$(8).info$S);
...
var id=$I$(5).stringAt$javajs_util_Lst$I(selection, 0);
...
if (tok == 12294) this.htHiddenObjects.put$O$O(name, $I$(9).TRUE);
...
return Clazz.new_($I$(11,1).c$$I$S$javajs_util_BS$O,[id, this.objectNameID, bsAtoms, info]);
}, p$1);
...
myGroup.type=type;
if (!myGroup.visible) {
this.occludedObjects.put$O$O(this.objectNameID, $I$(9).TRUE);
this.htHiddenObjects.put$O$O(this.objectName, $I$(9).TRUE);
...
var g=this.groups.get$O(name);
if (g == null ) {
this.groups.put$O$O(name, (g=Clazz.new_($I$(12,1).c$$S,[name])));
...
for (var e, $e = this.htCarveSets.entrySet$().iterator$(); $e.hasNext$()&&((e=($e.next$())),1);) p$1.getSelectionAtoms$javajs_util_Lst$I$javajs_util_BS.apply(this, [(function(a,f){return f.apply(null,a)})([htObjNames.get$O(e.getKey$()), 5],$I$(5).listAt$javajs_util_Lst$I), 0, e.getValue$()]);
...
}this.labels.put$O$O(Integer.valueOf$I(atomIndex), p$1.newTextLabel$S$FA$I$I$F.apply(this, [label, labelPos, icolor, this.labelFontId, this.labelSize]));
});
...
if ($I$(8).debugging) (function(a,f){return f.apply(null,a)})(["Pymol unique setting for " + id + ": [" + key + "] = " + new Float(v).toString() ],$I$(8).debug$S);
return v;
});
...
pt=Clazz.new_($I$(4,1));
(function(a,f){return f.apply(null,a)})([setting.get$I(2), 0, pt],$I$(5).pointAt$javajs_util_Lst$I$javajs_util_P3);
(function(a,f){return f.apply(null,a)})(["Pymol unique setting for " + id + ": " + key + " = " + pt ],$I$(8).info$S);
return pt;
});
...
var setting=p$1.getSetting$I.apply(this, [i]);
if (setting != null  && setting.size$() == 3 ) return $I$(5).stringAt$javajs_util_Lst$I(setting, 2);
...
for (var i=0; i < nCoord; i++, p+=3) points.addLast$O((function(a,f){return f.apply(null,a)})([list, p, Clazz.new_($I$(16,1))],$I$(5).pointAt$javajs_util_Lst$I$javajs_util_P3));

offset=(function(a,f){return f.apply(null,a)})([$I$(5).listAt$javajs_util_Lst$I(offsets, index), 0, Clazz.array(Float.TYPE, [7]), 7],$I$(5).floatsAt$javajs_util_Lst$I$FA$I);
...
var colix=(colorIndex == -7 ? ($I$(14).getBgContrast$I(this.bgRgb) == 8 ? 4 : 8) : colorIndex == -6 ? $I$(14).getBgContrast$I(this.bgRgb) : (function(a,f){return f.apply(null,a)})([Integer.valueOf$I($I$(6).getRGB$I(colorIndex))],$I$(14).getColixO$O));
...
this.atomColorList.addLast$O(Integer.valueOf$I(this.getColix$I$F(atomColor, 0)));
});
...
this.htAtomMap.put$O$O(this.objectNameID, atomMap);
...
var t=(function(a,f){return f.apply(null,a)})([this.vwr, font, label, this.getColix$I$F(colorIndex, 0), 0, 0, 0],$I$(20).newLabel$org_jmol_viewer_Viewer$org_jmol_util_Font$S$H$H$I$F);
...
if (settingCount <= key) for (var i=key + 1; --i >= settingCount; ) this.settings.addLast$O(null);
...
this.settings.set$I$O(key, setting);
}, p$1);
...
var bs=e.getValue$();
p$1.addJmolObject$I$javajs_util_BS$O.apply(this, [1140850689, bs, null]).rd=Clazz.new_([null, r, $I$(22).ABSOLUTE, $I$(23).AUTO],$I$(21,1).c$$FA$F$org_jmol_atomdata_RadiusData_EnumType$org_jmol_c_VDW);
}
this.htSpacefill.clear$();
}, p$1);
...
var bs=(function(a,f){return f.apply(null,a)})([this.ssMapAtom.get$O(key)],$I$(10).copy$javajs_util_BS);
if (bs == null ) return;
...
if (vis) return;
g.visible=false;
this.occludedObjects.put$O$O(g.objectNameID, $I$(9).TRUE);
this.htHiddenObjects.put$O$O(g.name, $I$(9).TRUE);
switch (g.type) {
case 1:
...
if (!Float.isNaN$F(trans)) b.colix=(function(a,f){return f.apply(null,a)})([colix, trans != 0 , trans],$I$(14).getColixTranslucent3$H$Z$F);
...
if (meshColor < 0) meshColor=(function(a,f){return f.apply(null,a)})([$I$(5).listAt$javajs_util_Lst$I(obj, 0), 2],$I$(5).intAt$javajs_util_Lst$I);
if (!isMep) {
