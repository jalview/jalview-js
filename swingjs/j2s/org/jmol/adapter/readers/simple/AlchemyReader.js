(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.simple"),p$1={},I$=[[0,'javajs.util.PT','org.jmol.adapter.smarter.Atom']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var c2=" ";
var nChar=(name.length$() == 2 && ((function(a,f){return f.apply(null,a)})([c1, c2=Character.toLowerCase$C(name.charAt$I(1))],$I$(2).isValidSym2$C$C) || name.equals$O("Du") )  ? 2 : 1);
