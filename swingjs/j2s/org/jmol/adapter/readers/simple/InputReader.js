...
/*c*/var C$=Clazz.newClass(P$, "InputReader", null, 'org.jmol.adapter.smarter.AtomSetCollectionReader');

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.vAtoms=Clazz.new_($I$(1,1));
this.atomMap=Clazz.new_($I$(2,1));
this.lineBuffer=Clazz.new_($I$(1,1));
this.symbolicMap=Clazz.new_($I$(2,1));
this.isHeader=true;
this.firstLine=true;
this.pt0=Clazz.new_($I$(3,1));
this.v1=Clazz.new_($I$(4,1));
this.v2=Clazz.new_($I$(4,1));
this.plane1=Clazz.new_($I$(5,1));
this.plane2=Clazz.new_($I$(5,1));
},1);

C$.$fields$=[['Z',['isJmolZformat','isMopac','isHeader','firstLine'],'I',['ac'],'O',['vAtoms','javajs.util.Lst','atomMap','java.util.Map','tokens','String[]','lineBuffer','javajs.util.Lst','symbolicMap','java.util.Map','pt0','javajs.util.P3','v1','javajs.util.V3','+v2','plane1','javajs.util.P4','+plane2']]]
...
break;
}this.tokens=(function(a,f){return f.apply(null,a)})([this.tokens[0], "="],$I$(6).split$S$S);
case 2:
...
this.lineBuffer.addLast$O(this.tokens);
return true;
});
...
var lstTokens=Clazz.new_($I$(1,1));
var n=0;
while (this.rd$() != null  && this.line.length$() > 40 ){
n++;
var tokens=this.getTokens$();
lstTokens.addLast$O(tokens);
map.put$O$O(tokens[1], this.addAtomXYZSymName$SA$I$S$S(tokens, 2, tokens[0], null));
}
for (var i=0; i < n; i++) {
var tokens=lstTokens.get$I(i);
var a=map.get$O(tokens[1]);
for (var j=6; j < tokens.length; j++) this.asc.addBond$org_jmol_adapter_smarter_Bond(Clazz.new_([a.index, map.get$O(tokens[j]).index, 1],$I$(7,1).c$$I$I$I));
...
this.tokens=(function(a,f){return f.apply(null,a)})([this.rd$()],$I$(6).getTokens$S);
...
for (var i=0, pt=0; i < nBonds; i++) this.asc.addBond$org_jmol_adapter_smarter_Bond(Clazz.new_([map.get$O("" + (bonds[pt++]|0)).index, map.get$O("" + (bonds[pt++]|0)).index, (orders[i]|0)],$I$(7,1).c$$I$I$I));
...
for (var i=this.tokens.length; --i >= 11; ) bonds.addLast$O(Clazz.array(String, -1, [this.tokens[3], this.tokens[i]]));
...
var b=bonds.get$I(i);
this.asc.addBond$org_jmol_adapter_smarter_Bond(Clazz.new_([map.get$O(b[0]).index, map.get$O(b[1]).index, 1],$I$(7,1).c$$I$I$I));
}
return (this.continuing=false);
}, p$1);
...
this.lineBuffer.clear$();
while (this.rd$() != null  && p$1.cleanLine.apply(this, []) != null   && (strEnd == null  ? this.line.length$() > 0 : this.line.indexOf$S(strEnd) < 0) )this.lineBuffer.addLast$O(this.getTokens$());
...
this.symbolicMap.put$O$O(this.tokens[0], Float.valueOf$F(f));
(function(a,f){return f.apply(null,a)})(["symbolic " + this.tokens[0] + " = " + new Float(f).toString() ],$I$(8).info$S);
}, p$1);
...
while (--i >= 0 && (function(a,f){return f.apply(null,a)})([element.charAt$I(i)],$I$(6).isDigit$C) ){
}
if (++i == 0) element=(function(a,f){return f.apply(null,a)})([this.parseIntStr$S(element)],$I$(10).getElementSymbol$I);
...
this.atomMap.put$O$O(atom.atomName, Integer.valueOf$I(this.ac++));
...
(function(a,f){return f.apply(null,a)})([atom.atomName + " " + new Float(atom.x).toString() + " " + new Float(atom.y).toString() + " " + new Float(atom.z).toString() ],$I$(8).info$S);
if (bondOrder < 0 || this.isJmolZformat && bondOrder > 0  ) this.asc.addBond$org_jmol_adapter_smarter_Bond(Clazz.new_([atom.index, this.vAtoms.get$I(ia).index, Math.abs(bondOrder)],$I$(7,1).c$$I$I$I));
}}, p$1);
...
var name;
if (i >= this.tokens.length || (name=this.tokens[i]).indexOf$S(".") >= 0  || !(function(a,f){return f.apply(null,a)})([name.charAt$I(0)],$I$(6).isLetterOrDigit$C) ) return -1;
...
if (atom.atomName.startsWith$S(name) && atom.atomName.length$() > name.length$()  && (function(a,f){return f.apply(null,a)})([atom.atomName.charAt$I(name.length$())],$I$(6).isDigit$C) ) {
...
(function(a,f){return f.apply(null,a)})([this.setAtom$org_jmol_adapter_smarter_Atom$I$I$I$F$F$F(atom, ia, ib, ic, -d, theta1, 0), this.v1, this.plane1],$I$(12).getPlaneThroughPoint$javajs_util_T3$javajs_util_V3$javajs_util_P4);
(function(a,f){return f.apply(null,a)})([this.setAtom$org_jmol_adapter_smarter_Atom$I$I$I$F$F$F(atom, ia, ic, ib, -d, theta2, 0), this.v1, this.plane2],$I$(12).getPlaneThroughPoint$javajs_util_T3$javajs_util_V3$javajs_util_P4);
