(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.xml"),I$=[[0,'org.jmol.util.Logger','javajs.util.PT','org.jmol.adapter.smarter.AtomSetCollectionReader']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.parent.setAtomCoordScaled$org_jmol_adapter_smarter_Atom$SA$I$F(null, (function(a,f){return f.apply(null,a)})([this.atts.get$O("tau")],$I$(2).getTokens$S), 0, 0.5291772).elementSymbol=this.atts.get$O("species").trim$();
...
this.parent.setFractionalCoordinates$Z(true);
var data=(function(a,f){return f.apply(null,a)})([this.chars.toString(), null, 6],$I$(3).getTokensFloat$S$FA$I);
this.a=data[0];
this.b=(data[1] == 0  ? this.a : data[1]);
this.c=(data[2] == 0  ? this.a : data[2]);
break;
}if ("at".equals$O(localName)) {
var m=(function(a,f){return f.apply(null,a)})([this.chars.toString(), null, 9],$I$(3).getTokensFloat$S$FA$I);
for (var i=0; i < 9; i+=3) {
m[i] *= this.a;
m[i + 1] *= this.b;
m[i + 2] *= this.c;
