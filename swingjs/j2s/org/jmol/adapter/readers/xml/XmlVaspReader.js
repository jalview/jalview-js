(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.xml"),I$=[[0,'org.jmol.util.Logger','javajs.util.PT','javajs.util.SB','org.jmol.adapter.smarter.AtomSetCollectionReader','javajs.util.V3']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var ijk=$I$(4,"getTokensFloat$S$FA$I",[this.data.toString(), null, 9]);
...
$I$(4,"getTokensFloat$S$FA$I",[this.data.toString(), fdata, this.ac * 3]);
var fpt=0;
