...
if (Clazz.instanceOf(o, "java.io.BufferedInputStream")) o=(function(a,f){return f.apply(null,a)})([$I$(5).getBIS$BA(data)],$I$(5).streamToUTF8String$java_io_BufferedInputStream);
var isjs=false;
{
isjs = true;
}
