...
(function(a,f){return f.apply(null,a)})([this.key.startsWith$S("save_") ? "CIF reader ignoring save_" : "CIF ERROR ? should be an underscore: " + this.key],$I$(5).warn$S);
this.parser.getTokenPeeked$();
...
(function(a,f){return f.apply(null,a)})([type + " = " + this.data ],$I$(5).debug$S);
}return this.data;
}, p$1);
...
var tokens=(function(a,f){return f.apply(null,a)})([$I$(6).replaceAllCharacters$S$S$S(s, "xyz+", ""), ","],$I$(6).split$S$S);
var n=0;
...
for (var i=0; i < this.lattvecs.size$(); i++) this.appendLoadNote$S((function(a,f){return f.apply(null,a)})([null, this.lattvecs.get$I(i)],$I$(6).toJSON$S$O));
...
(function(a,f){return f.apply(null,a)})(["CIF charge on " + this.field + " was " + new Float(charge).toString() + "; rounded to " + atom.formalCharge ],$I$(5).debug$S);
}}break;
case 49:
case 1:
case 2:
...
(function(a,f){return f.apply(null,a)})(["CIF creating molecule for " + nat + " atoms " + (this.bondTypes.size$() > 0 ? " using GEOM_BOND records" : "") ],$I$(5).info$S);
...
for (var i=this.firstAtom; i < this.ac; i++) {
var elemnoWithIsotope=(function(a,f){return f.apply(null,a)})([this.atoms[i].getElementSymbol$()],$I$(10).getElementNumber$S);
...
if (this.asc.bsAtoms == null ) this.asc.bsAtoms=Clazz.new_($I$(13,1));
