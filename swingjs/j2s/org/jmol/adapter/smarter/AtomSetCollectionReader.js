...
s=(function(a,f){return f.apply(null,a)})([$I$(6).replaceAllCharacters$S$S$S(s, "{}", "").trim$(), "\n", "\n  "],$I$(6).rep$S$S$S) + "\n\nUse SHOW DOMAINS for details.";
...
info.put$O$O("dssrJSON", $I$(7).TRUE);
for (var i=this.asc.atomSetCount; --i >= 0; ) {
info=this.asc.getAtomSetAuxiliaryInfo$I(i);
...
this.htParams.put$O$O("filteredAtomCount", Integer.valueOf$I($I$(8).cardinalityOf$javajs_util_BS(this.bsFilter)));
...
if (this.debugging) {
(function(a,f){return f.apply(null,a)})(["setunitcellitem " + i + " " + new Float(x).toString() ],$I$(2).debug$S);
...
filter0=this.filter=(function(a,f){return f.apply(null,a)})([this.filter, "NAME=", ""],$I$(6).rep$S$S$S);
...
if (this.bsFilter == null ) {
this.bsFilter=Clazz.new_($I$(10,1));
this.htParams.put$O$O("bsFilter", this.bsFilter);
...
(function(a,f){return f.apply(null,a)})(["defaultOrientationMatrix = " + this.matRot],$I$(2).info$S);
});
...
var ch;
for (var i=name.length$(); --i >= 0; ) if (!(function(a,f){return f.apply(null,a)})([ch=name.charAt$I(i)],$I$(6).isLetterOrDigit$C) && ch != "\'" ) name=name.substring$I$I(0, i) + "_" + name.substring$I(i + 1) ;
...
if (orbitals != null ) (function(a,f){return f.apply(null,a)})([orbitals.size$() + " molecular orbitals read in model " + this.asc.atomSetCount ],$I$(2).info$S);
});
...
data[i]=(function(a,f){return f.apply(null,a)})([this.discardLinesUntilNonBlank$()],$I$(6).getTokens$S);
...
while ((tokens=(function(a,f){return f.apply(null,a)})([this.rd$()],$I$(6).getTokens$S)).length < 3){
}
...
if (this.debugging) (function(a,f){return f.apply(null,a)})(["atom " + iAtom + " vib" + j + ": " + new Float(vx).toString() + " " + new Float(vy).toString() + " " + new Float(vz).toString() ],$I$(2).debug$S);
...
$I$(2).debug$S(this.line);
if (this.line.indexOf$S("ATOMS IN THE") >= 0) System.err.println$S("ascr test");
}return this.line;
});
...
(function(a,f){return f.apply(null,a)})([$I$(6).getTokens$S(s), f, n],$I$(6).parseFloatArrayDataN$SA$FA$I);
return f;
}, 1);
