(function(){var P$=Clazz.newPackage("org.jmol.jsv"),p$1={},I$=[[0,'javajs.util.PT','javajs.util.SB','javajs.util.Lst','org.jmol.util.Logger','java.util.Hashtable','javajs.util.BS']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
