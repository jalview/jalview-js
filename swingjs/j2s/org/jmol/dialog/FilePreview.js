(function(){var P$=Clazz.newPackage("org.jmol.dialog"),I$=[[0,'java.awt.Dimension','org.jmol.viewer.Viewer','java.awt.Rectangle','javax.swing.Box','javax.swing.JCheckBox','org.jmol.i18n.GT',['org.jmol.dialog.FilePreview','.FPPanel'],'javajs.util.PT']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var box=$I$(4).createVerticalBox$();
this.active=Clazz.new_([$I$(6).$$S("Preview"), false],$I$(5,1).c$$S$Z);
...
this.display=Clazz.new_($I$(7,1).c$$java_util_Map,[vwrOptions]);
...
if (allowAppend) {
this.append=Clazz.new_([$I$(6).$$S("Append models"), false],$I$(5,1).c$$S$Z);
box.add$java_awt_Component(this.append);
this.cartoons=Clazz.new_([$I$(6).$$S("PDB cartoons"), C$.pdbCartoonChecked],$I$(5,1).c$$S$Z);
...
script=$I$(8,"rep$S$S$S",[this.display.vwr.getP$S("defaultdropscript"), "\"%FILE\"", script + " 1"]);
script=$I$(8,"rep$S$S$S",[script, "%ALLOWCARTOONS", "" + (this.isCartoonsSelected$() && !this.isAppendSelected$() )]);
...
Clazz.super_(C$, this);
info.put$O$O("previewOnly", Boolean.TRUE);
var display=info.get$O("display");
info.put$O$O("display", this);
this.vwr=Clazz.new_($I$(2,1).c$$java_util_Map,[info]);
