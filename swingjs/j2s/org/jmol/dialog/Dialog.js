(function(){var P$=Clazz.newPackage("org.jmol.dialog"),p$1={},I$=[[0,'org.jmol.dialog.Dialog','javax.swing.border.TitledBorder','org.jmol.i18n.GT','java.io.File',['org.jmol.dialog.Dialog','.TypeFilter'],'org.jmol.dialog.FileChooser','javax.swing.UIManager','org.jmol.dialog.FilePreview','org.jmol.viewer.FileManager','javax.swing.JFileChooser','java.awt.BorderLayout','javax.swing.JPanel','java.awt.FlowLayout','javax.swing.JComboBox',['org.jmol.dialog.Dialog','.ExportChoiceListener'],'javax.swing.JSlider',['org.jmol.dialog.Dialog','.QualityListener'],'javax.swing.JOptionPane','javax.swing.SwingUtilities','org.jmol.util.Logger']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
}if (this.openPreview == null  && (vwr.isApplet || Boolean.valueOf$S(System.getProperty$S$S("openFilePreview", "true")).booleanValue$() ) ) {
this.openPreview=Clazz.new_($I$(8,1).c$$org_jmol_viewer_Viewer$javax_swing_JFileChooser$Z$java_util_Map,[vwr, C$.openChooser, allowAppend, vwrOptions]);
}if (jmolApp != null ) {
...
var dir=$I$(9).getLocalDirectory$org_jmol_viewer_Viewer$Z(vwr, true);
...
$I$(9,"setLocalPath$org_jmol_viewer_Viewer$S$Z",[vwr, file.getParent$(), true]);
...
var doAppend=(allowAppend && !$I$(9).isScriptType$S(fileName) && this.openPreview != null    && this.openPreview.isAppendSelected$() );
this.closePreview$();
...
C$.saveChooser=Clazz.new_($I$(10,1));
C$.getXPlatformLook$javax_swing_JFileChooser(C$.saveChooser);
}C$.saveChooser.setCurrentDirectory$java_io_File($I$(9).getLocalDirectory$org_jmol_viewer_Viewer$Z(vwr, true));
var file=null;
...
C$.imageChooser=Clazz.new_($I$(10,1));
C$.getXPlatformLook$javax_swing_JFileChooser(C$.imageChooser);
}C$.imageChooser.setCurrentDirectory$java_io_File($I$(9).getLocalDirectory$org_jmol_viewer_Viewer$Z(vwr, true));
...
this.setLayout$java_awt_LayoutManager(Clazz.new_($I$(11,1)));
...
var cbPanel=Clazz.new_($I$(12,1));
cbPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13,1)));
cbPanel.setBorder$javax_swing_border_Border(Clazz.new_([$I$(3).$$S("Image Type")],$I$(2,1).c$$S));
this.cb=Clazz.new_($I$(14,1));
for (var i=0; i < choices.length; i++) {
this.cb.addItem$O(choices[i]);
}
cbPanel.add$java_awt_Component(this.cb);
this.cb.setSelectedIndex$I(C$.defaultChoice);
this.cb.addItemListener$java_awt_event_ItemListener(Clazz.new_($I$(15,1),[this, null]));
this.add$java_awt_Component$O(cbPanel, "North");
var qPanel2=Clazz.new_($I$(12,1));
qPanel2.setLayout$java_awt_LayoutManager(Clazz.new_($I$(11,1)));
this.qPanelJPEG=Clazz.new_($I$(12,1));
this.qPanelJPEG.setLayout$java_awt_LayoutManager(Clazz.new_($I$(11,1)));
this.qPanelJPEG.setBorder$javax_swing_border_Border(Clazz.new_([$I$(3,"i$S$I",[$I$(3,"$$S",["JPEG Quality ({0})"]), C$.qualityJPG])],$I$(2,1).c$$S));
this.qSliderJPEG=Clazz.new_($I$(16,1).c$$I$I$I$I,[0, 50, 100, C$.qualityJPG]);
this.qSliderJPEG.putClientProperty$O$O("JSlider.isFilled", Boolean.TRUE);
this.qSliderJPEG.setPaintTicks$Z(true);
this.qSliderJPEG.setMajorTickSpacing$I(10);
this.qSliderJPEG.setPaintLabels$Z(true);
this.qSliderJPEG.addChangeListener$javax_swing_event_ChangeListener(Clazz.new_($I$(17,1).c$$Z$javax_swing_JSlider,[this, null, true, this.qSliderJPEG]));
this.qPanelJPEG.add$java_awt_Component$O(this.qSliderJPEG, "South");
qPanel2.add$java_awt_Component$O(this.qPanelJPEG, "North");
this.qPanelPNG=Clazz.new_($I$(12,1));
this.qPanelPNG.setLayout$java_awt_LayoutManager(Clazz.new_($I$(11,1)));
this.qPanelPNG.setBorder$javax_swing_border_Border(Clazz.new_([$I$(3,"i$S$I",[$I$(3,"$$S",["PNG Compression  ({0})"]), C$.qualityPNG])],$I$(2,1).c$$S));
this.qSliderPNG=Clazz.new_($I$(16,1).c$$I$I$I$I,[0, 0, 9, C$.qualityPNG]);
this.qSliderPNG.putClientProperty$O$O("JSlider.isFilled", Boolean.TRUE);
this.qSliderPNG.setPaintTicks$Z(true);
this.qSliderPNG.setMajorTickSpacing$I(2);
this.qSliderPNG.setPaintLabels$Z(true);
this.qSliderPNG.addChangeListener$javax_swing_event_ChangeListener(Clazz.new_($I$(17,1).c$$Z$javax_swing_JSlider,[this, null, false, this.qSliderPNG]));
...
var opt=$I$(18,"showOptionDialog$java_awt_Component$O$S$I$I$javax_swing_Icon$OA$O",[chooser, $I$(3,"o$S$O",[$I$(3).$$S("Do you want to overwrite file {0}?"), file.getAbsolutePath$()]), $I$(3).$$S("Warning"), -1, 2, null, options, options[0]]);
return (opt == 0);
}, 1);
...
try {
$I$(19,"invokeAndWait$Runnable",[((P$.Dialog$1||
...
this.b$['org.jmol.dialog.Dialog'].qPanelJPEG.setBorder$javax_swing_border_Border(Clazz.new_([$I$(3,"i$S$I",[$I$(3,"$$S",["JPEG Quality ({0})"]), value])],$I$(2,1).c$$S));
} else {
$I$(1).qualityPNG=value;
this.b$['org.jmol.dialog.Dialog'].qPanelPNG.setBorder$javax_swing_border_Border(Clazz.new_([$I$(3,"i$S$I",[$I$(3,"$$S",["PNG Quality ({0})"]), value])],$I$(2,1).c$$S));
}});
...
if (selectedFile == null ) selectedFile=this.b$['org.jmol.dialog.Dialog'].initialFile;
var newFile=null;
var name;
var newExt=this.b$['org.jmol.dialog.Dialog'].extensions[source.getSelectedIndex$()];
if ((name=selectedFile.getName$()) != null  && name.endsWith$S("." + this.b$['org.jmol.dialog.Dialog'].extension) ) {
name=name.substring$I$I(0, name.length$() - this.b$['org.jmol.dialog.Dialog'].extension.length$());
name += newExt;
this.b$['org.jmol.dialog.Dialog'].initialFile=newFile=Clazz.new_([selectedFile.getParent$(), name],$I$(4,1).c$$S$S);
}this.b$['org.jmol.dialog.Dialog'].extension=newExt;
$I$(1).imageChooser.resetChoosableFileFilters$();
$I$(1).imageChooser.addChoosableFileFilter$javax_swing_filechooser_FileFilter(Clazz.new_($I$(5,1).c$$S,[this.b$['org.jmol.dialog.Dialog'].extension]));
if (newFile != null ) $I$(1).imageChooser.setSelectedFile$java_io_File(newFile);
this.b$['org.jmol.dialog.Dialog'].choice=source.getSelectedItem$();
});
