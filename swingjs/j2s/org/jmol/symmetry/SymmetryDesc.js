...
}var info=(function(a,f){return f.apply(null,a)})([pta00, pt0, $I$(9).getQuaternionFrame$javajs_util_P3$javajs_util_T3$javajs_util_T3(pt0, pt1, pt2).div$javajs_util_Quat($I$(9).getQuaternionFrame$javajs_util_P3$javajs_util_T3$javajs_util_T3(pta00, pta01, pta02))],$I$(8).computeHelicalAxis$javajs_util_P3$javajs_util_P3$javajs_util_Quat);
var pa1=info[0];
var ax1=info[1];
var ang1=(Math.abs((function(a,f){return f.apply(null,a)})([(info[3]).x, 1],$I$(5).approx$F$F))|0);
var pitch1=(function(a,f){return f.apply(null,a)})([(info[3]).y],$I$(10).approxF$F);
if (haveInversion) {
