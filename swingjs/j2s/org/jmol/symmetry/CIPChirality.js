...
}if ($I$(3).debugging) $I$(3,"info$S",[atom + " " + $I$(11).getCIPChiralityName$I(rs) + " by Rule " + this.getRuleName$I(this.currentRule) + "\n----------------------------------" ]);
return rs;
}}
}} catch (e) {
...
if ($I$(3).debugging) $I$(3,"info$S",["get Bond Chirality " + $I$(11).getCIPChiralityName$I(c) + " " + bond ]);
return c;
}, p$2);
...
if ($I$(3).debugging) $I$(3,"info$S",[a + "-" + b + " " + $I$(11).getCIPChiralityName$I(c) ]);
}return c;
}, p$2);
...
this.id=++this.b$['org.jmol.symmetry.CIPChirality'].ptIDLogger;
this.parent=parent;
if (atom == null ) return this;
this.isAlkene=isAlkene;
this.atom=atom;
this.atomIndex=atom.getIndex$();
if (atom.getIsotopeNumber$() > 0) this.b$['org.jmol.symmetry.CIPChirality'].bsNeedRule.set$I(3);
this.isDuplicate=this.multipleBondDuplicate=isDuplicate;
this.isKekuleAmbiguous=(this.b$['org.jmol.symmetry.CIPChirality'].data.bsKekuleAmbiguous != null  && this.b$['org.jmol.symmetry.CIPChirality'].data.bsKekuleAmbiguous.get$I(this.atomIndex) );
...
this.isSP3=(this.bondCount == 4 || this.bondCount == 3 && !isAlkene  && (this.elemNo > 10  || this.b$['org.jmol.symmetry.CIPChirality'].data.bsAzacyclic != null  && this.b$['org.jmol.symmetry.CIPChirality'].data.bsAzacyclic.get$I(this.atomIndex)  )  );
...
if (isDuplicate) this.b$['org.jmol.symmetry.CIPChirality'].bsNeedRule.set$I(4);
...
this.b$['org.jmol.symmetry.CIPChirality'].bsNeedRule.setBitTo$I$Z(2, (this.isDuplicate=true));
if ((this.rootDistance=(atom === this.b$['org.jmol.symmetry.CIPChirality'].root.atom  ? 0 : isParentBond ? parent.sphere : this.htPathPoints.get$O(Integer.valueOf$I(this.atomIndex)).intValue$())) == 0) {
this.b$['org.jmol.symmetry.CIPChirality'].root.nRootDuplicates++;
}} else {
this.bsPath.set$I(this.atomIndex);
this.htPathPoints.put$O$O(Integer.valueOf$I(this.atomIndex), Integer.valueOf$I(this.rootDistance));
}if (this.b$['org.jmol.symmetry.CIPChirality'].doTrack) {
...
if (this.b$['org.jmol.symmetry.CIPChirality'].data.testRule6Full) {
...
rs=this.b$['org.jmol.symmetry.CIPChirality'].getAtomChiralityLimited$org_jmol_util_SimpleNode$org_jmol_symmetry_CIPChirality_CIPAtom$org_jmol_util_SimpleNode.apply(this.b$['org.jmol.symmetry.CIPChirality'], [this.atom, cipAtom, null]);
this.b$['org.jmol.symmetry.CIPChirality'].currentRule=9;
if (rs == 0) return 0;
} else {
this.b$['org.jmol.symmetry.CIPChirality'].root.bsRule6Subs=Clazz.new_($I$(1,1));
this.b$['org.jmol.symmetry.CIPChirality'].root.rule6refIndex=this.atoms[i].atomIndex;
p$1.saveRestorePriorities$Z.apply(this, [false]);
this.sortSubstituents$I(-2147483648);
if (!this.sortSubstituents$I(0)) return 0;
rs=this.b$['org.jmol.symmetry.CIPChirality'].data.checkHandedness$org_jmol_symmetry_CIPChirality_CIPAtom(this);
...
if (this.b$['org.jmol.symmetry.CIPChirality'].data.bsKekuleAmbiguous.get$I(other.getIndex$())) {
n++;
...
var order=this.b$['org.jmol.symmetry.CIPChirality'].data.getBondOrder$org_jmol_util_SimpleEdge(bond);
if (order == 2) {
...
case 2:
case 3:
if (this.elemNo == 6  && this.b$['org.jmol.symmetry.CIPChirality'].data.bsNegativeAromatic.get$I(index)  || this.b$['org.jmol.symmetry.CIPChirality'].data.bsXAromatic.get$I(index) ) {
this.nAtoms++;
...
switch (this.b$['org.jmol.symmetry.CIPChirality'].currentRule) {
case 5:
case 7:
...
}ignoreTies|=(this.b$['org.jmol.symmetry.CIPChirality'].currentRule == 6 || this.b$['org.jmol.symmetry.CIPChirality'].currentRule == 8 );
var indices=Clazz.array(Integer.TYPE, [4]);
var newPriorities=Clazz.array(Integer.TYPE, [4]);
if ($I$(3).debuggingHigh && this.h1Count < 2 ) {
$I$(3).info$S(this.b$['org.jmol.symmetry.CIPChirality'].root + "---sortSubstituents---" + this );
for (var i=0; i < 4; i++) {
$I$(3,"info$S",[this.b$['org.jmol.symmetry.CIPChirality'].getRuleName$I.apply(this.b$['org.jmol.symmetry.CIPChirality'], [this.b$['org.jmol.symmetry.CIPChirality'].currentRule]) + ": " + this + "[" + i + "]=" + this.atoms[i].myPath + " " + Integer.toHexString$I(this.priorities[i]) ]);
}
$I$(3).info$S("---" + this.nPriorities);
}var loser;
for (var i=0; i < 3; i++) {
var a=this.atoms[i];
var aLoses=a.isDuplicate && this.b$['org.jmol.symmetry.CIPChirality'].currentRule > 2 ;
for (var j=i + 1; j < 4; j++) {
...
case -1:
newPriorities[loser]++;
if (this.b$['org.jmol.symmetry.CIPChirality'].doTrack && score != 0  && (sphere == 0 || ignoreTies ) ) this.b$['org.jmol.symmetry.CIPChirality'].data.track$org_jmol_symmetry_CIPChirality$org_jmol_symmetry_CIPChirality_CIPAtom$org_jmol_symmetry_CIPChirality_CIPAtom$I$I$Z(this.b$['org.jmol.symmetry.CIPChirality'], a, b, 1, score, false);
case -2147483648:
case 0:
indices[loser]++;
continue;
...
var finalScore=0;
while (true){
if (this.isDuplicate && (this.b$['org.jmol.symmetry.CIPChirality'].currentRule > 2 || b.isDuplicate && this.atom === b.atom   && this.rootDistance == b.rootDistance  )  || !this.setNode$()  || !b.setNode$()  || this.isTerminal && b.isTerminal   || this.isDuplicate && b.isDuplicate  ) break;
if (this.isTerminal != b.isTerminal ) {
finalScore=(this.isTerminal ? 1 : -1) * (sphere + (b.isDuplicate || this.isDuplicate  ? 0 : 1));
if (this.b$['org.jmol.symmetry.CIPChirality'].doTrack) this.b$['org.jmol.symmetry.CIPChirality'].data.track$org_jmol_symmetry_CIPChirality$org_jmol_symmetry_CIPChirality_CIPAtom$org_jmol_symmetry_CIPChirality_CIPAtom$I$I$Z(this.b$['org.jmol.symmetry.CIPChirality'], this, b, sphere, finalScore, true);
break;
}var score=(this.b$['org.jmol.symmetry.CIPChirality'].currentRule > 2 ? 0 : p$1.unlikeDuplicates$org_jmol_symmetry_CIPChirality_CIPAtom.apply(this, [b]));
if (score != 0) {
finalScore=score * (sphere + 1);
if (this.b$['org.jmol.symmetry.CIPChirality'].doTrack) this.b$['org.jmol.symmetry.CIPChirality'].data.track$org_jmol_symmetry_CIPChirality$org_jmol_symmetry_CIPChirality_CIPAtom$org_jmol_symmetry_CIPChirality_CIPAtom$I$I$Z(this.b$['org.jmol.symmetry.CIPChirality'], this, b, sphere, finalScore, false);
break;
...
finalScore=score * (sphere + 1);
if (this.b$['org.jmol.symmetry.CIPChirality'].doTrack) this.b$['org.jmol.symmetry.CIPChirality'].data.track$org_jmol_symmetry_CIPChirality$org_jmol_symmetry_CIPChirality_CIPAtom$org_jmol_symmetry_CIPChirality_CIPAtom$I$I$Z(this.b$['org.jmol.symmetry.CIPChirality'], this.atoms[i], b.atoms[i], sphere, finalScore, false);
break;
}
if (finalScore != 0) {
break;
...
return (this.atomIndex == b.atomIndex ? 0 : p$1.getMass.apply(this, []) > p$1.getMass.apply(b, [])  ? -1 : this.mass < b.mass  ? 1 : this.b$['org.jmol.symmetry.CIPChirality'].root.rule6refIndex < 0 ? 0 : !this.b$['org.jmol.symmetry.CIPChirality'].root.bsRule6Subs.get$I(this.atomIndex) || !this.b$['org.jmol.symmetry.CIPChirality'].root.bsRule6Subs.get$I(b.atomIndex)  ? 0 : this.b$['org.jmol.symmetry.CIPChirality'].root.rule6refIndex == this.atomIndex ? -1 : this.b$['org.jmol.symmetry.CIPChirality'].root.rule6refIndex == b.atomIndex ? 1 : 0);
}, p$1);
...
if (best != null ) {
if (this.b$['org.jmol.symmetry.CIPChirality'].currentRule == 8) {
...
}if (this.b$['org.jmol.symmetry.CIPChirality'].doTrack) this.b$['org.jmol.symmetry.CIPChirality'].data.track$org_jmol_symmetry_CIPChirality$org_jmol_symmetry_CIPChirality_CIPAtom$org_jmol_symmetry_CIPChirality_CIPAtom$I$I$Z(this.b$['org.jmol.symmetry.CIPChirality'], this, b, 1, score, false);
}return score;
}, p$1);

Clazz.newMeth(C$, 'compareRule6$org_jmol_symmetry_CIPChirality_CIPAtom', function (b) {
return ((this.atomIndex == this.b$['org.jmol.symmetry.CIPChirality'].root.rule6refIndex) == (b.atomIndex == this.b$['org.jmol.symmetry.CIPChirality'].root.rule6refIndex)  ? 0 : this.atomIndex == this.b$['org.jmol.symmetry.CIPChirality'].root.rule6refIndex ? -1 : 1);
}, p$1);
...
if (this.listRS != null ) return this.listRS[this.b$['org.jmol.symmetry.CIPChirality'].currentRule == 8 ? 1 : 0];
var bs;
...
$I$(3).info$S("getBest " + this.b$['org.jmol.symmetry.CIPChirality'].currentRule + " " + this + " " + this.listRS[1] + this.listRS[2] + " " + this.myPath );
bs=p$1.compareLikeUnlike$javajs_util_BS$javajs_util_BS.apply(this, [this.listRS[1], this.listRS[2]]);
return this.listRS[0]=(this.b$['org.jmol.symmetry.CIPChirality'].currentRule == 8 || bs == null   ? this.listRS[1] : bs);
}, p$1);
...
this.b$['org.jmol.symmetry.CIPChirality'].root.rule4Ref=ref;
p$1.addChiralAtoms$javajs_util_Lst$I.apply(this, [chiralAtoms, ref]);
$I$(9).sort$java_util_List(chiralAtoms);
this.b$['org.jmol.symmetry.CIPChirality'].root.rule4Ref=0;
...
rs=this.b$['org.jmol.symmetry.CIPChirality'].data.checkHandedness$org_jmol_symmetry_CIPChirality_CIPAtom(atom1);
isChiralPath|=(rs != 0);
c=(rs == 1 ? "R" : rs == 2 ? "S" : "~");
if (rule == 8) {
c=(c == "R" ? "r" : c == "S" ? "s" : "~");
if (rs != 0) this.b$['org.jmol.symmetry.CIPChirality'].havePseudoAuxiliary=true;
} else {
this.rule4Type=rs;
}}}this.auxChirality=c;
}if (node1 == null ) this.b$['org.jmol.symmetry.CIPChirality'].bsNeedRule.setBitTo$I$Z(5, nRS > 0);
if (c != "~") {
...
var current=this.b$['org.jmol.symmetry.CIPChirality'].currentRule;
this.b$['org.jmol.symmetry.CIPChirality'].currentRule=rule;
var rule6ref=this.b$['org.jmol.symmetry.CIPChirality'].root.rule6refIndex;
var nDup=this.b$['org.jmol.symmetry.CIPChirality'].root.nRootDuplicates;
var isChiral=(rule == 9 ? this.getRule6Descriptor$Z(true) != 0 : this.sortSubstituents$I(0));
this.b$['org.jmol.symmetry.CIPChirality'].root.nRootDuplicates=nDup;
this.b$['org.jmol.symmetry.CIPChirality'].root.rule6refIndex=rule6ref;
this.b$['org.jmol.symmetry.CIPChirality'].currentRule=current;
return isChiral;
}, p$1);
...
return this.b$['org.jmol.symmetry.CIPChirality'].getEneChirality$org_jmol_symmetry_CIPChirality_CIPAtom$org_jmol_symmetry_CIPChirality_CIPAtom$org_jmol_symmetry_CIPChirality_CIPAtom$org_jmol_symmetry_CIPChirality_CIPAtom$Z$Z.apply(this.b$['org.jmol.symmetry.CIPChirality'], [winner1, end1, end2, winner2, isAxial, false]);
}, p$1);
...
a.id=this.b$['org.jmol.symmetry.CIPChirality'].ptIDLogger++;
...
if ($I$(3).debuggingHigh) return ("[" + this.b$['org.jmol.symmetry.CIPChirality'].currentRule + "." + this.sphere + "," + this.id + "." + (this.isDuplicate ? this.parent.atom : this.atom).getAtomName$() + (this.isDuplicate ? "*(" + this.rootDistance + ")"  : "") + (this.auxChirality == "~" ? "" : "" + this.auxChirality) + " " + new Float(this.elemNo).toString() + "]" );
