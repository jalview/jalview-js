(function(){var P$=Clazz.newPackage("org.jmol.symmetry"),p$1={},I$=[[0,'javajs.util.Matrix','javajs.util.SB','org.jmol.util.Parser','javajs.util.M4','org.jmol.util.Logger','javajs.util.P3','javajs.util.PT','javajs.util.V3','java.util.Hashtable','Boolean']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return (function(a,f){return f.apply(null,a)})([s.substring$I(1), ",+", ","],$I$(7).rep$S$S$S);
}, 1);
...
xyz += "(" + (function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([C$.getXYZFromMatrix$javajs_util_M4$Z$Z$Z(m2, false, false, false), "x", "mx"],$I$(7).rep$S$S$S), "y", "my"],$I$(7).rep$S$S$S), "z", "mz"],$I$(7).rep$S$S$S) + ")" ;
return xyz;
});
...
this.info.put$O$O("isCenteringOp", $I$(10).valueOf$Z(this.isCenteringOp));
