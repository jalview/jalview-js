(function(){var P$=Clazz.newPackage("org.jmol.symmetry"),I$=[[0,'javajs.util.M4','org.jmol.symmetry.HallRotation','org.jmol.util.Logger','org.jmol.symmetry.HallTranslation','javajs.util.SB','org.jmol.symmetry.SymmetryOperation']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
(function(a,f){return f.apply(null,a)})(["code = " + code + "; primitive code =" + this.primitiveCode + "\n Seitz Matrix(12ths):" + this.seitzMatrix12ths ],$I$(3).debug$S);
}}, 1);
