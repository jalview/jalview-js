(function(){var P$=Clazz.newPackage("org.jmol.symmetry"),p$1={},I$=[[0,'javajs.util.P3','org.jmol.util.BoxInfo','javajs.util.P3i','org.jmol.util.Logger','javajs.util.Lst','org.jmol.util.Point3fi']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.minXYZ=(function(a,f){return f.apply(null,a)})([(Math.floor(min.x)|0), (Math.floor(min.y)|0), (Math.floor(min.z)|0)],$I$(3).new3$I$I$I);
this.maxXYZ=(function(a,f){return f.apply(null,a)})([(Math.ceil(max.x)|0), (Math.ceil(max.y)|0), (Math.ceil(max.z)|0)],$I$(3).new3$I$I$I);
