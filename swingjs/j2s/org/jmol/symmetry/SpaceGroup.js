...
/*c*/var C$=Clazz.newClass(P$, "SpaceGroup");
...
C$.$fields$=[['Z',['isSSG','doNormalize','isBio','isBilbao'],'C',['ambiguityType','uniqueAxis','axisChoice'],'I',['index','latticeParameter','operationCount','latticeOp','modDim'],'S',['name','hallSymbol','crystalClass','hmSymbol','hmSymbolFull','hmSymbolExt','hmSymbolAbbr','hmSymbolAlternative','hmSymbolAbbrShort','intlTableNumber','intlTableNumberFull','intlTableNumberExt','latticeType'],'O',['hallInfo','org.jmol.symmetry.HallInfo','operations','org.jmol.symmetry.SymmetryOperation[]','+finalOperations','xyzList','java.util.Map','nHallOperators','Integer','info','java.util.Map']]
,['I',['sgIndex'],'S',['ambiguousNames','lastInfo'],'O',['canonicalSeitzList','String[]','SG','org.jmol.symmetry.SpaceGroup[]','htByOpCount','java.util.Map','STR_SG','String[]']]]
...
var h=Clazz.new_([$I$(3).getHallLatticeEquivalent$I(this.latticeParameter)],$I$(2,1).c$$S);
...
this.finalOperations[0]=Clazz.new_($I$(4,1).c$$org_jmol_symmetry_SymmetryOperation$javajs_util_P3A$I$I$Z,[this.operations[0], atoms, atomIndex, count, true]);
...
this.finalOperations[i]=Clazz.new_($I$(4,1).c$$org_jmol_symmetry_SymmetryOperation$javajs_util_P3A$I$I$Z,[this.operations[i], atoms, atomIndex, count, doNormalize]);
...
if (sg != null  && sg.index >= C$.SG.length ) {
var sgDerived=C$.findSpaceGroup$I$S(sg.operationCount, p$1.getCanonicalSeitzList.apply(sg, []));
...
var sgFound=C$.createSpaceGroupN$S(spaceGroup);
sgFound=C$.findSpaceGroup$I$S(sgFound.operationCount, p$1.getCanonicalSeitzList.apply(sgFound, []));
...
this.info.put$O$O("HMSymbol", "??");
} else {
var seitz=p$1.dumpCanonicalSeitzList.apply(this, []);
this.info.put$O$O("SeitzList", seitz == null  ? "" : seitz);
this.info.put$O$O("HMSymbol", this.hmSymbol + (this.hmSymbolExt.length$() > 0 ? ":" + this.hmSymbolExt : ""));
this.info.put$O$O("ITSNumber", Integer.valueOf$S(this.intlTableNumber));
this.info.put$O$O("ITSNumberFull", this.intlTableNumberFull);
this.info.put$O$O("crystalClass", this.crystalClass);
this.info.put$O$O("HallSymbol", this.hallInfo.hallSymbol.equals$O("--") ? "" : this.hallInfo.hallSymbol);
}this.info.put$O$O("operationCount", Integer.valueOf$I(this.operationCount));
var ops=Clazz.new_($I$(7,1));
this.info.put$O$O("operationInfo", ops);
for (var i=0; i < this.operationCount; i++) ops.addLast$O(this.operations[i].getInfo$());

}var ucmap=(cellInfo == null  ? null : cellInfo.getUnitCellInfoMap$());
if (ucmap != null ) this.info.put$O$O("unitCell", ucmap);
return this.info;
}, p$1);
...
var sb=Clazz.new_($I$(6,1)).append$S("\nHermann-Mauguin symbol: ");
...
Clazz.newMeth(C$, 'dumpInfoObj$', function () {
var info=p$1.dumpCanonicalSeitzList.apply(this, []);
if (Clazz.instanceOf(info, "org.jmol.symmetry.SpaceGroup")) return (info).dumpInfoObj$();
...
map.put$O$O("HermannMauguinSymbol", s);
if (this.intlTableNumber != null ) {
map.put$O$O("ita", Integer.valueOf$S(this.intlTableNumber));
map.put$O$O("itaFull", this.intlTableNumberFull);
map.put$O$O("crystalClass", this.crystalClass);
map.put$O$O("operationCount", Integer.valueOf$I(this.operationCount));
}var lst=Clazz.new_($I$(7,1));
for (var i=0; i < this.operationCount; i++) {
lst.addLast$O(this.operations[i].xyz);
}
map.put$O$O("operationsXYZ", lst);
map.put$O$O("HallSymbol", (this.hallInfo == null  ? "?" : this.hallInfo.hallSymbol));
return map;
});
...
if (latticeParameter > 10) this.latticeParameter=-(function(a,f){return f.apply(null,a)})([$I$(3).getLatticeCode$I(latticeParameter)],$I$(3).getLatticeIndex$C);
});

Clazz.newMeth(C$, 'dumpCanonicalSeitzList', function () {
if (this.nHallOperators != null ) {
if (this.hallInfo == null ) this.hallInfo=Clazz.new_($I$(2,1).c$$S,[this.hallSymbol]);
...
if (sgDerived != null ) return p$1.getCanonicalSeitzList.apply(sgDerived, []);
...
var hallInfo;
if (sg == null ) {
hallInfo=Clazz.new_($I$(2,1).c$$S,[name]);
...
this.xyzList.clear$();
this.operationCount=0;
this.modDim=(function(a,f){return f.apply(null,a)})([xyz0.substring$I(xyz0.lastIndexOf$S("x") + 1)],$I$(9).parseInt$S) - 3;
} else if (xyz0.indexOf$S("m") >= 0) {
xyz0=$I$(9).rep$S$S$S(xyz0, "+m", "m");
if (xyz0.equals$O("x,y,z,m") || xyz0.equals$O("x,y,z(mx,my,mz)") ) {
this.xyzList.clear$();
this.operationCount=0;
}}var op=Clazz.new_($I$(4,1).c$$org_jmol_symmetry_SymmetryOperation$javajs_util_P3A$I$I$Z,[null, null, 0, opId, this.doNormalize]);
...
if (id >= 0) return id;
if (this.latticeOp < 0) {
var xxx=(function(a,f){return f.apply(null,a)})([this.modDim > 0 ? $I$(4).replaceXn$S$I(xyz, this.modDim + 3) : xyz, "+123/", ""],$I$(9).replaceAllCharacters$S$S$S);
if (this.xyzList.containsKey$O(xxx + "!")) {
this.latticeOp=this.operationCount;
} else {
this.xyzList.put$O$O(xxx + "!", Integer.valueOf$I(this.operationCount));
}}this.xyzList.put$O$O(xyz, Integer.valueOf$I(this.operationCount));
}if (!xyz.equals$O(xyz0)) this.xyzList.put$O$O(xyz0, Integer.valueOf$I(this.operationCount));
...
if ($I$(10).debugging) (function(a,f){return f.apply(null,a)})(["\naddOperation " + this.operationCount + op.dumpInfo$() ],$I$(10).debug$S);
return this.operationCount - 1;
}, p$1);

Clazz.newMeth(C$, 'generateOperatorsFromXyzInfo$S', function (xyzInfo) {
p$1.init$Z.apply(this, [true]);
var terms=(function(a,f){return f.apply(null,a)})([xyzInfo.toLowerCase$(), ";"],$I$(9).split$S$S);
...
if (this.hallInfo == null  || this.hallInfo.nRotations == 0 ) h=this.hallInfo=Clazz.new_($I$(2,1).c$$S,[this.hallSymbol]);
...
var mat1=Clazz.new_($I$(12,1));
var operation=Clazz.new_($I$(12,1));
var newOps=Clazz.array($I$(12), [7]);
for (var i=0; i < 7; i++) newOps[i]=Clazz.new_($I$(12,1));
...
ext="?";
haveExtension=true;
}var abbr=(function(a,f){return f.apply(null,a)})([name, " ()", ""],$I$(9).replaceAllCharacters$S$S$S);
var s;
...
var terms=(function(a,f){return f.apply(null,a)})([cifLine.toLowerCase$(), ";"],$I$(9).split$S$S);
...
if (lst == null ) C$.htByOpCount.put$O$O(this.nHallOperators, lst=Clazz.new_($I$(7,1)));
lst.addLast$O(this);
...
var newOp=Clazz.new_($I$(4,1).c$$org_jmol_symmetry_SymmetryOperation$javajs_util_P3A$I$I$Z,[null, null, 0, 0, true]);
...
C$.ambiguousNames="";
C$.lastInfo="";
C$.htByOpCount=Clazz.new_($I$(1,1));
