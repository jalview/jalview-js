(function(){var P$=Clazz.newPackage("org.jmol.i18n"),p$1={},I$=[[0,'java.util.Hashtable','org.jmol.i18n.Resource','org.jmol.util.Logger','java.text.MessageFormat','javajs.util.PT','org.jmol.i18n.Language']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
o=(o)[0];
}return (function(a,f){return f.apply(null,a)})([s, "{0}", o.toString()],$I$(5).rep$S$S$S);
}, 1);
...
s=(function(a,f){return f.apply(null,a)})([C$.getLanguageList$org_jmol_i18n_GT(this), code],$I$(6).getSupported$org_jmol_i18n_LanguageA$S);
