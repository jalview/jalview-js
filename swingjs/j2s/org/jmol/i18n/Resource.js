(function(){var P$=Clazz.newPackage("org.jmol.i18n"),I$=[[0,'org.jmol.viewer.Viewer','org.jmol.util.Logger','org.jmol.viewer.FileManager','org.jmol.translation.PO','javajs.util.Rdr','java.util.Hashtable','javajs.util.PT']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
try {
var br=$I$(3,"getBufferedReaderForResource$org_jmol_viewer_Viewer$O$S$S",[vwr, Clazz.new_($I$(4,1)), "org/jmol/translation/", (className.indexOf$S("Applet") >= 0 ? "JmolApplet/" : "Jmol/") + name + ".po" ]);
