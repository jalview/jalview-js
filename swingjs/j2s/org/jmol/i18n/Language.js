(function(){var P$=Clazz.newPackage("org.jmol.i18n"),I$=[[0,'org.jmol.i18n.GT']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "Language");
...
C$.$fields$=[['Z',['display'],'S',['code','language','nativeLanguage']]]
