(function(){var P$=Clazz.newPackage("org.jmol.util"),I$=[[0,'javajs.util.BS']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (bs0 == null ) return;
var bsTemp=(function(a,f){return f.apply(null,a)})([bs0.length$() + offset],$I$(1).newN$I);
