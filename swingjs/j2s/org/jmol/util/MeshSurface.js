(function(){var P$=Clazz.newPackage("org.jmol.util"),I$=[[0,'org.jmol.api.Interface','javajs.util.T3','javajs.util.AU','javajs.util.P3','org.jmol.util.C','org.jmol.util.TempArray','org.jmol.util.Geodesic','javajs.util.V3','org.jmol.util.BoxInfo']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
}this.pcs[this.pc]=(isExplicit ? (2047|0) : color == this.lastColor ? this.lastColix : (this.lastColix=(function(a,f){return f.apply(null,a)})([this.lastColor=color],$I$(5).getColix$I)));
