...
var s=(function(a,f){return f.apply(null,a)})([$I$(2).replaceWithCharacter$S$S$C(";.............;eigenvalues..;eigenvectors.;asymmatrix...;symmatrix....;value........;isotropy.....;anisotropy...;asymmetry....;eulerzyz.....;eulerzxz.....;quaternion...;indices......;string.......;type.........;id...........;span.........;skew.........", ";.", " ").trim$()],$I$(2).getTokens$S);
$I$(3).sort$OA(s);
...
(function(a,f){return f.apply(null,a)})([o, C$.getEigenSort$()],$I$(3).sort$OA$java_util_Comparator);
for (var i=0; i < 3; i++) {
var pt=i;
