(function(){var P$=Clazz.newPackage("org.jmol.util"),I$=[[0,'org.jmol.util.Elements','javajs.util.BS','javajs.util.AU','java.util.Hashtable','javajs.util.PT']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (nX != 0) {
mf += sep + (function(a,f){return f.apply(null,a)})([$I$(1).altElementNumberFromIndex$I(i)],$I$(1).elementSymbolFromNumber$I) + " " + nX ;
sep=" ";
}}
return mf;
});
...
var ch;
var isDigit;
mf=(function(a,f){return f.apply(null,a)})([$I$(5).clean$S(mf + "Z"), " ", ""],$I$(5).rep$S$S$S);
...
pt=i;
map.put$O$O(s, Clazz.array(Integer.TYPE, -1, [isDigit ? (function(a,f){return f.apply(null,a)})([mf.substring$I$I(pt0, pt)],$I$(5).parseInt$S) : 1]));
}}
