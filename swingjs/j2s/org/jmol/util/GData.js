(function(){var P$=Clazz.newPackage("org.jmol.util"),I$=[[0,'org.jmol.util.Normix','javajs.util.V3','org.jmol.util.Shader','javajs.util.AU','org.jmol.util.C','org.jmol.util.Font','javajs.util.P3']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return (function(a,f){return f.apply(null,a)})([$I$(6).getFontFaceID$S(fontFace), 0, fontSize, fontSize, this.apiPlatform, this.graphicsForMetrics],$I$(6).createFont3D$I$I$F$F$org_jmol_api_FontManager$O);
});
...
return (function(a,f){return f.apply(null,a)})([$I$(6).getFontFaceID$S(fontFace), iStyle, fontSize, fontSize, this.apiPlatform, this.graphicsForMetrics],$I$(6).createFont3D$I$I$F$F$org_jmol_api_FontManager$O);
});
