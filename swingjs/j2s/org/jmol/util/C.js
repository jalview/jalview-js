(function(){var P$=Clazz.newPackage("org.jmol.util"),I$=[[0,'org.jmol.util.Int2IntHash','javajs.util.AU','javajs.util.CU','org.jmol.c.PAL','org.jmol.util.Logger','javajs.util.PT','org.jmol.util.Escape','javajs.util.SB']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if ($I$(5).debugging) {
(function(a,f){return f.apply(null,a)})(["?? getColix(" + obj + ")" ],$I$(5).debug$S);
}return 22;
}, 1);
...
return (function(a,f){return f.apply(null,a)})([C$.getArgb$H(colix)],$I$(7).escapeColor$I);
}, 1);
