(function(){var P$=Clazz.newPackage("org.jmol.util"),p$1={},I$=[[0,'javajs.util.P3','javajs.util.Matrix','javajs.util.V3','org.jmol.util.Logger','org.jmol.util.Escape','java.util.Hashtable','javajs.util.PT','javajs.util.Lst','org.jmol.util.Vibration']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if ($I$(4).debuggingHigh) (function(a,f){return f.apply(null,a)})(["MODSET create " + id + " r0=" + $I$(5).eP$javajs_util_T3(r0) + " tau=" + this.tau ],$I$(4).debug$S);
return this;
});
...
if ($I$(4).debuggingHigh) (function(a,f){return f.apply(null,a)})(["MODSET " + this.id + " utens=" + utens + " f=" + f.toString() + " v=" + new Float(v).toString() ],$I$(4).debug$S);
...
switch (type.$c()) {
case 68:
return (function(a,f){return f.apply(null,a)})([tuv == null  ? this.r0 : this.modCalc.calculate$javajs_util_T3$Z(tuv, false)],$I$(1).newP$javajs_util_T3);
case 77:
return (function(a,f){return f.apply(null,a)})([tuv == null  ? this.v0 : this.modCalc.calculate$javajs_util_T3$Z(tuv, false).mxyz],$I$(1).newP$javajs_util_T3);
case 84:
this.modCalc.calculate$javajs_util_T3$Z(tuv, false);
var ta=this.modCalc.rI.getArray$();
return (function(a,f){return f.apply(null,a)})([ta[0][0], (this.modDim > 1 ? ta[1][0] : 0), (this.modDim > 2 ? ta[2][0] : 0)],$I$(1).new3$F$F$F);
case 79:
