...
return;
}this.myClip=(function(a,f){return f.apply(null,a)})([Clazz.new_([Clazz.getClass($I$(6),['getFrameLength$','getMicrosecondLength$','loop$I','open$javax_sound_sampled_AudioInputStream','open$javax_sound_sampled_AudioFormat$BA$I$I','setFramePosition$I','setLoopPoints$I$I','setMicrosecondPosition$J'])],$I$(5,1).c$$Class)],$I$(4).getLine$javax_sound_sampled_Line_Info);
this.myClip.addLineListener$javax_sound_sampled_LineListener(this);
var ais=(function(a,f){return f.apply(null,a)})([Clazz.new_([Clazz.new_($I$(8,1).c$$BA,[data])],$I$(7,1).c$$sun_audio_AudioData)],$I$(4).getAudioInputStream$java_io_InputStream);
