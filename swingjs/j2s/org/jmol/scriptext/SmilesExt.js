(function(){var P$=Clazz.newPackage("org.jmol.scriptext"),I$=[[0,'javajs.util.Lst','javajs.util.M4','javajs.util.P3','org.jmol.util.Logger','org.jmol.api.Interface','javajs.util.Measure','javajs.util.BS','javajs.util.AU']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
(function(a,f){return f.apply(null,a)})(["getSmilesCorrelation stddev=" + new Float(stddev).toString()],$I$(4).info$S);
if (vReturn != null ) {
if (stddev < tolerance ) {
