...
this.chk=this.e.chk;
this.slen=this.e.slen;
var se=Clazz.new_($I$(2,1)).setViewer$org_jmol_viewer_Viewer(this.vwr);
se.historyDisabled=true;
se.compiler=Clazz.new_($I$(3,1).c$$org_jmol_viewer_Viewer,[this.vwr]);
se.sm=shapeManager;
try {
...
var tokens=(asIdentity ? null : isAtoms ? $I$(5).compile$org_jmol_viewer_Viewer$S$C$java_util_Map(this.vwr, label, "\u0000", null) : $I$(5).compile$org_jmol_viewer_Viewer$S$C$java_util_Map(this.vwr, label, "\u0001", htValues));
var nmax=(haveIndex ? 1 : bs.cardinality$());
var sout=Clazz.array(String, [nmax]);
var ptTemp=Clazz.new_($I$(6,1));
for (var j=(haveIndex ? index : bs.nextSetBit$I(0)); j >= 0; j=bs.nextSetBit$I(j + 1)) {
var str;
if (isAtoms) {
if (asIdentity) str=modelSet.at[j].getInfo$();
 else str=$I$(5).formatLabelAtomArray$org_jmol_viewer_Viewer$org_jmol_modelset_Atom$org_jmol_modelset_LabelTokenA$C$IA$javajs_util_P3(this.vwr, modelSet.at[j], tokens, "\u0000", indices, ptTemp);
} else {
var bond=modelSet.bo[j];
if (asIdentity) str=bond.getIdentity$();
 else str=$I$(5).formatLabelBond$org_jmol_viewer_Viewer$org_jmol_modelset_Bond$org_jmol_modelset_LabelTokenA$java_util_Map$IA$javajs_util_P3(this.vwr, bond, tokens, htValues, indices, ptTemp);
}str=$I$(1,"formatStringI$S$S$I",[str, "#", (n + 1)]);
sout[n++]=str;
if (haveIndex) break;
}
...
}sOptions.append$S($I$(8).e$O(supercell));
...
++i;
spacegroup=$I$(1,"rep$S$S$S",[this.paramAsStr$I(i++), "\'\'", "\""]);
...
$I$(7).setOabc$S$FA$javajs_util_T3A(s, fparams, null);
} else {
...
htParams.put$O$O("unitCellOffsetFractional", (eval.coordinatesAreFractional ? Boolean.TRUE : Boolean.FALSE));
sOptions.append$S(" offset {" + new Float(offset.x).toString() + " " + new Float(offset.y).toString() + " " + new Float(offset.z).toString() + "/1}" );
} else {
sOptions.append$S(" offset " + $I$(8).eP$javajs_util_T3(offset));
...
switch (this.tokAt$I(i)) {
case 1073741938:
htParams.put$O$O("packed", Boolean.TRUE);
var oabc=null;
var tok=this.tokAt$I(++i);
switch (tok) {
case 1814695966:
...
oabc=Clazz.array($I$(6), -1, [Clazz.new_($I$(6,1)), $I$(6).new3$F$F$F(d, d, d)]);
} else {
...
if (unitCell != null ) {
oabc=$I$(9,"toOABC$javajs_util_P3A$javajs_util_T3",[unitCell.getUnitCellVerticesNoOffset$(), unitCell.getCartesianOffset$()]);
break;
}case 1678381065:
oabc=$I$(9,"toOABC$javajs_util_P3A$javajs_util_T3",[this.vwr.ms.getBBoxVertices$(), null]);
break;
}
switch (oabc.length) {
case 2:
var a=oabc[1];
oabc=Clazz.array($I$(10), -1, [oabc[0], $I$(6).newP$javajs_util_T3(oabc[0]), Clazz.new_($I$(6,1)), Clazz.new_($I$(6,1))]);
oabc[1].x=a.x;
oabc[2].y=a.y;
oabc[3].z=a.z;
break;
case 3:
oabc=Clazz.array($I$(10), -1, [Clazz.new_($I$(6,1)), oabc[0], oabc[1], oabc[2]]);
break;
case 4:
break;
default:
oabc=Clazz.array($I$(10), -1, [Clazz.new_($I$(6,1)), $I$(6).new3$F$F$F(10, 0, 0), $I$(6).new3$F$F$F(0, 10, 0), $I$(6).new3$F$F$F(0, 0, 10)]);
}
...
this.showString$S($I$(11,"i$S$I",[$I$(11).$$S("{0} charges modified"), n]));
return;
case 1075838996:
this.checkLength$I(2);
...
if (n != -2147483648) eval.report$S$Z($I$(11,"i$S$I",[$I$(11).$$S("{0} hydrogen bonds"), Math.abs(n)]), false);
return;
case 1612709900:
...
}this.showString$S($I$(11,"i$S$I",[$I$(11).$$S("{0} struts added"), n]));
}return;
case 2097180:
isSurface=true;
case 1111490575:
...
params=Clazz.new_($I$(12,1));
var fps=this.vwr.getInt$I(553648132);
if (streaming) {
params.put$O$O("streaming", Boolean.TRUE);
if (!looping) this.showString$S($I$(11,"o$S$O",[$I$(11).$$S("Note: Enable looping using the LOOP keyword just after the file name or {0}"), Clazz.array(java.lang.Object, -1, ["ANIMATION MODE LOOP"])]));
this.showString$S($I$(11,"o$S$O",[$I$(11).$$S("Animation delay based on: {0}"), Clazz.array(java.lang.Object, -1, ["ANIMATION FPS " + fps])]));
}params.put$O$O("captureFps", Integer.valueOf$I(fps));
break;
case 102409:
case 1073741874:
if (params != null ) params.put$O$O("captureSilent", Boolean.TRUE);
case 1073742335:
case 1073742334:
this.checkLength$I(-2);
mode=tok;
...
params.put$O$O("captureMode", $I$(13).nameOf$I(mode).toLowerCase$());
params.put$O$O("captureLooping", looping ? Boolean.TRUE : Boolean.FALSE);
...
var isSmiles=false;
var strSmiles=null;
var bs=$I$(14).copy$javajs_util_BS(bsFrom);
...
bsAtoms2=(coordTo == null  && eval.isArrayParameter$I(eval.iToken + 1)  ? null : (tok == 10 || tok == 1073742325  ? this.atomExpressionAt$I(++eval.iToken) : $I$(14).copy$javajs_util_BS(bsAtoms1)));
if (bsSubset != null ) {
...
if (vAtomSets == null ) vAtomSets=Clazz.new_($I$(15,1));
vAtomSets.addLast$O(Clazz.array($I$(16), -1, [bsAtoms1, bsAtoms2]));
i=eval.iToken;
break;
case 7:
...
if (vQuatSets == null ) vQuatSets=Clazz.new_($I$(15,1));
...
if (isAtoms) $I$(17).getInterface$S$org_jmol_viewer_Viewer$S("javajs.util.Eigen", this.vwr, "script");
if (vAtomSets == null  && vQuatSets == null  ) {
if (bsSubset == null ) {
bsAtoms1=(isAtoms ? this.vwr.getAtomBitSet$O("spine") : Clazz.new_($I$(16,1)));
if (bsAtoms1.nextSetBit$I(0) < 0) {
bsAtoms1=bsFrom;
bsAtoms2=bsTo;
} else {
bsAtoms2=$I$(14).copy$javajs_util_BS(bsAtoms1);
bsAtoms1.and$javajs_util_BS(bsFrom);
bsAtoms2.and$javajs_util_BS(bsTo);
}} else {
bsAtoms1=$I$(14).copy$javajs_util_BS(bsFrom);
bsAtoms2=$I$(14).copy$javajs_util_BS(bsTo);
bsAtoms1.and$javajs_util_BS(bsSubset);
bsAtoms1.and$javajs_util_BS(bsFrom);
if (bsAtoms2 != null ) {
bsAtoms2.and$javajs_util_BS(bsSubset);
bsAtoms2.and$javajs_util_BS(bsTo);
}}vAtomSets=Clazz.new_($I$(15,1));
vAtomSets.addLast$O(Clazz.array($I$(16), -1, [bsAtoms1, bsAtoms2]));
}var bsFrames;
if (isFrames) {
var bsModels=this.vwr.ms.getModelBS$javajs_util_BS$Z(bsFrom, false);
bsFrames=Clazz.array($I$(16), [bsModels.cardinality$()]);
...
bsFrames=Clazz.array($I$(16), -1, [bsFrom]);
}for (var iFrame=0; iFrame < bsFrames.length; iFrame++) {
bsFrom=bsFrames[iFrame];
var retStddev=Clazz.array(Float.TYPE, [2]);
var q=null;
var vQ=Clazz.new_($I$(15,1));
var centerAndPoints=null;
var vAtomSets2=(isFrames ? Clazz.new_($I$(15,1)) : vAtomSets);
for (var i=0; i < vAtomSets.size$(); ++i) {
var bss=vAtomSets.get$I(i);
if (isFrames) vAtomSets2.addLast$O(bss=Clazz.array($I$(16), -1, [$I$(14).copy$javajs_util_BS(bss[0]), bss[1]]));
...
q=$I$(18).calculateQuaternionRotation$javajs_util_P3AA$FA(centerAndPoints, retStddev);
...
data1=vQ.toArray$OA(Clazz.array($I$(19), [vQ.size$()]));
q=$I$(19).sphereMean$javajs_util_QuatA$FA$F(data1, retStddev, 1.0E-4);
this.showString$S("RMSD = " + new Float(retStddev[0]).toString() + " degrees" );
} else {
var m4=Clazz.new_($I$(20,1));
center=Clazz.new_($I$(6,1));
...
translation=Clazz.new_($I$(21,1));
m4.getTranslation$javajs_util_T3(translation);
}if (doRotate) {
var m3=Clazz.new_($I$(22,1));
m4.getRotationScale$javajs_util_M3(m3);
q=$I$(19).newM$javajs_util_M3(m3);
...
}var pt1=Clazz.new_($I$(6,1));
var endDegrees=NaN;
if (doTranslate) {
if (translation == null ) translation=$I$(21).newVsub$javajs_util_T3$javajs_util_T3(centerAndPoints[1][0], center);
endDegrees=1.0E10;
}if (doRotate) {
...
var m4=$I$(23,"getMatrix4f$javajs_util_M3$javajs_util_T3",[q.getMatrix$(), translation]);
ptsB=$I$(18).transformPoints$javajs_util_Lst$javajs_util_M4$javajs_util_P3(ptsA, m4, center);
}if (!eval.useThreads$()) doAnimate=false;
if (this.vwr.rotateAboutPointsInternal$org_jmol_api_JmolScriptEvaluator$javajs_util_P3$javajs_util_P3$F$F$Z$javajs_util_BS$javajs_util_V3$javajs_util_Lst$FA$javajs_util_M4(eval, center, pt1, endDegrees / nSeconds, endDegrees, doAnimate, bsFrom, translation, ptsB, null, null) && doAnimate && eval.isJS  ) throw Clazz.new_($I$(24,1).c$$org_jmol_script_ScriptEval$S$I,[eval, "compare", 1]);
}
}, p$1);
...
this.vwr.addStateScript$S$Z$Z("configuration " + $I$(8).eBS$javajs_util_BS(bsAtoms) + " " + n + ";" , true, false);
...
case 1073742334:
this.setShapeProperty$I$S$O(6, "hideAll", Boolean.TRUE);
return;
case 12291:
...
case 1073742335:
this.vwr.shm.loadShape$I(6);
this.setShapeProperty$I$S$O(6, "hideAll", Boolean.FALSE);
return;
case 1073742001:
...
break;
case 1765808134:
colix=$I$(25,"getColix$I",[eval.getArgbParam$I(++i)]);
i=eval.iToken;
break;
case 1073742066:
if (eval.isPoint3f$I(++i)) {
...
case 1073741989:
case 1073741990:
intramolecular=Boolean.valueOf$Z(eval.theTok == 1073741989);
isAll=true;
...
isNotConnected=true;
isAll=true;
intramolecular=Boolean.valueOf$Z(false);
if (nBitSets == 1) {
nBitSets++;
nAtoms++;
var bs2=$I$(14).copy$javajs_util_BS(bs);
$I$(14).invertInPlace$javajs_util_BS$I(bs2, this.vwr.ms.ac);
...
break;
case 1715472409:
property=this.paramAsStr$I(i);
break;
case 1073742188:
value=this.floatParameter$I(++i);
break;
case 4:
...
}this.setShapeProperty$I$S$O(6, "measure", this.vwr.newMeasurementData$S$javajs_util_Lst(id, points).set$I$java_util_Map$org_jmol_atomdata_RadiusData$S$S$S$org_jmol_modelset_TickInfo$Z$Z$Boolean$Z$I$H$org_jmol_modelset_Text$F(tokAction, null, rd, property, strFormat, units, tickInfo, isAllConnected, isNotConnected, intramolecular, isAll, mad, colix, text, value));
return;
...
var atomSets=Clazz.array($I$(16), [2]);
...
var bsExclude=Clazz.new_($I$(16,1));
...
if (isDelete) {
if (report) eval.report$S$Z($I$(11,"i$S$I",[$I$(11).$$S("{0} connections deleted"), nModified]), false);
return;
}if (isColorOrRadius) {
...
}if (report) eval.report$S$Z($I$(11,"o$S$O",[$I$(11).$$S("{0} new bonds; {1} modified"), Clazz.array(java.lang.Object, -1, [Integer.valueOf$I(nNew), Integer.valueOf$I(nModified)])]), false);
}, p$1);
...
d[2]=$I$(14).copy$javajs_util_BS(bs);
}d[1]=dataString;
d[3]=Integer.valueOf$I(0);
...
break;
case 1611272194:
var axes=Clazz.array($I$(21), [3]);
var l=null;
switch (this.getToken$I(i + 1).tok) {
case 11:
i++;
var m=eval.theToken.value;
for (var im=3; --im >= 0; ) m.getColumnV$I$javajs_util_T3(im, axes[im]=Clazz.new_($I$(21,1)));
...
l.addLast$O($I$(34,"newV$I$O",[8, this.centerParameter$I(i)]));
...
switch (v.tok) {
case 7:
axes[k]=$I$(21,"new3$F$F$F",[$I$(34,"fValue$org_jmol_script_T",[v.getList$().get$I(0)]), $I$(34,"fValue$org_jmol_script_T",[v.getList$().get$I(1)]), $I$(34,"fValue$org_jmol_script_T",[v.getList$().get$I(2)])]);
break;
case 8:
axes[k]=$I$(21).newV$javajs_util_T3(v.value);
break;
}
}
}i=eval.iToken;
...
if (this.tokAt$I(++eval.iToken) != 1073742336 || !$I$(13,"tokAttr$I$I",[tokProp1=this.tokAt$I(++eval.iToken), 1077936128]) ) break;
property1=this.paramAsStr$I(eval.iToken);
bsTo=this.atomExpressionAt$I(++eval.iToken);
if (this.tokAt$I(++eval.iToken) != 1073742336 || !$I$(13,"tokAttr$I$I",[tokProp2=this.tokAt$I(++eval.iToken), 2048]) ) break;
property2=this.paramAsStr$I(eval.iToken);
}if ($I$(13,"tokAttr$I$I",[tokKey=this.tokAt$I(eval.iToken + 1), 1077936128])) mapKey=this.paramAsStr$I(++eval.iToken);
 else mapKey=$I$(13,"nameOf$I",[tokKey=1094715393]);
eval.checkLast$I(eval.iToken);
if (this.chk) return;
var bsOut=null;
...
if ($I$(13).tokAttrOr$I$I$I(tokProp1, 1094713344, 1111490560) && $I$(13).tokAttrOr$I$I$I(tokProp2, 1094713344, 1111490560) && $I$(13).tokAttrOr$I$I$I(tokKey, 1094713344, 1111490560)  ) {
...
if (isProperty) this.vwr.setData$S$OA$I$I$I$I$I(property2, Clazz.array(java.lang.Object, -1, [property2, dataOut, bsOut, Integer.valueOf$I(1), Boolean.TRUE]), this.vwr.ms.ac, 0, 0, 2147483647, 0);
 else if (!$I$(13).tokAttr$I$I(tokProp2, 2048)) this.error$I(56);
...
var bsSubset=$I$(14).copy$javajs_util_BS(this.vwr.slm.bsSubset);
...
throw Clazz.new_($I$(24,1).c$$org_jmol_script_ScriptEval$S$I,[this.e, "minimize", 1]);
} else {
throw e1;
}
}
...
switch (this.tokAt$I(1)) {
case 2:
this.st[1]=$I$(13).o$I$O(4, "" + this.st[1].value);
default:
bs=this.atomExpressionAt$I(1);
i=++this.e.iToken;
break;
...
return;
}var rotAxis=$I$(21).new3$F$F$F(0, 1, 0);
...
var bs=$I$(14,"copy$javajs_util_BS",[this.vwr.bsA$()]);
var preSelected="; select " + $I$(8).eBS$javajs_util_BS(bs) + ";\n " ;
var type=eval.optParameterAsString$I(pt).toLowerCase$();
var minXYZ=null;
var maxXYZ=null;
var format=null;
var tok=C$.tokAtArray$I$org_jmol_script_TA(pt0, args);
if (tok == 4) tok=$I$(13).getTokFromName$S(args[pt0].value);
switch (tok) {
default:
eval.iToken=1;
this.invArg$();
...
switch (this.tokAt$I(eval.iToken)) {
case 4:
propToks[i]=$I$(13,"getTokFromName$S",[eval.getToken$I(eval.iToken).value]);
break;
default:
...
if (propToks[i] != 1715472409 && !$I$(13).tokAttr$I$I(propToks[i], 1077936128) ) this.invArg$();
...
stateScript="select " + $I$(8).eBS$javajs_util_BS(bs) + ";\n " ;
break;
case 4138:
...
propData[0]=props[0] + " " + $I$(8).eAF$FA(dataX) ;
if (props[1] != null ) {
...
propData[1]=props[1] + " " + $I$(8).eAF$FA(dataY) ;
}if (props[2] != null ) {
...
propData[2]=props[2] + " " + $I$(8).eAF$FA(dataZ) ;
...
if ($I$(13).tokAttr$I$I(propToks[0], 1094713344)) {
factors.x=1;
center.x=0;
} else if (factors.x > 0.1  && factors.x <= 10  ) {
factors.x=1;
}if ($I$(13).tokAttr$I$I(propToks[1], 1094713344)) {
factors.y=1;
center.y=0;
} else if (factors.y > 0.1  && factors.y <= 10  ) {
factors.y=1;
}if ($I$(13).tokAttr$I$I(propToks[2], 1094713344)) {
factors.z=1;
center.z=0;
...
var color=($I$(25).getHexCode$H(this.vwr.cm.colixBackgroundContrast));
...
this.setShapeProperty$I$S$O(21, "init", Boolean.TRUE);
var translucentLevel=3.4028235E38;
var radius=-1;
var colorArgb=Clazz.array(Integer.TYPE, -1, [-2147483648]);
var noToParam=-1;
...
if (!this.chk) ($I$(17).getInterface$S$org_jmol_viewer_Viewer$S("org.jmol.util.BZone", this.vwr, "script")).setViewer$org_jmol_viewer_Viewer(this.vwr).createBZ$I$OA$Z$S$F(index, null, false, id, scale);
this.setShapeProperty$I$S$O(21, "init", Boolean.FALSE);
return;
case 6:
propertyName="info";
...
case 1073742099:
case 1073741924:
propertyName=$I$(13).nameOf$I(eval.theTok);
switch (this.tokAt$I(i + 1)) {
case 268435860:
case 268435504:
i++;
...
if (tok == 4 && !isCommand ) {
var t0=$I$(13,"getTokenFromName$S",[$I$(34).sValue$org_jmol_script_T(args[0]).toLowerCase$()]);
...
default:
type=$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [pt, args])]).toUpperCase$();
}
...
case 1073741984:
type="INLINE";
data=$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [++pt, args])]);
pt++;
break;
case 134217762:
type="PGRP";
pt++;
type2=$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [pt, args])]).toLowerCase$();
...
case 1073742158:
case 134222850:
val=$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [++pt, args])]).toLowerCase$();
while (val.equals$O("localpath") || val.equals$O("remotepath") ){
if (val.equals$O("localpath")) localPath=$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [++pt, args])]);
 else remotePath=$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [++pt, args])]);
val=$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [++pt, args])]).toLowerCase$();
}
type="SPT";
break;
...
break;
case 1073742139:
val=$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [++pt, args])]).toUpperCase$();
...
var t=$I$(13,"getTokenFromName$S",[$I$(34).sValue$org_jmol_script_T(args[pt]).toLowerCase$()]);
if (t != null ) type=$I$(34).sValue$org_jmol_script_T(t).toUpperCase$();
if ($I$(1,"isOneOf$S$S",[type, driverList.toUpperCase$()])) {
pt++;
...
width=$I$(34,"iValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [pt++, args])]);
if (width <= 0) this.invArg$();
height=$I$(34,"iValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [pt++, args])]);
if (height <= 0) this.invArg$();
}break;
}
if (pt0 < argCount) {
val=$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [pt, args])]);
if (val.equalsIgnoreCase$S("clipboard")) {
if (this.chk) return "";
} else if ($I$(1,"isOneOf$S$S",[val.toLowerCase$(), ";jpg;jpeg;jpg64;jpeg64;gif;gift;pdf;ppm;png;pngj;pngt;"])) {
if (C$.tokAtArray$I$org_jmol_script_TA(pt + 1, args) == 2 && C$.tokAtArray$I$org_jmol_script_TA(pt + 2, args) == 2 ) {
width=$I$(34,"iValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [++pt, args])]);
if (width <= 0) this.invArg$();
height=$I$(34,"iValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [++pt, args])]);
if (height <= 0) this.invArg$();
}if (C$.tokAtArray$I$org_jmol_script_TA(pt + 1, args) == 2) quality=$I$(34,"iValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [++pt, args])]);
} else if ($I$(1,"isOneOf$S$S",[val.toLowerCase$(), ";xyz;xyzrn;xyzvib;mol;mol67;sdf;v2000;v3000;json;pdb;pqr;cml;cif;qcjson;"])) {
type=val.toUpperCase$();
if (pt + 1 == argCount) pt++;
}if (type.equals$O("IMAGE") && $I$(1,"isOneOf$S$S",[val.toLowerCase$(), ";jpg;jpeg;jpg64;jpeg64;gif;gift;pdf;ppm;png;pngj;pngt;scene;"]) ) {
type=val.toUpperCase$();
quality=-2147483648;
pt++;
}}if (pt + 2 == argCount) {
$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [++pt, args])]);
...
case 1073741824:
case 4:
fileName=$I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [pt, args])]);
...
}var isImage=$I$(1,"isOneOf$S$S",[type.toLowerCase$(), ";jpg;jpeg;jpg64;jpeg64;gif;gift;pdf;ppm;png;pngj;pngt;scene;"]);
if (!isImage) {
...
if (tVar == null ) {
tVar=eval.getParameter$S$I$Z($I$(34,"sValue$org_jmol_script_T",[p$1.tokenAt$I$org_jmol_script_TA.apply(this, [isCommand ? 2 : 1, args])]), 1073742190, true);
}var v=null;
if (tVar.tok == 15) {
v=Clazz.new_($I$(15,1));
v.addLast$O((tVar.value).data);
} else if (tVar.tok == 6) {
v=(fileName == null  ? Clazz.new_($I$(15,1)) : this.prepareBinaryOutput$org_jmol_script_SV(tVar));
}if (v == null ) {
data=tVar.asString$();
type="TXT";
} else {
...
params.put$O$O("type", type);
if (is2D) {
params.put$O$O("is2D", Boolean.TRUE);
var smiles;
...
if (tok == 4) {
token=$I$(13,"getTokenFromName$S",[str.toLowerCase$()]);
...
case 134221829:
if (!this.chk) msg=$I$(8,"e$O",[this.vwr.fm.cacheList$()]);
break;
case 1111490587:
eval.checkLength23$();
len=this.st.length;
...
msg=(d == null  ? "no DSSR information has been read" : len > 2 ? $I$(34,"getVariable$O",[this.vwr.extractProperty$O$O$I(d, this.stringParameter$I(2), -1)]).asString$() : "" + $I$(34).getVariable$O(d).asString$());
}break;
case 1073741915:
var version=2;
...
var ret=Clazz.array($I$(16), -1, [null, this.vwr.getFrameAtoms$()]);
...
break;
case 536870918:
value=$I$(8,"eP$javajs_util_T3",[this.vwr.getDefaultLattice$()]);
break;
case 4126:
...
break;
case 1073741828:
msg=$I$(8,"eAP$javajs_util_T3A",[this.vwr.getAdditionalHydrogens$javajs_util_BS$Z$Z$javajs_util_Lst(null, true, true, null)]);
break;
case 1612709900:
...
msg=(data == null  ? "no data" : $I$(8,"encapsulateData$S$O$I",[data[0], data[1], (data[3]).intValue$()]));
}break;
case 1073742330:
len=3;
...
case 12289:
if (!this.chk) msg="center " + $I$(8).eP$javajs_util_T3(this.vwr.tm.fixedRotationCenter);
break;
case 135176:
...
msg=this.vwr.getOrientationText$I$S$javajs_util_BS($I$(13,"getTokFromName$S",[msg.equals$O("box") ? "volume" : msg.equals$O("rotation") ? "best" : msg]), "best", null).toString();
}break;
case 1073742132:
tok=this.tokAt$I(2);
...
}if (Clazz.instanceOf(newUC, Clazz.array($I$(10), -1))) {
oabc=newUC;
...
if (!isPrimitive) {
$I$(7).getReciprocal$javajs_util_T3A$javajs_util_T3A$F(oabc, oabc, scale);
}break;
}} else {
ucname=s;
...
var bs=(atomIndex < 0 ? Clazz.new_($I$(16,1)) : $I$(14).newAndSetBit$I(atomIndex));
var pts=Clazz.array($I$(6), -1, [pt]);
var vConnections=Clazz.new_($I$(15,1));
var modelIndex=-1;
if (atom != null ) {
...
var tokens=$I$(1,"getTokens$S",[str.substring$I$I(pt, lines[iLine])]);
$I$(1,"parseFloatArrayData$SA$FA",[tokens, data[iLine]=Clazz.array(Float.TYPE, [tokens.length])]);
}
return data;
}var tokens=$I$(1,"getTokens$S",[str.substring$I$I(0, lines[0])]);
...
tokens=$I$(1,"getTokens$S",[str.substring$I$I(pt, lines[iLine])]);
if (tokens.length < nZ) continue;
$I$(1,"parseFloatArrayData$SA$FA",[tokens, data[iX][iY]=Clazz.array(Float.TYPE, [tokens.length])]);
if (++iY == nY) {
iX++;
iY=0;
}}
...
;Clazz.setTVer('3.2.9-v1');//Created 2020-06-01 14:49:45 Java2ScriptVisitor version 3.2.9-v1 net.sf.j2s.core.jar version 3.2.9-v1
