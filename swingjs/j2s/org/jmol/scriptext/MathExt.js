...
for (var i=pts.length; --i >= 0; ) pts[i]=(function(a,f){return f.apply(null,a)})([points.get$I(i)],$I$(1).ptValue$org_jmol_script_SV);
...
var x1=(isSelector ? (function(a,f){return f.apply(null,a)})([mp.getX$(), true],$I$(1).getBitSet$org_jmol_script_SV$Z) : null);
...
for (var i=0; i < 3; i++) ucnew[i + 1]=(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([uc.get$I(i)],$I$(1).ptValue$org_jmol_script_SV)],$I$(2).newP$javajs_util_T3);

break;
case 4:
for (var i=0; i < 4; i++) ucnew[i]=(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([uc.get$I(i)],$I$(1).ptValue$org_jmol_script_SV)],$I$(2).newP$javajs_util_T3);
...
switch (lastParam) {
case 3:
for (var i=1; i < 4; i++) (ucnew[i]=(function(a,f){return f.apply(null,a)})([$I$(1).ptValue$org_jmol_script_SV(args[i])],$I$(2).newP$javajs_util_T3)).sub$javajs_util_T3(ucnew[0]);

break;
case 1:
var l=args[1].getList$();
if (l != null  && l.size$() == 3 ) {
for (var i=0; i < 3; i++) ucnew[i + 1]=(function(a,f){return f.apply(null,a)})([l.get$I(i)],$I$(1).ptValue$org_jmol_script_SV);
...
for (var i=0, n=lst1.size$(); i < n; i++) {
var m=lst1.get$I(i);
var m1=(function(a,f){return f.apply(null,a)})([m.getMap$(), true, false],$I$(1).deepCopy$O$Z$Z);
...
if (key != null ) maps=(function(a,f){return f.apply(null,a)})([list.size$()],$I$(7).createArrayOfHashtable$I);
try {
for (var i=list.size$(); --i >= 0; ) data[i]=(function(a,f){return f.apply(null,a)})([key == null  ? list.get$I(i) : (maps[i]=list.get$I(i).getMap$()).get$O(key)],$I$(1).fValue$org_jmol_script_T);
...
var v1=f0 + df * bin;
var v2=v1 + df;
map.put$O$O("_binMin", (function(a,f){return f.apply(null,a)})([bin == 0 ? -3.4028235E38 : v1],$I$(1).newF$F));
map.put$O$O("_binMax", (function(a,f){return f.apply(null,a)})([bin == nbins - 1 ? 3.4028235E38 : v2],$I$(1).newF$F));
}}
if (addBins) {
var lst=Clazz.new_($I$(5,1));
...
if (args.length == 2 && colorScheme.equalsIgnoreCase$S("TOHSL") ) return mp.addXPt$javajs_util_P3((function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([args[1].tok == 8 ? $I$(1).ptValue$org_jmol_script_SV(args[1]) : (function(a,f){return f.apply(null,a)})([args[1].asString$()],$I$(8).colorPtFromString$S)],$I$(2).newP$javajs_util_T3), true],$I$(8).rgbToHSL$javajs_util_P3$Z));
if (args.length == 2 && colorScheme.equalsIgnoreCase$S("TORGB") ) {
var pt=(function(a,f){return f.apply(null,a)})([args[1].tok == 8 ? $I$(1).ptValue$org_jmol_script_SV(args[1]) : (function(a,f){return f.apply(null,a)})([args[1].asString$()],$I$(8).colorPtFromString$S)],$I$(2).newP$javajs_util_T3);
...
var pt1=(function(a,f){return f.apply(null,a)})([args[0].tok == 8 ? $I$(1).ptValue$org_jmol_script_SV(args[0]) : (function(a,f){return f.apply(null,a)})([args[0].asString$()],$I$(8).colorPtFromString$S)],$I$(2).newP$javajs_util_T3);
var pt2=(function(a,f){return f.apply(null,a)})([args[1].tok == 8 ? $I$(1).ptValue$org_jmol_script_SV(args[1]) : (function(a,f){return f.apply(null,a)})([args[1].asString$()],$I$(8).colorPtFromString$S)],$I$(2).newP$javajs_util_T3);
...
vd.scale$F(1.0 / (n - 1));
for (var i=0; i < n; i++) {
sb.append$S((function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([usingHSL ? $I$(8).hslToRGB$javajs_util_P3(pt1) : pt1],$I$(8).colorPtToFFRGB$javajs_util_T3)],$I$(11).escapeColor$I));
...
if (getValue) return mp.addXPt$javajs_util_P3((function(a,f){return f.apply(null,a)})([ce.getArgb$F(hi == 3.4028235E38  ? lo : value), null],$I$(8).colorPtFromInt$I$javajs_util_P3));
...
}if (intValue == 1275203608) atoms1=(function(a,f){return f.apply(null,a)})([mp.getX$(), true],$I$(1).getBitSet$org_jmol_script_SV$Z);
...
return mp.addX$org_jmol_script_SV((function(a,f){return f.apply(null,a)})([10, (function(a,f){return f.apply(null,a)})([bsBonds, this.vwr.ms.getAtomIndices$javajs_util_BS(this.vwr.ms.getAtoms$I$O(1677721602, bsBonds))],$I$(18).newBS$javajs_util_BS$IA)],$I$(1).newV$I$O));
...
var f=(function(a,f){return f.apply(null,a)})([$I$(1).sValue$org_jmol_script_T(args[0]), null, 0, 0, null, iField, nBytes, null, firstLine],$I$(23).parseFloatArrayFromMatchAndField$S$javajs_util_BS$I$I$IA$I$I$FA$I);
...
if (tok == 1275069442) {
var a=(function(a,f){return f.apply(null,a)})([mp.ptValue$org_jmol_script_SV$javajs_util_BS(x1, null)],$I$(2).newP$javajs_util_T3);
...
var pt=(function(a,f){return f.apply(null,a)})([list1.get$I(i)],$I$(1).ptValue$org_jmol_script_SV);
...
return mp.addXAF$FA(data);
}for (var i=data.length; --i >= 0; ) data[i]=(this.e.getBitsetProperty$javajs_util_BS$javajs_util_Lst$I$javajs_util_P3$javajs_util_P4$O$O$Z$I$Z(bs2, list2, op, (function(a,f){return f.apply(null,a)})([list1.get$I(i)],$I$(1).ptValue$org_jmol_script_SV), plane2, null, null, false, 2147483647, false)).floatValue$();
...
if (isDist) {
if (plane2 != null  && x3 != null  ) f=(function(a,f){return f.apply(null,a)})([pt1, plane2, $I$(1).ptValue$org_jmol_script_SV(x3)],$I$(15).directedDistanceToPlane$javajs_util_P3$javajs_util_P4$javajs_util_P3);
...
if (data.startsWith$S("InChI")) data=(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([data, "InChI=", ""],$I$(27).rep$S$S$S), "InChIKey=", ""],$I$(27).rep$S$S$S);
...
if (isMF || isCF ) return mp.addXStr$S((function(a,f){return f.apply(null,a)})([this.vwr.ms.at, bs, (isMF ? null : this.vwr.ms.getCellWeights$javajs_util_BS(bs)), isON],$I$(13).getMolecularFormulaAtoms$org_jmol_util_NodeA$javajs_util_BS$FA$Z));
if (isSequence || isSeq ) {
...
isMatch=((function(a,f){return f.apply(null,a)})([svlist.get$I(i)],$I$(1).sValue$org_jmol_script_T).indexOf$S(sFind) >= 0);
...
shapeID=(function(a,f){return f.apply(null,a)})([$I$(24).getTokFromName$S(name)],$I$(26).shapeTokenIndex$I);
if (shapeID >= 0) {
data[0]=pname;
...
if (vlist == null ) map.put$O$O(key, vlist=(function(a,f){return f.apply(null,a)})([7, Clazz.new_($I$(5,1))],$I$(1).newV$I$O));
...
x1=(function(a,f){return f.apply(null,a)})([p$1.getSublist$javajs_util_Lst$javajs_util_Lst.apply(this, [listIn, formatList])],$I$(1).getVariableList$javajs_util_Lst);
...
return mp.addXObj$O(format == null  ? "" : bs == null  ? (function(a,f){return f.apply(null,a)})([$I$(27).formatCheck$S(format), x1],$I$(1).sprintf$S$org_jmol_script_SV) : this.e.getCmdExt$().getBitsetIdent$javajs_util_BS$S$O$Z$I$Z(bs, format, x1.value, true, x1.index, asArray));
}, p$1);
...
v=map.get$O((function(a,f){return f.apply(null,a)})([formatList.get$I(j)],$I$(1).sValue$org_jmol_script_T));
...
map.put$O$O((function(a,f){return f.apply(null,a)})([formatList.get$I(j)],$I$(1).sValue$org_jmol_script_T), list.get$I(j));
}
...
x2=args[1];
if (tok == 1275069441) {
sList1=(isArray1 ? $I$(1).strListValue$org_jmol_script_T(x1) : (function(a,f){return f.apply(null,a)})([$I$(1).sValue$org_jmol_script_T(x1), "\n"],$I$(27).split$S$S));
sList2=(x2.tok == 7 ? $I$(1).strListValue$org_jmol_script_T(x2) : (function(a,f){return f.apply(null,a)})([$I$(1).sValue$org_jmol_script_T(x2), "\n"],$I$(27).split$S$S));
...
s2[i]=(function(a,f){return f.apply(null,a)})([sb.toString()],$I$(1).newS$S);
}}
...
la.addLast$O((function(a,f){return f.apply(null,a)})([Integer.parseInt$S(s)],$I$(1).newI$I));
continue;
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
} else {
...
la.addLast$O((function(a,f){return f.apply(null,a)})([Float.valueOf$F(Float.parseFloat$S(s))],$I$(1).getVariable$O));
continue;
} catch (ee) {
...
sList1=((function(a,f){return f.apply(null,a)})([$I$(1).sValue$org_jmol_script_T(x1), "\n"],$I$(27).split$S$S));
list1=Clazz.array(Float.TYPE, [len=sList1.length]);
$I$(27).parseFloatArrayData$SA$FA(sList1, list1);
}if (isAll && tok != 1275069446 ) {
var sum=0.0;
if (isArray1) {
for (var i=len; --i >= 0; ) sum += (function(a,f){return f.apply(null,a)})([alist1.get$I(i)],$I$(1).fValue$org_jmol_script_T);
...
for (var i=0; i < len; i++) sb.append$S(i > 0 ? s : "").append$S((function(a,f){return f.apply(null,a)})([alist1.get$I(i)],$I$(1).sValue$org_jmol_script_T));
...
sList2=(function(a,f){return f.apply(null,a)})([$I$(1).sValue$org_jmol_script_T(x2), "\n"],$I$(27).split$S$S);
...
if (isScalar2) b=scalar;
 ...
 else if (Float.isNaN$F(list2[i])) b=(function(a,f){return f.apply(null,a)})([$I$(1).unescapePointOrBitsetAsVariable$O(sList2[i])],$I$(1).getVariable$O);
 else b=$I$(1).newF$F(list2[i]);
if (!isScalar1) {
if (isArray1) a=alist1.get$I(i);
 else if (Float.isNaN$F(list1[i])) a=(function(a,f){return f.apply(null,a)})([$I$(1).unescapePointOrBitsetAsVariable$O(sList1[i])],$I$(1).getVariable$O);
...
if (args.length < 1 || args.length > 3 ) return false;
var file=(function(a,f){return f.apply(null,a)})([$I$(1).sValue$org_jmol_script_T(args[0])],$I$(29).fixDOSName$S);
...
if (tok == 134217749) {
if (args.length == 1 && args[0].tok == 4 ) return mp.addXStr$S((Clazz.new_($I$(31,1))) + "\t" + $I$(1).sValue$org_jmol_script_T(args[0]) );
...
if (s.equalsIgnoreCase$S("vdw") || s.equalsIgnoreCase$S("vanderwaals") ) vdw=(i + 1 < args.length && args[i + 1].tok == 2  ? args[++i].asInt$() : 100) / 100.0;
 ...
 else if ((function(a,f){return f.apply(null,a)})([s.toLowerCase$(), ";nm;nanometers;pm;picometers;angstroms;ang;au;"],$I$(27).isOneOf$S$S) || s.endsWith$S("hz") ) units=s.toLowerCase$();
...
return mp.addXPt4$javajs_util_P4((function(a,f){return f.apply(null,a)})([pts.get$I(0), pts.get$I(1), pts.get$I(2), Clazz.new_($I$(10,1)), Clazz.new_($I$(10,1)), Clazz.new_($I$(33,1))],$I$(15).getPlaneThroughPoints$javajs_util_T3$javajs_util_T3$javajs_util_T3$javajs_util_V3$javajs_util_V3$javajs_util_P4));
}}var pt=(function(a,f){return f.apply(null,a)})([$I$(1).sValue$org_jmol_script_T(args[0])],$I$(11).uP$S);
...
switch (tok) {
case 134219265:
return mp.addXPt4$javajs_util_P4(this.e.getHklPlane$javajs_util_P3((function(a,f){return f.apply(null,a)})([$I$(1).fValue$org_jmol_script_T(args[0]), $I$(1).fValue$org_jmol_script_T(args[1]), $I$(1).fValue$org_jmol_script_T(args[2])],$I$(2).new3$F$F$F)));
case 134217763:
...
pt3=(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([sv.get$I(0)],$I$(1).ptValue$org_jmol_script_SV)],$I$(2).newP$javajs_util_T3);
pt3.scaleAdd2$F$javajs_util_T3$javajs_util_T3(pt1.x, (function(a,f){return f.apply(null,a)})([sv.get$I(1)],$I$(1).ptValue$org_jmol_script_SV), pt3);
pt3.scaleAdd2$F$javajs_util_T3$javajs_util_T3(pt1.y, (function(a,f){return f.apply(null,a)})([sv.get$I(2)],$I$(1).ptValue$org_jmol_script_SV), pt3);
pt3.scaleAdd2$F$javajs_util_T3$javajs_util_T3(pt1.z, (function(a,f){return f.apply(null,a)})([sv.get$I(3)],$I$(1).ptValue$org_jmol_script_SV), pt3);
break;
default:
return false;
}
return mp.addXPt$javajs_util_P3(pt3);
case 3:
return mp.addXPt$javajs_util_P3((function(a,f){return f.apply(null,a)})([args[0].asFloat$(), args[1].asFloat$(), args[2].asFloat$()],$I$(2).new3$F$F$F));
case 4:
return mp.addXPt4$javajs_util_P4((function(a,f){return f.apply(null,a)})([args[0].asFloat$(), args[1].asFloat$(), args[2].asFloat$(), args[3].asFloat$()],$I$(33).new4$F$F$F$F));
}
}, p$1);
...
var s=$I$(1).sValue$org_jmol_script_T(args[0]);
var v=(function(a,f){return f.apply(null,a)})([s.equalsIgnoreCase$S("best") ? this.vwr.getOrientationText$I$S$javajs_util_BS(1073741864, "best", null).toString() : s],$I$(11).uP$S);
if (!(Clazz.instanceOf(v, "javajs.util.P4"))) return false;
p4=v;
}if (tok == 134217731) q=(function(a,f){return f.apply(null,a)})([$I$(2).new3$F$F$F(p4.x, p4.y, p4.z), p4.w],$I$(25).newVA$javajs_util_T3$F);
break;
case 2:
if (tok == 134221850) {
...
if (pt1 != null ) q=(function(a,f){return f.apply(null,a)})([$I$(2).new3$F$F$F(0, 0, 0), pt0, pt1],$I$(25).getQuaternionFrame$javajs_util_P3$javajs_util_T3$javajs_util_T3);
 else q=(function(a,f){return f.apply(null,a)})([pt0, $I$(1).fValue$org_jmol_script_T(args[1])],$I$(25).newVA$javajs_util_T3$F);
break;
case 3:
if (args[0].tok == 9) {
var pt=(args[2].tok == 8 ? args[2].value : this.vwr.ms.getAtomSetCenter$javajs_util_BS(args[2].value));
return mp.addXStr$S((function(a,f){return f.apply(null,a)})([$I$(25).newP4$javajs_util_P4(args[0].value), "q", $I$(1).sValue$org_jmol_script_T(args[1]), pt, 1.0],$I$(11).drawQuat$javajs_util_Quat$S$S$javajs_util_P3$F));
...
break;
case 4:
if (tok == 134221850) p4=(function(a,f){return f.apply(null,a)})([$I$(1).fValue$org_jmol_script_T(args[1]), $I$(1).fValue$org_jmol_script_T(args[2]), $I$(1).fValue$org_jmol_script_T(args[3]), $I$(1).fValue$org_jmol_script_T(args[0])],$I$(33).new4$F$F$F$F);
 else q=(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([$I$(1).fValue$org_jmol_script_T(args[0]), $I$(1).fValue$org_jmol_script_T(args[1]), $I$(1).fValue$org_jmol_script_T(args[2])],$I$(2).new3$F$F$F), $I$(1).fValue$org_jmol_script_T(args[3])],$I$(25).newVA$javajs_util_T3$F);
break;
}
if (qs != null ) {
if (nMax != 2147483647) {
...
if (lst != null ) for (var i=0, n=lst.size$(); i < n; i++) if ((function(a,f){return f.apply(null,a)})([x1, lst.get$I(i)],$I$(1).areEqual$org_jmol_script_SV$org_jmol_script_SV)) return mp.addXInt$I(i + 1);
...
return mp.addX$org_jmol_script_SV((function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([x.asString$()],$I$(27).getTokens$S)],$I$(1).getVariable$O));
}break;
case 2:
if (x.tok == 7) break;
if (tok == 1275069447) {
x=(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([$I$(27).rep$S$S$S(x.value, "\n\r", "\n").replace$C$C("\r", "\n"), "\n"],$I$(27).split$S$S)],$I$(1).getVariable$O);
break;
}default:
return false;
}
...
var ops=(function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})([this.vwr.getSymTemp$().getSpaceGroupInfo$org_jmol_modelset_ModelSet$S$I$Z$FA(this.vwr.ms, null, this.vwr.ms.at[bsAtoms.nextSetBit$I(0)].mi, false, null).get$O("symmetryInfo"), "\n"],$I$(27).trim$S$S), "\n"],$I$(27).split$S$S);
var lst=Clazz.new_($I$(5,1));
...
System.out.println$S(args[1].tok + " " + 1275068445 );
...
for (var i=ap3.length; --i >= 0; ) ap3[i]=(function(a,f){return f.apply(null,a)})([sv.get$I(i)],$I$(1).ptValue$org_jmol_script_SV);

var ap31=null;
if (pts1 != null ) {
ap31=Clazz.array($I$(2), [pts1.size$()]);
for (var i=ap31.length; --i >= 0; ) ap31[i]=(function(a,f){return f.apply(null,a)})([pts1.get$I(i)],$I$(1).ptValue$org_jmol_script_SV);
...
var bis=(function(a,f){return f.apply(null,a)})([oc.toByteArray$()],$I$(37).getBIS$BA);
...
var pt=(data == null  ? (function(a,f){return f.apply(null,a)})([sv.get$I(i)],$I$(1).ptValue$org_jmol_script_SV) : data[i]);
