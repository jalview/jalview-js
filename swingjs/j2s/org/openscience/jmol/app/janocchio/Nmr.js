(function(){var P$=Clazz.newPackage("org.openscience.jmol.app.janocchio"),p$1={},I$=[[0,'org.jmol.dialog.Dialog','javax.swing.UIManager','javax.swing.JFrame','org.openscience.jmol.app.janocchio.NmrResourceHandler','org.jmol.util.Logger','org.openscience.jmol.app.jmolpanel.Splash','java.awt.Cursor','org.jmol.i18n.GT','org.openscience.jmol.app.janocchio.NmrGuiMap','org.openscience.jmol.app.janocchio.NMR_JmolPanel']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
$I$(1).setupUIManager$();
try {
(function(a,f){return f.apply(null,a)})([$I$(2).getCrossPlatformLookAndFeelClassName$()],$I$(2).setLookAndFeel$S);
} catch (exc) {
...
if (!this.isSilent) (function(a,f){return f.apply(null,a)})(["splash_image=" + splash_image],$I$(5).info$S);
