...
/*c*/var C$=Clazz.newClass(P$, "NmrSaver", null, 'javax.swing.JPanel');
...
fc.addChoosableFileFilter$javax_swing_filechooser_FileFilter(Clazz.new_($I$(2,1).c$$S$S,["jsn", "NMR Data files"]));
}, 1);
