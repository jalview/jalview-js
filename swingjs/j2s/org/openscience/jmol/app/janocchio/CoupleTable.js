...
Clazz.newMeth(C$, 'getRowCount$', function () {
this.this$0.natomsPerModel=this.this$0.calcNatomsPerModel$.apply(this.this$0, []);
var rowCount=0;
for (var i=0; i < this.this$0.viewer.getMeasurementCount$(); i++) {
if (this.this$0.nmrPanel.getViewerMeasurement$I$I(i, 7) != null ) {
++rowCount;
}}
return rowCount;
});
...
return this.this$0.viewer.getMeasurementCountPlusIndices$I(this.this$0.getViewerRow$I.apply(this.this$0, [row]));
});
...
var atoms=this.this$0.nmrPanel.getViewerMeasurement$I$I(vRow, 7);
var dihecouple=this.this$0.calcProps.calcCouple$org_jmol_modelset_AtomA(atoms);
var measure=(dihecouple == null  ? null : Clazz.new_([this.this$0.expCouples[this.this$0.viewer.indexInFrame$org_jmol_modelset_Atom(atoms[0])][this.this$0.viewer.indexInFrame$org_jmol_modelset_Atom(atoms[3])], dihecouple[1]],$I$(2,1).c$$S$D));
if (col == 0) {
return (function(a,f){return f.apply(null,a)})([dihecouple == null  ? 0 : dihecouple[0] / 0.017453292519943295],$I$(3).formatDistance$D);
}if (col == 1) {
return measure;
}if (col == 4) {
...
var vRow=this.this$0.getViewerRow$I.apply(this.this$0, [row]);
var countPlusIndices=this.this$0.getMeasurementCountPlusIndices$I.apply(this.this$0, [vRow]);
this.this$0.expCouples[countPlusIndices[1]][countPlusIndices[4]]=val;
this.this$0.expCouples[countPlusIndices[4]][countPlusIndices[1]]=val;
this.this$0.updateCoupleTableData$.apply(this.this$0, []);
}});
