...
/*c*/var C$=Clazz.newClass(P$, "NamfisReader", null, 'javax.swing.JPanel');
...
var s="out";
fc.addChoosableFileFilter$javax_swing_filechooser_FileFilter(Clazz.new_($I$(2,1).c$$S$S,[s, "NAMFIS Output Files"]));
}, 1);
