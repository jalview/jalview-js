...
this.htMessageCallbacks=Clazz.new_($I$(14,1));
},1);
...
return Clazz.new_([this, (mol == null  ? this.vwr.getFrameAtoms$() : mol), labelArray, forNOE],$I$(15,1).c$$org_openscience_jmol_app_janocchio_NMR_JmolPanel$javajs_util_BS$SA$Z);
});

Clazz.newMeth(C$, 'getAllMolecules$', function () {
var mols;
var mc=(this.vwr).getModelCount$();
mols=Clazz.array($I$(16), [mc]);
for (var i=mc; --i >= 0; ) {
...
return (cmd.indexOf$S("NMR.") == 0 ? $I$(13).getStringX$S(cmd) : $I$(28).getStringX$S(cmd));
});

Clazz.newMeth(C$, 'getIconX$S', function (img) {
return (img.indexOf$S("NMR.") == 0 ? $I$(13).getIconX$S(img) : $I$(28).getIconX$S(img));
});

Clazz.newMeth(C$, 'createGuiMap$', function () {
return this.nmrguimap=Clazz.new_($I$(29,1));
});
...
var toolbar=this.newToolbar$SA(C$.tokenize$S($I$(13).getStringX$S("toolbar")));
this.frameCounter=Clazz.new_($I$(30,1).c$$org_openscience_jmol_app_janocchio_NMR_Viewer,[this.vwr]);
toolbar.add$java_awt_Component$O(this.frameCounter, "East");
this.say$S($I$(31).$$S("Initializing Noes..."));
this.noeTable=Clazz.new_($I$(32,1).c$$org_openscience_jmol_app_janocchio_NMR_JmolPanel$javax_swing_JFrame,[this, this.frame]);
this.say$S($I$(31).$$S("Initializing Couples..."));
this.coupleTable=Clazz.new_($I$(33,1).c$$org_openscience_jmol_app_janocchio_NMR_JmolPanel$javax_swing_JFrame,[this, this.frame]);
this.labelSetter=Clazz.new_($I$(34,1).c$$org_openscience_jmol_app_janocchio_NMR_Viewer$org_openscience_jmol_app_janocchio_NoeTable$org_openscience_jmol_app_janocchio_CoupleTable,[this.vwr, this.noeTable, this.coupleTable]);
toolbar.add$java_awt_Component$O(this.labelSetter, "East");
toolbar.add$java_awt_Component($I$(35).createHorizontalGlue$());
return toolbar;
});

Clazz.newMeth(C$, 'createDisplayAndAddStatusListener$', function () {
this.isPlugin=(this.jmolApp).isPlugin$();
this.say$S($I$(31).$$S("Initializing 3D display..."));
this.display=this.nmrDisplay=Clazz.new_($I$(36,1).c$$org_openscience_jmol_app_jmolpanel_JmolPanel,[this]);
this.vwrOptions.put$O$O("display", this.display);
this.myStatusListener=Clazz.new_($I$(37,1).c$$org_openscience_jmol_app_jmolpanel_JmolPanel$org_openscience_jmol_app_jmolpanel_DisplayPanel,[this, null, this, this.display]);
this.vwrOptions.put$O$O("statusListener", this.myStatusListener);
});

Clazz.newMeth(C$, 'setupModelAdapterAndViewer$', function () {
if ($I$(28).codePath != null ) this.vwrOptions.put$O$O("codePath", $I$(28).codePath);
if (this.modelAdapter != null ) this.vwrOptions.put$O$O("modelAdapter", this.modelAdapter);
this.say$S($I$(31).$$S("Initializing 3D display...4"));
this.vwr=Clazz.new_($I$(38,1).c$$java_util_Map,[this.vwrOptions]);
this.say$S($I$(31).$$S("Initializing 3D display...5"));
...
this.frame.setBackground$java_awt_Color($I$(39).lightGray);
this.frame.setLayout$java_awt_LayoutManager(Clazz.new_($I$(40,1)));
this.frame.setBounds$I$I$I$I(0, 0, this.startupWidth, this.startupHeight);
var contentPane=this.frame.getContentPane$();
this.mainSplitPane=Clazz.new_($I$(41,1).c$$I$java_awt_Component$java_awt_Component,[1, null, null]);
...
this.frame.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(42,1).c$$I$I,[this.startupWidth + 400, 100]));
var splitPaneRight=Clazz.new_($I$(41,1).c$$I$java_awt_Component$java_awt_Component,[0, null, null]);
splitPaneRight.setOneTouchExpandable$Z(true);
var noePanel=Clazz.new_($I$(43,1));
noePanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(44,1).c$$java_awt_Container$I,[noePanel, 3]));
var label=Clazz.new_($I$(45,1).c$$S$javax_swing_Icon$I,["NOE Table", null, 0]);
label.setAlignmentX$F(0.5);
noePanel.add$java_awt_Component(label);
noePanel.add$java_awt_Component(this.noeTable);
var couplePanel=Clazz.new_($I$(43,1));
couplePanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(44,1).c$$java_awt_Container$I,[couplePanel, 3]));
var label1=Clazz.new_($I$(45,1).c$$S$javax_swing_Icon$I,["Couple Table", null, 0]);
label1.setAlignmentX$F(0.5);
this.populationDisplay=Clazz.new_([(this.vwr)],$I$(46,1).c$$org_openscience_jmol_app_janocchio_NMR_Viewer);
this.frameDeltaDisplay=Clazz.new_([(this.vwr)],$I$(47,1).c$$org_openscience_jmol_app_janocchio_NMR_Viewer);
...
splitPaneRight.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(42,1).c$$I$I,[300, 500]));
contentPane.add$java_awt_Component$O(this.mainSplitPane, "Center");
contentPane.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(42,1).c$$I$I,[this.startupWidth, this.startupHeight]));
this.frame.pack$();
var jmolIcon=$I$(28).getIconX$S("icon");
var iconImage=jmolIcon.getImage$();
this.frame.setIconImage$java_awt_Image(iconImage);
if (!(this.jmolApp).isPlugin$()) this.frame.addWindowListener$java_awt_event_WindowListener(Clazz.new_($I$(48,1),[this, null]));
});
...
this.say$S($I$(31).$$S("Launching main frame..."));
});
...
var v=Clazz.new_($I$(49,1));
var t=Clazz.new_($I$(50,1).c$$S,[input]);
var cmd;
...
var out=Clazz.new_([Clazz.new_($I$(52,1).c$$java_io_File,[file])],$I$(51,1).c$$java_io_Writer);
...
var jsonData=Clazz.new_($I$(53,1)).parseMap$S$Z(json, true);
...
var opt=$I$(54).showConfirmDialog$java_awt_Component$O$S$I(this, "No Structure File currently loaded.\nLoad Structure File " + structureFile + "\ndefined in this NMR Data File?" , "No Structure Warning", 0);
if (opt != 0) return;
} else if (!currentStructureFile.equals$O(structureFile)) {
var opt=$I$(54).showConfirmDialog$java_awt_Component$O$S$I(this, "This NMR Data file was saved from a different structure file from that currently loaded.\nContinue Reading Data?", "Read NMR Data Warning", 0);
if (opt != 0) {
return;
}structureFile=null;
}var thread=("jnc".equals$O(fileType) ? Clazz.new_($I$(55,1).c$$org_openscience_jmol_app_janocchio_NMR_JmolPanel$S,[this, fileData]) : Clazz.new_($I$(4,1).c$$org_openscience_jmol_app_janocchio_NMR_JmolPanel$java_util_Map,[this, fileData]));
...
var atoms=Clazz.array($I$(56), -1, [(this.vwr).getAtomAt$I(m[1]), null, null, (this.vwr).getAtomAt$I(m[2])]);
return ($I$(57).getCalcType$org_jmol_modelset_AtomA$SA$I(atoms, null, type) == 0 ? null : atoms);
});
...
C$.haveBorder=$I$(11).FALSE;
{
C$.htGuiChanges=Clazz.new_($I$(12,1));
var changes=C$.tokenize$S($I$(13).getStringX$S("changes"));
...
var nmrSaver=Clazz.new_($I$(1,1).c$$javax_swing_JFileChooser,[this.this$0.saveNmrChooser]);
this.this$0.saveNmrChooser.setAccessory$javax_swing_JComponent(nmrSaver);
var retval=this.this$0.saveNmrChooser.showSaveDialog$java_awt_Component(this.this$0);
var cDir=this.this$0.saveNmrChooser.getCurrentDirectory$();
this.this$0.setCurrentDirectoryAll$java_io_File.apply(this.this$0, [cDir]);
if (retval == 0) {
var file=this.this$0.saveNmrChooser.getSelectedFile$();
...
Clazz.new_($I$(4,1).c$$org_openscience_jmol_app_janocchio_NMR_JmolPanel$java_util_Map,[this.this$0, null]).writeNmrDataJSON$java_io_File(file);
} catch (exc) {
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
var nmrReader=Clazz.new_($I$(5,1).c$$javax_swing_JFileChooser,[this.this$0.readNmrChooser]);
this.this$0.readNmrChooser.setAccessory$javax_swing_JComponent(nmrReader);
var retval=this.this$0.readNmrChooser.showOpenDialog$java_awt_Component(this.this$0);
var cDir=this.this$0.readNmrChooser.getCurrentDirectory$();
this.this$0.setCurrentDirectoryAll$java_io_File.apply(this.this$0, [cDir]);
if (retval == 0) {
var file=this.this$0.readNmrChooser.getSelectedFile$();
if (file != null ) {
try {
var filter=Clazz.new_($I$(2,1).c$$S$S,["jnc", "NMR Data files"]);
if (filter.checkExtension$java_io_File(file)) {
this.this$0.readNmrData$java_io_File.apply(this.this$0, [file]);
} else {
this.this$0.readNmrDataJSON$java_io_File.apply(this.this$0, [file]);
}} catch (exc) {
if (Clazz.exceptionOf(exc,"Exception")){
} else {
throw exc;
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
var labelArray=this.this$0.labelSetter.getLabelArray$();
var command= String.instantialize();
for (var i=0; i < labelArray.length; i++) {
command=command + this.this$0.labelSetter.setLabelString$I$S(i, labelArray[i]);
}
this.this$0.vwr.script$S(command);
});
})()
;
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
var namfisReader=Clazz.new_($I$(6,1).c$$javax_swing_JFileChooser,[this.this$0.readNamfisChooser]);
this.this$0.readNamfisChooser.setAccessory$javax_swing_JComponent(namfisReader);
var retval=this.this$0.readNamfisChooser.showOpenDialog$java_awt_Component(this.this$0);
var cDir=this.this$0.readNamfisChooser.getCurrentDirectory$();
this.this$0.setCurrentDirectoryAll$java_io_File.apply(this.this$0, [cDir]);
if (retval == 0) {
var file=this.this$0.readNamfisChooser.getSelectedFile$();
if (file != null ) {
try {
...
inp.readLine$();
inp.readLine$();
var nmodel=(this.this$0.vwr).getModelCount$();
...
this.this$0.populationDisplay.addPopulation$DA(population);
this.this$0.frameDeltaDisplay.setVisible$Z(false);
var mi=this.this$0.getMenuItem$S.apply(this.this$0, ["NMR.populationDisplayCheck"]);
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
var namfisSaver=Clazz.new_($I$(9,1).c$$javax_swing_JFileChooser,[this.this$0.saveNamfisChooser]);
this.this$0.saveNamfisChooser.setAccessory$javax_swing_JComponent(namfisSaver);
var retval=this.this$0.saveNamfisChooser.showSaveDialog$java_awt_Component(this.this$0);
var cDir=this.this$0.saveNamfisChooser.getCurrentDirectory$();
this.this$0.setCurrentDirectoryAll$java_io_File.apply(this.this$0, [cDir]);
if (retval == 0) {
var file=this.this$0.saveNamfisChooser.getSelectedFile$();
if (file != null ) {
var name=file.getAbsolutePath$();
...
Clazz.new_($I$(4,1).c$$org_openscience_jmol_app_janocchio_NMR_JmolPanel$java_util_Map,[this.this$0, null]).writeNamfisFiles$S(name);
} catch (exc) {
if (Clazz.exceptionOf(exc,"Exception")){
} else {
throw exc;
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
var frame=Clazz.new_($I$(4,1).c$$org_openscience_jmol_app_janocchio_NMR_JmolPanel$java_util_Map,[this.this$0, null]).jumpBestFrame$();
if (frame >= 0) this.this$0.frameCounter.setFrameNumberChangeViewer$I(frame);
});
})()
;
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
if (this.this$0.atomSetChooser != null ) this.this$0.atomSetChooser.setVisible$Z(true);
});
})()
;
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
this.this$0.coupleTable.activate$();
});
})()
;
...
if (errorMsg != null ) {
return;
}if (this.this$0.jmolApp.haveDisplay) this.this$0.pcs.firePropertyChange$S$O$O("chemFile", null, fullPathName);
var nmodel=(this.this$0.vwr).getModelCount$();
this.this$0.frameCounter.setFrameCount$I(nmodel);
this.this$0.populationDisplay.setVisible$Z(false);
this.this$0.frameDeltaDisplay.setVisible$Z(true);
var mi=this.this$0.getMenuItem$S.apply(this.this$0, ["NMR.frameDeltaDisplayCheck"]);
mi.setSelected$Z(true);
if (this.defaultFormat != null ) this.this$0.vwr.script$S(this.defaultFormat);
}, p$2);

Clazz.newMeth(C$, 'notifyFrameChanged$I', function (modelIndex) {
if (this.this$0.vwr == null  || modelIndex < 0 ) return;
if (modelIndex == -2147483648) modelIndex=(this.this$0.vwr).getCurrentModelIndex$();
var modelAtomCount=this.this$0.getFrameAtomCount$.apply(this.this$0, []);
if (this.this$0.labelSetter.getLabelArray$() == null  || modelAtomCount != this.this$0.labelSetter.getLabelArray$().length ) {
this.this$0.labelSetter.allocateLabelArray$I(modelAtomCount);
this.this$0.noeTable.allocateLabelArray$I(modelAtomCount);
this.this$0.noeTable.allocateExpNoes$I(modelAtomCount);
this.this$0.coupleTable.allocateLabelArray$I(modelAtomCount);
this.this$0.coupleTable.allocateExpCouples$I(modelAtomCount);
}this.this$0.frameCounter.setFrameNumberFromViewer$I(modelIndex + 1);
this.this$0.populationDisplay.setFrameNumberFromViewer$I(modelIndex + 1);
this.this$0.coupleTable.setmolCDKuptodate$Z(false);
this.this$0.noeTable.setmolCDKuptodate$Z(false);
this.this$0.noeTable.addMol$();
this.this$0.coupleTable.updateTables$();
this.this$0.noeTable.updateTables$();
});

Clazz.newMeth(C$, 'notifyAtomPicked$I$S', function (atomIndex, strInfo) {
if (atomIndex < 0) {
return;
}var atomNo=(this.this$0.vwr).getAtomNumber$I(atomIndex);
this.this$0.labelSetter.setSelectedAtomIndex$I(atomNo - 1);
...
this.this$0.vwr.script$S(this.defaultFormat);
...
var picked=this.this$0.vwr.getPOrNull$S("_picked");
if (picked != null ) this.notifyAtomPicked$I$S(picked.intValue$(), strInfo);
}}var n=this.this$0.vwr.getMeasurementCount$() - 1;
System.out.println$S("checking for measurement " + n);
if (this.this$0.getViewerMeasurement$I$I.apply(this.this$0, [n, 7]) == null  && this.this$0.getViewerMeasurement$I$I.apply(this.this$0, [n, 8]) == null  ) {
this.this$0.vwr.deleteMeasurement$I(n);
return;
...
case $I$(10).SCRIPT:
var status=data[3];
if (status.intValue$() < -1) this.this$0.notifyScriptCallback$S.apply(this.this$0, [data[2].toString()]);
break;
case $I$(10).SERVICE:
break;
...
this.this$0.vwr.deleteMeasurement$I(this.this$0.vwr.getMeasurementCount$() - 1);
