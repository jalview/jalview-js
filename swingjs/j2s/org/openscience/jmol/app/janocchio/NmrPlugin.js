(function(){var P$=Clazz.newPackage("org.openscience.jmol.app.janocchio"),p$1={},I$=[[0,'org.openscience.jmol.app.janocchio.Nmr','org.openscience.jmol.app.janocchio.NmrPlugin','javax.swing.JOptionPane']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
(function(a,f){return f.apply(null,a)})([this.b$['org.openscience.jmol.app.janocchio.NmrPlugin'].nmrApp.mainFrame, $I$(2).notification],$I$(3).showMessageDialog$java_awt_Component$O);
