(function(){var P$=Clazz.newPackage("org.openscience.jmol.app.janocchio"),p$1={},I$=[[0,'java.util.StringTokenizer','java.util.ResourceBundle','org.openscience.jmol.app.janocchio.Nmr','java.util.Locale','javax.swing.ImageIcon']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
}}this.stringsResourceBundle=(function(a,f){return f.apply(null,a)})([$I$(3).path + "Properties.Nmr", Clazz.new_($I$(4,1).c$$S$S,[language, country])],$I$(2).getBundle$S$java_util_Locale);
}, 1);
