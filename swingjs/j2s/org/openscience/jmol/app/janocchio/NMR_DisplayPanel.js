...
this.b$['org.openscience.jmol.app.janocchio.NMR_DisplayPanel'].populationDisplay.setVisible$Z(cbmi.isSelected$());
});
})()
;
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
var cbmi=e.getSource$();
this.b$['org.openscience.jmol.app.janocchio.NMR_DisplayPanel'].frameDeltaDisplay.setVisible$Z(cbmi.isSelected$());
});
})()
;
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
this.b$['org.openscience.jmol.app.janocchio.NMR_DisplayPanel'].viewer.evalStringQuiet$S("select all");
});
})()
;
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
this.b$['org.openscience.jmol.app.janocchio.NMR_DisplayPanel'].viewer.evalStringQuiet$S("select none");
});
})()
;
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
this.b$['org.openscience.jmol.app.janocchio.NMR_DisplayPanel'].viewer.setSelectionHalos$Z(false);
this.b$['org.openscience.jmol.app.janocchio.NMR_DisplayPanel'].status.setStatus$I$S(1, $I$(1).$$S("Select Atoms"));
});
})()
;
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
this.b$['org.openscience.jmol.app.janocchio.NMR_DisplayPanel'].viewer.setSelectionHalos$Z(false);
this.b$['org.openscience.jmol.app.janocchio.NMR_DisplayPanel'].status.setStatus$I$S(1, (e.getSource$()).getToolTipText$());
});
})()
