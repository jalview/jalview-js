...
}if (this.b$['org.openscience.jmol.app.janocchio.NoeTable'].lexpNoes) {
return this.noeHeaders[4];
}return this.noeHeaders[5];
});

Clazz.newMeth(C$, 'getRowCount$', function () {
this.b$['org.openscience.jmol.app.janocchio.NoeTable'].natomsPerModel=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].nmrPanel.getFrameAtomCount$();
var rowCount=0;
for (var i=0; i < this.b$['org.openscience.jmol.app.janocchio.NoeTable'].viewer.getMeasurementCount$(); i++) {
if (this.b$['org.openscience.jmol.app.janocchio.NoeTable'].checkNoe$I.apply(this.b$['org.openscience.jmol.app.janocchio.NoeTable'], [i])) {
++rowCount;
}}
return rowCount;
});
...
Clazz.newMeth(C$, 'getMeasurementCountPlusIndices$I', function (row) {
var vRow=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].getViewerRow$I.apply(this.b$['org.openscience.jmol.app.janocchio.NoeTable'], [row]);
var countPlusIndices=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].viewer.getMeasurementCountPlusIndices$I(vRow);
return countPlusIndices;
});

Clazz.newMeth(C$, 'getValueAt$I$I', function (row, col) {
if (!this.b$['org.openscience.jmol.app.janocchio.NoeTable'].molCDKuptodate) {
this.b$['org.openscience.jmol.app.janocchio.NoeTable'].addMol$.apply(this.b$['org.openscience.jmol.app.janocchio.NoeTable'], []);
}var vRow=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].getViewerRow$I.apply(this.b$['org.openscience.jmol.app.janocchio.NoeTable'], [row]);
var m=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].viewer.getMeasurementCountPlusIndices$I(vRow);
var a1=m[1];
var a2=m[2];
var noeNP=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].calcProps.getJmolNoe$I$I(a1, a2);
var noeNPref=1.0;
var base=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].viewer.getFrameBase$I(a1);
var f1=a1 - base;
var f2=a2 - base;
if (this.b$['org.openscience.jmol.app.janocchio.NoeTable'].lrefSingle) {
if (this.b$['org.openscience.jmol.app.janocchio.NoeTable'].noeNPrefIndices[0] != -1 && this.b$['org.openscience.jmol.app.janocchio.NoeTable'].noeNPrefIndices[1] != -1 ) {
noeNPref=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].calcProps.getJmolNoe$I$I(this.b$['org.openscience.jmol.app.janocchio.NoeTable'].noeNPrefIndices[0], this.b$['org.openscience.jmol.app.janocchio.NoeTable'].noeNPrefIndices[1]);
}} else {
noeNPref=noeNP;
}noeNP /= noeNPref;
var expNOE=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].expNoes[f1][f2];
var expDist=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].expDists[f1][f2];
var dExpNOE;
try {
dExpNOE=(Double.valueOf$S(expNOE)).doubleValue$();
if (this.b$['org.openscience.jmol.app.janocchio.NoeTable'].lrefSingle) {
dExpNOE /= this.b$['org.openscience.jmol.app.janocchio.NoeTable'].noeExprefValue;
...
var distNP=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].calcProps.getJmolDistance$I$I(a1, a2);
...
var name=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].labelArray[atomIndex];
var reserve="" + this.b$['org.openscience.jmol.app.janocchio.NoeTable'].viewer.getAtomNumber$I(atomIndex) + " " + this.b$['org.openscience.jmol.app.janocchio.NoeTable'].viewer.getAtomName$I(atomIndex) ;
...
var m=this.b$['org.openscience.jmol.app.janocchio.NoeTable'].viewer.getMeasurementCountPlusIndices$I(vRow);
if (this.b$['org.openscience.jmol.app.janocchio.NoeTable'].lexpNoes) {
this.b$['org.openscience.jmol.app.janocchio.NoeTable'].expNoes[m[1]][m[2]]=val;
this.b$['org.openscience.jmol.app.janocchio.NoeTable'].expNoes[m[2]][m[1]]=val;
} else {
this.b$['org.openscience.jmol.app.janocchio.NoeTable'].expDists[m[1]][m[2]]=val;
this.b$['org.openscience.jmol.app.janocchio.NoeTable'].expDists[m[2]][m[1]]=val;
}this.b$['org.openscience.jmol.app.janocchio.NoeTable'].updateNoeTableData$.apply(this.b$['org.openscience.jmol.app.janocchio.NoeTable'], []);
}});
