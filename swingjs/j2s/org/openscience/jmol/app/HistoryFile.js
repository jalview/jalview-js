(function(){var P$=Clazz.newPackage("org.openscience.jmol.app"),p$1={},I$=[[0,'java.util.Properties','java.awt.Point','java.awt.Dimension','Boolean','java.io.FileInputStream','java.io.FileOutputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
try {
var input=Clazz.new_($I$(5,1).c$$java_io_File,[this.file]);
...
if (this.file == null ) return;
try {
var output=Clazz.new_($I$(6,1).c$$java_io_File,[this.file]);
