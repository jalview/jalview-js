(function(){var P$=Clazz.newPackage("org.openscience.jmol.app"),I$=[[0,'org.openscience.jmol.app.JmolApp','org.jmol.dialog.Dialog','org.openscience.jmol.app.jmolpanel.JmolPanel','org.openscience.jmol.app.jsonkiosk.KioskFrame','javax.swing.JFrame','org.jmol.util.Logger','java.util.Hashtable','org.openscience.jmol.app.jmolpanel.JmolResourceHandler','org.openscience.jmol.app.jmolpanel.Splash','java.awt.Cursor','org.jmol.i18n.GT','javax.swing.UIManager']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
try {
jmol.service=$I$(3).getJsonNioServer$();
...
if (!jmolApp.isSilent) (function(a,f){return f.apply(null,a)})(["splash_image=" + splash_image],$I$(6).info$S);
...
(function(a,f){return f.apply(null,a)})([$I$(12).getCrossPlatformLookAndFeelClassName$()],$I$(12).setLookAndFeel$S);
} catch (exc) {
