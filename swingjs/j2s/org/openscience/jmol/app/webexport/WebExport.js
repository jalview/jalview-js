...
C$.pageAuthorName=(function(a,f){return f.apply(null,a)})(["webMakerPageAuthorName", $I$(4).$$S("Jmol Web Page Maker")],$I$(3).getJmolProperty$S$S);
C$.popInWidth=(function(a,f){return f.apply(null,a)})([$I$(3).getJmolProperty$S$S("webMakerPopInWidth", "300")],$I$(5).parseInt$S);
C$.popInHeight=(function(a,f){return f.apply(null,a)})([$I$(3).getJmolProperty$S$S("webMakerPopInHeight", "300")],$I$(5).parseInt$S);
C$.scriptButtonPercent=(function(a,f){return f.apply(null,a)})([$I$(3).getJmolProperty$S$S("webMakerScriptButtonPercent", "60")],$I$(5).parseInt$S);
...
if (url == null ) {
System.err.println$S((function(a,f){return f.apply(null,a)})([$I$(4).$$S("Couldn\'t find file: {0}"), introFileName + ".html"],$I$(4).o$S$O));
...
}C$.showMoleculesAndOrbitals=(C$.runStatus == 0 || (function(a,f){return f.apply(null,a)})([vwr.getP$S("webMakerAllTabs")],$I$(8).checkOption$O) );
...
return (function(a,f){return f.apply(null,a)})([$I$(4).$$S("Page skeleton and JavaScript generated by the Export to Web module of {0} on {1}."), Clazz.array(String, -1, [" <a href=\"http://jmol.sourceforge.net\">Jmol " + $I$(17).getJmolVersion$() + "</a> " , $I$(18).getDateInstance$().format$java_util_Date(Clazz.new_($I$(19,1)))])],$I$(4).o$S$O);
}, 1);
...
var scratchdir=Clazz.new_($I$(24,1).c$$S,[scratchpath]);
