(function(){var P$=Clazz.newPackage("org.openscience.jmol.app.webexport"),I$=[[0,'org.openscience.jmol.app.webexport.LogPanel','javajs.util.BS','javax.swing.filechooser.FileSystemView','java.io.File','org.jmol.i18n.GT','java.util.Hashtable','java.io.FileInputStream','java.io.FileOutputStream']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
