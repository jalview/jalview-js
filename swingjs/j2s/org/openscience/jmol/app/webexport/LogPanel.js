(function(){var P$=Clazz.newPackage("org.openscience.jmol.app.webexport"),I$=[[0,'javax.swing.JTextArea','java.awt.Insets','javax.swing.JScrollPane','javax.swing.JPanel','java.awt.BorderLayout','javax.swing.BorderFactory','org.jmol.i18n.GT']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
logPanel.setBorder$javax_swing_border_Border((function(a,f){return f.apply(null,a)})([$I$(7).$$S("Log and Error Messages:")],$I$(6).createTitledBorder$S));
...
miniPanel.setBorder$javax_swing_border_Border((function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})(["Messages (see Log tab for full history):"],$I$(7).$$S)],$I$(6).createTitledBorder$S));
