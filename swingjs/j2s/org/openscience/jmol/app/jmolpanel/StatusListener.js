(function(){var P$=Clazz.newPackage("org.openscience.jmol.app.jmolpanel"),p$1={},I$=[[0,'org.jmol.c.CBK','javajs.util.PT','java.util.Hashtable','org.openscience.jmol.app.jmolpanel.JmolResourceHandler','org.jmol.dialog.Dialog','org.openscience.jmol.app.webexport.WebExport','java.net.URI','org.jmol.util.Logger','jspecview.application.MainFrame','java.io.FileInputStream','java.io.FileOutputStream']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (this.vwr == null ) {
return;
}if (this.jmolPanel.isServer$() && data != null   && "SYNC".equals$O(data[0]) ) {
data[0]=type.toString();
this.jmolPanel.sendNioSyncRequest$O$I$S(data, 2, null);
...
case $I$(1).ANIMFRAME:
var iData=data[1];
strInfo=$I$(2).toJSON$S$O(null, iData);
...
if (msWalltime == 0) {
if (data[2] != null  && this.display.haveDisplay ) {
this.jmolPanel.setStatus$I$S(1, data[2]);
}}break;
case $I$(1).MEASURE:
var mystatus=data[3];
...
if (this.nboOptions == null ) this.nboOptions=Clazz.new_($I$(3,1));
this.nboOptions.put$O$O("options", strInfo);
this.jmolPanel.startNBO$java_util_Map(this.nboOptions);
return;
}this.jmolPanel.sendNioSyncRequest$O$I$S(null, (data[3]).intValue$(), strInfo);
return;
case $I$(1).AUDIO:
case $I$(1).HOVER:
case $I$(1).IMAGE:
...
if (this.jmolPanel.isServer$()) this.jmolPanel.sendNioSyncRequest$O$I$S(null, 2, (type + ":" + strInfo ).trim$());
...
this.jmolPanel.notifyFileOpen$S$S(fullPathName == null  ? null : fullPathName + (isAsync === Boolean.TRUE  ? " (*)" : ""), title);
...
peaks="hidden true; load CHECK " + $I$(2).esc$S(file) + ";hidden false" + (newSim && isC13  ? ";scaleby 0.5" : null) ;
...
data=$I$(2).replaceAllCharacters$S$S$S(data, "&", "_");
peaks="hidden true; load CHECK " + (peaks.equals$O("H1Simulate:") ? "H1 " : "C13 ") + $I$(2,"esc$S",["id='~" + model + "';" + data ]) + ";hidden false #SYNC_PEAKS" ;
}isStartup=false;
