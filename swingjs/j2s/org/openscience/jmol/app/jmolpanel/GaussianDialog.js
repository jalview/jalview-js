...
var routeTitle=(function(a,f){return f.apply(null,a)})([$I$(1).$$S("Route")],$I$(5).createTitledBorder$S);
...
var molTitle=(function(a,f){return f.apply(null,a)})([$I$(1).$$S("Molecular Properties")],$I$(5).createTitledBorder$S);
...
var fileTitle=(function(a,f){return f.apply(null,a)})([$I$(1).$$S("Gaussian Input File Name")],$I$(5).createTitledBorder$S);
...
if (this.iscroll >= 0) {
data=(function(a,f){return f.apply(null,a)})([data, a, "<b><font color=\"red\">" + $I$(23).rep$S$S$S(a, "\n", "") + "&#160;&#160;&lt;&lt;&lt;</font></b>\n" ],$I$(23).rep$S$S$S);
...
if (this.iscroll >= 0) (function(a,f){return f.apply(null,a)})([((P$.GaussianDialog$1||
...
), Clazz.new_(P$.GaussianDialog$1.$init$,[this, null]))],$I$(25).invokeLater$Runnable);
});
...
s=$I$(23).rep$S$S$S(s, "</b>", "");
s=(function(a,f){return f.apply(null,a)})([s, "<font color=\"red\">", ""],$I$(23).rep$S$S$S);
...
(function(a,f){return f.apply(null,a)})([((P$.GaussianDialog$2||
...
), Clazz.new_(P$.GaussianDialog$2.$init$,[this, null]))],$I$(25).invokeLater$Runnable);
}});
