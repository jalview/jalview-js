...
C$.$fields$=[['I',['outputWidth','outputHeight'],'S',['outputExtension','outputFileType'],'O',['vwr','org.jmol.viewer.Viewer','povrayPathButton','javax.swing.JButton','+goButton','saveField','javax.swing.JTextField','+savePathLabel','+povrayPathLabel','runPovCheck','javax.swing.JCheckBox','+allFramesCheck','+antiAliasCheck','+displayWhileRenderingCheck','imageSizeWidth','javax.swing.JLabel','imageSizeTextWidth','javax.swing.JFormattedTextField','imageSizeHeight','javax.swing.JLabel','imageSizeTextHeight','javax.swing.JFormattedTextField','imageSizeRatioBox','javax.swing.JCheckBox','imageSizeRatioCombo','javax.swing.JComboBox','outputFormatCheck','javax.swing.JCheckBox','outputFormatCombo','javax.swing.JComboBox','outputAlphaCheck','javax.swing.JCheckBox','+mosaicPreviewCheck','mosaicPreviewStart','javax.swing.JLabel','mosaicPreviewComboStart','javax.swing.JComboBox','mosaicPreviewEnd','javax.swing.JLabel','mosaicPreviewComboEnd','javax.swing.JComboBox']]]

Clazz.newMeth(C$, 'c$$javax_swing_JFrame$org_jmol_viewer_Viewer', function (f, vwr) {
;C$.superclazz.c$$java_awt_Frame$S$Z.apply(this,[f, $I$(1).$$S("Render in POV-Ray"), true]);C$.$init$.apply(this);
this.vwr=vwr;
var text=null;
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('javax.swing.InputVerifier'), null, 1);
...
), Clazz.new_($I$(2,1),[this, null],P$.PovrayDialog$2));
var updateItemListener=((P$.PovrayDialog$3||
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
justSavingBox.setBorder$javax_swing_border_Border(Clazz.new_($I$(4,1).c$$S,[text]));
var saveBox=$I$(3).createHorizontalBox$();
text=$I$(1).$$S("File Name:");
saveBox.setBorder$javax_swing_border_Border(Clazz.new_($I$(4,1).c$$S,[text]));
text=$I$(1).$$S("\'caffeine.pov\' -> \'caffeine.pov\', \'caffeine.pov.ini\', \'caffeine.pov.spt\'");
saveBox.setToolTipText$S(text);
this.saveField=Clazz.new_($I$(5,1).c$$S$I,["Jmol.pov", 20]);
...
savePathBox.setBorder$javax_swing_border_Border(Clazz.new_($I$(4,1).c$$S,[text]));
text=$I$(1).$$S("Where the .pov files will be saved");
savePathBox.setToolTipText$S(text);
this.savePathLabel=Clazz.new_($I$(5,1).c$$S,[""]);
...
text=$I$(1).$$S("Select");
var savePathButton=Clazz.new_($I$(6,1).c$$S,[text]);
savePathButton.addActionListener$java_awt_event_ActionListener(((P$.PovrayDialog$4||
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
povOptionsBox.setBorder$javax_swing_border_Border(Clazz.new_($I$(4,1).c$$S,[text]));
var runPovBox=$I$(3).createHorizontalBox$();
text=$I$(1).$$S("Run POV-Ray directly");
this.runPovCheck=Clazz.new_($I$(7,1).c$$S$Z,[text, true]);
...
this.displayWhileRenderingCheck=Clazz.new_($I$(7,1).c$$S$Z,[text, true]);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.beans.PropertyChangeListener', 1);
...
text=$I$(1).$$S("height:") + " ";
this.imageSizeHeight=Clazz.new_($I$(8,1).c$$S,[text]);
...
this.imageSizeTextHeight=Clazz.new_($I$(9,1));
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.beans.PropertyChangeListener', 1);
...
this.imageSizeRatioBox=Clazz.new_($I$(7,1).c$$S$Z,[text, true]);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$7", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
this.imageSizeRatioCombo=Clazz.new_($I$(10,1));
text=$I$(1).$$S("User defined");
this.imageSizeRatioCombo.addItem$O(text);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$8", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
this.outputFormatCombo=Clazz.new_($I$(10,1));
text=$I$(1).$$S("N - PNG");
this.outputFormatCombo.addItem$O(text);
text=$I$(1).$$S("P - PPM");
this.outputFormatCombo.addItem$O(text);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$9", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
this.outputAlphaCheck=Clazz.new_($I$(7,1).c$$S$Z,[text, false]);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$10", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
this.mosaicPreviewCheck=Clazz.new_($I$(7,1).c$$S$Z,[text, false]);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$11", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
this.mosaicPreviewStart=Clazz.new_($I$(8,1).c$$S,[text]);
...
this.mosaicPreviewComboStart=Clazz.new_($I$(10,1));
for (var power=0; power < 8; power++) {
this.mosaicPreviewComboStart.addItem$O(Integer.toString$I((Math.pow(2, power)|0)));
}
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$12", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
mosaicBox.add$java_awt_Component($I$(3).createHorizontalStrut$I(10));
text=$I$(1).$$S("End size : ");
this.mosaicPreviewEnd=Clazz.new_($I$(8,1).c$$S,[text]);
...
this.mosaicPreviewComboEnd=Clazz.new_($I$(10,1));
for (var power=0; power < 8; power++) {
this.mosaicPreviewComboEnd.addItem$O(Integer.toString$I((Math.pow(2, power)|0)));
}
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$13", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
povrayPathBox.setBorder$javax_swing_border_Border(Clazz.new_($I$(4,1).c$$S,[text]));
text=$I$(1).$$S("Location of the POV-Ray Executable");
povrayPathBox.setToolTipText$S(text);
this.povrayPathLabel=Clazz.new_($I$(5,1).c$$S,[""]);
...
text=$I$(1).$$S("Select");
this.povrayPathButton=Clazz.new_($I$(6,1).c$$S,[text]);
this.povrayPathButton.addActionListener$java_awt_event_ActionListener(((P$.PovrayDialog$14||
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$14", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
text=$I$(1).$$S("Go!");
this.goButton=Clazz.new_($I$(6,1).c$$S,[text]);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$15", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
text=$I$(1).$$S("Cancel");
var cancelButton=Clazz.new_($I$(6,1).c$$S,[text]);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "PovrayDialog$16", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var theFile=Clazz.new_($I$(11,1).c$$S$S,[savePath, filename]);
...
params.put$O$O("params", p$1.getINI.apply(this, []));
...
var myChooser=Clazz.new_($I$(15,1));
...
var props=$I$(17).historyFile.getProperties$();
if (this.povrayPathLabel != null ) {
var povrayPath=props.getProperty$S$S("povrayPath", System.getProperty$S("user.home"));
if (povrayPath != null ) {
this.povrayPathLabel.setText$S(povrayPath);
}}if (this.savePathLabel != null ) {
var savePath=props.getProperty$S$S("povraySavePath", System.getProperty$S("user.home"));
if (savePath != null ) {
this.savePathLabel.setText$S(savePath);
}}}, p$1);

Clazz.newMeth(C$, 'saveHistory', function () {
var props=Clazz.new_($I$(18,1));
...
$I$(17).historyFile.addProperties$java_util_Properties(props);
}, p$1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.PovrayDialog, "PovrayWindowListener", function(){
