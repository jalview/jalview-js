...
this.labels.put$O$O("atom15Script", $I$(2,"o$S$O",[$I$(2).$$S("{0}% van der Waals"), "15"]));
this.labels.put$O$O("atom20Script", $I$(2,"o$S$O",[$I$(2).$$S("{0}% van der Waals"), "20"]));
this.labels.put$O$O("atom25Script", $I$(2,"o$S$O",[$I$(2).$$S("{0}% van der Waals"), "25"]));
this.labels.put$O$O("atom100Script", $I$(2,"o$S$O",[$I$(2).$$S("{0}% van der Waals"), "100"]));
...
this.labels.put$O$O("bond100Script", $I$(2,"o$S$O",[$I$(2).$$S("{0} \u00c5"), "0.10"]));
this.labels.put$O$O("bond150Script", $I$(2,"o$S$O",[$I$(2).$$S("{0} \u00c5"), "0.15"]));
this.labels.put$O$O("bond200Script", $I$(2,"o$S$O",[$I$(2).$$S("{0} \u00c5"), "0.20"]));
...
this.labels.put$O$O("vector3Script", $I$(2,"o$S$O",[$I$(2).$$S("{0} pixels"), "3"]));
this.labels.put$O$O("vector005Script", $I$(2,"o$S$O",[$I$(2).$$S("{0} \u00c5"), "0.05"]));
this.labels.put$O$O("vector01Script", $I$(2,"o$S$O",[$I$(2).$$S("{0} \u00c5"), "0.1"]));
this.labels.put$O$O("vectorScale02Script", $I$(2,"o$S$O",[$I$(2).$$S("Scale {0}"), "0.2"]));
this.labels.put$O$O("vectorScale05Script", $I$(2,"o$S$O",[$I$(2).$$S("Scale {0}"), "0.5"]));
this.labels.put$O$O("vectorScale1Script", $I$(2,"o$S$O",[$I$(2).$$S("Scale {0}"), "1"]));
this.labels.put$O$O("vectorScale2Script", $I$(2,"o$S$O",[$I$(2).$$S("Scale {0}"), "2"]));
this.labels.put$O$O("vectorScale5Script", $I$(2,"o$S$O",[$I$(2).$$S("Scale {0}"), "5"]));
this.labels.put$O$O("zoomMenu", $I$(2).$$S("&Zoom"));
this.labels.put$O$O("zoom100Script", $I$(2,"o$S$O",[$I$(2).$$S("{0}%"), "100"]));
this.labels.put$O$O("zoom150Script", $I$(2,"o$S$O",[$I$(2).$$S("{0}%"), "150"]));
this.labels.put$O$O("zoom200Script", $I$(2,"o$S$O",[$I$(2).$$S("{0}%"), "200"]));
this.labels.put$O$O("zoom400Script", $I$(2,"o$S$O",[$I$(2).$$S("{0}%"), "400"]));
this.labels.put$O$O("zoom800Script", $I$(2,"o$S$O",[$I$(2).$$S("{0}%"), "800"]));
...
this.labels.put$O$O("distanceHzScript", $I$(2,"$$S",["&Hz (NMR J-coupling)"]));
...
this.labels.put$O$O("Prefs.openFilePreview", $I$(2,"$$S",["File Preview (requires restarting Jmol)"]));
this.labels.put$O$O("Prefs.clearHistory", $I$(2,"$$S",["Clear history (requires restarting Jmol)"]));
...
var btn=(this.get$S(key));
if (btn != null ) btn.setSelected$Z(b);
});

Clazz.newMeth(C$, 'setEnabled$S$Z', function (key, b) {
var btn=(this.get$S(key));
if (btn != null ) btn.setEnabled$Z(b);
});
