(function(){var P$=Clazz.newPackage("org.openscience.jmol.app.jmolpanel"),I$=[[0,'javax.swing.SwingUtilities','org.jmol.i18n.GT','org.openscience.jmol.app.jmolpanel.JmolResourceHandler','java.net.URL','javax.swing.JEditorPane','org.jmol.util.Logger','javax.swing.JScrollPane','java.awt.Dimension','javax.swing.JPanel','java.awt.BorderLayout','java.awt.FlowLayout','javax.swing.JButton',['javax.swing.event.HyperlinkEvent','.EventType'],'java.awt.Cursor',['org.openscience.jmol.app.jmolpanel.HelpDialog','.PageLoader']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
}this.html=(myURL == null  ? Clazz.new_(["text/plain", (function(a,f){return f.apply(null,a)})([$I$(2).$$S("Unable to find url \"{0}\"."), resource],$I$(2).o$S$O)],$I$(5,1).c$$S$S) : Clazz.new_($I$(5,1).c$$java_net_URL,[myURL]));
...
(function(a,f){return f.apply(null,a)})([Clazz.new_($I$(15,1).c$$java_net_URL$java_awt_Cursor,[this, null, u, c])],$I$(1).invokeLater$Runnable);
});
