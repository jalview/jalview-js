...
var sfLabel=Clazz.new_([$I$(4,"$$S",["(percentage of vanDerWaals radius)"]), 0],$I$(15,1).c$$S$I);
...
this.vdwPercentSlider.putClientProperty$O$O("JSlider.isFilled", Boolean.TRUE);
...
autobondPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(17,1).c$$java_awt_Container$I,[autobondPanel, 1]));
autobondPanel.setBorder$javax_swing_border_Border(Clazz.new_([$I$(4).$$S("Compute Bonds")],$I$(13,1).c$$S));
var abGroup=Clazz.new_($I$(18,1));
this.abYes=Clazz.new_([$I$(4).$$S("Automatically")],$I$(19,1).c$$S);
this.abNo=Clazz.new_([$I$(4).$$S("Don\'t Compute Bonds")],$I$(19,1).c$$S);
...
var bwLabel=Clazz.new_([$I$(4,"$$S",["(Angstroms)"]), 0],$I$(15,1).c$$S$I);
...
this.bwSlider.putClientProperty$O$O("JSlider.isFilled", Boolean.TRUE);
...
var btLabel=Clazz.new_([$I$(4,"$$S",["(Angstroms)"]), 0],$I$(15,1).c$$S$I);
...
this.btSlider.putClientProperty$O$O("JSlider.isFilled", Boolean.TRUE);
...
var bdLabel=Clazz.new_([$I$(4,"$$S",["(Angstroms)"]), 0],$I$(15,1).c$$S$I);
...
this.bdSlider.putClientProperty$O$O("JSlider.isFilled", Boolean.TRUE);
...
try {
var fileOutputStream=Clazz.new_($I$(21,1).c$$java_io_File,[this.jmol.jmolApp.userPropsFile]);
...
this.jmolDefaultProperties=Clazz.new_($I$(23,1).c$$java_util_Properties,[this.originalSystemProperties]);
for (var i=C$.jmolDefaults.length; (i-=2) >= 0; ) this.jmolDefaultProperties.put$O$O(C$.jmolDefaults[i], C$.jmolDefaults[i + 1]);

this.currentProperties=Clazz.new_($I$(23,1).c$$java_util_Properties,[this.jmolDefaultProperties]);
try {
var bis=Clazz.new_([Clazz.new_($I$(25,1).c$$java_io_File,[this.jmol.jmolApp.userPropsFile]), 1024],$I$(24,1).c$$java_io_InputStream$I);
...
this.autoBond=Boolean.getBoolean$S("autoBond");
this.showHydrogens=Boolean.getBoolean$S("showHydrogens");
this.showMeasurements=Boolean.getBoolean$S("showMeasurements");
this.perspectiveDepth=Boolean.getBoolean$S("perspectiveDepth");
this.showAxes=Boolean.getBoolean$S("showAxes");
this.showBoundingBox=Boolean.getBoolean$S("showBoundingBox");
this.axesOrientationRasmol=Boolean.getBoolean$S("axesOrientationRasmol");
this.openFilePreview=Boolean.valueOf$S(System.getProperty$S$S("openFilePreview", "true")).booleanValue$();
this.clearHistory=Boolean.getBoolean$S("clearHistory");
...
if (Boolean.getBoolean$S("jmolDefaults")) this.vwr.setStringProperty$S$S("defaults", "Jmol");
