...
options.addOption$S$S$Z$S("a", "autoanimationdelay", true, (function(a,f){return f.apply(null,a)})(["delay time in seconds for press-and-hold operation of toolbar animation buttons (default 0.2; numbers > 10 assumed to be milliseconds; set to 0 to disable)"],$I$(2).$$S));
...
options.addOption$S$S$Z$S("g", "geometry", true, (function(a,f){return f.apply(null,a)})([$I$(2).$$S("window width x height, e.g. {0}"), "-g500x500"],$I$(2).o$S$O));
...
options.addOption$S$S$Z$S("M", "multitouch", true, (function(a,f){return f.apply(null,a)})(["use multitouch interface (requires \"sparshui\" parameter"],$I$(2).$$S));
options.addOption$S$S$Z$S("m", "menu", true, $I$(2).$$S("menu file to use"));
options.addOption$S$S$Z$S("n", "nodisplay", false, (function(a,f){return f.apply(null,a)})(["no display (and also exit when done)"],$I$(2).$$S));
...
options.addOption$S$S$Z$S("p", "printOnly", false, (function(a,f){return f.apply(null,a)})(["send only output from print messages to console (implies -i)"],$I$(2).$$S));
options.addOption$S$S$Z$S("q", "quality", true, (function(a,f){return f.apply(null,a)})(["JPG image quality (1-100; default 75) or PNG image compression (0-9; default 2, maximum compression 9)"],$I$(2).$$S));
options.addOption$S$S$Z$S("R", "restricted", false, $I$(2).$$S("restrict local file access"));
options.addOption$S$S$Z$S("r", "restrictSpt", false, (function(a,f){return f.apply(null,a)})(["restrict local file access (allow reading of SPT files)"],$I$(2).$$S));
options.addOption$S$S$Z$S("s", "script", true, $I$(2).$$S("script file to execute or \'-\' for System.in"));
options.addOption$S$S$Z$S("T", "headlessmaxtime", true, (function(a,f){return f.apply(null,a)})(["headless max time (sec)"],$I$(2).$$S));
...
options.addOption$S$S$Z$S("w", "write", true, (function(a,f){return f.apply(null,a)})([$I$(2).$$S("{0} or {1}:filename"), Clazz.array(java.lang.Object, -1, ["CLIP", "GIF|JPG|JPG64|PNG|PPM"])],$I$(2).o$S$O));
options.addOption$S$S$Z$S("x", "exit", false, (function(a,f){return f.apply(null,a)})(["exit after script (implicit with -n)"],$I$(2).$$S));
return options;
}, p$1);
...
System.out.println$();
System.out.println$S((function(a,f){return f.apply(null,a)})(["The -D options are as follows (defaults in parenthesis) and must be called preceding \'-jar Jmol.jar\':"],$I$(2).$$S));
System.out.println$();
...
this.autoAnimationDelay=(function(a,f){return f.apply(null,a)})([line.getOptionValue$S("a")],$I$(8).parseFloat$S);
if (this.autoAnimationDelay > 10 ) this.autoAnimationDelay /= 1000;
(function(a,f){return f.apply(null,a)})(["setting autoAnimationDelay to " + new Float(this.autoAnimationDelay).toString() + " seconds" ],$I$(9).info$S);
}if (line.hasOption$S("d")) {
$I$(9).setLogLevel$I(5);
}this.info.put$O$O(this.isDataOnly ? "JmolData" : "Jmol", $I$(10).TRUE);
if (line.hasOption$S("k")) this.info.put$O$O("isKiosk", (function(a,f){return f.apply(null,a)})([this.isKiosk=true],$I$(10).valueOf$Z));
if (line.hasOption$S("P")) this.port=(function(a,f){return f.apply(null,a)})([line.getOptionValue$S("P")],$I$(8).parseInt$S);
if (this.port > 0) this.info.put$O$O("port", Integer.valueOf$I(this.port));
if (line.hasOption$S("p")) this.isPrintOnly=true;
if (this.isPrintOnly) {
this.info.put$O$O("printOnly", $I$(10).TRUE);
this.isSilent=true;
}if (line.hasOption$S("i")) this.isSilent=true;
if (this.isSilent) this.info.put$O$O("silent", $I$(10).TRUE);
if (true ||line.hasOption$S("o")) this.haveConsole=false;
if (!this.haveConsole) this.info.put$O$O("noConsole", $I$(10).TRUE);
if (line.hasOption$S("b")) this.info.put$O$O("transparentBackground", $I$(10).TRUE);
if (line.hasOption$S("R")) this.info.put$O$O("access:NONE", $I$(10).TRUE);
if (line.hasOption$S("r")) this.info.put$O$O("access:READSPT", $I$(10).TRUE);
if (line.hasOption$S("t")) this.info.put$O$O("useCommandThread", $I$(10).TRUE);
if (line.hasOption$S("l")) this.info.put$O$O("listCommands", $I$(10).TRUE);
if (line.hasOption$S("L")) this.splashEnabled=false;
if (line.hasOption$S("c")) this.info.put$O$O("check", $I$(10).TRUE);
if (line.hasOption$S("C")) this.info.put$O$O("checkLoad", $I$(10).TRUE);
...
if (indexX > 0) {
width=(function(a,f){return f.apply(null,a)})([geometry.substring$I$I(0, indexX)],$I$(8).parseInt$S);
height=(function(a,f){return f.apply(null,a)})([geometry.substring$I(indexX + 1)],$I$(8).parseInt$S);
} else {
...
var quality=-1;
if (line.hasOption$S("q")) quality=(function(a,f){return f.apply(null,a)})([line.getOptionValue$S("q")],$I$(8).parseInt$S);
...
if (type.indexOf$S(" ") >= 0) {
quality=(function(a,f){return f.apply(null,a)})([type.substring$I(type.indexOf$S(" ")).trim$()],$I$(8).parseInt$S);
...
}}if ($I$(11).isHeadless$()) this.info.put$O$O("headlistMaxTimeMs", Integer.valueOf$I(1000 * (line.hasOption$S("T") ? (function(a,f){return f.apply(null,a)})([line.getOptionValue$S("T")],$I$(8).parseInt$S) : 60)));
...
if (!this.haveDisplay) this.info.put$O$O("noDisplay", $I$(10).TRUE);
if (exitUponCompletion) {
this.info.put$O$O("exit", $I$(10).TRUE);
...
var scan=Clazz.new_($I$(12,1).c$$java_io_InputStream,[System.$in]);
var linein="";
var script=Clazz.new_($I$(13,1));
...
if (this.scanInput) {
Clazz.new_($I$(14,1).c$$org_jmol_api_JmolViewer$Z,[vwr, this.isSilent]);
}});
