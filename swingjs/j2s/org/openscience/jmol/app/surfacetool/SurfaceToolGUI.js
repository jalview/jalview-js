...
C$.$classes$=[['SurfaceListCellRenderer',0]];
...
C$.$fields$=[['S',['histWinName'],'O',['slicerFrame','javax.swing.JFrame','slicer','org.openscience.jmol.app.surfacetool.SurfaceTool','tabPanel','javax.swing.JPanel','+objectsPanel','+topPanel','+angleUnitsPanel','angleUnitsList','javax.swing.JComboBox','originPanel','javax.swing.JPanel','viewCenterButton','javax.swing.JRadioButton','+absoluteButton','capCheck','javax.swing.JCheckBox','capPlanesPanel','javax.swing.JPanel','+ghostPanel','ghostCheck','javax.swing.JCheckBox','+boundaryPlaneCheck','sliderPanel','javax.swing.JPanel','+normAnglePanel','angleXYSlider','javax.swing.JSlider','+angleZSlider','positionThicknessPanel','javax.swing.JPanel','positionSlider','javax.swing.JSlider','+thicknessSlider','whichOrigin','javax.swing.ButtonGroup','surfaceScrollPane','javax.swing.JScrollPane','surfaceList','javax.swing.JList']]]
...
this.slicerFrame=Clazz.new_([$I$(4).$$S("SurfaceTool")],$I$(3,1).c$$S);
...
var jmolIcon=Clazz.new_($I$(5,1).c$$java_net_URL,[imageUrl]);
...
this.tabPanel=Clazz.new_([Clazz.new_($I$(2,1))],$I$(6,1).c$$java_awt_LayoutManager);
this.topPanel=Clazz.new_([Clazz.new_($I$(7,1).c$$I$I,[1, 0])],$I$(6,1).c$$java_awt_LayoutManager);
this.whichOrigin=Clazz.new_($I$(8,1));
this.originPanel=Clazz.new_([Clazz.new_($I$(7,1).c$$I$I,[0, 1])],$I$(6,1).c$$java_awt_LayoutManager);
if (slicer.getUseMolecular$()) {
this.viewCenterButton=Clazz.new_([$I$(4).$$S("View Center"), false],$I$(9,1).c$$S$Z);
this.absoluteButton=Clazz.new_([$I$(4).$$S("Absolute"), true],$I$(9,1).c$$S$Z);
} else {
this.viewCenterButton=Clazz.new_([$I$(4).$$S("View Center"), true],$I$(9,1).c$$S$Z);
this.absoluteButton=Clazz.new_([$I$(4).$$S("Absolute"), false],$I$(9,1).c$$S$Z);
...
this.originPanel.setBorder$javax_swing_border_Border((function(a,f){return f.apply(null,a)})([$I$(4).$$S("Origin")],$I$(10).createTitledBorder$S));
this.capPlanesPanel=Clazz.new_([Clazz.new_($I$(7,1).c$$I$I,[0, 1])],$I$(6,1).c$$java_awt_LayoutManager);
this.capCheck=Clazz.new_([$I$(4).$$S("Cap")],$I$(11,1).c$$S);
...
this.boundaryPlaneCheck=Clazz.new_([$I$(4).$$S("Slice Planes")],$I$(11,1).c$$S);
...
this.ghostPanel=Clazz.new_([Clazz.new_($I$(7,1).c$$I$I,[0, 1])],$I$(6,1).c$$java_awt_LayoutManager);
this.ghostCheck=Clazz.new_([$I$(4).$$S("Ghost On")],$I$(11,1).c$$S);
...
this.sliderPanel=Clazz.new_([Clazz.new_($I$(7,1).c$$I$I,[0, 1])],$I$(6,1).c$$java_awt_LayoutManager);
this.normAnglePanel=Clazz.new_([Clazz.new_($I$(7,1).c$$I$I,[0, 1])],$I$(6,1).c$$java_awt_LayoutManager);
this.angleUnitsPanel=Clazz.new_([Clazz.new_($I$(2,1))],$I$(6,1).c$$java_awt_LayoutManager);
var space=Clazz.new_($I$(12,1).c$$S,["   "]);
this.angleUnitsPanel.add$java_awt_Component$O(space, "West");
var angleUnits=slicer.getAngleUnitsList$();
this.angleUnitsList=Clazz.new_($I$(13,1).c$$OA,[angleUnits]);
...
var labelAndUnits=Clazz.new_([Clazz.new_($I$(7,1).c$$I$I,[1, 0])],$I$(6,1).c$$java_awt_LayoutManager);
var sliderLabel=Clazz.new_([$I$(4).$$S("Angle from X-axis in XY plane"), 0],$I$(12,1).c$$S$I);
...
this.angleXYSlider=Clazz.new_($I$(14,1).c$$I$I$I,[0, 180, 0]);
...
var sliderLabel2=Clazz.new_([$I$(4).$$S("Angle from Z-axis"), 0],$I$(12,1).c$$S$I);
sliderLabel2.setAlignmentX$F(0.5);
this.normAnglePanel.add$java_awt_Component(sliderLabel2);
this.angleZSlider=Clazz.new_($I$(14,1).c$$I$I$I,[0, 180, 0]);
...
this.normAnglePanel.setBorder$javax_swing_border_Border((function(a,f){return f.apply(null,a)})([$I$(4).$$S("Direction vector of normal to slice")],$I$(10).createTitledBorder$S));
this.sliderPanel.add$java_awt_Component(this.normAnglePanel);
this.positionThicknessPanel=Clazz.new_([Clazz.new_($I$(7,1).c$$I$I,[0, 1])],$I$(6,1).c$$java_awt_LayoutManager);
var sliderLabel3=Clazz.new_([$I$(4).$$S("Distance of slice from origin"), 0],$I$(12,1).c$$S$I);
...
this.positionSlider=Clazz.new_($I$(14,1).c$$I$I$I,[0, 180, tempPos]);
...
var sliderLabel4=Clazz.new_([$I$(4).$$S("Thickness of slice"), 0],$I$(12,1).c$$S$I);
sliderLabel4.setAlignmentX$F(0.5);
this.positionThicknessPanel.add$java_awt_Component(sliderLabel4);
this.thicknessSlider=Clazz.new_([0, 180, ((180 * slicer.getSliceThickness$() / slicer.getThicknessMax$())|0)],$I$(14,1).c$$I$I$I);
...
this.objectsPanel=Clazz.new_($I$(6,1));
this.objectsPanel.setBorder$javax_swing_border_Border((function(a,f){return f.apply(null,a)})([(function(a,f){return f.apply(null,a)})(["Select Surface(s)"],$I$(4).$$S)],$I$(10).createTitledBorder$S));
this.surfaceList=Clazz.new_([Clazz.new_($I$(16,1))],$I$(15,1).c$$javax_swing_ListModel);
this.surfaceList.setCellRenderer$javax_swing_ListCellRenderer(Clazz.new_($I$(17,1),[this, null]));
this.surfaceList.addListSelectionListener$javax_swing_event_ListSelectionListener(this);
this.updateSurfaceList$();
this.surfaceScrollPane=Clazz.new_($I$(18,1).c$$java_awt_Component,[this.surfaceList]);
this.surfaceScrollPane.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(19,1).c$$I$I,[120, 300]));
...
var positionLabels=Clazz.new_($I$(21,1));
var temp="";
for (var i=0; i < 7; i++) {
...
}}positionLabels.put$O$O(Integer.valueOf$I(i * 30), Clazz.new_($I$(12,1).c$$S,[temp]));
}
...
var thicknessLabels=Clazz.new_($I$(21,1));
var temp="";
for (var i=0; i < 7; i++) {
...
if (temp.length$() > 5) {
temp=temp.substring$I$I(0, 4);
}thicknessLabels.put$O$O(Integer.valueOf$I(i * 30), Clazz.new_($I$(12,1).c$$S,[temp]));
}
...
var angleLabels=Clazz.new_($I$(21,1));
angleLabels.put$O$O(Integer.valueOf$I(0), Clazz.new_($I$(12,1).c$$S,["0"]));
switch (this.slicer.getAngleUnits$()) {
case 0:
angleLabels.put$O$O(Integer.valueOf$I(30), Clazz.new_($I$(12,1).c$$S,["30"]));
angleLabels.put$O$O(Integer.valueOf$I(60), Clazz.new_($I$(12,1).c$$S,["60"]));
angleLabels.put$O$O(Integer.valueOf$I(90), Clazz.new_($I$(12,1).c$$S,["90"]));
angleLabels.put$O$O(Integer.valueOf$I(120), Clazz.new_($I$(12,1).c$$S,["120"]));
angleLabels.put$O$O(Integer.valueOf$I(150), Clazz.new_($I$(12,1).c$$S,["150"]));
angleLabels.put$O$O(Integer.valueOf$I(180), Clazz.new_($I$(12,1).c$$S,["180"]));
break;
case 1:
angleLabels.put$O$O(Integer.valueOf$I(30), Clazz.new_($I$(12,1).c$$S,["0.52"]));
angleLabels.put$O$O(Integer.valueOf$I(60), Clazz.new_($I$(12,1).c$$S,["1.05"]));
angleLabels.put$O$O(Integer.valueOf$I(90), Clazz.new_($I$(12,1).c$$S,["1.75"]));
angleLabels.put$O$O(Integer.valueOf$I(120), Clazz.new_($I$(12,1).c$$S,["2.09"]));
angleLabels.put$O$O(Integer.valueOf$I(150), Clazz.new_($I$(12,1).c$$S,["2.62"]));
angleLabels.put$O$O(Integer.valueOf$I(180), Clazz.new_($I$(12,1).c$$S,["3.14"]));
break;
case 2:
angleLabels.put$O$O(Integer.valueOf$I(30), Clazz.new_($I$(12,1).c$$S,["33.3"]));
angleLabels.put$O$O(Integer.valueOf$I(60), Clazz.new_($I$(12,1).c$$S,["66.7"]));
angleLabels.put$O$O(Integer.valueOf$I(90), Clazz.new_($I$(12,1).c$$S,["100"]));
angleLabels.put$O$O(Integer.valueOf$I(120), Clazz.new_($I$(12,1).c$$S,["133"]));
angleLabels.put$O$O(Integer.valueOf$I(150), Clazz.new_($I$(12,1).c$$S,["167"]));
angleLabels.put$O$O(Integer.valueOf$I(180), Clazz.new_($I$(12,1).c$$S,["200"]));
break;
case 3:
angleLabels.put$O$O(Integer.valueOf$I(30), Clazz.new_($I$(12,1).c$$S,["1/12"]));
angleLabels.put$O$O(Integer.valueOf$I(60), Clazz.new_($I$(12,1).c$$S,["1/6"]));
angleLabels.put$O$O(Integer.valueOf$I(90), Clazz.new_($I$(12,1).c$$S,["1/4"]));
angleLabels.put$O$O(Integer.valueOf$I(120), Clazz.new_($I$(12,1).c$$S,["1/3"]));
angleLabels.put$O$O(Integer.valueOf$I(150), Clazz.new_($I$(12,1).c$$S,["5/12"]));
angleLabels.put$O$O(Integer.valueOf$I(180), Clazz.new_($I$(12,1).c$$S,["1/2"]));
break;
case 4:
var piStr="\u03c0";
angleLabels.put$O$O(Integer.valueOf$I(30), Clazz.new_($I$(12,1).c$$S,[piStr + "/6"]));
angleLabels.put$O$O(Integer.valueOf$I(60), Clazz.new_($I$(12,1).c$$S,[piStr + "/3"]));
angleLabels.put$O$O(Integer.valueOf$I(90), Clazz.new_($I$(12,1).c$$S,[piStr + "/2"]));
angleLabels.put$O$O(Integer.valueOf$I(120), Clazz.new_($I$(12,1).c$$S,["2" + piStr + "/3" ]));
angleLabels.put$O$O(Integer.valueOf$I(150), Clazz.new_($I$(12,1).c$$S,["5" + piStr + "/6" ]));
angleLabels.put$O$O(Integer.valueOf$I(180), Clazz.new_($I$(12,1).c$$S,[piStr]));
break;
}
...
listModel.addElement$O(this.slicer.getSurfaces$().get$I(i));
}
});
...
;C$.superclazz.c$$Z.apply(this,[isDoubleBuffered]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$java_awt_LayoutManager$Z', function (layout, isDoubleBuffered) {
;C$.superclazz.c$$java_awt_LayoutManager$Z.apply(this,[layout, isDoubleBuffered]);C$.$init$.apply(this);
}, 1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.SurfaceToolGUI, "SurfaceListCellRenderer", function(){
...
this.setForeground$java_awt_Color(Clazz.new_([(value).color],$I$(1,1).c$$I));
} else {
