(function(){var P$=Clazz.newPackage("org.openscience.jmol.app.surfacetool"),I$=[[0,'javajs.util.P4','javajs.util.P3','javajs.util.Measure','javajs.util.V3']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
(function(a,f){return f.apply(null,a)})([pt, $I$(4).new3$F$F$F(this.middle.x, this.middle.y, this.middle.z), this.middle],$I$(3).getPlaneThroughPoint$javajs_util_T3$javajs_util_V3$javajs_util_P4);
