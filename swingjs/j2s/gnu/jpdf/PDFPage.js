(function(){var P$=Clazz.newPackage("gnu.jpdf"),p$1={},I$=[[0,'java.util.Vector','gnu.jpdf.PDFStream','java.awt.print.PageFormat','gnu.jpdf.PDFGraphics','java.awt.Dimension','java.awt.Rectangle','gnu.jpdf.PDFAnnot','gnu.jpdf.PDFOutline','gnu.jpdf.PDFObject',['gnu.jpdf.PDFPage','.procset']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
