(function(){var P$=Clazz.newPackage("swingjs"),p$1={},I$=[[0,'sun.awt.AppContext','Thread','swingjs.JSUtil','java.awt.image.ColorModel','javax.swing.UIManager','swingjs.api.Interface','javajs.util.PT','swingjs.JSNullComponentPeer','swingjs.JSImagekit','java.io.BufferedInputStream','java.io.ByteArrayInputStream','java.awt.datatransfer.Clipboard','swingjs.JSFocusPeer','java.awt.Point']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return this.createImage$java_net_URL(Clazz.getClass(C$).getResource$S(filename));
});
...
return p$1.getImagekit.apply(this, []).createImageFromBytes$BA$I$I$S($I$(3,"getSignedStreamBytes$java_io_BufferedInputStream",[Clazz.new_([Clazz.new_([$I$(3).getFileAsBytes$O(filename)],$I$(11,1).c$$BA)],$I$(10,1).c$$java_io_InputStream)]), 0, -1, filename);
});
...
if (C$.systemClipboard == null ) C$.systemClipboard=Clazz.new_($I$(12,1).c$$S,["System"]);
...
return (C$.focusManager == null  ? C$.focusManager=Clazz.new_($I$(13,1)) : C$.focusManager);
}, 1);
...
return $I$(3).J2S.getMousePosition(Clazz.new_($I$(14,1)));
}, 1);
