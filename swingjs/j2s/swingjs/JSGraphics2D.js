(function(){var P$=Clazz.newPackage("swingjs"),p$1={},I$=[[0,'swingjs.JSUtil','java.awt.RenderingHints','java.util.Hashtable','java.awt.geom.AffineTransform','java.awt.BasicStroke','java.awt.Color','swingjs.JSToolkit','swingjs.api.js.HTML5CanvasContext2D','swingjs.api.js.DOMNode','java.awt.Rectangle','swingjs.JSImagekit',['java.awt.geom.RoundRectangle2D','.Double'],'java.awt.Font','java.awt.Toolkit','java.awt.AlphaComposite','swingjs.JSGraphicsCompositor']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['isShifted','inPath','thinLine','clearing','unclipped'],'I',['constrainX','constrainY','width','height','initialState','lastx','lasty','nx','ny','alpha'],'O',['canvas','swingjs.api.js.HTML5Canvas','ctx','swingjs.api.js.HTML5CanvasContext2D','gc','java.awt.GraphicsConfiguration','currentStroke','java.awt.BasicStroke','currentClip','java.awt.Shape','alphaComposite','java.awt.AlphaComposite','font','java.awt.Font','hints','java.awt.RenderingHints','transform','java.awt.geom.AffineTransform','backgroundColor','java.awt.Color','fontTransform','java.awt.geom.AffineTransform','foregroundColor','java.awt.Color','rrect','java.awt.geom.RoundRectangle2D.Double','imageData','swingjs.api.js.HTML5CanvasContext2D.ImageData','buf8','int[]','shader','java.awt.Paint','clearColorSaved','java.awt.Color']]
...
var p1=p.getPoint1$();
var p2=p.getPoint2$();
$I$(8,"createLinearGradient",[this.ctx, p1, p2, $I$(7,"getCSSColor$java_awt_Color",[p.getColor1$()]), $I$(7,"getCSSColor$java_awt_Color",[p.getColor2$()])]);
this.ctx.beginPath();
p$1.doShape$java_awt_Shape.apply(this, [s]);
this.ctx.fill();
} else {
...
var ret=this.drawImageFromRaster$java_awt_Image$I$I$java_awt_image_ImageObserver(img, 0, 0, obs);
this.ctx.restore();
return ret;
}, p$1);

Clazz.newMeth(C$, 'drawImageFromRaster$java_awt_Image$I$I$java_awt_image_ImageObserver', function (img, x, y, observer) {
if (img == null ) return true;
return p$1.drawImagePriv$java_awt_Image$I$I$I$I$java_awt_image_ImageObserver.apply(this, [img, x, y, img.getWidth$java_awt_image_ImageObserver(observer), img.getHeight$java_awt_image_ImageObserver(observer), observer]);
});
...
var pixels=(C$.isTranslationOnly$DA(m) && !p$1.isClipped$I$I$I$I.apply(this, [x, y, width, height])  ? (img).get秘pix$() : null);
var imgNode=null;
if (pixels == null ) {
...
Clazz.newMeth(C$, 'loadCTX$I$I$I$I$IA$D$D$Z', function (x, y, w, h, pixels, m4, m5, isOpaque) {
}, p$1);
...
this.ctx.fillStyle=this.ctx.strokeStyle=$I$(7).getCSSColor$java_awt_Color(c);
}, p$1);
...
map[0]=new Integer((1 ? this.ctx.globalAlpha :0));
...
;Clazz.setTVer('3.2.9-v1');//Created 2020-04-08 08:14:53 Java2ScriptVisitor version 3.2.9-v1 net.sf.j2s.core.jar version 3.2.9-v1
