(function(){var P$=Clazz.newPackage("swingjs"),p$1={},p$2={},I$=[[0,'swingjs.JSDnD',['swingjs.JSDnD','.FileTransferable'],'java.awt.datatransfer.DataFlavor','java.util.ArrayList','java.io.File',['swingjs.JSDnD','.JSTransferable'],'swingjs.JSUtil',['swingjs.JSDnD','.JSDropMouseEvent'],'java.awt.dnd.DropTargetContext',['swingjs.JSDnD','.JSDropTargetContextPeer'],'java.awt.dnd.DropTargetDropEvent','java.awt.Point']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var t=Clazz.new_($I$(6,1).c$$O,[html5DataTransfer]);
if (name == null ) {
...
var file=Clazz.new_($I$(5,1).c$$S,[name]);
file.秘bytes=data;
