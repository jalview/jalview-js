...
if (this.htData == null ) this.htData=Clazz.new_($I$(5,1));
...
return Clazz.new_([this.node.getElementsByTagName(tagname) ||null],$I$(4,1).c$$O);
});

Clazz.newMeth(C$, 'getElementsByTagNameNS$S$S', function (namespaceURI, localName) {
return Clazz.new_([this.node.getElementsByTagNameNS(namespaceURI, localName) ||null],$I$(4,1).c$$O);
});
