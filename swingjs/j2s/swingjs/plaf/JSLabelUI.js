(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[[0,'swingjs.plaf.JSComponentUI','swingjs.api.js.DOMNode','javax.swing.LookAndFeel','swingjs.plaf.JSGraphicsUtils','java.awt.Dimension']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.enableNode=this.domNode=$I$(1).newDOMObject$S$S$SA("label", this.id, []);
...
if (this.icon != null ) {
$I$(2).setStyles(this.imageNode, ["visibility", null]);
...
$I$(2).setStyles(this.imageNode, ["visibility", "hidden"]);
