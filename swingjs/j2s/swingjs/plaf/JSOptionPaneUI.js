...
$I$(8).installProperty$javax_swing_JComponent$S$O(this.optionPane, "opaque", Boolean.TRUE);
});
...
return Clazz.new_($I$(10,1).c$$java_awt_Container$I,[this.optionPane, 1]);
});
...
$I$(12).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.optionPane, 2, map);
$I$(13,"installLazyActionMap$javax_swing_JComponent$Class$S",[this.optionPane, Clazz.getClass(C$), "OptionPane.actionMap"]);
});

Clazz.newMeth(C$, 'uninstallKeyboardActions$', function () {
$I$(12).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.optionPane, 2, null);
$I$(12).replaceUIActionMap$javax_swing_JComponent$javax_swing_ActionMap(this.optionPane, null);
});

Clazz.newMeth(C$, 'getInputMap$I', function (condition) {
if (condition == 2) {
var bindings=$I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.windowBindings");
if (bindings != null ) {
...
var top=Clazz.new_($I$(15,1));
var topBorder=$I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.messageAreaBorder");
if (topBorder != null ) {
top.setBorder$javax_swing_border_Border(topBorder);
}top.setLayout$java_awt_LayoutManager(Clazz.new_($I$(16,1)));
var body=Clazz.new_([Clazz.new_($I$(17,1))],$I$(15,1).c$$java_awt_LayoutManager);
var realBody=Clazz.new_([Clazz.new_($I$(16,1))],$I$(15,1).c$$java_awt_LayoutManager);
body.setName$S("OptionPane.body");
realBody.setName$S("OptionPane.realBody");
if (this.getIcon$() != null ) {
var sep=Clazz.new_($I$(15,1));
...
var cons=Clazz.new_($I$(18,1));
cons.gridx=cons.gridy=0;
cons.gridwidth=0;
cons.gridheight=1;
cons.anchor=$I$(14).getInt$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S$I(this.optionPane, this, "OptionPane.messageAnchor", 10);
cons.insets=Clazz.new_($I$(19,1).c$$I$I$I$I,[0, 0, 3, 0]);
...
var label=Clazz.new_($I$(20,1).c$$javax_swing_Icon$I,[msg, 0]);
...
), Clazz.new_($I$(15,1),[this, null],P$.JSOptionPaneUI$1));
...
var label;
label=Clazz.new_($I$(20,1).c$$S$I,[s, 10]);
...
var list=Clazz.new_($I$(23,1).c$$OA,[sValues]);
var sp=Clazz.new_($I$(24,1).c$$java_awt_Component,[list]);
...
var tf=Clazz.new_($I$(25,1).c$$I,[20]);
tf.setName$S("OptionPane.textField");
tf.setKeyStrokes$javax_swing_KeyStrokeA(Clazz.array($I$(26), -1, [$I$(26).getKeyStroke$S("ENTER")]));
if (inputValue != null ) {
...
if (sideIcon != null ) {
var iconLabel=Clazz.new_($I$(20,1).c$$javax_swing_Icon,[sideIcon]);
...
return $I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, propertyName);
}return null;
});
...
return;
}}var label=Clazz.new_($I$(20,1).c$$S$I,[d, 2]);
label.setName$S("OptionPane.label");
p$2.configureMessageLabel$javax_swing_JLabel.apply(this, [label]);
...
var bottom=Clazz.new_($I$(15,1));
var border=$I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.buttonAreaBorder");
bottom.setName$S("OptionPane.buttonArea");
if (border != null ) {
bottom.setBorder$javax_swing_border_Border(border);
}bottom.setLayout$java_awt_LayoutManager(Clazz.new_([$I$(14).getBoolean$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S$Z(this.optionPane, this, "OptionPane.sameSizeButtons", true), $I$(14).getInt$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S$I(this.optionPane, this, "OptionPane.buttonPadding", 6), $I$(14).getInt$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S$I(this.optionPane, this, "OptionPane.buttonOrientation", 0), $I$(14).getBoolean$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S$Z(this.optionPane, this, "OptionPane.isYesLast", false)],$I$(27,1).c$$Z$I$I$Z));
...
aButton.setMultiClickThreshhold$J($I$(14).getInt$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S$I(this.optionPane, this, "OptionPane.buttonClickThreshhold", 0));
...
var root=$I$(12).getRootPane$java_awt_Component(defaultButton);
if (root != null ) {
...
if ($I$(14).getBoolean$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S$Z(this.optionPane, this, "OptionPane.setButtonMargin", true) && sizeButtonsToSame && createdAll  ) {
var aButton;
var padSize;
padSize=(numButtons <= 2 ? 8 : 4);
for (var counter=0; counter < numButtons; counter++) {
aButton=createdButtons[counter];
aButton.setMargin$java_awt_Insets(Clazz.new_($I$(19,1).c$$I$I$I$I,[2, padSize, 2, padSize]));
}
}}});

Clazz.newMeth(C$, 'createButtonActionListener$I', function (buttonIndex) {
return Clazz.new_($I$(28,1).c$$I,[this, null, buttonIndex]);
});
...
var minimumWidth=$I$(14).getInt$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S$I(this.optionPane, this, "OptionPane.buttonMinimumWidth", -1);
if (type == 0) {
defaultOptions=Clazz.array($I$(29), [2]);
defaultOptions[0]=Clazz.new_([$I$(9).getString$O$java_util_Locale("OptionPane.yesButtonText", l), p$2.getMnemonic$S$java_util_Locale.apply(this, ["OptionPane.yesButtonMnemonic", l]), $I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.yesIcon"), minimumWidth],$I$(29,1).c$$S$I$javax_swing_Icon$I);
defaultOptions[1]=Clazz.new_([$I$(9).getString$O$java_util_Locale("OptionPane.noButtonText", l), p$2.getMnemonic$S$java_util_Locale.apply(this, ["OptionPane.noButtonMnemonic", l]), $I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.noIcon"), minimumWidth],$I$(29,1).c$$S$I$javax_swing_Icon$I);
} else if (type == 1) {
defaultOptions=Clazz.array($I$(29), [3]);
defaultOptions[0]=Clazz.new_([$I$(9).getString$O$java_util_Locale("OptionPane.yesButtonText", l), p$2.getMnemonic$S$java_util_Locale.apply(this, ["OptionPane.yesButtonMnemonic", l]), $I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.yesIcon"), minimumWidth],$I$(29,1).c$$S$I$javax_swing_Icon$I);
defaultOptions[1]=Clazz.new_([$I$(9).getString$O$java_util_Locale("OptionPane.noButtonText", l), p$2.getMnemonic$S$java_util_Locale.apply(this, ["OptionPane.noButtonMnemonic", l]), $I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.noIcon"), minimumWidth],$I$(29,1).c$$S$I$javax_swing_Icon$I);
defaultOptions[2]=Clazz.new_([$I$(9).getString$O$java_util_Locale("OptionPane.cancelButtonText", l), p$2.getMnemonic$S$java_util_Locale.apply(this, ["OptionPane.cancelButtonMnemonic", l]), $I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.cancelIcon"), minimumWidth],$I$(29,1).c$$S$I$javax_swing_Icon$I);
} else if (type == 2) {
defaultOptions=Clazz.array($I$(29), [2]);
defaultOptions[0]=Clazz.new_([$I$(9).getString$O$java_util_Locale("OptionPane.okButtonText", l), p$2.getMnemonic$S$java_util_Locale.apply(this, ["OptionPane.okButtonMnemonic", l]), $I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.okIcon"), minimumWidth],$I$(29,1).c$$S$I$javax_swing_Icon$I);
defaultOptions[1]=Clazz.new_([$I$(9).getString$O$java_util_Locale("OptionPane.cancelButtonText", l), p$2.getMnemonic$S$java_util_Locale.apply(this, ["OptionPane.cancelButtonMnemonic", l]), $I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.cancelIcon"), minimumWidth],$I$(29,1).c$$S$I$javax_swing_Icon$I);
} else {
defaultOptions=Clazz.array($I$(29), [1]);
defaultOptions[0]=Clazz.new_([$I$(9).getString$O$java_util_Locale("OptionPane.okButtonText", l), p$2.getMnemonic$S$java_util_Locale.apply(this, ["OptionPane.okButtonMnemonic", l]), $I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.okIcon"), minimumWidth],$I$(29,1).c$$S$I$javax_swing_Icon$I);
...
if (Clazz.instanceOf(this.initialFocusComponent, "javax.swing.JButton")) {
var root=$I$(12).getRootPane$java_awt_Component(this.initialFocusComponent);
if (root != null ) {
...
var color=$I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.messageForeground");
if (color != null ) {
label.setForeground$java_awt_Color(color);
}var messageFont=$I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.messageFont");
if (messageFont != null ) {
label.setFont$java_awt_Font(messageFont);
}}, p$2);

Clazz.newMeth(C$, 'configureButton$javax_swing_JButton', function (button) {
var buttonFont=$I$(14).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.optionPane, this, "OptionPane.buttonFont");
if (buttonFont != null ) {
