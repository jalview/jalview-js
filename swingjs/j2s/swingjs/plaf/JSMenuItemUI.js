(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[[0,'swingjs.api.js.DOMNode','java.awt.Dimension','swingjs.plaf.JSPopupMenuUI']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return Clazz.new_([this.isMenu && this.containerNode == null   ? 0 : 5, 0],$I$(2,1).c$$I$I);
});
