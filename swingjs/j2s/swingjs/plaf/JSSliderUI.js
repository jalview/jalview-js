(function(){var P$=Clazz.newPackage("swingjs.plaf"),p$1={},I$=[[0,'swingjs.jquery.JQueryUI','swingjs.plaf.JSComponentUI','swingjs.api.js.DOMNode','java.awt.Color','swingjs.JSToolkit','javax.swing.LookAndFeel','swingjs.plaf.JSGraphicsUtils','java.awt.Rectangle','javax.swing.plaf.InsetsUIResource','java.awt.Dimension','sun.swing.DefaultLookup']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.paintLabels=(this.majorSpacing > 0 && this.slider.getPaintLabels$() );
...
if (isNew) {
this.domNode=$I$(2,"wrap$S$S$swingjs_api_js_DOMNodeA",["div", this.id + "_wrap", [this.jqSlider=$I$(3).createElement("div", this.id)]]);
...
var s=$I$(5).getCSSColor$java_awt_Color(c);
...
if (this.isScrollBar) $I$(3,"setStyles",[node, ["background-color", $I$(5).getCSSColor$java_awt_Color(c)]]);
if (this.isScrollBar && ($I$(4).WHITE.equals$O(c) || c.getRGB$() == (-1118482) ) ) $I$(3).setStyles(this.sliderHandle, ["background", "#ccc"]);
...
p$1.setSliderFields.apply(this, []);
$I$(6).installColorsAndFont$javax_swing_JComponent$S$S$S(jc, "Slider.background", "Slider.foreground", "Slider.font");
this.insetCache=this.slider.getInsets$();
this.leftToRightCache=$I$(7).isLeftToRight$java_awt_Component(this.slider);
this.focusRect=Clazz.new_($I$(8,1));
this.contentRect=Clazz.new_($I$(8,1));
this.labelRect=Clazz.new_($I$(8,1));
this.tickRect=Clazz.new_($I$(8,1));
this.trackRect=Clazz.new_($I$(8,1));
this.thumbRect=Clazz.new_($I$(8,1));
this.lastValue=this.slider.getValue$();
this.focusInsets=Clazz.new_($I$(9,1).c$$I$I$I$I,[2, 2, 2, 2]);
});
...
if (!p$1.sliderInitialized.apply(this, [])) this.noSnapping=true;
var id=null;
try {
...
return (this.$data$swingjs_api_js_DOMNode$S(this.jqSlider, "ui-j2sslider") != null );
}, p$1);
...
return Clazz.new_([(this.isHoriz ? this.actualWidth : d), (this.isHoriz ? d : this.actualHeight)],$I$(10,1).c$$I$I);
});
...
var horizDim=$I$(11).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.slider, this, "Slider.minimumHorizontalSize");
if (horizDim == null ) {
horizDim=Clazz.new_($I$(10,1).c$$I$I,[36, this.paintLabels ? 35 : 21]);
}return horizDim;
}, p$1);
...
d=Clazz.new_([p$1.getMinimumVerticalSize.apply(this, [])],$I$(10,1).c$$java_awt_Dimension);
...
d=Clazz.new_([p$1.getMinimumHorizontalSize.apply(this, [])],$I$(10,1).c$$java_awt_Dimension);
...
var ltr=$I$(7).isLeftToRight$java_awt_Component(this.slider);
...
if ($I$(7).isLeftToRight$java_awt_Component(this.slider)) {
...
if (max == null  || (i).valueOf() > (max).valueOf()  ) {
max=i;
}}
return max;
});
...
while (keys.hasMoreElements$()){
var i=keys.nextElement$();
if (min == null  || (i).valueOf() < (min).valueOf()  ) {
min=i;
}}
return min;
});
...
var vertDim=$I$(11).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.slider, this, "Slider.minimumVerticalSize");
if (vertDim == null ) {
vertDim=Clazz.new_($I$(10,1).c$$I$I,[this.paintLabels ? 35 : 21, 36]);
}return vertDim;
}, p$1);
...
var d;
if (this.slider.getOrientation$() == 1) {
d=Clazz.new_([this.getPreferredVerticalSize$()],$I$(10,1).c$$java_awt_Dimension);
d.width=this.insetCache.left + this.insetCache.right;
d.width+=this.focusInsets.left + this.focusInsets.right;
d.width+=this.trackRect.width + this.tickRect.width + this.labelRect.width ;
} else {
d=Clazz.new_([this.getPreferredHorizontalSize$()],$I$(10,1).c$$java_awt_Dimension);
d.height=this.insetCache.top + this.insetCache.bottom;
d.height+=this.focusInsets.top + this.focusInsets.bottom;
d.height+=this.trackRect.height + this.tickRect.height + this.labelRect.height ;
}return d;
...
var horizDim=$I$(11).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.slider, this, "Slider.horizontalSize");
return Clazz.new_([horizDim.width, Math.max(horizDim.height, this.myHeight)],$I$(10,1).c$$I$I);
});

Clazz.newMeth(C$, 'getPreferredVerticalSize$', function () {
var vertDim=$I$(11).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.slider, this, "Slider.verticalSize");
return Clazz.new_([Math.max(vertDim.width, this.myHeight), vertDim.height],$I$(10,1).c$$I$I);
});
...
return (d != null  ? d : this.isHoriz ? Clazz.new_($I$(10,1).c$$I$I,[32767, 40]) : Clazz.new_($I$(10,1).c$$I$I,[40, 32767]));
});
