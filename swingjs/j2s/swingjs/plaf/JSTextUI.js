...
map.put$O$javax_swing_Action($I$(13).getCutAction$().getValue$S("Name"), $I$(13).getCutAction$());
map.put$O$javax_swing_Action($I$(13).getCopyAction$().getValue$S("Name"), $I$(13).getCopyAction$());
map.put$O$javax_swing_Action($I$(13).getPasteAction$().getValue$S("Name"), $I$(13).getPasteAction$());
return map;
});
...
this.editor=jc;
this.textListener=Clazz.new_($I$(14,1).c$$swingjs_plaf_JSTextUI$javax_swing_text_JTextComponent,[this, this.editor]);
...
$I$(15).setAttr(this.focusNode, "readOnly", this.editable ? null : "\u79d8TRUE");
});
...
return $I$(16).jquery.contains(this.focusNode, document.activeElement ||null);
});
...
return new Boolean(true);
case 9:
return (type === "keydown"  && this.handleTab$O(jQueryEvent) == true   ? null : Boolean.valueOf$Z(false));
case 38:
case 40:
case 37:
case 39:
...
$I$(15).setStyles(this.domNode, ["overflow", "hidden", "overflow-x", null, "overflow-y", null]);
return;
}var sp=scroller;
$I$(15).setStyles(this.domNode, ["overflow", null]);
$I$(15,"setStyles",[this.domNode, ["overflow-x", C$.overflows[sp.getHorizontalScrollBarPolicy$() % 10]]]);
$I$(15,"setStyles",[this.domNode, ["overflow-y", C$.overflows[sp.getVerticalScrollBarPolicy$() % 10]]]);
});
...
;Clazz.setTVer('3.2.9-v1');//Created 2020-04-08 08:17:09 Java2ScriptVisitor version 3.2.9-v1 net.sf.j2s.core.jar version 3.2.9-v1
