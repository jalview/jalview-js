...
this.domNode=this.focusNode=this.enableNode=$I$(9).newDOMObject$S$S$SA("div", this.id, []);
this.innerNode=$I$(9).newDOMObject$S$S$SA("div", this.id + "_inner", []);
...
if ((jnode)[0] == null ) {
if (node != null ) {
var div=$I$(9).newDOMObject$S$S$SA("div", myid, []);
...
var c=e.getKeyChar$();
var time=e.getWhen$();
var startIndex=$I$(1,"adjustIndex$I$javax_swing_JList",[src.getLeadSelectionIndex$(), this.this$0.list]);
...
$I$(7).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.this$0.list, 0, inputMap);
break;
...
var grabFocus=true;
if (dragEnabled) {
var row=$I$(2,"loc2IndexFileList$javax_swing_JList$java_awt_Point",[this.this$0.list, e.getPoint$()]);
if (row != -1) {
...
$I$(2).adjustFocus$javax_swing_JComponent(this.this$0.list);
...
var anchorIndex=$I$(1,"adjustIndex$I$javax_swing_JList",[this.this$0.list.getAnchorSelectionIndex$(), this.this$0.list]);
var anchorSelected;
if (anchorIndex == -1) {
anchorIndex=0;
...
Clazz.newMeth(C$, 'repaintCellFocus$', function () {
var leadIndex=$I$(1,"adjustIndex$I$javax_swing_JList",[this.this$0.list.getLeadSelectionIndex$(), this.this$0.list]);
if (leadIndex != -1) {
