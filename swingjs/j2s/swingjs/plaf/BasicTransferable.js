(function(){var P$=Clazz.newPackage("swingjs.plaf"),p$1={},I$=[[0,'java.awt.datatransfer.DataFlavor','java.io.Reader','java.io.StringReader','java.io.InputStream','sun.awt.datatransfer.DataTransferer','java.io.ByteArrayInputStream']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
