...
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectPrevious"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectPreviousChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectPreviousExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectNext"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectNextChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectNextExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectChild"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectChildChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectParent"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectParentChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["scrollUpChangeSelection"]));
...
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["scrollDownChangeSelection"]));
...
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectFirst"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectFirstChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectFirstExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectLast"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectLastChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["selectLastExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["toggle"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["cancel"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["startEditing"]));
...
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["scrollLeft"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["scrollRight"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["scrollLeftExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["scrollRightExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["scrollRightChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["scrollLeftChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["expand"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["collapse"]));
map.put$javax_swing_Action(Clazz.new_($I$(10,1).c$$S,["moveSelectionToParent"]));
...
map.put$javax_swing_Action($I$(11).getCutAction$());
map.put$javax_swing_Action($I$(11).getCopyAction$());
map.put$javax_swing_Action($I$(11).getPasteAction$());
}, 1);
...
this.domNode=this.focusNode=this.enableNode=$I$(12).newDOMObject$S$S$SA("div", this.id, []);
$I$(13).setStyles(this.domNode, ["outline", "none"]);
...
return p$1.getPathBounds$javax_swing_tree_TreePath$java_awt_Insets$java_awt_Rectangle.apply(this, [path, tree.getInsets$(), Clazz.new_($I$(2,1))]);
}return null;
});
...
this.drawingCache=Clazz.new_($I$(14,1).c$$I,[7]);
this.leftToRight=$I$(6).isLeftToRight$java_awt_Component(this.tree);
this.stopEditingInCompleteEditing=true;
this.lastSelectedRow=-1;
this.leadRow=-1;
this.$preferredSize=Clazz.new_($I$(15,1));
...
this.tree.setBackground$java_awt_Color($I$(16).getColor$O("Tree.background"));
}this.selectionBackground=$I$(12,"toCSSString$java_awt_Color",[$I$(16).getColor$O("Tree.selectionBackground")]);
if (this.getHashColor$() == null  || Clazz.instanceOf(this.getHashColor$(), "javax.swing.plaf.UIResource") ) {
this.setHashColor$java_awt_Color($I$(16).getColor$O("Tree.hash"));
}if (this.tree.getFont$() == null  || Clazz.instanceOf(this.tree.getFont$(), "javax.swing.plaf.UIResource") ) this.tree.setFont$java_awt_Font($I$(16).getFont$O("Tree.font"));
this.setExpandedIcon$javax_swing_Icon($I$(16).get$O("Tree.expandedIcon"));
this.setCollapsedIcon$javax_swing_Icon($I$(16).get$O("Tree.collapsedIcon"));
this.setLeftChildIndent$I(($I$(16).get$O("Tree.leftChildIndent")).intValue$());
this.setRightChildIndent$I(($I$(16).get$O("Tree.rightChildIndent")).intValue$());
$I$(17,"installProperty$javax_swing_JComponent$S$O",[this.tree, "rowHeight", $I$(16).get$O("Tree.rowHeight")]);
this.largeModel=(this.tree.isLargeModel$() && this.tree.getRowHeight$() > 0 );
var scrollsOnExpand=$I$(16).get$O("Tree.scrollsOnExpand");
if (scrollsOnExpand != null ) {
$I$(17).installProperty$javax_swing_JComponent$S$O(this.tree, "scrollsOnExpand", scrollsOnExpand);
}this.paintLines=$I$(16).getBoolean$O("Tree.paintLines");
this.lineTypeDashed=$I$(16).getBoolean$O("Tree.lineTypeDashed");
var l=$I$(16).get$O("Tree.timeFactor");
this.timeFactor=(l != null ) ? l.longValue$() : 1000;
var showsRootHandles=$I$(16).get$O("Tree.showsRootHandles");
if (showsRootHandles != null ) {
$I$(17).installProperty$javax_swing_JComponent$S$O(this.tree, "showsRootHandles", showsRootHandles);
}});
...
}$I$(17).installProperty$javax_swing_JComponent$S$O(this.tree, "opaque", Boolean.TRUE);
});

Clazz.newMeth(C$, 'installKeyboardActions$', function () {
var km=this.getInputMap$I(1);
$I$(5).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.tree, 1, km);
km=this.getInputMap$I(0);
$I$(5).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.tree, 0, km);
$I$(18,"installLazyActionMap$javax_swing_JComponent$Class$S",[this.tree, Clazz.getClass(C$), "Tree.actionMap"]);
});

Clazz.newMeth(C$, 'getInputMap$I', function (condition) {
if (condition == 1) {
return $I$(19).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.tree, this, "Tree.ancestorInputMap");
} else if (condition == 0) {
var keyMap=$I$(19).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.tree, this, "Tree.focusInputMap");
var rtlKeyMap;
if (this.tree.getComponentOrientation$().isLeftToRight$() || ((rtlKeyMap=$I$(19).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.tree, this, "Tree.focusInputMap.RightToLeft")) == null ) ) {
return keyMap;
} else {
...
return Clazz.new_($I$(20,1),[this, null]);
});
...
this.handler=Clazz.new_($I$(21,1),[this, null]);
}return this.handler;
}, p$1);
...
return Clazz.new_($I$(22,1),[this, null]);
});
...
var editor=Clazz.new_($I$(26,1).c$$javax_swing_JTree$javax_swing_tree_DefaultTreeCellRenderer,[this.tree, this.currentCellRenderer]);
return editor;
}return Clazz.new_($I$(26,1).c$$javax_swing_JTree$javax_swing_tree_DefaultTreeCellRenderer,[this.tree, null]);
});
...
$I$(5).replaceUIActionMap$javax_swing_JComponent$javax_swing_ActionMap(this.tree, null);
$I$(5).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.tree, 1, null);
$I$(5).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.tree, 0, null);
});
...
var lafDefaults=$I$(16).getLookAndFeelDefaults$();
...
if (this.tree !== c ) {
throw Clazz.new_($I$(29,1).c$$S,["incorrect component"]);
}if (this.treeState == null ) {
return;
...
var hasBeenExpanded;
var isLeaf;
var boundsBuffer=Clazz.new_($I$(2,1));
var bounds;
var path;
...
this.paintVerticalPartOfLeg$java_awt_Graphics$java_awt_Rectangle$java_awt_Insets$javax_swing_tree_TreePath(g, paintBounds, insets, parentPath);
this.drawingCache.put$O$O(parentPath, Boolean.TRUE);
}this.paintHorizontalPartOfLeg$java_awt_Graphics$java_awt_Rectangle$java_awt_Insets$java_awt_Rectangle$javax_swing_tree_TreePath$I$Z$Z$Z(g, paintBounds, insets, bounds, path, row, isExpanded, hasBeenExpanded, isLeaf);
...
return;
}var c=$I$(16).getColor$O("Tree.dropLineColor");
if (c != null ) {
...
rect=Clazz.new_([insets.left, insets.top, this.tree.getWidth$() - insets.left - insets.right , 0],$I$(2,1).c$$I$I$I$I);
} else {
...
if (this.leftToRight) {
var leftX=bounds.x - this.getRightChildIndent$();
var nodeX=bounds.x - this.getHorizontalLegBuffer$();
if (lineY >= clipTop && lineY < clipBottom  && nodeX >= clipLeft  && leftX < clipRight  && leftX < nodeX ) {
g.setColor$java_awt_Color(this.getHashColor$());
this.paintHorizontalLine$java_awt_Graphics$javax_swing_JComponent$I$I$I(g, this.tree, lineY, leftX, nodeX - 1);
}} else {
var nodeX=bounds.x + bounds.width + this.getHorizontalLegBuffer$() ;
var rightX=bounds.x + bounds.width + this.getRightChildIndent$() ;
if (lineY >= clipTop && lineY < clipBottom  && rightX >= clipLeft  && nodeX < clipRight  && nodeX < rightX ) {
g.setColor$java_awt_Color(this.getHashColor$());
this.paintHorizontalLine$java_awt_Graphics$javax_swing_JComponent$I$I$I(g, this.tree, lineY, nodeX, rightX - 1);
}}});
...
var div=$I$(30).getDOMNode(jnode);
if (div == null ) {
div=$I$(12).newDOMObject$S$S$SA("div", myid, []);
div.appendChild(node);
this.domNode.appendChild(div);
} else {
jnode.empty();
if (node != null ) jnode.append(node);
}$I$(13).setSize(node, width, height);
$I$(13).setTopLeftAbsolute(node, top, left);
$I$(13).setStyles(node, ["display", null]);
this.$$O("#" + $I$(13).getAttrInt(node, "id") + "_txt" ).css("background", this.tree.isPathSelected$javax_swing_tree_TreePath(path) ? this.selectionBackground : null);
}, p$1);
...
var depth=path.getPathCount$() - 1;
if ((depth == 0 || (depth == 1 && !this.isRootVisible$() ) ) && !this.getShowsRootHandles$() ) return false;
return true;
});
...
var rootPath=Clazz.new_([this.treeModel.getRoot$()],$I$(31,1).c$$O);
...
if (this.getShowsRootHandles$()) this.depthOffset=1;
 else this.depthOffset=0;
} else if (!this.getShowsRootHandles$()) this.depthOffset=-1;
 else this.depthOffset=0;
});
...
visRect.x-=i.left;
visRect.y-=i.top;
}var component=$I$(5).getUnwrappedParent$java_awt_Component(this.tree);
...
var scrollVert=$I$(19).getBoolean$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S$Z(this.tree, this, "Tree.scrollsHorizontallyAndVertically", false);
if (beginRow == endRow) {
...
this.tree.scrollRectToVisible$java_awt_Rectangle(Clazz.new_($I$(2,1).c$$I$I$I$I,[visRect.x, beginY, 1, testRect.y + testRect.height - beginY]));
}}}});
...
return Clazz.new_($I$(15,1).c$$java_awt_Dimension,[this.preferredMinSize]);
});
...
if (this.tree != null ) {
if (pSize != null ) return Clazz.new_([Math.max(pSize.width, this.$preferredSize.width), Math.max(pSize.height, this.$preferredSize.height)],$I$(15,1).c$$I$I);
return Clazz.new_($I$(15,1).c$$I$I,[this.$preferredSize.width, this.$preferredSize.height]);
} else if (pSize != null ) return pSize;
 else return Clazz.new_($I$(15,1).c$$I$I,[0, 0]);
});
...
var requestFocus=(this.tree != null  && (this.tree.hasFocus$() || $I$(5).findFocusOwner$java_awt_Component(this.editingComponent) != null  ) );
...
$I$(32).getComponentAccessor$().revalidateSynchronously$java_awt_Component(this.editingComponent);
...
this.stopEditingInCompleteEditing=true;
}var focusedComponent=$I$(4).compositeRequestFocus$java_awt_Component(this.editingComponent);
var selectAll=true;
if (event != null ) {
var componentPoint=$I$(5,"convertPoint$java_awt_Component$java_awt_Point$java_awt_Component",[this.tree, Clazz.new_([event.getX$(), event.getY$()],$I$(33,1).c$$I$I), this.editingComponent]);
var activeComponent=$I$(5).getDeepestComponentAt$java_awt_Component$I$I(this.editingComponent, componentPoint.x, componentPoint.y);
if (activeComponent != null ) {
var handler=Clazz.new_($I$(34,1).c$$java_awt_Component$java_awt_Component$java_awt_event_MouseEvent$java_awt_Component,[this, null, this.tree, activeComponent, event, focusedComponent]);
...
return ($I$(5).isLeftMouseButton$java_awt_event_MouseEvent(event) && $I$(6).isMenuShortcutKeyDown$java_awt_event_InputEvent(event) );
});

Clazz.newMeth(C$, 'isMultiSelectEvent$java_awt_event_MouseEvent', function (event) {
return ($I$(5).isLeftMouseButton$java_awt_event_MouseEvent(event) && event.isShiftDown$() );
});

Clazz.newMeth(C$, 'isToggleEvent$java_awt_event_MouseEvent', function (event) {
if (!$I$(5).isLeftMouseButton$java_awt_event_MouseEvent(event)) {
return false;
...
p$1.setLeadSelectionPath$javax_swing_tree_TreePath.apply(this, [path]);
} else if ($I$(5).isLeftMouseButton$java_awt_event_MouseEvent(event)) {
this.tree.setSelectionPath$javax_swing_tree_TreePath(path);
...
if ($I$(16).getBoolean$O("Tree.repaintWholeRow")) {
bounds.x=0;
...
C$.BASELINE_COMPONENT_KEY=Clazz.new_($I$(9,1).c$$S,["Tree.baselineComponent"]);
C$.SHARED_ACTION=Clazz.new_($I$(10,1));
};
;
...
p$1.getHandler.apply(this.this$0, []).treeExpanded$javax_swing_event_TreeExpansionEvent(event);
});

Clazz.newMeth(C$, 'treeCollapsed$javax_swing_event_TreeExpansionEvent', function (event) {
p$1.getHandler.apply(this.this$0, []).treeCollapsed$javax_swing_event_TreeExpansionEvent(event);
});
...
if (scrollPane == null ) this.this$0.updateSize$.apply(this.this$0, []);
 else {
...
if ((this.scrollBar=scrollPane.getHorizontalScrollBar$()) != null  && this.scrollBar.getValueIsAdjusting$() ) this.startTimer$();
 else this.this$0.updateSize$.apply(this.this$0, []);
} else this.startTimer$();
}}});

Clazz.newMeth(C$, 'startTimer$', function () {
if (this.timer == null ) {
this.timer=Clazz.new_($I$(1,1).c$$I$java_awt_event_ActionListener,[200, this]);
this.timer.setRepeats$Z(true);
}this.timer.start$();
});

Clazz.newMeth(C$, 'getScrollPane$', function () {
var c=this.this$0.tree.getParent$();
...
this.this$0.updateSize$.apply(this.this$0, []);
this.timer=null;
this.scrollBar=null;
}});
...
p$1.getHandler.apply(this.this$0, []).treeNodesChanged$javax_swing_event_TreeModelEvent(e);
});

Clazz.newMeth(C$, 'treeNodesInserted$javax_swing_event_TreeModelEvent', function (e) {
p$1.getHandler.apply(this.this$0, []).treeNodesInserted$javax_swing_event_TreeModelEvent(e);
});

Clazz.newMeth(C$, 'treeNodesRemoved$javax_swing_event_TreeModelEvent', function (e) {
p$1.getHandler.apply(this.this$0, []).treeNodesRemoved$javax_swing_event_TreeModelEvent(e);
});

Clazz.newMeth(C$, 'treeStructureChanged$javax_swing_event_TreeModelEvent', function (e) {
p$1.getHandler.apply(this.this$0, []).treeStructureChanged$javax_swing_event_TreeModelEvent(e);
});
...
p$1.getHandler.apply(this.this$0, []).valueChanged$javax_swing_event_TreeSelectionEvent(event);
});
...
p$1.getHandler.apply(this.this$0, []).editingStopped$javax_swing_event_ChangeEvent(e);
});

Clazz.newMeth(C$, 'editingCanceled$javax_swing_event_ChangeEvent', function (e) {
p$1.getHandler.apply(this.this$0, []).editingCanceled$javax_swing_event_ChangeEvent(e);
});
...
p$1.getHandler.apply(this.this$0, []).keyTyped$java_awt_event_KeyEvent(e);
});
...
p$1.getHandler.apply(this.this$0, []).keyReleased$java_awt_event_KeyEvent(e);
});
...
if (this.this$0.editingComponent != null  && this.this$0.editingRow == row ) {
var prefSize=this.this$0.editingComponent.getPreferredSize$();
var rh=this.this$0.getRowHeight$.apply(this.this$0, []);
...
size=Clazz.new_([this.getRowX$I$I(row, depth), 0, prefSize.width, prefSize.height],$I$(2,1).c$$I$I$I$I);
}return size;
}if (this.this$0.currentCellRenderer != null ) {
var aComponent;
aComponent=this.this$0.currentCellRenderer.getTreeCellRendererComponent$javax_swing_JTree$O$Z$Z$Z$I$Z(this.this$0.tree, value, this.this$0.tree.isRowSelected$I(row), expanded, this.this$0.treeModel.isLeaf$O(value), row, false);
if (this.this$0.tree != null ) {
this.this$0.rendererPane.add$java_awt_Component(aComponent);
aComponent.validate$();
...
Clazz.newMeth(C$, 'getRowX$I$I', function (row, depth) {
return this.this$0.getRowX$I$I.apply(this.this$0, [row, depth]);
});
...
p$1.getHandler.apply(this.this$0, []).mouseDragged$java_awt_event_MouseEvent(e);
});

Clazz.newMeth(C$, 'mouseMoved$java_awt_event_MouseEvent', function (e) {
p$1.getHandler.apply(this.this$0, []).mouseMoved$java_awt_event_MouseEvent(e);
});

Clazz.newMeth(C$, 'mouseReleased$java_awt_event_MouseEvent', function (e) {
p$1.getHandler.apply(this.this$0, []).mouseReleased$java_awt_event_MouseEvent(e);
});
...
p$1.getHandler.apply(this.this$0, []).propertyChange$java_beans_PropertyChangeEvent(event);
});
...
if (this.this$0.tree != null ) {
p$2.traverse$javax_swing_JTree$swingjs_plaf_JSTreeUI$I$Z.apply($I$(3).SHARED_ACTION, [this.this$0.tree, this.this$0, this.direction, this.changeSelection]);
}});
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
if (this.this$0.tree != null ) {
p$2.page$javax_swing_JTree$swingjs_plaf_JSTreeUI$I$Z$Z.apply($I$(3).SHARED_ACTION, [this.this$0.tree, this.this$0, this.direction, this.addToSelection, this.changeSelection]);
}});
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
if (this.this$0.tree != null ) {
p$2.increment$javax_swing_JTree$swingjs_plaf_JSTreeUI$I$Z$Z.apply($I$(3).SHARED_ACTION, [this.this$0.tree, this.this$0, this.direction, this.addToSelection, this.changeSelection]);
}});
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
if (this.this$0.tree != null ) {
p$2.home$javax_swing_JTree$swingjs_plaf_JSTreeUI$I$Z$Z.apply($I$(3).SHARED_ACTION, [this.this$0.tree, this.this$0, this.direction, this.addToSelection, this.changeSelection]);
}});
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
if (this.this$0.tree != null ) {
p$2.toggle$javax_swing_JTree$swingjs_plaf_JSTreeUI.apply($I$(3).SHARED_ACTION, [this.this$0.tree, this.this$0]);
}});
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
if (this.this$0.tree != null ) {
p$2.cancelEditing$javax_swing_JTree$swingjs_plaf_JSTreeUI.apply($I$(3).SHARED_ACTION, [this.this$0.tree, this.this$0]);
}});

Clazz.newMeth(C$, 'isEnabled$', function () {
return (this.this$0.tree != null  && this.this$0.tree.isEnabled$()  && this.this$0.isEditing$javax_swing_JTree.apply(this.this$0, [this.this$0.tree]) );
});
...
$I$(4,"setSkipClickCount$java_awt_Component$I",[destination, event.getClickCount$() - 1]);
destination.dispatchEvent$java_awt_AWTEvent($I$(5).convertMouseEvent$java_awt_Component$java_awt_event_MouseEvent$java_awt_Component(source, event, destination));
...
this.destination.dispatchEvent$java_awt_AWTEvent($I$(5).convertMouseEvent$java_awt_Component$java_awt_event_MouseEvent$java_awt_Component(this.source, e, this.destination));
}});
...
Clazz.newMeth(C$, 'mouseReleased$java_awt_event_MouseEvent', function (e) {
if (this.destination != null ) this.destination.dispatchEvent$java_awt_AWTEvent($I$(5).convertMouseEvent$java_awt_Component$java_awt_event_MouseEvent$java_awt_Component(this.source, e, this.destination));
this.removeFromSource$();
});

Clazz.newMeth(C$, 'mouseEntered$java_awt_event_MouseEvent', function (e) {
if (!$I$(5).isLeftMouseButton$java_awt_event_MouseEvent(e)) {
this.removeFromSource$();
}});
...
Clazz.newMeth(C$, 'keyTyped$java_awt_event_KeyEvent', function (e) {
if (this.this$0.tree != null  && this.this$0.tree.getRowCount$() > 0  && this.this$0.tree.hasFocus$()  && this.this$0.tree.isEnabled$() ) {
if (e.isAltDown$() || $I$(6).isMenuShortcutKeyDown$java_awt_event_InputEvent(e) || p$3.isNavigationKey$java_awt_event_KeyEvent.apply(this, [e])  ) {
return;
}var startingFromSelection=true;
var c=e.getKeyChar$();
var time=e.getWhen$();
var startingRow=this.this$0.tree.getLeadSelectionRow$();
...
if (startingRow < 0 || startingRow >= this.this$0.tree.getRowCount$() ) {
startingFromSelection=false;
startingRow=0;
}var path=this.this$0.tree.getNextMatch$S$I$javax_swing_text_Position_Bias(this.prefix, startingRow, $I$(7).Forward);
if (path != null ) {
this.this$0.tree.setSelectionPath$javax_swing_tree_TreePath(path);
var row=this.this$0.getRowForPath$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, path]);
this.this$0.ensureRowsAreVisible$I$I.apply(this.this$0, [row, row]);
} else if (startingFromSelection) {
path=this.this$0.tree.getNextMatch$S$I$javax_swing_text_Position_Bias(this.prefix, 0, $I$(7).Forward);
if (path != null ) {
this.this$0.tree.setSelectionPath$javax_swing_tree_TreePath(path);
var row=this.this$0.getRowForPath$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, path]);
this.this$0.ensureRowsAreVisible$I$I.apply(this.this$0, [row, row]);
...
Clazz.newMeth(C$, 'keyPressed$java_awt_event_KeyEvent', function (e) {
if (this.this$0.tree != null  && p$3.isNavigationKey$java_awt_event_KeyEvent.apply(this, [e]) ) {
this.prefix="";
this.typedString="";
this.lastTime=0;
}});
...
var inputMap=this.this$0.tree.getInputMap$I(1);
var key=$I$(8).getKeyStrokeForEvent$java_awt_event_KeyEvent(event);
return inputMap != null  && inputMap.get$javax_swing_KeyStroke(key) != null  ;
}, p$3);

Clazz.newMeth(C$, 'propertyChange$java_beans_PropertyChangeEvent', function (event) {
if (event.getSource$() === this.this$0.treeSelectionModel ) {
this.this$0.treeSelectionModel.resetRowSelection$();
} else if (event.getSource$() === this.this$0.tree ) {
var changeName=event.getPropertyName$();
if (changeName == "leadSelectionPath") {
if (!this.this$0.ignoreLAChange) {
this.this$0.updateLeadSelectionRow$.apply(this.this$0, []);
p$1.repaintPath$javax_swing_tree_TreePath.apply(this.this$0, [event.getOldValue$()]);
p$1.repaintPath$javax_swing_tree_TreePath.apply(this.this$0, [event.getNewValue$()]);
}} else if (changeName == "anchorSelectionPath") {
if (!this.this$0.ignoreLAChange) {
p$1.repaintPath$javax_swing_tree_TreePath.apply(this.this$0, [event.getOldValue$()]);
p$1.repaintPath$javax_swing_tree_TreePath.apply(this.this$0, [event.getNewValue$()]);
}}if (changeName == "cellRenderer") {
this.this$0.setCellRenderer$javax_swing_tree_TreeCellRenderer.apply(this.this$0, [event.getNewValue$()]);
p$1.redoTheLayout.apply(this.this$0, []);
} else if (changeName == "model") {
this.this$0.setModel$javax_swing_tree_TreeModel.apply(this.this$0, [event.getNewValue$()]);
} else if (changeName == "rootVisible") {
this.this$0.setRootVisible$Z.apply(this.this$0, [(event.getNewValue$()).booleanValue$()]);
} else if (changeName == "showsRootHandles") {
this.this$0.setShowsRootHandles$Z.apply(this.this$0, [(event.getNewValue$()).booleanValue$()]);
} else if (changeName == "rowHeight") {
this.this$0.setRowHeight$I.apply(this.this$0, [(event.getNewValue$()).intValue$()]);
} else if (changeName == "cellEditor") {
this.this$0.setCellEditor$javax_swing_tree_TreeCellEditor.apply(this.this$0, [event.getNewValue$()]);
} else if (changeName == "editable") {
this.this$0.setEditable$Z.apply(this.this$0, [(event.getNewValue$()).booleanValue$()]);
} else if (changeName == "largeModel") {
this.this$0.setLargeModel$Z.apply(this.this$0, [this.this$0.tree.isLargeModel$()]);
} else if (changeName == "selectionModel") {
this.this$0.setSelectionModel$javax_swing_tree_TreeSelectionModel.apply(this.this$0, [this.this$0.tree.getSelectionModel$()]);
} else if (changeName === "font" ) {
this.this$0.completeEditing$.apply(this.this$0, []);
if (this.this$0.treeState != null ) this.this$0.treeState.invalidateSizes$();
this.this$0.updateSize$.apply(this.this$0, []);
} else if (changeName === "componentOrientation" ) {
if (this.this$0.tree != null ) {
this.this$0.leftToRight=$I$(6).isLeftToRight$java_awt_Component(this.this$0.tree);
p$1.redoTheLayout.apply(this.this$0, []);
this.this$0.tree.treeDidChange$();
var km=this.this$0.getInputMap$I.apply(this.this$0, [0]);
$I$(5).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.this$0.tree, 0, km);
...
p$3.repaintDropLocation$javax_swing_JTree_DropLocation.apply(this, [this.this$0.tree.getDropLocation$()]);
}}});
...
if (this.this$0.isDropLine$javax_swing_JTree_DropLocation.apply(this.this$0, [loc])) {
r=this.this$0.getDropLineRect$javax_swing_JTree_DropLocation.apply(this.this$0, [loc]);
} else {
r=this.this$0.tree.getPathBounds$javax_swing_tree_TreePath(loc.getPath$());
}if (r != null ) {
this.this$0.tree.repaint$java_awt_Rectangle(r);
}}, p$3);

Clazz.newMeth(C$, 'isActualPath$javax_swing_tree_TreePath$I$I', function (path, x, y) {
if (path == null ) {
return false;
}var bounds=this.this$0.getPathBounds$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, path]);
...
Clazz.newMeth(C$, 'mousePressed$java_awt_event_MouseEvent', function (e) {
if ($I$(4).shouldIgnore$java_awt_event_MouseEvent$javax_swing_JComponent(e, this.this$0.tree)) {
return;
}if (this.this$0.isEditing$javax_swing_JTree.apply(this.this$0, [this.this$0.tree]) && this.this$0.tree.getInvokesStopCellEditing$() && !this.this$0.stopEditing$javax_swing_JTree.apply(this.this$0, [this.this$0.tree])  ) {
return;
}this.this$0.completeEditing$.apply(this.this$0, []);
this.pressedPath=this.this$0.getClosestPathForLocation$javax_swing_JTree$I$I.apply(this.this$0, [this.this$0.tree, e.getX$(), e.getY$()]);
if (this.this$0.tree.getDragEnabled$()) {
p$3.mousePressedDND$java_awt_event_MouseEvent.apply(this, [e]);
} else {
$I$(4).adjustFocus$javax_swing_JComponent(this.this$0.tree);
...
var bounds=this.this$0.getPathBounds$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, this.pressedPath]);
if (bounds == null  || e.getY$() >= (bounds.y + bounds.height) ) {
return;
}if ($I$(5).isLeftMouseButton$java_awt_event_MouseEvent(e)) {
this.this$0.checkForClickInExpandControl$javax_swing_tree_TreePath$I$I.apply(this.this$0, [this.pressedPath, e.getX$(), e.getY$()]);
}var x=e.getX$();
if (x >= bounds.x && x < (bounds.x + bounds.width) ) {
if (this.this$0.tree.getDragEnabled$() || !this.this$0.startEditing$javax_swing_tree_TreePath$java_awt_event_MouseEvent.apply(this.this$0, [this.pressedPath, e]) ) {
this.this$0.selectPathForEvent$javax_swing_tree_TreePath$java_awt_event_MouseEvent.apply(this.this$0, [this.pressedPath, e]);
}}}});

Clazz.newMeth(C$, 'dragStarting$java_awt_event_MouseEvent', function (me) {
this.dragStarted=true;
if ($I$(6).isMenuShortcutKeyDown$java_awt_event_InputEvent(me)) {
this.this$0.tree.addSelectionPath$javax_swing_tree_TreePath(this.pressedPath);
p$1.setAnchorSelectionPath$javax_swing_tree_TreePath.apply(this.this$0, [this.pressedPath]);
p$1.setLeadSelectionPath$javax_swing_tree_TreePath$Z.apply(this.this$0, [this.pressedPath, true]);
...
p$1.startEditingOnRelease$javax_swing_tree_TreePath$java_awt_event_MouseEvent$java_awt_event_MouseEvent.apply(this.this$0, [this.pressedPath, this.pressedEvent, e]);
}}}, p$3);

Clazz.newMeth(C$, 'focusGained$java_awt_event_FocusEvent', function (e) {
if (this.this$0.tree != null ) {
var pBounds;
pBounds=this.this$0.getPathBounds$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, this.this$0.tree.getLeadSelectionPath$()]);
if (pBounds != null ) this.this$0.tree.repaint$java_awt_Rectangle(p$1.getRepaintPathBounds$java_awt_Rectangle.apply(this.this$0, [pBounds]));
pBounds=this.this$0.getPathBounds$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, p$1.getLeadSelectionPath.apply(this.this$0, [])]);
if (pBounds != null ) this.this$0.tree.repaint$java_awt_Rectangle(p$1.getRepaintPathBounds$java_awt_Rectangle.apply(this.this$0, [pBounds]));
}});
...
Clazz.newMeth(C$, 'editingStopped$javax_swing_event_ChangeEvent', function (e) {
this.this$0.completeEditing$Z$Z$Z.apply(this.this$0, [false, false, true]);
});

Clazz.newMeth(C$, 'editingCanceled$javax_swing_event_ChangeEvent', function (e) {
this.this$0.completeEditing$Z$Z$Z.apply(this.this$0, [false, false, false]);
});

Clazz.newMeth(C$, 'valueChanged$javax_swing_event_TreeSelectionEvent', function (event) {
this.valueChangedOnPress=true;
this.this$0.completeEditing$.apply(this.this$0, []);
if (this.this$0.tree.getExpandsSelectedPaths$() && this.this$0.treeSelectionModel != null  ) {
var paths=this.this$0.treeSelectionModel.getSelectionPaths$();
if (paths != null ) {
for (var counter=paths.length - 1; counter >= 0; counter--) {
var path=paths[counter].getParentPath$();
var expand=true;
while (path != null ){
if (this.this$0.treeModel.isLeaf$O(path.getLastPathComponent$())) {
expand=false;
path=null;
} else {
path=path.getParentPath$();
...
if (expand) {
this.this$0.tree.makeVisible$javax_swing_tree_TreePath(paths[counter]);
}}
}}var oldLead=p$1.getLeadSelectionPath.apply(this.this$0, []);
this.this$0.lastSelectedRow=this.this$0.tree.getMinSelectionRow$();
var lead=this.this$0.tree.getSelectionModel$().getLeadSelectionPath$();
p$1.setAnchorSelectionPath$javax_swing_tree_TreePath.apply(this.this$0, [lead]);
p$1.setLeadSelectionPath$javax_swing_tree_TreePath.apply(this.this$0, [lead]);
var changedPaths=event.getPaths$();
var nodeBounds;
var visRect=this.this$0.tree.getVisibleRect$();
var paintPaths=true;
var nWidth=this.this$0.tree.getWidth$();
...
nodeBounds=this.this$0.getPathBounds$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, changedPaths[counter]]);
if (nodeBounds != null  && visRect.intersects$java_awt_Rectangle(nodeBounds) ) this.this$0.tree.repaint$I$I$I$I(0, nodeBounds.y, nWidth, nodeBounds.height);
}
}}if (paintPaths) {
nodeBounds=this.this$0.getPathBounds$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, oldLead]);
if (nodeBounds != null  && visRect.intersects$java_awt_Rectangle(nodeBounds) ) this.this$0.tree.repaint$I$I$I$I(0, nodeBounds.y, nWidth, nodeBounds.height);
nodeBounds=this.this$0.getPathBounds$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, lead]);
if (nodeBounds != null  && visRect.intersects$java_awt_Rectangle(nodeBounds) ) this.this$0.tree.repaint$I$I$I$I(0, nodeBounds.y, nWidth, nodeBounds.height);
}});

Clazz.newMeth(C$, 'treeExpanded$javax_swing_event_TreeExpansionEvent', function (event) {
if (event != null  && this.this$0.tree != null  ) {
var path=event.getPath$();
this.this$0.updateExpandedDescendants$javax_swing_tree_TreePath.apply(this.this$0, [path]);
}});
...
var path=event.getPath$();
this.this$0.completeEditing$.apply(this.this$0, []);
if (path != null  && this.this$0.tree.isVisible$javax_swing_tree_TreePath(path) ) {
this.this$0.treeState.setExpandedState$javax_swing_tree_TreePath$Z(path, false);
this.this$0.updateLeadSelectionRow$.apply(this.this$0, []);
this.this$0.updateSize$.apply(this.this$0, []);
}}});

Clazz.newMeth(C$, 'treeNodesChanged$javax_swing_event_TreeModelEvent', function (e) {
if (this.this$0.treeState != null  && e != null  ) {
var parentPath=$I$(4,"getTreePath$javax_swing_event_TreeModelEvent$javax_swing_tree_TreeModel",[e, this.this$0.getModel$.apply(this.this$0, [])]);
var indices=e.getChildIndices$();
if (indices == null  || indices.length == 0 ) {
this.this$0.treeState.treeNodesChanged$javax_swing_event_TreeModelEvent(e);
this.this$0.updateSize$.apply(this.this$0, []);
} else if (this.this$0.treeState.isExpanded$javax_swing_tree_TreePath(parentPath)) {
var minIndex=indices[0];
for (var i=indices.length - 1; i > 0; i--) {
minIndex=Math.min(indices[i], minIndex);
}
var minChild=this.this$0.treeModel.getChild$O$I(parentPath.getLastPathComponent$(), minIndex);
var minPath=parentPath.pathByAddingChild$O(minChild);
var minBounds=this.this$0.getPathBounds$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, minPath]);
this.this$0.treeState.treeNodesChanged$javax_swing_event_TreeModelEvent(e);
p$1.updateSize0.apply(this.this$0, []);
var newMinBounds=this.this$0.getPathBounds$javax_swing_JTree$javax_swing_tree_TreePath.apply(this.this$0, [this.this$0.tree, minPath]);
if (minBounds == null  || newMinBounds == null  ) {
return;
}if (indices.length == 1 && newMinBounds.height == minBounds.height ) {
this.this$0.tree.repaint$I$I$I$I(0, minBounds.y, this.this$0.tree.getWidth$(), minBounds.height);
} else {
this.this$0.tree.repaint$I$I$I$I(0, minBounds.y, this.this$0.tree.getWidth$(), this.this$0.tree.getHeight$() - minBounds.y);
}} else {
this.this$0.treeState.treeNodesChanged$javax_swing_event_TreeModelEvent(e);
}}});
...
Clazz.newMeth(C$, 'treeNodesInserted$javax_swing_event_TreeModelEvent', function (e) {
if (this.this$0.treeState != null  && e != null  ) {
this.this$0.treeState.treeNodesInserted$javax_swing_event_TreeModelEvent(e);
this.this$0.updateLeadSelectionRow$.apply(this.this$0, []);
var path=$I$(4,"getTreePath$javax_swing_event_TreeModelEvent$javax_swing_tree_TreeModel",[e, this.this$0.getModel$.apply(this.this$0, [])]);
if (this.this$0.treeState.isExpanded$javax_swing_tree_TreePath(path)) {
this.this$0.updateSize$.apply(this.this$0, []);
} else {
var indices=e.getChildIndices$();
var childCount=this.this$0.treeModel.getChildCount$O(path.getLastPathComponent$());
if (indices != null  && (childCount - indices.length) == 0 ) this.this$0.updateSize$.apply(this.this$0, []);
}}});

Clazz.newMeth(C$, 'treeNodesRemoved$javax_swing_event_TreeModelEvent', function (e) {
if (this.this$0.treeState != null  && e != null  ) {
this.this$0.treeState.treeNodesRemoved$javax_swing_event_TreeModelEvent(e);
this.this$0.updateLeadSelectionRow$.apply(this.this$0, []);
var path=$I$(4,"getTreePath$javax_swing_event_TreeModelEvent$javax_swing_tree_TreeModel",[e, this.this$0.getModel$.apply(this.this$0, [])]);
if (this.this$0.treeState.isExpanded$javax_swing_tree_TreePath(path) || this.this$0.treeModel.getChildCount$O(path.getLastPathComponent$()) == 0 ) this.this$0.updateSize$.apply(this.this$0, []);
}});

Clazz.newMeth(C$, 'treeStructureChanged$javax_swing_event_TreeModelEvent', function (e) {
if (this.this$0.treeState != null  && e != null  ) {
this.this$0.treeState.treeStructureChanged$javax_swing_event_TreeModelEvent(e);
this.this$0.updateLeadSelectionRow$.apply(this.this$0, []);
var pPath=$I$(4,"getTreePath$javax_swing_event_TreeModelEvent$javax_swing_tree_TreeModel",[e, this.this$0.getModel$.apply(this.this$0, [])]);
if (pPath != null ) {
pPath=pPath.getParentPath$();
}if (pPath == null  || this.this$0.treeState.isExpanded$javax_swing_tree_TreePath(pPath) ) this.this$0.updateSize$.apply(this.this$0, []);
}});
...
$I$(5,"invokeLater$Runnable",[((P$.JSTreeUI$Actions$1||
...
;Clazz.setTVer('3.2.9-v1');//Created 2020-04-08 08:17:06 Java2ScriptVisitor version 3.2.9-v1 net.sf.j2s.core.jar version 3.2.9-v1
