(function(){var P$=Clazz.newPackage("java.text"),p$1={},I$=[[0,'java.util.ArrayList','StringBuffer',['java.text.PatternEntry','.Parser']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
