(function(){var P$=Clazz.newPackage("java.text"),p$1={},I$=[[0,'StringBuffer','sun.text.CollatorUtilities','sun.text.normalizer.NormalizerBase']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
