(function(){var P$=Clazz.newPackage("java.text"),p$1={},I$=[[0,'java.util.Arrays']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return this.format$D$StringBuffer$java_text_FieldPosition(number, toAppendTo, status);
});
...
var magnitude=bits & ~-9223372036854775808;
if ((bits > 0) == positive ) {
if (magnitude != 9218868437227405312) {
magnitude+=1;
}} else {
magnitude-=1;
}var signbit=bits & -9223372036854775808;
return Double.longBitsToDouble$J(magnitude | signbit);
}, 1);
