(function(){var P$=Clazz.newPackage("java.text"),p$1={},I$=[[0,'java.text.RBTableBuilder',['java.text.RBCollationTables','.BuildAPI']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.this$0.mapping=map;
this.this$0.contractTable=cTbl;
this.this$0.expandTable=eTbl;
this.this$0.contractFlags=cFlgs;
