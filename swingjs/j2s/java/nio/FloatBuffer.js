(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.HeapFloatBuffer','java.nio.Buffer','StringBuffer']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
