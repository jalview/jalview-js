(function(){var P$=Clazz.newPackage("java.nio.channels.spi"),I$=[[0,'java.security.AccessController',['java.nio.channels.spi.AsynchronousChannelProvider','.ProviderHolder'],'sun.nio.ch.DefaultAsynchronousChannelProvider','java.util.ServiceConfigurationError','java.util.ServiceLoader','java.nio.channels.spi.AsynchronousChannelProvider','RuntimePermission']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
