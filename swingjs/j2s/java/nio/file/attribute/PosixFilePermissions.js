(function(){var P$=Clazz.newPackage("java.nio.file.attribute"),I$=[[0,'StringBuilder','java.nio.file.attribute.PosixFilePermission','java.util.EnumSet','java.util.HashSet','java.util.Collections']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
