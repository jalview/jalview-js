...
var options=$I$(9,"of$Enum$Enum",[$I$(10).CREATE_NEW, $I$(10).WRITE]);
...
return $I$(12,"createTempFile$java_nio_file_Path$S$S$java_nio_file_attribute_FileAttributeA",[$I$(13).requireNonNull$O(dir), prefix, suffix, attrs]);
}, 1);
...
return $I$(12,"createTempDirectory$java_nio_file_Path$S$java_nio_file_attribute_FileAttributeA",[$I$(13).requireNonNull$O(dir), prefix, attrs]);
}, 1);
...
if ($I$(13).requireNonNull$O(result) !== $I$(24).CONTINUE ) {
...
var reader=Clazz.new_([C$.newInputStream$java_nio_file_Path$java_nio_file_OpenOptionA(path, []), decoder],$I$(27,1).c$$java_io_InputStream$S);
...
var writer=Clazz.new_([C$.newOutputStream$java_nio_file_Path$java_nio_file_OpenOptionA(path, options), encoder],$I$(30,1).c$$java_io_OutputStream$java_nio_charset_CharsetEncoder);
...
(path).秘bytes=bytes=C$.read$java_io_InputStream$I($in, (size|0));
}
}finally{/*res*/
try{$in&&$in.close$&&$in.close$()}catch(_){}
...
$I$(13).requireNonNull$O(lines);
var encoder=cs.newEncoder$();
var out=C$.newOutputStream$java_nio_file_Path$java_nio_file_OpenOptionA(path, options);
try {
var writer=Clazz.new_([Clazz.new_($I$(30,1).c$$java_io_OutputStream$java_nio_charset_CharsetEncoder,[out, encoder])],$I$(31,1).c$$java_io_Writer);
/*try*/ {
