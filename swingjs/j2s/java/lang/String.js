...
var pa=other.value;
var po=ooffset;
if ((ooffset < 0) || (toffset < 0) || (toffset > this.value.length - len) || (ooffset > other.value.length - len)  ) {
return false;
}while (len-- > 0){
if (ta[to++] != pa[po++]) {
return false;
