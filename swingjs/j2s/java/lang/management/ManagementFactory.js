(function(){var P$=Clazz.newPackage("java.lang.management"),I$=[[0,'StringBuffer',['java.lang.management.ManagementFactory','.Usage'],'java.util.ArrayList',['java.lang.management.ManagementFactory','.Bean'],'sun.management.ManagementFactoryHelper']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
buf.append$S("init = " + this.init + "(" + (this.init >> 10) + "K) " );
buf.append$S("used = " + this.used + "(" + (this.used >> 10) + "K) " );
buf.append$S("committed = " + this.committed + "(" + (this.committed >> 10) + "K) " );
buf.append$S("max = " + this.max + "(" + (this.max >> 10) + "K)" );
return buf.toString();
});
})()
;
