(function(){var P$=java.lang,I$=[[0,'Shutdown','ApplicationShutdownHooks','java.util.IdentityHashMap']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
