...
return P$.reflect.AnnotatedElement.prototype.isAnnotationPresent$Class.apply(this, [annotationClass]);
});
...
try{jis&&jis.close$&&jis.close$()}catch(_){}
try{fis&&fis.close$&&fis.close$()}catch(_){}}
}, 1);
