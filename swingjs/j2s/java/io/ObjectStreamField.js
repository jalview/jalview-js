(function(){var P$=java.io,I$=[[0,'sun.reflect.Reflection','sun.reflect.misc.ReflectUtil','StringBuilder','Void','InternalError']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
