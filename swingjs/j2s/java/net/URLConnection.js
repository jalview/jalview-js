(function(){var P$=Clazz.newPackage("java.net"),p$1={},I$=[[0,'sun.net.www.MessageHeader','java.util.Collections','java.util.Hashtable','swingjs.JSUtil','sun.net.www.MimeTable','java.net.URLConnection','sun.security.util.SecurityConstants']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
