(function(){var P$=Clazz.newPackage("java.security"),I$=[[0,'java.util.Arrays','java.util.Collections','java.security.cert.X509Certificate','java.util.HashSet','StringBuilder','java.security.KeyStore','java.io.FileInputStream','javax.security.auth.callback.PasswordCallback','javax.security.auth.callback.Callback',['java.security.KeyStore','.PasswordProtection'],'java.security.AccessController',['java.security.KeyStore','.Builder','.FileBuilder'],['java.security.KeyStore','.SimpleLoadStoreParameter'],'sun.security.util.Debug','java.security.Security']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
), Clazz.new_(P$.KeyStore$Builder$2$1.$init$,[this, {type:this.$finals$.type,protection:this.$finals$.protection,provider:this.$finals$.provider}]));
},1);
...
), Clazz.new_(C$,[this, {type:type,protection:protection,context:context,provider:provider}],P$.KeyStore$Builder$2));
}, 1);
;
