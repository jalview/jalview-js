(function(){var P$=Clazz.newPackage("java.security.cert"),p$1={},I$=[[0,'java.util.Collections','java.util.HashMap','java.security.cert.Extension','sun.security.x509.InvalidityDateExtension','sun.security.x509.Extension','sun.security.util.ObjectIdentifier']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
