...
if (this.skew > 0) {
nowPlusSkew=Clazz.new_(java.util.Date.c$$J,[this.dateAndTime.getTime$() + this.skew]);
nowMinusSkew=Clazz.new_(java.util.Date.c$$J,[this.dateAndTime.getTime$() - this.skew]);
