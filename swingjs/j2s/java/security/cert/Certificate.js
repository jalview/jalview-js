(function(){var P$=Clazz.newPackage("java.security.cert"),I$=[[0,'java.security.cert.CertificateFactory','java.io.ByteArrayInputStream','sun.security.x509.X509CertImpl','java.util.Arrays',['java.security.cert.Certificate','.CertificateRep']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
