(function(){var P$=Clazz.newPackage("java.security"),p$1={},p$2={},I$=[[0,'java.security.BasicPermissionCollection','java.io.ObjectStreamField','java.util.Hashtable','java.util.HashMap','java.util.Collections']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
