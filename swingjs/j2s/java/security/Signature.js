(function(){var P$=Clazz.newPackage("java.security"),p$1={},I$=[[0,'javax.crypto.Cipher',['java.security.Signature','.CipherAdapter'],'java.security.Signature','AssertionError','java.io.ByteArrayOutputStream','java.util.Arrays','sun.security.util.Debug','sun.security.jca.ServiceId','java.util.concurrent.ConcurrentHashMap','sun.security.jca.GetInstance',['java.security.Signature','.Delegate'],'java.security.SignatureSpi','java.security.Security']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
