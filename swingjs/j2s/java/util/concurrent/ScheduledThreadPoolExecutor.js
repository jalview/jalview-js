...
), Clazz.new_(P$.ScheduledThreadPoolExecutor$lambda1.$init$,[this, {task:task,id:id}]))],$I$(7,1).c$$Runnable), Math.max(1, Long.$ival(task.getDelay$java_util_concurrent_TimeUnit($I$(2).MILLISECONDS))), 0])), task);
} else 
{}
}}, p$2);
