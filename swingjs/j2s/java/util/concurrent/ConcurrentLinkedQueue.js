(function(){var P$=Clazz.newPackage("java.util.concurrent"),p$1={},I$=[[0,'java.util.concurrent.atomic.AtomicReferenceFieldUpdater',['java.util.concurrent.ConcurrentLinkedQueue','.Node'],'java.util.ArrayList',['java.util.concurrent.ConcurrentLinkedQueue','.Itr']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var x=this.nextItem;
var p=(this.nextNode == null ) ? this.this$0.first$.apply(this.this$0, []) : this.nextNode.getNext$();
for (; ; ) {
if (p == null ) {
this.nextNode=null;
this.nextItem=null;
