(function(){var P$=Clazz.newPackage("java.util.concurrent"),I$=[[0,'java.util.concurrent.TimeUnit','AbstractMethodError','Thread']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
Clazz.newMeth(C$, 'toNanos$J', function (d) {
return $I$(1).x$J$J$J(d, 1000, 9223372036854775);
});
...
Clazz.newMeth(C$, 'toSeconds$J', function (d) {
return $I$(1).x$J$J$J(d, 60, 153722867280912930);
});
...
Clazz.newMeth(C$, 'toHours$J', function (d) {
return $I$(1).x$J$J$J(d, 24, 384307168202282325);
});
