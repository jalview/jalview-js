(function(){var P$=Clazz.newPackage("java.util.concurrent.atomic"),p$1={},p$2={},I$=[[0,'java.util.concurrent.atomic.LongAccumulator','java.util.concurrent.atomic.Striped64',['java.util.concurrent.atomic.LongAccumulator','.SerializationProxy']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var m;
var a;
if ((as=this.cells) != null  || (r=this.$function.applyAsLong$J$J(b=this.base, x)) != b && !this.casBase$J$J(b, r)  ) {
var uncontended=true;
if (as == null  || (m=as.length - 1) < 0  || (a=as[$I$(2).getProbe$() & m]) == null   || !(uncontended=(r=this.$function.applyAsLong$J$J(v=a.value, x)) == v || a.cas$J$J(v, r) ) ) this.longAccumulate$J$java_util_function_LongBinaryOperator$Z(x, this.$function, uncontended);
}});
