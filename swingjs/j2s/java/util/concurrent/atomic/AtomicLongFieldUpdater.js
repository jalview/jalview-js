...
Clazz.newMeth(C$, 'incrementAndGet$O', function (obj) {
return this.getAndAdd$O$J(obj, 1) + 1;
});
...
Clazz.newMeth(C$, 'addAndGet$O$J', function (obj, delta) {
return this.getAndAdd$O$J(obj, delta) + delta;
});
