(function(){var P$=Clazz.newPackage("java.util.concurrent.atomic"),p$1={},p$2={},I$=[[0,'java.util.concurrent.atomic.LongAdder','java.util.concurrent.atomic.Striped64',['java.util.concurrent.atomic.LongAdder','.SerializationProxy']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (as == null  || (m=as.length - 1) < 0  || (a=as[$I$(2).getProbe$() & m]) == null   || !(uncontended=a.cas$J$J(v=a.value, v + x)) ) this.longAccumulate$J$java_util_function_LongBinaryOperator$Z(x, null, uncontended);
}});
