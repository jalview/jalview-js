...
/*lambda_E*/
Clazz.newMeth(C$, ['applyAsLong$J','applyAsLong$O'], function (v) { return (this.applyAsLong$J(before.applyAsLong$J(v)));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['applyAsLong$J','applyAsLong$O'], function (t) { return (after.applyAsLong$J(this.applyAsLong$J(t)));});
})()
