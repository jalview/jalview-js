...
/*lambda_E*/
Clazz.newMeth(C$, ['applyAsDouble$D','applyAsDouble$O'], function (v) { return (this.applyAsDouble$D(before.applyAsDouble$D(v)));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['applyAsDouble$D','applyAsDouble$O'], function (t) { return (after.applyAsDouble$D(this.applyAsDouble$D(t)));});
})()
