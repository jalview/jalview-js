...
/*lambda_E*/
Clazz.newMeth(C$, ['applyAsInt$I','applyAsInt$O'], function (v) { return (this.applyAsInt$I(before.applyAsInt$I(v)));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['applyAsInt$I','applyAsInt$O'], function (t) { return (after.applyAsInt$I(this.applyAsInt$I(t)));});
})()
