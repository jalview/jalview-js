...
switch ($I$(2).秘hasKey$java_util_Map$O(this.this$0, key)) {
case 3:
...
for (var e=this.this$0.head; e != null ; e=e.after) action.accept$O(e.key);
...
if (action == null ) throw Clazz.new_(Clazz.load('NullPointerException'));
var mc=this.this$0.modCount;
for (var e=this.this$0.head; e != null ; e=e.after) action.accept$O(e.value);
...
if (action == null ) throw Clazz.new_(Clazz.load('NullPointerException'));
var mc=this.this$0.modCount;
for (var e=this.this$0.head; e != null ; e=e.after) action.accept$O(e);
