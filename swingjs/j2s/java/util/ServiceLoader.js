(function(){var P$=java.util,p$1={},I$=[[0,'java.util.ServiceLoader','Error','java.security.AccessController','java.util.LinkedHashMap',['java.util.ServiceLoader','.LazyIterator'],'java.util.Objects','java.util.ServiceConfigurationError','Thread']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.this$0.providers.put$O$O(cn, p);
return p;
} catch (x) {
...
return ($I$(3).doPrivileged$java_security_PrivilegedAction$java_security_AccessControlContext(action, this.this$0.acc)).valueOf();
}});
...
return $I$(3).doPrivileged$java_security_PrivilegedAction$java_security_AccessControlContext(action, this.this$0.acc);
}});
