...
/*lambda_E*/
Clazz.newMeth(C$, ['applyAsLong$Long','applyAsLong$O'], function (i) { return (((i).valueOf()|0));});
})()
...
/*lambda_M*/
Clazz.newMeth(C$, ['applyAsLong$J$J','applyAsLong$O$O'], function (t,u) { return $$.min.apply(null,[t,u])});
})()
...
/*lambda_M*/
Clazz.newMeth(C$, ['applyAsLong$J$J','applyAsLong$O$O'], function (t,u) { return $$.max.apply(null,[t,u])});
})()
...
), Clazz.new_(P$.LongPipeline$lambda9.$init$,[this, null]))))), (P$.LongPipeline$lambda10$||(P$.LongPipeline$lambda10$=(((P$.LongPipeline$lambda10||
...
return avg[0] > 0 ? $I$(17).of$D(avg[1] / avg[0]) : $I$(17).empty$();
});
...
), Clazz.new_(P$.LongPipeline$lambda12.$init$,[this, null])), (function($$){((
...
)); return Clazz.new_(P$.LongPipeline$lambda13.$init$,[this, null])})($I$(18)), (function($$){((
...
)); return Clazz.new_(P$.LongPipeline$lambda14.$init$,[this, null])})($I$(18)));
});
...
return $I$(3,"flattenLong$java_util_stream_Node_OfLong",[this.evaluateToArrayNode$java_util_function_IntFunction(((P$.LongPipeline$lambda16||
