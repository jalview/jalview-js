...
return Clazz.new_($I$(3,1),[this, {combiner:this.$finals$.combiner,reducer:this.$finals$.reducer,seed:this.$finals$.seed}],P$.ReduceOps$1ReducingSink);
});
})()
), Clazz.new_([this, {combiner:combiner,reducer:reducer,seed:seed}, $I$(5).REFERENCE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$1));
}, 1);
...
Clazz.newMeth(C$, 'makeSink$',  function () {
return Clazz.new_($I$(3,1),[this, {accumulator:this.$finals$.accumulator,reducer:this.$finals$.reducer,seedFactory:this.$finals$.seedFactory}],P$.ReduceOps$4ReducingSink);
});
})()
), Clazz.new_([this, {accumulator:accumulator,reducer:reducer,seedFactory:seedFactory}, $I$(5).REFERENCE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$4));
}, 1);
...
Clazz.newMeth(C$, 'makeSink$',  function () {
return Clazz.new_($I$(3,1),[this, {supplier:this.$finals$.supplier,combiner:this.$finals$.combiner,accumulator:this.$finals$.accumulator}],P$.ReduceOps$10ReducingSink);
});
})()
), Clazz.new_([this, {supplier:supplier,combiner:combiner,accumulator:accumulator}, $I$(5).LONG_VALUE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$10));
}, 1);
...
;Clazz.setTVer('3.3.1-v1');//Created 2021-07-22 00:09:22 Java2ScriptVisitor version 3.3.1-v1 net.sf.j2s.core.jar version 3.3.1-v1
