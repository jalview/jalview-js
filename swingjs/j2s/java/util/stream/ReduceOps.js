...
return Clazz.new_($I$(3,1),[this, {reducer:this.$finals$.reducer,seed:this.$finals$.seed,combiner:this.$finals$.combiner}],P$.ReduceOps$1ReducingSink);
});
})()
), Clazz.new_([this, {reducer:reducer,seed:seed,combiner:combiner}, $I$(5).REFERENCE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$1));
}, 1);
...
), Clazz.new_([this, {collector:collector,supplier:supplier,accumulator:accumulator,combiner:combiner}, $I$(5).REFERENCE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$3));
}, 1);
