...
C$.c$$java_util_Spliterator_OfPrimitive$J$J$J$J.apply(this, [s, sliceOrigin, sliceFence, 0, Math.min(s.estimateSize$(), sliceFence)]);
}, 1);
...
this.permits=Clazz.new_([limit >= 0 ? skip + limit : skip],$I$(12,1).c$$J);
}, 1);
...
var permitsRequested=0;
do {
} while (this.s.tryAdvance$O(sbc) && ++permitsRequested < 128 );
if (permitsRequested == 0) return;
