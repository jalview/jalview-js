(function(){var P$=Clazz.newPackage("java.util.stream"),I$=[[0,'java.util.stream.Nodes','java.util.stream.StreamShape']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var boxed=generator.apply$I((this.count$()|0));
