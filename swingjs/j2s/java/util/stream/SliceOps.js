...
), Clazz.new_($I$(14,1).c$$java_util_stream_Sink,[this, {limit:this.$finals$.limit,skip:this.$finals$.skip}, sink],P$.SliceOps$2$1));
});
})()
), Clazz.new_([this, {limit:limit,skip:skip}, upstream, $I$(3).INT_VALUE, C$.flags$J(limit)],$I$(15,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.SliceOps$2));
}, 1);
...
return Clazz.new_([this, helper, spliterator, ((P$.SliceOps$3$lambda3||
...
), Clazz.new_(P$.SliceOps$3$lambda3.$init$,[this, null])), this.$finals$.skip, this.$finals$.limit],$I$(10,1).c$$java_util_stream_AbstractPipeline$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_function_IntFunction$J$J).invoke$().spliterator$();
}});
...
return Clazz.new_([this, helper, spliterator, ((P$.SliceOps$4$lambda4||
...
), Clazz.new_(P$.SliceOps$4$lambda4.$init$,[this, null])), this.$finals$.skip, this.$finals$.limit],$I$(10,1).c$$java_util_stream_AbstractPipeline$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_function_IntFunction$J$J).invoke$().spliterator$();
}});
