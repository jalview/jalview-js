...
), Clazz.new_($I$(17,1).c$$java_util_stream_Sink,[this, {limit:this.$finals$.limit,skip:this.$finals$.skip}, sink],P$.SliceOps$3$1));
});
})()
), Clazz.new_([this, {limit:limit,skip:skip}, upstream, $I$(3).LONG_VALUE, C$.flags$J(limit)],$I$(18,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.SliceOps$3));
}, 1);
...
;Clazz.setTVer('3.3.1-v1');//Created 2021-07-22 00:09:23 Java2ScriptVisitor version 3.3.1-v1 net.sf.j2s.core.jar version 3.3.1-v1
