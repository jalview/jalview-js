...
return new Boolean(helper.wrapAndCopyInto$java_util_stream_Sink$java_util_Spliterator(this.sinkSupplier.get$(), spliterator).getAndClearState$());
});
...
if (b == this.op.matchKind.shortCircuitResult ) this.shortCircuit$O(new Boolean(b));
return null;
});
