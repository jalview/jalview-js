...
), Clazz.new_(P$.IntPipeline$lambda10.$init$,[this, null]))))), (P$.IntPipeline$lambda11$||(P$.IntPipeline$lambda11$=(((P$.IntPipeline$lambda11||
...
), Clazz.new_(P$.IntPipeline$lambda12.$init$,[this, null])), (function($$){((
...
)); return Clazz.new_(P$.IntPipeline$lambda13.$init$,[this, null])})($I$(18)), (function($$){((
...
)); return Clazz.new_(P$.IntPipeline$lambda14.$init$,[this, null])})($I$(18)));
});

Clazz.newMeth(C$, 'reduce$I$java_util_function_IntBinaryOperator', function (identity, op) {
return (this.evaluate$java_util_stream_TerminalOp($I$(19).makeInt$I$java_util_function_IntBinaryOperator(identity, op))).valueOf();
});
...
return $I$(3,"flattenInt$java_util_stream_Node_OfInt",[this.evaluateToArrayNode$java_util_function_IntFunction(((P$.IntPipeline$lambda16||
