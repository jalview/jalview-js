...
), Clazz.new_($I$(9,1).c$$java_util_stream_Sink,[this, {mapper:this.$finals$.mapper}, sink],P$.ReferencePipeline$8$1));
});
})()
), Clazz.new_([this, {mapper:mapper}, this, $I$(1).REFERENCE, $I$(7).NOT_SORTED | $I$(7).NOT_DISTINCT | $I$(7).NOT_SIZED ],$I$(10,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.ReferencePipeline$8));
});
...
), Clazz.new_($I$(9,1).c$$java_util_stream_Sink,[this, {mapper:this.$finals$.mapper}, sink],P$.ReferencePipeline$9$1));
});
})()
), Clazz.new_([this, {mapper:mapper}, this, $I$(1).REFERENCE, $I$(7).NOT_SORTED | $I$(7).NOT_DISTINCT | $I$(7).NOT_SIZED ],$I$(12,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.ReferencePipeline$9));
});
...
), Clazz.new_($I$(9,1).c$$java_util_stream_Sink,[this, {mapper:this.$finals$.mapper}, sink],P$.ReferencePipeline$10$1));
});
})()
), Clazz.new_([this, {mapper:mapper}, this, $I$(1).REFERENCE, $I$(7).NOT_SORTED | $I$(7).NOT_DISTINCT | $I$(7).NOT_SIZED ],$I$(11,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.ReferencePipeline$10));
});
...
), Clazz.new_(P$.ReferencePipeline$lambda5.$init$,[this, {container:container,accumulator:accumulator}])));
} else {
