...
), Clazz.new_(P$.DoublePipeline$lambda6.$init$,[this, null]))))), (P$.DoublePipeline$lambda7$||(P$.DoublePipeline$lambda7$=(((P$.DoublePipeline$lambda7||
...
), Clazz.new_(P$.DoublePipeline$lambda11.$init$,[this, null]))))), (P$.DoublePipeline$lambda12$||(P$.DoublePipeline$lambda12$=(((P$.DoublePipeline$lambda12||
...
), Clazz.new_(P$.DoublePipeline$lambda14.$init$,[this, null])), (function($$){((
...
)); return Clazz.new_(P$.DoublePipeline$lambda15.$init$,[this, null])})($I$(19)), (function($$){((
...
)); return Clazz.new_(P$.DoublePipeline$lambda16.$init$,[this, null])})($I$(19)));
});
...
return $I$(3,"flattenDouble$java_util_stream_Node_OfDouble",[this.evaluateToArrayNode$java_util_function_IntFunction(((P$.DoublePipeline$lambda18||
