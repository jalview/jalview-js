(function(){var P$=Clazz.newPackage("java.util.stream"),I$=[[0,'java.util.stream.StreamShape','java.util.stream.StreamOpFlag',['java.util.stream.ForEachOps','.ForEachOrderedTask'],['java.util.stream.ForEachOps','.ForEachTask'],'java.util.stream.AbstractTask','java.util.concurrent.ConcurrentHashMap','java.util.Objects',['java.util.stream.ForEachOps','.ForEachOp','.OfRef'],['java.util.stream.ForEachOps','.ForEachOp','.OfInt'],['java.util.stream.ForEachOps','.ForEachOp','.OfLong'],['java.util.stream.ForEachOps','.ForEachOp','.OfDouble']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
