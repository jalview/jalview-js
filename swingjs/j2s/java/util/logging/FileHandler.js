(function(){var P$=Clazz.newPackage("java.util.logging"),p$1={},I$=[[0,'java.util.HashSet','java.io.FileOutputStream','java.io.BufferedOutputStream',['java.util.logging.FileHandler','.MeteredStream'],'java.util.logging.LogManager','java.util.logging.Level','java.util.logging.XMLFormatter','java.nio.file.Files',['java.util.logging.FileHandler','.InitializationErrorManager'],'java.nio.file.Paths','java.nio.channels.FileChannel','java.nio.file.StandardOpenOption','java.nio.file.LinkOption','java.io.File','java.util.logging.ErrorManager','java.security.AccessController']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
file=Clazz.new_([System.getProperty$S("user.home")],$I$(14,1).c$$S);
if (C$.isSetUID$()) {
