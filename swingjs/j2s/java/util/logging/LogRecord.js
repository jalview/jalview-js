(function(){var P$=Clazz.newPackage("java.util.logging"),p$1={},I$=[[0,'java.util.concurrent.atomic.AtomicLong','java.util.concurrent.atomic.AtomicInteger','ThreadLocal','Thread','java.util.ResourceBundle','java.util.Locale']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['needToInferCaller'],'I',['threadID'],'J',['sequenceNumber','millis'],'S',['sourceClassName','sourceMethodName','message','loggerName','resourceBundleName'],'O',['level','java.util.logging.Level','thrown','Throwable','parameters','Object[]','resourceBundle','java.util.ResourceBundle']]
