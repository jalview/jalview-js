(function(){var P$=Clazz.newPackage("java.util.logging"),I$=[[0,'sun.util.logging.LoggingSupport','java.io.StringWriter','java.io.PrintWriter']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
