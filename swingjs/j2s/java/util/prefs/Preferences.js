(function(){var P$=Clazz.newPackage("java.util.prefs"),I$=[[0,'RuntimePermission','java.security.AccessController','java.security.AllPermission','Thread','InternalError','java.util.prefs.Preferences','java.util.prefs.XmlSupport']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
