(function(){var P$=Clazz.newPackage("java.util.jar"),I$=[[0,'java.security.AccessController','sun.security.action.GetPropertyAction','com.sun.java.util.jar.pack.PackerImpl','com.sun.java.util.jar.pack.UnpackerImpl','Error']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
