(function(){var P$=Clazz.newPackage("java.awt"),I$=[[0,'java.awt.image.DirectColorModel','java.lang.ref.WeakReference',['java.awt.geom.Point2D','.Double'],'java.awt.image.ColorModel']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
