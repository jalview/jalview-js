...
switch (dataType) {
case 0:
r=Clazz.new_($I$(7,1).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
break;
case 1:
r=Clazz.new_($I$(8,1).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
break;
}
} else if (Clazz.instanceOf(sm, "java.awt.image.SinglePixelPackedSampleModel")) {
switch (dataType) {
...
break;
case 3:
r=Clazz.new_($I$(14,1).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
r.秘pix=$I$(12).stealData$java_awt_image_DataBufferInt$I(db, 0);
break;
}
} else if (Clazz.instanceOf(sm, "java.awt.image.MultiPixelPackedSampleModel") && dataType == 0  && sm.getSampleSize$I(0) < 8 ) {
r=Clazz.new_($I$(16,1).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
}if (r == null ) {
r=Clazz.new_($I$(12,1).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
}return r;
}, 1);
