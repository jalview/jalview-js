(function(){var P$=Clazz.newPackage("java.awt.image"),p$1={},I$=[[0,'java.awt.image.ColorModel','java.awt.image.DataBufferByte','java.awt.image.Raster','java.awt.image.BufferedImage','InternalError','java.awt.image.DataBufferInt']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
