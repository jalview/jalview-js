(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[[0,'java.awt.image.ColorModel','java.awt.image.IndexColorModel']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
