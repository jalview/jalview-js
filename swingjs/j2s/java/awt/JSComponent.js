...
C$.$fields$=[['Z',['秘isRootPane','秘isContentPane','秘iPaintMyselfEntirely','秘repaintAsUpdate','秘isDesktop'],'I',['秘num','秘iPaintMyself'],'S',['秘htmlName','秘uiClassID'],'O',['秘keyAction','javax.swing.Action','秘tempInsets','java.awt.Insets','秘gtemp','swingjs.JSGraphics2D','秘appletViewer','swingjs.JSAppletViewer','秘frameViewer','swingjs.JSFrameViewer','+秘topFrameViewer','秘canvas','swingjs.api.js.HTML5Canvas','ui','javax.swing.plaf.ComponentUI','秘peerVis','Boolean','秘border','javax.swing.border.AbstractBorder','秘paintClass','Class','+秘updateClass']]
...
this.秘iPaintMyself=this.秘setPaintsSelf$I((this.秘iPaintMyselfEntirely=($I$(9).isOverridden$O$S$Class(this, "paint$java_awt_Graphics", this.秘paintClass) || $I$(9).isOverridden$O$S$Class(this, "paintComponent$java_awt_Graphics", javax.swing.JComponent ||null) || $I$(9).isOverridden$O$S$Class(this, "update$java_awt_Graphics", this.秘updateClass) || $I$(9).isOverridden$O$S$Class(this, "paintContainer$java_awt_Graphics", java.awt.Container ||null)  )) || this.秘paintsBorder$() && $I$(9).isOverridden$O$S$Class(this.秘border, "paintBorder$java_awt_Component$java_awt_Graphics$I$I$I$I", this.秘border.秘paintClass)   ? 1 : -1);
...
jc.getRootPane$().setContentPane$java_awt_Container(Clazz.new_($I$(10,1)));
