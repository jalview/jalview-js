...
C$.PRIMARY_MASK=$I$(3,"getMask$sun_font_EAttributeA",[[$I$(4).EFAMILY, $I$(4).EWEIGHT, $I$(4).EWIDTH, $I$(4).EPOSTURE, $I$(4).ESIZE, $I$(4).ETRANSFORM, $I$(4).ESUPERSCRIPT, $I$(4).ETRACKING]]);
C$.SECONDARY_MASK=C$.RECOGNIZED_MASK & ~C$.PRIMARY_MASK;
C$.LAYOUT_MASK=$I$(3,"getMask$sun_font_EAttributeA",[[$I$(4).ECHAR_REPLACEMENT, $I$(4).EFOREGROUND, $I$(4).EBACKGROUND, $I$(4).EUNDERLINE, $I$(4).ESTRIKETHROUGH, $I$(4).ERUN_DIRECTION, $I$(4).EBIDI_EMBEDDING, $I$(4).EJUSTIFICATION, $I$(4).EINPUT_METHOD_HIGHLIGHT, $I$(4).EINPUT_METHOD_UNDERLINE, $I$(4).ESWAP_COLORS, $I$(4).ENUMERIC_SHAPING, $I$(4).EKERNING, $I$(4).ELIGATURES, $I$(4).ETRACKING]]);
C$.EXTRA_MASK=$I$(3,"getMask$sun_font_EAttributeA",[[$I$(4).ETRANSFORM, $I$(4).ESUPERSCRIPT, $I$(4).EWIDTH]]);
C$.haveMasks=true;
}, 1);
