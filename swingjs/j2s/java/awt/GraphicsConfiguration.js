(function(){var P$=Clazz.newPackage("java.awt"),I$=[[0,'java.awt.image.BufferedImage','swingjs.api.Interface']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return Clazz.new_($I$(1,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[cm, wr, alphaPremultiplied, properties]);
});
