...
return;
}me=Clazz.new_([this.nativeContainer, 1500, srcEvent.getWhen$(), srcEvent.getModifiersEx$() | srcEvent.getModifiers$(), srcEvent.getX$(), srcEvent.getY$(), srcEvent.getXOnScreen$(), srcEvent.getYOnScreen$(), srcEvent.getClickCount$(), srcEvent.isPopupTrigger$(), srcEvent.getButton$()],$I$(16,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I);
...
if (component != null ) {
if (id == 507) {
retargeted=Clazz.new_([target, id, e.getWhen$(), e.getModifiersEx$() | e.getModifiers$(), x, y, e.getXOnScreen$(), e.getYOnScreen$(), e.getClickCount$(), e.isPopupTrigger$(), (e).getScrollType$(), (e).getScrollAmount$(), (e).getWheelRotation$(), (e).getPreciseWheelRotation$()],$I$(17,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I$I$I$D);
} else {
retargeted=Clazz.new_([target, id, e.getWhen$(), e.getModifiersEx$() | e.getModifiers$(), x, y, e.getXOnScreen$(), e.getYOnScreen$(), e.getClickCount$(), e.isPopupTrigger$(), e.getButton$()],$I$(16,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I);
