(function(){var P$=Clazz.newPackage("java.awt"),I$=[[0,'java.util.LinkedList','sun.awt.AppContext','java.awt.EventQueue','Thread','swingjs.JSUtil','java.awt.Toolkit','sun.awt.SunToolkit','java.awt.SentEvent']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
;Clazz.setTVer('3.2.9-v1');//Created 2020-04-08 07:27:14 Java2ScriptVisitor version 3.2.9-v1 net.sf.j2s.core.jar version 3.2.9-v1
