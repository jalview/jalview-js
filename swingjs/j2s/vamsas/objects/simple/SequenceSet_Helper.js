...
/*c*/var C$=Clazz.newClass(P$, "SequenceSet_Helper");
...
{
C$.typeDesc.setXmlType$javax_xml_namespace_QName(Clazz.new_($I$(3,1).c$$S$S,["simple.objects.vamsas", "SequenceSet"]));
...
elemField.setXmlType$javax_xml_namespace_QName(Clazz.new_($I$(3,1).c$$S$S,["simple.objects.vamsas", "Sequence"]));
