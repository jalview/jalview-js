...
/*c*/var C$=Clazz.newClass(P$, "MsaResult_Helper");
...
{
C$.typeDesc.setXmlType$javax_xml_namespace_QName(Clazz.new_($I$(3,1).c$$S$S,["simple.objects.vamsas", "MsaResult"]));
var elemField=Clazz.new_($I$(4,1));
elemField.setFieldName$S("msa");
elemField.setXmlName$javax_xml_namespace_QName(Clazz.new_($I$(3,1).c$$S$S,["", "msa"]));
