...
/*c*/var C$=Clazz.newClass(P$, "WsJobId_Helper");
...
{
C$.typeDesc.setXmlType$javax_xml_namespace_QName(Clazz.new_($I$(3,1).c$$S$S,["simple.objects.vamsas", "WsJobId"]));
var elemField=Clazz.new_($I$(4,1));
elemField.setFieldName$S("jobId");
elemField.setXmlName$javax_xml_namespace_QName(Clazz.new_($I$(3,1).c$$S$S,["", "jobId"]));
