...
var _hashCode=1;
_hashCode+=(this.isBroken$() ? Boolean.TRUE : Boolean.FALSE).hashCode$();
_hashCode+=(this.isFailed$() ? Boolean.TRUE : Boolean.FALSE).hashCode$();
_hashCode+=(this.isFinished$() ? Boolean.TRUE : Boolean.FALSE).hashCode$();
_hashCode+=(this.isInvalid$() ? Boolean.TRUE : Boolean.FALSE).hashCode$();
_hashCode+=(this.isJobFailed$() ? Boolean.TRUE : Boolean.FALSE).hashCode$();
_hashCode+=(this.isQueued$() ? Boolean.TRUE : Boolean.FALSE).hashCode$();
_hashCode+=(this.isRunning$() ? Boolean.TRUE : Boolean.FALSE).hashCode$();
_hashCode+=(this.isServerError$() ? Boolean.TRUE : Boolean.FALSE).hashCode$();
_hashCode+=this.getState$();
if (this.getStatus$() != null ) {
_hashCode+=this.getStatus$().hashCode$();
}_hashCode+=(this.isSuspended$() ? Boolean.TRUE : Boolean.FALSE).hashCode$();
this.__hashCodeCalc=false;
return _hashCode;
});
})();
