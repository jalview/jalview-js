...
/*c*/var C$=Clazz.newClass(P$, "Msfalignment_Helper");
...
{
C$.typeDesc.setXmlType$javax_xml_namespace_QName(Clazz.new_($I$(3,1).c$$S$S,["http://simple.objects.vamsas", "Msfalignment"]));
var elemField=Clazz.new_($I$(4,1));
elemField.setFieldName$S("msf");
elemField.setXmlName$javax_xml_namespace_QName(Clazz.new_($I$(3,1).c$$S$S,["", "msf"]));
...
elemField.setXmlName$javax_xml_namespace_QName(Clazz.new_($I$(3,1).c$$S$S,["", "notes"]));
elemField.setXmlType$javax_xml_namespace_QName(Clazz.new_($I$(3,1).c$$S$S,["http://schemas.xmlsoap.org/soap/encoding/", "string"]));
C$.typeDesc.addFieldDesc$org_apache_axis_description_FieldDesc(elemField);
};
};
