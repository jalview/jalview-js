(function(){var P$=Clazz.newPackage("sun.text.bidi"),I$=[[0,'sun.text.bidi.BidiBase','sun.text.bidi.BidiRun','java.util.Arrays']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
