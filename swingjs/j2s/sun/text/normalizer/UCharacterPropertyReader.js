(function(){var P$=Clazz.newPackage("sun.text.normalizer"),I$=[[0,'sun.text.normalizer.ICUBinary','java.io.DataInputStream','sun.text.normalizer.CharTrie','sun.text.normalizer.VersionInfo']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
ucharppty.m_unicodeVersion_=$I$(4).getInstance$I$I$I$I(this.m_unicodeVersion_[0], this.m_unicodeVersion_[1], this.m_unicodeVersion_[2], this.m_unicodeVersion_[3]);
});
