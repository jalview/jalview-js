(function(){var P$=Clazz.newPackage("sun.text.normalizer"),p$1={},I$=[[0,'java.io.DataInputStream',['sun.text.normalizer.Trie','.DefaultGetFoldingOffset'],'sun.text.normalizer.UTF16']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
