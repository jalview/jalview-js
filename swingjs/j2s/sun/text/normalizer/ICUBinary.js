(function(){var P$=Clazz.newPackage("sun.text.normalizer"),I$=[[0,'java.io.DataInputStream','java.util.Arrays']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
