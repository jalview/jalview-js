...
if ((norm32 & qcMask & 8 ) != 0 && args.length >= 256 ) {
...
if ((C$.getNorm32$CA$I$I(C$.extraData, p, qcMask) & qcMask) == 0) {
return true;
}}}return false;
}, 1);
...
return result;
} else if (((c=src[srcStart++]).$c()) >= minNoMaybe  && ((norm32=C$.getNorm32$C(c)) & ccOrQCMask) != 0 ) {
break;
}prevCC=String.fromCharCode(0);
}
if (C$.isNorm32LeadSurrogate$J(norm32)) {
...
norm32=0;
}cc=String.fromCharCode(((norm32 >> 8) & 255));
if (cc.$c() != 0  && cc < prevCC ) {
return $I$(17).NO;
}prevCC=cc;
...
for (; ; ) {
prevSrc=srcIndex;
while (srcIndex != srcLimit && ((c=src[srcIndex]) < minNoMaybe || ((norm32=C$.getNorm32$C(c)) & ccOrQCMask) == 0 ) ){
prevCC=0;
++srcIndex;
}
if (srcIndex != prevSrc) {
...
args.combiningIndex=(((4294967295) & (65520 | (norm32 >> 16)))|0);
return ((norm32 & 192)|0);
} else {
...
return 0;
}args.cc=String.fromCharCode(((norm32 >> 8) & 255));
combineFlags=((norm32 & 192)|0);
if (combineFlags != 0) {
...
key=(((4294967295) & ((value & 8192) + 1))|0);
if ((value & 32768) != 0) {
if ((value & 16384) != 0) {
value=(((4294967295) & ((value & 1023) | 55296))|0);
...
if (decompArgs.cc == 0 && (C$.getNorm32$CA$I$I(C$.extraData, p, qcMask) & qcMask) == 0 ) {
break;
}}start+=c2.$c() == 0  ? 1 : 2;
}
return start;
...
if (C$.isNorm32Regular$J(norm32) && ((norm32 & 8) != 0) ) {
var p;
...
var norm32=(C$.getNorm32$I(c)|0) & qcMask[modeValue];
if (norm32 == 0) {
return 1;
} else if ((norm32 & 15) != 0) {
return 0;
...
for (; ; ) {
prevSrc=srcIndex;
while (srcIndex != srcLimit && ((c=src[srcIndex]) < minNoMaybe || ((norm32=C$.getNorm32$C(c)) & ccOrQCMask) == 0  || (c >= "\uac00" && c <= "\ud7a3" ) ) ){
prevCC=0;
++srcIndex;
}
if (srcIndex != prevSrc) {
