(function(){var P$=Clazz.newPackage("sun.text.normalizer"),p$1={},I$=[[0,'sun.text.normalizer.NormalizerImpl','sun.text.normalizer.NormalizerBase',['sun.text.normalizer.NormalizerBase','.IsPrevNFDSafe'],['sun.text.normalizer.NormalizerBase','.IsNextNFDSafe'],['sun.text.normalizer.NormalizerBase','.IsPrevTrueStarter'],['sun.text.normalizer.NormalizerBase','.IsNextTrueStarter'],['sun.text.normalizer.NormalizerBase','.Mode'],['sun.text.normalizer.NormalizerBase','.NFDMode'],['sun.text.normalizer.NormalizerBase','.NFKDMode'],['sun.text.normalizer.NormalizerBase','.NFCMode'],['sun.text.normalizer.NormalizerBase','.NFKCMode'],['sun.text.normalizer.NormalizerBase','.QuickCheckResult'],'sun.text.normalizer.UCharacterIterator','InternalError','sun.text.normalizer.UTF16','sun.text.normalizer.Utility','sun.text.normalizer.UCharacterProperty',['java.text.Normalizer','.Form']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
