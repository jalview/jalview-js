(function(){var P$=Clazz.newPackage("sun.text.normalizer"),I$=[[0,['sun.text.normalizer.CharTrie','.FriendAgent'],'java.io.DataInputStream']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return this.this$0.m_data_;
});

Clazz.newMeth(C$, 'getPrivateInitialValue$', function () {
return this.this$0.m_initialValue_.$c();
});
