(function(){var P$=Clazz.newPackage("sun.text"),I$=[[0,['sun.text.normalizer.NormalizerBase','.Mode'],'sun.text.normalizer.NormalizerBase']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
