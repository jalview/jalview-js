(function(){var P$=Clazz.newPackage("sun.misc"),p$1={},I$=[[0,'java.util.Vector',['java.util.jar.Attributes','.Name'],'java.util.StringTokenizer','sun.misc.ExtensionInfo','java.security.AccessController','java.util.jar.JarFile','sun.misc.Launcher','sun.misc.ExtensionDependency','java.io.File','sun.security.action.GetPropertyAction','sun.misc.JarFilter','sun.net.www.ParseUtil']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var s=$I$(5,"doPrivileged$java_security_PrivilegedAction",[Clazz.new_($I$(10,1).c$$S,["java.ext.dirs"])]);
var dirs;
if (s != null ) {
...
for (var i=0; i < dirs.length; i++) {
var files=dirs[i].list$java_io_FilenameFilter(Clazz.new_($I$(11,1)));
if (files != null ) {
...
Clazz.newMeth(C$, 'run$', function () {
try {
return $I$(12).fileToEncodedURL$java_io_File(this.$finals$.instFile);
} catch (e) {
