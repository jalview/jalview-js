(function(){var P$=Clazz.newPackage("sun.misc"),p$1={},p$2={},I$=[[0,['sun.misc.SoftCache','.ValueCell'],'sun.misc.SoftCache',['sun.misc.SoftCache','.Entry'],'java.util.HashMap',['sun.misc.SoftCache','.EntrySet']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
