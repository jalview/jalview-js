...
if (C$.loggingEnabled$()) {
C$.times.set$I$O(0, Clazz.new_($I$(8,1).c$$S$J,[message, time]));
}}, 1);
...
if (C$.loggingEnabled$()) {
{
C$.times.add$O(Clazz.new_($I$(8,1).c$$S$J,[message, time]));
...
try {
var logFile=Clazz.new_([$I$(4).logFileName],$I$(3,1).c$$S);
...
}}C$.times=Clazz.new_($I$(7,1).c$$I,[10]);
for (var i=0; i <= 0; ++i) {
C$.times.add$O(Clazz.new_($I$(8,1).c$$S$J,["Time " + i + " not set" , 0]));
}
};
};
;
