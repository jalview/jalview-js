...
this.fields.add$O(Clazz.new_($I$(21,1).c$$S$S$I,[this, null, pm.methodFieldName, "Ljava/lang/reflect/Method;", 10]));
...
}sigmethods.add$O(Clazz.new_($I$(22,1).c$$S$ClassA$Class$ClassA$Class,[this, null, name, parameterTypes, returnType, exceptionTypes, fromClass]));
}, p$1);

Clazz.newMeth(C$, 'checkReturnTypes$java_util_List', function (methods) {
if (methods.size$() < 2) {
return;
}var uncoveredReturnTypes=Clazz.new_($I$(23,1));
...
uniqueList.add$O(Clazz.getClass($I$(25)));
...
p$1.code_aload$I$java_io_DataOutputStream.apply(this.this$0, [0, out]);
out.writeByte$I(178);
out.writeShort$I(this.this$0.cp.getFieldRef$S$S$S($I$(3).dotToSlash$S(this.this$0.className), this.methodFieldName, "Ljava/lang/reflect/Method;"));
...
minfo.exceptionTable.add$O(Clazz.new_([tryBegin, tryEnd, pc, this.this$0.cp.getClass$S($I$(3,"dotToSlash$S",[ex.getName$()]))],$I$(6,1).c$$H$H$H$H));
}
out.writeByte$I(191);
pc=($s$[0] = minfo.code.size$(), $s$[0]);
minfo.exceptionTable.add$O(Clazz.new_([tryBegin, tryEnd, pc, this.this$0.cp.getClass$S("java/lang/Throwable")],$I$(6,1).c$$H$H$H$H));
...
minfo.declaredExceptions[i]=this.this$0.cp.getClass$S($I$(3,"dotToSlash$S",[this.exceptionTypes[i].getName$()]));
}
return minfo;
}, p$2);
...
out.writeByte$I(192);
out.writeShort$I(this.this$0.cp.getClass$S($I$(3,"dotToSlash$S",[type.getName$()])));
out.writeByte$I(176);
}}, p$2);
