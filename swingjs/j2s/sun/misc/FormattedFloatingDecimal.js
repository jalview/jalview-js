(function(){var P$=Clazz.newPackage("sun.misc"),p$1={},I$=[[0,'ThreadLocal','sun.misc.FloatingDecimal',['sun.misc.FormattedFloatingDecimal','.Form'],'java.util.Arrays']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
