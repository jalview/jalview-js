(function(){var P$=Clazz.newPackage("sun.misc"),I$=[[0,'java.lang.reflect.Modifier','IllegalAccessError']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if ($I$(1,"isStatic$I",[f.getModifiers$()])) return (this.staticFieldOffset$java_lang_reflect_Field(f)|0);
 else return (this.objectFieldOffset$java_lang_reflect_Field(f)|0);
});
