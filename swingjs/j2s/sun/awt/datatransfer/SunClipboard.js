(function(){var P$=Clazz.newPackage("sun.awt.datatransfer"),p$1={},I$=[[0,'java.awt.datatransfer.SystemFlavorMap','sun.awt.datatransfer.TransferableProxy','java.awt.EventQueue','sun.awt.AppContext','sun.awt.datatransfer.ClipboardTransferable','sun.awt.datatransfer.DataTransferer','sun.awt.SunToolkit','sun.awt.PeerEvent','sun.awt.EventListenerAggregate','java.awt.datatransfer.FlavorListener','java.awt.datatransfer.FlavorEvent']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.flavorListener.flavorsChanged$java_awt_datatransfer_FlavorEvent(Clazz.new_($I$(11,1).c$$java_awt_datatransfer_Clipboard,[this.this$0]));
}});
