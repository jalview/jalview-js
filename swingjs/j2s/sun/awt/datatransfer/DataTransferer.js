(function(){var P$=Clazz.newPackage("sun.awt.datatransfer"),p$1={},I$=[[0,'java.util.HashMap','sun.awt.datatransfer.DataTransferer','java.util.Collections',['sun.awt.datatransfer.DataTransferer','.IndexedComparator'],'java.io.InputStream','java.io.Reader',['sun.awt.datatransfer.DataTransferer','.CharsetComparator'],'java.util.HashSet','java.awt.datatransfer.DataFlavor','java.util.ArrayList',['sun.awt.datatransfer.DataTransferer','.DataFlavorComparator'],'sun.awt.SunToolkit','java.awt.AWTError','java.security.AccessController','java.util.TreeSet','java.util.TreeMap',['sun.awt.datatransfer.DataTransferer','.IndexOrderComparator'],'java.util.Arrays','StringBuffer','java.io.ByteArrayOutputStream','java.io.ByteArrayInputStream','java.io.File','java.io.StringReader','java.io.InputStreamReader','java.lang.reflect.Modifier','java.io.SequenceInputStream','java.util.Stack','java.awt.EventQueue','sun.awt.AppContext']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
), Clazz.new_(P$.DataTransferer$4.$init$,[this, {format:format,formatMap:formatMap,contents:contents,stack:stack}]));
