(function(){var P$=Clazz.newPackage("sun.java2d.loops"),I$=[[0,'java.awt.Font','sun.java2d.loops.GraphicsPrimitive','sun.java2d.loops.RenderCache','sun.java2d.loops.GraphicsPrimitiveMgr',['sun.java2d.loops.BlitBg','.General'],['sun.java2d.loops.BlitBg','.TraceBlitBg']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
