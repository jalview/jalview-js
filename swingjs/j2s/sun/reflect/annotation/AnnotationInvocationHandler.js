(function(){var P$=Clazz.newPackage("sun.reflect.annotation"),p$1={},I$=[[0,'AssertionError','java.lang.reflect.Array','java.lang.reflect.Proxy','java.util.Arrays']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
