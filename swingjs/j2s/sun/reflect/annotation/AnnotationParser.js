(function(){var P$=Clazz.newPackage("sun.reflect.annotation"),I$=[[0,'java.util.ArrayList','java.lang.reflect.Method','java.util.HashMap','java.lang.reflect.Array','Enum','sun.reflect.annotation.AnnotationType','java.util.LinkedHashMap','java.util.Collections','java.lang.annotation.AnnotationFormatError','java.lang.annotation.Annotation',['sun.reflect.annotation.AnnotationParser','.JSAnnotationObject'],'java.lang.reflect.Proxy','sun.reflect.annotation.AnnotationInvocationHandler']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
