(function(){var P$=Clazz.newPackage("sun.reflect.misc"),I$=[[0,'java.lang.reflect.Proxy','java.lang.reflect.Modifier']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
