(function(){var P$=Clazz.newPackage("sun.reflect.misc"),p$1={},I$=[[0,'Error','java.security.AccessController','java.lang.reflect.Method','swingjs.JSUtil',['sun.reflect.misc.MethodUtil','.Signature'],'sun.reflect.misc.MethodUtil','InternalError','sun.reflect.misc.ReflectUtil','java.security.CodeSource','java.io.BufferedInputStream','sun.misc.IOUtils','java.security.AllPermission']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
