(function(){var P$=Clazz.newPackage("sun.util.logging"),p$1={},p$2={},I$=[[0,'java.util.Arrays','sun.util.logging.LoggingSupport',['sun.util.logging.PlatformLogger','.Level'],'sun.util.logging.PlatformLogger','java.text.MessageFormat','java.io.StringWriter','java.io.PrintWriter','sun.misc.SharedSecrets','java.util.HashMap',['sun.util.logging.PlatformLogger','.DefaultLoggerProxy'],['sun.util.logging.PlatformLogger','.JavaLoggerProxy']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
