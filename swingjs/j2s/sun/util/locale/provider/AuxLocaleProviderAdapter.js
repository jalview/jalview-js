(function(){var P$=Clazz.newPackage("sun.util.locale.provider"),I$=[[0,'java.util.Locale',['sun.util.locale.provider.AuxLocaleProviderAdapter','.NullProvider'],'java.util.concurrent.ConcurrentHashMap','java.text.spi.BreakIteratorProvider','java.text.spi.CollatorProvider','java.text.spi.DateFormatProvider','java.text.spi.DateFormatSymbolsProvider','java.text.spi.DecimalFormatSymbolsProvider','java.text.spi.NumberFormatProvider','java.util.spi.CurrencyNameProvider','java.util.spi.LocaleNameProvider','java.util.spi.TimeZoneNameProvider','java.util.spi.CalendarDataProvider','java.util.spi.CalendarNameProvider','sun.util.spi.CalendarProvider','java.util.HashSet','sun.util.locale.provider.LocaleServiceProviderPool','java.util.Arrays']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
