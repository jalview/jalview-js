(function(){var P$=Clazz.newPackage("sun.util.locale.provider"),p$1={},I$=[[0,'java.lang.ref.ReferenceQueue','java.util.HashMap','sun.util.resources.LocaleData','java.util.LinkedHashSet',['sun.util.locale.provider.LocaleProviderAdapter','.Type'],'sun.util.calendar.ZoneInfo','java.util.Calendar','sun.util.locale.provider.CalendarDataUtility','java.text.MessageFormat','StringBuilder']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
caldata=new Integer(Integer.parseInt$S(rb.getString$S(key)));
} else {
caldata=new Integer(0);
}this.cache.put$O$O(cacheKey, caldata);
}return (caldata).valueOf();
});
...
break;
default:
pattern=$I$(9).format$S$OA(dateTimePattern, [timePattern, datePattern]);
break;
}
} else {
pattern=timePattern;
