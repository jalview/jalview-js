(function(){var P$=Clazz.newPackage("sun.util.locale.provider"),p$1={},I$=[[0,'java.util.HashSet','sun.util.locale.provider.LocaleServiceProviderPool','java.util.Locale','java.util.concurrent.ConcurrentHashMap','java.text.spi.BreakIteratorProvider','java.text.spi.CollatorProvider','java.text.spi.DateFormatProvider','java.text.spi.DateFormatSymbolsProvider','java.text.spi.DecimalFormatSymbolsProvider','java.text.spi.NumberFormatProvider','java.util.spi.CurrencyNameProvider','java.util.spi.LocaleNameProvider','java.util.spi.TimeZoneNameProvider','java.util.spi.CalendarDataProvider','java.util.Collections','sun.util.locale.provider.LocaleProviderAdapter','sun.util.logging.PlatformLogger',['sun.util.locale.provider.LocaleServiceProviderPool','.AllAvailableLocales'],'java.util.Arrays',['sun.util.locale.provider.LocaleProviderAdapter','.Type'],'java.util.ArrayList',['java.util.ResourceBundle','.Control'],'sun.util.locale.provider.JRELocaleConstants',['java.util.Locale','.Builder']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
