(function(){var P$=Clazz.newPackage("sun.util.locale.provider"),p$1={},I$=[[0,'sun.util.locale.provider.BreakDictionary','sun.util.locale.provider.RuleBasedBreakIterator','java.util.Stack','java.util.ArrayList']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
possibleBreakPositions.push$O(new Integer(text.getIndex$()));
...
}currentBreakPositions.push$O(new Integer(endPos));
