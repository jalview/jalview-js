(function(){var P$=Clazz.newPackage("sun.util.locale.provider"),p$1={},I$=[[0,'sun.util.locale.provider.LocaleProviderAdapter','java.util.TreeMap',['sun.util.locale.provider.CalendarNameProviderImpl','.LengthBasedComparator'],'java.util.Locale',['sun.util.locale.provider.LocaleProviderAdapter','.Type'],'StringBuilder']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
if (field == 1) {
if (strings.length > 0) {
map.put$O$O(strings[0], new Integer(1));
}} else {
...
if (name.length$() == 0) {
continue;
}map.put$O$O(name, new Integer(base + i));
}
}}}}return map;
}, p$1);
