(function(){var P$=Clazz.newPackage("sun.util.locale.provider"),I$=[[0,['sun.util.locale.provider.LocaleProviderAdapter','.Type'],'sun.util.locale.provider.HostLocaleProviderAdapterImpl','sun.util.locale.provider.LocaleServiceProviderPool']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
