(function(){var P$=Clazz.newPackage("sun.util.locale.provider"),I$=[[0,'java.util.concurrent.ConcurrentHashMap','sun.util.locale.provider.SPILocaleProviderAdapter','java.util.Locale',['sun.util.locale.provider.LocaleProviderAdapter','.Type'],'java.security.AccessController','java.util.ServiceLoader','sun.util.locale.provider.LocaleServiceProviderPool']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
