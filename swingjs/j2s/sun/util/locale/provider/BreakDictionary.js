(function(){var P$=Clazz.newPackage("sun.util.locale.provider"),p$1={},I$=[[0,'java.security.AccessController','java.io.BufferedInputStream','InternalError','sun.util.locale.provider.RuleBasedBreakIterator','sun.text.CompactByteArray','sun.text.SupplementaryCharacterData']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
