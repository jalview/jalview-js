(function(){var P$=Clazz.newPackage("sun.util.locale.provider"),p$1={},I$=[[0,'Error','sun.text.CompactByteArray','sun.text.SupplementaryCharacterData','java.io.BufferedInputStream','StringBuilder','java.text.StringCharacterIterator',['sun.util.locale.provider.RuleBasedBreakIterator','.SafeCharIterator']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
