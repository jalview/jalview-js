...
return pool.getLocalizedObject$sun_util_locale_provider_LocaleServiceProviderPool_LocalizedObjectGetter$java_util_Locale$S$OA($I$(8).INSTANCE, locale, "generic", [new Integer(style), id]);
}, 1);

Clazz.newMeth(C$, 'retrieveDisplayName$S$Z$I$java_util_Locale', function (id, daylight, style, locale) {
var pool=$I$(7,"getPool$Class",[Clazz.getClass($I$(5))]);
return pool.getLocalizedObject$sun_util_locale_provider_LocaleServiceProviderPool_LocalizedObjectGetter$java_util_Locale$S$OA($I$(8).INSTANCE, locale, daylight ? "dst" : "std", [new Integer(style), id]);
}, 1);
...
if (names != null ) {
return names;
}names=pool.getLocalizedObject$sun_util_locale_provider_LocaleServiceProviderPool_LocalizedObjectGetter$java_util_Locale$S$OA($I$(9).INSTANCE, locale, id, []);
if (names != null ) {
perLocale.put$O$O(locale, names);
}return names;
}}var names=pool.getLocalizedObject$sun_util_locale_provider_LocaleServiceProviderPool_LocalizedObjectGetter$java_util_Locale$S$OA($I$(9).INSTANCE, locale, id, []);
if (names != null ) {
