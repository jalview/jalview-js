...
if (value == null ) {
continue;
}}map.put$O$O(new Character(key), Clazz.new_([key, $I$(3).toLowerString$S(value)],$I$(7,1).c$$C$S));
}
...
map.put$O$O(new Character("u"), ule);
}if (map.isEmpty$()) {
this.id="";
this.extensionMap=$I$(2).emptyMap$();
} else {
...
return this.extensionMap.get$O(new Character($I$(3,"toLower$C",[(key).valueOf()])));
});

Clazz.newMeth(C$, 'getExtensionValue$Character', function (key) {
var ext=this.extensionMap.get$O(new Character($I$(3,"toLower$C",[(key).valueOf()])));
if (ext == null ) {
return null;
}return ext.getValue$();
});
...
var ext=this.extensionMap.get$O(new Character("u"));
if (ext == null ) {
return $I$(2).emptySet$();
...
C$.CALENDAR_JAPANESE=Clazz.new_(C$.c$$S$Character$sun_util_locale_Extension,["u-ca-japanese", new Character("u"), $I$(1).CA_JAPANESE]);
C$.NUMBER_THAI=Clazz.new_(C$.c$$S$Character$sun_util_locale_Extension,["u-nu-thai", new Character("u"), $I$(1).NU_THAI]);
};
