(function(){var P$=Clazz.newPackage("sun.util.locale"),p$1={},I$=[[0,'java.util.HashMap','sun.util.locale.LocaleUtils','java.util.Collections','sun.util.locale.ParseStatus','sun.util.locale.StringTokenIterator','java.util.ArrayList','StringBuilder']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
