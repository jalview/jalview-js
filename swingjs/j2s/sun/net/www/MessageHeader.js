(function(){var P$=Clazz.newPackage("sun.net.www"),p$1={},I$=[[0,'java.util.StringJoiner',['sun.net.www.MessageHeader','.HeaderIterator'],'java.util.HashMap','java.util.ArrayList','java.util.Collections']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
