...
this.eflags=0;
this.engine=this.this$0._lef.getEngine$sun_font_GlyphLayout_LayoutEngineKey(this.key);
});

Clazz.newMeth(C$, 'layout$', function () {
this.this$0._textRecord.start=this.start;
this.this$0._textRecord.limit=this.limit;
this.engine.layout$sun_font_FontStrikeDesc$FA$I$I$sun_font_TextRecord$I$java_awt_geom_Point2D_Float$sun_font_GlyphLayout_GVData(this.this$0._sd, this.this$0._mat, this.gmask, this.start - this.this$0._offset, this.this$0._textRecord, this.this$0._typo_flags | this.eflags, this.this$0._pt, this.this$0._gvdata);
});
})()
})();
