(function(){var P$=Clazz.newPackage("sun.font"),p$1={},p$2={},I$=[[0,'java.awt.geom.AffineTransform','java.awt.Rectangle',['java.awt.geom.Point2D','.Float'],['sun.font.StandardGlyphVector','.GlyphStrike'],'java.lang.ref.SoftReference','java.awt.RenderingHints','swingjs.JSUtil',['java.awt.geom.Rectangle2D','.Float'],'StringBuffer','java.awt.font.FontRenderContext','java.awt.geom.Rectangle2D',['sun.font.StandardGlyphVector','.GlyphTransformInfo'],'java.awt.Shape',['sun.font.StandardGlyphVector','.ADL'],'java.awt.geom.GeneralPath','sun.font.DelegatingShape','java.awt.font.GlyphMetrics','swingjs.JSFontMetrics']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['I',['flags'],'O',['font','java.awt.Font','frc','java.awt.font.FontRenderContext','glyphs','int[]','+userGlyphs','positions','float[]','charIndices','int[]','gti','sun.font.StandardGlyphVector.GlyphTransformInfo','ftx','java.awt.geom.AffineTransform','+dtx','+invdtx','+frctx','fontxx2D','sun.font.Font2D','fsref','java.lang.ref.SoftReference','+lbcacheRef','+vbcacheRef']]]
...
if (aaHint !== $I$(6).VALUE_TEXT_ANTIALIAS_ON  && aaHint !== $I$(6).VALUE_TEXT_ANTIALIAS_GASP  ) {
var frc=gv.getFontRenderContext$();
frc=Clazz.new_([frc.getTransform$(), $I$(6).VALUE_TEXT_ANTIALIAS_ON, frc.getFractionalMetricsHint$()],$I$(10,1).c$$java_awt_geom_AffineTransform$O$O);
...
}return Clazz.new_($I$(8,1).c$$F$F$F$F,[minX, minY, maxX - minX, maxY - minY]);
});

Clazz.newMeth(C$, 'getVisualBounds$', function () {
var result=null;
for (var i=0; i < this.glyphs.length; ++i) {
var glyphVB=this.getGlyphVisualBounds$I(i).getBounds2D$();
if (!glyphVB.isEmpty$()) {
if (result == null ) {
result=glyphVB;
} else {
$I$(11).union$java_awt_geom_Rectangle2D$java_awt_geom_Rectangle2D$java_awt_geom_Rectangle2D(result, glyphVB, result);
}}}
if (result == null ) {
result=Clazz.new_($I$(8,1).c$$F$F$F$F,[0, 0, 0, 0]);
}return result;
});
...
return;
}this.gti=Clazz.new_($I$(12,1).c$$sun_font_StandardGlyphVector,[this]);
...
lbcache=Clazz.array($I$(13), [this.glyphs.length]);
this.lbcacheRef=Clazz.new_($I$(5,1).c$$O,[lbcache]);
}var result=lbcache[ix];
if (result == null ) {
p$1.setFRCTX.apply(this, []);
p$1.initPositions.apply(this, []);
var adl=Clazz.new_($I$(14,1));
...
var gm=Clazz.new_($I$(17,1).c$$Z$F$F$java_awt_geom_Rectangle2D$B,[true, adv.x, adv.y, vb, 0]);
return gm;
});
...
result.gti=Clazz.new_($I$(12,1).c$$sun_font_StandardGlyphVector$sun_font_StandardGlyphVector_GlyphTransformInfo,[result, this.gti]);
}return result;
} catch (e) {
...
$I$(18).charsToGlyphs$I$CA$IA(count, text, this.glyphs);
}, p$1);
...
p$1.setFRCTX.apply(this, []);
p$1.initPositions.apply(this, []);
return p$1.getGlyphStrike$I.apply(this, [ix]).getGlyphOutlineBounds$I$F$F(this.glyphs[ix], this.positions[ix * 2], this.positions[ix * 2 + 1]);
}, p$1);

Clazz.newMeth(C$, 'getGlyphsOutline$I$I$F$F', function (start, count, x, y) {
p$1.setFRCTX.apply(this, []);
p$1.initPositions.apply(this, []);
var result=Clazz.new_($I$(15,1).c$$I,[1]);
for (var i=start, e=start + count, n=start * 2; i < e; ++i, n+=2) {
var px=x + this.positions[n];
var py=y + this.positions[n + 1];
p$1.getGlyphStrike$I.apply(this, [i]).appendGlyphOutline$I$java_awt_geom_GeneralPath$F$F(this.glyphs[i], result, px, py);
}
return result;
}, p$1);
...
var lbcache=this.lbcacheRef.get$();
if (lbcache != null ) {
lbcache[ix]=null;
}}if (this.vbcacheRef != null ) {
var vbcache=this.vbcacheRef.get$();
if (vbcache != null ) {
vbcache[ix]=null;
}}}, p$1);
...
this.fsref=Clazz.new_($I$(5,1).c$$O,[gs]);
}return gs;
}, p$1);
...
C$.$fields$=[['Z',['haveAllStrikes'],'O',['sgv','sun.font.StandardGlyphVector','indices','int[]','transforms','double[]','strikesRef','java.lang.ref.SoftReference']]]
...
this.strikesRef=Clazz.new_($I$(5,1).c$$O,[strikes]);
}return strikes;
}, p$2);
...
tx=Clazz.new_($I$(1,1).c$$java_awt_geom_AffineTransform,[sgv.ftx]);
if (gtx != null ) {
tx.preConcatenate$java_awt_geom_AffineTransform(gtx);
dx=tx.getTranslateX$();
dy=tx.getTranslateY$();
}if (!dtx.isIdentity$()) {
tx.preConcatenate$java_awt_geom_AffineTransform(dtx);
}}var ptSize=1;
var aaHint=sgv.frc.getAntiAliasingHint$();
if (aaHint === $I$(6).VALUE_TEXT_ANTIALIAS_GASP ) {
if (!tx.isIdentity$() && (tx.getType$() & ~1) != 0 ) {
var shearx=tx.getShearX$();
if (shearx != 0 ) {
var scaley=tx.getScaleY$();
ptSize=(Math.sqrt(shearx * shearx + scaley * scaley)|0);
} else {
ptSize=((Math.abs(tx.getScaleY$()))|0);
}}}var strike=null;
return Clazz.new_(C$.c$$sun_font_StandardGlyphVector$sun_font_FontStrike$F$F,[sgv, strike, dx, dy]);
}, 1);
