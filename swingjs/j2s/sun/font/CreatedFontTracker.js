...
Clazz.newMeth(C$, 'init$', function () {
if (C$.t == null ) {
$I$(2,"doPrivileged$java_security_PrivilegedAction",[(P$.CreatedFontTracker$TempFileDeletionHook$lambda2$||(P$.CreatedFontTracker$TempFileDeletionHook$lambda2$=(((P$.CreatedFontTracker$TempFileDeletionHook$lambda1||
...
$I$(4).t=Clazz.new_([rootTG, (P$.CreatedFontTracker$TempFileDeletionHook$lambda1$lambda2$||(P$.CreatedFontTracker$TempFileDeletionHook$lambda1$lambda2$=((function($$){((
(function(){/*m*/var C$=Clazz.newClass(P$, "CreatedFontTracker$TempFileDeletionHook$lambda1$lambda2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
)); return Clazz.new_(P$.CreatedFontTracker$TempFileDeletionHook$lambda1$lambda2.$init$,[this, null])})($I$(4)))))],$I$(5,1).c$$ThreadGroup$Runnable);
$I$(4).t.setContextClassLoader$ClassLoader(null);
$I$(6).getRuntime$().addShutdownHook$Thread($I$(4).t);
return null;
});
})()
), Clazz.new_(P$.CreatedFontTracker$TempFileDeletionHook$lambda2.$init$,[this, null])))))]);
}}, 1);
