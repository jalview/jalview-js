(function(){var P$=Clazz.newPackage("sun.font"),I$=[[0,'sun.font.StandardTextSource','sun.font.ExtendedTextSourceLabel','sun.font.TextSourceLabel']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
