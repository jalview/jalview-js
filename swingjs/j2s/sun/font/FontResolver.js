(function(){var P$=Clazz.newPackage("sun.font"),p$1={},I$=[[0,'java.awt.Font','java.awt.GraphicsEnvironment','java.util.ArrayList','sun.font.FontUtilities']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
for (var i=0; i < len; i++) {
this.supplementaryIndices[i]=(indices.get$I(i)).valueOf();
}
