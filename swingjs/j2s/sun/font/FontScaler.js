(function(){var P$=Clazz.newPackage("sun.font"),I$=[[0,'sun.font.Font2D','sun.font.FontUtilities','sun.font.NullFontScaler','sun.java2d.Disposer']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var scaler=null;
try {
var args=Clazz.array(java.lang.Object, -1, [font, new Integer(indexInCollection), new Boolean(supportsCJK), new Integer(filesize)]);
