...
C$.VALUES_MASK=$I$(8,"getMask$sun_font_EAttributeA",[[$I$(9).EFOREGROUND, $I$(9).EBACKGROUND, $I$(9).ESWAP_COLORS, $I$(9).ESTRIKETHROUGH, $I$(9).EUNDERLINE, $I$(9).EINPUT_METHOD_HIGHLIGHT, $I$(9).EINPUT_METHOD_UNDERLINE]]);
