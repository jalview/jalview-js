...
var lo=this.this$0.data[ix - 1];
var hi=this.this$0.data[ix + 2];
switch (this.this$0.etype) {
case $I$(2).PINNED:
break;
case $I$(2).EXTENDED:
if (ix == 3) lo=-Infinity;
if (ix == this.this$0.data.length - 3) hi=Infinity;
break;
case $I$(2).CLOSED:
break;
}
...
;C$.$init$.apply(this);
this.ix=ix;
var len=this.this$0.data[ix + 2] - this.this$0.data[ix - 1];
this.ux=(this.this$0.data[ix] - this.this$0.data[ix - 3]) / len;
this.uy=(this.this$0.data[ix + 1] - this.this$0.data[ix - 2]) / len;
...
this.temp.sx -= this.this$0.data[this.ix - 1];
var sx=this.this$0.data[this.ix - 3] + this.temp.sx * this.ux - this.temp.sy * this.uy;
var sy=this.this$0.data[this.ix - 2] + this.temp.sx * this.uy + this.temp.sy * this.ux;
this.temp.lx -= this.this$0.data[this.ix - 1];
var lx=this.this$0.data[this.ix - 3] + this.temp.lx * this.ux - this.temp.ly * this.uy;
var ly=this.this$0.data[this.ix - 2] + this.temp.lx * this.uy + this.temp.ly * this.ux;
...
for (var i=3; i < this.this$0.data.length; i+=3) {
if (this.this$0.data[i + 2] != this.this$0.data[i - 1] ) {
