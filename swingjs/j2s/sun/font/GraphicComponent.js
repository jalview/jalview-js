(function(){var P$=Clazz.newPackage("sun.font"),p$1={},I$=[[0,'sun.font.BidiUtils','InternalError',['java.awt.geom.Rectangle2D','.Float'],'sun.font.CoreMetrics','java.awt.geom.AffineTransform','java.awt.geom.GeneralPath']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
