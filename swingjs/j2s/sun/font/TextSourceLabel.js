(function(){var P$=Clazz.newPackage("sun.font"),p$1={},I$=[[0,['java.awt.geom.Rectangle2D','.Float'],'sun.font.AttributeValues','swingjs.JSUtil']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
