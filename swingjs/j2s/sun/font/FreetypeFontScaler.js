(function(){var P$=Clazz.newPackage("sun.font"),p$1={},I$=[[0,'sun.font.FontManagerNativeLibrary','sun.font.FontScaler','sun.font.NullFontScaler']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
