...
this.helix.setLabel$S($I$(11).getString$S("label.colourScheme_helixpropensity"));
this.helix.addActionListener$java_awt_event_ActionListener(this);
this.strand.setLabel$S($I$(11).getString$S("label.colourScheme_strandpropensity"));
this.strand.addActionListener$java_awt_event_ActionListener(this);
this.turn.setLabel$S($I$(11).getString$S("label.colourScheme_turnpropensity"));
this.turn.addActionListener$java_awt_event_ActionListener(this);
this.buried.setLabel$S($I$(11).getString$S("label.colourScheme_buriedindex"));
