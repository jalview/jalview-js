(function(){var P$=Clazz.newPackage("javax.imageio"),I$=[[0,'javax.imageio.ImageIO','javax.imageio.spi.ImageReaderSpi','java.util.Arrays','javax.imageio.spi.ImageWriterSpi',['javax.imageio.ImageIO','.SpiInfo'],'swingjs.JSUtil','java.util.HashSet','swingjs.image.PngImageWriter','swingjs.image.JpgImageWriter','swingjs.image.GifImageWriter','javax.imageio.spi.IIORegistry','sun.awt.AppContext',['javax.imageio.ImageIO','.CacheInfo'],'sun.security.action.GetPropertyAction','java.security.AccessController','java.io.File','java.io.FilePermission','javax.imageio.spi.ImageInputStreamSpi','javax.imageio.spi.ImageOutputStreamSpi','java.util.Collections',['javax.imageio.ImageIO','.CanDecodeInputFilter'],['javax.imageio.ImageIO','.ImageReaderIterator'],['javax.imageio.ImageIO','.ContainsFilter'],['javax.imageio.ImageIO','.ImageWriterIterator'],['javax.imageio.ImageIO','.CanEncodeImageAndFormatFilter'],['javax.imageio.ImageIO','.TranscoderFilter'],'javax.imageio.spi.ImageTranscoderSpi',['javax.imageio.ImageIO','.ImageTranscoderIterator'],'java.awt.Toolkit','java.io.BufferedInputStream','javax.imageio.ImageTypeSpecifier']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return (C$.theRegistry == null  ? C$.theRegistry=$I$(11).getDefaultInstance$() : C$.theRegistry);
}, 1);
...
var context=$I$(12).getAppContext$();
var info=context.get$O(Clazz.getClass($I$(13)));
if (info == null ) {
info=Clazz.new_($I$(13,1));
context.put$O$O(Clazz.getClass($I$(13)), info);
}return info;
}, 1);

Clazz.newMeth(C$, 'getTempDir$', function () {
var a=Clazz.new_($I$(14,1).c$$S,["java.io.tmpdir"]);
return $I$(15).doPrivileged$java_security_PrivilegedAction(a);
}, 1);
...
if (!filepath.endsWith$S($I$(16).separator)) {
filepath += $I$(16).separator;
}filepath += "*";
security.checkPermission$java_security_Permission(Clazz.new_($I$(17,1).c$$S$S,[filepath, "read, write, delete"]));
}} catch (e) {
...
while (iter.hasNext$()){
var spi=iter.next$();
$I$(20,"addAll$java_util_Collection$OA",[s, spiInfo.info$javax_imageio_spi_ImageReaderWriterSpi(spi)]);
}
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(2)), Clazz.new_($I$(21,1).c$$O,[input]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(20).emptyIterator$();
} else {
throw e;
}
}
return Clazz.new_($I$(22,1).c$$java_util_Iterator,[iter]);
}, 1);
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(2)), Clazz.new_($I$(23,1).c$$java_lang_reflect_Method$S,[C$.readerFormatNamesMethod, formatName]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(20).emptyIterator$();
} else {
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(2)), Clazz.new_($I$(23,1).c$$java_lang_reflect_Method$S,[C$.readerFileSuffixesMethod, fileSuffix]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(20).emptyIterator$();
} else {
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(2)), Clazz.new_($I$(23,1).c$$java_lang_reflect_Method$S,[C$.readerMIMETypesMethod, MIMEType]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(20).emptyIterator$();
} else {
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(4)), Clazz.new_($I$(23,1).c$$java_lang_reflect_Method$S,[C$.writerFormatNamesMethod, formatName]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(20).emptyIterator$();
} else {
...
return Clazz.new_($I$(24,1).c$$java_util_Iterator,[iter]);
}, 1);
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(4)), Clazz.new_($I$(23,1).c$$java_lang_reflect_Method$S,[C$.writerFileSuffixesMethod, fileSuffix]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(20).emptyIterator$();
} else {
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(4)), Clazz.new_($I$(23,1).c$$java_lang_reflect_Method$S,[C$.writerMIMETypesMethod, MIMEType]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(20).emptyIterator$();
} else {
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(4)), Clazz.new_($I$(25,1).c$$javax_imageio_ImageTypeSpecifier$S,[type, formatName]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(20).emptyIterator$();
} else {
...
var writerSpi=writer.getOriginatingProvider$();
var filter=Clazz.new_($I$(26,1).c$$javax_imageio_spi_ImageReaderSpi$javax_imageio_spi_ImageWriterSpi,[readerSpi, writerSpi]);
var iter;
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(27)), filter, true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(20).emptyIterator$();
} else {
...
return Clazz.new_($I$(28,1).c$$java_util_Iterator,[iter]);
}, 1);
...
return $I$(29).getDefaultToolkit$().createImage$BA($I$(6,"getSignedStreamBytes$java_io_BufferedInputStream",[Clazz.instanceOf(input, "java.io.BufferedInputStream") ? input : Clazz.new_($I$(30,1).c$$java_io_InputStream,[input])]));
}, 1);
...
var type=$I$(31).createFromRenderedImage$java_awt_image_RenderedImage(im);
...
try {
if (C$.useSPI) {
C$.readerFormatNamesMethod=Clazz.getClass($I$(2)).getMethod$S$ClassA("getFormatNames", []);
C$.readerFileSuffixesMethod=Clazz.getClass($I$(2)).getMethod$S$ClassA("getFileSuffixes", []);
C$.readerMIMETypesMethod=Clazz.getClass($I$(2)).getMethod$S$ClassA("getMIMETypes", []);
C$.writerFormatNamesMethod=Clazz.getClass($I$(4)).getMethod$S$ClassA("getFormatNames", []);
C$.writerFileSuffixesMethod=Clazz.getClass($I$(4)).getMethod$S$ClassA("getFileSuffixes", []);
C$.writerMIMETypesMethod=Clazz.getClass($I$(4)).getMethod$S$ClassA("getMIMETypes", []);
}} catch (e) {
...
Clazz.newMeth(C$, 'filter$O', function (elt) {
try {
return $I$(1,"contains$SA$S",[this.method.invoke$O$OA(elt, []), this.name]);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return false;
} else {
