(function(){var P$=Clazz.newPackage("javax.imageio.stream"),I$=[[0,'java.nio.file.Files','java.io.RandomAccessFile','com.sun.imageio.stream.StreamCloser']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
