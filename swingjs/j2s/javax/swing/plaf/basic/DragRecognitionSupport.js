(function(){var P$=Clazz.newPackage("javax.swing.plaf.basic"),p$1={},I$=[[0,'sun.awt.AppContext','javax.swing.SwingUtilities','sun.awt.dnd.SunDragSourceContextPeer','java.awt.dnd.DragSource']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
