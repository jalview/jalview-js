...
p$1.addTimer$javax_swing_TimerQueue_DelayedTimer.apply(this, [Clazz.new_([timer, $I$(3).MILLISECONDS.toNanos$J(delayMillis) + C$.now$()],$I$(9,1).c$$javax_swing_Timer$J)]);
}} finally {
}
});
...
timer.delayedTimer=null;
if (timer.isRepeats$()) {
delayedTimer.setTime$J(C$.now$() + $I$(3).MILLISECONDS.toNanos$J(timer.getDelay$()));
...
return unit.convert$J$java_util_concurrent_TimeUnit(this.time - $I$(2).now$(), $I$(3).NANOSECONDS);
});
...
return 1;
}}var d=(this.getDelay$java_util_concurrent_TimeUnit($I$(3).NANOSECONDS) - other.getDelay$java_util_concurrent_TimeUnit($I$(3).NANOSECONDS));
