...
p$1.addMapping$javax_swing_tree_FixedHeightLayoutCache_FHTreeStateNode.apply(this.this$0, [this]);
}});
...
p$1.removeMapping$javax_swing_tree_FixedHeightLayoutCache_FHTreeStateNode.apply(this.this$0, [this]);
...
var newChildIndex=this.this$0.treeModel.getIndexOfChild$O$O(this.getUserObject$(), userObject);
if (newChildIndex < 0) return null;
var aNode;
var child=p$1.createNodeForValue$O$I.apply(this.this$0, [userObject, newChildIndex]);
var childRow;
if (this.isVisible$()) {
...
}p$1.adjustRowCountBy$I.apply(this.this$0, [childRowCount]);
});
...
this.childCount=this.this$0.treeModel.getChildCount$O(this.getUserObject$());
if (visible) {
this.didExpand$();
}if (visible && this.this$0.treeSelectionModel != null  ) {
...
p$1.adjustRowCountBy$I.apply(this.this$0, [-childCount]);
this.adjustRowBy$I$I(-childCount, 0);
} else this.isExpanded=false;
if (adjustRows && this.isVisible$() && this.this$0.treeSelectionModel != null   ) this.this$0.treeSelectionModel.resetRowSelection$();
}});
...
p$1.adjustRowCountBy$I.apply(this.this$0, [-1]);
...
if (this.isNodeParentNode) return this.node.getTreePath$().pathByAddingChild$O(this.this$0.treeModel.getChild$O$I(this.node.getUserObject$(), this.childIndex));
...
this.childCount=this.this$0.treeModel.getChildCount$O(this.parent.getUserObject$());
}, 1);
...
if (node == null ) retObject=this.parent.getTreePath$().pathByAddingChild$O(this.this$0.treeModel.getChild$O$I(this.parent.getUserObject$(), this.nextIndex));
...
this.parent=child;
this.nextIndex=-1;
this.childCount=this.this$0.treeModel.getChildCount$O(child.getUserObject$());
}return true;
});
