...
p$1.addMapping$javax_swing_tree_VariableHeightLayoutCache_TreeStateNode.apply(this.this$0, [this]);
}});
...
return this.this$0.visibleNodes.indexOf$O(this);
});
...
if (this === this.this$0.root ) return true;
var parent=this.getParent$();
...
p$1.removeMapping$javax_swing_tree_VariableHeightLayoutCache_TreeStateNode.apply(this.this$0, [this]);
...
var bounds=this.b$['javax.swing.tree.AbstractLayoutCache'].getNodeDimensions$O$I$I$Z$java_awt_Rectangle.apply(this.b$['javax.swing.tree.AbstractLayoutCache'], [this.getUserObject$(), index, this.getLevel$(), this.isExpanded$(), this.this$0.boundsBuffer]);
if (bounds == null ) {
this.xOrigin=0;
...
newNode=p$1.createNodeForValue$O.apply(this.this$0, [treeModel.getChild$O$I(realNode, i)]);
...
if (isFixed) newYOrigin=0;
 else if (this === this.this$0.root  && !this.b$['javax.swing.tree.AbstractLayoutCache'].isRootVisible$.apply(this.b$['javax.swing.tree.AbstractLayoutCache'], []) ) newYOrigin=0;
 else newYOrigin=this.getYOrigin$() + this.getPreferredHeight$();
var aNode;
if (!isFixed) {
while (cursor.hasMoreElements$()){
aNode=cursor.nextElement$();
if (!this.this$0.updateNodeSizes && !aNode.hasValidSize$() ) aNode.updatePreferredSize$I(i + 1);
aNode.setYOrigin$I(newYOrigin);
newYOrigin+=aNode.getPreferredHeight$();
this.this$0.visibleNodes.insertElementAt$O$I(aNode, ++i);
}
} else {
while (cursor.hasMoreElements$()){
aNode=cursor.nextElement$();
...
if (!isFixed && ++i < this.this$0.getRowCount$.apply(this.this$0, []) ) {
var counter;
var heightDiff=newYOrigin - (this.getYOrigin$() + this.getPreferredHeight$()) + (this.getPreferredHeight$() - startHeight);
for (counter=this.this$0.visibleNodes.size$() - 1; counter >= i; counter--) (this.this$0.visibleNodes.elementAt$I(counter)).shiftYOriginBy$I(heightDiff);

}this.didAdjustTree$();
p$1.visibleNodesChanged.apply(this.this$0, []);
...
this.this$0.visibleNodes.removeElementAt$I(counter);
}
this.expanded=false;
...
if (!isFixed && (myRow + 1) < this.this$0.getRowCount$.apply(this.this$0, [])  && startYEnd != lastYEnd ) {
var counter;
var maxCounter;
var shiftAmount;
shiftAmount=startYEnd - lastYEnd;
for (counter=myRow + 1, maxCounter=this.this$0.visibleNodes.size$(); counter < maxCounter; counter++) (this.this$0.visibleNodes.elementAt$I(counter)).shiftYOriginBy$I(shiftAmount);

}this.didAdjustTree$();
p$1.visibleNodesChanged.apply(this.this$0, []);
}if (this.this$0.treeSelectionModel != null  && rowsDeleted > 0  && myRow != -1 ) {
this.this$0.treeSelectionModel.resetRowSelection$();
}}});
