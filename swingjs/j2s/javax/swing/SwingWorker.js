...
this.b$['javax.swing.SwingWorker'].doSubmit.add$OA([this]);
});
})()
...
}}this.doNotifyProgressChange.add$OA([new Integer(oldProgress), new Integer(progress)]);
});
...
this.this$0.doSubmit.add$OA([((P$.SwingWorker$SwingWorkerPropertyChangeSupport$1||
