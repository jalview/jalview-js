(function(){var P$=Clazz.newPackage("javax.swing.text.html"),I$=[[0,'javax.swing.text.AttributeSet','javax.swing.text.SimpleAttributeSet',['javax.swing.text.html.MuxingAttributeSet','.MuxingAttributeNameEnumeration']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var as=this.this$0.getAttributes$.apply(this.this$0, []);
