(function(){var P$=Clazz.newPackage("javax.swing.text.html.parser"),I$=[[0,'java.util.Hashtable','sun.awt.AppContext','javax.swing.text.html.parser.AttributeList']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
$I$(2).getAppContext$().put$O$O(C$.MAX_INDEX_KEY, new Integer(index));
}}, 1);
