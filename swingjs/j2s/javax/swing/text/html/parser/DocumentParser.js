(function(){var P$=Clazz.newPackage("javax.swing.text.html.parser"),p$1={},I$=[[0,'javax.swing.text.SimpleAttributeSet',['javax.swing.text.html.HTMLEditorKit','.ParserCallback'],['javax.swing.text.html.HTML','.Attribute']]],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
