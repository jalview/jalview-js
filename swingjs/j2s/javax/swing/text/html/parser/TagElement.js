(function(){var P$=Clazz.newPackage("javax.swing.text.html.parser"),I$=[[0,'javax.swing.text.html.HTML',['javax.swing.text.html.HTML','.UnknownTag']]],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
