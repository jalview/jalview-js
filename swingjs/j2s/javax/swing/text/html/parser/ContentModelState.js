...
{
var m=this.model.content;
for (var i=0; i < this.value; i++, m=m.next) ;
...
return Clazz.new_(C$.c$$O$javax_swing_text_html_parser_ContentModelState,[this.model.content, Clazz.new_(C$.c$$O$javax_swing_text_html_parser_ContentModelState$J,[this.model, this.next, this.value + 1])]).advance$O(token);
}if (this.value != 0) {
if (this.next != null ) {
...
return Clazz.new_(C$.c$$O$javax_swing_text_html_parser_ContentModelState,[m, Clazz.new_(C$.c$$O$javax_swing_text_html_parser_ContentModelState$J,[this.model, this.next, this.value + 1])]).advance$O(token);
}}break;
}case 38:
{
var m=this.model.content;
...
if ((this.value & (1 << i)) == 0) {
if (m.first$O(token)) {
return Clazz.new_(C$.c$$O$javax_swing_text_html_parser_ContentModelState,[m, Clazz.new_(C$.c$$O$javax_swing_text_html_parser_ContentModelState$J,[this.model, this.next, this.value | (1 << i)])]).advance$O(token);
}if (!m.empty$()) {
complete=false;
}}}
if (complete) {
