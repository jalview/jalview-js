(function(){var P$=Clazz.newPackage("javax.swing.text.html.parser"),I$=[[0,'javax.swing.text.html.parser.Element']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
