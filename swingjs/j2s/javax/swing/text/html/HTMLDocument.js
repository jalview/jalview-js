...
this.isStyleCSS="text/css".equals$O(this.this$0.getDefaultStyleSheetType$.apply(this.this$0, []));
this.offset=offset;
this.threshold=this.this$0.getTokenThreshold$.apply(this.this$0, []);
...
var elem=this.this$0.getCharacterElement$I.apply(this.this$0, [targetOffset]);
...
if (length == 0) {
return;
}this.this$0.obtainLock$.apply(this.this$0, []);
try {
...
added=Clazz.array($I$(48), [1]);
added[0]=this.this$0.createLeafElement$javax_swing_text_Element$javax_swing_text_AttributeSet$I$I.apply(this.this$0, [pPath[pLength - 1], sas, length, length + 1]);
...
event.end$();
this.this$0.fireChangedUpdate$javax_swing_event_DocumentEvent.apply(this.this$0, [event]);
this.this$0.fireUndoableEditUpdate$javax_swing_event_UndoableEditEvent.apply(this.this$0, [Clazz.new_($I$(52,1).c$$O$javax_swing_undo_UndoableEdit,[this, event])]);
...
this.this$0.releaseLock$.apply(this.this$0, []);
}
}, p$2);
...
if (this.this$0.getLength$.apply(this.this$0, []) > 0 || this.parseBuffer.size$() > 0 ) {
...
return;
}if (Boolean.FALSE.equals$O(this.this$0.getProperty$O.apply(this.this$0, ["i18n"]))) {
...
this.this$0.putProperty$O$O.apply(this.this$0, ["i18n", Boolean.TRUE]);
} else {
...
this.styleAttributes=this.this$0.getStyleSheet$.apply(this.this$0, []).getDeclaration$S(decl);
...
if (this.styles != null ) {
this.styles.addElement$O( String.instantialize(data));
}} else if (this.this$0.getPreservesUnknownTags$.apply(this.this$0, [])) {
...
var oldLength=this.this$0.getLength$.apply(this.this$0, []);
...
this.this$0.create$javax_swing_text_DefaultStyledDocument_ElementSpecA.apply(this.this$0, [spec]);
} else {
this.this$0.insert$I$javax_swing_text_DefaultStyledDocument_ElementSpecA.apply(this.this$0, [this.offset, spec]);
}this.parseBuffer.removeAllElements$();
this.offset+=this.this$0.getLength$.apply(this.this$0, []) - oldLength;
this.flushCount++;
});
...
var ss=this.this$0.getStyleSheet$.apply(this.this$0, []);
ss.addRule$S(rules);
});
...
var url;
try {
url=Clazz.new_($I$(11,1).c$$java_net_URL$S,[this.this$0.base, href]);
} catch (mfe) {
...
if (url != null ) {
this.this$0.getStyleSheet$.apply(this.this$0, []).importStyleSheet$java_net_URL(url);
}});
...
this.this$0.blockOpen$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this.this$0, [t, attr]);
});

Clazz.newMeth(C$, 'end$javax_swing_text_html_HTML_Tag', function (t) {
this.this$0.blockClose$javax_swing_text_html_HTML_Tag.apply(this.this$0, [t]);
});
...
this.this$0.inParagraph=true;
});

Clazz.newMeth(C$, 'end$javax_swing_text_html_HTML_Tag', function (t) {
C$.superclazz.prototype.end$javax_swing_text_html_HTML_Tag.apply(this, [t]);
this.this$0.inParagraph=false;
});
...
Clazz.newMeth(C$, 'start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet', function (t, a) {
this.this$0.addSpecialElement$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this.this$0, [t, a]);
});
...
Clazz.newMeth(C$, 'start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet', function (t, a) {
this.this$0.blockOpen$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this.this$0, [$I$(4).IMPLIED, Clazz.new_($I$(5,1))]);
this.this$0.addSpecialElement$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this.this$0, [t, a]);
this.this$0.blockClose$javax_swing_text_html_HTML_Tag.apply(this.this$0, [$I$(4).IMPLIED]);
});
...
this.this$0.isStyleCSS="text/css".equals$O(this.b$['javax.swing.text.html.HTMLDocument'].getDefaultStyleSheetType$.apply(this.b$['javax.swing.text.html.HTMLDocument'], []));
} else if (equiv.equals$O("default-style")) {
this.this$0.defaultStyle=a.getAttribute$O($I$(6).CONTENT);
}}C$.superclazz.prototype.start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this, [t, a]);
});
...
Clazz.newMeth(C$, 'start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet', function (t, a) {
this.this$0.inHead=true;
if ((this.this$0.insertTag == null  && !this.this$0.insertAfterImplied ) || (this.this$0.insertTag === $I$(4).HEAD ) || (this.this$0.insertAfterImplied && (this.this$0.foundInsertTag || !a.isDefined$O($I$(7).IMPLIED) ) )  ) {
C$.superclazz.prototype.start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this, [t, a]);
}});

Clazz.newMeth(C$, 'end$javax_swing_text_html_HTML_Tag', function (t) {
this.this$0.inHead=this.this$0.inStyle=false;
if (this.this$0.styles != null ) {
var isDefaultCSS=this.this$0.isStyleCSS;
for (var counter=0, maxCounter=this.this$0.styles.size$(); counter < maxCounter; ) {
var value=this.this$0.styles.elementAt$I(counter);
if (value === $I$(4).LINK ) {
p$1.handleLink$javax_swing_text_AttributeSet.apply(this, [this.this$0.styles.elementAt$I(++counter)]);
counter++;
} else {
var type=this.this$0.styles.elementAt$I(++counter);
var isCSS=(type == null ) ? isDefaultCSS : type.equals$O("text/css");
while (++counter < maxCounter && (Clazz.instanceOf(this.this$0.styles.elementAt$I(counter), "java.lang.String")) ){
if (isCSS) {
this.this$0.addCSSRules$S.apply(this.this$0, [this.this$0.styles.elementAt$I(counter)]);
}}
}}
}if ((this.this$0.insertTag == null  && !this.this$0.insertAfterImplied ) || this.this$0.insertTag === $I$(4).HEAD   || (this.this$0.insertAfterImplied && this.this$0.foundInsertTag ) ) {
C$.superclazz.prototype.end$javax_swing_text_html_HTML_Tag.apply(this, [t]);
}});
...
rel=rel.toLowerCase$();
if ((media.indexOf$S("all") != -1 || media.indexOf$S("screen") != -1 ) && (rel.equals$O("stylesheet") || (rel.equals$O("alternate stylesheet") && title.equals$O(this.this$0.defaultStyle) ) ) ) {
this.this$0.linkCSSStyleSheet$S.apply(this.this$0, [attr.getAttribute$O($I$(6).HREF)]);
}}}}, p$1);
...
if (this.this$0.styles == null ) {
this.this$0.styles=Clazz.new_($I$(8,1).c$$I,[3]);
}this.this$0.styles.addElement$O(t);
this.this$0.styles.addElement$O(a.copyAttributes$());
}}C$.superclazz.prototype.start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this, [t, a]);
});
...
Clazz.newMeth(C$, 'start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet', function (t, a) {
this.this$0.lastMap=Clazz.new_([a.getAttribute$O($I$(6).NAME)],$I$(9,1).c$$S);
this.b$['javax.swing.text.html.HTMLDocument'].addMap$javax_swing_text_html_Map.apply(this.b$['javax.swing.text.html.HTMLDocument'], [this.this$0.lastMap]);
});
...
Clazz.newMeth(C$, 'start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet', function (t, a) {
if (this.this$0.lastMap != null ) {
this.this$0.lastMap.addArea$javax_swing_text_AttributeSet(a.copyAttributes$());
}});
...
Clazz.newMeth(C$, 'start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet', function (t, a) {
if (this.this$0.inHead) {
if (this.this$0.styles == null ) {
this.this$0.styles=Clazz.new_($I$(8,1).c$$I,[3]);
}this.this$0.styles.addElement$O(t);
this.this$0.styles.addElement$O(a.getAttribute$O($I$(6).TYPE));
this.this$0.inStyle=true;
}});

Clazz.newMeth(C$, 'end$javax_swing_text_html_HTML_Tag', function (t) {
this.this$0.inStyle=false;
});
...
Clazz.newMeth(C$, 'start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet', function (t, attr) {
this.this$0.inPre=true;
this.this$0.blockOpen$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this.this$0, [t, attr]);
attr.addAttribute$O$O($I$(10).WHITE_SPACE, "pre");
this.this$0.blockOpen$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this.this$0, [$I$(4).IMPLIED, attr]);
});

Clazz.newMeth(C$, 'end$javax_swing_text_html_HTML_Tag', function (t) {
this.this$0.blockClose$javax_swing_text_html_HTML_Tag.apply(this.this$0, [$I$(4).IMPLIED]);
this.this$0.inPre=false;
this.this$0.blockClose$javax_swing_text_html_HTML_Tag.apply(this.this$0, [t]);
});
...
Clazz.newMeth(C$, 'start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet', function (t, attr) {
this.this$0.pushCharacterStyle$.apply(this.this$0, []);
if (!this.this$0.foundInsertTag) {
var insert=p$2.canInsertTag$javax_swing_text_html_HTML_Tag$javax_swing_text_AttributeSet$Z.apply(this.this$0, [t, attr, false]);
if (this.this$0.foundInsertTag) {
if (!this.this$0.inParagraph) {
this.this$0.inParagraph=this.this$0.impliedP=true;
}}if (!insert) {
return;
}}if (attr.isDefined$O($I$(7).IMPLIED)) {
attr.removeAttribute$O($I$(7).IMPLIED);
}this.this$0.charAttr.addAttribute$O$O(t, attr.copyAttributes$());
if (this.this$0.styleAttributes != null ) {
this.this$0.charAttr.addAttributes$javax_swing_text_AttributeSet(this.this$0.styleAttributes);
}});

Clazz.newMeth(C$, 'end$javax_swing_text_html_HTML_Tag', function (t) {
this.this$0.popCharacterStyle$.apply(this.this$0, []);
});
...
if (t === $I$(4).B ) {
sheet.addCSSAttribute$javax_swing_text_MutableAttributeSet$javax_swing_text_html_CSS_Attribute$S(this.this$0.charAttr, $I$(10).FONT_WEIGHT, "bold");
} else if (t === $I$(4).I ) {
sheet.addCSSAttribute$javax_swing_text_MutableAttributeSet$javax_swing_text_html_CSS_Attribute$S(this.this$0.charAttr, $I$(10).FONT_STYLE, "italic");
} else if (t === $I$(4).U ) {
var v=this.this$0.charAttr.getAttribute$O($I$(10).TEXT_DECORATION);
var value="underline";
value=(v != null ) ? value + "," + v.toString()  : value;
sheet.addCSSAttribute$javax_swing_text_MutableAttributeSet$javax_swing_text_html_CSS_Attribute$S(this.this$0.charAttr, $I$(10).TEXT_DECORATION, value);
...
var v=this.this$0.charAttr.getAttribute$O($I$(10).VERTICAL_ALIGN);
var value="sup";
value=(v != null ) ? value + "," + v.toString()  : value;
sheet.addCSSAttribute$javax_swing_text_MutableAttributeSet$javax_swing_text_html_CSS_Attribute$S(this.this$0.charAttr, $I$(10).VERTICAL_ALIGN, value);
} else if (t === $I$(4).SUB ) {
var v=this.this$0.charAttr.getAttribute$O($I$(10).VERTICAL_ALIGN);
var value="sub";
value=(v != null ) ? value + "," + v.toString()  : value;
...
if (color != null ) {
sheet.addCSSAttribute$javax_swing_text_MutableAttributeSet$javax_swing_text_html_CSS_Attribute$S(this.this$0.charAttr, $I$(10).COLOR, color);
}var face=attr.getAttribute$O($I$(6).FACE);
if (face != null ) {
sheet.addCSSAttribute$javax_swing_text_MutableAttributeSet$javax_swing_text_html_CSS_Attribute$S(this.this$0.charAttr, $I$(10).FONT_FAMILY, face);
}var size=attr.getAttribute$O($I$(6).SIZE);
if (size != null ) {
sheet.addCSSAttributeFromHTML$javax_swing_text_MutableAttributeSet$javax_swing_text_html_CSS_Attribute$S(this.this$0.charAttr, $I$(10).FONT_SIZE, size);
}}});
...
Clazz.newMeth(C$, 'start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet', function (t, attr) {
this.this$0.emptyAnchor=true;
C$.superclazz.prototype.start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this, [t, attr]);
});

Clazz.newMeth(C$, 'end$javax_swing_text_html_HTML_Tag', function (t) {
if (this.this$0.emptyAnchor) {
var one=Clazz.array(Character.TYPE, [1]);
one[0]="\n";
this.this$0.addContent$CA$I$I.apply(this.this$0, [one, 0, 1]);
}C$.superclazz.prototype.end$javax_swing_text_html_HTML_Tag.apply(this, [t]);
});
...
Clazz.newMeth(C$, 'start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet', function (t, attr) {
this.this$0.inTitle=true;
C$.superclazz.prototype.start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this, [t, attr]);
});

Clazz.newMeth(C$, 'end$javax_swing_text_html_HTML_Tag', function (t) {
this.this$0.inTitle=false;
C$.superclazz.prototype.end$javax_swing_text_html_HTML_Tag.apply(this, [t]);
});
...
var objSpec=this.this$0.parseBuffer.lastElement$();
...
this.this$0.inTextArea=true;
this.this$0.textAreaDocument=Clazz.new_($I$(12,1));
attr.addAttribute$O$O($I$(2).ModelAttribute, this.this$0.textAreaDocument);
...
this.this$0.option=Clazz.new_($I$(16,1).c$$javax_swing_text_AttributeSet,[attr]);
if (Clazz.instanceOf(this.selectModel, "javax.swing.text.html.OptionListModel")) {
var m=this.selectModel;
m.addElement$O(this.this$0.option);
if (this.this$0.option.isSelected$()) {
...
m.addElement$O(this.this$0.option);
if (this.this$0.option.isSelected$()) {
m.setSelectedItem$O(this.this$0.option);
m.setInitialSelection$javax_swing_text_html_Option(this.this$0.option);
}}this.optionCount++;
} else {
C$.superclazz.prototype.start$javax_swing_text_html_HTML_Tag$javax_swing_text_MutableAttributeSet.apply(this, [t, attr]);
}});
...
Clazz.newMeth(C$, 'end$javax_swing_text_html_HTML_Tag', function (t) {
if (t === $I$(4).OPTION ) {
this.this$0.option=null;
} else {
if (t === $I$(4).SELECT ) {
this.selectModel=null;
this.optionCount=0;
} else if (t === $I$(4).TEXTAREA ) {
this.this$0.inTextArea=false;
this.this$0.textAreaDocument.storeInitialText$();
}C$.superclazz.prototype.end$javax_swing_text_html_HTML_Tag.apply(this, [t]);
}});
...
;Clazz.setTVer('3.2.9-v1');//Created 2020-04-08 07:28:20 Java2ScriptVisitor version 3.2.9-v1 net.sf.j2s.core.jar version 3.2.9-v1
