...
if (img !== this.this$0.image  && img !== this.this$0.disabledImage   || this.this$0.image == null   || this.b$['javax.swing.text.View'].getParent$.apply(this.b$['javax.swing.text.View'], []) == null  ) {
return false;
}if ((flags & (192)) != 0) {
p$1.repaint$J.apply(this.this$0, [0]);
{
...
this.this$0.disabledImage=null;
}if ((this.this$0.state & 1) == 1) {
return false;
}}p$1.updateAltTextView.apply(this.this$0, []);
p$1.safePreferenceChanged.apply(this.this$0, []);
return false;
}if (this.this$0.image === img ) {
...
if ((changed & 1) == 1 && (this.this$0.state & 4) == 0 ) {
this.this$0.width=newWidth;
}if ((changed & 2) == 2 && (this.this$0.state & 8) == 0 ) {
...
p$1.repaint$J.apply(this.this$0, [$I$(2).sIncRate]);
}return ((flags & 32) == 0);
});
var $s$ = new Int16Array(1);
