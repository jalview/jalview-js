...
return this.this$0.model.getProperty$O("title");
} else {
return null;
}});
...
var comp=p$1.getTextComponent.apply(this.this$0, []);
if (comp.isEnabled$()) {
...
return p$1.getTextComponent.apply(this.this$0, []).getBackground$();
});

Clazz.newMeth(C$, 'setBackground$java_awt_Color', function (c) {
p$1.getTextComponent.apply(this.this$0, []).setBackground$java_awt_Color(c);
});

Clazz.newMeth(C$, 'getForeground$', function () {
return p$1.getTextComponent.apply(this.this$0, []).getForeground$();
});

Clazz.newMeth(C$, 'setForeground$java_awt_Color', function (c) {
p$1.getTextComponent.apply(this.this$0, []).setForeground$java_awt_Color(c);
});

Clazz.newMeth(C$, 'getCursor$', function () {
return p$1.getTextComponent.apply(this.this$0, []).getCursor$();
});

Clazz.newMeth(C$, 'setCursor$java_awt_Cursor', function (cursor) {
p$1.getTextComponent.apply(this.this$0, []).setCursor$java_awt_Cursor(cursor);
});

Clazz.newMeth(C$, 'getFont$', function () {
return p$1.getTextComponent.apply(this.this$0, []).getFont$();
});

Clazz.newMeth(C$, 'setFont$java_awt_Font', function (f) {
p$1.getTextComponent.apply(this.this$0, []).setFont$java_awt_Font(f);
});

Clazz.newMeth(C$, 'getFontMetrics$java_awt_Font', function (f) {
return p$1.getTextComponent.apply(this.this$0, []).getFontMetrics$java_awt_Font(f);
});

Clazz.newMeth(C$, 'isEnabled$', function () {
return p$1.getTextComponent.apply(this.this$0, []).isEnabled$();
});

Clazz.newMeth(C$, 'setEnabled$Z', function (b) {
p$1.getTextComponent.apply(this.this$0, []).setEnabled$Z(b);
});

Clazz.newMeth(C$, 'isVisible$', function () {
return p$1.getTextComponent.apply(this.this$0, []).isVisible$();
});

Clazz.newMeth(C$, 'setVisible$Z', function (b) {
p$1.getTextComponent.apply(this.this$0, []).setVisible$Z(b);
});

Clazz.newMeth(C$, 'isShowing$', function () {
return p$1.getTextComponent.apply(this.this$0, []).isShowing$();
});
...
var editorLocation=p$1.getTextComponent.apply(this.this$0, []).getLocationOnScreen$();
var r=this.getBounds$();
if (r != null ) {
...
var innerMostElement=p$2.getElementInfoAt$javax_swing_text_html_AccessibleHTML_ElementInfo$java_awt_Point.apply(this, [this.this$0.rootElementInfo, p]);
...
p$1.getTextComponent.apply(this.this$0, []).addFocusListener$java_awt_event_FocusListener(l);
});

Clazz.newMeth(C$, 'removeFocusListener$java_awt_event_FocusListener', function (l) {
p$1.getTextComponent.apply(this.this$0, []).removeFocusListener$java_awt_event_FocusListener(l);
});
...
if (this.this$0.width == -1) {
this.this$0.width=p$4.getImageSize$O.apply(this.this$0, [$I$(10).WIDTH]);
}return this.this$0.width;
});

Clazz.newMeth(C$, 'getAccessibleIconHeight$', function () {
if (this.this$0.height == -1) {
this.this$0.height=p$4.getImageSize$O.apply(this.this$0, [$I$(10).HEIGHT]);
...
this.caption=this.this$0.createElementInfo$javax_swing_text_Element$javax_swing_text_html_AccessibleHTML_ElementInfo.apply(this.this$0, [child, this]);
}}
});
...
var captionInfo=this.this$0.getCaptionInfo$.apply(this.this$0, []);
if (Clazz.instanceOf(captionInfo, "javax.accessibility.Accessible")) {
return this.this$0.caption;
} else {
return null;
}});
...
var cellInfo=this.this$0.getCell$I$I.apply(this.this$0, [r, c]);
if (cellInfo != null ) {
...
return false;
}var cell=this.this$0.getCell$I$I.apply(this.this$0, [r, c]);
if (cell != null ) {
...
var startCell=this.this$0.getCell$I$I.apply(this.this$0, [r, 0]);
if (startCell == null ) {
return false;
}var start=startCell.getElement$().getStartOffset$();
var endCell=this.this$0.getCell$I$I.apply(this.this$0, [r, nColumns - 1]);
if (endCell == null ) {
return false;
...
var startCell=this.this$0.getCell$I$I.apply(this.this$0, [0, c]);
if (startCell == null ) {
return false;
}var start=startCell.getElement$().getStartOffset$();
var endCell=this.this$0.getCell$I$I.apply(this.this$0, [nRows - 1, c]);
if (endCell == null ) {
return false;
}var end=endCell.getElement$().getEndOffset$();
return start >= this.b$['javax.swing.text.html.AccessibleHTML'].editor.getSelectionStart$() && end <= this.b$['javax.swing.text.html.AccessibleHTML'].editor.getSelectionEnd$() ;
...
var emptyRow=false;
while (!emptyRow){
for (var counter=0; counter < this.this$0.grid[row].length; counter++) {
if (this.this$0.grid[row][counter] == null ) {
emptyRow=true;
break;
}}
if (!emptyRow) {
...
var childInfo=this.this$0.createElementInfo$javax_swing_text_Element$javax_swing_text_html_AccessibleHTML_ElementInfo.apply(this.this$0, [e, this]);
if (childInfo != null ) {
...
if (!this.validateIfNecessary$()) {
return null;
}var lock=p$1.lock.apply(this.this$0, []);
try {
var rootView=p$1.getRootView.apply(this.this$0, []);
...
p$1.unlock$O.apply(this.this$0, [lock]);
}
});
...
try {
var bounds=p$1.getRootEditorRect.apply(this.this$0, []);
var rootView=p$1.getRootView.apply(this.this$0, []);
var e=this.getElement$();
...
parent.invalidate$Z(parent === p$1.getRootInfo.apply(this.this$0, []) );
}return;
...
p$9.update$javax_swing_event_DocumentEvent.apply(p$1.getRootInfo.apply(this.this$0, []), [e]);
});
...
p$1.setDocument$javax_swing_text_Document.apply(this.this$0, [this.this$0.editor.getDocument$()]);
}});
