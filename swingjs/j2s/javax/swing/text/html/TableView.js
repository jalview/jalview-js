...
if (r.minimum < (min|0)) {
r.maximum=r.minimum=r.preferred=(min|0);
...
this.adjustmentWeights=Clazz.array(Integer.TYPE, [this.this$0.columnRequirements.length]);
for (var i=0; i < this.this$0.columnRequirements.length; i++) {
this.adjustmentWeights[i]=0;
}
if (this.this$0.relativeCells) {
this.percentages=Clazz.array(Integer.TYPE, [this.this$0.columnRequirements.length]);
} else {
this.percentages=null;
}var nrows=this.this$0.getRowCount$.apply(this.this$0, []);
for (var rowIndex=0; rowIndex < nrows; rowIndex++) {
var row=this.this$0.getRow$I.apply(this.this$0, [rowIndex]);
var col=0;
var ncells=row.getViewCount$();
...
return this.this$0.borderWidth;
});

Clazz.newMeth(C$, 'getLeadingCollapseSpan$', function () {
return this.this$0.cellSpacing;
});
...
var n=this.this$0.getRowCount$.apply(this.this$0, []);
this.adjustments=Clazz.array(Integer.TYPE, [n]);
for (var i=0; i < n; i++) {
var rv=this.this$0.getRow$I.apply(this.this$0, [i]);
if (rv.multiRowCells == true ) {
var ncells=rv.getViewCount$();
for (var j=0; j < ncells; j++) {
var v=rv.getView$I(j);
var nrows=this.this$0.getRowsOccupied$javax_swing_text_View.apply(this.this$0, [v]);
if (nrows > 1) {
...
for (var i=0; i < nrows; i++) {
var rv=this.this$0.getRow$I.apply(this.this$0, [rowIndex + i]);
...
var rv=this.this$0.getRow$I.apply(this.this$0, [rowIndex]);
...
Clazz.newMeth(C$, 'setOffset$I', function (offs) {
var rv=this.this$0.getRow$I.apply(this.this$0, [this.row]);
if (rv != null ) {
...
return rv.getPreferredSpan$I(this.this$0.getAxis$.apply(this.this$0, [])) + adjust;
}return 0;
});
...
req.minimum=this.this$0.totalColumnRequirements.minimum;
...
var value;
if (axis == 0) {
value=this.this$0.totalColumnRequirements.minimum + this.getLeftInset$() + this.getRightInset$() ;
} else {
...
var value;
if (axis == 0) {
value=this.this$0.totalColumnRequirements.preferred + this.getLeftInset$() + this.getRightInset$() ;
} else {
...
for (var i=0; i < n; i++) {
var v=this.getView$I(i);
if (this.this$0.getRowsOccupied$javax_swing_text_View.apply(this.this$0, [v]) > 1) {
this.multiRowCells=true;
...
if (this.this$0.skipComments && !(Clazz.instanceOf(cv, "javax.swing.text.html.TableView.CellView")) ) {
continue;
...
var row1=Math.min(this.rowIndex + rowSpan - 1, this.this$0.getRowCount$.apply(this.this$0, []) - 1);
spans[cell]=this.this$0.getMultiRowSpan$I$I.apply(this.this$0, [row0, row1]);
}if (colSpan > 1) {
col+=colSpan - 1;
}}
});
