(function(){var P$=Clazz.newPackage("javax.xml.validation"),p$1={},I$=[[0,'javax.xml.validation.SecuritySupport','java.util.Properties','javax.xml.validation.SchemaFactory','java.io.File']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
