(function(){var P$=Clazz.newPackage("javax.xml.xpath"),p$1={},I$=[[0,'javax.xml.xpath.SecuritySupport','java.util.Properties','javax.xml.xpath.XPathFactory','java.io.File','java.io.BufferedReader','java.io.InputStreamReader']],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
