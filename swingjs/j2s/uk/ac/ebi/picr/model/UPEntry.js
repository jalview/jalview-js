(function(){var P$=Clazz.newPackage("uk.ac.ebi.picr.model"),I$=[[0,'java.util.Arrays','java.lang.reflect.Array']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
