(function(){var P$=Clazz.newPackage("uk.ac.ebi.www"),I$=[[0,'java.net.URL','uk.ac.ebi.www.WSWUBlastSoapBindingStub','uk.ac.ebi.www.WSWUBlast','jalview.util.MessageManager','javax.xml.namespace.QName','java.util.HashSet']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
