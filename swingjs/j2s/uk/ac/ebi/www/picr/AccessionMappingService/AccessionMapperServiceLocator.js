(function(){var P$=Clazz.newPackage("uk.ac.ebi.www.picr.AccessionMappingService"),I$=[[0,'java.net.URL','uk.ac.ebi.www.picr.AccessionMappingService.AccessionMapperBindingStub','uk.ac.ebi.www.picr.AccessionMappingService.AccessionMapperInterface','jalview.util.MessageManager','javax.xml.namespace.QName','java.util.HashSet']],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
