...
_call.setEncodingStyle$S(null);
_call.setProperty$S$O("sendXsiTypes", Boolean.FALSE);
_call.setProperty$S$O("sendMultiRefs", Boolean.FALSE);
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(20).SOAP11_CONSTANTS);
...
var _resp=_call.invoke$OA(Clazz.array(java.lang.Object, -1, [sequence, searchDatabases, taxonId, java.lang.Boolean.valueOf$Z(onlyActive)]));
...
return $I$(21,"convert$O$Class",[_resp, Clazz.getClass($I$(4))]);
} else {
throw _exception;
}
}
...
this.setRequestHeaders$org_apache_axis_client_Call(_call);
this.setAttachments$org_apache_axis_client_Call(_call);
var _resp=_call.invoke$OA(Clazz.array(java.lang.Object, -1, [accession, ac_version, searchDatabases, taxonId, java.lang.Boolean.valueOf$Z(onlyActive)]));
if (Clazz.instanceOf(_resp, "java.rmi.RemoteException")) {
throw _resp;
} else {
this.extractAttachments$org_apache_axis_client_Call(_call);
...
if (Clazz.exceptionOf(_exception,"Exception")){
return $I$(21,"convert$O$Class",[_resp, Clazz.array($I$(4), -1)]);
} else {
throw _exception;
}
}
...
if (Clazz.exceptionOf(_exception,"Exception")){
return $I$(21,"convert$O$Class",[_resp, Clazz.array(String, -1)]);
} else {
throw _exception;
}
}
